...
\chapter{Axiome der endlichen Mengen}

Die Theorie der endlichen Mengen wird hier durch ein Axiompaket ueber
Peano-Anfangsabschnitten aufgebaut. Die einzelnen Zeilen nennen die fuer den
Testband verwendeten Ausgangsaussagen; im anschliessenden Resultatteil werden
sie, soweit sie in Band~04 bereits vorkommen, nochmals in tabellarischer Form
nachgewiesen.

\FormulaAxiomDeltaK[Axiome der endlichen Mengen]{%
  ...
  \DeltaRow{Endlichkeitsprädikat}{\Finite{M}}
  \DeltaRow{Endliche Kardinalzahl}{\tCard(M)}
}

\paragraph{Status dieses Testbands.}
Die Axiome sind hier bewusst als kompaktes Paket vorangestellt. Der folgende
Teil ist der Resultatteil aus Band~04 zum Thema endliche Mengen; er bleibt als
Beweis- und Konsistenztest fuer die axiomatische Neuordnung erhalten.
