...
definitionellen Ausgangsdaten festgelegt. Diese gehoeren nicht zur
axiomatischen Struktur selbst.

\FormulaDefDeltaK[Definitionelle Ausgangsdaten der endlichen Mengen]{%
  \mathsf{FinDef}(\NatSeg,\Finite,\tCard)%
