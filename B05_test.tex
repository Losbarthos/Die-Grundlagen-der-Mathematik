...
Die Definitionen legen die verwendeten Begriffe fest; die Axiome sind die
Saetze, die aus diesen Definitionen folgen und die endlichen Mengen als
Struktur vollstaendig charakterisieren. Deshalb werden die Definitionen hier
nur orientierend vorangestellt. Das eigentliche Axiompaket enthaelt keine
Definitionen, sondern Folgesaetze ueber endliche Mengen.

\begin{DeltaContext}{Definierende Begriffe}
...
\FormulaAxiomDeltaK[Axiomatische Charakterisierung der endlichen Mengen]{%
  ...
  \DeltaRow{\textbf{Anfangsabschnitte}}{}
  ...
  \DeltaRow{Nachfolgerabschnitt}
           ...
           [\FormulaRefAuto{PeanoNatSegSucc}]
  \DeltaRow{Ordnungsschnitt}
           {m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
            m<n\leftrightarrow m\in\NatSeg{n}}
           [\FormulaRefAuto{PeanoNatSegStrictMembership}]
  \DeltaRow{\textbf{Endlichkeit}}{}
  ...
  \DeltaRow{Endliche Vereinigung}
           ...
           [\FormulaRefAuto{\Finite{A}\dsep \Finite{B}\vdash \Finite{A\cup B}}]
  \DeltaRow{Teilmengen}
           {T\subseteq M\dsep \Finite{M} \vdash \Finite{T}}
           [\FormulaRefAuto{T\subseteq M\dsep \Finite{M} \vdash \Finite{T}}]
  \DeltaRow{Bilder}
           {C\subseteq A\dsep F\colon A\to B\dsep \Finite{C} \vdash \Finite{F[C]}}
           [\FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep \Finite{C} \vdash \Finite{F[C]}}]
  \DeltaRow{Gleichmaechtigkeitstransport}
           {\Finite{M}\dsep M\EqCard N\vdash \Finite{N}}
           [\FormulaRefAuto{\Finite{M}\dsep M \EqCard N \vdash \Finite{N}}]
  \DeltaRow{\textbf{Kardinalzahl}}{}
  \DeltaRow{Wohldefiniertheit}
           {\Finite{M}\vdash
            \exists! n\,(n\in\mathbb{N}\land \NatSeg{n}\EqCard M)}
           [\FormulaRefAuto{\Finite{M}\vdash \exists! n\,\bigl(n\in\mathbb{N}\land \NatSeg{n} \EqCard M\bigr)}]
  \DeltaRow{Zaehlt die Menge}
           {\Finite{M}\vdash \NatSeg{\tCard(M)}\EqCard M}
           [\FormulaRefAuto{\Finite{M}\vdash \NatSeg{\tCard(M)}\EqCard M}]
  \DeltaRow{Eindeutigkeit}
           {n\in\mathbb{N}\dsep m\in\mathbb{N}\dsep
            \NatSeg{n}\EqCard M\dsep \NatSeg{m}\EqCard M\vdash n=m}
           [\FormulaRefAuto{n\in\mathbb{N}\dsep m\in\mathbb{N}\dsep \NatSeg{n} \EqCard M\dsep \NatSeg{m} \EqCard M \vdash n=m}]
