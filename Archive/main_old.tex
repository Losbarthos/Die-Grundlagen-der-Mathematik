...
\cs_new_protected:Npn \mx_print_formula_item_aux:nnn #1#2#3
  ...
  % --- Variante: mit Quelltext in der zweiten Spalte ---
\cs_new_protected:Npn \mx_print_formula_item_src_aux:nnn #1#2#3
  {
    \str_case:nnF {#1}
      {
        % Formel: links gesetzt, rechts LaTeX-Quelltext
        {F}{
          $ #3 $ & \ShowFormulaSource{#3} \\
        }
        % Überschrift: fett, zweite Spalte leer
        {H}{
          \textbf{#3} & \\
          [0.6\baselineskip]
        }
  ...
  % --- Variante: NUR Quelltext (eine Spalte) ---
\cs_new_protected:Npn \mx_print_formula_plain_aux:nnn #1#2#3
  {
    \str_case:nnF {#1}
      {
        % Formel: nur Quelltext
        {F}{
          \ShowFormulaSource{#3}\\
        }
        % Überschrift: fett, als Abschnittstrenner
        {H}{
          \textbf{#3}\\[0.6\baselineskip]
        }
      }
      { } % Default: nichts
  }
...
\cs_new_protected:Npn \mx_print_formula_plain:n #1
  { \mx_print_formula_plain_aux:nnn #1 }

\cs_new_protected:Npn \mx_print_formula_item_src:n #1
  { \mx_print_formula_item_src_aux:nnn #1 }
...
\NewDocumentCommand{\PrintFormulaStack}{}
  ...
  % Formelregister mit Quelltext in der zweiten Spalte
...
% Formelregister NUR mit Quelltext (eine Spalte, gut kopierbar)
...
% --- Neue Variante: Quelltext links, Referenz rechts ---
\cs_new_protected:Npn \mx_print_formula_item_src_ref_aux:nnn #1#2#3
  {
    \str_case:nnF {#1}
      {
        % Formel-Eintrag: links Quelltext, rechts Referenz
        {F}{
          \ShowFormulaSource{#3} & \FormulaRefAuto{#3} \\
        }
        % Überschrift-Eintrag (H): Abschnittstrenner
        {H}{
          \textbf{#3} & \\
          [0.6\baselineskip]
        }
...
\cs_new_protected:Npn \mx_print_formula_item_src_ref:n #1
  { \mx_print_formula_item_src_ref_aux:nnn #1 }

% Formelregister: Quelltext + Referenz (Typ steckt in der Referenz)
...
% --- Hilfsbefehl: Formel-Quelltext hübsch in Schreibmaschine darstellen ---
\newcommand{\ShowFormulaSource}[1]{%
  \begingroup
