...
% Ein fester Mindestabstand hält Formel und Begründung auch in den
% ungebrochenen Zeilen dieses Bandes lesbar auseinander.
\NewCommandCopy\BXXVIIIOriginalProofStepWideStar\proofstepwidestar
\RenewDocumentCommand{\proofstepwidestar}{O{} m m}{%
  \BXXVIIIOriginalProofStepWideStar[#1]{#2}{\hspace*{1em}#3}}
...
konkreten Produkt. Für beliebig lange Produkte werden nun die in Band~27
konstruierten Wortwerkzeuge verwendet.

Für eine Halbgruppe \(\SemigroupAlg{A}{\star}\) bezeichnet
\(\WordFold{\star}{u}\) die in Band~27 rekursiv definierte Linksfaltung des
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,3]{%
    ...
    \FormulaRefAuto{LeftWordFoldLetter}[thm]{4,3}}
  \proofstepwidestar[1,3]{%
  ...
  \proofstepwide[1,2,3]{%
    ...
    \FormulaRefAuto{LeftWordFoldStep}[thm]{4,2,3}}
  \proofstepwide[1,2,3]{}{=}{%
    \WordFold{\star}{u}\star\WordFold{\star}{\LetterWord{a}}}{%
    \FormulaRefAuto{BinaryFunctionRightArgumentCongruence}[thm]{6}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[4]{\LetterWord{a}\in\FiniteWords{A}}{%
    \FormulaRefAuto{NonemptyWordFinite}[thm]{11}}
  ...
  \proofstepwidestar[1,3,4]{%
    ...
    \FormulaRefAuto{LeftWordFoldStep}[thm]{6,3,4}}
  \proofstepwidestar[1,3,4]{%
    \WordFold{\star}{v}\star a
      =\WordFold{\star}{\WordConcat{v}{\LetterWord{a}}}}{%
  ...
  \proofstepwide[1,2,3,4,5]{}{=}{%
    ...
    \FormulaRefAuto{LeftWordFoldStep}[thm]{6,10,4}}
  \proofstepwide[1,2,3,4,5]{}{=}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{%
    \WordFold{\star}{\LetterWord{a}}=a}{%
    \FormulaRefAuto{LeftWordFoldLetter}[thm]{3,2}}
  \proofstepwidestar[1,2]{%
    a=\WordFold{\star}{\LetterWord{a}}}{%
  ...
  \proofstepwide[1,2]{%
    ...
    \FormulaRefAuto{TreeEvaluationLeafEquation}[thm]{3,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,3]{%
    \begin{aligned}[t]
      ...
      &\qquad
        =\WordConcat{\TreeLeafWord{A}{S}}{\TreeLeafWord{A}{T}}
    \end{aligned}}{%
    \FormulaRefAuto{TreeLeafWordNodeEquation}[thm]{2,3}}
  \proofstepwidestar[2,3]{%
    \begin{aligned}[t]
      &\WordConcat{\TreeLeafWord{A}{S}}{\TreeLeafWord{A}{T}}\\[-2pt]
      &\qquad
  ...
  \proofstepwide[1,2,3,4,5]{%
    ...
    \FormulaRefAuto{TreeEvaluationNodeEquation}[thm]{6,2,3}}
  \proofstepwide[1,2,3,4,5]{}{=}{%
    \WordFold{\star}{\TreeLeafWord{A}{S}}\star
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2,3,4]{%
    ...
    \FormulaRefAuto{m_0\in M\dsep f\colon M\to M\dsep k\in\mathbb{N}
      ...
      2,6,\FormulaRefAuto{PeanoMinusOneNatural}[thm]{3,4}}}
  \proofstepwidestarbreak[1,2,3,4]{%
    \rho_{A,\star,a}
      (\RecFun{a}{\rho_{A,\star,a}}(n-1))
...
\SemigroupAlg{A}{\star}\dsep e\in E_{A,\star}\vdash e^1=e
  ...
  \proofstepwidestar[1,2]{e\in A}{\rAEa{\FormulaRefAuto{SemigroupIdempotentMembership}[thm]{1,2}}}
  \proofstepwidestar[1,2]{e^1=e}{\FormulaRefAuto{SemigroupPowerOne}[thm]{1,3}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{\begin{aligned}[t]&(U\subseteq A\land U\neq\varnothing\land \forall x\in U\,\forall y\in U\,(x\star y\in U))\rightarrow{}\\[-2pt]&\quad \mathsf{UHGr}(U;A,\star)\end{aligned}}{\rRI{11,18}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Produktabschluss der positiven Potenzen]{%
    ...
    \proofstepwidestar[7,8]{m+n\neq0}{%
      \FormulaRefAuto{PeanoAddNonzeroLeft}[thm]{9,12,10}}
    \proofstepwidestarbreak[1,2,7,8]{a^{m+n}=a^m\star a^n}{%
      \FormulaRefAuto{SemigroupPowerAdditionLaw}[thm]{1,2,9,12,10,13}}
    \proofstepwidestar[1,2,7,8]{x\star y=a^{m+n}}{\rIE{11,14,17}}
    \proofstepwidestarbreak[1,2,7,8]{x\star y\in A}{%
      \rIE{18,\FormulaRefAuto{SemigroupPowerClosure}[thm]{1,2,15,16}}}
    \proofstepwidestarbreak[1,2,7,8]{%
      x\star y\in A\land
      \exists k\in\mathbb N\,(k\neq0\land x\star y=a^k)}{%
      \rAI{19,\rEI{15,\rAI{16,18}}}}
    \proofstepwidestarbreak[1,2,7,8]{x\star y\in P_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPositivePowerSetMembership}[thm]{1,2,20}}
...
\SemigroupAlg{A}{\star}\dsep a\in A\dsep k\in\mathbb N\dsep k\neq0\vdash a^k\in\langle a\rangle_{A,\star}
  ...
  \proofstepwidestar[1,2]{a\in\langle\{a\}\rangle_{A,\star}}{\FormulaRefAuto{GeneratedSubsemigroupContainsGenerators}[thm]{1,5,6,\FormulaRefAuto{a\in\{a\}}[thm]}}
  \proofstepwidestar[1,2]{a\in\langle a\rangle_{A,\star}}{\rIE{\FormulaRefAuto{SemigroupMonogenicSubsemigroupDef}[def]{1,2},7}}
  \proofstepwidestar[1,2]{a^1\in\langle a\rangle_{A,\star}}{\rIE{\FormulaRefAuto{SemigroupPowerOne}[thm]{1,2},8}}
  ...
  \proofstepwidestar[11]{j\in\mathbb N}{\rA}
  \proofstepwidestar[12]{j\neq0}{\rA}
  \proofstepwidestar[13]{a^j\in\langle a\rangle_{A,\star}}{\rA}
  \proofstepwidestar[1,2,11,12]{a^{j+1}=a^j\star a}{\FormulaRefAuto{SemigroupPowerSuccessor}[thm]{1,2,11,12}}
  \proofstepwidestar[1,2,13]{a^j\star a\in\langle a\rangle_{A,\star}}{\FormulaRefAuto{SemigroupSubsemigroupClosureAxiom}[ax]{1,10,13,8}}
  \proofstepwidestar[1,2,11,12,13]{a^{j+1}\in\langle a\rangle_{A,\star}}{\rIE{14,15}}
  ...
  \proofstepwidestar[1,2,5]{a^n\in\langle a\rangle_{A,\star}}{\FormulaRefAuto{SemigroupPowerInMonogenicSubsemigroup}[thm]{1,2,6,7}}
  \proofstepwidestar[1,2,5]{x\in\langle a\rangle_{A,\star}}{\rIE{8,9}}
  \proofstepwidestar[1,2,3]{x\in\langle a\rangle_{A,\star}}{\rEE{4,5,10}}
  \proofstepwidestar[1,2]{P_{A,\star}(a)\subseteq\langle a\rangle_{A,\star}}{\FormulaRefAuto{A\subseteq B\coloneq\forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{3,11}}}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{L_{A,\star}(a)\neq\varnothing}{%
    \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{4}}
  \proofstepwidestarbreak[6]{s\in A}{\rA}
  \proofstepwidestarbreak[7]{b\in L_{A,\star}(a)}{\rA}
  \proofstepwidestarbreak[1,2,7]{b\in A}{%
    \rAEa{\FormulaRefAuto{SemigroupPrincipalLeftIdealMembership}[thm]{1,2,7}}}
  \proofstepwidestarbreak[1,2,6,7]{s\star b\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,6,8}}
  \proofstepwidestarbreak[1,2,7]{b=a\lor\exists x\in A\,(b=x\star a)}{%
    \rAEb{\FormulaRefAuto{SemigroupPrincipalLeftIdealMembership}[thm]{1,2,7}}}
  \proofstepwidestarbreak[11]{b=a}{\rA}
  \proofstepwidestarbreak[6,11]{s\star b=s\star a}{\rIE{11}}
  \proofstepwidestarbreak[6,11]{\exists u\in A\,(s\star b=u\star a)}{%
    \rEI{6,12}}
  \proofstepwidestarbreak[1,2,6,7,11]{s\star b\in L_{A,\star}(a)}{%
    \FormulaRefAuto{SemigroupPrincipalLeftIdealMembership}[thm]{%
      1,2,\rAI{9,\rOIb{13}}}}
  \proofstepwidestarbreak[15]{\exists x\in A\,(b=x\star a)}{\rA}
  \proofstepwidestarbreak[16]{x\in A\land b=x\star a}{\rA}
  \proofstepwidestarbreak[16]{x\in A}{\rAEa{16}}
  \proofstepwidestarbreak[16]{b=x\star a}{\rAEb{16}}
  \proofstepwidestarbreak[1,6,16]{s\star x\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,6,17}}
  \proofstepwidestarbreak[1,2,6,16]{s\star b=(s\star x)\star a}{%
    \rIE{18,\FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,6,17,2}}}
  \proofstepwidestarbreak[1,2,6,16]{%
    \exists u\in A\,(s\star b=u\star a)}{\rEI{19,20}}
  \proofstepwidestarbreak[1,2,6,7,16]{s\star b\in L_{A,\star}(a)}{%
    \FormulaRefAuto{SemigroupPrincipalLeftIdealMembership}[thm]{%
      1,2,\rAI{9,\rOIb{21}}}}
  \proofstepwidestarbreak[1,2,6,7,15]{s\star b\in L_{A,\star}(a)}{%
    \rEE{15,16,22}}
  \proofstepwidestarbreak[1,2,6,7]{s\star b\in L_{A,\star}(a)}{%
    \rOE{10,11,14,15,23}}
  \proofstepwidestarbreak[1,2]{%
  ...
  \proofstepwidestarbreak[1,2]{\mathsf{LId}(L_{A,\star}(a);A,\star)}{%
    \FormulaRefAuto{SemigroupLeftIdealCriterion}[thm]{1,\rAI{3,\rAI{5,25}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{R_{A,\star}(a)\neq\varnothing}{%
    \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{4}}
  \proofstepwidestarbreak[6]{b\in R_{A,\star}(a)}{\rA}
  \proofstepwidestarbreak[7]{s\in A}{\rA}
  \proofstepwidestarbreak[1,2,6]{b\in A}{%
    \rAEa{\FormulaRefAuto{SemigroupPrincipalRightIdealMembership}[thm]{1,2,6}}}
  \proofstepwidestarbreak[1,2,6,7]{b\star s\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,8,7}}
  \proofstepwidestarbreak[1,2,6]{b=a\lor\exists y\in A\,(b=a\star y)}{%
    \rAEb{\FormulaRefAuto{SemigroupPrincipalRightIdealMembership}[thm]{1,2,6}}}
  \proofstepwidestarbreak[11]{b=a}{\rA}
  \proofstepwidestarbreak[7,11]{b\star s=a\star s}{\rIE{11}}
  \proofstepwidestarbreak[7,11]{\exists u\in A\,(b\star s=a\star u)}{\rEI{7,12}}
  \proofstepwidestarbreak[1,2,6,7,11]{b\star s\in R_{A,\star}(a)}{%
    \FormulaRefAuto{SemigroupPrincipalRightIdealMembership}[thm]{%
      1,2,\rAI{9,\rOIb{13}}}}
  \proofstepwidestarbreak[15]{\exists y\in A\,(b=a\star y)}{\rA}
  \proofstepwidestarbreak[16]{y\in A\land b=a\star y}{\rA}
  \proofstepwidestarbreak[16]{y\in A}{\rAEa{16}}
  \proofstepwidestarbreak[16]{b=a\star y}{\rAEb{16}}
  \proofstepwidestarbreak[1,7,16]{y\star s\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,17,7}}
  \proofstepwidestarbreak[1,2,7,16]{b\star s=a\star(y\star s)}{%
    \rIE{18,\FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,2,17,7}}}
  \proofstepwidestarbreak[1,2,7,16]{\exists u\in A\,(b\star s=a\star u)}{\rEI{19,20}}
  \proofstepwidestarbreak[1,2,6,7,16]{b\star s\in R_{A,\star}(a)}{%
    \FormulaRefAuto{SemigroupPrincipalRightIdealMembership}[thm]{%
      1,2,\rAI{9,\rOIb{21}}}}
  \proofstepwidestarbreak[1,2,6,7,15]{b\star s\in R_{A,\star}(a)}{\rEE{15,16,22}}
  \proofstepwidestarbreak[1,2,6,7]{b\star s\in R_{A,\star}(a)}{%
    \rOE{10,11,14,15,23}}
  \proofstepwidestarbreak[1,2]{%
  ...
  \proofstepwidestarbreak[1,2]{\mathsf{RId}(R_{A,\star}(a);A,\star)}{%
    \FormulaRefAuto{SemigroupRightIdealCriterion}[thm]{1,\rAI{3,\rAI{5,25}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,3]{%
    ...
    \rAEb{\rAEb{\FormulaRefAuto{SemigroupLeftIdealCriterion}[thm]{1,3}}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,3]{%
    ...
    \rAEb{\rAEb{\FormulaRefAuto{SemigroupRightIdealCriterion}[thm]{1,3}}}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Linksidealeigenschaft]{%
    ...
    \proofstepwidestarbreak[1,2]{J_{A,\star}(a)\neq\varnothing}{%
      \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{4}}
    \proofstepwidestarbreak[6]{s\in A}{%
      \rA}
    ...
    \proofstepwidestarbreak[11]{b=a}{%
      \rA}
    \proofstepwidestarbreak[6,11]{s\star b=s\star a}{%
      \FormulaRefAuto{BinaryFunctionRightArgumentCongruence}[thm]{11}}
    \proofstepwidestarbreak[6,11]{\exists u\in A\,(s\star b=u\star a)}{%
      \rEI{6,12}}
    \proofstepwidestarbreak[1,2,6,7,11]{s\star b\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIa{13}}}}}
    \proofstepwidestarbreak[15]{\exists x\in A\,(b=x\star a)}{%
      \rA}
    \proofstepwidestarbreak[16]{x\in A\land b=x\star a}{%
      \rA}
    \proofstepwidestarbreak[16]{x\in A}{%
      \rAEa{16}}
    \proofstepwidestarbreak[16]{b=x\star a}{%
      \rAEb{16}}
    \proofstepwidestarbreak[1,6,16]{s\star x\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,6,17}}
    \proofstepwidestarbreak[6,16]{s\star b=s\star(x\star a)}{%
      \FormulaRefAuto{BinaryFunctionRightArgumentCongruence}[thm]{18}}
    \proofstepwidestarbreak[1,2,6,16]{s\star(x\star a)=(s\star x)\star a}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,6,17,2}}
    \proofstepwidestarbreak[1,2,6,16]{s\star b=(s\star x)\star a}{%
      \rIE{21,20}}
    \proofstepwidestarbreak[1,2,6,16]{\exists u\in A\,(s\star b=u\star a)}{%
      \rEI{19,22}}
    \proofstepwidestarbreak[1,2,6,7,16]{s\star b\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIa{23}}}}}
    ...
    \proofstepwidestarbreak[26]{b=a\star y}{%
      \rAEb{26}}
    \proofstepwidestarbreak[6,26]{s\star b=s\star(a\star y)}{%
      \FormulaRefAuto{BinaryFunctionRightArgumentCongruence}[thm]{28}}
    \proofstepwidestarbreak[1,2,6,26]{s\star(a\star y)=(s\star a)\star y}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,6,2,27}}
    \proofstepwidestarbreak[1,2,6,26]{s\star b=(s\star a)\star y}{%
      \rIE{30,29}}
    \proofstepwidestarbreak[1,2,6,26]{%
      \exists u,v\in A\,(s\star b=(u\star a)\star v)}{%
      \rEI{6,\rEI{27,31}}}
    \proofstepwidestarbreak[1,2,6,7,26]{s\star b\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIb{32}}}}}}
    \proofstepwidestarbreak[34]{\exists x,y\in A\,(b=(x\star a)\star y)}{%
      \rA}
    \proofstepwidestarbreak[35]{x\in A\land(y\in A\land b=(x\star a)\star y)}{%
      \rA}
    \proofstepwidestarbreak[35]{x\in A}{%
      \rAEa{35}}
    \proofstepwidestarbreak[35]{y\in A}{%
      \rAEa{\rAEb{35}}}
    \proofstepwidestarbreak[35]{b=(x\star a)\star y}{%
      \rAEb{\rAEb{35}}}
    \proofstepwidestarbreak[1,6,35]{s\star x\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,6,36}}
    \proofstepwidestarbreak[1,2,35]{x\star a\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,36,2}}
    \proofstepwidestarbreak[6,35]{s\star b=s\star((x\star a)\star y)}{%
      \FormulaRefAuto{BinaryFunctionRightArgumentCongruence}[thm]{38}}
    \proofstepwidestarbreak[1,2,6,35]{s\star((x\star a)\star y)=(s\star(x\star a))\star y}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,6,40,37}}
    \proofstepwidestarbreak[1,2,6,35]{s\star(x\star a)=(s\star x)\star a}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,6,36,2}}
    \proofstepwidestarbreak[1,2,6,35]{%
      s\star b=((s\star x)\star a)\star y}{%
      \rIE{42,43,41}}
    \proofstepwidestarbreak[1,2,6,35]{%
      \exists u,v\in A\,(s\star b=(u\star a)\star v)}{%
      \rEI{39,\rEI{37,44}}}
    \proofstepwidestarbreak[1,2,6,7,35]{s\star b\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIb{45}}}}}}
    \proofstepwidestarbreak[1,2,6,7,34]{s\star b\in J_{A,\star}(a)}{%
      \rEE{34,35,46}}
    \proofstepwidestarbreak[1,2,6,7,25]{s\star b\in J_{A,\star}(a)}{%
      \rEE{25,26,33}}
    \proofstepwidestarbreak[1,2,6,7,15]{s\star b\in J_{A,\star}(a)}{%
      \rEE{15,16,24}}
    ...
    \proofstepwidestarbreak[51]{\begin{aligned}[t]
      ...
      \end{aligned}}{%
      \rA}
    \proofstepwidestarbreak[1,2,6,7,51]{s\star b\in J_{A,\star}(a)}{%
      \rOE{51,25,48,34,47}}
    \proofstepwidestarbreak[1,2,6,7,50]{s\star b\in J_{A,\star}(a)}{%
      \rOE{50,15,49,51,52}}
    \proofstepwidestarbreak[1,2,6,7]{s\star b\in J_{A,\star}(a)}{%
      \rOE{10,11,14,50,53}}
    \proofstepwidestarbreak[1,2]{%
      \forall s\in A\,\forall b\in J_{A,\star}(a)\,
      (s\star b\in J_{A,\star}(a))}{%
      \rUI{\rRI{6,\rUI{\rRI{7,54}}}}}
    \proofstepwidestarbreak[1,2]{\mathsf{LId}(J_{A,\star}(a);A,\star)}{%
      \FormulaRefAuto{SemigroupLeftIdealCriterion}[thm]{1,\rAI{3,\rAI{5,55}}}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Rechtsidealeigenschaft]{%
    ...
    \proofstepwidestarbreak[1,2]{J_{A,\star}(a)\neq\varnothing}{%
      \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{4}}
    \proofstepwidestarbreak[6]{b\in J_{A,\star}(a)}{%
      \rA}
    ...
    \proofstepwidestarbreak[11]{b=a}{%
      \rA}
    \proofstepwidestarbreak[7,11]{b\star s=a\star s}{%
      \FormulaRefAuto{BinaryFunctionLeftArgumentCongruence}[thm]{11}}
    \proofstepwidestarbreak[7,11]{\exists v\in A\,(b\star s=a\star v)}{%
      \rEI{7,12}}
    \proofstepwidestarbreak[1,2,6,7,11]{b\star s\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIa{13}}}}}}
    \proofstepwidestarbreak[15]{\exists x\in A\,(b=x\star a)}{%
      \rA}
    \proofstepwidestarbreak[16]{x\in A\land b=x\star a}{%
      \rA}
    ...
    \proofstepwidestarbreak[16]{b=x\star a}{%
      \rAEb{16}}
    \proofstepwidestarbreak[1,2,7,16]{b\star s=(x\star a)\star s}{%
      \FormulaRefAuto{BinaryFunctionLeftArgumentCongruence}[thm]{18}}
    \proofstepwidestarbreak[1,2,7,16]{%
      \exists u,v\in A\,(b\star s=(u\star a)\star v)}{%
      \rEI{17,\rEI{7,19}}}
    \proofstepwidestarbreak[1,2,6,7,16]{b\star s\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIb{20}}}}}}
    \proofstepwidestarbreak[22]{\exists y\in A\,(b=a\star y)}{%
      \rA}
    \proofstepwidestarbreak[23]{y\in A\land b=a\star y}{%
      \rA}
    \proofstepwidestarbreak[23]{y\in A}{%
      \rAEa{23}}
    \proofstepwidestarbreak[23]{b=a\star y}{%
      \rAEb{23}}
    \proofstepwidestarbreak[1,7,23]{y\star s\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,24,7}}
    \proofstepwidestarbreak[7,23]{b\star s=(a\star y)\star s}{%
      \FormulaRefAuto{BinaryFunctionLeftArgumentCongruence}[thm]{25}}
    \proofstepwidestarbreak[1,2,7,23]{b\star s=a\star(y\star s)}{%
      \rIE{\FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,2,24,7},27}}
    \proofstepwidestarbreak[1,2,7,23]{\exists v\in A\,(b\star s=a\star v)}{%
      \rEI{26,28}}
    \proofstepwidestarbreak[1,2,6,7,23]{b\star s\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIa{29}}}}}}
    \proofstepwidestarbreak[31]{\exists x,y\in A\,(b=(x\star a)\star y)}{%
      \rA}
    \proofstepwidestarbreak[32]{x\in A\land(y\in A\land b=(x\star a)\star y)}{%
      \rA}
    \proofstepwidestarbreak[32]{x\in A}{%
      \rAEa{32}}
    \proofstepwidestarbreak[32]{y\in A}{%
      \rAEa{\rAEb{32}}}
    \proofstepwidestarbreak[32]{b=(x\star a)\star y}{%
      \rAEb{\rAEb{32}}}
    \proofstepwidestarbreak[1,7,32]{y\star s\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,34,7}}
    \proofstepwidestarbreak[1,2,32]{x\star a\in A}{%
      \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,33,2}}
    \proofstepwidestarbreak[7,32]{b\star s=((x\star a)\star y)\star s}{%
      \FormulaRefAuto{BinaryFunctionLeftArgumentCongruence}[thm]{35}}
    \proofstepwidestarbreak[1,2,7,32]{((x\star a)\star y)\star s=(x\star a)\star(y\star s)}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,37,34,7}}
    \proofstepwidestarbreak[1,2,7,32]{b\star s=(x\star a)\star(y\star s)}{%
      \rIE{39,38}}
    \proofstepwidestarbreak[1,2,7,32]{%
      \exists u,v\in A\,(b\star s=(u\star a)\star v)}{%
      \rEI{33,\rEI{36,40}}}
    \proofstepwidestarbreak[1,2,6,7,32]{b\star s\in J_{A,\star}(a)}{%
      \FormulaRefAuto{SemigroupPrincipalTwoSidedIdealMembership}[thm]{%
        1,2,\rAI{9,\rOIb{\rOIb{\rOIb{41}}}}}}
    \proofstepwidestarbreak[1,2,6,7,31]{b\star s\in J_{A,\star}(a)}{%
      \rEE{31,32,42}}
    \proofstepwidestarbreak[1,2,6,7,22]{b\star s\in J_{A,\star}(a)}{%
      \rEE{22,23,30}}
    \proofstepwidestarbreak[1,2,6,7,15]{b\star s\in J_{A,\star}(a)}{%
      \rEE{15,16,21}}
    \proofstepwidestarbreak[46]{\begin{aligned}[t]
        &\exists x\in A\,(b=x\star a)\\[-2pt]
        &{}\lor\exists y\in A\,(b=a\star y)\\[-2pt]
        &{}\lor\exists x,y\in A\,(b=(x\star a)\star y)
      \end{aligned}}{%
      \rA}
    \proofstepwidestarbreak[47]{\begin{aligned}[t]
        &\exists y\in A\,(b=a\star y)\\[-2pt]
        &{}\lor\exists x,y\in A\,(b=(x\star a)\star y)
      \end{aligned}}{%
      \rA}
    \proofstepwidestarbreak[1,2,6,7,47]{b\star s\in J_{A,\star}(a)}{%
      \rOE{47,22,44,31,43}}
    \proofstepwidestarbreak[1,2,6,7,46]{b\star s\in J_{A,\star}(a)}{%
      \rOE{46,15,45,47,48}}
    \proofstepwidestarbreak[1,2,6,7]{b\star s\in J_{A,\star}(a)}{%
      \rOE{10,11,14,46,49}}
    \proofstepwidestarbreak[1,2]{%
      \forall b\in J_{A,\star}(a)\,\forall s\in A\,
      (b\star s\in J_{A,\star}(a))}{%
      \rUI{\rRI{6,\rUI{\rRI{7,50}}}}}
    \proofstepwidestarbreak[1,2]{\mathsf{RId}(J_{A,\star}(a);A,\star)}{%
      \FormulaRefAuto{SemigroupRightIdealCriterion}[thm]{1,\rAI{3,\rAI{5,51}}}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{A\in\PowNE{A}}{%
    \FormulaRefAuto{NonemptyPowersetMembership}[thm]{%
      \rAI{\FormulaRefAuto{A\subseteq A}[thm],\allowbreak 1}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[2]{A\in\PowNE{A}}{%
    \FormulaRefAuto{NonemptyPowersetMembership}[thm]{%
      \rAI{\FormulaRefAuto{A\subseteq A}[thm],\allowbreak 2}}}
  ...
  \proofstepwidestarbreakkeep[1,2]{%
    ...
    \bigl(z\in A\land\exists a\in A\,\exists b\in A\,
      (z=a\star b)\bigr)}{%
    \rIE{4,\allowbreak \FormulaRefAuto{PowerSemigroupProductMembership}[thm]{1,\allowbreak 3,\allowbreak 3}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3]{%
    ...
    \rAEb{\FormulaRefAuto{SemigroupSquareMembership}[thm]{1,\allowbreak 2,\allowbreak 3}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3]{z\in A}{%
    \rAEa{\FormulaRefAuto{SemigroupSquareMembership}[thm]{1,\allowbreak 2,\allowbreak 3}}}
  \proofstepwidestarbreakkeep[1,2]{A^2\subseteq A}{%
    \FormulaRefAuto{A\subseteq B\coloneq
      \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{3,\allowbreak 4}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2]{A^2\neq\varnothing}{%
    \rIE{\FormulaRefAuto{SemigroupSquareDef}[def]{1,\allowbreak 2},\allowbreak %
      \FormulaRefAuto{PowerSemigroupProductNonempty}[thm]{1,\allowbreak 4,\allowbreak 4}}}
  \proofstepwidestarbreakkeep[6]{x,y\in A^2}{\rA}
  \proofstepwidestarbreakkeep[1,2,6]{x,y\in A}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{3,\allowbreak 6}}
  \proofstepwidestarbreakkeep[1,2,6]{x\star y\in A^2}{%
    \FormulaRefAuto{SemigroupSquareProductMember}[thm]{1,\allowbreak 2,\allowbreak 7}}
  \proofstepwidestarbreakkeep[1,2]{\mathsf{UHGr}(A^2;A,\star)}{%
    \FormulaRefAuto{SemigroupSubsemigroupDef}[def]{1,\allowbreak 3,\allowbreak 5,\allowbreak 8}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[2]{\PowNE{A}\neq\varnothing}{%
    \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{4}}
  \proofstepwidestarbreakkeep[6]{Z\in\PowNE{A}^{\,2}}{\rA}
  \proofstepwidestarbreakkeep[1,2,6]{%
    \exists X\in\PowNE{A}\,\exists Y\in\PowNE{A}\,
      (Z=X\star_{\mathcal P}Y)}{%
    \FormulaRefAuto{SemigroupSquareWitnesses}[thm]{3,\allowbreak 5,\allowbreak 6}}
  \proofstepwidestarbreakkeep[8]{X,Y\in\PowNE{A}\land Z=X\star_{\mathcal P}Y}{\rA}
  \proofstepwidestarbreakkeep[9]{z\in Z}{\rA}
  \proofstepwidestarbreakkeep[1,8,9]{%
    \exists a\in X\,\exists b\in Y\,(z=a\star b)}{%
    \FormulaRefAuto{PowerSemigroupProductWitnesses}[thm]{1,\allowbreak 8,\allowbreak \rIE{8,\allowbreak 9}}}
  \proofstepwidestarbreakkeep[11]{a\in X\land b\in Y\land z=a\star b}{\rA}
  \proofstepwidestarbreakkeep[8,11]{a,b\in A}{%
    \FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{8,\allowbreak 11}}
  \proofstepwidestarbreakkeep[1,2,8,11]{z\in A^2}{%
    \rIE{11,\allowbreak \FormulaRefAuto{SemigroupSquareProductMember}[thm]{1,\allowbreak 2,\allowbreak 12}}}
  \proofstepwidestarbreakkeep[1,2,8,9]{z\in A^2}{\rEEStar{10,\allowbreak 11\text{--}13}}
  \proofstepwidestarbreakkeep[1,2,8]{Z\subseteq A^2}{%
    \FormulaRefAuto{A\subseteq B\coloneq
      \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{9,\allowbreak 14}}}}
  \proofstepwidestarbreakkeep[1,8]{Z\neq\varnothing}{%
    \rIE{8,\allowbreak \FormulaRefAuto{PowerSemigroupProductNonempty}[thm]{1,\allowbreak 8}}}
  \proofstepwidestarbreakkeep[1,2,8]{Z\in\PowNE{A^2}}{%
    \FormulaRefAuto{NonemptyPowersetMembership}[thm]{\rAI{15,\allowbreak 16}}}
  \proofstepwidestarbreakkeep[1,2,6]{Z\in\PowNE{A^2}}{\rEEStar{7,\allowbreak 8\text{--}17}}
  \proofstepwidestarbreakkeep[1,2]{\PowNE{A}^{\,2}\subseteq\PowNE{A^2}}{%
    \FormulaRefAuto{A\subseteq B\coloneq
      \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{6,\allowbreak 18}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[2]{\PowNE{A}\neq\varnothing}{%
    \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{5}}
  \proofstepwidestarbreakkeep[7]{\{a\}\in\PowNE{A}^{\,2}}{\rA}
  \proofstepwidestarbreakkeep[1,2,7]{\{a\}\in\PowNE{A^2}}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{%
      \FormulaRefAuto{PowerSemigroupSquareSubset}[thm]{1,\allowbreak 2},\allowbreak 7}}
  \proofstepwidestarbreakkeep[1,2,7]{a\in A^2}{%
    \FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{8,\allowbreak \FormulaRefAuto{a\in\{a\}}[thm]}}
  \proofstepwidestarbreakkeep[1,2]{\{a\}\in\PowNE{A}^{\,2}\rightarrow a\in A^2}{\rRI{7,\allowbreak 9}}
  \proofstepwidestarbreakkeep[11]{a\in A^2}{\rA}
  \proofstepwidestarbreakkeep[1,2,11]{\exists x\in A\,\exists y\in A\,(a=x\star y)}{%
    \FormulaRefAuto{SemigroupSquareWitnesses}[thm]{1,\allowbreak 2,\allowbreak 11}}
  \proofstepwidestarbreakkeep[13]{x,y\in A\land a=x\star y}{\rA}
  ...
  \proofstepwidestarbreakkeep[1,13]{\{a\}=\{x\}\star_{\mathcal P}\{y\}}{%
    \rIE{13,\allowbreak \FormulaRefAuto{SemigroupSingletonCopyDef}[def]{1},\allowbreak %
      \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{14,\allowbreak 13}}}
  \proofstepwidestarbreakkeep[13]{\{x\},\{y\}\in\PowNE{A}}{%
    \FormulaRefAuto{NonemptyPowersetMembership}[thm]{%
      \FormulaRefAuto{a\in A\vdash\{a\}\subseteq A}[thm]{13},\allowbreak %
      \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{%
        \FormulaRefAuto{a\in\{a\}}[thm]}}}
  \proofstepwidestarbreakkeep[1,2,13]{\{a\}\in\PowNE{A}^{\,2}}{%
    \rIE{15,\allowbreak \FormulaRefAuto{SemigroupSquareProductMember}[thm]{4,\allowbreak 6,\allowbreak 16}}}
  \proofstepwidestarbreakkeep[1,2,11]{\{a\}\in\PowNE{A}^{\,2}}{\rEEStar{12,\allowbreak 13\text{--}17}}
  \proofstepwidestarbreakkeep[1,2]{a\in A^2\rightarrow\{a\}\in\PowNE{A}^{\,2}}{\rRI{11,\allowbreak 18}}
  \proofstepwidestarbreakkeep[1,2,3]{\{a\}\in\PowNE{A}^{\,2}\leftrightarrow a\in A^2}{\rLRI{10,\allowbreak 19}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{\SemigroupAlg{A}{\star}\land\SemigroupAlg{B}{\diamond}}{%
    \rAI{\FormulaRefAuto{SemigroupHomSourceAxiom}[ax]{4},\allowbreak %
  ...
  \proofstepwidestarbreakkeep[1,2,3]{F[A^2]=F[A\star_{\mathcal P}A]}{%
    \rIE{\FormulaRefAuto{SemigroupSquareDef}[def]{5,\allowbreak 2}}}
  \proofstepwidestarbreakkeep[1,2,3]{\phantom{F[A^2]}=F[A]\diamond_{\mathcal P}F[A]}{%
    \FormulaRefAuto{SemigroupHomPreservesPowerProduct}[thm]{4,\allowbreak 7,\allowbreak 7}}
  \proofstepwidestarbreakkeep[1,2,3]{\phantom{F[A^2]}=B\diamond_{\mathcal P}B}{\rIE{6}}
  \proofstepwidestarbreakkeep[1,2,3]{\phantom{F[A^2]}=B^2}{%
    \FormulaRefAuto{SemigroupSquareDef}[def]{5,\allowbreak 3}}
  \proofstepwidestarbreakkeep[1,2,3]{F[A^2]=B^2}{\rChain{8,\allowbreak 11}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,4]{F\restriction_U\colon U\inj B}{%
    \FormulaRefAuto{F\colon A\inj B\dsep C\subseteq A \vdash F\restriction_C\colon C\inj B}[thm]{7,\allowbreak 4}}
  ...
  \proofstepwidestarbreakkeep[1,4]{(F\restriction_U)[U]=F[U]}{%
    \FormulaRefAuto{C\subseteq A \dsep F\colon A\to B \vdash (F\restriction_C)[C]=F[C]}[thm]{4,\allowbreak 7}}
  \proofstepwidestarbreakkeep[1,4,6]{F\restriction_U\colon U\bij V}{\rIE{6,\allowbreak 10,\allowbreak 9}}
  \proofstepwidestarbreakkeep[12]{x,y\in U}{\rA}
  \proofstepwidestarbreakkeep[4,12]{x,y\in A}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{4,\allowbreak 12}}
  \proofstepwidestarbreakkeep[2,12]{x\star y\in U}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{2,\allowbreak 12}}
  \proofstepwidestarbreakkeep[1,2,4,12]{(F\restriction_U)(x\star y)=F(x\star y)}{%
    \FormulaRefAuto{C\subseteq A \dsep x\in C \vdash F\restriction_C(x)=F(x)}[thm]{7,\allowbreak 4,\allowbreak 14}}
  \proofstepwidestarbreakkeep[1,2,4,12]{\phantom{(F\restriction_U)(x\star y)}=F(x)\diamond F(y)}{%
    \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{1},\allowbreak 13}}
  \proofstepwidestarbreakkeep[1,2,4,12]{\phantom{(F\restriction_U)(x\star y)}=(F\restriction_U)(x)\diamond(F\restriction_U)(y)}{%
    \rIE{\FormulaRefAuto{C\subseteq A \dsep x\in C \vdash F\restriction_C(x)=F(x)}[thm]{7,\allowbreak 4,\allowbreak 12}}}
  \proofstepwidestarbreakkeep[1,2,4,12]{%
    (F\restriction_U)(x\star y)=(F\restriction_U)(x)\diamond(F\restriction_U)(y)}{\rChain{15,\allowbreak 17}}
  \proofstepwidestarbreakkeep[1,2,3,4,6]{\SemigroupHom{F\restriction_U}{U,\star}{V,\diamond}}{%
    \FormulaRefAuto{SemigroupHomDef}[def]{2,\allowbreak 3,\allowbreak %
      \FormulaRefAuto{Bijektive Funktion}[def]{11},\allowbreak 18}}
  \proofstepwidestarbreakkeep[1,2,3,4,5,6]{\SemigroupIso{F\restriction_U}{U,\star}{V,\diamond}}{%
    \FormulaRefAuto{SemigroupIsoDef}[def]{19,\allowbreak 11}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[3]{B\neq\varnothing}{\rA}
  \proofstepwidestarbreakkeep[1]{\SemigroupAlg{A}{\star}\land\SemigroupAlg{B}{\diamond}}{%
    \rAI{\FormulaRefAuto{SemigroupHomSourceAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{1}},\allowbreak %
      \FormulaRefAuto{SemigroupHomTargetAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{1}}}}
  \proofstepwidestarbreakkeep[1,2]{\SemigroupAlg{A^2}{\star}}{%
    \FormulaRefAuto{SubsemigroupFormsSemigroup}[thm]{4,\allowbreak %
      \FormulaRefAuto{SemigroupSquareIsSubsemigroup}[thm]{4,\allowbreak 2}}}
  \proofstepwidestarbreakkeep[1,3]{\SemigroupAlg{B^2}{\diamond}}{%
    \FormulaRefAuto{SubsemigroupFormsSemigroup}[thm]{4,\allowbreak %
      \FormulaRefAuto{SemigroupSquareIsSubsemigroup}[thm]{4,\allowbreak 3}}}
  \proofstepwidestarbreakkeep[1,2,3]{\SemigroupIso{F\restriction_{A^2}}{A^2,\star}{B^2,\diamond}}{%
    \FormulaRefAuto{SemigroupIsoRestrictionToImage}[thm]{1,\allowbreak 5,\allowbreak 6,\allowbreak %
      \FormulaRefAuto{SemigroupSquareSubset}[thm]{4,\allowbreak 2},\allowbreak %
      \FormulaRefAuto{SemigroupSquareSubset}[thm]{4,\allowbreak 3},\allowbreak %
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[6]{x\in A}{\rA}
  \proofstepwidestarbreakkeep[1,2,6]{F(a\star x)=F(a)\diamond F(x)}{%
    \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{1},\allowbreak 2,\allowbreak 6}}
  \proofstepwidestarbreakkeep[1,2,6]{a\star x\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{4,\allowbreak 2,\allowbreak 6}}
  \proofstepwidestarbreakkeep[9]{a\star x=b}{\rA}
  \proofstepwidestarbreakkeep[1,2,6,9]{F(a)\diamond F(x)=F(b)}{\rIE{9,\allowbreak 7}}
  \proofstepwidestarbreakkeep[1,2,6]{a\star x=b\rightarrow F(a)\diamond F(x)=F(b)}{\rRI{9,\allowbreak 10}}
  \proofstepwidestarbreakkeep[12]{F(a)\diamond F(x)=F(b)}{\rA}
  \proofstepwidestarbreakkeep[1,2,6,12]{F(a\star x)=F(b)}{\rChain{7,\allowbreak 12}}
  \proofstepwidestarbreakkeep[1,2,6,12]{a\star x=b}{%
    \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep
      F(x)=F(y)\vdash x=y}[ax]{%
      \FormulaRefAuto{F\colon A\bij B\vdash F\colon A\inj B}[thm]{3},\allowbreak 8,\allowbreak 2,\allowbreak 13}}
  \proofstepwidestarbreakkeep[1,2,6]{F(a)\diamond F(x)=F(b)\rightarrow a\star x=b}{\rRI{12,\allowbreak 14}}
  \proofstepwidestarbreakkeep[1,2,6]{a\star x=b\leftrightarrow F(a)\diamond F(x)=F(b)}{\rLRI{11,\allowbreak 15}}
  \proofstepwidestarbreakkeep[1,6]{F(x)\in B}{%
    \FormulaRefAuto{F\colon A\bij B\dsep x\in A\vdash F(x)\in B}[thm]{3,\allowbreak 6}}
  \proofstepwidestarbreakkeep[1,2,6]{x\in L_A(a,b)\leftrightarrow a\star x=b}{%
    \FormulaRefAuto{x\in\{u\in A\mid P(u)\}\eqvdash x\in A\land P(x)}[thm]{%
      \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{4,\allowbreak 2},\allowbreak 6}}
  \proofstepwidestarbreakkeep[1,2,6]{F(x)\in L_B(F(a),F(b))
    \leftrightarrow F(a)\diamond F(x)=F(b)}{%
    \FormulaRefAuto{x\in\{u\in A\mid P(u)\}\eqvdash x\in A\land P(x)}[thm]{%
      \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{4,\allowbreak 5},\allowbreak 17}}
  \proofstepwidestarbreakkeep[1,2]{\forall x\in A\,
    (x\in L_A(a,b)\leftrightarrow F(x)\in L_B(F(a),F(b)))}{%
    \rUI{\rRI{6,\allowbreak \rChain{18,\allowbreak 16,\allowbreak 19}}}}
  \proofstepwidestarbreakkeep[1,2]{L_A(a,b)\subseteq A\land
    L_B(F(a),F(b))\subseteq B}{%
    \rAI{\FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}[thm]{%
      \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{4,\allowbreak 2}},\allowbreak %
      \FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}[thm]{%
      \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{4,\allowbreak 5}}}}
  \proofstepwidestarbreakkeep[1,2]{F\restriction_{L_A(a,b)}\colon
    L_A(a,b)\bij L_B(F(a),F(b))}{%
    \FormulaRefAuto{BijectiveRestrictionIffPointwiseCompatibility}[thm]{3,\allowbreak 21,\allowbreak 20}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[4]{X\in\PowNE{A}}{%
    \rIE{4,\allowbreak \FormulaRefAuto{NonemptyPowersetMembership}[thm]{\rAI{5,\allowbreak 6}}}}
  \proofstepwidestarbreakkeep[1,2]{X\in\PowNE{A}}{\rEE{3,\allowbreak 4,\allowbreak 7}}
  \proofstepwidestarbreakkeep[1]{\operatorname{Sing}(A)\subseteq\PowNE{A}}{%
    \FormulaRefAuto{A\subseteq B\coloneq
      \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{2,\allowbreak 8}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4]{\SemigroupIso{R}
    ...
    \FormulaRefAuto{SemigroupIsoRestrictionToImage}[thm]{3,\allowbreak %
      \FormulaRefAuto{SemigroupHomTargetAxiom}[ax]{%
        \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{5}},\allowbreak %
      \FormulaRefAuto{SemigroupHomTargetAxiom}[ax]{%
        \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{6}},\allowbreak %
      \FormulaRefAuto{SemigroupSingletonCopySubset}[thm]{1},\allowbreak %
      \FormulaRefAuto{SemigroupSingletonCopySubset}[thm]{2},\allowbreak 4}}
  \proofstepwidestarbreakkeep[1,2,3,4]{R\circ\eta_A\colon A\bij\operatorname{Sing}(B)}{%
    \FormulaRefAuto{SemigroupIsoBijectiveAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoComposition}[thm]{5,\allowbreak 7}}}
  ...
  \proofstepwidestarbreakkeep[2]{\eta_B^{-1}\colon\operatorname{Sing}(B)\bij B}{%
    \FormulaRefAuto{F\colon A\bij B\vdash F^{-1}\colon B\bij A}[thm]{9}}
  \proofstepwidestarbreakkeep[1,2,3,4]{f\colon A\bij B}{%
    \FormulaRefAuto{F\colon A\bij B\dsep G\colon B\bij C\vdash
      G\circ F\colon A\bij C}[thm]{8,\allowbreak 10}}
  \proofstepwidestarbreakkeep[12]{a\in A}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{f(a)\in B}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      \FormulaRefAuto{Bijektive Funktion}[def]{11},\allowbreak 12}}
  \proofstepwidestarbreakkeep[1,12]{\{a\}\in\operatorname{Sing}(A)}{%
    \FormulaRefAuto{SemigroupSingletonCopyDef}[def]{1,\allowbreak 12}}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{F(\{a\})\in\operatorname{Sing}(B)}{%
    \rIE{4,\allowbreak \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep
      x\in C\vdash F(x)\in F[C]}[thm]{%
      \FormulaRefAuto{SemigroupSingletonCopySubset}[thm]{1},\allowbreak %
      \FormulaRefAuto{Bijektive Funktion}[def]{%
        \FormulaRefAuto{SemigroupIsoBijectiveAxiom}[ax]{3}},\allowbreak 14}}}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{f(a)=\eta_B^{-1}(F(\{a\}))}{%
    \FormulaRefAuto{x\in A\vdash(F\circ G)(x)=F(G(x))}[thm]{8,\allowbreak 10,\allowbreak 12},\allowbreak %
    \FormulaRefAuto{RestrictionDef}[def]{14},\allowbreak %
    \FormulaRefAuto{SemigroupSingletonCopyDef}[def]{1,\allowbreak 12}}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{\{f(a)\}=\eta_B(f(a))}{%
    \FormulaRefAuto{SemigroupSingletonCopyDef}[def]{2,\allowbreak 13}}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{\phantom{\{f(a)\}}=\eta_B(\eta_B^{-1}(F(\{a\})))}{\rIE{16}}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{\phantom{\{f(a)\}}=F(\{a\})}{%
    \FormulaRefAuto{F\colon A\bij B\dsep y\in B\vdash F(F^{-1}(y))=y}[thm]{9,\allowbreak 15}}
  \proofstepwidestarbreakkeep[1,2,3,4]{\forall a\in A\,(F(\{a\})=\{f(a)\})}{%
    \rUI{\rRI{12,\allowbreak \FormulaRefAuto{a=b\vdash b=a}[thm]{\rChain{17,\allowbreak 19}}}}}
  \proofstepwidestarbreakkeep[21]{a,b\in A}{\rA}
  \proofstepwidestarbreakkeep[1,21]{a\star b\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{1,\allowbreak 21}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{f(a),f(b)\in B}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      \FormulaRefAuto{Bijektive Funktion}[def]{11},\allowbreak 21}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{\{f(a\star b)\}=F(\{a\star b\})}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{\rRE{22,\allowbreak \rUE{20}}}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{\phantom{\{f(a\star b)\}}=F(\{a\}\star_{\mathcal P}\{b\})}{%
    \rIE{\FormulaRefAuto{SemigroupSingletonCopyDef}[def]{1},\allowbreak %
      \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
        \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{5},\allowbreak 21}}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{\phantom{\{f(a\star b)\}}=F(\{a\})\diamond_{\mathcal P}F(\{b\})}{%
    \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{3},\allowbreak %
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{%
        \FormulaRefAuto{SemigroupSingletonCopySubset}[thm]{1},\allowbreak %
        \FormulaRefAuto{SemigroupSingletonCopyDef}[def]{1,\allowbreak 21}}}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{\phantom{\{f(a\star b)\}}=\{f(a)\}\diamond_{\mathcal P}\{f(b)\}}{%
    \rIE{\rRE{21,\allowbreak \rUE{20}}}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{\phantom{\{f(a\star b)\}}=\{f(a)\diamond f(b)\}}{%
    \rIE{\FormulaRefAuto{SemigroupSingletonCopyDef}[def]{2},\allowbreak %
      \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
        \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{6},\allowbreak 23}}}
  \proofstepwidestarbreakkeep[1,2,3,4,21]{f(a\star b)=f(a)\diamond f(b)}{%
    \FormulaRefAuto{\{a\}=\{b\}\eqvdash a=b}[thm]{\rChain{24,\allowbreak 28}}}
  \proofstepwidestarbreakkeep[1,2,3,4]{\SemigroupIso{f}{A,\star}{B,\diamond}}{%
    \FormulaRefAuto{SemigroupIsoDef}[def]{%
      \FormulaRefAuto{SemigroupHomDef}[def]{1,\allowbreak 2,\allowbreak %
        \FormulaRefAuto{Bijektive Funktion}[def]{11},\allowbreak 29},\allowbreak 11}}
  \proofstepwidestarbreakkeep[1,2,3,4]{\exists f\,\Bigl(
    \begin{aligned}[t]
      &\SemigroupIso{f}{A,\star}{B,\diamond}\land{}\\[-2pt]
      &\forall a\in A\,(F(\{a\})=\{f(a)\})
    \end{aligned}\Bigr)}{\rEI{\rAI{30,\allowbreak 20}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,3,9,12]{\phantom{f(x\star y)}=\varphi(r(x))\diamond\varphi(r(y))}{%
    \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]{%
      \FormulaRefAuto{SemigroupIsoHomAxiom}[ax]{3},\allowbreak 13}}
  \proofstepwidestarbreakkeep[1,3,9,12]{\phantom{f(x\star y)}=s(f(x))\diamond s(f(y))}{\rIE{\rRE{12,\allowbreak \rUE{18}}}}
  \proofstepwidestarbreakkeep[1,2,3,9,12]{\phantom{f(x\star y)}=f(x)\diamond f(y)}{%
    \FormulaRefAuto{SemigroupInflationDef}[def]{2,\allowbreak 14}}
  \proofstepwidestarbreakkeep[1,2,3,9,12]{f(x\star y)=f(x)\diamond f(y)}{\rChain{19,\allowbreak 23}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\SemigroupHom{f}{S,\star}{T,\diamond}}{%
    \FormulaRefAuto{SemigroupHomDef}[def]{10,\allowbreak 11,\allowbreak %
      \FormulaRefAuto{Bijektive Funktion}[def]{\rAEa{9}},\allowbreak 24}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\SemigroupIso{f}{S,\star}{T,\diamond}}{%
    \FormulaRefAuto{SemigroupIsoDef}[def]{25,\allowbreak \rAEa{9}}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\exists f\,\SemigroupIso{f}{S,\star}{T,\diamond}}{\rEI{26}}
  \proofstepwidestarbreakkeep[1,2,3,4]{\exists f\,\SemigroupIso{f}{S,\star}{T,\diamond}}{\rEE{8,\allowbreak 9,\allowbreak 27}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechte Mengenprodukte]{%
    ...
    \proofstepwidestarbreak[1,2,3,4,8,12]{x\diamond z=y\diamond z}{%
      \rAEa{\FormulaRefAuto{SemigroupTranslationIndistinguishableActions}[thm]{%
        1,15,16,14,17}}}
    \proofstepwidestarbreak[1,2,3,4,8,12]{w=y\diamond z}{\rChain{11,18}}
    ...
    \proofstepwidestarbreak[1,2,3,4,27,31]{y\diamond z=x\diamond z}{%
      \rAEa{\FormulaRefAuto{SemigroupTranslationIndistinguishableActions}[thm]{%
        1,34,35,33,36}}}
    \proofstepwidestarbreak[1,2,3,4,27,31]{w=x\diamond z}{\rChain{30,37}}
  ...
  \proofpartwideindR[Linke Mengenprodukte]{%
    ...
    \proofstepwidestarbreak[1,2,3,4,8,12]{z\diamond x=z\diamond y}{%
      \rAEb{\FormulaRefAuto{SemigroupTranslationIndistinguishableActions}[thm]{%
        1,15,16,14,17}}}
    \proofstepwidestarbreak[1,2,3,4,8,12]{w=z\diamond y}{\rChain{11,18}}
    \proofstepwidestarbreak[1,3,4,8,12]{%
    ...
    \proofstepwidestarbreak[1,2,3,4,27,31]{z\diamond y=z\diamond x}{%
      \rAEb{\FormulaRefAuto{SemigroupTranslationIndistinguishableActions}[thm]{%
        1,34,35,33,36}}}
    \proofstepwidestarbreak[1,2,3,4,27,31]{w=z\diamond x}{\rChain{30,37}}
    \proofstepwidestarbreak[1,2,4,27,31]{%
...
\FormulaRefAuto{ProtectedPowerSetExtensionBijective}[thm] sind somit erfüllt, und
...
\FormulaRefAuto{LayerPowerMapEvaluation}[thm] folgt daher unmittelbar
\[
  \Phi(X)=(X\cap A_*)\cup\eta(X\cap D).
\]
...
\RenewCommandCopy\proofstepwidestar\BXXVIIIOriginalProofStepWideStar
