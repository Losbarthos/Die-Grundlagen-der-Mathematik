...
\proofpartwide{Träger und vorbereitende Wortgleichungen}
  \proofstepwidestar[1]{\SemigroupAlg{A}{\star}}{\rA}
  \proofstepwidestar[2]{u\in\NonemptyWords{A}}{\rA}
...
\closeproofpartwide
\proofpartwide{Induktionsrechnung und Schluss}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{u\in\NonemptyWords{A}}{\rA}
  \proofstepwidestar[3]{a\in A}{\rA}
  \proofstepwidestar[1,2,3]{\WordFold{\star}{\WordConcat{u}{\LetterWord{a}}}=\WordFold{\star}{u}\star\WordFold{\star}{\LetterWord{a}}}{\FormulaRefAuto{SemigroupWordBlockBase}[thm]{1,2,3}}
  \proofstepwidestar[1,2]{\begin{aligned}[t]&\forall a\in A\;\bigl(\\[-2pt]&\WordFold{\star}{\WordConcat{u}{\LetterWord{a}}}=\WordFold{\star}{u}\star\WordFold{\star}{\LetterWord{a}}\bigr)\end{aligned}}{\rUI{\rRI{3,4}}}
  \proofstepwidestar[6]{w\in\NonemptyWords{A}}{\rA}
  \proofstepwidestar[7]{b\in A}{\rA}
  \proofstepwidestar[8]{\WordFold{\star}{\WordConcat{u}{w}}=\WordFold{\star}{u}\star\WordFold{\star}{w}}{\rA}
  \proofstepwidestar[1,2,6,7,8]{\begin{aligned}[t]&\WordFold{\star}{\WordConcat{u}{\WordConcat{w}{\LetterWord{b}}}}\\[-2pt]&\quad=\WordFold{\star}{u}\star\WordFold{\star}{\WordConcat{w}{\LetterWord{b}}}\end{aligned}}{\FormulaRefAuto{SemigroupWordBlockStep}[thm]{1,2,6,7,8}}
  \proofstepwidestar[1,2]{\begin{aligned}[t]&\forall w\in\NonemptyWords{A}\;\forall b\in A\;\bigl(\\[-2pt]&\WordFold{\star}{\WordConcat{u}{w}}=\WordFold{\star}{u}\star\WordFold{\star}{w}\rightarrow\\[-2pt]&\WordFold{\star}{\WordConcat{u}{\WordConcat{w}{\LetterWord{b}}}}\\[-2pt]&\quad=\WordFold{\star}{u}\star\WordFold{\star}{\WordConcat{w}{\LetterWord{b}}}\bigr)\end{aligned}}{\rUI{\rRI{6,\rUI{\rRI{7,\rRI{8,9}}}}}}
  \proofstepwidestar[1,2]{\begin{aligned}[t]&\forall w\in\NonemptyWords{A}\;\bigl(\\[-2pt]&\WordFold{\star}{\WordConcat{u}{w}}=\WordFold{\star}{u}\star\WordFold{\star}{w}\bigr)\end{aligned}}{\FormulaRefAuto{NonemptyWordInduction}[thm]{5,10}}
  \proofstepwidestar[12]{v\in\NonemptyWords{A}}{\rA}
  \proofstepwidestar[1,2,12]{\WordFold{\star}{\WordConcat{u}{v}}=\WordFold{\star}{u}\star\WordFold{\star}{v}}{\rRE{12,\rUE{11}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  \proofstepwidestar[1]{\SemigroupAlg{A}{\star}}{\rA}
  \proofstepwidestar[2]{a\in A}{\rA}
  \proofstepwidestar[1,2]{\TreeEvaluation{\star}{\LeafTree{A}{a}}=\WordFold{\star}{\TreeLeafWord{A}{\LeafTree{A}{a}}}}{\FormulaRefAuto{SemigroupTreeNormalFormLeaf}[thm]{1,2}}
  \proofstepwidestar[1]{\begin{aligned}[t]&\forall a\in A\;\bigl(\\[-2pt]&\TreeEvaluation{\star}{\LeafTree{A}{a}}=\WordFold{\star}{\TreeLeafWord{A}{\LeafTree{A}{a}}}\bigr)\end{aligned}}{\rUI{\rRI{2,3}}}
  \proofstepwidestar[5]{S\in\BracketTreeSet{A}}{\rA}
  \proofstepwidestar[6]{T\in\BracketTreeSet{A}}{\rA}
  \proofstepwidestar[7]{\begin{aligned}[t]&\TreeEvaluation{\star}{S}=\WordFold{\star}{\TreeLeafWord{A}{S}}\land\\[-2pt]&\TreeEvaluation{\star}{T}=\WordFold{\star}{\TreeLeafWord{A}{T}}\end{aligned}}{\rA}
  \proofstepwidestar[7]{\TreeEvaluation{\star}{S}=\WordFold{\star}{\TreeLeafWord{A}{S}}}{\rAEa{7}}
  \proofstepwidestar[7]{\TreeEvaluation{\star}{T}=\WordFold{\star}{\TreeLeafWord{A}{T}}}{\rAEb{7}}
  \proofstepwidestar[1,5,6,7]{\begin{aligned}[t]&\TreeEvaluation{\star}{\NodeTree{A}{S}{T}}\\[-2pt]&\quad=\WordFold{\star}{\TreeLeafWord{A}{\NodeTree{A}{S}{T}}}\end{aligned}}{\FormulaRefAuto{SemigroupTreeNormalFormNode}[thm]{1,5,6,8,9}}
  \proofstepwidestar[1]{\begin{aligned}[t]&\forall S,T\in\BracketTreeSet{A}\;\bigl(\\[-2pt]&\TreeEvaluation{\star}{S}=\WordFold{\star}{\TreeLeafWord{A}{S}}\land\\[-2pt]&\TreeEvaluation{\star}{T}=\WordFold{\star}{\TreeLeafWord{A}{T}}\rightarrow\\[-2pt]&\TreeEvaluation{\star}{\NodeTree{A}{S}{T}}\\[-2pt]&\quad=\WordFold{\star}{\TreeLeafWord{A}{\NodeTree{A}{S}{T}}}\bigr)\end{aligned}}{\rUI{\rRI{5,\rUI{\rRI{6,\rRI{7,10}}}}}}
  \proofstepwidestar[1]{\begin{aligned}[t]&\forall R\in\BracketTreeSet{A}\;\bigl(\\[-2pt]&\TreeEvaluation{\star}{R}=\WordFold{\star}{\TreeLeafWord{A}{R}}\bigr)\end{aligned}}{\FormulaRefAuto{FullPlanarBinaryTreeStructuralInduction}[thm]{4,11}}
  \proofstepwidestar[13]{T\in\BracketTreeSet{A}}{\rA}
  \proofstepwidestar[1,13]{\TreeEvaluation{\star}{T}=\WordFold{\star}{\TreeLeafWord{A}{T}}}{\rRE{13,\rUE{12}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3,4]{w=\TreeLeafWord{A}{T}}{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{10}}
  \proofstepwide[1,2,3,4]{\WordFold{\star}{w}}{=}{%
    \WordFold{\star}{\TreeLeafWord{A}{T}}}{%
    \rIE{13}}
  \proofstepwidestar[1,2,3,4]{\TreeEvaluation{\star}{T}=\WordFold{\star}{\TreeLeafWord{A}{T}}}{%
      \FormulaRefAuto{SemigroupTreeNormalForm}[thm]{1,9}}
  \proofstepwide[1,2,3,4]{\WordFold{\star}{\TreeLeafWord{A}{T}}}{=}{\TreeEvaluation{\star}{T}}{%
...
\closeproofpartwideindR
  ...
  \proofstepwidestar[1,2,3,4,5]{\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=x\star(y\star z))}{\FormulaRefAuto{PowerSemigroupTripleWitnessAssociativityForward}[thm]{1,2,3,4,5}}
  \proofstepwidestar[1,2,3,4]{\begin{aligned}[t]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=(x\star y)\star z)\rightarrow\\[-2pt]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=x\star(y\star z))\end{aligned}}{\rRI{5,6}}
  \proofstepwidestar[8]{\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=x\star(y\star z))}{\rA}
  \proofstepwidestar[1,2,3,4,8]{\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=(x\star y)\star z)}{\FormulaRefAuto{PowerSemigroupTripleWitnessAssociativityBackward}[thm]{1,2,3,4,8}}
  \proofstepwidestar[1,2,3,4]{\begin{aligned}[t]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=x\star(y\star z))\rightarrow\\[-2pt]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=(x\star y)\star z)\end{aligned}}{\rRI{8,9}}
  \proofstepwidestar[1,2,3,4]{\begin{aligned}[t]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=(x\star y)\star z)\leftrightarrow\\[-2pt]&\exists x\in X\,\exists y\in Y\,\exists z\in Z\;(w=x\star(y\star z))\end{aligned}}{\rLRI{7,10}}
\closeproofpartwideindR
...
\input{tex/B28-isomorphism-examples.tex}
