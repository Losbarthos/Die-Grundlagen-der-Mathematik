...
\FormulaThmDeltaK[Additionsschritt der Einbettung]{%
  \begin{aligned}[t]
    &\SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}\dsep n\in\mathbb N\vdash{}\\[-2pt]
    &\eta_R(n+1)=\eta_R(n)\oplus1_R
  \end{aligned}%
}{NaturalSemiringMapAddOne}{%
  \DeltaRow{Mengen}{R\dsep0_R\dsep1_R\dsep n}
  \DeltaRow{Funktionen}{\oplus\dsep\odot\dsep\eta_R}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{\SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}}{\rA}
  \proofstepwidestar[2]{n\in\mathbb N}{\rA}
  \proofstepwidestar[2]{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwide[2]{\eta_R(n+1)}{=}{\eta_R(\Succ(n))}{\rIE{3}}
  \proofstepwide[1,2]{}{=}{\eta_R(n)\oplus1_R}{%
    \FormulaRefAuto{NaturalSemiringMapSuccessor}[thm]{1,2}}
  \proofstepwidestar[1,2]{\eta_R(n+1)=\eta_R(n)\oplus1_R}{\rChain{4,5}}
\end{tabproofwide}
