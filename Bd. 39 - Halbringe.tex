...
\ifSubfilesClassLoaded{
  \BandSetupStandalone{B39}
}{
}

\title{Bd. 39 - Halbringe}
\author{Martin Kunze}
\date{}
\setcounter{file}{39}

\hypersetup{
  pdftitle={Bd. 39 - Halbringe},
...
\begin{tabproofsplitwide}
  \proofpartwide{Additiver Monoidanteil}
  \proofstepwidestar[1]{%
    \SemiringHom{f}{R,\oplus,\odot,0_R,1_R}
...
\FormulaDefDeltaK[Homomorphismen kommutativer Halbringe]{%
  \CommutativeSemiringHom{f}{R,\oplus,\odot,0_R,1_R}{S,\boxplus,\boxtimes,0_S,1_S}%
}{CommutativeSemiringHomDef}{%
  \DeltaRow{Mengen}{R\dsep S\dsep0_R\dsep1_R\dsep0_S\dsep1_S}
  \DeltaRow{Funktionen}{f\dsep\oplus\dsep\odot\dsep\boxplus\dsep\boxtimes}
  \DeltaRow{\textbf{Axiome}}{}
  \DeltaPrem{Quellstruktur}{\CommutativeSemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}}
  \DeltaPrem{Zielstruktur}{\CommutativeSemiringAlg{S}{\boxplus}{\boxtimes}{0_S}{1_S}}
  \DeltaPrem{Homomorphismus}{\SemiringHom{f}{R,\oplus,\odot,0_R,1_R}{S,\boxplus,\boxtimes,0_S,1_S}}
  \DeltaRow{\textbf{Neues Symbol}}{}
  \DeltaPrem{Homomorphismus}{\CommutativeSemiringHom{f}{R,\oplus,\odot,0_R,1_R}{S,\boxplus,\boxtimes,0_S,1_S}}
}
...
\FormulaDefDeltaK[Isomorphismen kommutativer Halbringe]{%
  \CommutativeSemiringIso{f}{R,\oplus,\odot,0_R,1_R}{S,\boxplus,\boxtimes,0_S,1_S}%
  ...
  \DeltaPrem{Bijektivität}{f\colon R\bij S}
  \DeltaRow{\textbf{Neues Symbol}}{}
  \DeltaPrem{Isomorphismus}{\CommutativeSemiringIso{f}{R,\oplus,\odot,0_R,1_R}{S,\boxplus,\boxtimes,0_S,1_S}}
}
...
\FormulaDefDeltaK[Nachfolgerabbildung eines Halbrings]{%
  \SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}\vdash
  \begin{aligned}[t]
    &\SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R,\\[-2pt]
    &\forall x\in R\,
      \bigl(
  ...
  \DeltaRow{Funktionen}{\oplus\dsep\odot\dsep
...
\begin{tabproof}
  ...
  \proofstep{1}{\forall x\in R\,x\oplus1_R\in R}{%
    \rUI{\rRI{7,8}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{%
    \FormulaRefAuto{SemiringSuccessorDef}[def]{1}}
\end{tabproof}
...
\FormulaDefDeltaK[Kanonische Abbildung in einen Halbring]{%
  ...
  \DeltaRow{Rekursionssatz}{}[%
    \FormulaRefAuto{DedekindRecursionTheoremAddOne}[thm]]
  \DeltaRow{\textbf{Neues Symbol}}{}
...
\FormulaThmDeltaK[Additionsschritt der kanonischen Abbildung]{%
  \begin{aligned}[t]
    &\SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}\dsep n\in\mathbb N\\
    &\vdash
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n+1)
      =
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)\oplus1_R
  \end{aligned}
}{NaturalSemiringMapAddOne}{%
  \DeltaRow{Mengen}{R\dsep0_R\dsep1_R\dsep n}
  \DeltaRow{Funktionen}{\oplus\dsep\odot}
}
\begin{notation*}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    \forall x\in R\,s_R(x)=x\oplus1_R}{%
    \FormulaRefAuto{SemiringSuccessorDef}[def]{1}}

  \proofstepwide[1,2]{\eta_R(n+1)}{=}{%
    \RecFun{0_R}{s_R}(n+1)}{\rIE{5}}
  \proofstepwide[1,2]{}{=}{%
    s_R\!\left(\RecFun{0_R}{s_R}(n)\right)}{%
    \FormulaRefAuto{PeanoRecursionAddOne}{3,4,2}}
  \proofstepwide[1,2]{}{=}{s_R\!\left(\eta_R(n)\right)}{\rIE{8}}
  \proofstepwide[1,2]{}{=}{\eta_R(n)\oplus1_R}{%
    \rRE{\rUE{9},7}}
  \proofstepwidestar[1,2]{%
    \eta_R(n+1)=\eta_R(n)\oplus1_R}{%
    \rChain{10,11,12,13}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{0+1=1}{%
      \FormulaRefAuto{PeanoAddLeftZero}[thm]{\rAEb{4}}}
  ...
  \proofstepwidestar[1]{\MonoidAlg{R}{\oplus}{0_R}}{%
    \FormulaRefAuto{CommutativeMonoidBaseMonoidAxiom}[ax]{8}}
  ...
  \proofstepwide[1]{%
    ...
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(0+1)}{\rIE{6}}
  \proofstepwide[1]{}{=}{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(0)\oplus1_R}{%
    \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,\rAEa{4}}}
  \proofstepwide[1]{}{=}{0_R\oplus1_R}{\rIE{7}}
  \proofstepwide[1]{}{=}{1_R}{%
    \FormulaRefAuto{MonoidLeftIdentityAxiom}[ax]{9,11}}
  \proofstepwidestar[1]{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(1)=1_R}{%
    \rChain{12,13,14,15}}
\end{tabproofwide}
...
\FormulaThmDeltaK[Induktionsschritt der Additionserhaltung]{%
  \begin{aligned}[t]
    ...
    &\vdash
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(m+(n+1))
      =
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(m)
      \oplus
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n+1)
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Gleichheitskette des Nachfolgerschritts]{%
    ...
    \proofstepwidestar[1,3]{\eta_R(n+1)=\eta_R(n)\oplus1_R}{%
      \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,3}}
    \proofstepwidestar[1,3]{\eta_R(n)\oplus1_R=\eta_R(n+1)}{%
      \FormulaRefAuto{a=b\vdash b=a}{7}}
    \proofstepwide[2,3]{\eta_R(m+(n+1))}{=}{\eta_R((m+n)+1)}{%
      \FormulaRefAuto{PeanoAddAddOneRight}[thm]{2,3}}
    \proofstepwide[1,2,3]{}{=}{\eta_R(m+n)\oplus1_R}{%
      \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,5}}
    \proofstepwide[1,2,3,4]{}{=}{%
      \bigl(\eta_R(m)\oplus\eta_R(n)\bigr)\oplus1_R}{\rIE{4}}
    \proofstepwide[1,2,3]{}{=}{%
      \eta_R(m)\oplus\bigl(\eta_R(n)\oplus1_R\bigr)}{\rIE{6}}
    \proofstepwide[1,2,3]{}{=}{\eta_R(m)\oplus\eta_R(n+1)}{\rIE{8}}
...
\FormulaThmDeltaK[Induktionsschritt der Multiplikationserhaltung]{%
  \begin{aligned}[t]
    &\SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}\dsep m,n\in\mathbb N\dsep{}\\[-2pt]
    &\NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(m\cdot n)
      ...
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)\\
    &\vdash
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(m\cdot(n+1))
      =
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(m)
      \odot
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n+1)
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Nachfolgerdarstellung von \(y\)]{%
    ...
    \proofstepwidestar[1]{%
      \SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}}{\rA}
    \proofstepwidestar[2]{n\in\mathbb N}{\rA}
    \proofstepwidestar[1,2]{\eta_R(n+1)=y\oplus1_R}{%
      \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,2}}
    \proofstepwidestar[1,2]{y\oplus1_R=\eta_R(n+1)}{%
  ...
  \proofpartwide{Gleichheitskette}
    ...
    \proofstepwidestar[1,3]{y\oplus1_R=\eta_R(n+1)}{%
      \FormulaRefAuto{NaturalSemiringMapMultiplicationStepSuccessor}[thm]{1,3}}
    \proofstepwide[2,3]{\eta_R(m\cdot(n+1))}{=}{\eta_R(m\cdot n+m)}{%
      \FormulaRefAuto{PeanoMulAddOneRight}[thm]{2,3}}
    ...
    \proofstepwide[1,2,3,4]{}{=}{x\odot\eta_R(n+1)}{\rIE{8}}
    \proofstepwidestar[1,2,3,4]{%
      \eta_R(m\cdot(n+1))=x\odot\eta_R(n+1)}{%
      \rChain{9,14}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,5,6]{%
    \eta_R(m\cdot(k+1))=\eta_R(m)\odot\eta_R(k+1)}{%
...
\begin{tabproofsplitwide}
  \proofpartwide{Funktionstypisierung und Additionserhaltung}
    \proofstepwidestar[1]{%
      \SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}}{\rA}
    ...
    \proofstepwidestar[1,8,9]{%
      \eta_R(m+n)=\eta_R(m)\oplus\eta_R(n)}{%
      \FormulaRefAuto{NaturalSemiringMapAddition}[thm]{1,8,9}}
    \proofstepwidestar[1]{%
      \SemigroupHom{\eta_R}{\mathbb N,+}{R,\oplus}}{%
      \FormulaRefAuto{SemigroupHomDef}[def]{5,6,7,10}}
  \closeproofpartwide

  \proofpartwide{Nullerhaltung und Monoidanteil}
  \setcounter{proofstepnr}{11}
    \proofstepwidestar[1]{\eta_R(0)=0_R}{%
      \FormulaRefAuto{NaturalSemiringMapZero}[thm]{1}}
    \proofstepwidestar[1]{%
      \MonoidHom{\eta_R}{\mathbb N,+,0}{R,\oplus,0_R}}{%
      \FormulaRefAuto{MonoidHomDef}[def]{2,4,11,12}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Funktionstypisierung und Multiplikationserhaltung}
    \proofstepwidestar[1]{%
      \SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}}{\rA}
    \proofstepwidestar[]{\MonoidAlg{\mathbb N}{\cdot}{1}}{%
  ...
  \proofpartwide{Einserhaltung und Monoidanteil}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      ...
      &f(n)=\eta_R(n)\vdash f(n+1)=\eta_R(n+1)
    \end{aligned}
  }{%
    \begin{aligned}[t]
      &\SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}\dsep
    ...
    \proofstepwidestar[2]{f(0)=0_R\land f(1)=1_R}{%
      \FormulaRefAuto{SemiringHomConstantsAxiom}[ax]{2}}
    \proofstepwidestar[2]{f(1)=1_R}{%
      \rAEb{6}}
    \proofstepwidestar[1,3]{\eta_R(n+1)=\eta_R(n)\oplus1_R}{%
      \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,3}}
    \proofstepwide[2,3]{f(n+1)}{=}{f(n)\oplus f(1)}{%
      \FormulaRefAuto{SemiringHomAdditionAxiom}[ax]{2,3,5}}
    \proofstepwide[2,3,4]{}{=}{\eta_R(n)\oplus1_R}{\rIE{4,7}}
    \proofstepwide[1,2,3,4]{}{=}{\eta_R(n+1)}{%
      \FormulaRefAuto{a=b\vdash b=a}{8}}
    \proofstepwidestar[1,2,3,4]{f(n+1)=\eta_R(n+1)}{\rChain{9,11}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2,5,6]{f(k+1)=\eta_R(k+1)}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,3]{%
    ...
    \FormulaRefAuto{FunctionExtensionality}[thm]{4,5,8}}
  \proofstepwidestar[1]{%
    \exists! f\,
    \SemiringHom{f}{\mathbb N,+,\cdot,0,1}
      {R,\oplus,\odot,0_R,1_R}}{%
...
\FormulaThmDeltaK[Vertauschen der Eins]{%
  n\in\mathbb{N}\vdash1+n=(n+1)%
}{NaturalOnePlusCommutative}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{1+n=(n+1)}{%
    \FormulaRefAuto{NaturalOnePlusCommutative}{2}}
  \proofstepwide[2]{n+1}{=}{1+n}{%
    \FormulaRefAuto{a=b\vdash b=a}{4}}
  \proofstepwide[2,3]{}{=}{0}{\rIE{3}}
  \proofstepwidestar[2,3]{(n+1)=0}{\rChain{5,6}}
  \proofstepwidestar[2]{(n+1)\neq0}{%
    \FormulaRefAuto{PeanoAddOneNonzero}[thm]{2}}
  \proofstepwidestar[2,3]{\bot}{\rBI{8,7}}
