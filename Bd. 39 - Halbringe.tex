...
\begin{tabproofwide}
  ...
  \proofstepwide[1,2]{\eta_R(n+1)}{=}{%
    \RecFun{0_R}{s_R}(n+1)}{\quad\rIE{5}}
  \proofstepwide[1,2]{}{=}{%
    s_R\!\left(\RecFun{0_R}{s_R}(n)\right)}{%
    \quad\FormulaRefAuto{PeanoRecursionAddOne}{3,4,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{1=0+1}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{%
      \FormulaRefAuto{PeanoAddLeftZero}[thm]{\rAEb{2}}}}
  \proofstepwidestar[1]{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(0)=0_R}{%
  ...
  \proofstepwide[1]{%
    ...
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(0+1)}{\rIE{3}}
  \proofstepwide[1]{}{=}{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(0)\oplus1_R}{%
    \quad\FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,\rAEa{2}}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[2]{f(1)=1_R}{%
      \rAEb{\FormulaRefAuto{SemiringHomConstantsAxiom}[ax]{2}}}
    \proofstepwidestar[1,3]{\eta_R(n+1)=\eta_R(n)\oplus1_R}{%
      \FormulaRefAuto{NaturalSemiringMapAddOne}[thm]{1,3}}
    \proofstepwide[2,3]{f(n+1)}{=}{f(n)\oplus f(1)}{%
      \FormulaRefAuto{SemiringHomAdditionAxiom}[ax]{2,3,5}}
    \proofstepwide[2,3,4]{}{=}{\eta_R(n)\oplus1_R}{\rIE{4,6}}
    \proofstepwide[1,2,3,4]{}{=}{\eta_R(n+1)}{%
      \FormulaRefAuto{a=b\vdash b=a}{7}}
    \proofstepwidestar[1,2,3,4]{f(n+1)=\eta_R(n+1)}{\rChain{8,10}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{1+n=n+1}{%
    \quad\FormulaRefAuto{PeanoAddCommutative}[thm]{2,1}}
\end{tabproofwide}
