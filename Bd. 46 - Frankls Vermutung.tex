%============================================================
%  Bd. 46 - Frankls Vermutung
%============================================================

\documentclass[main.tex]{subfiles}

\ifSubfilesClassLoaded{
  \BandSetupStandalone{B46}
}{
}

\title{Bd. 46 - Frankls Vermutung}
\author{Martin Kunze}
\date{}
\setcounter{file}{46}

\hypersetup{
  pdftitle={Bd. 46 - Frankls Vermutung},
...
\begin{tabproofsplitwide}
  ...
  \(M\setminus\FamAvoiding{M}{a}\subseteq\FamContaining{M}{a}\)]{%
    ...
    \proofstepwidestar{%
      M\setminus\FamAvoiding{M}{a}\subseteq\FamContaining{M}{a}}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[1]\vdots 11}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{X\cup\{a,b\}\in M}{%
    \FormulaRefAuto{Vereinigungsabgeschlossene Familie}{1,6,2}}
  ...
  \proofstep{}{b\in X\cup\{a,b\}}{%
    \FormulaRefAuto{z \in B \vdash z \in A \cup B}{9}}
  \proofstep{1,2,3}{X\cup\{a,b\}\in\FamContaining{M}{a}}{%
    \FormulaRefAuto{\FamContaining{M}{a}\coloneqq
      \{X\in M\mid a\in X\}}{\rAI{7,10}}}
  \proofstep{1,2,3}{X\cup\{a,b\}\in\FamContaining{M}{b}}{%
    \FormulaRefAuto{\FamContaining{M}{a}\coloneqq
      \{X\in M\mid a\in X\}}{\rAI{7,11}}}
...
\begin{tabproof}
  ...
  \proofstep{4}{X\in M\land a\notin X}{%
      \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq
      \{X\in M\mid a\notin X\}}{7}}
  \proofstep{4}{a\notin X}{%
    \rAEb{11}}
  \proofstep{4}{X\in M\land b\notin X}{%
      \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq
      \{X\in M\mid a\notin X\}}{8}}
  \proofstep{4}{b\notin X}{%
    \rAEb{13}}
  \proofstep{5}{Y\in M\land a\notin Y}{%
      \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq
      \{X\in M\mid a\notin X\}}{9}}
  \proofstep{5}{a\notin Y}{%
    \rAEb{15}}
  \proofstep{5}{Y\in M\land b\notin Y}{%
      \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq
      \{X\in M\mid a\notin X\}}{10}}
  \proofstep{5}{b\notin Y}{%
    \rAEb{17}}
  \proofstep{4}{X\cap\{a,b\}=\varnothing}{%
    \FormulaRefAuto{PairSetDisjointFromTwoAvoided}{12,14}}
  \proofstep{5}{Y\cap\{a,b\}=\varnothing}{%
    \FormulaRefAuto{PairSetDisjointFromTwoAvoided}{16,18}}
  ...
  \proofstep{1,2,4,6}{X\cup\{a,b\}=U(Y)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{23,6}}
  \proofstep{1,2,4,5,6}{X\cup\{a,b\}=Y\cup\{a,b\}}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{24,22}}
  \proofstep{1,2,4,5,6}{X=Y}{%
    \FormulaRefAuto{UnionCancelDisjointRight}{19,20,25}}
  \proofstep{1,2}{U\colon\mathcal A\inj\mathcal B}{%
    \ProofRefStack{%
      \FormulaRefAuto{Injektive Funktion}\\
      \bigl(3,\rUI{\rRI{4,\rRI{5,\rRI{6,26}}}}\bigr)}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{\FamAvoiding{M}{a}=\mathcal A_{00}\cup\mathcal A_{01}}{%
      \FormulaRefAuto{FranklPairAvoidADecomp}}
  \proofstep{}{\mathcal A_{00}\cup\mathcal A_{01}
    =\FamAvoiding{M}{a}}{%
    \FormulaRefAuto{a=b\vdash b=a}{11}}
  \proofstep{}{\FamContaining{M}{a}=\mathcal A_{11}\cup\mathcal A_{10}}{%
      \FormulaRefAuto{FranklPairContainADecomp}}
  ...
  \proofstep{3,10}{\Frankl{M}}{%
    \ProofRefStack{%
      ...
      \FormulaRefAuto{\HalfOcc{a}{M}\coloneqq
        a\in\bigcup M\land
        \exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}\\
      \bigl(\rEI{\rAI{3,\rEI{15}}}\bigr)}}
  \proofstep{1,2,3,6}{\Frankl{M}}{\rEE{9,10,16}}
  \proofstep{1,2,3,4}{\Frankl{M}}{\rEE{4,6,17}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{\OccQuotCarrier{M}\subseteq\OccQuotCarrier{M}}{%
  ...
  \proofstep{1}{\Finite{\TraceMap{\OccQuotMap{M}}[\OccQuotCarrier{M}]}}{%
    \FormulaRefAuto{FiniteSubset}[thm]{7,2}}
  \proofstep{}{{\TraceMap{\OccQuotMap{M}}}^{-1}\colon
    \TraceMap{\OccQuotMap{M}}[\OccQuotCarrier{M}]
    \bij\OccQuotCarrier{M}}{%
    \FormulaRefAuto{InverseFunctionBijection}{4}}
...
\begin{tabproof}
  ...
  \proofstep{}{\FamAvoiding{\OccQuotFam{M}}{C}\subseteq
    \OccQuotFam{M}}{%
    \FormulaRefAuto{\FamAvoiding{M}{a}\subseteq M}}
  \proofstep{1,2}{\OccQuotMap{M}\restriction_{(\OccQuotMap{M})^{-1}[\FamAvoiding{\OccQuotFam{M}}C]}\colon (\OccQuotMap{M})^{-1}[\FamAvoiding{\OccQuotFam{M}}C]\bij \FamAvoiding{\OccQuotFam{M}}C}{%
      \FormulaRefAuto{F\colon A\bij B \dsep T\subseteq B \vdash F\restriction_{F^{-1}[T]}\colon F^{-1}[T]\bij T}{4,5}}
  ...
  \proofstep{1,2}{%
    ...
    \FamAvoiding{\OccQuotFam{M}}{C}}{\rIE{3,8}}
  \proofstep{1,2}{%
    \FamAvoiding{\OccQuotFam{M}}{C}\EqCard
    \FamAvoiding{M}{a}}{%
    \FormulaRefAuto{EqCardSymmetric}{9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{\OccQuotMap{M}\colon M\bij\OccQuotFam{M}}{%
    \FormulaRefAuto{OccQuotMapBijective}}
  \proofstep{1,2}{\OccQuotMap{M}\restriction_{(\OccQuotMap{M})^{-1}[\FamContaining{\OccQuotFam{M}}C]}\colon (\OccQuotMap{M})^{-1}[\FamContaining{\OccQuotFam{M}}C]\bij \FamContaining{\OccQuotFam{M}}C}{%
      \FormulaRefAuto{F\colon A\bij B \dsep T\subseteq B \vdash F\restriction_{F^{-1}[T]}\colon F^{-1}[T]\bij T}{12,6}}
  \proofstep{1,2}{\exists H\colon
    \bigl(\OccQuotMap{M}\bigr)^{-1}[\FamContaining{\OccQuotFam{M}}{C}]
    \bij
    \FamContaining{\OccQuotFam{M}}{C}}{%
  ...
  \proofstep{1,2}{%
    ...
    \EqCard
    \FamContaining{\OccQuotFam{M}}{C}}{%
    \FormulaRefAuto{A \EqCard B \coloneqq \exists F\colon A\bij B}{14}}
  \proofstep{1,2}{%
    \FamContaining{M}{a}\EqCard
    \FamContaining{\OccQuotFam{M}}{C}}{\rIE{11,15}}
  \proofstep{1,2}{%
    \FamContaining{\OccQuotFam{M}}{C}\EqCard
    \FamContaining{M}{a}}{%
    \FormulaRefAuto{EqCardSymmetric}{16}}
  \proofstep{1,2,3}{%
    \exists G\colon \FamAvoiding{M}{a}\inj
    \FamContaining{M}{a}}{%
    \FormulaRefAuto{EqCardInjectionTransport}{4,17,3}}
\end{tabproof}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[4]{F\colon
    \FamAvoiding{\OccQuotFam{M}}{C}\inj
    \FamContaining{\OccQuotFam{M}}{C}}{\rA}
  \proofstepwidestar[1,2,4]{%
    \exists G\colon \FamAvoiding{M}{a}\inj\FamContaining{M}{a}}{\FormulaRefAuto{OccQuotInjectionPullback}{1,2,4}}
  \proofstepwidestar[1,2,4]{\HalfOcc{a}{M}}{\FormulaRefAuto{Halbhäufiges Element}{\rAI{2,5}}}
  \proofstepwidestar[1,2,3]{\HalfOcc{a}{M}}{\rEE{3,4,6}}
\end{tabproofwide}
...
\begin{tabproof}
  ...
  \proofstep{2}{Y\in\OccQuotFam{M}\vdash\Finite Y}{%
      \FormulaRefAuto{OccQuotMembersFinite}{3}}
  ...
  \proofstep{1}{%
    ...
    \end{aligned}}{\rUE{1}}
  \proofstep{1,2}{\Frankl{\OccQuotFam{M}}}{\rRE{8,7}}
  \proofstep{1,2}{\Frankl{M}}{\FormulaRefAuto{OccQuotFranklTransport}{9}}
\end{tabproof}
...
beschränkten Supremums-Halbverbände steht nun unabhängig in Band~45. Im
...
\begin{tabproofsplitwide}
  ...
  [JoinIrreducibleTopFilterSingleton]
    ...
    \proofstepwidestar[1,2,3]{%
      ...
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[8]\vdots 14}}
    \proofstepwidestar[1,2,3]{%
  ...
  [JoinIrreducibleTopAtMostHalf]
    ...
    \proofstepwidestar[]{0=t\rightarrow t=0}{%
      \rRI{\FormulaRefAuto{a=b\vdash b=a}}}
    \proofstepwidestar[1,2]{0\neq t}{%
      \FormulaRefAuto{P \rightarrow Q, \neg Q \vdash \neg P}{6,5}}
    \proofstepwidestar[1,2]{0\notin\{t\}}{\FormulaRefAuto{x\notin\{a\}\eqvdash x\neq a}{7}}
    \proofstepwidestar[1,2]{0\in A\setminus\{t\}}{%
      \FormulaRefAuto{x\in A\setminus B\eqvdash x\in A\land x\notin B}{%
        \rAI{4,8}}}
    \proofstepwidestar[1,2]{\exists F\colon\{t\}\inj A\setminus\{t\}}{%
      \FormulaRefAuto{SingletonInjectionIntoNonempty}[thm]{9}}
    \proofstepwidestar[1,2,3]{%
      \PrincipalFilter{A,\InducedLeq}{t}=\{t\}}{%
      \FormulaRefAuto{JoinIrreducibleTopFilterSingleton}[thm]{1,2,3}}
    \proofstepwidestar[]{t\in A}{%
    ...
    \proofstepwidestar[1,2,3]{%
      \AtMostHalf{\PrincipalFilter{A,\InducedLeq}{t}}{A}}{%
      \FormulaRefAuto{AtMostHalf}[def]{\rIE{11,13},\rIE{11,10}}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[5,8]{j\in\JoinIrrSet{A,\JoinOp,0}\land j\InducedLeq y}{%
      \FormulaRefAuto{IrreduciblesBelow}[def]{13}}
  \proofstepwidestar[5,8]{j\InducedLeq y}{%
    \rAEb{14}}
  \proofstepwidestar[5,8]{\bot}{\rBI{11,15}}
  \proofstepwidestar[1,2,3,4,5,6]{\bot}{\rEE{7,8,16}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,4,5,6]{\Semi{A,\JoinOp}}{%
  ...
  \proofstepwidestar[1,2]{\Phi\colon A\inj\mathcal U}{%
    \ProofRefStack{%
      ...
      \bigl(3,\rUI{\rRI{4,\rRI{5,\rRI{6,19}}}}\bigr)}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Erste Teilmengenrichtung]{%
    ...
    \proofstepwidestar[1,2,3,4]{%
      ...
      \end{aligned}}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[12]\vdots 20}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Zweite Teilmengenrichtung]{%
    ...
    \proofstepwidestar[1,2,3,5]{%
      ...
      \end{aligned}}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[8]\vdots 22}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{\CanonicalProfileMap{A,\JoinOp,0}\colon A\to\mathcal U_{A,\JoinOp,0}}{%
      \FormulaRefAuto{CanonicalProfileFunction}[thm]{2}}
  \proofstepwidestar[2]{%
    \CanonicalProfileMap{A,\JoinOp,0}(0)\in\mathcal U_{A,\JoinOp,0}}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{%
  ...
  \proofstepwidestar[2,6]{j\in\bigcup\mathcal U_{A,\JoinOp,0}}{%
    \FormulaRefAuto{B\in A\dsep x\in B\vdash x \in \bigcup A}{15,13}}
  \proofstepwidestar[2,6]{%
    \exists j\,j\in\bigcup\mathcal U_{A,\JoinOp,0}}{\rEI{16}}
  \proofstepwidestar[1,2,3]{%
    \exists j\,j\in\bigcup\mathcal U_{A,\JoinOp,0}}{\rEE{5,6,17}}
  \proofstepwidestar[1,2,3]{\bigcup\mathcal U_{A,\JoinOp,0}\neq\varnothing}{%
    \FormulaRefAuto{A\neq\varnothing \eqvdash \exists x\,(x \in A)}{18}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{\(\vdash\)}
    ...
    \proofstepwidestar[1,2,3,4]{j\in\JoinIrrSet{A,\JoinOp,0}\land j\InducedLeq x}{%
      \FormulaRefAuto{IrreduciblesBelow}[def]{10}}
    \proofstepwidestar[1,2,3,4]{j\InducedLeq x}{%
      \rAEb{11}}
    \proofstepwidestar[1,2,3,4]{%
      x\in\PrincipalFilter{A,\InducedLeq}{j}}{%
      \FormulaRefAuto{PrincipalFilter}[def]{\rAI{3,12}}}
  \closeproofpartwide
  ...
  \proofpartwide{\(\dashv\)}
    ...
    \proofstepwidestar[4]{x\in A\land j\InducedLeq x}{%
      \FormulaRefAuto{PrincipalFilter}[def]{4}}
    \proofstepwidestar[4]{j\InducedLeq x}{%
      \rAEb{5}}
    \proofstepwidestar[2,4]{j\in\IrrBelow{A,\JoinOp,0}{x}}{%
      \FormulaRefAuto{IrreduciblesBelow}[def]{\rAI{2,6}}}
    \proofstepwidestar[2]{%
      j\notin\JoinIrrSet{A,\JoinOp,0}\setminus
        \IrrBelow{A,\JoinOp,0}{x}
      \leftrightarrow j\in\IrrBelow{A,\JoinOp,0}{x}}{%
    ...
    \proofstepwidestar[2,4]{%
      j\notin\JoinIrrSet{A,\JoinOp,0}\setminus
        \IrrBelow{A,\JoinOp,0}{x}}{%
      \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{8,7}}
    \proofstepwidestar[1,3]{%
      \CanonicalProfileMap{A,\JoinOp,0}(x)=
      \JoinIrrSet{A,\JoinOp,0}\setminus\IrrBelow{A,\JoinOp,0}{x}}{%
      \FormulaRefAuto{CanonicalProfileEvaluation}[thm]{1,3}}
    ...
    \proofstepwidestar[1,3]{%
      \CanonicalProfileMap{A,\JoinOp,0}(x)\in\mathcal U_{A,\JoinOp,0}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{12,3}}
    \proofstepwidestar[1,2,3,4]{%
      \CanonicalProfileMap{A,\JoinOp,0}(x)
        \in\FamAvoiding{\mathcal U_{A,\JoinOp,0}}{j}}{%
      \FormulaRefAuto{Vermeidende Teilfamilie}[def]{\rAI{13,11}}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{\(\vdash\)}
    ...
    \proofstepwidestar[4]{\CanonicalProfileMap{A,\JoinOp,0}(x)\in\mathcal U_{A,\JoinOp,0}\land j\in\CanonicalProfileMap{A,\JoinOp,0}(x)}{%
      \FormulaRefAuto{Enthaltende Teilfamilie}[def]{4}}
    \proofstepwidestar[4]{%
    ...
    \proofstepwidestar[1,2,3,7]{%
      \CanonicalProfileMap{A,\JoinOp,0}(x)
        \in\FamAvoiding{\mathcal U_{A,\JoinOp,0}}{j}}{%
      \FormulaRefAuto{CanonicalAvoidingMembership}[thm]{1,2,3,7}}
    \proofstepwidestar[8]{\CanonicalProfileMap{A,\JoinOp,0}(x)\in\mathcal U_{A,\JoinOp,0}\land j\notin\CanonicalProfileMap{A,\JoinOp,0}(x)}{%
      \FormulaRefAuto{Vermeidende Teilfamilie}[def]{8}}
    \proofstepwidestar[8]{%
      j\notin\CanonicalProfileMap{A,\JoinOp,0}(x)}{%
      \rAEb{9}}
    \proofstepwidestar[4,7]{\bot}{\rBI{6,10}}
    \proofstepwidestar[4]{%
      x\notin\PrincipalFilter{A,\InducedLeq}{j}}{%
      \rCI{7,11}}
    \proofstepwidestar[3,4]{%
      x\in A\setminus\PrincipalFilter{A,\InducedLeq}{j}}{%
      \FormulaRefAuto{x \in A\dsep x\notin B\vdash x \in A\setminus B}{3,12}}
  \closeproofpartwide
...
\begin{tabproofsplitwide}
  \proofpartwide{Zerlegung eines Existenzzeugen}
  ...
  \proofpartwide{Einführung eines Existenzzeugen}
...
\]
\begin{tabproofsplitwide}
  \proofpartwide{Einschränkung auf die beiden Teile}
  ...
  \proofpartwide{Zusammenführung der beiden Allbedingungen}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{a\in\bigcup C\leftrightarrow\exists Y\in C(a\in Y)}{%
      \FormulaRefAuto{x \in \bigcup A \;\eqvdash\;\exists B\in A\,(x \in B)}}
  \proofstepwide{%
    \bigl(\exists Y\in C\,(a\in Y)\bigr)\lor a\in X} {\leftrightarrow}{a\in\bigcup C\lor a\in X}{%
    \rLRS{3,2}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[5]{X\in C\cup\{X\}}{%
      \FormulaRefAuto{a\in A\cup\{a\}}}
    \proofstepwidestar[5]{X\in L}{%
      \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
        \rAEa{5},6}}
    \proofstepwidestar[8]{C=\varnothing}{\rA}
    \proofstepwidestar[5,8]{C\cup\{X\}=\{X\}}{\rIE{8,\rII}}
    \proofstepwidestar[5,8]{\bigcap\{X\}=X}{%
      \FormulaRefAuto{IntersectionSingletonFamily}[thm]}
    \proofstepwidestar[5,8]{\bigcap(C\cup\{X\})=X}{%
      \rIE{9,10}}
    \proofstepwidestar[5,8]{\bigcap(C\cup\{X\})\in L}{\rIE{11,7}}
    \proofstepwidestar[13]{C\neq\varnothing}{\rA}
    \proofstepwidestar[5]{C\subseteq C\cup\{X\}}{%
    ...
    \proofstepwidestar[5]{C\subseteq L}{%
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}{%
        14,\rAEa{5}}}
    \proofstepwidestar[2,5,13]{\bigcap C\in L}{\rRE{2,\rAI{15,13}}}
    \proofstepwidestar[4,7,16]{(\bigcap C)\cap X\in L}{%
      \FormulaRefAuto{IntersectionClosedFamily}[def]{4,16,7}}
    \proofstepwidestar[13]{\bigcap(C\cup\{X\})=(\bigcap C)\cap X}{%
      \FormulaRefAuto{IntersectionFamilyAdjunction}[thm]{13}}
    \proofstepwidestar[2,4,5,13]{\bigcap(C\cup\{X\})\in L}{\rIE{18,17}}
    \proofstepwidestar[]{C=\varnothing\lor C\neq\varnothing}{%
      \FormulaRefAuto{P\lor\neg P}}
    \proofstepwidestar[2,4,5]{\bigcap(C\cup\{X\})\in L}{%
      \rOE{20,8,12,13,19}}
    \proofstepwidestar[1,2,3,4]{P(C\cup\{X\})}{\rRI{5,21}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[5]{X\in M}{%
      \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
        \rAEa{5},6}}
    \proofstepwidestar[8]{C=\varnothing}{\rA}
    \proofstepwidestar[5,8]{\bigcup(C\cup\{X\})=\bigcup C\cup X}{%
      \FormulaRefAuto{UnionFamilyAdjunction}[thm]}
    \proofstepwidestar[5,8]{\bigcup(C\cup\{X\})=X}{%
      \rIE{8,9}}
    \proofstepwidestar[5,8]{\bigcup(C\cup\{X\})\in M}{\rIE{10,7}}
    \proofstepwidestar[12]{C\neq\varnothing}{\rA}
    \proofstepwidestar[5]{C\subseteq C\cup\{X\}}{%
      \FormulaRefAuto{A\subseteq A\cup B}}
    \proofstepwidestar[5]{C\subseteq M}{%
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}{%
        13,\rAEa{5}}}
    \proofstepwidestar[2,5,12]{\bigcup C\in M}{\rRE{2,\rAI{14,12}}}
    \proofstepwidestar[4,7,15]{(\bigcup C)\cup X\in M}{%
      \FormulaRefAuto{X\in M\dsep Y\in M\vdash X\cup Y\in M}[ax]{15,7}}
    \proofstepwidestar[]{\bigcup(C\cup\{X\})=(\bigcup C)\cup X}{%
      \FormulaRefAuto{UnionFamilyAdjunction}[thm]}
    \proofstepwidestar[2,4,5,12]{\bigcup(C\cup\{X\})\in M}{\rIE{17,16}}
    \proofstepwidestar[]{C=\varnothing\lor C\neq\varnothing}{%
      \FormulaRefAuto{P\lor\neg P}}
    \proofstepwidestar[2,4,5]{\bigcup(C\cup\{X\})\in M}{%
      \rOE{19,8,11,12,18}}
    \proofstepwidestar[1,2,3,4]{Q(C\cup\{X\})}{\rRI{5,20}}
  \closeproofpartwideindR
...
\begin{tabproof}
  ...
  \proofstep{7}{\varnothing\subseteq U_M}{%
      \FormulaRefAuto{\varnothing\subseteq A}}
  \proofstep{7}{X\subseteq U_M}{%
    \rIE{7,8}}
  \proofstep{1,2}{X\subseteq U_M}{\rOE{4,5,6,7,9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{4}{U_M\setminus Y\subseteq U_M}{%
      \FormulaRefAuto{A\setminus B\subseteq A}}
  \proofstep{4}{X\subseteq U_M}{%
    \rIE{\rAEb{4},5}}
  \proofstep{2}{X\subseteq U_M}{\rEE{3,4,6}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Teilmengenrichtung zur ursprünglichen Familie]{%
    ...
    \proofstepwidestar[1]{%
      \FamContaining{M^\circ}{a}\subseteq\FamContaining{M}{a}}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[2]\vdots 14}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwide{Vereinigungen mit einem Mitglied der ursprünglichen Familie}
  \proofstepwidestar[1]{\FranklFam M}{\rA}
  ...
  \proofstepwidestar[12]{X\cup\varnothing=X}{%
  ...
  \proofstepwidestar[7]{X\in M^\circ}{\rIE{3,15}}
  \proofstepwidestar[7,12]{X\cup Y\in M^\circ}{\rIE{14,16}}
  \proofstepwidestar[1,4,6,7]{X\cup Y\in M^\circ}{%
    \rOE{6,8,11,12,17}}

  \closeproofpartwide

  \proofpartwide{Vereinigungen mit der leeren Menge}
  \setcounter{proofstepnr}{18}
  \proofstepwidestar[19]{X=\varnothing}{\rA}
  \proofstepwidestar[20]{Y\in M}{\rA}
  \proofstepwidestar[19]{\varnothing\cup Y=Y}{%
      \FormulaRefAuto{\varnothing\cup A=A}}
  \proofstepwidestar[19]{X\cup Y=Y}{%
    \rIE{19,21}}
  \proofstepwidestar[20]{Y\in M\cup\{\varnothing\}}{%
    \FormulaRefAuto{z\in A\vdash z\in A\cup B}[thm]{20}}
  \proofstepwidestar[20]{Y\in M^\circ}{\rIE{3,23}}
  \proofstepwidestar[19,20]{X\cup Y\in M^\circ}{\rIE{22,24}}
  \proofstepwidestar[26]{Y=\varnothing}{\rA}
  \proofstepwidestar[19,26]{\varnothing\cup\varnothing=\varnothing}{%
      \FormulaRefAuto{\varnothing\cup\varnothing=\varnothing}}
  \proofstepwidestar[19,26]{X\cup Y=\varnothing}{%
    \rIE{19,\rIE{26,27}}}
  \proofstepwidestar[]{\varnothing\in M\cup\{\varnothing\}}{%
    \FormulaRefAuto{a\in A\cup\{a\}}[thm]}
  \proofstepwidestar[]{\varnothing\in M^\circ}{\rIE{3,29}}
  \proofstepwidestar[19,26]{X\cup Y\in M^\circ}{\rIE{28,30}}
  \proofstepwidestar[4,6,19]{X\cup Y\in M^\circ}{%
    \rOE{6,20,25,26,31}}
  \closeproofpartwide

  \proofpartwide{Zusammenführung und Abschluss}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,6,7]{A\cup B\in M^\circ}{%
    \FormulaRefAuto{X\in M\dsep Y\in M\vdash X\cup Y\in M}[ax]{%
      \rAEa{6},\rAEa{7}}}
  \proofstepwidestar[6,7]{(U_M\setminus A)\cap(U_M\setminus B)=U_M\setminus(A\cup B)}{%
  ...
  \proofstepwidestar[1,2,6,7]{X\cap Y\in\mathcal L_M}{%
    \FormulaRefAuto{FranklComplementConstruction}[def]{8,10}}
  \proofstepwidestar[1,2]{X\cap Y\in\mathcal L_M}{%
    \rEE{4,6,\rEE{5,7,11}}}
  \proofstepwidestar[1]{\InterClosedFam{\mathcal L_M}}{%
    \FormulaRefAuto{IntersectionClosedFamily}[def]{\rUI{\rUI{\rRI{2,12}}}}}
\end{tabproofwide}
...
\begin{tabproof}
  ...
  \proofstep{1}{\mathcal L_M\subseteq\powerset(U_M)}{%
    \FormulaRefAuto{SubsetIntroductionRule}[thm]{[2]\vdots 4}}
...
\]
\begin{tabproofsplitwide}
  \proofpartwide{Trägereinschluss und gemeinsames oberes Element}
  \proofstepwidestar[1]{\FranklFam M}{\rA}
  \proofstepwidestar[2]{X,Y\in\mathcal L_M}{\rA}
  ...
  \proofstepwidestar[1,2]{X\cup Y\subseteq U_M}{\FormulaRefAuto{A \subseteq C,\, B \subseteq C \vdash A \cup B \subseteq C}{7,8}}
  \proofstepwidestar[1,2]{U_M\in\mathcal C}{%
    \FormulaRefAuto{FranklComplementCommonUpperFamily}[def]{6,9}}
  \proofstepwidestar[1,2]{\mathcal C\neq\varnothing}{%
    \FormulaRefAuto{a\in S\vdash S\neq\varnothing}{10}}
  \closeproofpartwide

  \proofpartwide{Endlichkeit und Schluss}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Beide Operanden liegen im Schnitt der gemeinsamen oberen Elemente]{%
    ...
    \proofstepwidestar[1]{\FranklFam M}{\rA}
    \proofstepwidestar[2]{X,Y\in\mathcal L_M}{\rA}
    \proofstepwidestar[1,2]{\Finite{\mathcal C_M(X,Y)}\land\mathcal C_M(X,Y)\neq\varnothing}{%
      \FormulaRefAuto{FranklComplementCommonUpperFiniteNonempty}[thm]{1,2}}
    \proofstepwidestar[1,2]{\mathcal C_M(X,Y)\neq\varnothing}{%
      \rAEb{3}}
    \proofstepwidestar[5]{a\in X}{\rA}
    \proofstepwidestar[6]{Z\in\mathcal C_M(X,Y)}{\rA}
    \proofstepwidestar[6]{X\cup Y\subseteq Z}{%
      \FormulaRefAuto{FranklComplementCommonUpperFamily}[def]{6}}
    \proofstepwidestar[]{X\subseteq X\cup Y}{%
      \FormulaRefAuto{A\subseteq A\cup B}}
    \proofstepwidestar[6]{X\subseteq Z}{%
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}{8,7}}
    \proofstepwidestar[5,6]{a\in Z}{%
      \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{9,5}}
    \proofstepwidestar[5]{\forall Z\in\mathcal C_M(X,Y)\,(a\in Z)}{%
      \rUI{\rRI{6,10}}}
    \proofstepwidestar[1,2]{%
      a\in\bigcap\mathcal C_M(X,Y)\leftrightarrow
      \forall Z\in\mathcal C_M(X,Y)\,(a\in Z)}{%
      \FormulaRefAuto{M\neq\varnothing \vdash x\in\bigcap M \leftrightarrow
        \forall X\in M\,(x\in X)}{4}}
    \proofstepwidestar[1,2,5]{a\in\bigcap\mathcal C_M(X,Y)}{%
    ...
    \proofstepwidestar[15]{a\in Y}{\rA}
    \proofstepwidestar[16]{Z\in\mathcal C_M(X,Y)}{\rA}
    \proofstepwidestar[16]{X\cup Y\subseteq Z}{%
      \FormulaRefAuto{FranklComplementCommonUpperFamily}[def]{16}}
    \proofstepwidestar[]{Y\subseteq X\cup Y}{%
      \FormulaRefAuto{B\subseteq A\cup B}}
    \proofstepwidestar[16]{Y\subseteq Z}{%
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}{18,17}}
    \proofstepwidestar[15,16]{a\in Z}{%
      \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{19,15}}
    \proofstepwidestar[15]{\forall Z\in\mathcal C_M(X,Y)\,(a\in Z)}{%
      \rUI{\rRI{16,20}}}
    \proofstepwidestar[1,2]{%
      a\in\bigcap\mathcal C_M(X,Y)\leftrightarrow
      \forall Z\in\mathcal C_M(X,Y)\,(a\in Z)}{%
      \FormulaRefAuto{M\neq\varnothing \vdash x\in\bigcap M \leftrightarrow
        \forall X\in M\,(x\in X)}{4}}
    \proofstepwidestar[1,2,15]{a\in\bigcap\mathcal C_M(X,Y)}{%
      \FormulaRefAuto{P\leftrightarrow Q,Q\vdash P}{22,21}}
    \proofstepwidestar[1,2]{Y\subseteq\bigcap\mathcal C_M(X,Y)}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[15]\vdots 23}}
    \proofstepwidestar[1,2]{%
      X\subseteq\bigcap\mathcal C_M(X,Y)\land
      Y\subseteq\bigcap\mathcal C_M(X,Y)}{\rAI{14,24}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Kleinste obere Schranke]{%
    ...
    \proofstepwidestar[1,2,3,4,5]{X\FamilyJoinOp{M}{}Y\subseteq W}{%
      \rIE{\FormulaRefAuto{a=b\vdash b=a}{11},10}}
  \closeproofpartwideindR
  \proofpartwideindR[Zusammenführung der Paarsupremumseigenschaften]{%
    ...
    \proofstepwidestar[1,2]{\begin{aligned}[t]&X\FamilyJoinOp{M}{}Y\in\mathcal L_M\land{}\\[-2pt]&X\subseteq X\FamilyJoinOp{M}{}Y\land Y\subseteq X\FamilyJoinOp{M}{}Y\end{aligned}}{%
    ...
    \proofstepwidestar[2]{\{X,Y\}\subseteq\mathcal L_M}{%
      \FormulaRefAuto{a \in A,\, b \in A \vdash
        \{a,b\} \subseteq A}{10,11}}
    \proofstepwidestar[1,2]{\begin{aligned}[t]&X\FamilyJoinOp{M}{}Y\in\UB_{\mathcal L_M,\subseteq}(\{X,Y\})\leftrightarrow{}\\[-2pt]&\bigl(X\FamilyJoinOp{M}{}Y\in\mathcal L_M\land X\subseteq X\FamilyJoinOp{M}{}Y\land Y\subseteq X\FamilyJoinOp{M}{}Y\bigr)\end{aligned}}{%
      \FormulaRefAuto{PairUpperBoundSetCharacterization}[thm]{3,10,11}}
    \proofstepwidestar[1,2]{%
      X\FamilyJoinOp{M}{}Y\in\UB_{\mathcal L_M,\subseteq}(\{X,Y\})}{\FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{13,\rAI{5,\rAI{7,9}}}}
    ...
    \proofstepwidestar[1,2,15]{%
      W\in\mathcal L_M\land X\subseteq W
        \land Y\subseteq W}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{16,15}}
    \proofstepwidestar[1,2,15]{%
      X\FamilyJoinOp{M}{}Y\subseteq W}{%
      \ProofRefStack{%
        \FormulaRefAuto{FranklComplementPairSupremumLeast}[thm]\\
        \bigl(1,2,\rAEa{17},\rAEa{\rAEb{17}},\bigr.\\[-2pt]
        \bigl.\rAEb{\rAEb{17}}\bigr)}}
    \proofstepwidestar[1,2]{%
      \begin{aligned}[t]
    ...
    \proofstepwidestar[1,2]{%
      \PairSup{\mathcal L_M}{\subseteq}{X}{Y}{X\FamilyJoinOp{M}{}Y}}{%
      \FormulaRefAuto{SupremumCandidateEqualsSupremum}[thm]{3,12,14,19}}
  \closeproofpartwideindR
\end{tabproofsplitwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    \PairJoinOp{\mathcal L_M,\FamilyJoinOp{M}}}{%
    \FormulaRefAuto{PairJoinOperation}[def]{3,5,6}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Träger des Nullelements]{%
    ...
    \proofstepwidestar[1]{U_M\in M}{%
      \FormulaRefAuto{FiniteUnionClosedFamilyTotalUnion}[thm]{%
        ...
        3,
        4}}
    \proofstepwidestar[1]{U_M\setminus U_M=\varnothing}{%
  ...
  \proofpartwideindR[Supremum von Null und einem Trägerelement]{%
    ...
    \proofstepwidestar[1,2]{\{\varnothing,X\}\subseteq\mathcal L_M}{%
      \FormulaRefAuto{a \in A,\, b \in A \vdash
        \{a,b\} \subseteq A}{4,2}}
    \proofstepwidestar[1,2]{X\in\UB_{\mathcal L_M,\subseteq}(\{\varnothing,X\})\leftrightarrow(X\in\mathcal L_M\land\varnothing\subseteq X\land X\subseteq X)}{%
      \FormulaRefAuto{PairUpperBoundSetCharacterization}[thm]{3,4,2}}
    \proofstepwidestar[1,2]{%
      X\in\UB_{\mathcal L_M,\subseteq}(\{\varnothing,X\})}{\FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{8,\rAI{2,\rAI{5,6}}}}
    ...
    \proofstepwidestar[1,2,10]{X\subseteq W}{%
      \rAEb{\rAEb{12}}}
    \proofstepwidestar[1,2]{%
      \begin{aligned}[t]
    ...
    \proofstepwidestar[1,2]{%
      \PairSup{\mathcal L_M}{\subseteq}{\varnothing}{X}{X}}{%
      \FormulaRefAuto{SupremumCandidateEqualsSupremum}[thm]{3,7,9,14}}
  \closeproofpartwideindR
...
\begin{tabproof}
  ...
  \proofstep{1}{\varnothing\in M\cup\{\varnothing\}}{%
      \FormulaRefAuto{a\in A\cup\{a\}}[thm]}
  \proofstep{1}{U_M\setminus\varnothing=U_M}{%
      \FormulaRefAuto{RelativeComplementEmpty}[thm]}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{M\subseteq M\cup\{\varnothing\}}{%
  ...
  \proofstepwidestar[]{%
    ...
    \FormulaRefAuto{FamAvoidingMonotone}[thm]{8}}
  \proofstepwidestar[1]{%
    \FamContaining{M^\circ}{a}=\FamContaining{M}{a}}{%
  ...
  \proofstepwidestar[9,12]{%
    ...
    \FormulaRefAuto{F\colon A\inj B\dsep C\subseteq A\vdash
      F\restriction_C\colon C\inj B}[thm]{12,9}}
  ...
  \proofstepwidestar[1,2]{\HalfOcc{a}{M}}{%
    \FormulaRefAuto{Halbhäufiges Element}[def]{5,15}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Einschränkung auf Familien mit leerer Menge}
  \proofstepwidestar[1]{%
  ...
  \proofpartwide{Rücktransport von der erweiterten Familie}
...
\begin{tabproofsplitwide}
  \proofpartwide{Ein privater Punkt erzwingt die Inklusion}
  ...
  \proofstepwidestar[6]{a\in P\land a\notin P_\ast}{%
      \FormulaRefAuto{x \in A \setminus B \eqvdash
      x \in A \land x \notin B}{6}}
  ...
  \proofstepwidestar[6]{a\notin P_\ast}{%
    \rAEb{12}}
  \proofstepwidestar[14]{Q\in L}{\rA}
  \proofstepwidestar[15]{a\in Q}{\rA}
  \proofstepwidestar[16]{P\nsubseteq Q}{\rA}
  \proofstepwidestar[2,9,14]{P\cap Q\in L}{%
    \FormulaRefAuto{IntersectionClosedFamily}[def]{2,9,14}}
  \proofstepwidestar[]{P\cap Q\subseteq P}{\FormulaRefAuto{A\cap B\subseteq A}}
  \proofstepwidestar[3,9,14]{P\cap Q\InducedLeq P}{%
    \FormulaRefAuto{P\leftrightarrow Q,Q\vdash P}{%
      \rUE{\rUE{3}},18}}
  \proofstepwidestar[16]{P\subseteq Q\leftrightarrow P\cap Q=P}{%
      \FormulaRefAuto{A \subseteq B \eqvdash A \cap B = A}}
  \proofstepwidestar[16]{P\cap Q\neq P}{%
    \FormulaRefAuto{P\leftrightarrow Q,\neg P\vdash\neg Q}{%
      20,16}}
  \proofstepwidestar[3,9,14,16]{P\cap Q\in D_L(P)}{%
    \FormulaRefAuto{JoinIrreducibleProperLowerSet}[def]{17,19,21}}
  \proofstepwidestar[3,5,9,14,16]{%
    P\cap Q\InducedLeq P_\ast}{\rRE{22,\rUE{5}}}
  \proofstepwidestar[3,5,9,14,16]{P\cap Q\subseteq P_\ast}{%
    \FormulaRefAuto{P\leftrightarrow Q,P\vdash Q}{%
      \rUE{\rUE{3}},23}}
  \proofstepwidestar[11,15]{a\in P\cap Q}{%
    \FormulaRefAuto{x\in A\cap B\eqvdash x\in A\land x\in B}{%
      \rAI{11,15}}}
  \proofstepwidestar[3,5,9,11,14,15,16]{a\in P_\ast}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{24,25}}
  \proofstepwidestar[3,5,6,9,11,14,15,16]{\bot}{\rBI{26,13}}
  \proofstepwidestar[1,2,3,4,5,6,14,15]{P\subseteq Q}{%
    \FormulaRefAuto{rDN}{\rCI{16,27}}}
  \proofstepwidestar[1,2,3,4,5,6,14]{a\in Q\to P\subseteq Q}{%
    \rRI{15,28}}
  \closeproofpartwide

  \proofpartwide{Die Inklusion enthält den privaten Punkt}
  \setcounter{proofstepnr}{29}
  \proofstepwidestar[30]{P\subseteq Q}{\rA}
  \proofstepwidestar[11,30]{a\in Q}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{30,11}}
  \proofstepwidestar[11,14]{P\subseteq Q\to a\in Q}{\rRI{30,31}}
  \proofstepwidestar[1,2,3,4,5,6,14]{a\in Q\leftrightarrow P\subseteq Q}{%
    \FormulaRefAuto{P \leftrightarrow Q \eqvdash
      (P \rightarrow Q)\land(Q\rightarrow P)}{\rAI{29,32}}}
  \closeproofpartwide

  \proofpartwide{Übersetzung in den Hauptfilter}
  \setcounter{proofstepnr}{33}
  \proofstepwidestar[14]{Q\in
    \PrincipalFilter{L,\InducedLeq}{P}\leftrightarrow
    P\InducedLeq Q}{%
    \FormulaRefAuto{PrincipalFilter}[def]{14}}
  \proofstepwidestar[3,9,14]{P\InducedLeq Q\leftrightarrow
    P\subseteq Q}{\rUE{\rUE{3}}}
  \proofstepwidestar[3,9,14]{Q\in
    \PrincipalFilter{L,\InducedLeq}{P}\leftrightarrow
    P\subseteq Q}{\rChain{34,35}}
  \proofstepwidestar[3,9,14]{P\subseteq Q\leftrightarrow Q\in
    \PrincipalFilter{L,\InducedLeq}{P}}{%
    \FormulaRefAuto{P\leftrightarrow Q\vdash Q\leftrightarrow P}{36}}
  \proofstepwidestar[1,2,3,4,5,6,14]{a\in Q\leftrightarrow
    Q\in\PrincipalFilter{L,\InducedLeq}{P}}{\rChain{33,37}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[12]{a\in P\land a\notin P_\ast}{%
      \FormulaRefAuto{x \in A \setminus B \eqvdash
      x \in A \land x \notin B}{12}}
  ...
  \proofstepwidestar[1,2,3,4,5]{\exists a\in P\,\forall Q\in L\,
    (a\in Q\leftrightarrow
      Q\in\PrincipalFilter{L,\InducedLeq}{P})}{%
    \rEE{6,7,\rEE{11,12,\rEI{\rAI{15,13}}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    ...
    \rUE{6}}
  \proofstepwidestar[]{\mathcal K\subseteq\mathcal L_M}{%
      \FormulaRefAuto{A\setminus B\subseteq A}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{M\subseteq M\cup\{\varnothing\}}{%
      \FormulaRefAuto{A\subseteq A\cup B}}
  \proofstepwidestar[1]{M^\circ=M\cup\{\varnothing\}}{%
      \FormulaRefAuto{FranklEmptyAdjunction}[def]{1}}
  ...
  \proofstepwidestar[1]{\FamAvoiding{M}{a}\subseteq
    \FamAvoiding{M^\circ}{a}}{%
    \FormulaRefAuto{FamAvoidingMonotone}[thm]{13}}
  \proofstepwidestar[1]{\FamContaining{M^\circ}{a}=
    \FamContaining{M}{a}}{%
    \FormulaRefAuto{FranklAugmentedContainingUnchanged}[thm]{1}}
  \proofstepwidestar[16]{F\colon\FamAvoiding{M^\circ}{a}
    \inj\FamContaining{M^\circ}{a}}{\rA}
  \proofstepwidestar[14,16]{F\restriction_{\FamAvoiding{M}{a}}
    \colon\FamAvoiding{M}{a}\inj\FamContaining{M^\circ}{a}}{%
    \FormulaRefAuto{F\colon A\inj B\dsep C\subseteq A\vdash
      F\restriction_C\colon C\inj B}{16,14}}
  \proofstepwidestar[14,15,16]{\exists F\colon\FamAvoiding{M}{a}
    \inj\FamContaining{M}{a}}{\rEI{\rIE{15,17}}}
  \proofstepwidestar[1,2,3,4,5]{\exists F\colon\FamAvoiding{M}{a}
    \inj\FamContaining{M}{a}}{\rEE{10,16,18}}
  \proofstepwidestar[1,2,3,4,5]{\HalfOcc{a}{M}}{%
    \FormulaRefAuto{Halbhäufiges Element}[def]{3,19}}
\end{tabproofwide}
