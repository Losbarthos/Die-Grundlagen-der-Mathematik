...
\proofstep{9}{x\in C}{\rA}
  \proofstep{2,9}{\exists y\,((x,y)\in F)}{ 
    \FormulaRefAuto{x\in A\vdash \exists y\,(x,y)\in F}{2,9}}
  \proofstep{11}{(x,y)\in F}{\rA}
  \proofstep{1,11}{x\in A}{ 
    \FormulaRefAuto{F\colon A\to B\dsep (x,y)\in F\vdash x\in A}{1,11}}
  \proofstep{1,2,9}{x\in A}{\rEE{10,11,12}}
  \proofstep{1,2}{C\subseteq A}{ 
    \FormulaRefAuto{SubsetIntroductionRule}[thm]{[9]\vdots 13}}

\closeproofpart

\proofpart{Gleichheit der Definitionsbereiche}
  \setcounter{proofstepnr}{14}% Fortlaufende Schritte dieses Beweises.
\proofstep{1,2}{A=C}{ 
    \FormulaRefAuto{A\subseteq B\dsep B\subseteq A\vdash A=B}[thm]{8,14}}
...
\input{tex/b05-migrated-function-fiber}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideind[Teilmengenrichtung \(\{F(x)\}\subseteq F[\{x\}]\)]{%
    ...
    \proofstepwidestar[1,2]{\{F(x)\}\subseteq F[\{x\}]}{ 
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[3]\vdots 10}}
  \closeproofpartwideind
...
{
  \DeltaRow{Mengen}{A\dsep B\dsep p\dsep x\dsep y\dsep z}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproof}
  \proofstep{1}{F\colon A\to B}{\rA}
  \proofstep{2}{p\in F}{\rA}
  \proofstep{1,2}{\exists x\in A\,\exists y\in B\;p=(x,y)}{%
    \FormulaRefAuto{x\in A\times B\eqvdash
      ...
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{%
        \FormulaRefAuto{FunctionGraphSubsetProduct}[thm]{1},2}}}
  \proofstep{4}{x\in A\land\exists y\in B\;p=(x,y)}{\rA}
  \proofstep{5}{y\in B\land p=(x,y)}{\rA}
  \proofstep{1,2,5}{y=F(x)}{%
    \FormulaRefAuto{F\colon A\to B\dsep (x,y)\in F\vdash y=F(x)}[thm]{%
      1,\rIE{\rAEb{5},2}}}
  \proofstep{1,2,4,5}{y\in F[A]}{%
    \FormulaRefAuto{F\colon A\to B\dsep
      \exists x\in A\,y=F(x)\vdash y\in F[A]}[thm]{%
      1,\rEI{\rAI{\rAEa{4},6}}}}
  \proofstep{1,2,4,5}{p\in A\times F[A]}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}[thm]{\rAEb{5}},
      \FormulaRefAuto{a\in A\dsep b\in B\vdash (a,b)\in A\times B}[thm]{%
        \rAEa{4},7}}}
  \proofstep{1,2,4}{p\in A\times F[A]}{\rEE{\rAEb{4},5,8}}
  \proofstep{1,2}{p\in A\times F[A]}{\rEE{3,4,9}}
...
\begin{tabproof}
  ...
  \proofstep{2}{X\subseteq A\land X\neq\varnothing}{%
  ...
  \proofstep{8}{x\in X}{\rA}
  \proofstep{1,2,8}{f(x)\in f[X]}{%
    \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep
      x\in C\vdash F(x)\in F[C]}[thm]{4,1,8}}
  \proofstep{1,2,8}{f[X]\neq\varnothing}{%
    \FormulaRefAuto{a\in A\vdash A\neq\varnothing}[thm]{9}}
  \proofstep{1,2}{f[X]\neq\varnothing}{\rEE{7,8,10}}
  ...
  \proofstep{1,2}{f[X]\in\PowNE{B}}{%
    \FormulaRefAuto{NonemptyPowersetMembership}[thm]{13}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{F^{-1}[\varnothing]\subseteq \varnothing}{ 
    \FormulaRefAuto{SubsetIntroductionRule}[thm]{[3]\vdots 8}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{x\in F^{-1}[C]\leftrightarrow(x\in A\land F(x)\in C)}{%
      \FormulaRefAuto{F\colon A\to B\dsep C\subseteq B
          \vdash \bigl(x\in F^{-1}[C] \leftrightarrow
          (x\in A \land F(x)\in C)\bigr)}{1,2}}
  \proofstep{1,2,4,5,11}{x\in F^{-1}[C]}{%
  ...
  \proofstep{15}{F(x)\in D}{\rA}
  \proofstep{1,3}{x\in F^{-1}[D]\leftrightarrow(x\in A\land F(x)\in D)}{%
      \FormulaRefAuto{F\colon A\to B\dsep C\subseteq B
          \vdash \bigl(x\in F^{-1}[C] \leftrightarrow
          (x\in A \land F(x)\in C)\bigr)}{1,3}}
  \proofstep{1,3,4,5,15}{x\in F^{-1}[D]}{%
      \FormulaRefAuto{P \leftrightarrow Q, Q \vdash P}{%
        16,%
        \rAI{8,15}}}
  \proofstep{1,3,4,5,15}{x\in F^{-1}[C]\cup F^{-1}[D]}{%
    \FormulaRefAuto{y\in B\vdash y\in A\cup B}{%
      17}}

  \proofstep{1,2,3,4}{x\in F^{-1}[C]\cup F^{-1}[D]}{\rOE{10,11,14,15,18}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[1,2]{\forall x\forall y\forall z\,((x,y)\in R\land(x,z)\in R\rightarrow y=z)}{%
      \FormulaRefAuto{R\subseteq A\times B\dsep
          \forall x\in A\,\exists! y\in B\,\bigl((x,y)\in R\bigr)\dsep
          (x,y)\in R\dsep (x,z)\in R\vdash y=z}{1,2}}
    \proofstepwidestar[1,2]{\forall x\in A\,\exists y\,((x,y)\in R)}{%
      \FormulaRefAuto{R\subseteq A\times B\dsep
          \forall x\in A\,\exists! y\in B\,\bigl((x,y)\in R\bigr)\dsep
...
\begin{tabproof}
  ...
  \proofstep{}{\Graph(F)=\{(x,y)\in A\times B\mid y=F(x)\}}{%
      \FormulaRefAuto{\Graph(F)\coloneq\{(x,y) \in A \times B \mid y=F(x)\}}}
  \proofstep{1,2}{(x,F(x))\in\Graph(F)}{\rIE{7,6}}
  \proofstep{1,2}{\exists y\,(x,y)\in\Graph(F)}{\rEI{8}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Funktionswerte]{%
    ...
    \proofstepwidestar[1,3]{(x,R_y(x))\in A\times B\land R_y(x)=y}{%
      \FormulaRefAuto{x\in\{u\in A\mid P(u)\}
...
\proofpartwide{Existenz der Werte}
  \setcounter{proofstepnr}{4}% Fortlaufende Schritte dieses Beweises.
...
\proofpartwide{Eindeutigkeit der Werte}
...
\proofstepwidestar[10]{y\in B\land(x,y)\in\{(a,b)\}}{\rA}
  ...
  \proofstepwidestar[10]{x=a\land y=b}{%
      \FormulaRefAuto{(a,b)=(c,d)\eqvdash a=c\land b=d}[thm]{12}}
  \proofstepwidestar[10]{y=b}{%
    \rAEb{13}}
  \proofstepwidestar[11]{(x,z)=(a,b)}{%
    \FormulaRefAuto{x\in\{a\}\eqvdash x=a}[thm]{\rAEb{11}}}
  \proofstepwidestar[11]{x=a\land z=b}{%
      \FormulaRefAuto{(a,b)=(c,d)\eqvdash a=c\land b=d}[thm]{15}}
  \proofstepwidestar[11]{z=b}{%
    \rAEb{16}}
  \proofstepwidestar[10,11]{y=z}{%
    \FormulaRefAuto{a=b\dsep c=b\vdash a=c}[thm]{14,17}}

\closeproofpartwide

\proofpartwide{Zusammenführung zur Funktion}
  \setcounter{proofstepnr}{18}% Fortlaufende Schritte dieses Beweises.
\proofstepwidestar[1,5]{\exists!y\in B\,((x,y)\in\{(a,b)\})}{%
    \UEI{9,10,11,18}}
  \proofstepwidestar[1]{\forall x\in\{a\}\,\exists!y\in B\,
    ((x,y)\in\{(a,b)\})}{\rUI{\rRI{5,19}}}
  \proofstepwidestar[1]{\{(a,b)\}\colon\{a\}\to B}{%
    \FormulaRefAuto{UniqueValuedGraphFunction}[thm]{4,20}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{F \colon A \to B}{%
      \FormulaRefAuto{Funktion}}
  \proofstepwide[1]{F^{-1}[\{y\}]}{=}{\{\,u\in A \mid F(u)\in \{y\}\,\}}{%
    \FormulaRefAuto{F\colon A\to B\dsep C\subseteq B
...
\FormulaThmDelta[Verkleinerung der Zielmenge]{%
  ...
  \DeltaRow{Mengen}{A\dsep B\dsep C\dsep p\dsep x\dsep y\dsep z}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproofsplit}
\proofpart{Trägerrelation im kleineren Zielbereich}
  \proofstep{1}{F\colon A\to B}{\rA}
  \proofstep{2}{\forall x\in A\,F(x)\in C}{\rA}
  \proofstep{3}{p\in F}{\rA}
  \proofstep{1,3}{\exists x\in A\,\exists y\in B\;p=(x,y)}{%
    \FormulaRefAuto{x\in A\times B\eqvdash
      \exists a\in A\,\exists b\in B\,x=(a,b)}[thm]{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{%
        \FormulaRefAuto{FunctionGraphSubsetProduct}[thm]{1},3}}}
  \proofstep{5}{x\in A\land\exists y\in B\;p=(x,y)}{\rA}
  \proofstep{6}{y\in B\land p=(x,y)}{\rA}
  \proofstep{1,3,6}{y=F(x)}{%
    \FormulaRefAuto{F\colon A\to B\dsep (x,y)\in F\vdash y=F(x)}[thm]{%
      1,\rIE{\rAEb{6},3}}}
  \proofstep{2,5}{F(x)\in C}{\rRE{\rAEa{5},\rUE{2}}}
  \proofstep{1,2,3,5,6}{p\in A\times C}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}[thm]{\rAEb{6}},
      \FormulaRefAuto{a\in A\dsep b\in B\vdash (a,b)\in A\times B}[thm]{%
        \rAEa{5},\rIE{7,8}}}}
  \proofstep{1,2,3,5}{p\in A\times C}{\rEE{\rAEb{5},6,9}}
  \proofstep{1,2,3}{p\in A\times C}{\rEE{4,5,10}}
...
\proofpart{Zusammenführung}
  \setcounter{proofstepnr}{14}% Fortlaufende Schritte dieses Beweises.
\proofstep{1,2}{F\colon A\to C}{\FormulaRefAuto{Funktion}{12,13,14}}
...
\FormulaThmDeltaKR[Vereinigung einer kompatiblen Familie von
Funktionsgraphen]{%
  \begin{aligned}[t]
    ...
    &\vdash\;
      \begin{aligned}[t]
        &\text{(i)}\quad\bigcup H[I]\colon\bigcup D[I]\to B,\\[-2pt]
        &\text{(ii)}\quad\forall i\in I\,\forall x\in D(i)\,
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Graphteilmenge]{%
    ...
    \proofstepwidestar[]{I \subseteq I}{%
    ...
    \proofstepwidestar[1,2,3]{%
      ...
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[4]\vdots 29}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Totalität]{%
    ...
    \proofstepwidestar[1,10]{H(i)\subseteq\bigcup H[I]}{%
      \FormulaRefAuto{B\in A\vdash B\subseteq\bigcup A}[thm]{17}}
    \proofstepwidestar[19]{(x,y)\in H(i)}{\rA}
    \proofstepwidestar[1,10,19]{(x,y)\in\bigcup H[I]}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{18,19}}
    \proofstepwidestar[1,10,19]{%
      \exists y\,\bigl((x,y)\in\bigcup H[I]\bigr)}{\rEI{20}}
    \proofstepwidestar[1,2,3,6,10]{%
      \exists y\,\bigl((x,y)\in\bigcup H[I]\bigr)}{\rEE{15,19,21}}
    \proofstepwidestar[1,2,3,6]{%
      \exists y\,\bigl((x,y)\in\bigcup H[I]\bigr)}{\rEE{9,10,22}}
    \proofstepwidestar[1,2,3,4]{%
      \exists y\,\bigl((x,y)\in\bigcup H[I]\bigr)}{\rEE{5,6,23}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[1,2,3]{\forall x\in\bigcup D[I]\,\exists y\,((x,y)\in\bigcup H[I])}{%
      \FormulaRefAuto{CompatibleFunctionGraphFamilyUnionTotal}[thm]{1,2,3}}
    \proofstepwidestar[1,2,3]{\bigcup H[I]\subseteq\bigcup D[I]\times B}{%
      \FormulaRefAuto{CompatibleFunctionGraphFamilyUnionSubset}[thm]{1,2,3}}
    \proofstepwidestar[1,2,3,4]{\forall x\forall y\forall z\,((x,y)\in\bigcup H[I]\land(x,z)\in\bigcup H[I]\rightarrow y=z)}{%
    ...
    \proofstepwidestar[10]{x\in D(i)}{\rA}
    \proofstepwidestar[2,3,9]{H(i)\colon D(i)\to B}{%
      \rRE{\rUE{3},9}}
    \proofstepwidestar[2,3,9,10]{(x,H(i)(x))\in H(i)}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A
        \vdash(x,F(x))\in F}[thm]{11,10}}
    \proofstepwidestar[]{I \subseteq I}{%
      \FormulaRefAuto{A\subseteq A}[thm]}
    \proofstepwidestar[1,9]{H(i)\in H[I]}{%
      \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep
        x\in C\vdash F(x)\in F[C]}[thm]{%
          13,1,9}}
    \proofstepwidestar[1,9]{H(i)\subseteq\bigcup H[I]}{%
      \FormulaRefAuto{B\in A\vdash B\subseteq\bigcup A}[thm]{14}}
    \proofstepwidestar[1,2,3,9,10]{%
      (x,H(i)(x))\in\bigcup H[I]}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{15,12}}
    \proofstepwidestar[1,2,3,4,9,10]{%
      (\bigcup H[I])(x)=H(i)(x)}{%
      \FormulaRefAuto{F\colon A\to B\dsep (x,y)\in F
        \vdash F(x)=y}[thm]{8,16}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Urbildpunkte sind nichtleer]{%
    ...
    \proofstepwidestar[1,2]{\PowMap{f}(X)\subseteq B\land\PowMap{f}(X)\neq\varnothing}{%
    ...
    \proofstepwide[1,2,11]{}{=}{f[\varnothing]}{\rLRS{11}}
    \proofstepwide[1,2,11]{}{=}{\varnothing}{%
      \FormulaRefAuto{F\colon A\to B\vdash
        F[\varnothing]=\varnothing}[thm]{1}}
    \proofstepwide[1,2,11]{\PowMap{f}(X)}{=}{\varnothing}{%
      \rChain{12,14}}
    \proofstepwidestar[1,2,11]{\bot}{\rBI{10,15}}
    \proofstepwidestar[1,2]{X\neq\varnothing}{\rCI{11,16}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Nichtleere Teilmengen liegen im Urbild]{%
    ...
    \proofstepwidestar[1,2]{\PowMap{f}(X)=f[X]}{%
      \FormulaRefAuto{F\colon A\to B\dsep X\in\powerset(A)
        \vdash\PowMap{F}(X)=F[X]}[thm]{1,7}}
    \proofstepwidestar[1,2]{\PowMap{f}(X)\in\PowNE{B}}{\rIE{9,8}}
    \proofstepwidestar[1,2]{%
      X\in\powerset(A)\land\PowMap{f}(X)\in\PowNE{B}}{\rAI{7,10}}
    \proofstepwidestar[1]{%
      \begin{aligned}[t]
        &X\in(\PowMap{f})^{-1}[\PowNE{B}]\\[-2pt]
        &\quad\leftrightarrow
    ...
    \proofstepwidestar[1,2]{X\in(\PowMap{f})^{-1}[\PowNE{B}]}{%
      \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}[thm]{12,11}}
  \closeproofpartwideindR
...
\input{tex/b05-migrated-graph-fibers}
...
\proofpart{Werte auf dem bisherigen Bereich}
  \setcounter{proofstepnr}{4}% Fortlaufende Schritte dieses Beweises.
\proofstep{1,2,3}{\ExtMap{f}{a}{b}(a)=b}{%
    \FormulaRefAuto{a\notin A \dsep f\colon A\to M \dsep b\in M \vdash
...
\proofstepwidestar[15]{x\in W}{\rA}
  ...
  \proofstepwidestar[1,2]{W\subseteq\bigcup D[I]}{ 
    \FormulaRefAuto{SubsetIntroductionRule}[thm]{[15]\vdots 22}}
...
spezielle Funktionen ein. Die Bände~28--44 behandeln algebraische
Strukturen, Band~45 die Halbverbandsoperationen und Band~46 die für Frankls
