...
\proofstep{}{\ChoiceRel{A}=\{(X,a)\in\PowNE{A}\times A\mid a\in X\}}{%
...
\proofstep{3}{X\in \PowNE{A}}{\rA}
  \proofstep{3}{X\in \powerset(A)}{%
    \FormulaRefAuto{x \in A \setminus B \vdash x \in A}{3}}
  \proofstep{3}{X\notin \{\varnothing\}}{%
    \FormulaRefAuto{x\in A\setminus B\vdash x\notin B}{3}}
  \proofstep{3}{X\neq\varnothing}{%
    \FormulaRefAuto{x \notin \{a\} \eqvdash x \neq a}{5}}
  \proofstep{3}{X\subseteq A}{%
    \FormulaRefAuto{x \in \powerset(A)\eqvdash x \subseteq A}{4}}
  \proofstep{3}{\exists a\,(a\in X)}{%
    \FormulaRefAuto{A\neq\varnothing \eqvdash \exists x\,(x \in A)}{6}}

  \proofstep{9}{a\in X}{\rA}
  \proofstep{3,9}{a\in A}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{7,9}}
  \proofstep{3,9}{(X,a)\in \PowNE{A}\times A}{%
    \FormulaRefAuto{a\in A\dsep b\in B\vdash (a,b)\in A\times B}{3,10}}
  \proofstep{3,9}{(X,a)\in\{(X,a)\in\PowNE{A}\times A\mid a\in X\}}{%
      \FormulaRefAuto{x \in A\dsep P(x)\vdash x \in \{x \in A \mid P(x)\}}{11,9}}
  \proofstep{}{\ChoiceRel{A}=\{(X,a)\in\PowNE{A}\times A\mid a\in X\}}{%
      \FormulaRefAuto{\ChoiceRel{A}\coloneqq
      \{(X,a)\in \PowNE{A}\times A\mid a\in X\}}}
  \proofstep{3,9}{(X,a)\in \ChoiceRel{A}}{%
    \rIE{13,
      12}}
  \proofstep{3,9}{\exists a\,\bigl((X,a)\in \ChoiceRel{A}\bigr)}{\rEI{14}}
  \proofstep{3}{\exists a\,\bigl((X,a)\in \ChoiceRel{A}\bigr)}{\rEE{8,9,15}}
...
\proofstep{}{%
    \TotRel{\ChoiceRel{A},\PowNE{A},A}%
  }{\FormulaRefAuto{Totale Relation}{2,17}}
...
\proofpartwide{Existenz eines ausgewählten Faserminimums}
\proofstepwidestar[1]{\WellOrd{B,\preccurlyeq}}{\rA}
  ...
  \proofstepwidestar[]{L_{G,\preccurlyeq}=\{b\in B\mid\forall c\in B\,(G(c)=G(b)\rightarrow b\preccurlyeq c)\}}{%
      \FormulaRefAuto{FiberMinSet}[def]}
  \proofstepwidestar[2,5,11,15]{m\in L_{G,\preccurlyeq}}{%
    \rIE{31,30}}
  \proofstepwidestar[2,5,11,15]{%
    m\in X\land m\in L_{G,\preccurlyeq}}{\rAI{12,32}}
  \proofstepwidestar[2,5,11,15]{%
    \exists b\,(b\in X\land b\in L_{G,\preccurlyeq})}{\rEI{33}}


\closeproofpartwide

\proofpartwide{Eindeutigkeit des ausgewählten Elements}
  \setcounter{proofstepnr}{34}% Fortlaufende Schritte dieses Beweises.
\proofstepwidestar[35]{%
    n\in X\land n\in L_{G,\preccurlyeq}}{\rA}
  \proofstepwidestar[35]{n\in X}{\rAEa{35}}
  \proofstepwidestar[35]{n\in L_{G,\preccurlyeq}}{\rAEb{35}}
  \proofstepwidestar[2,5,35]{n\in B}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}{8,36}}
  \proofstepwidestar[15,35]{n\in\Fib_G(y)}{\rIE{17,36}}
  \proofstepwidestar[2,15,35]{G(n)=y}{%
    \FormulaRefAuto{y\in B\dsep x\in \Fib_F(y) \vdash F(x)=y}{%
      3,16,39}}
  \proofstepwidestar[]{L_{G,\preccurlyeq}=\{b\in B\mid\forall c\in B\,(G(c)=G(b)\rightarrow b\preccurlyeq c)\}}{%
      \FormulaRefAuto{FiberMinSet}[def]}
  ...
  \proofstepwidestar[35]{%
    ...
    \FormulaRefAuto{x \in \{u \in A \mid P(u)\}
      \eqvdash x \in A \land P(x)}{42}}
  \proofstepwidestar[35]{%
    \forall c\in B\,
      \bigl(G(c)=G(n)\rightarrow n\preccurlyeq c\bigr)}{\rAEb{43}}
  \proofstepwidestar[2,11,15,35]{G(m)=G(n)}{%
    \FormulaRefAuto{a=b,\,c=b\vdash a=c}{20,40}}
  \proofstepwidestar[2,5,11,15,35]{%
    G(m)=G(n)\rightarrow n\preccurlyeq m}{%
    \rRE{18,\rUE{44}}}
  \proofstepwidestar[2,5,11,15,35]{n\preccurlyeq m}{\rRE{45,46}}
  \proofstepwidestar[5,11,35]{m\preccurlyeq n}{%
    \rRE{36,\rUE{13}}}
  \proofstepwidestar[1,2,5,11,15,35]{m=n}{%
    \FormulaRefAuto{x\leq y\dsep y\leq x\vdash x=y}[ax]{48,47}}

\closeproofpartwide

\proofpartwide{Eindeutige Existenz in jeder Faser}
  \setcounter{proofstepnr}{49}% Fortlaufende Schritte dieses Beweises.
...
Zahlen. Band~20 behandelt endliche Mengen. Band~45 gewinnt aus
