...
\begin{tabproofsplitwide}
  \proofpartwide{Bijektivität der Translationen}
    \proofstepwidestar[1]{\FiniteSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[2]{\CancellativeSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[3]{A\neq\varnothing}{\rA}
    \proofstepwidestar[1]{\Finite{A}}{%
      \FormulaRefAuto{FiniteSemigroupFinitenessAxiom}[ax]{1}}
    \proofstepwidestar[3]{a_0\in A}{\textnormal{Wahl aus der Nichtleerheit}}
    \proofstepwidestar[1,5]{%
      L_{a_0}\colon A\to A,\quad L_{a_0}(x)=a_0\star x}{%
      \textnormal{Definition der Linkstranslation}}
    \proofstepwidestar[1,5]{%
      R_{a_0}\colon A\to A,\quad R_{a_0}(x)=x\star a_0}{%
      \textnormal{Definition der Rechtstranslation}}
    \proofstepwidestar[1,2,5]{L_{a_0}\colon A\inj A}{%
      \textnormal{Linkskürzbarkeit, 6}}
    \proofstepwidestar[1,2,5]{R_{a_0}\colon A\inj A}{%
      \textnormal{Rechtskürzbarkeit, 7}}
    \proofstepwidestar[1,2,5]{L_{a_0}\colon A\bij A}{%
      \textnormal{Endlichkeit von \(A\), 4,8}}
    \proofstepwidestar[1,2,5]{R_{a_0}\colon A\bij A}{%
      \textnormal{Endlichkeit von \(A\), 4,9}}
  \closeproofpartwide

  \proofpartwide{Konstruktion des neutralen Elements}
    \proofstepwidestar[1]{%
      \FiniteSemigroupAlg{A}{\star}\dsep
      \CancellativeSemigroupAlg{A}{\star}\dsep A\neq\varnothing}{\rA}
    \proofstepwidestar[1]{a_0\in A}{\textnormal{Wahl aus der Nichtleerheit}}
    \proofstepwidestar[1,2]{%
      L_{a_0}\colon A\bij A\land R_{a_0}\colon A\bij A}{%
      \textnormal{voriger Teil}}
    \proofstepwidestar[1,2]{%
      \begin{aligned}[t]
        &e_\ell,e_r\in A,\qquad
        a_0\star e_\ell=a_0,\qquad e_r\star a_0=a_0
      \end{aligned}}{%
      \textnormal{Surjektivität der beiden Translationen, 3}}
    \proofstepwidestar[5]{x\in A}{\rA}
    \proofstepwide[1,5]{a_0\star(e_\ell\star x)}{=}{%
      (a_0\star e_\ell)\star x}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]}
    \proofstepwide[1,5]{}{=}{a_0\star x}{\textnormal{4}}
    \proofstepwidestar[1,5]{e_\ell\star x=x}{%
      \textnormal{Linkskürzung, 6--7}}
    \proofstepwidestar[1]{\forall x\in A\,(e_\ell\star x=x)}{%
      \textnormal{Allgemeinheit von \(x\), 5--8}}
    \proofstepwide[1,5]{(x\star e_r)\star a_0}{=}{%
      x\star(e_r\star a_0)}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]}
    \proofstepwide[1,5]{}{=}{x\star a_0}{\textnormal{4}}
    \proofstepwidestar[1,5]{x\star e_r=x}{%
      \textnormal{Rechtskürzung, 10--11}}
    \proofstepwidestar[1]{\forall x\in A\,(x\star e_r=x)}{%
      \textnormal{Allgemeinheit von \(x\), 5,10--12}}
    \proofstepwide[1]{e_\ell}{=}{e_\ell\star e_r}{%
      \textnormal{Rechtsneutralität, 13}}
    \proofstepwide[1]{}{=}{e_r}{\textnormal{Linksneutralität, 9}}
    \proofstepwidestar[1]{e_\ell=e_r}{\rChain{14,15}}
    \proofstepwidestarbreak[1]{%
      \exists e\in A\,\forall x\in A\,
        (e\star x=x\land x\star e=x)}{%
      \textnormal{Setze \(e\coloneqq e_\ell=e_r\), 4,9,13,16}}
  \closeproofpartwide

  \proofpartwide{Beidseitige Inverse und Gruppenschluss}
    \proofstepwidestar[1]{%
      \FiniteSemigroupAlg{A}{\star}\dsep
      \CancellativeSemigroupAlg{A}{\star}\dsep A\neq\varnothing}{\rA}
    \proofstepwidestar[1]{%
      e\in A\land
      \forall y\in A\,(e\star y=y\land y\star e=y)}{%
      \textnormal{voriger Teil}}
    \proofstepwidestar[3]{x\in A}{\rA}
    \proofstepwidestar[1,3]{L_x\colon A\bij A\land R_x\colon A\bij A}{%
      \textnormal{Bijektivität der Translationen}}
    \proofstepwidestar[1,2,3]{%
      b,c\in A\land x\star b=e\land c\star x=e}{%
      \textnormal{Surjektivität von \(L_x\) und \(R_x\), 4}}
    \proofstepwide[1,2,3]{b}{=}{e\star b}{\textnormal{Linksneutralität, 2,5}}
    \proofstepwide[1,2,3]{}{=}{(c\star x)\star b}{\textnormal{5}}
    \proofstepwide[1,2,3]{}{=}{c\star(x\star b)}{%
      \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]}
    \proofstepwide[1,2,3]{}{=}{c\star e}{\textnormal{5}}
    \proofstepwide[1,2,3]{}{=}{c}{\textnormal{Rechtsneutralität, 2,5}}
    \proofstepwidestar[1,2,3]{b=c}{\rChain{6,7,8,9,10}}
    \proofstepwidestar[1,2,3]{b\star x=e}{\textnormal{5,11}}
    \proofstepwidestar[1,2,3]{%
      \exists y\in A\,(x\star y=e\land y\star x=e)}{%
      \textnormal{Wähle \(y=b\), 5,12}}
    \proofstepwidestar[1,2]{%
      \forall x\in A\,\exists y\in A\,
        (x\star y=e\land y\star x=e)}{%
      \textnormal{Allgemeinheit von \(x\), 3--13}}
    \proofstepwidestar[1,2]{\GroupAlg{A}{\star}{e}}{%
      \textnormal{Gruppenaxiome: Assoziativität, 2 und 14}}
    \proofstepwidestar[1]{\exists e\in A\,\GroupAlg{A}{\star}{e}}{%
      \textnormal{Existenz aus 2 und 15}}
  \closeproofpartwide
...
\ProofWideReasonsNearFormula
\begin{tabproofsplitwide}
  \proofpartwide{Linkskürzbarer Fall}
    \proofstepwidestar[1]{\FiniteSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[2]{A\neq\varnothing}{\rA}
    \proofstepwidestar[3]{\LeftCancellativeSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[4]{a\in A}{\rA}
    \proofstepwidestar[1,4]{%
      \langle a\rangle_{A,\star}
        =\{a^n\mid n\in\mathbb N\land n\neq0\}}{%
      \FormulaRefAuto{SemigroupMonogenicPowerDescription}[thm]{1,4}}
    \proofstepwidestar[1,4]{a\in\langle a\rangle_{A,\star}}{%
      \textnormal{Definition des Monogens}}
    \proofstepwidestar[1,4]{%
      \FiniteSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{Unterhalbgruppe einer endlichen Halbgruppe, 5--6}}
    \proofstepwidestar[1,3,4]{%
      \LeftCancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{Vererbung der Linkskürzbarkeit}}
    \proofstepwide[1,4]{%
      \substack{m,n\in\mathbb N,\ m\neq0,\ n\neq0\\
        a^m\star a^n}}{=}{a^{m+n}}{%
      \FormulaRefAuto{SemigroupPowerAdditionLaw}[thm]}
    \proofstepwide[1,4]{}{=}{a^{n+m}}{%
      \FormulaRefAuto{PeanoAddCommutative}[thm]}
    \proofstepwide[1,4]{}{=}{a^n\star a^m}{%
      \FormulaRefAuto{SemigroupPowerAdditionLaw}[thm]}
    \proofstepwidestar[1,4]{%
      \CommutativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{5,9--11}}
    \proofstepwidestarbreak[1,3,4]{%
      x\star z=y\star z\Longrightarrow
      z\star x=z\star y\Longrightarrow x=y}{%
      \textnormal{Kommutativität, 12; Linkskürzung, 8}}
    \proofstepwidestar[1,3,4]{%
      \RightCancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{13}}
    \proofstepwidestar[1,3,4]{%
      \CancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \FormulaRefAuto{CancellativeSemigroupDef}[def]{8,14}}
    \proofstepwidestar[1,3,4]{%
      \exists e_a\in\langle a\rangle_{A,\star}\,
        \GroupAlg{\langle a\rangle_{A,\star}}{\star}{e_a}}{%
      \textnormal{Hilfssatz über endliche kürzbare Halbgruppen, 6--7,15}}
    \proofstepwidestar[1,3]{%
      \forall a\in A\,\exists e_a\in\langle a\rangle_{A,\star}\,
        \GroupAlg{\langle a\rangle_{A,\star}}{\star}{e_a}}{%
      \textnormal{Allgemeinheit von \(a\), 4--16}}
    \proofstepwidestar[1]{%
      A=\bigcup_{a\in A}\langle a\rangle_{A,\star}}{%
      \textnormal{Jedes \(a\) liegt in seinem Monogen, 6}}
    \proofstepwidestar[1,3]{%
      \text{Die Halbgruppe }(A,\star)\text{ ist vollständig regulär}}{%
      \textnormal{Vereinigung der Untergruppen, 17--18}}
  \closeproofpartwide

  \proofpartwide{Rechtskürzbarer Fall}
    \proofstepwidestar[1]{\FiniteSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[2]{A\neq\varnothing}{\rA}
    \proofstepwidestar[3]{\RightCancellativeSemigroupAlg{A}{\star}}{\rA}
    \proofstepwidestar[4]{a\in A}{\rA}
    \proofstepwidestar[1,4]{%
      \langle a\rangle_{A,\star}
        =\{a^n\mid n\in\mathbb N\land n\neq0\}}{%
    ...
    \proofstepwidestar[1,3,4]{%
      \RightCancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{Vererbung der Rechtskürzbarkeit}}
    \proofstepwidestar[1,4]{%
      \CommutativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \FormulaRefAuto{SemigroupPowersCommute}[thm]{1,4}}
    \proofstepwidestarbreak[1,3,4]{%
      z\star x=z\star y\Longrightarrow
      x\star z=y\star z\Longrightarrow x=y}{%
      \textnormal{Kommutativität, 9; Rechtskürzung, 8}}
    \proofstepwidestar[1,3,4]{%
      \LeftCancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \textnormal{10}}
    \proofstepwidestar[1,3,4]{%
      \CancellativeSemigroupAlg{\langle a\rangle_{A,\star}}{\star}}{%
      \FormulaRefAuto{CancellativeSemigroupDef}[def]{11,8}}
    \proofstepwidestar[1,3,4]{%
      \exists e_a\in\langle a\rangle_{A,\star}\,
        \GroupAlg{\langle a\rangle_{A,\star}}{\star}{e_a}}{%
      \textnormal{Hilfssatz über endliche kürzbare Halbgruppen, 6--7,12}}
    \proofstepwidestar[1,3]{%
      \forall a\in A\,\exists e_a\in\langle a\rangle_{A,\star}\,
        \GroupAlg{\langle a\rangle_{A,\star}}{\star}{e_a}}{%
      \textnormal{Allgemeinheit von \(a\), 4--13}}
    \proofstepwidestar[1]{%
      A=\bigcup_{a\in A}\langle a\rangle_{A,\star}}{%
      \textnormal{Jedes \(a\) liegt in seinem Monogen, 6}}
    \proofstepwidestar[1,3]{%
      \text{Die Halbgruppe }(A,\star)\text{ ist vollständig regulär}}{%
      \textnormal{Vereinigung der Untergruppen, 14--15}}
  \closeproofpartwide
\end{tabproofsplitwide}
\endgroup
...
\begin{tabproofsplitwide}
  \proofpartwide{Nichtleere Träger in den Fällen (1) und (2)}
    ...
    \proofstepwidestar[1,4,5]{%
      \text{Die Halbgruppe }(A,\star)\text{ ist vollständig regulär}}{%
      \textnormal{Struktursatz über einseitige Kürzbarkeit}}
    ...
    \proofstepwidestar[1,2,3]{%
      ...
      \end{aligned}}{%
      \textnormal{im Rekonstruktionsbeweis auftretende Klassen}}
    \proofstepwidestar[1,2,8]{\Finite{C}\land\Finite{D}}{%
      \textnormal{Teilmengen endlicher Träger}}
    \proofstepwidestar[1,2,8,9]{2^{|C|}-1=2^{|D|}-1}{%
      \textnormal{Bijektivität in 8 und Anzahl nichtleerer Teilmengen}}
    \proofstepwidestar[1,2,8,9]{|C|=|D|}{%
      \textnormal{strenge Monotonie von \(n\mapsto2^n-1\), 10; kein GCH nötig}}
  ...
  \proofpartwide{Nichtleere Träger im Fall (3)}
    ...
    \proofstepwidestar[1,2,5]{%
      ...
      \end{aligned}}{%
      \textnormal{Bezeichnung der kürzbaren und der anderen Halbgruppe}}
    \proofstepwidestar[1,2,4,5,6]{%
      \FiniteSemigroupAlg{G}{\circ}\land G\neq\varnothing}{%
      \textnormal{6 und Endlichkeit der beiden Ausgangshalbgruppen}}
    \proofstepwidestar[1,2,4,5,6]{%
      e_G\in G\land\GroupAlg{G}{\circ}{e_G}}{%
      \textnormal{Wähle \(e_G\) nach dem Hilfssatz, 7}}
    \proofstepwidestar[1,2,3,6]{%
      \exists F'\,
        \SemigroupIso{F'}
          {\PowNE{G},\circ_{\mathcal P}}
          {\PowNE{S},\bullet_{\mathcal P}}}{%
      \textnormal{\(F\) oder \(F^{-1}\), gemäß der Bezeichnung in 6}}
    ...
    \proofstepwidestar[1,2,3,4,5]{(A,\star)\cong(B,\diamond)}{%
      \textnormal{Rückkehr von \(G,S\) zu \(A,B\), 6,10}}
  \closeproofpartwide
  ...
  \proofpartwide{Leere Träger und Schluss}
    ...
    \proofstepwidestar[]{%
      ...
      \textnormal{Definition von \(\PowNE{A}\)}}
    \proofstepwidestar[]{%
      \PowNE{B}=\varnothing\leftrightarrow B=\varnothing}{%
      \textnormal{Definition von \(\PowNE{B}\)}}
    \proofstepwidestar[3]{%
    ...
    \proofstepwidestar[3]{A=\varnothing\leftrightarrow B=\varnothing}{%
      \textnormal{5--7}}
    \proofstepwidestar[1,2,3]{%
      A=B=\varnothing\Longrightarrow(A,\star)\cong(B,\diamond)}{%
      \textnormal{die leere Abbildung ist ein Isomorphismus}}
    \proofstepwidestar[1,2,3,4]{%
      A\neq\varnothing\land B\neq\varnothing
        \Longrightarrow(A,\star)\cong(B,\diamond)}{%
      \textnormal{die beiden vorangehenden Teile}}
    \proofstepwidestar[1,2,3,4]{(A,\star)\cong(B,\diamond)}{%
      \textnormal{Fallunterscheidung mit 8--10}}
  \closeproofpartwide
\end{tabproofsplitwide}
\endgroup
...
Band~41 ergänzt nach Einführung der Gruppen einen weiteren vollständig
