%============================================================
%  Bd. 42 - Endliche Gruppen
%============================================================
\documentclass[main.tex]{subfiles}
\ifSubfilesClassLoaded{\BandSetupStandalone{B42}}{}
\title{Bd. 42 - Endliche Gruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{42}
\hypersetup{pdftitle={Bd. 42 - Endliche Gruppen},pdfauthor={Martin Kunze}}
\begin{document}
\title{Bd. 42 - Endliche Gruppen}
\author{Martin Kunze}
\date{}
...
\begin{tabproofsplitwide}
  \proofpartpairedindR[Das Zielquadrat ist ein Monoid]{%
    ...
    \end{aligned}}{\rA}
    \proofsteppaired[1,2,12]{Q_T^2=\PowNE H\land\MonoidAlg{Q_T^2}{\diamond_{\mathcal P}}{\{u\}}}{%
      \FormulaRefAuto{PowerSemigroupSquareMonoidForward}[thm]{1,\allowbreak 2,\allowbreak 12}}
    \proofsteppaired[1,2,12]{Q_T^2=\PowNE H}{%
      \rAEa{13}}
    \proofsteppaired[1,2,3,4,12]{%
      \SemigroupIso{F_0}{Q_G,\star_{\mathcal P}}{Q_H,\diamond_{\mathcal P}}}{\rIE{7,\allowbreak 9,\allowbreak 14}}
    ...
    \end{aligned}}{%
      \rEI{\rAI{\rAEa{12},\allowbreak \rAI{\rAEb{\rAEb{12}},\allowbreak 15}}}}
    \proofsteppaired[1,2,3,4]{\begin{aligned}[t]
      &\exists u\in H\,\bigl(\MonoidAlg{H}{\diamond}{u}\\[-2pt]
      &\quad\land\SemigroupIso{F_0}{Q_G,\star_{\mathcal P}}{Q_H,\diamond_{\mathcal P}}\bigr)
    \end{aligned}}{%
      \rEE{11,\allowbreak 12,\allowbreak 16}}
  ...
  \proofpartpaired{Gruppenstarrheit und Einermengentransport}
    ...
    \proofsteppaired[1,2,3]{\MonoidAlg{G}{\star}{e}}{%
      \FormulaRefAuto{GroupBaseMonoidAxiom}[ax]{3}}
    \proofsteppaired[1,2,3]{Q_S^2=\PowNE G\land\MonoidAlg{Q_S^2}{\star_{\mathcal P}}{\{e\}}}{%
      \FormulaRefAuto{PowerSemigroupSquareMonoidForward}[thm]{1,\allowbreak 2,\allowbreak
        18}}
    \proofsteppaired[1,2,3]{Q_S^2=\PowNE G}{%
      \rAEa{19}}
    \proofsteppaired[2]{Q_S\neq\varnothing}{\FormulaRefAuto{NonemptyPowerCarrierNonempty}[thm]{2}}
    \proofsteppaired[1,2]{\SemigroupAlg{Q_S}{\star_{\mathcal P}}}{%
      \FormulaRefAuto{NonemptyPowerSemigroup}[thm]{1}}
    \proofsteppaired[1,2]{Q_S^2\subseteq Q_S}{%
      \FormulaRefAuto{SemigroupSquareSubset}[thm]{22,\allowbreak 21}}
    \proofsteppaired[4]{F\colon Q_S\bij Q_T}{%
      \FormulaRefAuto{SemigroupIsoBijectiveAxiom}[ax]{4}}
    \proofsteppaired[4]{F\colon Q_S\to Q_T}{%
      \FormulaRefAuto{Bijektive Funktion}[def]{24}}
    \proofsteppaired[1,2,3,4,16]{F_0(\{g\})=F(\{g\})}{%
      \FormulaRefAuto{C\subseteq A\dsep x\in C\vdash F\restriction_C(x)=F(x)}[thm]{25,\allowbreak 23,\allowbreak \rIE{20,\allowbreak 17}}}
    \proofsteppaired[15,16]{F_0(\{g\})=\{\varphi(g)\}}{\rRE{\rUE{\rAEb{15}},\allowbreak 16}}
    \proofsteppaired[1,2,3,4,15,16]{F(\{g\})=\{\varphi(g)\}}{\rIE{26,\allowbreak 27}}
    \proofsteppaired[1,2,3,4,15]{\forall g\in G\,(F(\{g\})=\{\varphi(g)\})}{\rUI{\rRI{16,\allowbreak 28}}}
    ...
    \end{aligned}}{%
      \rEI{\rAI{\rAEa{9},\allowbreak \rEI{\rAI{13,\allowbreak \rAI{\rAEa{15},\allowbreak 29}}}}}}
    \proofsteppaired[1,2,3,4,6,9]{\begin{aligned}[t]
      &\exists u\in H\,\exists\varphi\,\bigl(\GroupAlg{H}{\diamond}{u}\\[-2pt]
      &\quad\land\GroupIso{\varphi}{G,\star,e}{H,\diamond,u}\\[-2pt]
      &\quad\land\forall g\in G\,(F(\{g\})=\{\varphi(g)\})\bigr)
    \end{aligned}}{\rEE{14,\allowbreak 15,\allowbreak 30}}
    \proofsteppaired[1,2,3,4,6]{\begin{aligned}[t]
      &\exists u\in H\,\exists\varphi\,\bigl(\GroupAlg{H}{\diamond}{u}\\[-2pt]
      &\quad\land\GroupIso{\varphi}{G,\star,e}{H,\diamond,u}\\[-2pt]
      &\quad\land\forall g\in G\,(F(\{g\})=\{\varphi(g)\})\bigr)
    \end{aligned}}{\rEE{8,\allowbreak 9,\allowbreak 31}}
    \proofsteppaired[1,2,3,4]{\begin{aligned}[t]
      &\exists u\in H\,\exists\varphi\,\bigl(\GroupAlg{H}{\diamond}{u}\\[-2pt]
      &\quad\land\GroupIso{\varphi}{G,\star,e}{H,\diamond,u}\\[-2pt]
      &\quad\land\forall g\in G\,(F(\{g\})=\{\varphi(g)\})\bigr)
    \end{aligned}}{\rEE{5,\allowbreak 6,\allowbreak 32}}
...
\begin{tabproofpaired}
  ...
  \proofsteppaired[3]{\MonoidAlg{G}{\star}{e}\land\MonoidAlg{H}{\diamond}{u}}{%
    \FormulaRefAuto{GroupBaseMonoidAxiom}[ax]{3}}
  \proofsteppaired[4]{\GroupHom{\varphi}{G,\star,e}{H,\diamond,u}}{%
      \FormulaRefAuto{GroupIsoDef}[def]{4}}
  \proofsteppaired[4]{\varphi\colon G\to H}{%
    \FormulaRefAuto{GroupHomFunctionAxiom}[ax]{10}}
  \proofsteppaired[4,7]{\varphi(g)\in H}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{11,\allowbreak 7}}
  \proofsteppaired[3]{e\in G\land u\in H}{\FormulaRefAuto{MonoidIdentityCarrierAxiom}[ax]{9}}
  \proofsteppaired[4]{\GroupHom{\varphi}{G,\star,e}{H,\diamond,u}}{%
      \FormulaRefAuto{GroupIsoDef}[def]{4}}
  \proofsteppaired[4]{\varphi(e)=u}{%
    \FormulaRefAuto{GroupHomIdentityPreservation}[thm]{14}}
  \proofsteppaired[3,4,6]{F(\{e\})=\{u\}}{\rIE{15,\allowbreak \rRE{\rUE{6},\allowbreak \rAEa{13}}}}
  ...
  \proofsteppaired[1,2,3,4,7]{\begin{aligned}[t]
    ...
    \end{aligned}}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{18,\allowbreak 13,\allowbreak 7,\allowbreak 12}}
  \proofsteppaired[1,2,3,4,7]{\begin{aligned}[t]
      &\{e\},\{g\}\in Q_S\\[-2pt]
      &\land\{u\},\{\varphi(g)\}\in Q_T
    \end{aligned}}{%
    \FormulaRefAuto{MonoidPowerSingletonCarrier}[thm]{19}}
  ...
  \proofsteppaired[1,2,3,4,7]{%
    ...
    \FormulaRefAuto{F\colon A\to B\dsep y\in B\vdash
      F^{-1}[\{y\}]=\{\,x\in A\mid F(x)=y\,\}}[thm]{21,\allowbreak 7,\allowbreak 12}}
  \proofsteppaired[1,2,3,7]{\SemigroupAlg{Q_S}{\star_{\mathcal P}}}{%
      \FormulaRefAuto{NonemptyPowerSemigroup}[thm]{8}}
  \proofsteppaired[1,2,3,7]{L_{Q_S}(\{e\},\{g\})=\PowNE{C_g}}{%
    ...
    \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{\allowbreak23,\allowbreak 20};\allowbreak \ \rIE{22}}
  \proofsteppaired[1,2,3,4,7]{\SemigroupAlg{Q_T}{\diamond_{\mathcal P}}}{%
      \FormulaRefAuto{NonemptyPowerSemigroup}[thm]{8}}
  \proofsteppaired[1,2,3,4,7]{\begin{aligned}[t]
      &L_{Q_T}(\{u\},\{\varphi(g)\})\\[-2pt]
      &{}=\PowNE{D_{\varphi(g)}}
    \end{aligned}}{%
    \FormulaRefAuto{MonoidSquarePowerFiber}[thm]{8,\allowbreak 2,\allowbreak 9,\allowbreak 12};\allowbreak \
    \FormulaRefAuto{SemigroupLeftEquationFiberDef}[def]{\allowbreak25,\allowbreak 20};\allowbreak \ \rIE{22}}
  \proofsteppaired[1,2,3,4,5,7]{\begin{aligned}[t]
      &F\restriction_{L_{Q_S}(\{e\},\{g\})}\colon\\[-2pt]
      &\quad L_{Q_S}(\{e\},\{g\})\\[-2pt]
      &\quad\bij L_{Q_T}(F(\{e\}),F(\{g\}))
    \end{aligned}}{%
    \FormulaRefAuto{SemigroupLeftEquationFiberTransport}[thm]{5,\allowbreak 20}}
  \proofsteppaired[1,2,3,4,5,6,7]{\begin{aligned}[t]
      &F\restriction_{\PowNE{C_g}}\colon\\[-2pt]
      &\quad\PowNE{C_g}\bij\PowNE{D_{\varphi(g)}}
    \end{aligned}}{%
    \rIE{27,\allowbreak 16,\allowbreak 17,\allowbreak 24,\allowbreak 26}}
  \proofsteppaired[1,2,3,4,5,6,7]{\PowNE{C_g}\EqCard\PowNE{D_{\varphi(g)}}}{%
    \FormulaRefAuto{A\EqCard B\coloneqq\exists F\colon A\bij B}[def]{\rEI{28}}}
  \proofsteppaired[1,2,3,4,7]{C_g\subseteq S\land D_{\varphi(g)}\subseteq T}{%
    \FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}[thm];\allowbreak \ \rIE{22}}
  \proofsteppaired[1,2,3,4,7]{\Finite S\land\Finite T}{%
      \FormulaRefAuto{FiniteSemigroupFinitenessAxiom}[ax]{1}}
  \proofsteppaired[1,2,3,4,7]{\Finite{C_g}\land\Finite{D_{\varphi(g)}}}{%
    \FormulaRefAuto{FiniteSubset}[thm]{31,\allowbreak 30}}
  \proofsteppaired[1,2,3,4,5,6,7]{\exists f_g\colon C_g\bij D_{\varphi(g)}}{%
    \FormulaRefAuto{FiniteNonemptyPowerSetReflectsBijection}[thm]{32,\allowbreak 29}}
  \proofsteppaired[1,2,3,4,5,6]{\forall g\in G\,\exists f_g\colon C_g\bij D_{\varphi(g)}}{%
    \rUI{\rRI{7,\allowbreak 33}}}
\end{tabproofpaired}
...
\begin{tabproofpaired}
  ...
  \proofsteppaired[4]{F\colon\PowNE S\bij\PowNE T}{%
      \FormulaRefAuto{SemigroupIsoBijectiveAxiom}[ax]{4}}
  \proofsteppaired[4]{F\colon\PowNE S\to\PowNE T}{%
    \FormulaRefAuto{Bijektive Funktion}[def]{8}}
  \proofsteppaired[4,7]{F(X)\in\PowNE T}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{9,\allowbreak 7}}
  ...
  \proofsteppaired[4,7]{\exists y\,(y\in F(X))}{%
    \FormulaRefAuto{A\neq\varnothing\eqvdash\exists x\,(x\in A)}[thm]{\rAEb{11}}}
  \proofsteppaired[13]{y\in F(X)}{\rA}
  \proofsteppaired[4,7,13]{y\in T}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{\rAEa{11},\allowbreak 13}}
  \proofsteppaired[4,7,13]{T\neq\varnothing}{%
    \FormulaRefAuto{A\neq\varnothing\eqvdash\exists x\,(x\in A)}[thm]{\rEI{14}}}
  \proofsteppaired[4,7]{T\neq\varnothing}{\rEE{12,\allowbreak 13,\allowbreak 15}}
  \proofsteppaired[2,4]{T\neq\varnothing}{\rEE{6,\allowbreak 7,\allowbreak 16}}
  \proofsteppaired[1,2,3,4]{\exists f\,\SemigroupIso{f}{S,\star}{T,\diamond}}{%
    \FormulaRefAuto{FiniteGroupSquarePowerSemigroupReconstruction}[thm]{1,\allowbreak 2,\allowbreak 17,\allowbreak 3,\allowbreak 4}}
\end{tabproofpaired}
