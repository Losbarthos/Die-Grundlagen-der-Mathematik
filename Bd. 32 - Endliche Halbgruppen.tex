%============================================================
%  Bd. 32 - Endliche Halbgruppen
%============================================================

\documentclass[main.tex]{subfiles}

\ifSubfilesClassLoaded{
  \BandSetupStandalone{B32}
}{
}

\title{Bd. 32 - Endliche Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{32}

\hypersetup{
  pdftitle={Bd. 32 - Endliche Halbgruppen},
...
Potenzen und die Existenz von Idempotenten.  Die Idealtheorie aus Band~23
...
Band~23 zur Verfügung.  Die Endlichkeit wird nun nur noch an den Stellen
...
Die Potenzfolge aus Band~23 beginnt beim Folgenindex \(0\), während positive
...
\begin{proof}
Nach Band~23 besteht \(\langle a\rangle_{A,\star}\) aus allen positiven
...
Kürzbarkeit und die in Band~23 eingeführten Teilbarkeitsrelationen
...
Die in Band~23 bewiesene umgekehrte Richtung gilt sogar ohne Endlichkeit:
  ...
  \proofpartwide{Nichtleere Träger im Fall (3)}
    ...
    \proofstepwidestarforcebreak[1,2,3,4,5]{%
      ...
      \begin{aligned}[t]
        ...
        &\text{in Band~35 vollständig bewiesen; Schritte 8--9}
      \end{aligned}}
...
\begin{itemize}
  \item Ohne Endlichkeitsvoraussetzung ist die allgemeine Aussage falsch.
    Das in Band~23 vollständig ausgeführte Gegenbeispiel geht zurück auf
  ...
  \item Sind beide endlichen Halbgruppen idempotent, so folgt ihre
    ...
    Band~26 enthält den Rekonstruktionsbeweis und erläutert auch, weshalb
  ...
  \item Ist eine Grundhalbgruppe eine Gruppe, darf die andere zunächst eine
    ...
    \href{https://doi.org/10.48550/arXiv.2606.01917}%
      {(Liu--Tringali, 2026)}.  Der vollständige Beweis steht in Band~35 im
...
positive Halbgruppenpotenzen aus Band~23 liefert unmittelbar
\[
...
Unterhalbgruppe aus Band~23 gilt
\[
...
beidseitiges Inverses.  In der erst in Band~35 formal eingeführten
