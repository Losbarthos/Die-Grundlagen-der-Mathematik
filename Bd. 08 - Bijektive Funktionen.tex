...
\FormulaThmDeltaK[Punktweises Kriterium für bijektive Einschränkungen]{%
  ...
  \DeltaRow{Mengen}{A\dsep B\dsep S\dsep T\dsep x\dsep y}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproofsplitwide}
  \proofpartwideindR[Aus der eingeschränkten Bijektivität]{%
    ...
    \proofstepwidestar[4]{F\restriction_S\colon S\to T}{%
      \FormulaRefAuto{Bijektive Funktion}[def]{4}}
    \proofstepwidestar[4]{F\restriction_S\colon S\sur T}{%
      \FormulaRefAuto{F\colon A\bij B\vdash F\colon A\sur B}[thm]{4}}
    ...
    \proofstepwidestar[9]{x\in S}{\rA}
    \proofstepwidestar[4,9]{(F\restriction_S)(x)\in T}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{5,9}}
    \proofstepwidestar[2,9]{(F\restriction_S)(x)=F(x)}{%
      \FormulaRefAuto{C\subseteq A\dsep x\in C\vdash
        F\restriction_C(x)=F(x)}[thm]{2,9}}
    \proofstepwidestar[2,4,9]{F(x)\in T}{\rIE{11,10}}
    \proofstepwidestar[2,4]{x\in S\rightarrow F(x)\in T}{\rRI{9,12}}
    \proofstepwidestar[14]{F(x)\in T}{\rA}
    \proofstepwidestar[4,14]{%
      \exists y\in S\,\bigl((F\restriction_S)(y)=F(x)\bigr)}{%
      \FormulaRefAuto{Surjektivität}[ax]{6,14}}
    \proofstepwidestar[16]{%
      y\in S\land (F\restriction_S)(y)=F(x)}{\rA}
    \proofstepwidestar[16]{y\in S}{\rAEa{16}}
    \proofstepwidestar[16]{(F\restriction_S)(y)=F(x)}{\rAEb{16}}
    \proofstepwidestar[2,16]{y\in A}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{2,17}}
    \proofstepwidestar[2,16]{(F\restriction_S)(y)=F(y)}{%
      \FormulaRefAuto{C\subseteq A\dsep x\in C\vdash
        F\restriction_C(x)=F(x)}[thm]{2,17}}
    \proofstepwidestar[2,16]{F(x)=F(y)}{%
      \FormulaRefAuto{a=b\dsep a=c\vdash b=c}[thm]{18,20}}
    \proofstepwidestar[1,2,8,16]{x=y}{%
      \FormulaRefAuto{Injektivität}[ax]{7,8,19,21}}
    \proofstepwidestar[1,2,8,16]{y=x}{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{22}}
    \proofstepwidestar[1,2,8,16]{x\in S}{\rIE{23,17}}
    \proofstepwidestar[1,2,4,8,14]{x\in S}{\rEE{15,16,24}}
    \proofstepwidestar[1,2,4,8]{F(x)\in T\rightarrow x\in S}{\rRI{14,25}}
    \proofstepwidestar[1,2,4,8]{x\in S\leftrightarrow F(x)\in T}{%
      \rLRI{13,26}}
  ...
  \proofpartwideindR[Aus der punktweisen Verträglichkeit]{%
    \begin{aligned}[t]
      &F\colon A\bij B\dsep S\subseteq A\dsep T\subseteq B\dsep
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Aus der eingeschränkten Bijektivität]{%
    ...
    \proofstepwidestar[1,9]{%
      ...
      \leftrightarrow
      \PowMap{F}(X)\in C}{%
      \FormulaRefAuto{RelCompNotMembership}[thm]{13}}
    \proofstepwidestar[9]{%
      X\in C\leftrightarrow X\notin\powerset(A)\setminus C}{%
      \FormulaRefAuto{P\leftrightarrow Q\vdash Q\leftrightarrow P}[thm]{12}}
    \proofstepwidestar[1,2,9]{%
      X\in C\leftrightarrow\PowMap{F}(X)\in C}{%
      \rChain{15,11,14}}
  ...
  \proofpartwideindR[Aus der \(C\)-Verträglichkeit]{%
    ...
    \proofstepwidestar[2,8]{X\in C\leftrightarrow F[X]\in C}{%
      \rRE{\rUE{2},8}}
    ...
    \proofstepwidestar[1,8]{%
      ...
      \leftrightarrow
      \PowMap{F}(X)\in C}{%
      \FormulaRefAuto{RelCompNotMembership}[thm]{14}}
    \proofstepwidestar[1,8]{%
      \PowMap{F}(X)\in C
      \leftrightarrow
      \PowMap{F}(X)\notin\powerset(B)\setminus C}{%
      \FormulaRefAuto{P\leftrightarrow Q\vdash Q\leftrightarrow P}[thm]{15}}
    \proofstepwidestar[1,2,8]{%
      X\notin\powerset(A)\setminus C
      \leftrightarrow
      \PowMap{F}(X)\notin\powerset(B)\setminus C}{%
