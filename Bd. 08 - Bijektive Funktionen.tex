...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Surjektives Verkleben]{%
    ...
    \proofstepwidestar[]{A_0\subseteq A_0\cup A_1}{%
      \FormulaRefAuto{A\subseteq A\cup B}[thm]}
    \proofstepwidestar[2,3,15]{\exists x\in A_0\cup A_1\,
    ...
    \proofstepwidestar[]{A_1\subseteq A_0\cup A_1}{%
      \FormulaRefAuto{B\subseteq A\cup B}[thm]}
    \proofstepwidestar[1,2,3,18]{\exists x\in A_0\cup A_1\,
      \CaseFun{A_0}{A_1}{f_0}{f_1}(x)=y}{%
      \FormulaRefAuto{SurjectiveBranchWitnessTransfer}[thm]{%
        8,19,6,11,12,18}}
...
\begin{tabproofwide}
  \proofstepwide[]{\CoreFamily{P}{A}}{=}{%
    \bigl\{H\in\powerset(P\cup A)\bigm|P\subseteq H\bigr\}}{%
    \FormulaRefAuto{CoreFamilyDef}[def]}
  \proofstepwide[]{}{=}{\mathfrak{I}[P,P\cup A]}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{%
      \FormulaRefAuto{BooleanSetIntervalDef}[def]}}
  \proofstepwide[]{\CoreFamily{P}{A}}{=}{\mathfrak{I}[P,P\cup A]}{%
    \rChain{1,2}}
\end{tabproofwide}
...
\begin{tabproofwide}
  \proofstepwide[]{H\in\CoreFamily{P}{A}}{\leftrightarrow}{%
    ...
    \rIE{\FormulaRefAuto{CoreFamilyBooleanInterval}[thm],
  ...
  \proofstepwide[]{H\in\CoreFamily{P}{A}}{\leftrightarrow}{%
    P\subseteq H\land H\subseteq P\cup A}{\rChain{1,2}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \CoreProofStepWideStarBreak[]{\powerset(D\cup\{k\})
  ...
  \CoreProofStepWideStarBreak[1,4,5]{%
    ...
    \end{aligned}}{%
    \FormulaRefAuto{CaseFunBijectiveDisjointTargets}[thm]{9,13,14,4}}
  ...
  \CoreProofStepWideStarBreak[1,2,4,5,6]{%
    \eta\colon\powerset(D)\bij\powerset(D\cup\{k\})}{\rIE{6,18}}

  \proofstepwidestar[]{\Id_{\mathcal O}\colon\mathcal O\to\mathcal O}{%
    \FormulaRefAuto{Bijektive Funktion}[def]{14}}
  ...
  \CoreProofStepWideStarBreak[4]{%
    ...
    \end{aligned}}{%
    \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C
      \vdash F\colon A\to C}[thm]{23,24}}

  \proofstepwidestar[26]{H\in\powerset(D)}{\rA}
  \proofstepwidestar[27]{H\notin\mathcal C}{\rA}
  \proofstepwidestar[5,26,27]{H\in\mathcal O}{%
    \FormulaRefAuto{x\in A\setminus B\eqvdash
      x\in A\land x\notin B}[thm]{\rAI{26,27},5}}
  \CoreProofStepWideStarBreak[4,5,26,27]{%
    \begin{aligned}[t]
      &\CaseFun{\mathcal O}{\mathcal C}{\Id_{\mathcal O}}{\psi}(H)\\[-2pt]
      &\qquad=\Id_{\mathcal O}(H)
    \end{aligned}}{%
    \FormulaRefAuto{f\colon A\to C\dsep g\colon B\to C\dsep x\in A
      \vdash\CaseFun{A}{B}{f}{g}(x)=f(x)}[thm]{22,25,28}}
  \proofstepwidestar[4,5,6,26,27]{\eta(H)=\Id_{\mathcal O}(H)}{%
    \rIE{6,29}}
  \proofstepwidestar[5,26,27]{\Id_{\mathcal O}(H)=H}{%
    \FormulaRefAuto{x\in A\vdash\Id_A(x)=x}[thm]{28}}
  \proofstepwidestar[4,5,6,26,27]{\eta(H)=H}{\rChain{30,31}}
  \proofstepwidestar[4,5,6,26]{%
    H\notin\mathcal C\rightarrow\eta(H)=H}{\rRI{27,32}}
  ...
  \proofstepwidestar[4,5,6]{%
    \varnothing\notin\mathcal C\rightarrow
      \eta(\varnothing)=\varnothing}{\rRE{\rUE{34},35}}
  \proofstepwidestar[3,4,5,6]{\eta(\varnothing)=\varnothing}{\rRE{36,3}}
  \CoreProofStepWideStarBreak[1,2,3,4,5,6]{%
    \begin{aligned}[t]
