...
\NewDocumentCommand{\CoreProofStepWideStarBreak}{O{} m m}{%
...
\begin{tabproofwide}
  ...
  \CoreProofStepWideStarBreak[1,2]{P\cap(A\cup\{c\})=\varnothing}{%
    \rChain{%
  ...
  \proofstepwidestar[1,2]{(P\cup\{c\})\cap A=\varnothing}{%
    \rChain{12,1}}
  \CoreProofStepWideStarBreak[2]{%
    \begin{aligned}[t]
      \CoreFamily{P}{A\cup\{c\}}
        &=\CoreFamily{P}{A}\cup\CoreFamily{P\cup\{c\}}{A}\dsep{}\\[-2pt]
      \CoreFamily{P}{A}\cap\CoreFamily{P\cup\{c\}}{A}
        &=\varnothing
    \end{aligned}}{%
    \FormulaRefAuto{CoreFamilyAdjoinedSplit}[thm]{2}}
  \proofstepwidestar[2]{%
    \CoreFamily{P}{A\cup\{c\}}
      =\CoreFamily{P}{A}\cup\CoreFamily{P\cup\{c\}}{A}}{\rAEa{14}}
  \proofstepwidestar[2]{%
    \CoreFamily{P}{A}\cap\CoreFamily{P\cup\{c\}}{A}=\varnothing}{%
    \rAEb{14}}
  \CoreProofStepWideStarBreak[1,2,4]{\CoreTransport{P}{P}{\sigma}\colon
    \CoreFamily{P}{A}\bij\CoreFamily{P}{A\cup\{c\}}}{%
    \FormulaRefAuto{CoreFamilyTransportBijective}[thm]{1,11,4}}
  \CoreProofStepWideStarBreak[1,2,3,5]{\CoreTransport{P\cup\{c\}}{Q}{\theta}\colon
    \CoreFamily{P\cup\{c\}}{A}\bij\CoreFamily{Q}{B}}{%
    \FormulaRefAuto{CoreFamilyTransportBijective}[thm]{13,3,5}}
  \CoreProofStepWideStarBreak[1,2,3,4,5,6]{%
    \begin{aligned}[t]
      &\CaseFun
        {\CoreFamily{P}{A}}
        {\CoreFamily{P\cup\{c\}}{A}}
    ...
    \end{aligned}}{%
    \FormulaRefAuto{CaseFunBijectiveDisjointTargets}[thm]{16,6,17,18}}
  \CoreProofStepWideStarBreak[1,2,3,4,5,6]{%
    \begin{aligned}[t]
      &\CaseFun
        {\CoreFamily{P}{A}}
...
\FormulaThmDeltaK[Gesch\"utzte Fortsetzung einer lokalen Potenzmengenabsorption]{%
  \begin{aligned}[t]
    ...
    &\qquad\forall H\in\powerset(D)\,
      \bigl(H\notin\mathcal C\rightarrow\eta(H)=H\bigr)\Bigr)
  \end{aligned}%
...
\begin{tabproofwide}
  ...
  \CoreProofStepWideStarBreak[4]{\psi\colon\mathcal C\bij
  ...
  \CoreProofStepWideStarBreak[1]{%
    \begin{aligned}[t]
      &\powerset(D\cup\{k\})
        =\powerset(D)\cup\mathfrak{I}[\{k\},D\cup\{k\}]\land{}\\[-2pt]
      &\powerset(D)\cap\mathfrak{I}[\{k\},D\cup\{k\}]=\varnothing
    \end{aligned}}{%
    \FormulaRefAuto{PowerSetAdjoinedPointPartition}[thm]{1}}
  \CoreProofStepWideStarBreak[1]{\powerset(D\cup\{k\})
    =\powerset(D)\cup\mathfrak{I}[\{k\},D\cup\{k\}]}{\rAEa{7}}
  \CoreProofStepWideStarBreak[1]{%
    \powerset(D)\cap\mathfrak{I}[\{k\},D\cup\{k\}]=\varnothing}{\rAEb{7}}
  ...
  \proofstepwidestar[]{%
    ...
    \FormulaRefAuto{A\subseteq A}[thm]}
  \CoreProofStepWideStarBreak[1,5]{%
    \mathcal O\cap\mathfrak{I}[\{k\},D\cup\{k\}]=\varnothing}{%
    \FormulaRefAuto{SubsetsOfDisjointSets}[thm]{11,12,9}}
  \CoreProofStepWideStarBreak[1,5]{%
    \begin{aligned}[t]
      &\mathcal O\cap
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)\\[-2pt]
      &\qquad=\varnothing
    \end{aligned}}{%
    \rChain{%
      \FormulaRefAuto{A\cap(B\cup C)=(A\cap B)\cup(A\cap C)}[thm],
  ...
  \CoreProofStepWideStarBreak[1,4,5]{%
    \begin{aligned}[t]
      &\CaseFun{\mathcal O}{\mathcal C}{\Id_{\mathcal O}}{\psi}
        \colon\mathcal O\cup\mathcal C\\[-2pt]
      &\qquad\bij\mathcal O\cup
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)
    \end{aligned}}{%
    \FormulaRefAuto{CaseFunBijectiveDisjointTargets}[thm]{10,14,15,4}}
  \CoreProofStepWideStarBreak[2,5]{\mathcal O\cup\mathcal C=\powerset(D)}{%
    \rChain{%
      \rLRS{5},
      \FormulaRefAuto{A\cup B=B\cup A}[thm],
      \FormulaRefAuto{a=b\vdash b=a}[thm]{%
        \FormulaRefAuto{UnionWithRelativeRemainder}[thm]{2}}}}
  \CoreProofStepWideStarBreak[1,2,5]{%
    \begin{aligned}[t]
      &\mathcal O\cup
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)\\[-2pt]
      &\qquad=\powerset(D\cup\{k\})
    \end{aligned}}{%
    \rChain{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{%
        \FormulaRefAuto{(A\cup B)\cup C=A\cup(B\cup C)}[thm]},
  ...
  \CoreProofStepWideStarBreak[1,2,4,5]{%
    \begin{aligned}[t]
      &\CaseFun{\mathcal O}{\mathcal C}{\Id_{\mathcal O}}{\psi}\\[-2pt]
      &\qquad\colon\powerset(D)\bij\powerset(D\cup\{k\})
    \end{aligned}}{%
    \rIE{17,18,16}}
  \CoreProofStepWideStarBreak[1,2,4,5,6]{%
    \eta\colon\powerset(D)\bij\powerset(D\cup\{k\})}{\rIE{6,19}}

  \proofstepwidestar[]{\Id_{\mathcal O}\colon\mathcal O\to\mathcal O}{%
    \FormulaRefAuto{Bijektive Funktion}[def]{15}}
  \proofstepwidestar[]{\mathcal O\subseteq
    \mathcal O\cup
      \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)}{%
    \FormulaRefAuto{A\subseteq A\cup B}[thm]}
  \CoreProofStepWideStarBreak[]{%
    \begin{aligned}[t]
      &\Id_{\mathcal O}\colon\mathcal O\to\\[-2pt]
      &\qquad\mathcal O\cup
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)
    \end{aligned}}{%
    \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C
      \vdash F\colon A\to C}[thm]{21,22}}
  \proofstepwidestar[4]{\psi\colon\mathcal C\to
    \mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]}{%
    \FormulaRefAuto{Bijektive Funktion}[def]{4}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\\[-2pt]
      &\qquad\subseteq\mathcal O\cup
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)
    \end{aligned}}{%
    \FormulaRefAuto{B\subseteq A\cup B}[thm]}
  \CoreProofStepWideStarBreak[4]{%
    \begin{aligned}[t]
      &\psi\colon\mathcal C\to\\[-2pt]
      &\qquad\mathcal O\cup
        \bigl(\mathcal C\cup\mathfrak{I}[\{k\},D\cup\{k\}]\bigr)
    \end{aligned}}{%
    \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C
      \vdash F\colon A\to C}[thm]{24,25}}

  \proofstepwidestar[27]{H\in\powerset(D)}{\rA}
  \proofstepwidestar[28]{H\notin\mathcal C}{\rA}
  \proofstepwidestar[5,27,28]{H\in\mathcal O}{%
    \FormulaRefAuto{x\in A\setminus B\eqvdash
      x\in A\land x\notin B}[thm]{\rAI{27,28},5}}
  \CoreProofStepWideStarBreak[4,5,27,28]{%
    \begin{aligned}[t]
      &\CaseFun{\mathcal O}{\mathcal C}{\Id_{\mathcal O}}{\psi}(H)\\[-2pt]
      &\qquad=\Id_{\mathcal O}(H)
    \end{aligned}}{%
    \FormulaRefAuto{f\colon A\to C\dsep g\colon B\to C\dsep x\in A
      \vdash\CaseFun{A}{B}{f}{g}(x)=f(x)}[thm]{23,26,29}}
  \proofstepwidestar[4,5,6,27,28]{\eta(H)=\Id_{\mathcal O}(H)}{%
    \rIE{6,30}}
  \proofstepwidestar[5,27,28]{\Id_{\mathcal O}(H)=H}{%
    \FormulaRefAuto{x\in A\vdash\Id_A(x)=x}[thm]{29}}
  \proofstepwidestar[4,5,6,27,28]{\eta(H)=H}{\rChain{31,32}}
  \proofstepwidestar[4,5,6,27]{%
    H\notin\mathcal C\rightarrow\eta(H)=H}{\rRI{28,33}}
  \CoreProofStepWideStarBreak[4,5,6]{%
  ...
  \proofstepwidestar[4,5,6]{%
    \varnothing\notin\mathcal C\rightarrow
      \eta(\varnothing)=\varnothing}{\rRE{\rUE{35},36}}
  \proofstepwidestar[3,4,5,6]{\eta(\varnothing)=\varnothing}{\rRE{37,3}}
  \CoreProofStepWideStarBreak[1,2,3,4,5,6]{%
    \begin{aligned}[t]
      &\bigl(\eta\colon\powerset(D)\bij\powerset(D\cup\{k\})\bigr)\\[-2pt]
      &\quad\land\Bigl(\eta(\varnothing)=\varnothing\land{}\\[-2pt]
      &\qquad\forall H\in\powerset(D)\,
        \bigl(H\notin\mathcal C\rightarrow\eta(H)=H\bigr)\Bigr)
    \end{aligned}}{%
    \rAI{20,\rAI{38,35}}}
