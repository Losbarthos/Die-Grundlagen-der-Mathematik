...
\begin{tabproofsplitwide}
  \proofpartwideindR[Urbildtransport entlang eines surjektiven Zweiges]{%
    \begin{aligned}[t]
      &f\colon A\sur B\dsep A\subseteq C\dsep G\colon C\to D\dsep
        u\in A\vdots G(u)=f(u)\mid_u\dsep y\in B\vdash{}\\[-2pt]
      &\exists x\in C\,G(x)=y
    \end{aligned}%
  }{%
    f\colon A\sur B\dsep A\subseteq C\dsep G\colon C\to D\dsep
    u\in A\vdots G(u)=f(u)\mid_u\dsep y\in B
    ...
    \proofstepwidestar[3,6]{G(x)=f(x)}{%
      \ensuremath{u\in A\vdots G(u)=f(u)\mid_u(7)}}
  ...
  \proofpartwideindR[Surjektives Verkleben]{%
    ...
    \proofstepwidestarbreakkeep[2]{f_0\colon A_0\to B_0\cup B_1}{%
      \FormulaRefAuto{BijectiveFunctionSubproofElimination}[thm]{%
        \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C\vdash
          F\colon A\to C}[thm]{%
            \FormulaRefAuto{A\subseteq A\cup B}[thm]},2}}
    \proofstepwidestarbreakkeep[3]{f_1\colon A_1\to B_0\cup B_1}{%
      \FormulaRefAuto{BijectiveFunctionSubproofElimination}[thm]{%
        \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C\vdash
          F\colon A\to C}[thm]{%
    ...
    \proofstepwidestar[2,3]{%
      ...
      \FormulaRefAuto{f\colon A\to C\dsep g\colon B\to C\vdash
        \CaseFun{A}{B}{f}{g}\colon A\cup B\to C}[thm]{4,5}}
    ...
    \proofstepwidestar[9]{x\in A_0}{\rA}
    \proofstepwidestarbreakkeep[2,3,9]{%
      \CaseFun{A_0}{A_1}{f_0}{f_1}(x)=f_0(x)}{%
      \FormulaRefAuto{f\colon A\to C\dsep g\colon B\to C\dsep x\in A
        \vdash \CaseFun{A}{B}{f}{g}(x)=f(x)}[thm]{4,5,9}}
    \proofstepwidestar[11]{x\in A_1}{\rA}
    \proofstepwidestarbreakkeep[1,2,3,11]{%
      ...
      \FormulaRefAuto{A\cap B=\varnothing\dsep f\colon A\to C\dsep
        ...
        \CaseFun{A}{B}{f}{g}(x)=g(x)}[thm]{1,4,5,11}}
    \proofstepwidestar[13]{y\in B_0\cup B_1}{\rA}
    \proofstepwidestar[13]{y\in B_0\lor y\in B_1}{%
      \FormulaRefAuto{z \in A \cup B \eqvdash z \in A \lor z \in B}{13}}
    \proofstepwidestar[15]{y\in B_0}{\rA}
    \proofstepwidestarbreakkeep[2,3,15]{\exists x\in A_0\cup A_1\,
      \CaseFun{A_0}{A_1}{f_0}{f_1}(x)=y}{%
      \FormulaRefAuto{SurjectiveBranchWitnessTransfer}[thm]{%
        7,\FormulaRefAuto{A\subseteq A\cup B}[thm],6,9,10,15}}
    \proofstepwidestar[17]{y\in B_1}{\rA}
    \proofstepwidestarbreakkeep[1,2,3,17]{\exists x\in A_0\cup A_1\,
      \CaseFun{A_0}{A_1}{f_0}{f_1}(x)=y}{%
      \FormulaRefAuto{SurjectiveBranchWitnessTransfer}[thm]{%
        8,\FormulaRefAuto{B\subseteq A\cup B}[thm],6,11,12,17}}
    \proofstepwidestar[1,2,3,13]{\exists x\in A_0\cup A_1\,
      \CaseFun{A_0}{A_1}{f_0}{f_1}(x)=y}{%
      \rOE{14,15,16,17,18}}
    \proofstepwidestar[1,2,3]{\forall y\in B_0\cup B_1\,
    ...
    \proofstepwidestar[1,2,3]{%
      \CaseFun{A_0}{A_1}{f_0}{f_1}
        \colon A_0\cup A_1\sur B_0\cup B_1}{%
      \FormulaRefAuto{Surjektive Funktion}[def]{6,20}}
  \closeproofpartwideindR
