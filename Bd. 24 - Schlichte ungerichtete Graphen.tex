...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,8]{\GraphStruct{V,E}}{%
      \FormulaRefAuto{UndirectedGraphAccess}[thm]{3}}
  \proofstepwidestar[1,2,8]{(x,x)\in\DirectedInducedEdges{E}{U}\leftrightarrow((x,x)\in E\land x\in U\land x\in U)}{%
  ...
  \proofstepwidestar[1,2,8]{%
    ...
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}[thm]{%
      10,8}}
  \proofstepwidestar[1,2,8]{(x,x)\in E}{\rAEa{11}}
  \proofstepwidestar[1,2,5,8]{\bot}{\rBI{12,7}}
  \proofstepwidestar[1,2,5]{%
    (x,x)\notin\DirectedInducedEdges{E}{U}}{\rCI{8,13}}
  \proofstepwidestar[1,2]{%
    \SimpleUndirectedGraphStruct{U,\DirectedInducedEdges{E}{U}}}{%
    \FormulaRefAuto{SimpleUndirectedGraphDef}[def]{4,14}}
\end{tabproofwide}
