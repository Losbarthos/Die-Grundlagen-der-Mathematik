...
\title{Bd. 31 - Endliche Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{31}

\hypersetup{
  pdftitle={Bd. 31 - Endliche Halbgruppen},
...
Für die in den Bänden~28--30 eingeführten Kürzbarkeitsklassen lässt sich die
  ...
  \proofpartwide{Nichtleere Träger im Fall (3)}
    ...
    \proofstepwidestarforcebreak[1,2,3,4,5]{%
      ...
      \begin{aligned}[t]
        ...
        &\text{in Band~34 vollständig bewiesen; Schritte 8--9}
      \end{aligned}}
...
\begin{itemize}
  ...
  \item Sind beide endlichen Halbgruppen idempotent, so folgt ihre
    ...
    Band~25 enthält den Rekonstruktionsbeweis und erläutert auch, weshalb
  ...
  \item Ist eine Grundhalbgruppe eine Gruppe, darf die andere zunächst eine
    ...
    \href{https://doi.org/10.48550/arXiv.2606.01917}%
      {(Liu--Tringali, 2026)}.  Der vollständige Beweis steht in Band~34 im
...
beidseitiges Inverses.  In der erst in Band~34 formal eingeführten
