...
\title{Bd. 29 - Kommutative Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{29}

\hypersetup{
  pdftitle={Bd. 29 - Kommutative Halbgruppen},
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3,4,5]{((a\star b)\star c)\star d=(a\star b)\star(c\star d)}{%
...
\begin{tabproofsplit}
  ...
  \proofpart{Assoziativität und Halbgruppenstruktur}
...
Forderung, dass \(p\) nicht jedes Element teilt. Nach der in Band~28
bewiesenen Charakterisierung durch zweiseitige Teilbarkeit ist diese
Forderung gleichbedeutend damit, dass das zweiseitige Hauptideal echt ist,
also \(J_{A,\star}(p)\subsetneq A\).
