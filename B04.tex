...
\subsection{Zur Existenz eines Vorgängers}
\FormulaThmAuto{%
...
\section{Addition als unendlicher Schnitt rekursiv abgeschlossener Relationen}
...
\FormulaThmAuto{((m,n),k)\in \mathrm{Add} \vdash ((S(m),n),S(k))\in \mathrm{Add}}[Seien \(m,n,k\in\mathbb{N}\), dann gilt:]
\begin{tabproof}
...
\begin{tabproof}
  ...
  % Basis m=0
  \proofcase[Basis]{m=0}
    \proofstep{6}{((0,n),y)\in\mathrm{Add}}{\rA}
    \proofstep{7}{((0,n),z)\in\mathrm{Add}}{\rA}
    \proofstep{6,7}{y=z}{\FormulaRefAuto{((0,x),y)\in\mathrm{Add},((0,x),z)\in\mathrm{Add}\vdash y=z}{6,7}}
