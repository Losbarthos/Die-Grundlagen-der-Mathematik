...
\newcommand{\PeanoBThreeThm}[2]{\ThmLookupEmitRefResolved{theorem}{#1}{#2}}
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.4.1}{3.19.4.1};
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.1}{3.19.5.1}.
\end{remark}

\FormulaAxiomAuto[Nachfolgerabschluss]{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.4.5}{3.19.4.5}.
\end{remark}

\FormulaAxiomAuto[Kein Nachfolger ist Null]{x\in\mathbb{N}\vdash \Succ(x) \neq 0}
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.3}{3.19.5.3};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.4}{3.19.5.4};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.5}{3.19.5.5}.
\end{remark}
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.7}{3.19.5.7};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03: \PeanoBThreeThm{thm:auto:3.19.5.8}{3.19.5.8};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
