...
\FormulaDefDeltaK[Peano-Axiome mit Nachfolgerfunktion]{%
  ...
  \DeltaRow{\makecell[l]{Nachfolger-\\funktion}}
           ...
           [\FormulaRefAutoFwd{\Succ\colon \mathbb{N}\to \mathbb{N}}[ax]]
...
\FormulaAxiomAuto[Nachfolgerfunktion]{%
  \Succ\colon \mathbb{N}\to \mathbb{N}%
}
...
% Der folgende Block stammt aus der von-Neumann-Konstruktion und ist aus den
% Peano-Axiomen allein nicht ableitbar.
\iffalse
...
% Die bis zur Rekursion folgenden Abschnitte verwenden die mengentheoretische
% Ordnung der von-Neumann-Zahlen und sind keine Peano-Folgerungen.
\iffalse
...
% Diese Zusatzformeln benutzen die zuvor ausgeblendete Vorgängerfunktion. Sie
% sind keine Folgen der Peano-Axiome allein und bleiben daher in B04 inaktiv.
\iffalse
...
% Die folgenden Injektivitätssätze stützen sich auf die ausgeblendete
% Vorgängerfunktion und die Gleichung n = Succ(Pred(n)).
\iffalse
...
% Der Endlichkeits- und Frankl-Block benutzt natürliche Zahlen als endliche
% von-Neumann-Ordinalzahlen. Ohne zusätzliches Kardinal-Nachfolgerprinzip folgt
% dieser Block nicht aus den Peano-Axiomen.
\iffalse
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1]{\Finite{\powerset(n)}}{%
      \FormulaRefAuto{P(0)\dsep [x\in\mathbb{N},P(x)]\vdots P(\Succ(x))\dsep n\in\mathbb{N} \vdash P(n)}{IA,IS,1}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproof}
  ...
  \proofstep{}{\Succ\colon\mathbb{N}\to\mathbb{N}}{%
    \FormulaRefAuto{\Succ\colon \mathbb{N}\to \mathbb{N}}[ax]}
...
% Die Stellenwertsysteme setzen die zuvor ausgeblendete Ordnung \(<_{\mathbb N}\)
% voraus. Sie werden erst wieder aktiviert, wenn diese Ordnung peano-basiert
% neu eingeführt ist.
\iffalse
