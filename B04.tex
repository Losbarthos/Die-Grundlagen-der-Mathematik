...
\FormulaThmDeltaK[Ersetzungsschema (äquivalente Funktionsform)]{%
  ...
  \DeltaRow{Mengen}{A\dsep B\dsep C\dsep x\dsep y\dsep z\dsep\vec p}
  \DeltaRow{Formel der Mengensprache}{\varphi(x,y,\vec p)}
  \DeltaRow{Wertterm (Termschema)}{t_{\varphi}}
}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Existenzrichtung \(\rightarrow\)]{%
    ...
    \proofstepwidestar[3]{%
      x\in A\land\varphi(x,y,\vec p)
    }{\rA}
    \proofstepwidestar[3]{x\in A}{\rAEa{3}}
    \proofstepwidestar[3]{\varphi(x,y,\vec p)}{\rAEb{3}}
    \proofstepwidestar[1,3]{%
      \varphi(x,y,\vec p)\leftrightarrow y=t_{\varphi}(x)
    }{\FormulaRefAuto{ReplacementValuePredicateEquivalence}{1,4}}
    \proofstepwidestar[1,3]{y=t_{\varphi}(x)}{%
      \FormulaRefAuto{P\leftrightarrow Q,\,P\vdash Q}{6,5}}
    \proofstepwidestar[1,3]{%
      x\in A\land y=t_{\varphi}(x)
    }{\rAI{4,7}}
    \proofstepwidestar[1,3]{%
      \exists x\in A\,\bigl(y=t_{\varphi}(x)\bigr)
    }{\rEI{8}}
  ...
  \proofpartwideindR[Existenzrichtung \(\leftarrow\)]{%
    ...
    \proofstepwidestar[3]{x\in A}{\rAEa{3}}
    \proofstepwidestar[3]{y=t_{\varphi}(x)}{\rAEb{3}}
    \proofstepwidestar[1,3]{%
      \varphi(x,y,\vec p)\leftrightarrow y=t_{\varphi}(x)
    }{\FormulaRefAuto{ReplacementValuePredicateEquivalence}{1,4}}
    \proofstepwidestar[1,3]{\varphi(x,y,\vec p)}{%
