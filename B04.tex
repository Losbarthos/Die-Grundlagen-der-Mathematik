...
\begin{remark}
  Herkunft in Band~03: \FormulaRefAuto[env=theorem]{\varnothing\in\mathbb{N}};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{\Succ\colon \mathbb{N}\to \mathbb{N}}.
\end{remark}
...
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{\forall x\in \mathbb{N}\,\Succ(x)\in \mathbb{N}}.
\end{remark}

\FormulaAxiomAuto[Nachfolgerabschluss]{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}.
\end{remark}

\FormulaAxiomAuto[Kein Nachfolger ist Null]{x\in\mathbb{N}\vdash \Succ(x) \neq 0}
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{x\in\mathbb{N}\vdash \Succ(x) \neq \varnothing};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{x\in\mathbb{N}\dsep x\neq \varnothing
  \vdash \exists y\in\mathbb{N}\,(x=\Succ(y))};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
...
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{x\in\mathbb{N}\dsep y\in\mathbb{N}\dsep \Succ(x)=\Succ(y)\vdash x=y}.
\end{remark}
...
\begin{remark}
  Herkunft in Band~03:
  \FormulaRefAuto[env=theorem]{P(\varnothing)\dsep
  \forall x\in\mathbb{N}\,(P(x) \rightarrow P(\Succ(x)))
  \vdash \forall x\in\mathbb{N}\,(P(x))};
  in Band~04 mit \(0\coloneqq\varnothing\).
\end{remark}
