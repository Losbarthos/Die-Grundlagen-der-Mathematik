...
\begin{tabproof}
  ...
  \proofstep{}{\NatSeg{0}=\varnothing}{%
    \FormulaRefAuto{A=\{x\in B\mid P(x)\}\dsep \forall x\in B\,\neg P(x)\vdash A=\varnothing}{2}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{i\in\NatSeg{\Succ(n)}\leftrightarrow i\in\NatSeg{n}\lor i=n}{%
    \FormulaRefAuto{x\in A\cup\{a\}\eqvdash x\in A\lor x=a}{3}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{m\leq n\leftrightarrow m<\Succ(n)}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m\leq n\leftrightarrow m<\Succ(n)}{1,2}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{B=(B\cap \NatSeg{n})\cup\{n\}}{%
    \FormulaRefAuto{PeanoNatSegSucc}{1}, \FormulaRefAuto{A=B\eqvdash A\subseteq B\land B\subseteq A}}
\end{tabproof}
...
\FormulaDefDelta[Begriff der endlichen Menge]{%
  \Finite{M}\coloneqq \exists n\in\mathbb{N}\,\bigl(\NatSeg{n} \EqCard M\bigr)
}{
  \DeltaRow{Mengen}{M\dsep n}
  \DeltaRow{\textbf{Neue Symbole}}{}
...
\FormulaThmDelta[Charakterisierung der Endlichkeit durch Bijektionen]{%
  \Finite{M}\vdash \exists n\in\mathbb{N}\,\exists F\colon \NatSeg{n}\bij M
}{%
  \DeltaRow{Mengen}{M\dsep n}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproof}
  ...
  \proofstep{3,7}{\exists F\colon \NatSeg{n}\bij M}{\rEI{7}}
  \proofstep{3,7}{\exists n\in\mathbb{N}\,\exists F\colon \NatSeg{n}\bij M}{\rEI{\rAI{4,8}}}

  \proofstep{1}{\exists n\in\mathbb{N}\,\exists F\colon \NatSeg{n}\bij M}{\rEE{2,3,9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,4}{u\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{2,1,4}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,5}{x\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{2,1,5}}
  \proofstep{1,3,6}{y\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{3,1,6}}
...
\begin{tabproof}
  ...
  \proofstep{2,3,5}{x\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{3,2,5}}
  \proofstep{1,2,3,4,5,6,7}{x=y}{%
    \FormulaRefAuto{%
      a\notin A\dsep n\in\mathbb{N}\dsep F\colon \NatSeg{n}\bij A\dsep x\in \NatSeg{n}\dsep y=n\dsep
      \ExtMap{\iota_{A,A\cup\{a\}}\circ F}{n}{a}(x)=
...
\begin{tabproof}
  ...
  \proofstep{1,6}{x<n}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{10,1,7}}
  \proofstep{1,2,6}{\ExtMap{\iota_{A,A\cup\{a\}}\circ F}{n}{a}(x)=F(x)}{%
    \FormulaRefAuto{n\in\mathbb{N}\dsep F\colon \NatSeg{n}\bij A\dsep u\in \NatSeg{n} \vdash \ExtMap{\iota_{A,A\cup\{a\}}\circ F}{n}{a}(u)=F(u)}{1,2,7}}
...
\begin{tabproof}
  ...
  \proofstep{2}{\exists n\in\mathbb{N}\,\exists F\colon \NatSeg{n}\bij A}{%
    \FormulaRefAuto{\Finite{M}\vdash \exists n\in\mathbb{N}\,\exists F\colon \NatSeg{n}\bij M}{2}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3,4}{x\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{5,1,6}}
...
\begin{tabproof}
  ...
  \proofstep{1}{\neg\exists H\colon \mathbb{N}\inj \NatSeg{n}}{\FormulaRefAuto{n\in\mathbb{N}\vdash \neg\exists F\colon \mathbb{N}\inj \NatSeg{n}}{1}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{m\in \NatSeg{n}}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m < n \leftrightarrow m\in \NatSeg{n}}{1,2,3}}
  \proofstep{1,2,3}{\NatSeg{m}\subseteq \NatSeg{n}}{%
...
\FormulaThmDeltaR[Eindeutigkeit der endlichen Kardinalzahl]{%
  ...
  n\in\mathbb{N}\dsep m\in\mathbb{N}\dsep \NatSeg{n} \EqCard M\dsep \NatSeg{m} \EqCard M \vdash n=m
}{%
...
\begin{tabproof}
  ...
  \proofstep{3,6}{n=m}{%
    \FormulaRefAuto{n\in\mathbb{N}\dsep m\in\mathbb{N}\dsep \NatSeg{n} \EqCard M\dsep \NatSeg{m} \EqCard M \vdash n=m}{4,7,5,8}}
...
\FormulaDefDelta[Kardinalzahl einer endlichen Menge]{%
  \Finite{M}\vdash \tCard(M) \coloneqq \iota n\,\bigl(n\in\mathbb{N}\land \NatSeg{n} \EqCard M\bigr)
}{%
  \DeltaRow{Mengen}{M\dsep n}
...
\begin{tabproof}
  ...
  \proofstep{1}{\tCard(M)\in\mathbb{N}\land \NatSeg{\tCard(M)}\EqCard M}{%
    \FormulaRefAuto{\Finite{M}\vdash \tCard(M) \coloneqq \iota n\,\bigl(n\in\mathbb{N}\land \NatSeg{n} \EqCard M\bigr)}{1}}
...
\FormulaDefDeltaK[Voraussetzung der Frankl-Vermutung]{%
  ...
  \DeltaRow{Endlichkeit}
           {\Finite{M}}
           [\parbox[t]{3cm}{\FormulaRefAuto{\Finite{M}\coloneqq \exists n\in\mathbb{N}\,\bigl(\NatSeg{n} \EqCard M\bigr)}}]
