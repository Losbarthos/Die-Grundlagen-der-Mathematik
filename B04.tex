...
bezeichnet. Die Eindeutigkeitsprämisse bleibt dabei als Voraussetzung der
Sequenz ausdrücklich erhalten; insbesondere bezeichnet \(B\) erst die durch
das Axiom bereitgestellte Wertemenge und nicht schon vorab eine Zielmenge
von \(F\).
...
\newpage
\FormulaThmDeltaK[Ersetzung (traditionelle Kurzform)]{%
  ...
  \bigl(
    ...
    \exists x\in A\,y=F(x)
  \bigr)%
}{ReplacementTraditionalShortForm}{%
  \DeltaRow{Mengen}{A\dsep B\dsep C\dsep u\dsep x\dsep y}
  \DeltaRow{Funktionssymbol}{F}
  \DeltaRow{Formel der Mengensprache}{%
    \varphi_F(x,y)\equiv y=F(x)}
  \DeltaRow{Wertterm (Termschema)}{t_{\varphi_F}}
}

Für den Beweis sei
\(\varphi_F(x,y)\) die Formel \(y=F(x)\).
Der zugehörige Wertterm \(t_{\varphi_F}\) wird nicht mit \(F\)
gleichgesetzt, sondern die benötigte Gleichheit wird zunächst hergeleitet.
Auch die Terminstanz \(y\coloneqq F(x)\) wird dabei nicht stillschweigend
vollzogen, sondern durch \(\forall I\) und \(\forall E\) ausgewiesen.
In den beiden Existenzrichtungen bezeichnet \(u\), im Schlussteil \(C\)
jeweils eine frische Eigenvariable.

\begin{tabproofsplitwide}
  \proofpartwideindR[Identifikation des Wertterms]{%
    \begin{aligned}[t]
      &\forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
      \dsep x\in A\vdash{}\\[-1mm]
      &\qquad t_{\varphi_F}(x)=F(x)
    \end{aligned}
  }{%
    \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    \dsep x\in A
    \vdash
    t_{\varphi_F}(x)=F(x)
  }[TraditionalValueTermEquality]
    \proofstepwidestar[1]{%
      \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    }{\rA}
    \proofstepwidestar[2]{x\in A}{\rA}
    \proofstepwidestar[1,2]{%
      y=F(x)\leftrightarrow y=t_{\varphi_F}(x)
    }{\FormulaRefAuto{ReplacementValuePredicateEquivalence}{1,2}}
    \proofstepwidestar[1,2]{%
      \forall y\,
      \bigl(y=F(x)\leftrightarrow y=t_{\varphi_F}(x)\bigr)
    }{\rUI{3}}
    \proofstepwidestar[1,2]{%
      F(x)=F(x)\leftrightarrow F(x)=t_{\varphi_F}(x)
    }{\rUE{4}}
    \proofstepwidestar[]{F(x)=F(x)}{\rII}
    \proofstepwidestar[1,2]{F(x)=t_{\varphi_F}(x)}{%
      \FormulaRefAuto{P\leftrightarrow Q,\,P\vdash Q}{5,6}}
    \proofstepwidestar[1,2]{t_{\varphi_F}(x)=F(x)}{%
  ...
  \proofpartwideindR[Existenzrichtung \(\rightarrow\)]{%
    \begin{aligned}[t]
      &\forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)\vdash{}\\[-1mm]
      &\quad
      \exists x\in A\,\bigl(y=t_{\varphi_F}(x)\bigr)
      \rightarrow
    ...
    \rightarrow
    \exists x\in A\,\bigl(y=F(x)\bigr)
  }[TraditionalValueExistentialForward]
    \proofstepwidestar[1]{%
      \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    }{\rA}
    \proofstepwidestar[2]{%
    ...
    \proofstepwidestar[3]{%
      u\in A\land y=t_{\varphi_F}(u)
    }{\rA}
    \proofstepwidestar[3]{u\in A}{\rAEa{3}}
    \proofstepwidestar[3]{y=t_{\varphi_F}(u)}{\rAEb{3}}
    \proofstepwidestar[1,3]{t_{\varphi_F}(u)=F(u)}{%
      \FormulaRefAuto{TraditionalValueTermEquality}{1,4}}
    \proofstepwidestar[1,3]{y=F(u)}{\rIE{6,5}}
    \proofstepwidestar[1,3]{u\in A\land y=F(u)}{\rAI{4,7}}
    \proofstepwidestar[1,3]{%
      \exists x\in A\,\bigl(y=F(x)\bigr)
    }{\rEI{8}}
    \proofstepwidestar[1,2]{%
  ...
  \proofpartwideindR[Existenzrichtung \(\leftarrow\)]{%
    ...
    \rightarrow
    \exists x\in A\,\bigl(y=t_{\varphi_F}(x)\bigr)
  }[TraditionalValueExistentialBackward]
    \proofstepwidestar[1]{%
      \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    }{\rA}
    \proofstepwidestar[2]{%
    ...
    \proofstepwidestar[3]{u\in A\land y=F(u)}{\rA}
    \proofstepwidestar[3]{u\in A}{\rAEa{3}}
    \proofstepwidestar[3]{y=F(u)}{\rAEb{3}}
    \proofstepwidestar[1,3]{t_{\varphi_F}(u)=F(u)}{%
      \FormulaRefAuto{TraditionalValueTermEquality}{1,4}}
    \proofstepwidestar[1,3]{F(u)=t_{\varphi_F}(u)}{%
      \FormulaRefAuto{a=b\vdash b=a}{6}}
    \proofstepwidestar[1,3]{y=t_{\varphi_F}(u)}{\rIE{7,5}}
    \proofstepwidestar[1,3]{%
      u\in A\land y=t_{\varphi_F}(u)
    }{\rAI{4,8}}
    \proofstepwidestar[1,3]{%
  ...
  \proofpartwideindR[Existenzielle Charakterisierung]{%
    ...
    \leftrightarrow
    \exists x\in A\,\bigl(y=F(x)\bigr)
  }[TraditionalValueExistentialEquivalence]
    \proofstepwidestar[1]{%
      \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    }{\rA}
    \proofstepwidestar[1]{%
      ...
      \rightarrow
      \exists x\in A\,\bigl(y=F(x)\bigr)
    }{\FormulaRefAuto{TraditionalValueExistentialForward}{1}}
    \proofstepwidestar[1]{%
      \exists x\in A\,\bigl(y=F(x)\bigr)
      \rightarrow
      \exists x\in A\,\bigl(y=t_{\varphi_F}(x)\bigr)
    }{\FormulaRefAuto{TraditionalValueExistentialBackward}{1}}
    \proofstepwidestar[1]{%
      \exists x\in A\,\bigl(y=t_{\varphi_F}(x)\bigr)
      \leftrightarrow
      \exists x\in A\,\bigl(y=F(x)\bigr)
  ...
  \proofpartwideindR[Mengencharakterisierung]{%
    ...
    \Bigl(
      ...
      \exists x\in A\,\bigl(y=F(x)\bigr)
    \Bigr)
  }[TraditionalValueSetCharacterization]
    \proofstepwidestar[1]{%
      \forall x\in A\,\exists!y\,\bigl(y=F(x)\bigr)
    }{\rA}
    \proofstepwidestar[2]{%
    ...
    \proofstepwidestar[1]{%
      ...
      \leftrightarrow
      \exists x\in A\,\bigl(y=F(x)\bigr)
    }{\FormulaRefAuto{TraditionalValueExistentialEquivalence}{1}}
    \proofstepwidestar[1,2]{%
      y\in C\leftrightarrow
      \exists x\in A\,\bigl(y=F(x)\bigr)
    }{%
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[1,3]{%
      ...
      \Bigl(
        ...
        \exists x\in A\,\bigl(y=F(x)\bigr)
      \Bigr)
    }{\FormulaRefAuto{TraditionalValueSetCharacterization}{1,3}}
    \proofstepwidestar[1,3]{%
      \exists B\,\forall y\,
      \Bigl(
        y\in B\leftrightarrow
...
Die Gleichheit \(t_{\varphi_F}(x)=F(x)\) ist damit keine bloße
Umbenennung. Sie wird im ersten Beweisteil gewonnen und in den beiden
Existenzrichtungen ausdrücklich durch \(=E\) verwendet.
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \Bigl(
      ...
      \exists x\in A\,\bigl(y=F(x)\bigr)
    \Bigr)
  }{\FormulaRefAuto{ReplacementTraditionalShortForm}[thm]{9}}
\end{tabproof}

Der letzte Schritt verwendet somit nicht unmittelbar
\FormulaRefAuto{ReplacementFunctionSchema}. Zeile~9 erfüllt vielmehr genau
die Eindeutigkeitsprämisse der traditionellen Kurzform
\FormulaRefAuto{ReplacementTraditionalShortForm}; deren Schlussformel ist
Zeile~10.
