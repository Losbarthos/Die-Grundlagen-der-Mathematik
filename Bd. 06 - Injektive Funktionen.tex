...
\begin{tabproofsplitwide}
  \proofpartwideindR[Teilmengenrichtung \(X\subseteq Y\)]{%
    ...
    \proofstepwidestar[1,2,3,4]{X\subseteq Y}{%
      \FormulaRefAuto{SubsetIntroductionRule}[thm]{[7]\vdots 11}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3,9,10}{\exists x\in A\cap B\,y=F(x)}{%
    \rEI{\rAI{11,\rAEb{9}}}}
  \proofstep{}{A \cap B \subseteq A}{%
      \FormulaRefAuto{A\cap B\subseteq A}}
  \proofstep{2}{A \cap B \subseteq M}{%
  ...
  \proofstep{1,2,3,9,10}{y\in F[A\cap B]}{%
    \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep \exists x\in C\,y=F(x)\vdash y\in F[C]}{%
      14,%
      6,12}}
  \proofstep{1,2,3,5,9}{y\in F[A\cap B]}{\rEE{8,10,15}}
  \proofstep{1,2,3,4,5}{y\in F[A\cap B]}{\rEE{7,9,16}}
\end{tabproof}
...
\begin{tabproofsplit}
\proofpart{Funktionstyp im kleineren Zielbereich}
\proofstep{1}{F\colon A\inj B}{\rA}
...
\begin{tabproofsplit}
\proofpart{Funktionstyp im größeren Zielbereich}
\proofstep{1}{F\colon A\inj B}{\rA}
...
\begin{tabproof}
  ...
  \proofstep{}{\forall t\in A\,((G\circ F)(t)=G(F(t)))}{%
      \FormulaRefAuto{x\in A \vdash (G\circ F)(x)=G(F(x))}}
  \proofstep{1}{G(F(x))=G(F(y))}{\rIE{6,1}}
  \proofstep{1,2,3}{F(x)=F(y)}{\FormulaRefAuto{Injektivität}{4,5,7}}
  \proofstep{1,2,3}{x=y}{\FormulaRefAuto{Injektivität}{2,3,8}}
\end{tabproof}
...
\proofstep{4}{X\in \FamAvoiding{M}{a}}{\rA}
  ...
  \proofstep{1,2,4,5,6}{X=Y}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep
    X\cup\{a\}=Y\cup\{a\}\vdash X=Y}{13,15,11}}
