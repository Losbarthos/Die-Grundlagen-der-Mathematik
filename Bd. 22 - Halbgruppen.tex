...
\title{Bd. 22 - Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{22}

\hypersetup{
  pdftitle={Bd. 22 - Halbgruppen},
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{%
    \begin{aligned}[t]
      (a\star b)\star\bigl((c\star d)\star e\bigr)
      &= (a\star b)\star\bigl(c\star(d\star e)\bigr)\\[-2pt]
      &= \bigl((a\star b)\star c\bigr)\star(d\star e)\\[-2pt]
      &= \bigl(((a\star b)\star c)\star d\bigr)\star e\\[-2pt]
      &= \bigl((a\star(b\star c))\star d\bigr)\star e
    \end{aligned}}{%
    \text{Schritte 6--9; Gleichheitssubstitution und Transitivität}}
\end{tabproofwide}
