...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \Succ(a)+b=\Succ(a+b)\vdash
    \Succ(a)+(b+1)=\Succ(a+(b+1))
  }{%
    a\in\mathbb{N}\dsep b\in\mathbb{N}\dsep
    \Succ(a)+b=\Succ(a+b)\vdash
    ...
    \proofstepwidestar[3]{\Succ(a)+b=\Succ(a+b)}{\rA}
    \proofstepwidestar[1]{\Succ(a)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1,2]{\Succ(a)+\Succ(b)=\Succ(\Succ(a)+b)}{%
      \hspace{0.8em}\FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{4,2}}
    \proofstepwidestar[3]{\Succ(\Succ(a)+b)=\Succ(\Succ(a+b))}{\hspace{0.8em}\rIE{3}}
    \proofstepwidestar[1,2,3]{\Succ(a)+\Succ(b)=\Succ(\Succ(a+b))}{%
      \hspace{0.8em}\FormulaRefAuto{a = b,\, b = c \vdash a = c}{5,6}}
    \proofstepwidestar[1,2]{a+\Succ(b)=\Succ(a+b)}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{1,2}}
    \proofstepwidestar[1,2]{\Succ(a+\Succ(b))=\Succ(\Succ(a+b))}{\hspace{0.8em}\rIE{8}}
    \proofstepwidestar[1,2]{\Succ(\Succ(a+b))=\Succ(a+\Succ(b))}{%
    ...
    \proofstepwidestar[2]{b+1=\Succ(b)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{\Succ(a)+(b+1)=\Succ(a+(b+1))}{\rIE{12,11}}
  \closeproofpartwideindR
...
\FormulaThmDeltaK[Linke Additionsregel mit \(+1\)]{%
  a\in\mathbb N\dsep b\in\mathbb N\vdash (a+1)+b=(a+b)+1
}{PeanoAddOneAddLeft}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproof}
  \proofstep{1}{a\in\mathbb N}{\rA}
  \proofstep{2}{b\in\mathbb N}{\rA}
  \proofstep{1}{a+1=\Succ(a)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{1}}
  \proofstep{1,2}{\Succ(a)+b=\Succ(a+b)}{\FormulaRefAuto{PeanoAddSuccLeft}[thm]{1,2}}
  \proofstep{1,2}{a+b\in\mathbb N}{\FormulaRefAuto{PeanoAddClosure}[thm]{1,2}}
  \proofstep{1,2}{(a+b)+1=\Succ(a+b)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{5}}
  \proofstep{1,2}{(a+1)+b=(a+b)+1}{\rIE{6,\rIE{3,4}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{3}{r\neq0}{\rA}
  \proofstep{1,3}{\exists k\in\mathbb N\,(r=\Succ(k))}{%
    \FormulaRefAuto{PeanoNonzeroIsSucc}[ax]{1,3}}
  \proofstep{5}{k\in\mathbb N\land r=\Succ(k)}{\rA}
  \proofstep{2,5}{k+s\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddClosure}[thm]{\rAEa{5},2}}
  \proofstep{2,5}{\Succ(k)+s=\Succ(k+s)}{%
    \FormulaRefAuto{PeanoAddSuccLeft}[thm]{\rAEa{5},2}}
  \proofstep{2,5}{r+s=\Succ(k+s)}{\rIE{\rAEb{5},7}}
  \proofstep{2,5}{\Succ(k+s)\neq0}{%
    \FormulaRefAuto{PeanoSuccNonzero}[ax]{6}}
  \proofstep{2,5}{r+s\neq0}{\rIE{8,9}}
  \proofstep{1,2,3}{r+s\neq0}{\rEE{4,5,10}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \begin{aligned}[t]
      &m,n\in\mathbb{N}\dsep
      (m\in n\rightarrow m\subseteq n)\vdash{}\\[-2pt]
      &m\in\Succ(n)\rightarrow m\subseteq\Succ(n)
    \end{aligned}%
  }[NaturalOrderMemberSubsetStep]
    \proofstepwidestar[1]{m\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{m\in n\rightarrow m\subseteq n}{\rA}
    \proofstepwidestar[4]{m\in\Succ(n)}{\rA}
    \proofstepwidestar[2,4]{m\in n\lor m=n}{%
      \FormulaRefAuto{n\in\mathbb{N}\dsep x\in\Succ(n)
        \vdash x\in n\lor x=n}[thm]{2,4}}
    \proofstepwidestar[2]{n\subseteq\Succ(n)}{%
      \FormulaRefAuto{n\in\mathbb{N}\vdash n\subseteq\Succ(n)}[thm]{2}}
    \proofstepwidestar[7]{m\in n}{\rA}
    \proofstepwidestar[3,7]{m\subseteq n}{\rRE{3,7}}
    \proofstepwidestar[2,3,7]{m\subseteq\Succ(n)}{%
    ...
    \proofstepwidestar[2,10]{m\subseteq\Succ(n)}{%
      \FormulaRefAuto{A \subseteq B, B \subseteq C
        \vdash A \subseteq C}[thm]{11,6}}
    \proofstepwidestar[2,3,4]{m\subseteq\Succ(n)}{%
      \rOE{5,7,9,10,12}}
    \proofstepwidestar[1,2,3]{%
      m\in\Succ(n)\rightarrow m\subseteq\Succ(n)}{\rRI{4,13}}
    \proofstepwidestar[2]{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{%
...
\FormulaThmDeltaK[Nachfolger eines natürlichen Elements liegt als Teilmenge im Träger]{%
  m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n
  \vdash \Succ(m)\subseteq n%
}{NaturalOrderMemberSuccessorSubset}{%
  \DeltaRow{Mengen}{m\dsep n}%
}
\begin{tabproof}
  \proofstep{1}{m\in\mathbb{N}}{\rA}
  ...
  \proofstep{1}{\Succ(m)=m\cup\{m\}}{%
    \FormulaRefAuto{x\in\mathbb{N}\vdash
      \Succ(x)=x\cup\{x\}}[thm]{1}}
  \proofstep{1,2,3}{\Succ(m)\subseteq n}{\rIE{7,6}}
\end{tabproof}

\FormulaThmDeltaK[Natürliche Zahl liegt in ihrem Nachfolger]{%
  n\in\mathbb{N}\vdash n\in\Succ(n)%
}{NaturalOrderElementInSuccessor}{%
  \DeltaRow{Mengen}{n}%
}
\begin{tabproof}
  \proofstep{1}{n\in\mathbb{N}}{\rA}
  \proofstep{1}{\Succ(n)=n\cup\{n\}}{%
    \FormulaRefAuto{x\in\mathbb{N}\vdash
      \Succ(x)=x\cup\{x\}}[thm]{1}}
  \proofstep{1}{n\cup\{n\}=\Succ(n)}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{2}}
  \proofstep{}{n\in\{n\}}{\FormulaRefAuto{a\in\{a\}}[thm]}
  \proofstep{}{n\in n\cup\{n\}}{%
    \FormulaRefAuto{u\in B\vdash u\in A\cup B}[thm]{4}}
  \proofstep{1}{n\in\Succ(n)}{\rIE{3,5}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2]{a+b\subseteq\Succ(a+b)}{%
      \FormulaRefAuto{n\in\mathbb{N}\vdash n\subseteq\Succ(n)}{4}}
    \proofstepwidestar[1,2,3]{a\subseteq\Succ(a+b)}{%
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}{3,5}}
    \proofstepwidestar[1,2]{a+\Succ(b)=\Succ(a+b)}{%
      \FormulaRefAuto{PeanoAddSuccRight}[thm]{1,2}}
    \proofstepwidestar[1,2]{\Succ(a+b)=a+\Succ(b)}{%
      \FormulaRefAuto{a=b\vdash b=a}{7}}
    \proofstepwidestar[1,2,3]{a\subseteq a+\Succ(b)}{\rIE{8,6}}
    \proofstepwidestar[2]{b+1=\Succ(b)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \begin{aligned}[t]
      ...
      \bigl(m\leq_{\mathbb{N}}n\leftrightarrow
      \exists k\in\mathbb{N}\,(m+k=n)\bigr)\vdash{}\\[-2pt]
      &m\leq_{\mathbb{N}}\Succ(n)\leftrightarrow
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))
    \end{aligned}%
    ...
    \proofstepwidestar[2]{\Succ(n)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}[thm]{2}}

    \proofstepwidestar[5]{m\leq_{\mathbb{N}}\Succ(n)}{\rA}
    \proofstepwidestar[1,2,5]{m\subseteq\Succ(n)}{%
    ...
    \proofstepwidestar[2]{\Succ(n)=n\cup\{n\}}{%
      \FormulaRefAuto{x\in\mathbb{N}\vdash
        \Succ(x)=x\cup\{x\}}[thm]{2}}
    \proofstepwidestar[1,2,8]{\Succ(n)\subseteq m}{\rIE{12,11}}
    \proofstepwidestar[1,2,5,8]{m=\Succ(n)}{%
      \FormulaRefAuto{A \subseteq B, B \subseteq A
        \vdash A = B}[thm]{6,13}}
    \proofstepwidestar[1]{m+0=m}{%
      \FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
    \proofstepwidestar[1,2,5,8]{m+0=\Succ(n)}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}[thm]{15,14}}
    \proofstepwidestar[1,2,5,8]{%
      0\in\mathbb{N}\land m+0=\Succ(n)}{\rAI{%
        \FormulaRefAuto{PeanoZero}[ax],16}}
    \proofstepwidestar[1,2,5,8]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rEI{17}}

    \proofstepwidestar[19]{n\notin m}{\rA}
    \proofstepwidestar[1,2,5,19]{m\subseteq n}{%
      \FormulaRefAuto{n\in\mathbb{N}\dsep B\subseteq\Succ(n)
        \dsep n\notin B\vdash B\subseteq n}[thm]{2,6,19}}
    ...
    \proofstepwidestar[23]{\Succ(k)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}[thm]{24}}
    \proofstepwidestar[1,23]{m+\Succ(k)=\Succ(m+k)}{%
      \FormulaRefAuto{PeanoAddSuccRight}[thm]{1,24}}
    \proofstepwidestar[23]{\Succ(m+k)=\Succ(n)}{\rIE{25}}
    \proofstepwidestar[1,23]{m+\Succ(k)=\Succ(n)}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}[thm]{27,28}}
    \proofstepwidestar[1,23]{%
      \Succ(k)\in\mathbb{N}\land m+\Succ(k)=\Succ(n)}{\rAI{26,29}}
    \proofstepwidestar[1,23]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rEI{30}}
    \proofstepwidestar[1,2,3,5,19]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rEE{22,23,31}}
    \proofstepwidestar[1,2,3,5]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{%
      \rOE{7,8,18,19,32}}
    \proofstepwidestar[1,2,3]{%
      m\leq_{\mathbb{N}}\Succ(n)\rightarrow
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rRI{5,33}}

    \proofstepwidestar[35]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rA}
    \proofstepwidestar[36]{k\in\mathbb{N}\land m+k=\Succ(n)}{\rA}
    \proofstepwidestar[36]{k\in\mathbb{N}}{\rAEa{36}}
    \proofstepwidestar[36]{m+k=\Succ(n)}{\rAEb{36}}
    \proofstepwidestar[1,36]{m\subseteq m+k}{%
      \FormulaRefAuto{PeanoAddLeftSubset}[thm]{1,37}}
    \proofstepwidestar[1,36]{m\subseteq\Succ(n)}{\rIE{38,39}}
    \proofstepwidestar[1,2,36]{m\leq_{\mathbb{N}}\Succ(n)}{%
      \FormulaRefAuto{NaturalOrderOperator}[def]{1,4,40}}
    \proofstepwidestar[1,2,35]{m\leq_{\mathbb{N}}\Succ(n)}{%
      \rEE{35,36,41}}
    \proofstepwidestar[1,2,3]{%
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))
      \rightarrow m\leq_{\mathbb{N}}\Succ(n)}{\rRI{35,42}}
    \proofstepwidestar[1,2,3]{%
      m\leq_{\mathbb{N}}\Succ(n)\leftrightarrow
      \exists k\in\mathbb{N}\,(m+k=\Succ(n))}{\rLRI{34,43}}
    \proofstepwidestar[2]{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{%
      m\leq_{\mathbb{N}}(n+1)\leftrightarrow
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Hinrichtung]{%
    ...
    \proofstepwidestar[1]{\Succ(m)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}[thm]{1}}
    \proofstepwidestar[1,2,3]{\Succ(m)\subseteq n}{%
      \FormulaRefAuto{NaturalOrderMemberSuccessorSubset}[thm]{1,2,4}}
    \proofstepwidestar[1,2,3]{\Succ(m)\leq_{\mathbb{N}}n}{%
    ...
    \proofstepwidestar[9]{k\in\mathbb{N}\land\Succ(m)+k=n}{\rA}
    \proofstepwidestar[9]{k\in\mathbb{N}}{\rAEa{9}}
    \proofstepwidestar[9]{\Succ(m)+k=n}{\rAEb{9}}
    \proofstepwidestar[1,9]{\Succ(m)+k=\Succ(m+k)}{%
      \FormulaRefAuto{PeanoAddSuccLeft}[thm]{1,10}}
    \proofstepwidestar[1,9]{m+\Succ(k)=\Succ(m+k)}{%
      \FormulaRefAuto{PeanoAddSuccRight}[thm]{1,10}}
    \proofstepwidestar[1,9]{\Succ(m+k)=\Succ(m)+k}{%
      \FormulaRefAuto{a=b\vdash b=a}{12}}
    \proofstepwidestar[1,9]{m+\Succ(k)=\Succ(m)+k}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}{13,14}}
    \proofstepwidestar[1,9]{m+\Succ(k)=n}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}{15,11}}
    \proofstepwidestar[1,9]{%
      k\in\mathbb{N}\land m+\Succ(k)=n}{\rAI{10,16}}
    \proofstepwidestar[1,9]{%
      \exists k\in\mathbb{N}\,(m+\Succ(k)=n)}{\rEI{17}}
    \proofstepwidestar[1,2,3]{%
      \exists k\in\mathbb{N}\,(m+\Succ(k)=n)}{\rEE{8,9,18}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Rückrichtung]{%
    ...
    \proofstepwidestar[2]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{%
      \exists k\in\mathbb{N}\,(m+\Succ(k)=n)}{\rA}
    \proofstepwidestar[4]{k\in\mathbb{N}\land m+\Succ(k)=n}{\rA}
    \proofstepwidestar[4]{k\in\mathbb{N}}{\rAEa{4}}
    \proofstepwidestar[4]{m+\Succ(k)=n}{\rAEb{4}}
    \proofstepwidestar[1,4]{\Succ(m)+k=\Succ(m+k)}{%
      \FormulaRefAuto{PeanoAddSuccLeft}[thm]{1,5}}
    \proofstepwidestar[1,4]{m+\Succ(k)=\Succ(m+k)}{%
      \FormulaRefAuto{PeanoAddSuccRight}[thm]{1,5}}
    \proofstepwidestar[1,4]{\Succ(m+k)=m+\Succ(k)}{%
      \FormulaRefAuto{a=b\vdash b=a}{8}}
    \proofstepwidestar[1,4]{\Succ(m)+k=m+\Succ(k)}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}{7,9}}
    \proofstepwidestar[1,4]{\Succ(m)+k=n}{%
      \FormulaRefAuto{a=b\dsep b=c\vdash a=c}{10,6}}
    \proofstepwidestar[1,4]{%
      k\in\mathbb{N}\land\Succ(m)+k=n}{\rAI{5,11}}
    \proofstepwidestar[1,4]{%
      \exists k\in\mathbb{N}\,(\Succ(m)+k=n)}{\rEI{12}}
    \proofstepwidestar[1]{\Succ(m)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}[thm]{1}}
    \proofstepwidestar[1,2,4]{\Succ(m)\leq_{\mathbb{N}}n}{%
      \FormulaRefAuto{NaturalOrderAdditiveCharacterization}[thm]{14,2,13}}
    \proofstepwidestar[1,2,4]{\Succ(m)\subseteq n}{%
      \FormulaRefAuto{NaturalOrderOperator}[def]{14,2,15}}
    \proofstepwidestar[1]{m\in\Succ(m)}{%
      \FormulaRefAuto{NaturalOrderElementInSuccessor}[thm]{1}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{m<_{\mathbb{N}}n
      \leftrightarrow \exists k\in\mathbb{N}\,(m+\Succ(k)=n)}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1]{m\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{k\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{m+\Succ(k)\neq m}{\rA}
    \proofstepwidestar[4]{\Succ(m)+\Succ(k)=\Succ(m)}{\rA}
    \proofstepwidestarbreak[1]{\Succ(m)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestarbreak[1,2]{\Succ(m)+\Succ(k)=\Succ(m+\Succ(k))}{%
      \FormulaRefAuto{PeanoAddSuccLeft}{1,%
        \FormulaRefAuto{PeanoSuccClosure}{2}}}
    \proofstepwidestarbreak[1,2,4]{\Succ(m+\Succ(k))=\Succ(m)}{%
      \FormulaRefAuto{a=b\dsep a=c\vdash b=c}{6,4}}
    \proofstepwidestarbreak[1,2,4]{m+\Succ(k)=m}{%
      \FormulaRefAuto{PeanoSuccInjective}{%
        \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash a+b\in\mathbb{N}}{1,%
          \FormulaRefAuto{PeanoSuccClosure}{2}},1,7}}
    \proofstepwidestarbreak[1,2,3,4]{\bot}{\rBI{8,3}}
    \proofstepwidestarbreak[1,2,3]{\Succ(m)+\Succ(k)\neq \Succ(m)}{\rCI{4,9}}
    \proofstepwidestarbreak[1]{m+1=\Succ(m)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{1}}
  \proofstepwidestarbreak[1,2,3]{(m+1)+\Succ(k)\neq (m+1)}{\rIE{11,10}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[4]{m\leq n}{\rA}
    \proofstepwidestar[1,2,4]{m\leq \Succ(n)}{%
      \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\leq n
        \vdash m\leq \Succ(n)}{1,2,4}}
    \proofstepwidestar[1,2,4]{m\leq \Succ(n)\lor \Succ(n)\leq m}{\rOIa{5}}
    \proofstepwidestar[7]{n\leq m}{\rA}
    \proofstepwidestar[1,2,7]{m\leq \Succ(n)\lor \Succ(n)\leq m}{%
      \FormulaRefAuto{n\in\mathbb{N}\dsep m\in\mathbb{N}\dsep n\leq m
        \vdash m\leq \Succ(n)\lor \Succ(n)\leq m}{2,1,7}}
    \proofstepwidestar[1,2,3]{m\leq \Succ(n)\lor \Succ(n)\leq m}{%
      \rOE{3,4,6,7,8}}
    \proofstepwidestar[2]{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
...
\begin{tabproofwide}
  \proofstepwidestar[1]{a\in\mathbb{N}}{\rA}
  \proofstepwidestarbreak[]{\Succ\colon\mathbb{N}\to\mathbb{N}}{\FormulaRefAuto{PeanoSuccFunction}[ax]}
  \proofstepwidestarbreak[1]{\RecFun{a}{\Succ}\colon\mathbb{N}\to\mathbb{N}}{%
    \FormulaRefAuto{m_0\in M\dsep f\colon M\to M\vdash
      \RecFun{m_0}{f}\colon\mathbb{N}\to M}{1,2}}
  \proofstepwidestar[4]{x\in\mathbb{N}}{\rA}
  \proofstepwidestar[5]{y\in\mathbb{N}}{\rA}
  \proofstepwidestar[6]{\RecFun{a}{\Succ}(x)=\RecFun{a}{\Succ}(y)}{\rA}
  \proofstepwidestarbreak[1,4]{a+x=\RecFun{a}{\Succ}(x)}{%
    \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      a+b\coloneqq\RecFun{a}{\Succ}(b)}{1,4}}
  \proofstepwidestarbreak[1,5]{a+y=\RecFun{a}{\Succ}(y)}{%
    \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      a+b\coloneqq\RecFun{a}{\Succ}(b)}{1,5}}
  \proofstepwidestarbreak[1,5]{\RecFun{a}{\Succ}(y)=a+y}{\FormulaRefAuto{a=b\vdash b=a}{8}}
  \proofstepwidestarbreak[1,4,5,6]{a+x=\RecFun{a}{\Succ}(y)}{%
  ...
  \proofstepwidestarbreak[1,4,5]{\RecFun{a}{\Succ}(x)=\RecFun{a}{\Succ}(y)\rightarrow x=y}{\rRI{6,12}}
  ...
  \proofstepwidestarbreak[1]{\RecFun{a}{\Succ}\colon\mathbb{N}\inj\mathbb{N}}{%
...
\FormulaThmDeltaK[Plus-eins-Fall der strikten Ordnung]{%
  n\in\mathbb N\dsep i\in\mathbb N\vdash i<n+1\leftrightarrow i<n\lor i=n
}{PeanoStrictAddOneSplit}{\DeltaRow{Mengen}{i\dsep n}}
\begin{tabproof}
  \proofstep{1}{n\in\mathbb N}{\rA}
  \proofstep{2}{i\in\mathbb N}{\rA}
  \proofstep{1}{n+1=\Succ(n)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{1}}
  \proofstep{1,2}{i<\Succ(n)\leftrightarrow i<n\lor i=n}{%
    \FormulaRefAuto{PeanoStrictSuccSplit}[thm]{1,2}}
  \proofstep{1,2}{i<n+1\leftrightarrow i<n\lor i=n}{\rIE{3,4}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Hinrichtung]{%
    n\in\mathbb{N}\vdash
    \NatSeg{\Succ(n)}\subseteq\NatSeg{n}\cup\{n\}%
  }{%
    n\in\mathbb{N}\vdash
    \NatSeg{\Succ(n)}\subseteq\NatSeg{n}\cup\{n\}%
  }[PeanoNatSegSuccForward]
    \proofstepwidestar[1]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[1]{\Succ(n)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1]{%
      \NatSeg{\Succ(n)}=\{i\in\mathbb{N}\mid i<\Succ(n)\}}{%
      \FormulaRefAuto{PeanoNatSeg}{2}}
    \proofstepwidestar[1]{%
      \NatSeg{n}=\{i\in\mathbb{N}\mid i<n\}}{%
      \FormulaRefAuto{PeanoNatSeg}{1}}
    \proofstepwidestar[5]{x\in\NatSeg{\Succ(n)}}{\rA}
    \proofstepwidestar[1,5]{%
      x\in\{i\in\mathbb{N}\mid i<\Succ(n)\}}{\rIE{3,5}}
    \proofstepwidestar[1,5]{x\in\mathbb{N}\land x<\Succ(n)}{%
      \FormulaRefAuto{x\in\{u\in A\mid P(u)\}\eqvdash
        x\in A\land P(x)}{6}}
    \proofstepwidestar[1,5]{x\in\mathbb{N}}{\rAEa{7}}
    \proofstepwidestar[1,5]{x<\Succ(n)}{\rAEb{7}}
    \proofstepwidestar[1,5]{x<n\lor x=n}{%
      \FormulaRefAuto{PeanoStrictSuccSplit}{1,8,9}}
  ...
  \proofpartwideindR[Rückrichtung]{%
    n\in\mathbb{N}\vdash
    \NatSeg{n}\cup\{n\}\subseteq\NatSeg{\Succ(n)}%
  }{%
    n\in\mathbb{N}\vdash
    \NatSeg{n}\cup\{n\}\subseteq\NatSeg{\Succ(n)}%
  }[PeanoNatSegSuccBackward]
    \proofstepwidestar[1]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[1]{\Succ(n)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1]{%
    ...
    \proofstepwidestar[1,7]{x<\Succ(n)}{%
      \FormulaRefAuto{PeanoStrictSuccSplit}{1,10,12}}
    \proofstepwidestar[1,7]{%
      x\in\{i\in\mathbb{N}\mid i<\Succ(n)\}}{%
      \FormulaRefAuto{x \in A\dsep P(x)\vdash
        x \in \{x \in A \mid P(x)\}}{10,13}}
    \proofstepwidestar[1,7]{x\in\NatSeg{\Succ(n)}}{\rIE{3,14}}
    ...
    \proofstepwidestar[1,16]{x<\Succ(n)}{%
      \FormulaRefAuto{PeanoStrictSuccSplit}{1,18,19}}
    \proofstepwidestar[1,16]{%
      x\in\{i\in\mathbb{N}\mid i<\Succ(n)\}}{%
      \FormulaRefAuto{x \in A\dsep P(x)\vdash
        x \in \{x \in A \mid P(x)\}}{18,20}}
    \proofstepwidestar[1,16]{x\in\NatSeg{\Succ(n)}}{\rIE{3,21}}
    \proofstepwidestar[1,5]{x\in\NatSeg{\Succ(n)}}{%
      \rOE{6,7,15,16,22}}
    \proofstepwidestar[1]{%
      \NatSeg{n}\cup\{n\}\subseteq\NatSeg{\Succ(n)}}{%
      \FormulaRefAuto{A\subseteq B\coloneq
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[1]{%
      \NatSeg{\Succ(n)}\subseteq\NatSeg{n}\cup\{n\}}{%
      \FormulaRefAuto{PeanoNatSegSuccForward}{1}}
    \proofstepwidestar[1]{%
      \NatSeg{n}\cup\{n\}\subseteq\NatSeg{\Succ(n)}}{%
      \FormulaRefAuto{PeanoNatSegSuccBackward}{1}}
    \proofstepwidestar[1]{%
      \NatSeg{\Succ(n)}=\NatSeg{n}\cup\{n\}}{%
...
\FormulaThmDeltaK[Nachfolger-Anfangsabschnitt: Elementkriterium]{%
  r\in\mathbb{N}\vdash
  x\in\NatSeg{\Succ(r)}\leftrightarrow
  \bigl(x\in\NatSeg{r}\lor x=r\bigr)%
}{PeanoNatSegSuccMembershipIff}{%
  \DeltaRow{Mengen}{r\dsep x}%
}
\begin{tabproof}
  \proofstep{1}{r\in\mathbb{N}}{\rA}
  \proofstep{2}{x\in\NatSeg{\Succ(r)}}{\rA}
  \proofstep{1,2}{x\in\NatSeg{r}\lor x=r}{%
    \FormulaRefAuto{PeanoNatSegSuccElim}[thm]{1,2}}
  \proofstep{1}{%
    x\in\NatSeg{\Succ(r)}\rightarrow
    \bigl(x\in\NatSeg{r}\lor x=r\bigr)}{\rRI{2,3}}
  \proofstep{5}{x\in\NatSeg{r}\lor x=r}{\rA}
  \proofstep{6}{x\in\NatSeg{r}}{\rA}
  \proofstep{1}{\NatSeg{r}\subseteq\NatSeg{\Succ(r)}}{%
    \FormulaRefAuto{PeanoNatSegSubsetSucc}[thm]{1}}
  \proofstep{1,6}{x\in\NatSeg{\Succ(r)}}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{7,6}}
  \proofstep{9}{x=r}{\rA}
  \proofstep{1}{\NatSeg{\Succ(r)}=\NatSeg{r}\cup\{r\}}{%
  ...
  \proofstep{1}{r\in\NatSeg{\Succ(r)}}{\rIE{10,12}}
  \proofstep{1,9}{x\in\NatSeg{\Succ(r)}}{\rIE{9,13}}
  \proofstep{1,5}{x\in\NatSeg{\Succ(r)}}{%
    \rOE{5,6,8,9,14}}
  \proofstep{1}{%
    \bigl(x\in\NatSeg{r}\lor x=r\bigr)\rightarrow
    x\in\NatSeg{\Succ(r)}}{\rRI{5,15}}
  \proofstep{1}{%
    x\in\NatSeg{\Succ(r)}\leftrightarrow
...
\FormulaThmDeltaK[Verfeinerung eines additiven Restfalls]{%
  \begin{aligned}[t]
    ...
    &\exists m\in\mathbb{N}\,(n=m+\Succ(r))
  \end{aligned}%
}{PeanoTailRefinement}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Nachfolgerfall des Restzeugen]{%
    ...
    n,r,p\in\mathbb{N}\dsep n=p+r\dsep p\neq0
    \vdash\exists m\in\mathbb{N}\,(n=m+\Succ(r))
  }[PeanoTailRefinementSuccCase]
    \proofstepwidestar[1]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{r\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{p\in\mathbb{N}}{\rA}
    \proofstepwidestar[4]{n=p+r}{\rA}
    \proofstepwidestar[5]{p\neq0}{\rA}
    \proofstepwidestar[3,5]{\exists m\in\mathbb{N}\,(p=\Succ(m))}{%
      \FormulaRefAuto{PeanoNonzeroIsSucc}[ax]{3,5}}
    \proofstepwidestar[7]{m\in\mathbb{N}\land p=\Succ(m)}{\rA}
    \proofstepwidestar[2,7]{\Succ(m)+r=\Succ(m+r)}{%
      \FormulaRefAuto{PeanoAddSuccLeft}[thm]{\rAEa{7},2}}
    \proofstepwidestar[2,7]{m+\Succ(r)=\Succ(m+r)}{%
      \FormulaRefAuto{PeanoAddSuccRight}[thm]{\rAEa{7},2}}
    \proofstepwidestar[2,7]{\Succ(m)+r=m+\Succ(r)}{%
      \FormulaRefAuto{a=b\dsep c=b\vdash a=c}[thm]{8,9}}
    \proofstepwidestar[1,2,3,4,7]{n=\Succ(m)+r}{%
      \rIE{\rAEb{7},4}}
    \proofstepwidestar[1,2,3,4,7]{n=m+\Succ(r)}{\rChain{11,10}}
    \proofstepwidestar[1,2,3,4,7]{%
      m\in\mathbb{N}\land n=m+\Succ(r)}{\rAI{\rAEa{7},12}}
    \proofstepwidestar[1,2,3,4,7]{%
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rEI{13}}
    \proofstepwidestar[1,2,3,4,5]{%
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rEE{6,7,14}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[1,2,4,6]{%
      n=r\lor\exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rOIa{7}}
    \proofstepwidestar[9]{p\neq0}{\rA}
    \proofstepwidestar[1,2,4,9]{%
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{%
      \FormulaRefAuto{PeanoTailRefinementSuccCase}[thm]{%
        1,2,\rAEa{4},\rAEb{4},9}}
    \proofstepwidestar[1,2,4,9]{%
      n=r\lor\exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rOIb{10}}
    \proofstepwidestar[1,2,4]{%
      n=r\lor\exists m\in\mathbb{N}\,(n=m+\Succ(r))}{%
      \rOE{5,6,8,9,11}}
    \proofstepwidestar[1,2,3]{%
      n=r\lor\exists m\in\mathbb{N}\,(n=m+\Succ(r))}{%
      \rEE{3,4,12}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[2]{\NatSeg{r}\subseteq\NatSeg{\Succ(r)}}{%
      \FormulaRefAuto{PeanoNatSegSubsetSucc}[thm]{2}}
    \proofstepwidestar[5]{n\in\NatSeg{r}}{\rA}
    \proofstepwidestar[2,5]{n\in\NatSeg{\Succ(r)}}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{4,5}}
    \proofstepwidestar[2,5]{%
      n\in\NatSeg{\Succ(r)}\lor
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rOIa{6}}
    ...
    \proofstepwidestar[2]{r\in\NatSeg{\Succ(r)}}{\rIE{11,13}}
    \proofstepwidestar[2,10]{n\in\NatSeg{\Succ(r)}}{\rIE{10,14}}
    \proofstepwidestar[2,10]{%
      n\in\NatSeg{\Succ(r)}\lor
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rOIa{15}}
    \proofstepwidestar[17]{%
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rA}
    \proofstepwidestar[17]{%
      n\in\NatSeg{\Succ(r)}\lor
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{\rOIb{17}}
    \proofstepwidestar[1,2,8]{%
      n\in\NatSeg{\Succ(r)}\lor
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{%
      \rOE{9,10,16,17,18}}
    \proofstepwidestar[1,2,3]{%
      ...
      \exists m\in\mathbb{N}\,(n=m+\Succ(r))}{%
      \rOE{3,5,7,8,19}}
    \proofstepwidestar[2]{r+1=\Succ(r)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{%
      n\in\NatSeg{r+1}\lor
...
\FormulaThmDeltaK[Nichtstrikte Ordnung als um eins erweiterter Anfangsabschnitt]{%
  m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
...
\begin{tabproof}
  \proofstep{1}{m\in\mathbb{N}}{\rA}
  \proofstep{2}{n\in\mathbb{N}}{\rA}
  \proofstep{2}{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstep{1,2}{m\leq n\leftrightarrow m\in\NatSeg{\Succ(n)}}{%
    \FormulaRefAuto{PeanoNatSegLeqSuccMembership}[thm]{1,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[4]{F(x_0)=n}{\rA}
  \proofstepwidestar[5]{x\in\mathbb{N}}{\rA}
  \proofstepwidestarbreak[3]{\RecFun{x_0}{\Succ}\colon\mathbb{N}\inj\mathbb{N}}{%
    \FormulaRefAuto{PeanoTranslateInjection}{3}}
  \proofstepwidestarbreak[3]{\SuccShift{\RecFun{x_0}{\Succ}}\colon
    \mathbb{N}\inj\mathbb{N}}{%
    \FormulaRefAuto{H\colon\mathbb{N}\inj M\vdash\SuccShift{H}\colon M\inj M}{6}}
  \proofstepwidestarbreak[2,3]{F\circ\SuccShift{\RecFun{x_0}{\Succ}}\colon
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestarbreak[3,4,7]{F(\Succ(k))\subseteq F(u)}{%
      \rRE{7,\rRE{4,\rUE{3}}}}
    \proofstepwidestarbreak[1,2]{F(u)\subseteq F(\Succ(u))}{%
      \rRE{2,\rUE{1}}}
    \proofstepwidestarbreak[1,2,3,4,7]{%
      ...
      \FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash
        A\subseteq C}{8,9}}
    \proofstepwidestar[11]{k=u}{\rA}
    \proofstepwidestarbreak[11]{\Succ(k)=\Succ(u)}{\rIE{11}}
    \proofstepwidestarbreak[11]{F(\Succ(k))=F(\Succ(u))}{\rIE{12}}
    \proofstepwidestarbreak[11]{F(\Succ(k))\subseteq F(\Succ(u))}{%
      \FormulaRefAuto{A=B\vdash A\subseteq B}{13}}
    \proofstepwidestarbreak[1,2,3,4,5]{%
    ...
    \proofstepwidestarbreak[2]{u+1=\Succ(u)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestarbreak[1,2,3]{%
      \forall k\in\mathbb{N}\,\bigl(k<(u+1)\rightarrow
        F(\Succ(k))\subseteq F(u+1)\bigr)}{\rIE{18,17}}
  \closeproofpartwideindR
...
\FormulaThmDeltaK[Anfangsabschnitt bei Addition von (1)]{%
  n\in\mathbb N\vdash
...
\begin{tabproof}
  ...
  \proofstep{1}{\NatSeg{\Succ(n)}=\NatSeg n\cup\{n\}}{%
    \FormulaRefAuto{PeanoNatSegSucc}[thm]{1}}
  \proofstep{1}{\NatSeg{n+1}=\NatSeg n\cup\{n\}}{\rIE{2,3}}
\end{tabproof}
...
\FormulaThmDeltaK[Rechte Multiplikationsregel mit \(+1\)]{%
  a\in\mathbb N\dsep b\in\mathbb N\vdash a\cdot(b+1)=a\cdot b+a
}{PeanoMulAddOneRight}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproof}
  \proofstep{1}{a\in\mathbb N}{\rA}
  \proofstep{2}{b\in\mathbb N}{\rA}
  \proofstep{2}{b+1=\Succ(b)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstep{1,2}{a\cdot\Succ(b)=a\cdot b+a}{\FormulaRefAuto{PeanoMulSuccRight}[thm]{1,2}}
  \proofstep{1,2}{a\cdot(b+1)=a\cdot b+a}{\rIE{3,4}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    a\in\mathbb{N}\dsep0\cdot a=0\vdash0\cdot\Succ(a)=0%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{a\cdot1=a\cdot\Succ(0)}{\rIE{3}}
  \proofstepwidestar[1]{a\cdot\Succ(0)=a\cdot0+a}{%
    \FormulaRefAuto{PeanoMulSuccRight}{1,2}}
  \proofstepwidestar[1]{a\cdot0=0}{\FormulaRefAuto{PeanoMulRightZero}{1}}
  \proofstepwidestar[1]{a\cdot0+a=0+a}{\rIE{6}}
  \proofstepwidestar[1]{0+a=a}{\FormulaRefAuto{PeanoAddLeftZero}{1}}
  \proofstepwidestar[1]{a\cdot1=a}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{4,5},7},8}}
\end{tabproofwide}

\FormulaThmDeltaK[Nachfolgerregel der Multiplikation links]{%
  a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
  \Succ(a)\cdot b=a\cdot b+b%
}{PeanoMulSuccLeft}{%
  \DeltaRow{Mengen}{a\dsep b}%
}
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktionsanfang]{%
    a\in\mathbb{N}\vdash\Succ(a)\cdot0=a\cdot0+0%
  }{%
    a\in\mathbb{N}\vdash\Succ(a)\cdot0=a\cdot0+0%
  }[PeanoMulSuccLeftBase]
    \proofstepwidestar[1]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[1]{\Succ(a)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1]{\Succ(a)\cdot0=0}{%
    ...
    \proofstepwidestar[1]{0=a\cdot0+0}{%
      \FormulaRefAuto{a=b\vdash b=a}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{5,6}}}
    \proofstepwidestar[1]{\Succ(a)\cdot0=a\cdot0+0}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{3,7}}
  \closeproofpartwideindR

  \proofpartwideindR[Induktionsschritt]{%
    a,b\in\mathbb{N}\dsep
    \Succ(a)\cdot b=a\cdot b+b\vdash
    \Succ(a)\cdot(b+1)=a\cdot(b+1)+(b+1)
  }{%
    a,b\in\mathbb{N}\dsep
    \Succ(a)\cdot b=a\cdot b+b\vdash
    \Succ(a)\cdot\Succ(b)=a\cdot\Succ(b)+\Succ(b)%
  }[PeanoMulSuccLeftStep]
    \proofstepwidestar[1]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{\Succ(a)\cdot b=a\cdot b+b}{\rA}
    \proofstepwidestar[1]{\Succ(a)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1,2]{%
      \Succ(a)\cdot\Succ(b)=\Succ(a)\cdot b+\Succ(a)}{%
      \FormulaRefAuto{PeanoMulSuccRight}{4,2}}
    \proofstepwidestar[1,2,3]{%
      \Succ(a)\cdot\Succ(b)=(a\cdot b+b)+\Succ(a)}{%
      \rIE{3,5}}
    \proofstepwidestar[1]{a+1=\Succ(a)}{%
      \FormulaRefAuto{PeanoAddOneSucc}{1}}
    \proofstepwidestar[2]{b+1=\Succ(b)}{%
      \FormulaRefAuto{PeanoAddOneSucc}{2}}
    \proofstepwidestar[]{1\in\mathbb{N}}{\FormulaRefAuto{PeanoOneInN}}
    \proofstepwidestar[1,2]{a\cdot b\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoMulClosure}{1,2}}
    \proofstepwidestar[1,2]{%
      (a\cdot b+b)+(a+1)=(a\cdot b+a)+(b+1)}{%
      \FormulaRefAuto{PeanoAddInterchange}{10,2,1,9}}
    \proofstepwidestar[1,2]{%
      (a\cdot b+b)+\Succ(a)=(a\cdot b+a)+\Succ(b)}{%
      \rIE{7,8,11}}
    \proofstepwidestar[1,2]{a\cdot\Succ(b)=a\cdot b+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{1,2}}
    \proofstepwidestar[1,2]{%
      (a\cdot b+a)+\Succ(b)=a\cdot\Succ(b)+\Succ(b)}{\rIE{13}}
    \proofstepwidestar[1,2,3]{%
      \Succ(a)\cdot\Succ(b)=a\cdot\Succ(b)+\Succ(b)}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{6,12},14}}
    \proofstepwidestar[2]{b+1=\Succ(b)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{%
      \Succ(a)\cdot(b+1)=a\cdot(b+1)+(b+1)}{\rIE{16,15}}
  \closeproofpartwideindR

  \proofpartwide{Induktionsschluss}
    \proofstepwidestar[1]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[1,2]{\Succ(a)\cdot b=a\cdot b+b}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{IA,IS,2,1}}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaThmDeltaK[Linke Multiplikationsregel mit \(+1\)]{%
  a\in\mathbb N\dsep b\in\mathbb N\vdash (a+1)\cdot b=a\cdot b+b
}{PeanoMulAddOneLeft}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproof}
  \proofstep{1}{a\in\mathbb N}{\rA}
  \proofstep{2}{b\in\mathbb N}{\rA}
  \proofstep{1}{a+1=\Succ(a)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{1}}
  \proofstep{1,2}{\Succ(a)\cdot b=a\cdot b+b}{\FormulaRefAuto{PeanoMulSuccLeft}[thm]{1,2}}
  \proofstep{1,2}{(a+1)\cdot b=a\cdot b+b}{\rIE{3,4}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    a,b\in\mathbb{N}\dsep a\cdot b=b\cdot a
    \vdash a\cdot\Succ(b)=\Succ(b)\cdot a%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    a,b,c\in\mathbb{N}\dsep
    a\cdot(b+c)=a\cdot b+a\cdot c\vdash
    a\cdot(b+\Succ(c))=a\cdot b+a\cdot\Succ(c)%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    a,b,c\in\mathbb{N}\dsep
    (a\cdot b)\cdot c=a\cdot(b\cdot c)\vdash
    (a\cdot b)\cdot\Succ(c)=a\cdot(b\cdot\Succ(c))%
...
\FormulaDefDelta[Summenschritt einer Folge natürlicher Zahlen]{%
  ...
  \begin{aligned}[t]
    ...
    &\forall k,x\in\mathbb{N}\,
      \bigl(\SumStep{u}(k,x)\coloneqq(\Succ(k),x + u(k))\bigr)
  \end{aligned}%
}{%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \forall k,x\in\mathbb N\,
      \bigl((\Succ(k),x+u(k))\in\mathbb N\times\mathbb N\bigr)}{%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \forall k,x\in\mathbb{N}\,
      \bigl(\SumStep{u}(k,x)=(\Succ(k),x + u(k))\bigr)}{%
    \FormulaRefAuto{u\colon\mathbb{N}\to\mathbb{N}\vdash
      \begin{aligned}[t]
        &\SumStep{u}\colon\mathbb{N}\times\mathbb{N}
          \to\mathbb{N}\times\mathbb{N},\\[-2pt]
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2,3]{\pi_1(R_u(\Succ(m)))=\Succ(m)}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{8,9}}
    \proofstepwidestar[2]{m+1=\Succ(m)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{\pi_1(R_u(m+1))=(m+1)}{\rIE{11,10}}
  \closeproofpartwideindR
...
\FormulaDefDelta[Produktschritt einer Folge natürlicher Zahlen]{%
  ...
  \begin{aligned}[t]
    &\ProdStep{u}\colon\mathbb{N}\times\mathbb{N}
      \to\mathbb{N}\times\mathbb{N},\\[-2pt]
    &\forall k,x\in\mathbb{N}\,
      \bigl(\ProdStep{u}(k,x)\coloneqq(\Succ(k),x \cdot u(k))\bigr)
  \end{aligned}%
}{%
  \DeltaRow{Mengen}{u\dsep k\dsep x}%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \forall k,x\in\mathbb N\,
      \bigl((\Succ(k),x\cdot u(k))\in\mathbb N\times\mathbb N\bigr)}{%
    \rUI{\rRI{2,\rUI{\rRI{3,7}}}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \forall k,x\in\mathbb{N}\,
      \bigl(\ProdStep{u}(k,x)=(\Succ(k),x \cdot u(k))\bigr)}{%
    \FormulaRefAuto{u\colon\mathbb{N}\to\mathbb{N}\vdash
      \begin{aligned}[t]
        &\ProdStep{u}\colon\mathbb{N}\times\mathbb{N}
          \to\mathbb{N}\times\mathbb{N},\\[-2pt]
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[2]{m+1=\Succ(m)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstepwidestar[1,2,3]{\pi_1(P_u(m+1))=(m+1)}{\rIE{11,10}}
  \closeproofpartwideindR
...
\FormulaThmDeltaK[Nachfolgerregel der Potenz natürlicher Zahlen]{%
...
\begin{tabproof}
  \proofstep{1}{b\in\mathbb N}{\rA}
  \proofstep{1}{b^0=\Succ(0)}{\FormulaRefAuto{PeanoPowerZero}[thm]{1}}
  \proofstep{}{1=\Succ(0)}{\FormulaRefAuto{PeanoOne}[def]}
  \proofstep{1}{b^0=1}{\rIE{3,2}}
\end{tabproof}

\FormulaThmDeltaK[Schrittregel der Potenz mit \(+1\)]{%
  b\in\mathbb N\dsep n\in\mathbb N\vdash b^{n+1}=b^n\cdot b
}{PeanoPowerAddOne}{\DeltaRow{Mengen}{b\dsep n}}
\begin{tabproof}
  \proofstep{1}{b\in\mathbb N}{\rA}
  \proofstep{2}{n\in\mathbb N}{\rA}
  \proofstep{2}{n+1=\Succ(n)}{\FormulaRefAuto{PeanoAddOneSucc}[thm]{2}}
  \proofstep{1,2}{b^{\Succ(n)}=b^n\cdot b}{\FormulaRefAuto{PeanoPowerSucc}[thm]{1,2}}
  \proofstep{1,2}{b^{n+1}=b^n\cdot b}{\rIE{3,4}}
\end{tabproof}
...
\FormulaDefDeltaK[Fakultätsfunktion]{%
  \begin{aligned}[t]
    ...
    &\forall n\in\mathbb{N}\,
      ...
      \prod_{i<n}\Succ(i)\right)
  \end{aligned}%
}{FactorialFunction}{%
  \DeltaRow{Mengen}{n\dsep i}%
  \DeltaRow{Funktionensymbole}{\Succ\dsep \operatorname{fac}}%
...
\FormulaThmDeltaK[Rekursionsgleichungen der Fakultät]{%
  \begin{aligned}[t]
    &0!=\Succ(0),\\[-2pt]
    &n\in\mathbb{N}\vdash \Succ(n)!=n!\cdot\Succ(n)
  \end{aligned}%
}{FactorialRecursion}{%
  \DeltaRow{Mengen}{n\dsep i}%
  \DeltaRow{Funktionensymbole}{\Succ\dsep \operatorname{fac}}%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Nullfall]{0!=\Succ(0)}{0!=\Succ(0)}
    \proofstepwidestar[]{0\in\mathbb{N}}{\FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[]{\Succ\colon\mathbb{N}\to\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccFunction}[ax]}
    \proofstepwidestar[]{0!=\prod_{i<0}\Succ(i)}{%
      \FormulaRefAuto{FactorialFunction}[def]{1}}
    \proofstepwidestar[]{\prod_{i<0}\Succ(i)=\Succ(0)}{%
      \FormulaRefAuto{u\colon\mathbb{N}\to\mathbb{N}\vdash
        \prod_{i<0}u(i)=\Succ(0)}{2}}
    \proofstepwidestar[]{0!=\Succ(0)}{\rChain{3,4}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Nachfolgerfall]{%
    ...
    \proofstepwidestar[1]{\Succ(n)!=\prod_{i<\Succ(n)}\Succ(i)}{%
      \FormulaRefAuto{FactorialFunction}[def]{3}}
    \proofstepwidestar[1]{%
      \prod_{i<\Succ(n)}\Succ(i)
      =\left(\prod_{i<n}\Succ(i)\right)\cdot\Succ(n)}{%
      \FormulaRefAuto{u\colon\mathbb{N}\to\mathbb{N}\dsep n\in\mathbb{N}
        \vdash \prod_{i<\Succ(n)}u(i)=
        \left(\prod_{i<n}u(i)\right)\cdot u(n)}{2,1}}
    \proofstepwidestar[1]{n!=\prod_{i<n}\Succ(i)}{%
      \FormulaRefAuto{FactorialFunction}[def]{1}}
    \proofstepwidestar[1]{%
      \left(\prod_{i<n}\Succ(i)\right)\cdot\Succ(n)
      =n!\cdot\Succ(n)}{\rIE{6}}
    \proofstepwidestar[1]{\Succ(n)!=n!\cdot\Succ(n)}{%
      \rChain{4,5,7}}
  \closeproofpartwideindR
\end{tabproofsplitwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,4]{\exists k\in\mathbb{N}\,(b=\Succ(k))}{%
    \FormulaRefAuto{PeanoNonzeroIsSucc}[ax]{2,4}}
  \proofstepwidestar[3]{\exists r\in\mathbb{N}\,(a=\Succ(r))}{%
    \FormulaRefAuto{PeanoNonzeroIsSucc}[ax]{1,3}}
  \proofstepwidestar[7]{k\in\mathbb{N}\land b=\Succ(k)}{\rA}
  \proofstepwidestar[8]{r\in\mathbb{N}\land a=\Succ(r)}{\rA}
  \proofstepwidestar[7]{k\in\mathbb{N}}{\rAEa{7}}
  \proofstepwidestar[7]{b=\Succ(k)}{\rAEb{7}}
  \proofstepwidestar[8]{r\in\mathbb{N}}{\rAEa{8}}
  \proofstepwidestar[8]{a=\Succ(r)}{\rAEb{8}}
  \proofstepwidestar[1,7]{a\cdot\Succ(k)=a\cdot k+a}{%
    \FormulaRefAuto{PeanoMulSuccRight}[thm]{1,9}}
  \proofstepwidestar[1,7,8]{a\cdot k+a=\Succ(a\cdot k+r)}{%
    \rIE{12,\FormulaRefAuto{PeanoAddSuccRight}[thm]{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{1,9},11}}}
  \proofstepwidestar[1,7,8]{a\cdot\Succ(k)=\Succ(a\cdot k+r)}{%
    \rChain{13,14}}
  \proofstepwidestar[1,7,8]{\Succ(a\cdot k+r)\neq0}{%
    \FormulaRefAuto{PeanoSuccNonzero}[ax]{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}
        \vdash a+b\in\mathbb{N}}{%
        \FormulaRefAuto{PeanoMulClosure}[thm]{1,9},11}}}
  \proofstepwidestar[1,7,8]{a\cdot\Succ(k)\neq0}{\rIE{15,16}}
  \proofstepwidestar[1,7,8]{a\cdot b\neq0}{\rIE{10,17}}
  \proofstepwidestar[1,3,7]{a\cdot b\neq0}{\rEE{6,8,18}}
  \proofstepwidestar[1,2,3,4]{a\cdot b\neq0}{\rEE{5,7,19}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1]{\Succ(n)\neq0}{%
      \FormulaRefAuto{PeanoSuccNonzero}[ax]{1}}
    \proofstepwidestar[1,2]{n!\cdot\Succ(n)\neq0}{%
...
\FormulaThmDeltaK[Strikter Fakultätsschritt]{%
  n\in\mathbb{N}\setminus\{0\}\vdash n!<\Succ(n)!%
}{FactorialSuccessorStrict}{%
  \DeltaRow{Mengen}{n}%
  \DeltaRow{Funktionensymbol}{\operatorname{fac}}%
...
\FormulaThmDeltaK[Vorgänger erhalten strikte Ungleichungen positiver Zahlen]{%
  r,s\in\mathbb N\dsep r\neq0\dsep r<s
  \vdash\Pred(r)<\Pred(s)%
}{PeanoPredStrictMonotonePositive}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2,3]{\Pred(r),\Pred(s)\in\mathbb N}{%
    \rAIRepeat{2}{\FormulaRefAuto{PeanoPredNatural}[thm]}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[4]{m<\Succ(n)}{\rA}
    ...
    \proofstepwidestarbreak[1]{n!\in\mathbb{N}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{%
        \FormulaRefAuto{FactorialClosure}[thm],1}}
    \proofstepwidestarbreak[1]{\Succ(n)!\in\mathbb{N}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{%
        \FormulaRefAuto{FactorialClosure}[thm],%
        \FormulaRefAuto{PeanoSuccClosure}[ax]{1}}}
    \proofstepwidestarbreak[1,3,4]{m<n\lor m=n}{%
      \FormulaRefAuto{PeanoStrictSuccSplit}[thm]{1,5,4}}
    \proofstepwidestar[10]{m<n}{\rA}
    ...
    \proofstepwidestarbreak[1,3,10]{n!<\Succ(n)!}{%
      \FormulaRefAuto{FactorialSuccessorStrict}[thm]{13}}
    \proofstepwidestarbreak[1,2,3,10]{m!<\Succ(n)!}{%
      \FormulaRefAuto{PeanoLtTransitive}[thm]{6,7,8,11,14}}
    \proofstepwidestar[16]{m=n}{\rA}
    \proofstepwidestarbreak[3]{m!<\Succ(m)!}{%
      \FormulaRefAuto{FactorialSuccessorStrict}[thm]{3}}
    \proofstepwidestarbreak[3,16]{m!<\Succ(n)!}{\rIE{16,17}}
    \proofstepwidestarbreak[1,2,3,4]{m!<\Succ(n)!}{%
      \rOE{9,10,15,16,18}}
    \proofstepwidestarbreak[1,2,3]{%
      m<\Succ(n)\rightarrow m!<\Succ(n)!}{\rRI{4,19}}
    \proofstepwidestarbreak[1,2]{%
      \forall m\in\mathbb{N}\setminus\{0\}\,
        (m<\Succ(n)\rightarrow m!<\Succ(n)!)}{\rUI{\rRI{3,20}}}
    \proofstepwidestarbreak[1]{n+1=\Succ(n)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{1}}
  \proofstepwidestarbreak[1,2]{%
      \forall m\in\mathbb{N}\setminus\{0\}\,
        (m<(n+1)\rightarrow m!<(n+1)!)}{\rIE{22,21}}
  \closeproofpartwideindR
...
\begin{tabproof}
  \proofstep{}{0\in\mathbb{N}}{\FormulaRefAuto{PeanoZero}[ax]}
  \proofstep{}{0\neq\Succ(0)}{%
    \FormulaRefAuto{PeanoZeroNeSuccessor}[thm]{1}}
  \proofstep{}{1=\Succ(0)}{\FormulaRefAuto{PeanoOne}[def]}
  \proofstep{}{\Succ(0)=1}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{3}}
  \proofstep{}{0\neq1}{%
...
ergeben die Definition des Zahlzeichens \(2\), die Gleichung
\(1+1=\Succ(1)\) aus \FormulaRefAuto{PeanoAddOneSucc}[thm],
...
\begin{tabproof}
  ...
  \proofstep{}{\Succ(0)\neq\Succ(1)}{%
    \FormulaRefAuto{PeanoSuccPreservesNe}[thm]{1,2,3}}
  \proofstep{}{1=\Succ(0)}{\FormulaRefAuto{PeanoOne}[def]}
  \proofstep{}{\Succ(0)=1}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{5}}
  \proofstep{}{2=\Succ(1)}{%
...
\begin{tabproof}
  \proofstep{}{0\in\mathbb{N}}{\FormulaRefAuto{PeanoZero}[ax]}
  \proofstep{}{\NatSeg{\Succ(0)}=\NatSeg{0}\cup\{0\}}{%
    \FormulaRefAuto{PeanoNatSegSucc}[thm]{1}}
  \proofstep{}{\NatSeg{0}=\varnothing}{%
    \FormulaRefAuto{PeanoNatSegZero}[thm]}
  \proofstep{}{\NatSeg{0}\cup\{0\}=\varnothing\cup\{0\}}{%
    \FormulaRefAuto{A=B\vdash A\cup C=B\cup C}[thm]{3}}
  \proofstep{}{\NatSeg{\Succ(0)}=\varnothing\cup\{0\}}{\rChain{2,4}}
  \proofstep{}{\varnothing\cup\{0\}=\{0\}}{%
    \FormulaRefAuto{\varnothing\cup A=A}[thm]}
  \proofstep{}{\NatSeg{\Succ(0)}=\{0\}}{\rChain{5,6}}
  \proofstep{}{1=\Succ(0)}{\FormulaRefAuto{PeanoOne}[def]}
  \proofstep{}{\NatSeg{1}=\{0\}}{\rIE{8,7}}
\end{tabproof}
...
\begin{tabproof}
  \proofstep{}{1\in\mathbb{N}}{\FormulaRefAuto{PeanoOneInN}[thm]}
  \proofstep{}{%
    n\in\NatSeg{\Succ(1)}\leftrightarrow
    \bigl(n\in\NatSeg{1}\lor n=1\bigr)}{%
    \FormulaRefAuto{PeanoNatSegSuccMembershipIff}[thm]{1}}
  \proofstep{}{n\in\NatSeg{1}\leftrightarrow n=0}{%
    \FormulaRefAuto{PeanoNatSegOneMembership}[thm]}
  \proofstep{}{%
    n\in\NatSeg{\Succ(1)}\leftrightarrow n=0\lor n=1}{\rLRS{3,2}}
  \proofstep{}{2=\Succ(1)}{%
    \FormulaRefAuto{Natürliche Zahlzeichen von zwei bis zehn}[def]}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{%
    n\in\NatSeg{\Succ(2)}\leftrightarrow
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{%
    n\in\NatSeg{\Succ(3)}\leftrightarrow
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{%
    n\in\NatSeg{\Succ(4)}\leftrightarrow
