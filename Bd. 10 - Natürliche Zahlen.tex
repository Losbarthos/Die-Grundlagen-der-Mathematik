...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1]{0+n=n}{%
      \hspace{0.8em}\FormulaRefAuto{PeanoInductionRule}{IA,IS,1}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2]{\Succ(a)+b=\Succ(a+b)}{%
      \hspace{0.8em}\FormulaRefAuto{PeanoInductionRule}{IA,IS,2,1}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2]{a+b\in\mathbb{N}}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash a+b\in\mathbb{N}}{1,2}}
    \proofstepwidestar[1,2,3]{(a+b)+\Succ(c)=\Succ((a+b)+c)}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{5,3}}
    \proofstepwidestar[4]{\Succ((a+b)+c)=\Succ(a+(b+c))}{\rIE{4}}
    \proofstepwidestar[1,2,3,4]{(a+b)+\Succ(c)=\Succ(a+(b+c))}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{6,7}}
    \proofstepwidestar[2,3]{b+\Succ(c)=\Succ(b+c)}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{2,3}}
    \proofstepwidestar[2,3]{b+c\in\mathbb{N}}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash a+b\in\mathbb{N}}{2,3}}
    \proofstepwidestar[1,2,3]{a+(b+\Succ(c))=a+\Succ(b+c)}{\rIE{9}}
    \proofstepwidestar[1,2,3]{a+\Succ(b+c)=\Succ(a+(b+c))}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{1,10}}
    \proofstepwidestar[1,2,3]{a+(b+\Succ(c))=\Succ(a+(b+c))}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{11,12}}
    \proofstepwidestar[1,2,3]{\Succ(a+(b+c))=a+(b+\Succ(c))}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2]{a+\Succ(b)=\Succ(a+b)}{%
      \FormulaRefAuto{PeanoAddSuccRight}{1,2}}
    \proofstepwidestar[3]{\Succ(a+b)=\Succ(b+a)}{\rIE{3}}
    \proofstepwidestar[1,2]{\Succ(b)+a=\Succ(b+a)}{%
      \FormulaRefAuto{PeanoAddSuccLeft}{2,1}}
    \proofstepwidestar[1,2]{\Succ(b+a)=\Succ(b)+a}{%
      \FormulaRefAuto{a=b\vdash b=a}{6}}
    \proofstepwidestar[1,2,3]{a+\Succ(b)=\Succ(b)+a}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3,4]{((a+b)+c)+d=((a+c)+b)+d}{\rIE{6}}
  \proofstepwidestar[1,2,3,4]{((a+c)+b)+d=(a+c)+(b+d)}{%
    \FormulaRefAuto{PeanoAddAssociative}{%
...
Für Induktionsbeweise in der gebräuchlichen Plus-eins-Schreibweise
leiten wir aus \(n+1=\Succ(n)\) die folgende Form der Induktionsregel ab.

\FormulaThmDeltaK[Induktionsregel in Plus-eins-Schreibweise]{%
...
\begin{tabproof}
  ...
  \proofstep{3}{x+1=\Succ(x)}{%
    \FormulaRefAuto{PeanoAddOneSucc}[thm]{3}}
  \proofstep{3,4}{P(\Succ(x))}{\rIE{6,5}}
  \proofstep{3}{P(x)\rightarrow P(\Succ(x))}{\rRI{4,7}}
  \proofstep{}{x\in\mathbb N\rightarrow
    \bigl(P(x)\rightarrow P(\Succ(x))\bigr)}{\rRI{3,8}}
  \proofstep{}{\forall x\in\mathbb N\,
    \bigl(P(x)\rightarrow P(\Succ(x))\bigr)}{\rUI{9}}
  \proofstep{1}{\forall x\in\mathbb N\,P(x)}{%
    \FormulaRefAuto{PeanoInductionAxiom}[ax]{1,10}}
  \proofstep{1}{n\in\mathbb N\rightarrow P(n)}{\rUE{11}}
  \proofstep{1,2}{P(n)}{\rRE{2,12}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2]{m\in n\rightarrow m\subseteq n}{%
      \makecell[l]{%
        \FormulaRefAuto{PeanoInductionRule}\\[-2pt]
        \quad(IA,IS,2,1)}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1]{\Succ(m)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{1}}
    \proofstepwidestar[1,2]{\Succ(m)+\Succ(k)=\Succ(m+\Succ(k))}{%
      \FormulaRefAuto{PeanoAddSuccLeft}{1,%
        \FormulaRefAuto{PeanoSuccClosure}{2}}}
    \proofstepwidestar[1,2,4]{\Succ(m+\Succ(k))=\Succ(m)}{%
      \FormulaRefAuto{a=b\dsep a=c\vdash b=c}{6,4}}
    \proofstepwidestar[1,2,4]{m+\Succ(k)=m}{%
      \FormulaRefAuto{PeanoSuccInjective}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \makecell[l]{%
        \FormulaRefAuto{PeanoInductionRule}[ax]\\[-2pt]
        \quad(IA,IS,2,1)}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\FormulaThmDeltaK[Eindeutiger Endpunkt eines Anfangsabschnitts]{%
...
\begin{tabproofwide}
  \proofstepwidestarbreakkeep[]{%
    \exists!X\,\forall x\,\Bigl(
      x\in X\leftrightarrow
      \exists j\,(j\in J\land x=r+j)\Bigr)}{%
    \FormulaRefAuto{TranslatedImageSetUniqueExists}[thm]}
  \proofstepwidestarbreakkeep[]{%
    \{r+j\mid j\in J\}=\iota X\,\forall x\,\Bigl(
      x\in X\leftrightarrow
      \exists j\,(j\in J\land x=r+j)\Bigr)}{%
  ...
  \proofstepwidestarbreakkeep[]{%
    x\in\{r+j\mid j\in J\}\leftrightarrow
      \exists j\,(j\in J\land x=r+j)}{\rUE{3}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[]{0\in\mathbb{N}}{\FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1]{0\cdot\Succ(a)=0\cdot a+0}{%
      \FormulaRefAuto{PeanoMulSuccRight}{3,1}}
    \proofstepwidestar[2]{0\cdot a+0=0+0}{\rIE{2}}
    \proofstepwidestar[]{0+0=0}{\FormulaRefAuto{PeanoAddRightZero}{3}}
    \proofstepwidestar[1,2]{0\cdot\Succ(a)=0}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2]{\Succ(b)\cdot a=b\cdot a+a}{%
      \FormulaRefAuto{PeanoMulSuccLeft}{2,1}}
    \proofstepwidestar[1,2]{b\cdot a+a=\Succ(b)\cdot a}{%
      \FormulaRefAuto{a=b\vdash b=a}{6}}
    \proofstepwidestar[1,2,3]{a\cdot\Succ(b)=\Succ(b)\cdot a}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{4,5},7}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[2,3]{b+\Succ(c)=\Succ(b+c)}{%
      \FormulaRefAuto{PeanoAddSuccRight}{2,3}}
    \proofstepwidestar[1,2,3]{%
      a\cdot(b+\Succ(c))=a\cdot\Succ(b+c)}{\rIE{5}}
    \proofstepwidestar[2,3]{b+c\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoAddClosure}{2,3}}
    \proofstepwidestar[1,2,3]{%
      a\cdot\Succ(b+c)=a\cdot(b+c)+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{1,7}}
    \proofstepwidestar[4]{%
    ...
    \proofstepwidestar[1,3]{a\cdot\Succ(c)=a\cdot c+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{1,3}}
    \proofstepwidestar[1,2,3]{%
      a\cdot b+(a\cdot c+a)=a\cdot b+a\cdot\Succ(c)}{\rIE{11}}
    \proofstepwidestar[1,2,3,4]{%
      a\cdot(b+\Succ(c))=a\cdot b+a\cdot\Succ(c)}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2]{a\cdot b\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoMulClosure}{1,2}}
    \proofstepwidestar[1,2,3]{%
      (a\cdot b)\cdot\Succ(c)=(a\cdot b)\cdot c+a\cdot b}{%
      \FormulaRefAuto{PeanoMulSuccRight}{5,3}}
    \proofstepwidestar[4]{%
    ...
    \proofstepwidestar[1,2,3]{%
      ...
      \FormulaRefAuto{a=b\vdash b=a}{8}}
    \proofstepwidestar[2,3]{b\cdot\Succ(c)=b\cdot c+b}{%
      \FormulaRefAuto{PeanoMulSuccRight}{2,3}}
    \proofstepwidestar[1,2,3]{%
      a\cdot(b\cdot c+b)=a\cdot(b\cdot\Succ(c))}{\rIE{10}}
    \proofstepwidestar[1,2,3,4]{%
      (a\cdot b)\cdot\Succ(c)=a\cdot(b\cdot\Succ(c))}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{a\cdot c\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}{1}}
  \proofstepwidestar[1]{a\cdot e\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}{1}}
  \proofstepwidestar[1]{b\cdot d\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}{1}}
  \proofstepwidestar[1]{b\cdot f\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}{1}}
  \proofstepwidestar[1]{a\cdot(c+e)=a\cdot c+a\cdot e}{%
    \FormulaRefAuto{PeanoMulLeftDistributive}{1}}
  \proofstepwidestar[1]{b\cdot(d+f)=b\cdot d+b\cdot f}{%
    \FormulaRefAuto{PeanoMulLeftDistributive}{1}}
  \proofstepwidestar[1]{%
    a\cdot(c+e)+b\cdot(d+f)
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    \proofstepwidestar[1]{n\in\mathbb{N}}{\rA}
    \proofstepwidestar[1]{n!\neq0}{%
      \FormulaRefAuto{PeanoInductionRule}[ax]{IA,IS,1}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[3]{m\in\mathbb{N}}{%
    ...
    \proofstepwidestar[1]{\Succ(n)!\in\mathbb{N}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{%
        \FormulaRefAuto{FactorialClosure}[thm],%
        \FormulaRefAuto{PeanoSuccClosure}[ax]{1}}}
    \proofstepwidestar[1,3,4]{m<n\lor m=n}{%
      \FormulaRefAuto{PeanoStrictSuccSplit}[thm]{1,5,4}}
    \proofstepwidestar[10]{m<n}{\rA}
    \proofstepwidestar[2,3,10]{m!<n!}{\rRE{10,\rRE{3,\rUE{2}}}}
    \proofstepwidestar[1,3,10]{n\neq0}{%
      \FormulaRefAuto{PeanoStrictUpperNonzero}[thm]{5,1,10}}
    \proofstepwidestar[1,3,10]{n\in\mathbb{N}\setminus\{0\}}{%
      \FormulaRefAuto{PeanoNonzeroCarrierMembership}[thm]{\rAI{1,12}}}
    \proofstepwidestar[1,3,10]{n!<\Succ(n)!}{%
      \FormulaRefAuto{FactorialSuccessorStrict}[thm]{13}}
    \proofstepwidestar[1,2,3,10]{m!<\Succ(n)!}{%
      \FormulaRefAuto{PeanoLtTransitive}[thm]{6,7,8,11,14}}
    \proofstepwidestar[16]{m=n}{\rA}
    \proofstepwidestar[3]{m!<\Succ(m)!}{%
      \FormulaRefAuto{FactorialSuccessorStrict}[thm]{3}}
    \proofstepwidestar[3,16]{m!<\Succ(n)!}{\rIE{16,17}}
    \proofstepwidestar[1,2,3,4]{m!<\Succ(n)!}{%
      \rOE{9,10,15,16,18}}
    \proofstepwidestar[1,2,3]{%
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[4]{%
      \forall m\in\mathbb{N}\setminus\{0\}\,(m<n\rightarrow m!<n!)}{%
      \FormulaRefAuto{PeanoInductionRule}[ax]{IA,IS,4}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[26]{x\in\mathbb{N}\setminus\{0\}}{\rAEa{26}}
  \proofstepwidestar[26]{y=\operatorname{fac}(x)}{\rAEb{26}}
  \proofstepwidestar[26]{\operatorname{fac}_{+}(x)=x!}{%
    \FormulaRefAuto{PositiveFactorialValue}[thm]{27}}
  \proofstepwidestar[26]{\operatorname{fac}(x)=x!}{%
    \FormulaRefAuto{FactorialFunction}[def]{%
      \rAEa{\FormulaRefAuto{PeanoNonzeroCarrierMembership}[thm]{27}}}}
  \proofstepwidestar[26]{y=\operatorname{fac}_{+}(x)}{%
...
\begin{proof}
Wir zeigen zunächst durch natürliche Induktion
\[
  \forall n\in\mathbb N\,
...
\FormulaRefAuto{PeanoPowerZero}[thm]
\(\operatorname{pow}_2(0)=2^0=\Succ(0)\). Ferner ist
\(\Succ(0)\neq0\) nach \FormulaRefAuto{PeanoZero}[ax] und
\FormulaRefAuto{PeanoSuccNonzero}[ax].
...
zusammen mit \FormulaRefAuto{PeanoPowerSucc}[thm]
\[
  \operatorname{pow}_2(\Succ(n))
  =2^{\Succ(n)}=2^n\cdot2\neq0.
\]

Für jedes \(n\in\mathbb N\) ist der Nachfolgerschritt strikt. Tatsächlich
ergeben die Definition des Zahlzeichens \(2\),
\FormulaRefAuto{PeanoMulSuccRight}[thm] und
...
Nach \FormulaRefAuto{PeanoNonzeroIsSucc}[thm] gibt es daher ein
\(j\in\mathbb N\) mit
\(\operatorname{pow}_2(n)=\Succ(j)\). Die additive Charakterisierung der
strikten natürlichen Ordnung
\FormulaRefAuto{NaturalStrictOrderAdditiveCharacterization}[thm] liefert nun
\[
  \operatorname{pow}_2(n)
  <\operatorname{pow}_2(n)+\operatorname{pow}_2(n)
  =\operatorname{pow}_2(\Succ(n)).
...
\FormulaRefAuto{PeanoStrictSuccSplit}[thm] die Voraussetzung
\(m<\Succ(r)\) in \(m<r\) oder \(m=r\). Im ersten Fall folgen aus der
...
\[
  ...
  <\operatorname{pow}_2(\Succ(r));
\]
im zweiten Fall ist genau der strikte Nachfolgerschritt anzuwenden. Der
Induktionsschluss ist die erste Behauptung des Satzes.
