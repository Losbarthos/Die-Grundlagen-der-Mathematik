...
\begin{tabproofsplitwide}
  \proofpartwideindR[Zusammenführen der Kreuzsummen]{%
    ...
    \proofstepwidestar[1,3]{f+c=c+f}{%
      \FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1,3]{d+e=e+d}{%
      \FormulaRefAuto{PeanoAddCommutative}{1}}
    ...
    \proofstepwidestar[1]{d+c=c+d}{%
      \FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1,2,3]{(a+f)+(d+c)=(b+e)+(c+d)}{%
      \FormulaRefAuto{PeanoSumEqualitiesAddition}{1,2,6}}
...
\FormulaThmDeltaK[Der Äquivalenzoperator auf Differenzenpaaren ist eine Äquivalenzrelation]{%
  ...
  \DeltaRow{Mengen}{%
    D_{\mathbb Z}\dsep x\dsep y\dsep z\dsep
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Symmetrie]{%
    x,y\in D_{\mathbb Z}\dsep
    x\IntPairRel y\vdash y\IntPairRel x%
  }{%
    x,y\in D_{\mathbb Z}\dsep
    x\IntPairRel y\vdash y\IntPairRel x%
  }[IntegerPairEquivalenceSymmetric]
    \proofstepwidestar[1]{x,y\in D_{\mathbb Z}}{\rA}
    \proofstepwidestar[2]{x\IntPairRel y}{\rA}
    \proofstepwidestar[1]{%
      \exists a,b\in\mathbb N\,x=(a,b)}{%
      \FormulaRefAuto{x\in A\times B\eqvdash
        \exists a\in A\,\exists b\in B\,x=(a,b)}{\rAEa{1}}}
    \proofstepwidestar[1]{%
      \exists c,d\in\mathbb N\,y=(c,d)}{%
      \FormulaRefAuto{x\in A\times B\eqvdash
        \exists a\in A\,\exists b\in B\,x=(a,b)}{\rAEb{1}}}
    \proofstepwidestar[5]{%
      a,b\in\mathbb N\land x=(a,b)}{\rA}
    \proofstepwidestar[6]{%
      c,d\in\mathbb N\land y=(c,d)}{\rA}
    \proofstepwidestar[5,6]{a,b,c,d\in\mathbb N}{%
      \rAI{\rAEa{5},\rAEa{6}}}
    \proofstepwidestar[2,5,6]{%
      (a,b)\IntPairRel(c,d)}{%
      \rIE{\rAEb{5},\rAEb{6},2}}
    \proofstepwidestar[2,5,6]{%
      (c,d)\IntPairRel(a,b)}{%
      \FormulaRefAuto{IntRelationSymmetricPairs}[thm]{7,8}}
    \proofstepwidestar[2,5,6]{y\IntPairRel x}{%
      \rIE{\rAEb{5},\rAEb{6},9}}
    \proofstepwidestar[1,2,5]{y\IntPairRel x}{%
      \rEE{4,6,10}}
    \proofstepwidestar[1,2]{y\IntPairRel x}{%
      \rEE{3,5,11}}
  \closeproofpartwideindR

  \proofpartwideindR[Transitivität]{%
    x,y,z\in D_{\mathbb Z}\dsep
    ...
    \proofstepwidestar[1]{x,y,z\in D_{\mathbb Z}}{\rA}
    \proofstepwidestar[2]{x\IntPairRel y}{\rA}
    \proofstepwidestar[3]{y\IntPairRel z}{\rA}
    \proofstepwidestar[1]{%
      \exists a,b\in\mathbb N\,x=(a,b)}{%
      \FormulaRefAuto{x\in A\times B\eqvdash
        \exists a\in A\,\exists b\in B\,x=(a,b)}{\rAEa{1}}}
    ...
    \proofstepwidestar[8]{%
      c,d\in\mathbb N\land y=(c,d)}{\rA}
    \proofstepwidestar[9]{%
      e,f\in\mathbb N\land z=(e,f)}{\rA}
    \proofstepwidestar[7,8,9]{a,b,c,d,e,f\in\mathbb N}{%
      \rAI{\rAEa{7},\rAI{\rAEa{8},\rAEa{9}}}}
    \proofstepwidestar[2,7,8]{%
      (a,b)\IntPairRel(c,d)}{%
      \rIE{\rAEb{7},\rAEb{8},2}}
    \proofstepwidestar[3,8,9]{%
      (c,d)\IntPairRel(e,f)}{%
      \rIE{\rAEb{8},\rAEb{9},3}}
    \proofstepwidestar[2,3,7,8,9]{%
      (a,b)\IntPairRel(e,f)}{%
      \FormulaRefAuto{IntRelationTransitivePairs}[thm]{10,11,12}}
    \proofstepwidestar[2,3,7,8,9]{x\IntPairRel z}{%
      \rIE{\rAEb{7},\rAEb{9},13}}
    \proofstepwidestar[1,2,3,7,8]{x\IntPairRel z}{%
      \rEE{6,9,14}}
    \proofstepwidestar[1,2,3,7]{x\IntPairRel z}{%
      \rEE{5,8,15}}
    \proofstepwidestar[1,2,3]{x\IntPairRel z}{%
      \rEE{4,7,16}}
  \closeproofpartwideindR

  \proofpartwide{Schluss}
    \proofstepwidestar[]{%
      \forall x\in D_{\mathbb Z}\,(x\IntPairRel x)}{%
      \FormulaRefAuto{IntegerPairEquivalenceReflexive}}
    \proofstepwidestar[]{%
      \forall x,y\in D_{\mathbb Z}\,
      (x\IntPairRel y\rightarrow y\IntPairRel x)}{%
      \FormulaRefAuto{IntegerPairEquivalenceSymmetric}}
    \proofstepwidestar[]{%
      \forall x,y,z\in D_{\mathbb Z}\,
      \bigl((x\IntPairRel y\land y\IntPairRel z)
        \rightarrow x\IntPairRel z\bigr)}{%
      \FormulaRefAuto{IntegerPairEquivalenceTransitive}[thm]}
...
\FormulaThmDeltaK[Typisierung der Repräsentantenabbildung]{%
  \forall a\forall b\,\bigl((a\in\mathbb N\land b\in\mathbb N)\rightarrow\IntClass{a}{b}\in\mathbb Z\bigr)%
}{IntegerPairClassTyping}{%
  \DeltaRow{Mengen}{a\dsep b}%
}
\begin{tabproofwide}
  \proofstepwidestar[1]{a\in\mathbb N\land b\in\mathbb N}{\rA}
  \proofstepwidestar[1]{\IntClass{a}{b}\in\mathbb Z}{%
    \FormulaRefAuto{IntegerClassInZ}[thm]{\rAEa{1},\rAEb{1}}}
  \proofstepwidestar[]{\forall a\forall b\,\bigl((a\in\mathbb N\land b\in\mathbb N)\rightarrow\IntClass{a}{b}\in\mathbb Z\bigr)}{\rUI{\rUI{\rRI{1,2}}}}
\end{tabproofwide}

\FormulaThmDeltaK[Surjektive Repräsentantendarstellung]{%
  \forall z\in\mathbb Z\,\exists a\exists b\,\bigl((a\in\mathbb N\land b\in\mathbb N)\land z=\IntClass{a}{b}\bigr)%
}{IntegerPairRepresentationSurjective}{%
  \DeltaRow{Mengen}{z\dsep a\dsep b}%
}
\begin{tabproofwide}
  \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
  \proofstepwidestar[1]{\exists a\in\mathbb N\,\exists b\in\mathbb N\,z=\IntClass{a}{b}}{%
    \FormulaRefAuto{IntegerPairRepresentative}[thm]{1}}
  \proofstepwidestar[1]{\exists a\exists b\,\bigl((a\in\mathbb N\land b\in\mathbb N)\land z=\IntClass{a}{b}\bigr)}{%
    \rRE{\rLREa{\FormulaRefAuto{BoundedPairExistsGuard}[thm]},2}}
  \proofstepwidestar[]{\forall z\in\mathbb Z\,\exists a\exists b\,\bigl((a\in\mathbb N\land b\in\mathbb N)\land z=\IntClass{a}{b}\bigr)}{\rUI{\rRI{1,3}}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Gleichheit von eingebetteten Zahlen]{%
    ...
    \proofstepwidestar[1,2]{m=n}{\rChain{8,9,10}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  \proofstepwidestar[1]{z\in\mathbb Z}{%
    \rA}
  \proofstepwidestar[]{\forall a\forall b\,\bigl((a,b\in\mathbb N)\rightarrow\IntClass{a}{b}\in\mathbb Z\bigr)}{%
    \FormulaRefAuto{IntegerPairClassTyping}[thm]}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall z\in\mathbb Z\,\exists a\exists b\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land z=\IntClass{a}{b}\bigr)
\end{aligned}}{%
    \FormulaRefAuto{IntegerPairRepresentationSurjective}[thm]}
  \proofstepwidestar[4]{a,b\in\mathbb N}{%
    \rA}
  \proofstepwidestar[4]{\IntClass{b}{a}\in\mathbb Z}{%
    \FormulaRefAuto{IntegerClassInZ}[thm]{\rAI{\rAEb{4},\rAEa{4}}}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\,\bigl((a,b\in\mathbb N)\rightarrow\\[-2pt]
&\qquad \IntClass{b}{a}\in\mathbb Z\bigr)
\end{aligned}}{%
    \rUI{\rUI{\rRI{4,5}}}}
  \proofstepwidestar[7]{\begin{aligned}[t]
&(a,b\in\mathbb N)\land(c,d\in\mathbb N)\land\IntClass{a}{b}=\IntClass{c}{d}
\end{aligned}}{%
    \rA}
  \proofstepwidestar[7]{\IntClass{b}{a}=\IntClass{d}{c}}{%
    \FormulaRefAuto{IntegerNegationCompatible}[thm]{\rAIStar{\rAEa{\rAEa{7}},\rAEb{\rAEa{7}},\rAEa{\rAEa{\rAEb{7}}},\rAEb{\rAEa{\rAEb{7}}}},\rAEb{\rAEb{7}}}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\forall c\forall d\,\Bigl(\\[-2pt]
&(a,b\in\mathbb N)\land(c,d\in\mathbb N)\land\IntClass{a}{b}=\IntClass{c}{d}\rightarrow\\[-2pt]
&\qquad \IntClass{b}{a}=\IntClass{d}{c}\Bigr)
\end{aligned}}{%
    \rUI{\rUI{\rUI{\rUI{\rRI{7,8}}}}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a\exists b\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land z=\IntClass{a}{b}\land u=\IntClass{b}{a}\bigr)
\end{aligned}}{%
    \FormulaRefAuto{RepresentativePairValueUnique}[thm]{2,3,6,9,1}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall u\,\Bigl(\exists a\exists b\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land z=\IntClass{a}{b}\land u=\IntClass{b}{a}\bigr)\\[-2pt]
&\quad\leftrightarrow{}\exists a\in\mathbb N\,\exists b\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land u=\IntClass{b}{a}\bigr)\Bigr)
\end{aligned}}{%
    \rUI{\FormulaRefAuto{P \leftrightarrow Q \vdash Q \leftrightarrow P}[thm]{\FormulaRefAuto{BoundedPairExistsGuard}[thm]}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a\in\mathbb N\,\exists b\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land u=\IntClass{b}{a}\bigr)
\end{aligned}}{%
    \FormulaRefAuto{UniqueExistenceUnderEquivalentConjuncts}[thm]{11,10}}
\end{tabproofwide}
...
\FormulaThmDeltaK[Quotientenabstieg der Addition]{%
  ...
  \DeltaRow{Weitere Mengen}{e\dsep f\dsep g\dsep h}%
}
\begin{tabproofwide}
...
\end{aligned}}{%
    \FormulaRefAuto{IntegerPairRepresentationSurjective}[thm]}
  \proofstepwidestar[4]{(a,b\in\mathbb N)\land(c,d\in\mathbb N)}{%
    \rA}
  \proofstepwidestar[4]{a+c\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddClosure}[thm]{\rAEa{\rAEa{4}},\rAEa{\rAEb{4}}}}
  \proofstepwidestar[4]{b+d\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddClosure}[thm]{\rAEb{\rAEa{4}},\rAEb{\rAEb{4}}}}
  \proofstepwidestar[4]{\IntClass{a+c}{b+d}\in\mathbb Z}{%
    \FormulaRefAuto{IntegerClassInZ}[thm]{5,6}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\forall c\forall d\,\bigl(((a,b\in\mathbb N)\land(c,d\in\mathbb N))\rightarrow\\[-2pt]
&\qquad \IntClass{a+c}{b+d}\in\mathbb Z\bigr)
\end{aligned}}{%
    \rUI{\rUI{\rUI{\rUI{\rRI{4,7}}}}}}
  \proofstepwidestar[9]{\begin{aligned}[t]
&(a,b\in\mathbb N)\land(c,d\in\mathbb N)\land{}\\[-2pt]
&(e,f\in\mathbb N)\land(g,h\in\mathbb N)\land{}\\[-2pt]
&\IntClass{a}{b}=\IntClass{e}{f}\land \IntClass{c}{d}=\IntClass{g}{h}
\end{aligned}}{%
    \rA}
  \proofstepwidestar[9]{\IntClass{a+c}{b+d}=\IntClass{e+g}{f+h}}{%
    \FormulaRefAuto{IntegerAdditionCompatible}[thm]{\rAIStar{\rAEa{\rAEa{9}},\rAEb{\rAEa{9}},\rAEa{\rAEa{\rAEb{\rAEb{9}}}},\rAEb{\rAEa{\rAEb{\rAEb{9}}}},\rAEa{\rAEa{\rAEb{9}}},\rAEb{\rAEa{\rAEb{9}}},\rAEa{\rAEa{\rAEb{\rAEb{\rAEb{9}}}}},\rAEb{\rAEa{\rAEb{\rAEb{\rAEb{9}}}}}},\rAEa{\rAEb{\rAEb{\rAEb{\rAEb{9}}}}},\rAEb{\rAEb{\rAEb{\rAEb{\rAEb{9}}}}}}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\forall c\forall d\forall e\forall f\forall g\forall h\,\Bigl(\\[-2pt]
&(a,b\in\mathbb N)\land(c,d\in\mathbb N)\land{}\\[-2pt]
&(e,f\in\mathbb N)\land(g,h\in\mathbb N)\land{}\\[-2pt]
&\IntClass{a}{b}=\IntClass{e}{f}\land \IntClass{c}{d}=\IntClass{g}{h}\rightarrow\\[-2pt]
&\qquad \IntClass{a+c}{b+d}=\IntClass{e+g}{f+h}\Bigr)
\end{aligned}}{%
    \rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rRI{9,10}}}}}}}}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a\exists b\exists c\exists d\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land(c,d\in\mathbb N)\land z=\IntClass{a}{b}\land{}\\[-2pt]
&\qquad w=\IntClass{c}{d}\land u=\IntClass{a+c}{b+d}\bigr)
\end{aligned}}{%
...
&\bigl((a,b\in\mathbb N)\land(c,d\in\mathbb N)\land z=\IntClass{a}{b}\land{}\\[-2pt]
&\qquad w=\IntClass{c}{d}\land u=\IntClass{a+c}{b+d}\bigr)\\[-2pt]
&\quad\leftrightarrow{}\exists a,b,c,d\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land w=\IntClass{c}{d}\land{}\\[-2pt]
&\qquad u=\IntClass{a+c}{b+d}\bigr)\Bigr)
\end{aligned}}{%
    \rUI{\FormulaRefAuto{P \leftrightarrow Q \vdash Q \leftrightarrow P}[thm]{\FormulaRefAuto{BoundedFourExistsGuard}[thm]}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a,b,c,d\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land w=\IntClass{c}{d}\land{}\\[-2pt]
&\qquad u=\IntClass{a+c}{b+d}\bigr)
\end{aligned}}{%
...
\FormulaDefDeltaK[Subtraktion ganzer Zahlen]{%
  z,w\in\mathbb Z\vdash z-w\coloneqq z+(-w)%
}{IntegerSubtractionDef}{%
  \DeltaRow{Mengen}{z\dsep w}%
  \DeltaRow{Neue Schreibweise}{z-w}%
}

Die Subtraktion ist die Addition des additiven Inversen. Insbesondere ist
\(z-\IntOne\) für jede ganze Zahl \(z\) definiert, auch für
\(z=\IntZero\).

\FormulaThmDeltaK[Abgeschlossenheit der Ganzzahlsubtraktion]{%
  z,w\in\mathbb Z\vdash z-w\in\mathbb Z%
}{IntegerSubtractionClosure}{%
  \DeltaRow{Mengen}{z\dsep w}%
}
\begin{tabproof}
  \proofstep{1}{z,w\in\mathbb Z}{\rA}
  \proofstep{1}{-w\in\mathbb Z}{\FormulaRefAuto{IntNegClosure}[thm]{1}}
  \proofstep{1}{z+(-w)\in\mathbb Z}{\FormulaRefAuto{IntAddClosure}[thm]{1,2}}
  \proofstep{1}{z-w=z+(-w)}{\FormulaRefAuto{IntegerSubtractionDef}[def]{1}}
  \proofstep{1}{z-w\in\mathbb Z}{\rIE{4,3}}
\end{tabproof}

\FormulaThmDeltaK[Addieren der Ganzzahleins erhält den Träger]{%
  z\in\mathbb Z\vdash z+\IntOne\in\mathbb Z%
}{IntegerAddOneClosure}{\DeltaRow{Mengen}{z}}
\begin{tabproof}
  \proofstep{1}{z\in\mathbb Z}{\rA}
  \proofstep{}{\IntOne\in\mathbb Z}{\FormulaRefAuto{IntOneCarrier}[thm]}
  \proofstep{1}{z+\IntOne\in\mathbb Z}{\FormulaRefAuto{IntAddClosure}[thm]{1,2}}
\end{tabproof}

\FormulaThmDeltaK[Subtrahieren der Ganzzahleins erhält den Träger]{%
  z\in\mathbb Z\vdash z-\IntOne\in\mathbb Z%
}{IntegerMinusOneClosure}{\DeltaRow{Mengen}{z}}
\begin{tabproof}
  \proofstep{1}{z\in\mathbb Z}{\rA}
  \proofstep{}{\IntOne\in\mathbb Z}{\FormulaRefAuto{IntOneCarrier}[thm]}
  \proofstep{1}{z-\IntOne\in\mathbb Z}{%
    \FormulaRefAuto{IntegerSubtractionClosure}[thm]{1,2}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Elimination des Repräsentanten]{%
    ...
    \proofstepwidestar[3]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntZeroCarrier}}
    \proofstepwidestar[3]{z = { ( z + \IntZero ) }}{%
    ...
    \proofstepwidestar[3]{\IntZero+z=z}{%
      \FormulaRefAuto{IntAddCommutative}{%
        ...
        6}}
    \proofstepwidestar[3]{%
      z+\IntZero=z\land\IntZero+z=z}{\rAI{4,7}}
    \proofstepwidestar[1]{%
      z+\IntZero=z\land\IntZero+z=z}{\rEE{2,3,8}}
  \closeproofpartwideindR
\end{tabproofsplitwide}
  ...
  \proofpartwideindR[Inverse Rechnung auf einer Klasse]{%
    ...
    \proofstepwidestar[]{\IntClass{0}{0}=\IntZero}{%
      \FormulaRefAuto{a=b\vdash b=a}{%
        10}}
    \proofstepwidestar[1]{%
      \IntClass{a}{b}+(-\IntClass{a}{b})=\IntZero}{\rChain{3,9,11}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Wechsel des ersten Repräsentanten]{%
    ...
    \proofstepwidestar[1,2]{a\cdot d+b'\cdot d=b\cdot d+a'\cdot d}{%
      \FormulaRefAuto{PeanoScaledSumEqualityRight}{1,3}}
    ...
    \proofstepwidestarbreakkeep[1,2]{%
      ...
      \FormulaRefAuto{PeanoSumEqualitiesAddition}{\rAI{9,10},4,6}}
    \proofstepwidestarbreakkeep[1,2]{%
      (ac+bd)+(a'd+b'c)=(ad+bc)+(a'c+b'd)}{%
      \rIE{7,11,8}}
    \proofstepwidestarbreakkeep[1,2]{%
      \IntClass{ac+bd}{ad+bc}=\IntClass{a'c+b'd}{a'd+b'c}}{%
      \FormulaRefAuto{IntegerClassEquality}{1,12}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Wechsel des zweiten Repräsentanten]{%
    ...
    \proofstepwidestar[1,2]{b\cdot c+b\cdot d'=b\cdot d+b\cdot c'}{%
      \FormulaRefAuto{PeanoScaledSumEqualityLeft}{1,3}}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \FormulaRefAuto{PeanoSumEqualitiesAddition}{\rAI{7,8},4,6}}
    \proofstepwidestar[1,2]{%
      \IntClass{ac+bd}{ad+bc}=\IntClass{ac'+bd'}{ad'+bc'}}{%
      \FormulaRefAuto{IntegerClassEquality}{1,9}}
  \closeproofpartwideindR
...
\end{aligned}}{%
  ...
  \proofstepwidestar[4]{(a,b\in\mathbb N)\land(c,d\in\mathbb N)}{%
    \rA}
  \proofstepwidestar[4]{a\cdot c\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}[thm]{\rAEa{\rAEa{4}},\rAEa{\rAEb{4}}}}
  \proofstepwidestar[4]{b\cdot d\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}[thm]{\rAEb{\rAEa{4}},\rAEb{\rAEb{4}}}}
  \proofstepwidestar[4]{a\cdot d\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}[thm]{\rAEa{\rAEa{4}},\rAEb{\rAEb{4}}}}
  \proofstepwidestar[4]{b\cdot c\in\mathbb N}{%
    \FormulaRefAuto{PeanoMulClosure}[thm]{\rAEb{\rAEa{4}},\rAEa{\rAEb{4}}}}
  \proofstepwidestar[4]{a\cdot c+b\cdot d\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddClosure}[thm]{5,6}}
  \proofstepwidestar[4]{a\cdot d+b\cdot c\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddClosure}[thm]{7,8}}
  \proofstepwidestar[4]{\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\in\mathbb Z}{%
    \FormulaRefAuto{IntegerClassInZ}[thm]{9,10}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\forall c\forall d\,\bigl(((a,b\in\mathbb N)\land(c,d\in\mathbb N))\rightarrow\\[-2pt]
&\qquad \IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\in\mathbb Z\bigr)
\end{aligned}}{%
...
\end{aligned}}{%
    \rA}
  \proofstepwidestar[13]{\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}=\IntClass{e\cdot g+f\cdot h}{e\cdot h+f\cdot g}}{%
    \FormulaRefAuto{IntegerMultiplicationCompatible}[thm]{\rAIStar{\rAEa{\rAEa{13}},\rAEb{\rAEa{13}},\rAEa{\rAEa{\rAEb{\rAEb{13}}}},\rAEb{\rAEa{\rAEb{\rAEb{13}}}},\rAEa{\rAEa{\rAEb{13}}},\rAEb{\rAEa{\rAEb{13}}},\rAEa{\rAEa{\rAEb{\rAEb{\rAEb{13}}}}},\rAEb{\rAEa{\rAEb{\rAEb{\rAEb{13}}}}}},\rAEa{\rAEb{\rAEb{\rAEb{\rAEb{13}}}}},\rAEb{\rAEb{\rAEb{\rAEb{\rAEb{13}}}}}}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall a\forall b\forall c\forall d\forall e\forall f\forall g\forall h\,\Bigl(\\[-2pt]
&(a,b\in\mathbb N)\land(c,d\in\mathbb N)\land{}\\[-2pt]
&(e,f\in\mathbb N)\land(g,h\in\mathbb N)\land{}\\[-2pt]
&\IntClass{a}{b}=\IntClass{e}{f}\land \IntClass{c}{d}=\IntClass{g}{h}\rightarrow\\[-2pt]
&\qquad \IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}={}\\[-2pt]
&\qquad \IntClass{e\cdot g+f\cdot h}{e\cdot h+f\cdot g}\Bigr)
\end{aligned}}{%
    \rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rUI{\rRI{13,14}}}}}}}}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a\exists b\exists c\exists d\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land(c,d\in\mathbb N)\land z=\IntClass{a}{b}\land{}\\[-2pt]
&\qquad w=\IntClass{c}{d}\land u=\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\bigr)
\end{aligned}}{%
    \FormulaRefAuto{RepresentativePairBinaryValueUnique}[thm]{2,3,12,15,\rAEa{1},\rAEb{1}}}
  \proofstepwidestar[]{\begin{aligned}[t]
&\forall u\,\Bigl(\exists a\exists b\exists c\exists d\,\\[-2pt]
&\bigl((a,b\in\mathbb N)\land(c,d\in\mathbb N)\land z=\IntClass{a}{b}\land{}\\[-2pt]
&\qquad w=\IntClass{c}{d}\land u=\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\bigr)\\[-2pt]
&\quad\leftrightarrow{}\exists a,b,c,d\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land w=\IntClass{c}{d}\land{}\\[-2pt]
&\qquad u=\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\bigr)\Bigr)
\end{aligned}}{%
    \rUI{\FormulaRefAuto{P \leftrightarrow Q \vdash Q \leftrightarrow P}[thm]{\FormulaRefAuto{BoundedFourExistsGuard}[thm]}}}
  \proofstepwidestar[1]{\begin{aligned}[t]
&\exists!u\in\mathbb Z\,\exists a,b,c,d\in\mathbb N\,\\[-2pt]
&\bigl(z=\IntClass{a}{b}\land w=\IntClass{c}{d}\land{}\\[-2pt]
&\qquad u=\IntClass{a\cdot c+b\cdot d}{a\cdot d+b\cdot c}\bigr)
\end{aligned}}{%
  ...
  \proofpartwideindR[Abgeschlossenheit für feste Repräsentanten]{%
    ...
    \proofstepwidestarbreakkeep[1]{ac+bd\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}{%
        3,
        4}}
    \proofstepwidestar[1]{a\cdot d\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}{1}}
    \proofstepwidestar[1]{b\cdot c\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}{1}}
    ...
    \proofstepwidestarbreakkeep[1]{\IntClass{ac+bd}{ad+bc}\in\mathbb Z}{%
      \FormulaRefAuto{IntegerClassInZ}{5,8}}
    \proofstepwidestarbreakkeep[1]{z\cdot w\in\mathbb Z}{\rIE{2,9}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechte Einheit am Repräsentanten]{%
    ...
    \proofstepwidestar[1]{b\cdot0=0}{%
      \FormulaRefAuto{PeanoMulRightZero}{1}}
    \proofstepwide[1]{a\cdot1+b\cdot0}{=}{a+0}{\rIE{5,8}}
    \proofstepwide[1]{}{=}{a}{\FormulaRefAuto{PeanoAddRightZero}{1}}
    \proofstepwidestar[1]{a\cdot1+b\cdot0=a}{\rChain{9,10}}
    \proofstepwide[1]{a\cdot0+b\cdot1}{=}{0+b}{\rIE{7,6}}
    \proofstepwide[1]{}{=}{b}{\FormulaRefAuto{PeanoAddLeftZero}{1}}
    \proofstepwidestar[1]{a\cdot0+b\cdot1=b}{\rChain{12,13}}
    \proofstepwide[1]{z\cdot\IntOne}{=}{%
      \IntClass{a\cdot1+b\cdot0}{a\cdot0+b\cdot1}}{%
      \FormulaRefAuto{IntegerMultiplicationDef}{1,2,4}}
    \proofstepwide[1]{}{=}{\IntClass{a}{b}}{\rIE{11,14}}
    \proofstepwide[1]{}{=}{z}{%
      \FormulaRefAuto{a=b\vdash b=a}{\rAEb{1}}}
    \proofstepwidestar[1]{z\cdot\IntOne=z}{\rChain{15,16,17}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Beidseitige Einheit]{%
    ...
    \proofstepwidestar[3]{\IntOne \in \mathbb Z}{%
      \FormulaRefAuto{IntOneCarrier}}
    \proofstepwidestar[3]{z = { ( z \cdot \IntOne ) }}{%
      \FormulaRefAuto{a=b\vdash b=a}{4}}
    ...
    \proofstepwidestar[3]{z\cdot\IntOne=z\land
      \IntOne\cdot z=z}{\rAI{4,7}}
    \proofstepwidestar[1]{z\cdot\IntOne=z\land
      \IntOne\cdot z=z}{\rEE{2,3,8}}
  \closeproofpartwideindR
\end{tabproofsplitwide}
  ...
  \proofpartwideindR[Rechnung mit Klassen]{%
    ...
    \proofstepwidestarbreakkeep[1]{%
      \begin{aligned}[t]
        &\IntClass{a}{b}\cdot
          (\IntClass{c}{d}\cdot\IntClass{e}{f})={}\\
        &\bigl[a(ce+df)+b(cf+de),\\[-2pt]
        &\quad a(cf+de)+b(ce+df)\bigr]_{\mathbb Z}
      \end{aligned}}{%
      \FormulaRefAuto{IntegerMultiplicationDef}{1}}
    \proofstepwidestarbreakkeep[1]{\begin{aligned}[t]
      &(ac+bd)e+(ad+bc)f={}\\
    ...
    \proofstepwidestarbreakkeep[1]{%
      \begin{aligned}[t]
        &(\IntClass{a}{b}\cdot\IntClass{c}{d})
          \cdot\IntClass{e}{f}={}\\
        &\bigl[(ac+bd)e+(ad+bc)f,\\[-2pt]
        &\quad (ac+bd)f+(ad+bc)e\bigr]_{\mathbb Z}
      \end{aligned}}{%
      \FormulaRefAuto{IntegerMultiplicationDef}{1}}
    \proofstepwidestarbreakkeep[1]{%
      \begin{aligned}[t]
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Distributivrechnung auf Klassen]{%
    ...
    \proofstepwidestar[1]{a,b,c,d,e,f\in\mathbb N}{\rA}
    \proofstepwidestar[1]{ac,bd,ad,bc,ae,bf,af,be\in\mathbb N}{
      \FormulaRefAuto{PeanoMulClosure}{1}}
    \proofstepwidestar[1]{ac+bd,ad+bc,ae+bf,af+be\in\mathbb N}{
      \FormulaRefAuto{PeanoAddClosure}{2}}
    \proofstepwidestar[1]{c+e,d+f\in\mathbb N}{
      \FormulaRefAuto{PeanoAddClosure}{1}}
    \proofstepwidestar[1]{\IntClass{a}{b}\cdot\IntClass{c}{d}
      =\IntClass{ac+bd}{ad+bc}}{\FormulaRefAuto{IntegerMultiplicationDef}{1}}
    \proofstepwidestar[1]{\IntClass{a}{b}\cdot\IntClass{e}{f}
      =\IntClass{ae+bf}{af+be}}{\FormulaRefAuto{IntegerMultiplicationDef}{1}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{ac+bd}{ad+bc}+\IntClass{ae+bf}{af+be}={}\\
      &\IntClass{(ac+bd)+(ae+bf)}{(ad+bc)+(af+be)}
      \end{aligned}}{\FormulaRefAuto{IntegerAdditionDef}{3}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{a}{b}\cdot\IntClass{c}{d}
        +\IntClass{a}{b}\cdot\IntClass{e}{f}={}\\
      &\IntClass{(ac+bd)+(ae+bf)}{(ad+bc)+(af+be)}
      \end{aligned}}{\rIE{5,\rIE{6,7}}}
    \proofstepwidestar[1]{\IntClass{c}{d}+\IntClass{e}{f}
      =\IntClass{c+e}{d+f}}{\FormulaRefAuto{IntegerAdditionDef}{1}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{a}{b}\cdot\IntClass{c+e}{d+f}={}\\
      &\IntClass{a(c+e)+b(d+f)}{a(d+f)+b(c+e)}
      \end{aligned}}{\FormulaRefAuto{IntegerMultiplicationDef}{1,4}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{a}{b}\cdot(\IntClass{c}{d}+\IntClass{e}{f})={}\\
      &\IntClass{a(c+e)+b(d+f)}{a(d+f)+b(c+e)}
      \end{aligned}}{\rIE{9,10}}
    \proofstepwidestar[1]{a(c+e)+b(d+f)=(ac+bd)+(ae+bf)}{
      \FormulaRefAuto{IntMulLeftDistributivePositiveCoordinate}{1}}
    \proofstepwidestar[1]{a(d+f)+b(c+e)=(ad+bc)+(af+be)}{
      \FormulaRefAuto{IntMulLeftDistributiveNegativeCoordinate}{1}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{a(c+e)+b(d+f)}{a(d+f)+b(c+e)}={}\\
      &\IntClass{(ac+bd)+(ae+bf)}{(ad+bc)+(af+be)}
      \end{aligned}}{\rIE{12,\rIE{13,\rII}}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\bigl[(ac+bd)+(ae+bf),\\[-2pt]
        &\quad (ad+bc)+(af+be)\bigr]_{\mathbb Z}={}\\
      &\IntClass{a}{b}\cdot\IntClass{c}{d}
        +\IntClass{a}{b}\cdot\IntClass{e}{f}
      \end{aligned}}{\FormulaRefAuto{a=b\vdash b=a}{8}}
    \proofstepwidestar[1]{\begin{aligned}[t]
      &\IntClass{a}{b}\cdot(\IntClass{c}{d}+\IntClass{e}{f})={}\\
      &\IntClass{a}{b}\cdot\IntClass{c}{d}
        +\IntClass{a}{b}\cdot\IntClass{e}{f}
      \end{aligned}}{\rChain{11,14,15}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{u\cdot w=w\cdot u}{%
    \FormulaRefAuto{IntMulCommutative}{1}}
  \proofstepwidestar[1]{z+w\in\mathbb Z}{%
      \FormulaRefAuto{IntAddClosure}{1}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{0+0=0}{%
    \FormulaRefAuto{PeanoAddRightZero}{5}}
  \proofstepwidestar[]{0=0+0}{%
    \FormulaRefAuto{a=b\vdash b=a}{6}}
  \proofstepwide[1]{\IntEmbed(m+n)}{=}{\IntClass{m+n}{0}}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{2}}
  \proofstepwide[1]{}{=}{\IntClass{m+n}{0+0}}{\rIE{7}}
  \proofstepwidestar[1]{\IntEmbed(m)+\IntEmbed(n)=\IntClass{m+n}{0+0}}{%
      \FormulaRefAuto{IntegerAdditionDef}{1,3,4}}
  \proofstepwide[1]{\IntClass{m+n}{0+0}}{=}{\IntEmbed(m)+\IntEmbed(n)}{%
    \FormulaRefAuto{a=b\vdash b=a}{%
      10}}
  \proofstepwidestar[1]{\IntEmbed(m+n)=
    \IntEmbed(m)+\IntEmbed(n)}{\rChain{8,9,11}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Produkt der eingebetteten Faktoren]{%
    ...
    \proofstepwidestar[]{0\cdot0=0}{%
      \FormulaRefAuto{PeanoMulLeftZero}{5}}
    \proofstepwidestar[1]{m\cdot0=0}{%
      \FormulaRefAuto{PeanoMulRightZero}{1}}
    \proofstepwidestar[1]{0\cdot n=0}{%
      \FormulaRefAuto{PeanoMulLeftZero}{1}}
    \proofstepwidestar[1]{{ m n } + 0 = { m n }}{%
      \FormulaRefAuto{PeanoAddRightZero}{2}}
    \proofstepwidestar[1]{mn+0\cdot0=mn}{%
      \rIE{6,9}}
    \proofstepwidestar[1]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}}
    \proofstepwidestar[1]{0 + 0 = 0}{%
      \FormulaRefAuto{PeanoAddRightZero}{11}}
    ...
    \proofstepwide[1]{}{=}{\IntClass{mn}{0}}{\rIE{10,13}}
    \proofstepwidestar[1]{%
      \IntEmbed(m)\cdot\IntEmbed(n)=\IntClass{mn}{0}}{%
      \rChain{14,15}}
  \closeproofpartwideindR
...
\FormulaThmDeltaKR[Multiplikation ganzer Zahlen mit null aus den Axiomen]{%
  \begin{aligned}[t]
    &z\in\mathbb Z\vdash{}\\[-2pt]
    &\text{(i)}\quad z\cdot\IntZero=\IntZero,\\[-2pt]
    &\text{(ii)}\quad \IntZero\cdot z=\IntZero.
  \end{aligned}%
}{%
  z\in\mathbb Z\vdash
...
\begin{tabproofsplitwide}
\proofpartwide{Rechtes Nullgesetz}
\proofstepwidestarbreak[1]{z\in\mathbb Z}{\rA}
  \proofstepwidestar[1]{\IntZero \in \mathbb Z}{%
  ...
  \proofstepwidestar[]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}
  \proofstepwidestar[]{\IntZero + \IntZero = \IntZero \land \IntZero + \IntZero = \IntZero}{%
  ...
  \proofstepwidestarbreak[1]{z\cdot\IntZero
    =z\cdot(\IntZero+\IntZero)}{\rIE{6}}
  \proofstepwidestarbreak[1]{z\cdot\IntZero
    =z\cdot\IntZero+z\cdot\IntZero}{\rChain{9,8}}
  \proofstepwidestar[1]{{ ( z \cdot \IntZero ) } + ( - { ( z \cdot \IntZero ) } ) = \IntZero \land ( - { ( z \cdot \IntZero ) } ) + { ( z \cdot \IntZero ) } = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{3}}
  \proofstepwidestarbreak[1]{-(z\cdot\IntZero)
  ...
  \proofstepwidestarbreak[1]{%
    ...
    =-(z\cdot\IntZero)
      +(z\cdot\IntZero+z\cdot\IntZero)}{%
    \FormulaRefAuto{IntegerAddAssociativeAxiom}[ax]{13,3,3}}
  \proofstepwidestarbreak[1]{%
    \bigl(-(z\cdot\IntZero)+(z\cdot\IntZero)\bigr)
      +z\cdot\IntZero
    =\IntZero+z\cdot\IntZero}{\rIE{12}}
  \proofstepwidestar[1]{{ ( z \cdot \IntZero ) } + \IntZero = { ( z \cdot \IntZero ) } \land \IntZero + { ( z \cdot \IntZero ) } = { ( z \cdot \IntZero ) }}{%
  ...
  \proofstepwidestarbreak[1]{%
    \bigl(-(z\cdot\IntZero)+(z\cdot\IntZero)\bigr)
      +z\cdot\IntZero
    =z\cdot\IntZero}{\rChain{15,17}}
  \proofstepwide[1]{z\cdot\IntZero}{=}{%
    -(z\cdot\IntZero)+(z\cdot\IntZero+z\cdot\IntZero)}{%
    \FormulaRefAuto{a=b\vdash b=a}{\rIE{14,18}}}
  \proofstepwide[1]{}{=}{%
    -(z\cdot\IntZero)+(z\cdot\IntZero)}{%
    \FormulaRefAuto{a=b\vdash b=a}{\rIE{10}}}
  \proofstepwidestar[1]{{ ( z \cdot \IntZero ) } + ( - { ( z \cdot \IntZero ) } ) = \IntZero \land ( - { ( z \cdot \IntZero ) } ) + { ( z \cdot \IntZero ) } = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{3}}
  \proofstepwide[1]{-(z\cdot\IntZero)+(z\cdot\IntZero)}{=}{\IntZero}{%
    \rAEb{21}}
  \proofstepwidestarbreak[1]{z\cdot\IntZero=\IntZero}{%
    \rChain{19,20,22}}
...
\proofpartwide{Linkes Nullgesetz}
...
\proofstepwidestarbreak[1]{\IntZero\cdot z=z\cdot\IntZero}{%
    \FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{%
      24,1}}
  \proofstepwidestarbreak[1]{\IntZero\cdot z=\IntZero}{\rChain{25,23}}
...
\proofstepwidestarbreak[1]{z\cdot\IntZero=\IntZero\land
    \IntZero\cdot z=\IntZero}{\rAI{23,26}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{{ ( - \IntZero ) } + \IntZero = { ( - \IntZero ) } \land \IntZero + { ( - \IntZero ) } = { ( - \IntZero ) }}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{2}}
  ...
  \proofstepwide[]{(-\IntZero)+\IntZero}{=}{\IntZero}{%
    \rAEb{5}}
  \proofstepwidestar[]{-\IntZero=\IntZero}{\rChain{4,6}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{y + ( - y ) = \IntZero \land ( - y ) + y = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{3}}
  ...
  \proofstepwide[1]{}{=}{x\cdot\IntZero}{\rIE{9}}
  \proofstepwidestar[1]{x \cdot \IntZero = \IntZero \land \IntZero \cdot x = \IntZero}{%
      \FormulaRefAuto{IntegerMulZeroFromAxioms}[thm]{2}}
  \proofstepwide[1]{x\cdot\IntZero}{=}{\IntZero}{%
    \rAEa{13}}
  \proofstepwidestarbreakkeep[1]{%
    x\cdot y+x\cdot(-y)=\IntZero}{\rChain{11,12,14}}
  \proofstepwidestar[1]{{ ( x \cdot y ) } + ( - { ( x \cdot y ) } ) = \IntZero \land ( - { ( x \cdot y ) } ) + { ( x \cdot y ) } = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{5}}
  \proofstepwidestarbreakkeep[1]{%
    -(x\cdot y)+x\cdot y=\IntZero}{%
    \rAEb{16}}
  \proofstepwidestar[1]{{ ( x \cdot ( - y ) ) } + \IntZero = { ( x \cdot ( - y ) ) } \land \IntZero + { ( x \cdot ( - y ) ) } = { ( x \cdot ( - y ) ) }}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{6}}
  \proofstepwidestarbreakkeep[1]{%
    \IntZero+x\cdot(-y)=x\cdot(-y)}{%
    \rAEb{18}}
  \proofstepwide[1]{x\cdot(-y)}{=}{\IntZero+x\cdot(-y)}{%
    \FormulaRefAuto{a=b\vdash b=a}{19}}
  \proofstepwidestarbreakkeep[1]{%
    \IntZero=-(x\cdot y)+x\cdot y}{%
    \FormulaRefAuto{a=b\vdash b=a}{17}}
  \proofstepwide[1]{\IntZero+x\cdot(-y)}{=}{%
    \bigl(-(x\cdot y)+x\cdot y\bigr)+x\cdot(-y)}{\rIE{21}}
  \proofstepwide[1]{}{=}{%
    -(x\cdot y)+\bigl(x\cdot y+x\cdot(-y)\bigr)}{%
    \FormulaRefAuto{IntegerAddAssociativeAxiom}[ax]{7,5,6}}
  \proofstepwide[1]{}{=}{-(x\cdot y)+\IntZero}{\rIE{15}}
  \proofstepwidestar[1]{{ ( - ( x \cdot y ) ) } + \IntZero = { ( - ( x \cdot y ) ) } \land \IntZero + { ( - ( x \cdot y ) ) } = { ( - ( x \cdot y ) ) }}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{7}}
  \proofstepwide[1]{-(x\cdot y)+\IntZero}{=}{-(x\cdot y)}{%
    \rAEa{25}}
  \proofstepwidestarbreakkeep[1]{%
    x\cdot(-y)=-(x\cdot y)}{\rChain{20,22,23,24,26}}
\end{tabproofwide}
...
\chapter{Schritte um eins und Normalformen}

\section{Addieren und Subtrahieren der Eins}

Die Schritte auf \(\mathbb Z\) werden durch \(+\IntOne\) und
\(-\IntOne\) geschrieben. Wo die zugehörige Funktion selbst benötigt wird,
bezeichnen \((x\mapsto x+\IntOne)\) und \((x\mapsto x-\IntOne)\)
die eindeutigen Abbildungen mit den folgenden Grundgleichungen.
Ihre Existenz folgt aus \FormulaRefAuto{TypedFunctionDefinitionPrinciple}[thm]
und dem jeweils angegebenen Abschlussbeweis.

\FormulaDefDeltaK[Abbildung zum Addieren der Ganzzahleins]{%
  \begin{aligned}[t]
    &(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z,\\[-2pt]
    &\forall z\in\mathbb Z\,
      \bigl((x\mapsto x+\IntOne)(z)\coloneqq z+\IntOne\bigr)
  \end{aligned}%
}{IntegerSuccessorDef}{%
  \DeltaRow{Mengen}{z}%
  \DeltaRow{Neue Abbildungsschreibweise}{(x\mapsto x+\IntOne)}%
}
\begin{tabproof}
  \proofstep{1}{z\in\mathbb Z}{\rA}
  \proofstep{1}{z+\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerAddOneClosure}[thm]{1}}
  \proofstep{}{\forall z\in\mathbb Z\,(z+\IntOne\in\mathbb Z)}{\rUI{\rRI{1,2}}}
\end{tabproof}

\FormulaDefDeltaK[Abbildung zum Subtrahieren der Ganzzahleins]{%
  \begin{aligned}[t]
    &(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z,\\[-2pt]
    &\forall z\in\mathbb Z\,
      \bigl((x\mapsto x-\IntOne)(z)\coloneqq z-\IntOne\bigr)
...
\begin{tabproof}
  \proofstep{1}{z\in\mathbb Z}{\rA}
  \proofstep{1}{z-\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerMinusOneClosure}[thm]{1}}
  \proofstep{}{\forall z\in\mathbb Z\,(z-\IntOne\in\mathbb Z)}{\rUI{\rRI{1,2}}}
\end{tabproof}

\FormulaThmDeltaK[Addieren der Ganzzahleins als Funktion]{%
  (x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z%
}{IntegerSuccessorFunction}{%
  \DeltaRow{Abbildung}{(x\mapsto x+\IntOne)}%
}
\begin{tabproofwide}
  \proofstepwidestar[]{(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z}{%
    \FormulaRefAuto{IntegerSuccessorDef}[def]}
\end{tabproofwide}

\FormulaThmDeltaK[Subtrahieren der Ganzzahleins als Funktion]{%
  (x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z%
...
\FormulaThmDeltaK[Auswertung der Abbildung zum Addieren der Eins]{%
  z\in\mathbb Z\vdash (x\mapsto x+\IntOne)(z)=z+\IntOne%
}{IntegerSuccessorValue}{\DeltaRow{Mengen}{z}}
\begin{tabproofwide}
  \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
  \proofstepwidestarbreakkeep[]{\forall u\in\mathbb Z\,
    ((x\mapsto x+\IntOne)(u)=u+\IntOne)}{%
    \FormulaRefAuto{IntegerSuccessorDef}[def]}
  \proofstepwidestar[1]{(x\mapsto x+\IntOne)(z)=z+\IntOne}{\rRE{\rUE{2},1}}
\end{tabproofwide}

\FormulaThmDeltaK[Auswertung der Abbildung zum Subtrahieren der Eins]{%
  z\in\mathbb Z\vdash (x\mapsto x-\IntOne)(z)=z-\IntOne%
}{IntegerPredecessorValue}{\DeltaRow{Mengen}{z}}
\begin{tabproofwide}
  \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
  \proofstepwidestarbreakkeep[]{\forall u\in\mathbb Z\,
    ((x\mapsto x-\IntOne)(u)=u-\IntOne)}{%
...
\FormulaThmDeltaK[Addieren der Eins auf Klassen]{%
  a,b\in\mathbb N\vdash
  \IntClass{a}{b}+\IntOne=\IntClass{a+1}{b}%
}{IntegerSuccessorClassValue}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproofwide}
  \proofstepwidestar[1]{a,b\in\mathbb N}{\rA}
  \proofstepwidestar[]{0 \in \mathbb N}{%
  ...
  \proofstepwidestar[]{0,1\in\mathbb N}{%
    \rAI{2,3}}
  \proofstepwidestar[]{\IntOne = \IntOfNat 1}{%
  ...
  \proofstepwidestar[]{\IntOne=\IntClass{1}{0}}{%
    \rChain{5,%
      6}}
  \proofstepwidestar[1]{b+0=b}{\FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
  \proofstepwidestar[1]{\IntClass{a}{b}+\IntClass{1}{0}=\IntClass{a+1}{b+0}}{%
      \FormulaRefAuto{IntegerAdditionDef}[def]{1,4}}
  \proofstepwide[1]{\IntClass{a}{b}+\IntOne}{=}{\IntClass{a+1}{b+0}}{%
    \rIE{7,9}}
  \proofstepwide[1]{}{=}{\IntClass{a+1}{b}}{\rIE{8}}
  \proofstepwidestar[1]{\IntClass{a}{b}+\IntOne=\IntClass{a+1}{b}}{\rChain{10,11}}
\end{tabproofwide}

\FormulaThmDeltaK[Subtrahieren der Eins auf Klassen]{%
  a,b\in\mathbb N\vdash
  \IntClass{a}{b}-\IntOne=\IntClass{a}{b+1}%
}{IntegerPredecessorClassValue}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproofwide}
  \proofstepwidestar[1]{a,b\in\mathbb N}{\rA}
  \proofstepwidestar[]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
  ...
  \proofstepwidestar[]{\IntOne=\IntClass{1}{0}}{%
    \rChain{5,%
      6}}
  \proofstepwidestar[]{-\IntClass{1}{0}=\IntClass{0}{1}}{%
      \FormulaRefAuto{IntegerNegationDef}[def]{4}}
  \proofstepwidestar[]{-\IntOne=\IntClass{0}{1}}{%
    \rIE{7,8}}
  \proofstepwidestar[1]{a+0=a}{\FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
  \proofstepwidestar[1]{\IntOne \in \mathbb Z}{%
      \FormulaRefAuto{IntOneCarrier}[thm]}
  \proofstepwidestar[1]{\IntClass{a}{b}\in\mathbb Z}{%
      \FormulaRefAuto{IntegerClassInZ}[thm]{1}}
  \proofstepwide[1]{\IntClass{a}{b}-\IntOne}{=}{\IntClass{a}{b}+(-\IntOne)}{%
    \FormulaRefAuto{IntegerSubtractionDef}[def]{%
      12,11}}
  \proofstepwidestar[1]{\IntClass{a}{b}+\IntClass{0}{1}=\IntClass{a+0}{b+1}}{%
      \FormulaRefAuto{IntegerAdditionDef}[def]{1,4}}
  \proofstepwide[1]{\IntClass{a}{b}+(-\IntOne)}{=}{\IntClass{a+0}{b+1}}{%
    \rIE{9,14}}
  \proofstepwide[1]{}{=}{\IntClass{a}{b+1}}{\rIE{10}}
  \proofstepwidestar[1]{\IntClass{a}{b}-\IntOne=\IntClass{a}{b+1}}{\rChain{13,15,16}}
\end{tabproofwide}

\FormulaThmDeltaK[Subtrahieren nach Addieren der Eins]{%
  z\in\mathbb Z\vdash (z+\IntOne)-\IntOne=z%
}{IntegerPredAfterSucc}{\DeltaRow{Mengen}{z}}
\begin{tabproofsplitwide}
  \proofpartwideindR[Auflösen der Subtraktion]{%
    z\in\mathbb Z\vdash (z+\IntOne)-\IntOne=(z+\IntOne)+(-\IntOne)
  }{%
    z\in\mathbb Z\vdash (z+\IntOne)-\IntOne=(z+\IntOne)+(-\IntOne)
  }[IntegerPredAfterSuccExpansion]
    \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestar[1]{z+\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerAddOneClosure}[thm]{1}}
    \proofstepwidestar[1]{\IntOne \in \mathbb Z}{%
      \FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}
    \proofstepwidestarbreakkeep[1]{(z+\IntOne)-\IntOne=(z+\IntOne)+(-\IntOne)}{%
      \FormulaRefAuto{IntegerSubtractionDef}[def]{2,3}}
  \closeproofpartwideindR
  \proofpartwide{Assoziativität und Inverses}
    \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestar[]{\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}
    \proofstepwidestar[]{-\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerNegClosureAxiom}[ax]{2}}
    \proofstepwidestar[]{\IntOne + ( - \IntOne ) = \IntZero \land ( - \IntOne ) + \IntOne = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{2}}
    \proofstepwidestar[]{\IntOne+(-\IntOne)=\IntZero}{%
      \rAEa{4}}
    \proofstepwide[1]{(z+\IntOne)-\IntOne}{=}{(z+\IntOne)+(-\IntOne)}{%
      \FormulaRefAuto{IntegerPredAfterSuccExpansion}[thm]{1}}
    \proofstepwide[1]{}{=}{z+(\IntOne+(-\IntOne))}{%
      \FormulaRefAuto{IntegerAddAssociativeAxiom}[ax]{1,2,3}}
    \proofstepwide[1]{}{=}{z+\IntZero}{\rIE{5}}
    \proofstepwidestar[1]{z + \IntZero = z \land \IntZero + z = z}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{1}}
    \proofstepwide[1]{z+\IntZero}{=}{z}{\rAEa{9}}
    \proofstepwidestar[1]{(z+\IntOne)-\IntOne=z}{\rChain{6,7,8,10}}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaThmDeltaK[Addieren nach Subtrahieren der Eins]{%
  z\in\mathbb Z\vdash (z-\IntOne)+\IntOne=z%
}{IntegerSuccAfterPred}{\DeltaRow{Mengen}{z}}
\begin{tabproofsplitwide}
  \proofpartwideindR[Auflösen der Subtraktion]{%
    z\in\mathbb Z\vdash (z-\IntOne)+\IntOne=(z+(-\IntOne))+\IntOne
  }{%
    ...
    \proofstepwidestar[1]{\IntOne \in \mathbb Z}{%
      \FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}
    \proofstepwidestar[1]{z-\IntOne=z+(-\IntOne)}{%
      \FormulaRefAuto{IntegerSubtractionDef}[def]{1,2}}
    \proofstepwidestarbreakkeep[1]{(z-\IntOne)+\IntOne=(z+(-\IntOne))+\IntOne}{\rIE{3}}
  \closeproofpartwideindR
  \proofpartwideindR[Assoziativität und Inverses]{%
    ...
    \proofstepwidestar[]{(-\IntOne)+\IntOne=\IntZero}{%
      \rAEb{4}}
    \proofstepwide[1]{(z-\IntOne)+\IntOne}{=}{(z+(-\IntOne))+\IntOne}{%
      \FormulaRefAuto{IntegerSuccAfterPredExpansion}[thm]{1}}
    \proofstepwide[1]{}{=}{z+((-\IntOne)+\IntOne)}{%
...
\FormulaThmDeltaK[Bijektivität des Addierens der Ganzzahleins]{%
  (x\mapsto x+\IntOne)\colon\mathbb Z\bij\mathbb Z%
}{IntegerSuccessorBijective}{%
  \DeltaRow{Abkürzung im Beweis}{F\coloneqq(x\mapsto x+\IntOne)}%
  \DeltaRow{Mengen}{x\dsep y}%
}
\begin{tabproofsplitwide}
  \proofpartwideindR[Injektivität]{%
    x,y\in\mathbb Z\dsep F(x)=F(y)\vdash x=y
  }{%
    x,y\in\mathbb Z\dsep F(x)=F(y)\vdash x=y
  }[IntegerSuccessorInjective]
    \proofstepwidestar[1]{x,y\in\mathbb Z}{\rA}
    \proofstepwidestar[2]{F(x)=F(y)}{\rA}
    \proofstepwidestar[1]{F(x)=x+\IntOne}{\FormulaRefAuto{IntegerSuccessorValue}[thm]{1}}
    \proofstepwidestar[1]{F(y)=y+\IntOne}{\FormulaRefAuto{IntegerSuccessorValue}[thm]{1}}
    \proofstepwidestar[1,2]{x+\IntOne=y+\IntOne}{\rIE{2,3,4}}
    \proofstepwidestar[1]{( x + \IntOne ) - \IntOne = x}{%
      \FormulaRefAuto{IntegerPredAfterSucc}[thm]{1}}
    \proofstepwide[1]{x}{=}{(x+\IntOne)-\IntOne}{%
      \FormulaRefAuto{a=b\vdash b=a}{6}}
    \proofstepwide[1,2]{}{=}{(y+\IntOne)-\IntOne}{\rIE{5}}
    \proofstepwide[1]{}{=}{y}{\FormulaRefAuto{IntegerPredAfterSucc}[thm]{1}}
    \proofstepwidestar[1,2]{x=y}{\rChain{7,8,9}}
  \closeproofpartwideindR
  \proofpartwideindR[Surjektivität]{%
    y\in\mathbb Z\vdash\exists x\in\mathbb Z\,F(x)=y
  }{%
    y\in\mathbb Z\vdash\exists x\in\mathbb Z\,F(x)=y
  }[IntegerSuccessorSurjective]
    \proofstepwidestar[1]{y\in\mathbb Z}{\rA}
    \proofstepwidestar[1]{y-\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerMinusOneClosure}[thm]{1}}
    \proofstepwidestar[1]{F(y-\IntOne)=(y-\IntOne)+\IntOne}{\FormulaRefAuto{IntegerSuccessorValue}[thm]{2}}
    \proofstepwidestar[1]{(y-\IntOne)+\IntOne=y}{\FormulaRefAuto{IntegerSuccAfterPred}[thm]{1}}
    \proofstepwidestar[1]{F(y-\IntOne)=y}{\rChain{3,4}}
    \proofstepwidestar[1]{\exists x\in\mathbb Z\,F(x)=y}{\rEI{\rAI{2,5}}}
  \closeproofpartwideindR
  \proofpartwide{Schluss}
    \proofstepwidestar[]{F\colon\mathbb Z\to\mathbb Z}{\FormulaRefAuto{IntegerSuccessorFunction}[thm]}
    \proofstepwidestar[]{\forall x,y\in\mathbb Z\,(F(x)=F(y)\rightarrow x=y)}{%
      \FormulaRefAuto{IntegerSuccessorInjective}[thm]}
    \proofstepwidestar[]{F\colon\mathbb Z\inj\mathbb Z}{\FormulaRefAuto{Injektive Funktion}[def]{1,2}}
    \proofstepwidestar[]{\forall y\in\mathbb Z\,\exists x\in\mathbb Z\,F(x)=y}{%
      \FormulaRefAuto{IntegerSuccessorSurjective}[thm]}
    \proofstepwidestar[]{F\colon\mathbb Z\sur\mathbb Z}{\FormulaRefAuto{Surjektive Funktion}[def]{1,4}}
    \proofstepwidestar[]{F\colon\mathbb Z\bij\mathbb Z}{%
      \FormulaRefAuto{F\colon A\inj B\dsep F\colon A\sur B\vdash F\colon A\bij B}{3,5}}
  \closeproofpartwide
\end{tabproofsplitwide}

\section{Normalformen}

\FormulaThmDeltaK[Addieren der Eins auf dem positiven Strahl]{%
  n\in\mathbb N\vdash \IntEmbed(n)+\IntOne=\IntEmbed(n+1)%
}{IntegerSuccessorOnEmbedding}{\DeltaRow{Mengen}{n}}
\begin{tabproofwide}
  \proofstepwidestar[1]{n\in\mathbb N}{\rA}
  \proofstepwidestar[]{1\in\mathbb N}{\FormulaRefAuto{PeanoOneInN}[thm]}
  \proofstepwidestar[]{\IntOne=\IntEmbed(1)}{\FormulaRefAuto{IntegerOneDef}[def]}
  \proofstepwide[1]{\IntEmbed(n)+\IntOne}{=}{\IntEmbed(n)+\IntEmbed(1)}{\rIE{3}}
  \proofstepwidestar[1]{\IntEmbed ( n + 1 ) = \IntEmbed ( n ) + \IntEmbed ( 1 )}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingAdditive}[thm]{1,2}}
  \proofstepwide[1]{\IntEmbed(n)+\IntEmbed(1)}{=}{\IntEmbed(n+1)}{%
    \FormulaRefAuto{a=b\vdash b=a}{5}}
  \proofstepwidestar[1]{\IntEmbed(n)+\IntOne=\IntEmbed(n+1)}{\rChain{4,6}}
\end{tabproofwide}

\FormulaThmDeltaK[Subtrahieren der Eins auf dem negativen Strahl]{%
  n\in\mathbb N\vdash -\IntEmbed(n)-\IntOne=-\IntEmbed(n+1)%
}{IntegerPredecessorOnNegativeEmbedding}{\DeltaRow{Mengen}{n}}
\begin{tabproofwide}
  \proofstepwidestar[1]{n\in\mathbb N}{\rA}
  ...
  \proofstepwidestar[1]{\IntEmbed(n)=\IntClass{n}{0}}{\FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{1}}
  \proofstepwidestar[1]{-\IntClass{n}{0}=\IntClass{0}{n}}{%
      \FormulaRefAuto{IntegerNegationDef}[def]{1,2}}
  \proofstepwidestar[1]{-\IntEmbed(n)=\IntClass{0}{n}}{%
    \rIE{4,5}}
  \proofstepwidestar[1]{\IntEmbed(n+1)=\IntClass{n+1}{0}}{\FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{3}}
  \proofstepwidestar[1]{-\IntClass{n+1}{0}=\IntClass{0}{n+1}}{%
      \FormulaRefAuto{IntegerNegationDef}[def]{2,3}}
  \proofstepwidestar[1]{-\IntEmbed(n+1)=\IntClass{0}{n+1}}{%
    \rIE{7,8}}
  \proofstepwidestar[1]{\IntClass{0}{n}-\IntOne=\IntClass{0}{n+1}}{%
      \FormulaRefAuto{IntegerPredecessorClassValue}[thm]{2,1}}
  \proofstepwide[1]{-\IntEmbed(n)-\IntOne}{=}{\IntClass{0}{n+1}}{%
    \rIE{6,10}}
  \proofstepwide[1]{}{=}{-\IntEmbed(n+1)}{\FormulaRefAuto{a=b\vdash b=a}{9}}
  \proofstepwidestar[1]{-\IntEmbed(n)-\IntOne=-\IntEmbed(n+1)}{\rChain{11,12}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Fall \(a\leq b\)]{%
    ...
    \proofstepwidestar[4]{-\IntEmbed(n)=\IntClass{0}{n}}{%
      \FormulaRefAuto{IntegerNegationDef}{4,8}}
    \proofstepwidestar[1,4]{\IntClass{a}{b}=-\IntEmbed(n)}{%
      \FormulaRefAuto{a=b\dsep c=b\vdash a=c}{7,9}}
    \proofstepwidestar[1,2]{\exists n\in\mathbb N\,
      \IntClass{a}{b}=-\IntEmbed(n)}{\rEE{3,4,10}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Kürzen einer Translation]{%
    ...
    \proofstepwidestar[1,4]{(a+k)+c=b+c}{%
      \rChain{5,6}}
    \proofstepwidestar[1,4]{a + k \in \mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}{1,4}}
    ...
    \proofstepwidestar[1,4]{a\leq b}{%
      \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
        m\leq n\leftrightarrow
        \exists k\in\mathbb{N}\,(m+k=n)}{1,\rEI{\rAI{\rAEa{4},9}}}}
    \proofstepwidestar[1,2]{a\leq b}{\rEE{3,4,10}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Rückrichtung]{%
    ...
    \proofstepwidestar[3]{c+d'=d+c'}{\rA}
    \proofstepwidestar[4]{a'+d'\leq c'+b'}{\rA}
    \proofstepwidestar[1]{b+a'=a'+b}{\FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1]{a+b'=b'+a}{\FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1,2]{b'+a=a'+b}{\rIE{5,\rIE{6,2}}}
    \proofstepwidestar[1,2]{a'+b=b'+a}{\FormulaRefAuto{a=b\vdash b=a}{7}}
    \proofstepwidestar[1]{d+c'=c'+d}{\FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1]{c+d'=d'+c}{\FormulaRefAuto{PeanoAddCommutative}{1}}
    \proofstepwidestar[1,3]{d'+c=c'+d}{\rIE{9,\rIE{10,3}}}
    \proofstepwidestar[1,3]{c'+d=d'+c}{\FormulaRefAuto{a=b\vdash b=a}{11}}
    \proofstepwidestar[1,2,3,4]{a+d\leq c+b}{
      \FormulaRefAuto{IntegerOrderCompatibleForward}{1,8,12,4}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Reflexivität]{%
    ...
    \proofstepwidestarbreakkeep[1]{\exists a,b\in\mathbb N\,
      z=\IntClass{a}{b}}{\FormulaRefAuto{IntegerPairRepresentative}{1}}
    \proofstepwidestarbreakkeep[3]{a,b\in\mathbb N\land z=\IntClass{a}{b}}{\rA}
    \proofstepwidestar[3]{a + b \in \mathbb N}{%
    ...
    \proofstepwidestarbreakkeep[3]{\IntClass{a}{b}\leq\IntClass{a}{b}}{%
      \FormulaRefAuto{IntegerOrderClassChar}{3,5}}
    \proofstepwidestarbreakkeep[3]{z\leq z}{\rIE{3,6}}
    \proofstepwidestarbreakkeep[1]{z\leq z}{\rEE{2,3,7}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Totalität]{%
    ...
    \proofstepwidestarbreakkeep[6]{a,b,c,d\in\mathbb N\land
      z=\IntClass{a}{b}\land w=\IntClass{c}{d}}{\rA}
    \proofstepwidestar[6]{a + d \in \mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}{6}}
    \proofstepwidestar[6]{c + b \in \mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}{6}}
    ...
    \proofstepwidestarbreakkeep[6]{z\leq w\lor w\leq z}{%
      \FormulaRefAuto{IntegerOrderClassChar}{6,9}}
    \proofstepwidestarbreakkeep[1]{z\leq w\lor w\leq z}{\rEE{4,5,6,10}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechnung auf drei festen Repräsentanten]{%
    ...
    \proofstepwidestar[1]{{ ( ( a + d ) + ( e + f ) \leq ( c + b ) + ( e + f ) ) } \leftrightarrow { ( \IntClass a b + \IntClass e f \leq \IntClass c d + \IntClass e f ) }}{%
      \FormulaRefAuto{P\leftrightarrow Q\vdash Q\leftrightarrow P}{9}}
    \proofstepwidestar[1]{{ \IntClass a b \leq \IntClass c d } \leftrightarrow { ( ( a + d ) + ( e + f ) \leq ( c + b ) + ( e + f ) ) }}{%
      \FormulaRefAuto{P\leftrightarrow Q\dsep Q\leftrightarrow R
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{-a\in\mathbb Z}{%
    \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{1}}
  \proofstepwidestar[1]{a + ( - a ) = \IntZero \land ( - a ) + a = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{1}}
  \proofstepwidestarbreakkeep[1]{a+(-a)=\IntZero}{%
    \rAEa{6}}
  \proofstepwidestar[1]{{ ( - a ) } + \IntZero = { ( - a ) } \land \IntZero + { ( - a ) } = { ( - a ) }}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{5}}
  ...
  \proofstepwidestarbreakkeep[1,2]{%
    a+(-a)\leq\IntZero+(-a)}{\rRE{10,\rAEa{4}}}
  \proofstepwidestarbreakkeep[1,2]{\IntZero\leq-a}{\rIE{7,9,11}}
  \proofstepwidestarbreakkeep[13]{-a=\IntZero}{\rA}
  \proofstepwidestarbreakkeep[13]{-(-a)=-\IntZero}{\rIE{13}}
...
\begin{tabproof}
  ...
  \proofstep{}{\IntOne = \IntOfNat 1}{%
      \FormulaRefAuto{IntegerOneDef}[def]}
  \proofstep{}{\IntZero = \IntOfNat 0}{%
      \FormulaRefAuto{IntegerZeroDef}[def]}
  ...
  \proofstep{}{\IntZero<\IntOne}{%
    \FormulaRefAuto{IntegerStrictOrderDef}[def]{9,10}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Positiver Normalformfall]{%
    ...
    \proofstepwidestar[4,5]{\IntZero = \IntOfNat 0}{%
      \FormulaRefAuto{IntegerZeroDef}[def]}
    \proofstepwidestarbreakkeep[4,5]{z=\IntZero}{%
      \rIE{4,5,6}}
    \proofstepwidestar[1,2]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntZeroCarrier}}
    \proofstepwidestar[1,2]{\IntZero\leq z\land\IntZero\neq z}{%
      \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
        8,1,2}}
    \proofstepwidestarbreakkeep[1,2]{\IntZero\neq z}{%
      \rAEb{9}}
    \proofstepwidestarbreakkeep[1,2,4,5]{\bot}{\rBI{10,7}}
  ...
  \proofpartwideindR[Negativer Normalformfall ist unmöglich]{%
    ...
    \proofstepwidestarbreakkeep[1,2]{\IntZero\leq z}{%
      \rAEa{6}}
    \proofstepwidestar[3]{\IntEmbed ( k ) = \IntClass k 0}{%
    ...
    \proofstepwidestar[1,2,3,4]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1,2,3,4]{\IntZero = \IntClass 0 0}{%
    ...
    \proofstepwidestar[3,12,13]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestarbreakkeep[3,12,13]{k=0}{%
      \FormulaRefAuto{PeanoLeqAntisymmetric}[thm]{%
        3,14,12,13}}
    \proofstepwidestar[3,4,15]{\IntZero = \IntOfNat 0}{%
      \FormulaRefAuto{IntegerZeroDef}[def]}
    \proofstepwidestar[3,4,15]{- \IntZero = \IntZero}{%
      \FormulaRefAuto{IntegerNegativeZero}[thm]}
    \proofstepwidestarbreakkeep[3,4,15]{z=\IntZero}{%
      \rIE{4,15,16,%
        17}}
    \proofstepwidestar[1,2]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntZeroCarrier}}
    ...
    \proofstepwidestarbreakkeep[1,2]{\IntZero\neq z}{%
      \rAEb{20}}
    \proofstepwidestarbreakkeep[1,2,3,4]{\bot}{\rBI{21,18}}
    \proofstepwidestarbreakkeep[1,2,3,4]{%
      \exists n\in\mathbb N\,(n\neq0\land z=\IntEmbed(n))}{%
      \FormulaRefAuto{\bot\vdash P}{22}}
  \closeproofpartwideindR

  \proofpartwide{Elimination der Normalform}
    \proofstepwidestar[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestar[2]{\IntZero<z}{\rA}
    \proofstepwidestar[1]{\exists k\in\mathbb N\,
      (z=\IntEmbed(k)\lor z=-\IntEmbed(k))}{
      \FormulaRefAuto{IntegerSignedNormalForm}[thm]{1}}
    \proofstepwidestar[4]{k\in\mathbb N\land
      (z=\IntEmbed(k)\lor z=-\IntEmbed(k))}{\rA}
    \proofstepwidestar[4]{k\in\mathbb N}{\rAEa{4}}
    \proofstepwidestar[6]{z=\IntEmbed(k)}{\rA}
    \proofstepwidestar[1,2,4,6]{\exists n\in\mathbb N\,
      (n\neq0\land z=\IntEmbed(n))}{
      \FormulaRefAuto{IntegerPositiveEmbeddingRepresentativePositiveCase}{1,2,5,6}}
    \proofstepwidestar[1,2,4]{z=\IntEmbed(k)\to
      \exists n\in\mathbb N\,(n\neq0\land z=\IntEmbed(n))}{\rRI{6,7}}
    \proofstepwidestar[9]{z=-\IntEmbed(k)}{\rA}
    \proofstepwidestar[1,2,4,9]{\exists n\in\mathbb N\,
      (n\neq0\land z=\IntEmbed(n))}{
      \FormulaRefAuto{IntegerPositiveEmbeddingRepresentativeNegativeCase}{1,2,5,9}}
    \proofstepwidestar[1,2,4]{z=-\IntEmbed(k)\to
      \exists n\in\mathbb N\,(n\neq0\land z=\IntEmbed(n))}{\rRI{9,10}}
    \proofstepwidestar[1,2,4]{\exists n\in\mathbb N\,
      (n\neq0\land z=\IntEmbed(n))}{\rOE{\rAEb{4},8,11}}
    \proofstepwidestar[1,2]{\exists n\in\mathbb N\,
      (n\neq0\land z=\IntEmbed(n))}{\rEE{3,4,12}}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaThmDeltaK[Die natürliche Einbettung erhält die Ordnung]{%
  a,b\in\mathbb N\dsep a\leq b\vdash\IntEmbed(a)\leq\IntEmbed(b)%
}{NaturalIntegerEmbeddingOrderPreserving}{\DeltaRow{Mengen}{a\dsep b}}
\begin{tabproofwide}
  \proofstepwidestar[1]{a,b\in\mathbb N}{\rA}
  \proofstepwidestar[2]{a\leq b}{\rA}
  \proofstepwidestar[]{0\in\mathbb N}{\FormulaRefAuto{PeanoZero}[ax]}
  \proofstepwidestar[1]{a+0=a}{\FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
  \proofstepwidestar[1]{b+0=b}{\FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
  \proofstepwidestar[1,2]{a+0\leq b+0}{\rIE{4,5,2}}
  \proofstepwidestar[1,2]{\IntClass{a}{0}\leq\IntClass{b}{0}}{%
    \FormulaRefAuto{IntegerOrderClassChar}[thm]{1,3,6}}
  \proofstepwidestar[1]{\IntEmbed(a)=\IntClass{a}{0}}{\FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{1}}
  \proofstepwidestar[1]{\IntEmbed(b)=\IntClass{b}{0}}{\FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{1}}
  \proofstepwidestar[1,2]{\IntEmbed(a)\leq\IntEmbed(b)}{\rIE{8,9,7}}
\end{tabproofwide}

\FormulaThmDeltaK[Positive natürliche Bilder sind positive ganze Zahlen]{%
  k\in\mathbb N\dsep k\neq0\vdash\IntZero<\IntEmbed(k)%
}{NaturalIntegerEmbeddingPositiveModel}{\DeltaRow{Mengen}{k}}
\begin{tabproofwide}
  \proofstepwidestar[1]{k\in\mathbb N}{\rA}
  \proofstepwidestar[2]{k\neq0}{\rA}
  \proofstepwidestar[]{0\in\mathbb N}{\FormulaRefAuto{PeanoZero}[ax]}
  \proofstepwidestar[1]{0\leq k}{\FormulaRefAuto{PeanoZeroLeq}[thm]{1}}
  \proofstepwidestar[1]{\IntEmbed(0)\leq\IntEmbed(k)}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingOrderPreserving}[thm]{3,1,4}}
  \proofstepwidestar[]{\IntZero=\IntEmbed(0)}{\FormulaRefAuto{IntegerZeroDef}[def]}
  \proofstepwidestar[1]{\IntZero\leq\IntEmbed(k)}{\rIE{6,5}}
  \proofstepwidestar[8]{\IntZero=\IntEmbed(k)}{\rA}
  \proofstepwidestar[8]{\IntEmbed(k)=\IntEmbed(0)}{%
    \FormulaRefAuto{a=b\dsep a=c\vdash b=c}[thm]{8,6}}
  \proofstepwidestar[1,8]{k=0}{\FormulaRefAuto{NaturalIntegerEmbeddingReflectsEquality}[thm]{1,3,9}}
  \proofstepwidestar[1,2,8]{\bot}{\rBI{2,10}}
  \proofstepwidestar[1,2]{\IntZero\neq\IntEmbed(k)}{\rCI{8,11}}
  \proofstepwidestar[1]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}[thm]}
  \proofstepwidestar[1]{\IntEmbed(k)\in\mathbb Z}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      13,1}}
  \proofstepwidestar[1,2]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}
  \proofstepwidestar[1,2]{\IntZero<\IntEmbed(k)}{%
    \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
      15,14,\rAI{7,12}}}
\end{tabproofwide}
...
\FormulaThmDeltaK[Produkt von null verschiedener natürlicher Zahlen]{%
  ...
  \vdash m\cdot n\neq0%
}{NaturalNonzeroProductForIntegerModel}{\DeltaRow{Mengen}{m\dsep n}}
\begin{tabproof}
  \proofstep{1}{m,n\in\mathbb N}{\rA}
  \proofstep{2}{m\neq0}{\rA}
  \proofstep{3}{n\neq0}{\rA}
  \proofstep{1,2,3}{m\cdot n\neq0}{%
    \FormulaRefAuto{PeanoMulNonzero}[thm]{\rAEa{1},\rAEb{1},2,3}}
\end{tabproof}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[6,7]{m \cdot n \in \mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{\rAEa{6},\rAEa{7}}}
  \proofstepwidestarbreakkeep[6,7]{\IntZero<\IntEmbed(m\cdot n)}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingPositiveModel}[thm]{%
      9,8}}
  \proofstepwidestar[6,7]{\IntEmbed(m)\cdot\IntEmbed(n)=\IntEmbed(m\cdot n)}{%
  ...
  \proofstepwidestarbreakkeep[6,7]{z\cdot w=\IntEmbed(m\cdot n)}{%
    \rIE{\rAEb{\rAEb{6}},\rAEb{\rAEb{7}},%
      11}}
  \proofstepwidestarbreakkeep[6,7]{\IntZero<z\cdot w}{\rIE{12,10}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}
  \proofstep{1,2,3}{z\cdot w\in\mathbb Z}{%
      \FormulaRefAuto{IntegerMulClosureAxiom}[ax]{1}}
  \proofstep{1,2,3}{\IntZero\leq z\cdot w\land\IntZero\neq z\cdot w}{%
      \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
      5,%
      6,4}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[5]{h\in\mathbb N\land a+(h+1)=c}{\rA}
  \proofstepwidestar[1,2,5]{h+1\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{5}}}
  \proofstepwidestar[1,2,5]{h+1\neq0}{%
      \FormulaRefAuto{PeanoAddOneNonzero}[thm]{\rAEa{5}}}
  \proofstepwidestarbreakkeep[1,2,5]{(h+1)\cdot k\neq0}{%
    \FormulaRefAuto{NaturalNonzeroProductForIntegerModel}[thm]{%
      6,%
      \rAEb{\rAEb{1}},%
      7,2}}
  \proofstepwidestar[1,2,5]{h+1\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{5}}}
  \proofstepwidestar[1,2,5]{{ ( h + 1 ) } \cdot k \in \mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{%
        9,%
        \rAEb{\rAEb{1}}}}
  \proofstepwidestarbreakkeep[1,2,5]{\exists t\in\mathbb N\,
    ((h+1)\cdot k=t+1)}{%
    \FormulaRefAuto{PeanoNonzeroIsAddOne}[thm]{%
      10,8}}
  \proofstepwidestarbreakkeep[12]{t\in\mathbb N\land
    (h+1)\cdot k=t+1}{\rA}
  \proofstepwidestar[1,5]{h+1\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{5}}}
  \proofstepwidestarbreakkeep[1,5]{(a+(h+1))\cdot k
    =a\cdot k+(h+1)\cdot k}{%
    \FormulaRefAuto{PeanoMulRightDistributive}[thm]{%
      \rAEa{1},13,%
      \rAEb{\rAEb{1}}}}
  \proofstepwidestarbreakkeep[1,5,12]{a\cdot k+(t+1)=c\cdot k}{%
    \rIE{\rAEb{5},\rAEb{12},14}}
  ...
  \proofstepwidestarbreakkeep[1,5,12]{%
    \exists t\in\mathbb N\,(a\cdot k+(t+1)=c\cdot k)}{%
    \rEI{\rAI{\rAEa{12},15}}}
  \proofstepwidestarbreakkeep[1,5,12]{a\cdot k<c\cdot k}{%
    \FormulaRefAuto{PeanoStrictAddOneDistance}[thm]{%
      16,17,18}}
  \proofstepwidestarbreakkeep[1,2,3]{a\cdot k<c\cdot k}{%
    \rEE{4,5,\rEE{11,12,19}}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Erhaltung]{%
    ...
    \proofstepwidestar[1,4]{(a+h)\cdot k=a\cdot k+h\cdot k}{%
      \FormulaRefAuto{PeanoMulRightDistributive}[thm]{%
    ...
    \proofstepwidestarbreakkeep[1,4]{a\cdot k\leq c\cdot k}{%
      \FormulaRefAuto{NaturalOrderAdditiveCharacterization}[thm]{%
        7,8,10}}
    \proofstepwidestarbreakkeep[1,2]{a\cdot k\leq c\cdot k}{\rEE{3,4,11}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Reflexion]{%
    ...
    \proofstepwidestar[1,7]{a\leq a}{%
      \FormulaRefAuto{PeanoLeqReflexive}[thm]{\rAEa{1}}}
    \proofstepwidestarbreakkeep[1,7]{a\leq c}{%
      \rIE{7,8}}
    \proofstepwidestarbreakkeep[10]{c<a}{\rA}
    \proofstepwidestarbreakkeep[1,2,10]{c\cdot k<a\cdot k}{%
      \FormulaRefAuto{NaturalPositiveFactorStrictOrderForIntegerModel}[thm]{%
        \rAEa{\rAEb{1}},\rAEa{1},\rAEb{\rAEb{1}},2,10}}
    \proofstepwidestar[1,2,10]{a\cdot k\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{%
          \rAEa{1},\rAEb{\rAEb{1}}}}
    \proofstepwidestar[1,2,10]{c\cdot k\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{%
          \rAEa{\rAEb{1}},\rAEb{\rAEb{1}}}}
    \proofstepwidestarbreakkeep[1,2,10]{%
      ...
      \FormulaRefAuto{NaturalStrictOrderNotation}[def]{%
        13,%
        12,11}}
    \proofstepwidestarbreakkeep[1,2,10]{c\cdot k\leq a\cdot k}{\rAEa{14}}
    \proofstepwidestarbreakkeep[1,2,10]{c\cdot k\neq a\cdot k}{\rAEb{14}}
    \proofstepwidestarbreakkeep[1]{a\cdot k\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{%
        \rAEa{1},\rAEb{\rAEb{1}}}}
    \proofstepwidestarbreakkeep[1]{c\cdot k\in\mathbb N}{%
      \FormulaRefAuto{PeanoMulClosure}[thm]{%
        \rAEa{\rAEb{1}},\rAEb{\rAEb{1}}}}
    \proofstepwidestarbreakkeep[1,2,3,10]{a\cdot k=c\cdot k}{%
      \FormulaRefAuto{PeanoLeqAntisymmetric}[thm]{%
        17,18,3,15}}
    \proofstepwidestarbreakkeep[1,2,3,10]{c\cdot k=a\cdot k}{%
      \FormulaRefAuto{a=b\vdash b=a}{19}}
    \proofstepwidestarbreakkeep[1,2,3,10]{\bot}{\rBI{16,20}}
    \proofstepwidestarbreakkeep[1,2,3,10]{a\leq c}{%
      \FormulaRefAuto{\bot\vdash P}{21}}
    \proofstepwidestarbreakkeep[1,2,3]{a\leq c}{%
      \rOE{4,5,6,7,9,10,22}}
  \closeproofpartwideindR

  \proofpartwide{Schluss}
    \proofstepwidestar[1]{a,c,k\in\mathbb N}{\rA}
    \proofstepwidestar[2]{k\neq0}{\rA}
    \proofstepwidestar[3]{a\leq c}{\rA}
    \proofstepwidestar[1,3]{a\cdot k\leq c\cdot k}{
      \FormulaRefAuto{NaturalPositiveFactorOrderForwardForIntegerModel}{1,3}}
    \proofstepwidestar[1]{a\leq c\to a\cdot k\leq c\cdot k}{\rRI{3,4}}
    \proofstepwidestar[6]{a\cdot k\leq c\cdot k}{\rA}
    \proofstepwidestar[1,2,6]{a\leq c}{
      \FormulaRefAuto{NaturalPositiveFactorOrderBackwardForIntegerModel}{1,2,6}}
    \proofstepwidestar[1,2]{a\cdot k\leq c\cdot k\to a\leq c}{\rRI{6,7}}
    \proofstepwidestar[1,2]{a\leq c\leftrightarrow a\cdot k\leq c\cdot k}{\rLRI{5,8}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechnung auf positiven Repräsentanten]{%
    ...
    \proofstepwidestar[1,2]{x+v\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}[thm]{1}}
    \proofstepwidestar[1,2]{u+y\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}[thm]{1}}
    ...
    \proofstepwidestarbreakkeep[1,3,4,5]{a\cdot d\leq c\cdot d
      ...
      \FormulaRefAuto{IntegerOrderClassChar}[thm]{1,19,26}}
    \proofstepwidestarbreakkeep[1,2,3,4,5]{a\leq c\leftrightarrow
      a\cdot d\leq c\cdot d}{\rIE{6,9,10,11,27}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[2]{\IntZero<d}{\rA}
  \proofstepwidestarbreakkeep[3]{a<c}{\rA}
  \proofstepwidestar[1,3]{a\leq c\land a\neq c}{%
      \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
      \rAEa{1},\rAEa{\rAEb{1}},3}}
  \proofstepwidestarbreakkeep[1,3]{a\leq c}{%
    \rAEa{4}}
  \proofstepwidestar[1,2,3]{a\leq c\leftrightarrow a\cdot d\leq c\cdot d}{%
      \FormulaRefAuto{IntegerPositiveFactorOrderAxiom}[ax]{1,2}}
  \proofstepwidestarbreakkeep[1,2,3]{a\cdot d\leq c\cdot d}{%
    \rRE{6,5}}
  \proofstepwidestarbreakkeep[8]{a\cdot d=c\cdot d}{\rA}
  \proofstepwidestarbreakkeep[1,2,8]{a=c}{%
    \FormulaRefAuto{IntegerPositiveFactorCancellationFromAxioms}[thm]{%
      1,2,8}}
  \proofstepwidestar[1,3,8]{a\leq c\land a\neq c}{%
      \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
      \rAEa{1},\rAEa{\rAEb{1}},3}}
  \proofstepwidestarbreakkeep[1,3,8]{\bot}{%
    \rBI{\rAEb{10},9}}
  \proofstepwidestarbreakkeep[1,2,3]{a\cdot d\neq c\cdot d}{\rCI{8,11}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{b\in\mathbb Z\land\IntZero<b}{\FormulaRefAuto{PositiveIntegersDef}[def]{1}}
  \proofstepwidestar[1]{\exists k\in\mathbb N\,(k\neq0\land b=\IntEmbed(k))}{%
    \FormulaRefAuto{IntegerPositiveEmbeddingRepresentativeModel}[thm]{\rAEa{2},\rAEb{2}}}
  \proofstepwidestar[4]{k\in\mathbb N\land k\neq0\land b=\IntEmbed(k)}{\rA}
  \proofstepwidestar[4]{\exists h\in\mathbb N\,(k=h+1)}{%
    \FormulaRefAuto{PeanoNonzeroIsAddOne}[thm]{\rAEa{4},\rAEa{\rAEb{4}}}}
  \proofstepwidestar[6]{h\in\mathbb N\land k=h+1}{\rA}
  \proofstepwidestar[]{1\in\mathbb N}{\FormulaRefAuto{PeanoOneInN}[thm]}
  \proofstepwidestar[6]{1+h=h+1}{\FormulaRefAuto{PeanoAddCommutative}[thm]{7,\rAEa{6}}}
  \proofstepwidestar[6]{1+h=k}{\rIE{\rAEb{6},8}}
  \proofstepwidestar[6]{\exists h\in\mathbb N\,(1+h=k)}{\rEI{\rAI{\rAEa{6},9}}}
  \proofstepwidestar[4,6]{1\leq k}{\FormulaRefAuto{NaturalOrderAdditiveCharacterization}[thm]{7,\rAEa{4},10}}
  \proofstepwidestar[4,6]{\IntEmbed(1)\leq\IntEmbed(k)}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingOrderPreserving}[thm]{7,\rAEa{4},11}}
  \proofstepwidestar[]{\IntOne=\IntEmbed(1)}{\FormulaRefAuto{IntegerOneDef}[def]}
  \proofstepwidestar[4,6]{\IntOne\leq b}{\rIE{13,\rAEb{\rAEb{4}},12}}
  \proofstepwidestar[4]{\IntOne\leq b}{\rEE{5,6,14}}
  \proofstepwidestar[1]{\IntOne\leq b}{\rEE{3,4,15}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{\IntOne\in\mathbb Z}{%
    \FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}
  \proofstepwidestar[1,2,3]{\IntOne\leq b\leftrightarrow\IntOne\cdot\IntEmbed(n)\leq b\cdot\IntEmbed(n)}{%
      \FormulaRefAuto{IntegerPositiveFactorOrderAxiom}[ax]{%
      9,\rAEa{8},5,6}}
  \proofstepwidestar[1,2,3]{%
    \IntOne\cdot\IntEmbed(n)\leq b\cdot\IntEmbed(n)}{%
    \rRE{10,7}}
  \proofstepwidestar[1]{{ \IntEmbed ( n ) } \cdot \IntOne = { \IntEmbed ( n ) } \land \IntOne \cdot { \IntEmbed ( n ) } = { \IntEmbed ( n ) }}{%
      \FormulaRefAuto{IntegerMulOneAxiom}[ax]{5}}
  \proofstepwidestar[1]{\IntOne\cdot\IntEmbed(n)=\IntEmbed(n)}{%
    \rAEb{12}}
  \proofstepwidestar[1,3]{b\cdot\IntEmbed(n)
    =\IntEmbed(n)\cdot b}{%
    \FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{\rAEa{8},5}}
  \proofstepwidestar[1,2,3]{\IntEmbed(n)\leq\IntEmbed(n)\cdot b}{%
    \rIE{13,11,14}}
\end{tabproofwide}


\section{Schritte um eins und Diskretheit der Ganzzahlordnung}

\FormulaThmDeltaK[Jede ganze Zahl ist kleiner als die um eins erhöhte Zahl]{%
  z\in\mathbb Z\vdash z<z+\IntOne%
}{IntegerSuccessorPositive}{\DeltaRow{Mengen}{z\dsep a\dsep b}}
\begin{tabproofsplitwide}
  \proofpartwideindR[Ordnungsteil]{%
    z\in\mathbb Z\vdash z\leq z+\IntOne
  }{%
    z\in\mathbb Z\vdash z\leq z+\IntOne
  }[IntegerSuccessorLeq]
    \proofstepwidestarbreakkeep[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestarbreakkeep[1]{\exists a,b\in\mathbb N\,z=\IntClass{a}{b}}{\FormulaRefAuto{IntegerPairRepresentative}[thm]{1}}
    \proofstepwidestarbreakkeep[3]{a,b\in\mathbb N\land z=\IntClass{a}{b}}{\rA}
    \proofstepwidestarbreakkeep[3]{a+1\in\mathbb N}{\FormulaRefAuto{PeanoAddOneClosure}[thm]{3}}
    \proofstepwidestar[3]{\IntClass{a}{b}+\IntOne=\IntClass{a+1}{b}}{%
      \FormulaRefAuto{IntegerSuccessorClassValue}[thm]{3}}
    \proofstepwidestarbreakkeep[3]{z+\IntOne=\IntClass{a+1}{b}}{%
      \rIE{3,5}}
    \proofstepwidestarbreakkeep[3]{a\leq a+1}{\FormulaRefAuto{PeanoLeqAddOne}[thm]{3}}
    \proofstepwidestarbreakkeep[3]{a+b\leq(a+1)+b}{\FormulaRefAuto{NaturalOrderTranslationForward}[thm]{3,4,7}}
    \proofstepwidestarbreakkeep[3]{\IntClass{a}{b}\leq\IntClass{a+1}{b}}{\FormulaRefAuto{IntegerOrderClassChar}[thm]{3,4,8}}
    \proofstepwidestarbreakkeep[3]{z\leq z+\IntOne}{\rIE{3,6,9}}
    \proofstepwidestarbreakkeep[1]{z\leq z+\IntOne}{\rEE{2,3,10}}
  \closeproofpartwideindR
  \proofpartwideindR[Ungleichheitsteil]{%
    ...
    \proofstepwidestarbreakkeep[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestarbreakkeep[2]{z=z+\IntOne}{\rA}
    \proofstepwidestarbreakkeep[1]{\exists a,b\in\mathbb N\,z=\IntClass{a}{b}}{\FormulaRefAuto{IntegerPairRepresentative}[thm]{1}}
    \proofstepwidestarbreakkeep[4]{a,b\in\mathbb N\land z=\IntClass{a}{b}}{\rA}
    \proofstepwidestarbreakkeep[4]{a+1\in\mathbb N}{\FormulaRefAuto{PeanoAddOneClosure}[thm]{4}}
    \proofstepwidestar[4]{\IntClass{a}{b}+\IntOne=\IntClass{a+1}{b}}{%
      \FormulaRefAuto{IntegerSuccessorClassValue}[thm]{4}}
    \proofstepwidestarbreakkeep[4]{z+\IntOne=\IntClass{a+1}{b}}{%
      \rIE{4,6}}
    \proofstepwidestarbreakkeep[2,4]{\IntClass{a}{b}=\IntClass{a+1}{b}}{\rIE{4,7,2}}
    \proofstepwidestarbreakkeep[2,4]{a+b=b+(a+1)}{\FormulaRefAuto{IntegerClassEquality}[thm]{4,5,8}}
    \proofstepwidestarbreakkeep[4]{b+(a+1)=(a+1)+b}{\FormulaRefAuto{PeanoAddCommutative}[thm]{4,5}}
    \proofstepwidestarbreakkeep[2,4]{a+b=(a+1)+b}{\rIE{9,10}}
    \proofstepwidestarbreakkeep[2,4]{a=a+1}{\FormulaRefAuto{PeanoAddRightCancellation}[thm]{4,5,11}}
    \proofstepwidestarbreakkeep[4]{a<a+1}{\FormulaRefAuto{PeanoLtAddOne}[thm]{4}}
    \proofstepwidestarbreakkeep[2,4]{\bot}{\FormulaRefAuto{PeanoStrictEqualityImpossible}[thm]{4,5,13,12}}
    \proofstepwidestarbreakkeep[1,2]{\bot}{\rEE{3,4,14}}
    \proofstepwidestarbreakkeep[1]{z\neq z+\IntOne}{\rCI{2,15}}
  \closeproofpartwideindR
  \proofpartwide{Schluss}
    \proofstepwidestarbreakkeep[1]{z\in\mathbb Z}{\rA}
    \proofstepwidestarbreakkeep[1]{z\leq z+\IntOne}{\FormulaRefAuto{IntegerSuccessorLeq}[thm]{1}}
    \proofstepwidestarbreakkeep[1]{z\neq z+\IntOne}{\FormulaRefAuto{IntegerSuccessorDistinct}[thm]{1}}
    \proofstepwidestarbreakkeep[1]{z+\IntOne\in\mathbb Z}{\FormulaRefAuto{IntegerAddOneClosure}[thm]{1}}
    \proofstepwidestarbreakkeep[1]{z<z+\IntOne}{\FormulaRefAuto{IntegerStrictOrderDef}[def]{1,4,\rAI{2,3}}}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaAxiomAutoR[Diskrete Orientierung des Schritts um eins]{%
  z\in\mathbb Z\vdash z<z+\IntOne%
...
\FormulaThmDeltaK[Die um eins erhöhte Normalformhöhe ist eine strikte Schranke]{%
  a\in\mathbb Z\dsep m\in\mathbb N\dsep
  \bigl(a=\IntEmbed(m)\lor a=-\IntEmbed(m)\bigr)
  \vdash a<\IntEmbed(m+1)%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}[thm]}
  \proofstepwidestar[2]{\IntEmbed(m)\in\mathbb Z}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      4,2}}
  \proofstepwidestar[2]{\IntEmbed(m)<\IntEmbed(m)+\IntOne}{%
    \FormulaRefAuto{IntegerSuccessorPositiveAxiom}[ax]{5}}
  \proofstepwidestar[2]{\IntEmbed(m)+\IntOne
    =\IntEmbed(m+1)}{%
    \FormulaRefAuto{IntegerSuccessorOnEmbedding}[thm]{2}}
  \proofstepwidestar[2]{\IntEmbed(m)<\IntEmbed(m+1)}{\rIE{6,7}}
  \proofstepwidestar[9]{a=\IntEmbed(m)}{\rA}
  \proofstepwidestar[2,9]{a<\IntEmbed(m+1)}{\rIE{9,8}}
  \proofstepwidestar[11]{a=-\IntEmbed(m)}{\rA}
  ...
  \proofstepwidestar[2]{\IntEmbed(0)\leq\IntEmbed(m)}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingOrderPreserving}[thm]{%
      13,2,12}}
  \proofstepwidestar[]{\IntZero=\IntEmbed(0)}{%
    \FormulaRefAuto{IntegerZeroDef}[def]}
  \proofstepwidestar[2]{\IntZero\leq\IntEmbed(m)}{\rIE{15,14}}
  \proofstepwidestar[2]{-\IntEmbed(m)\in\mathbb Z}{%
    \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{5}}
  \proofstepwidestar[2]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}
  \proofstepwidestar[2]{%
    \IntZero+(-\IntEmbed(m))
    ...
    \FormulaRefAuto{IntegerOrderTranslationAxiom}[ax]{%
      18,5,17,16}}
  \proofstepwidestar[2]{{ ( - \IntEmbed ( m ) ) } + \IntZero = { ( - \IntEmbed ( m ) ) } \land \IntZero + { ( - \IntEmbed ( m ) ) } = { ( - \IntEmbed ( m ) ) }}{%
      \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{17}}
  \proofstepwidestar[2]{\IntZero+(-\IntEmbed(m))=-\IntEmbed(m)}{%
    \rAEb{20}}
  \proofstepwidestar[2]{{ \IntEmbed ( m ) } + ( - { \IntEmbed ( m ) } ) = \IntZero \land ( - { \IntEmbed ( m ) } ) + { \IntEmbed ( m ) } = \IntZero}{%
      \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{5}}
  \proofstepwidestar[2]{\IntEmbed(m)+(-\IntEmbed(m))=\IntZero}{%
    \rAEa{22}}
  \proofstepwidestar[2]{-\IntEmbed(m)\leq\IntZero}{\rIE{19,21,23}}
  \proofstepwidestar[2]{m+1\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddOneClosure}[thm]{2}}
  \proofstepwidestar[2]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}[thm]}
  \proofstepwidestar[2]{\IntEmbed(m+1)\in\mathbb Z}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      26,25}}
  \proofstepwidestar[2]{m+1\neq0}{%
    \FormulaRefAuto{PeanoAddOneNonzero}[thm]{2}}
  \proofstepwidestar[2]{\IntZero<\IntEmbed(m+1)}{%
    \FormulaRefAuto{NaturalIntegerEmbeddingPositiveModel}[thm]{25,28}}
  \proofstepwidestar[2]{\IntZero \in \mathbb Z}{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}
  \proofstepwidestar[2]{-\IntEmbed(m)<\IntEmbed(m+1)}{%
    \FormulaRefAuto{IntegerLeqStrictTransitiveFromAxioms}[thm]{%
      17,30,27,24,29}}
  \proofstepwidestar[2,11]{a<\IntEmbed(m+1)}{\rIE{11,31}}
  \proofstepwidestar[1,2,3]{a<\IntEmbed(m+1)}{%
    \rOE{3,9,10,11,32}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[4]{m+1\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{4}}}
  \proofstepwidestar[1,4]{a<\IntEmbed(m+1)}{%
    \FormulaRefAuto{IntegerNormalFormSuccessorBound}[thm]{1,4}}
  \proofstepwidestar[4]{m+1\neq0}{%
    \FormulaRefAuto{PeanoAddOneNonzero}[thm]{\rAEa{4}}}
  \proofstepwidestar[2,4]{\IntEmbed(m+1)
    \leq\IntEmbed(m+1)\cdot b}{%
    \FormulaRefAuto{PositiveIntegerEmbeddingFactorLowerBound}[thm]{5,7,2}}
  \proofstepwidestar[4]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}[thm]}
  \proofstepwidestar[4]{\IntEmbed(m+1)\in\mathbb Z}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{%
      9,5}}
  \proofstepwidestar[2]{b\in\mathbb Z\land\IntZero<b}{%
    \FormulaRefAuto{PositiveIntegersDef}[def]{2}}
  \proofstepwidestar[2,4]{\IntEmbed(m+1)\cdot b\in\mathbb Z}{%
    \FormulaRefAuto{IntegerMulClosureAxiom}[ax]{10,\rAEa{11}}}
  \proofstepwidestar[1,2,4]{a<\IntEmbed(m+1)\cdot b}{%
    \FormulaRefAuto{IntegerStrictLeqTransitiveFromAxioms}[thm]{%
      1,10,12,6,8}}
  \proofstepwidestar[1,2,4]{\exists n\in\mathbb N\,
    a<\IntEmbed(n)\cdot b}{\rEI{\rAI{5,13}}}
  \proofstepwidestar[1,2]{\exists n\in\mathbb N\,
    a<\IntEmbed(n)\cdot b}{\rEE{3,4,14}}
\end{tabproofwide}
...
\FormulaThmDeltaK[Zweiseitige Induktion im Quotientenmodell]{%
  \begin{aligned}[t]
    &P(\IntZero)\dsep
    \forall z\in\mathbb Z\,
      (P(z)\rightarrow P(z+\IntOne))\dsep{}\\
    &\forall z\in\mathbb Z\,
      (P(z)\rightarrow P(z-\IntOne))
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktion auf dem nichtnegativen Strahl]{%
    \begin{aligned}[t]
      &P(\IntZero)\dsep
      \forall z\in\mathbb Z\,
      (P(z)\rightarrow P(z+\IntOne))\vdash{}\\
    ...
    \proofstepwidestar[5]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}}
    ...
    \proofstepwidestarbreakkeep[2,5]{%
      ...
      P(\IntEmbed(n)+\IntOne)}{\rRE{\rUE{2},8}}
    \proofstepwidestarbreakkeep[2,5,6]{P(\IntEmbed(n)+\IntOne)}{\rRE{9,6}}
    \proofstepwidestarbreakkeep[5]{%
      \IntEmbed(n)+\IntOne=\IntEmbed(n+1)}{%
      \FormulaRefAuto{IntegerSuccessorOnEmbedding}[thm]{5}}
    \proofstepwidestarbreakkeep[2,5,6]{P(\IntEmbed(n+1))}{\rIE{11,10}}
    \proofstepwidestarbreakkeep[2,5]{%
      P(\IntEmbed(n))\rightarrow P(\IntEmbed(n+1))}{\rRI{6,12}}
    \proofstepwidestarbreakkeep[2]{\forall n\in\mathbb N\,
      (P(\IntEmbed(n))\rightarrow P(\IntEmbed(n+1)))}{%
      \rUI{\rRI{5,13}}}
    \proofstepwidestarbreakkeep[1,2]{\forall n\in\mathbb N\,
      P(\IntEmbed(n))}{%
      \FormulaRefAuto{PeanoInductionAddOne}[thm]{4,14}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Induktion auf dem nichtpositiven Strahl]{%
    ...
    \proofstepwidestarbreakkeep[2]{\forall z\in\mathbb Z\,
      (P(z)\rightarrow P(z-\IntOne))}{\rA}
    \proofstepwidestar[]{\IntZero=\IntOfNat(0)}{%
      \FormulaRefAuto{IntegerZeroDef}}
    \proofstepwidestarbreakkeep[]{\IntEmbed(0)=\IntZero}{%
      \FormulaRefAuto{a=b\vdash b=a}{3}}
    \proofstepwidestarbreakkeep[]{-\IntZero=\IntZero}{%
      \FormulaRefAuto{IntegerNegativeZero}[thm]}
    \proofstepwidestarbreakkeep[1]{P(-\IntEmbed(0))}{\rIE{4,5,1}}

    \proofstepwidestarbreakkeep[7]{n\in\mathbb N}{\rA}
    \proofstepwidestarbreakkeep[8]{P(-\IntEmbed(n))}{\rA}
    \proofstepwidestar[7]{\IntEmbed \colon \mathbb N \to \mathbb Z}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}}
    \proofstepwidestar[7]{\IntEmbed ( n ) \in \mathbb Z}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{%
          9,7}}
    \proofstepwidestarbreakkeep[7]{-\IntEmbed(n)\in\mathbb Z}{%
      \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{%
        10}}
    \proofstepwidestarbreakkeep[2,7]{%
      P(-\IntEmbed(n))\rightarrow
      P(-\IntEmbed(n)-\IntOne)}{\rRE{\rUE{2},11}}
    \proofstepwidestarbreakkeep[2,7,8]{P(-\IntEmbed(n)-\IntOne)}{\rRE{12,8}}
    \proofstepwidestarbreakkeep[7]{%
      -\IntEmbed(n)-\IntOne=-\IntEmbed(n+1)}{%
      \FormulaRefAuto{IntegerPredecessorOnNegativeEmbedding}[thm]{7}}
    \proofstepwidestarbreakkeep[2,7,8]{P(-\IntEmbed(n+1))}{\rIE{14,13}}
    \proofstepwidestarbreakkeep[2,7]{%
      P(-\IntEmbed(n))\rightarrow P(-\IntEmbed(n+1))}{\rRI{8,15}}
    \proofstepwidestarbreakkeep[2]{\forall n\in\mathbb N\,
      (P(-\IntEmbed(n))\rightarrow P(-\IntEmbed(n+1)))}{%
      \rUI{\rRI{7,16}}}
    \proofstepwidestarbreakkeep[1,2]{\forall n\in\mathbb N\,
      P(-\IntEmbed(n))}{%
      \FormulaRefAuto{PeanoInductionAddOne}[thm]{6,17}}
  \closeproofpartwideindR
...
\FormulaThmDeltaK[Das Quotientenmodell erfüllt die Ganzzahlaxiome]{%
  ...
  \DeltaRow{Funktionen}{(x\mapsto x+\IntOne)\dsep(x\mapsto x-\IntOne)}%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Träger und Abbildungen]{%
    \begin{aligned}[t]
      ...
      &(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z\ \land{}\\
      &(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z
    \end{aligned}
  }{%
    \IntZero\in\mathbb Z\land
    ...
    \proofstepwidestarbreakkeep[]{\begin{aligned}[t]
      ...
      &(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z\ \land{}\\
      &(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z
    \end{aligned}}{\rAI{1,\rAI{2,3}}}
  \closeproofpartwideindR

  \proofpartwideindR[Gegenseitige Inversen]{%
    \begin{aligned}[t]
      &\forall z\in\mathbb Z\,
        (z+\IntOne)-\IntOne=z\ \land{}\\
      &\forall z\in\mathbb Z\,
        (z-\IntOne)+\IntOne=z
    \end{aligned}
  }{%
    \forall z\in\mathbb Z\,(z+\IntOne)-\IntOne=z
    \land
    \forall z\in\mathbb Z\,(z-\IntOne)+\IntOne=z
    ...
    \proofstepwidestarbreakkeep[]{\begin{aligned}[t]
      &\forall z\in\mathbb Z\,((z+\IntOne)-\IntOne=z)\ \land{}\\
      &\forall z\in\mathbb Z\,((z-\IntOne)+\IntOne=z)
    \end{aligned}}{\rAI{1,2}}
  \closeproofpartwideindR

  \proofpartwideindR[Geordnete Schritte um eins]{%
    \TotOrd{\mathbb Z,\leq_{\mathbb Z}}
    \land\forall z\in\mathbb Z\,(z<z+\IntOne)%
  }{%
    \TotOrd{\mathbb Z,\leq_{\mathbb Z}}
    \land\forall z\in\mathbb Z\,(z<z+\IntOne)%
    ...
    \proofstepwidestar[]{\forall z\in\mathbb Z\,
      (z<z+\IntOne)}{\FormulaRefAuto{IntegerSuccessorPositive}}
    \proofstepwidestar[]{\TotOrd{\mathbb Z,\leq_{\mathbb Z}}
      \land\forall z\in\mathbb Z\,(z<z+\IntOne)}{\rAI{1,2}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Induktionsschema]{%
    ...
    P(\IntZero)\dsep
    \forall z\in\mathbb Z\,(P(z)\to P(z+\IntOne))\dsep
  ...
  \proofpartwide{Schluss}
    \proofstepwidestar[]{\mathbb Z=\QuotientSet{D_{\mathbb Z}}{\IntPairRel}}{
      \FormulaRefAuto{IntegersAsQuotient}}
    \proofstepwidestar[]{\IntegerArithmetic{
      \mathbb Z,\IntZero,\IntOne,-,+,\cdot,\leq_{\mathbb Z}}}{
    ...
    \proofstepwidestar[]{\begin{aligned}[t]
      ...
      &(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z\land{}\\
      &(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z
      \end{aligned}}{\FormulaRefAuto{IntegerPeanoModelCarrierMaps}}
    \proofstepwidestar[]{\IntZero\in\mathbb Z}{\rAEa{3}}
    \proofstepwidestar[]{(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z}{\rAEa{\rAEb{3}}}
    \proofstepwidestar[]{(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z}{\rAEb{\rAEb{3}}}
    \proofstepwidestar[]{\begin{aligned}[t]
      &\forall z\in\mathbb Z\,((z+\IntOne)-\IntOne=z)\land{}\\
      &\forall z\in\mathbb Z\,((z-\IntOne)+\IntOne=z)
      \end{aligned}}{\FormulaRefAuto{IntegerPeanoModelInverses}}
    \proofstepwidestar[8]{z\in\mathbb Z}{\rA}
    \proofstepwidestar[8]{(z+\IntOne)-\IntOne=z}{\rRE{8,\rUE{\rAEa{7}}}}
    \proofstepwidestar[8]{(z-\IntOne)+\IntOne=z}{\rRE{8,\rUE{\rAEb{7}}}}
    \proofstepwidestar[]{\begin{aligned}[t]
      &\TotOrd{\mathbb Z,\leq_{\mathbb Z}}\land{}\\
      &\forall z\in\mathbb Z\,(z<z+\IntOne)
      \end{aligned}}{\FormulaRefAuto{IntegerPeanoModelOrder}}
    \proofstepwidestar[]{\TotOrd{\mathbb Z,\leq_{\mathbb Z}}}{\rAEa{11}}
    \proofstepwidestar[8]{z<z+\IntOne}{\rRE{8,\rUE{\rAEb{11}}}}
    \proofstepwidestar[14]{P(\IntZero)}{\rA}
    \proofstepwidestar[15]{\forall z\in\mathbb Z\,(P(z)\to P(z+\IntOne))}{\rA}
    \proofstepwidestar[16]{\forall z\in\mathbb Z\,(P(z)\to P(z-\IntOne))}{\rA}
    \proofstepwidestar[14,15,16]{\forall z\in\mathbb Z\,P(z)}{
      \FormulaRefAuto{IntegerPeanoModelInduction}[thm]{14,15,16}}
    \proofstepwidestar[]{\IntegerPeano{
      \mathbb Z,\IntZero,\IntOne,-,+,\cdot,\leq_{\mathbb Z}}}{
      \FormulaRefAuto{IntegerPeanoAxioms}{2,4,5,6,9,10,13,17}}
    \proofstepwidestar[]{\begin{aligned}[t]
      &\mathbb Z=\QuotientSet{D_{\mathbb Z}}{\IntPairRel}\land{}\\
      &\IntegerPeano{\mathbb Z,\IntZero,\IntOne,-,+,\cdot,\leq_{\mathbb Z}}
      \end{aligned}}{\rAI{1,18}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
Struktur mit den unten aufgeführten Konstanten, Operationen und der
Ordnung. Ihre Eigenschaften werden ausschließlich durch die
...
Die Schritte sind die arithmetischen Terme \(z+\IntOne\) und
\(z-\IntOne\), wobei \(z-w=z+(-w)\) weiterhin die Subtraktionsnotation
bezeichnet. Die Abbildungsschreibweisen \((x\mapsto x+\IntOne)\) und
\((x\mapsto x-\IntOne)\) stehen für die dadurch eindeutig bestimmten
Funktionen; sie sind keine zusätzlichen Grundoperationen. Zusammen mit der
geordneten Ringstruktur und der zweiseitigen Induktion bildet dies die
vollständige Schnittstelle für alle späteren Verwendungen der ganzen Zahlen.
...
\FormulaAxiomAutoR[Abbildung zum Addieren der Eins]{%
  (x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z%
}{IntegerPeanoSuccFunction}
\par\noindent\emph{Modellnachweis vor dem Abstraktionsschnitt:}
\FormulaRefAuto{IntegerSuccessorFunction}[thm].\par

\FormulaAxiomAutoR[Abbildung zum Subtrahieren der Eins]{%
  (x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z%
}{IntegerPeanoPredFunction}
\par\noindent\emph{Modellnachweis vor dem Abstraktionsschnitt:}
\FormulaRefAuto{IntegerPredecessorFunction}[thm].\par

\FormulaAxiomAutoR[Subtrahieren nach Addieren der Eins]{%
  z\in\mathbb Z\vdash(z+\IntOne)-\IntOne=z%
}{IntegerPeanoPredSucc}
\par\noindent\emph{Modellnachweis vor dem Abstraktionsschnitt:}
\FormulaRefAuto{IntegerPredAfterSucc}[thm].\par

\FormulaAxiomAutoR[Addieren nach Subtrahieren der Eins]{%
  z\in\mathbb Z\vdash(z-\IntOne)+\IntOne=z%
...
\FormulaAxiomAutoR[Strikte Orientierung des Schritts um eins]{%
  z\in\mathbb Z\vdash z<z+\IntOne%
...
Ringarithmetik mit den Schritten um eins. Anders als auf \(\mathbb N\) ist
die Abbildung \(x\mapsto x+\IntOne\) auf \(\mathbb Z\) bijektiv. Die totale Ordnung und die strikte
...
\(\IntZero\) durch Addieren und Subtrahieren von eins erzeugte Kette.
...
\FormulaDefDeltaK[Erweiterte Peano-Axiome der ganzen Zahlen]{%
  ...
  \DeltaRow{Addieren von eins}{(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z}
    [\FormulaRefAuto{IntegerPeanoSuccFunction}]%
  \DeltaRow{Subtrahieren von eins}{(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z}
  ...
  \DeltaRow{Induktion}{%
    \begin{aligned}[t]
      &P(\IntZero)\dsep{}\\[-2pt]
      &\forall z\in\mathbb Z\,(P(z)\to P(z+\IntOne))\dsep{}\\[-2pt]
      &\forall z\in\mathbb Z\,(P(z)\to P(z-\IntOne))\dsep{}\\[-2pt]
      &\vdash\forall z\in\mathbb Z\,P(z)
    \end{aligned}}
  ...
  \DeltaRow{Konstanten}{\IntZero\dsep\IntOne}%
  \DeltaRow{Operationen}{-\dsep+\dsep\cdot}%
  \DeltaRow{\makecell[l]{Definierte\\Abbildungen}}{%
    \begin{aligned}[t]
      &(x\mapsto x+\IntOne)\dsep{}\\
      &(x\mapsto x-\IntOne)
    \end{aligned}}%
  \DeltaRow{Ordnung}{\leq_{\mathbb Z}}%
}
