...
\begin{tabproofwide}
  \proofstepwidestar[]{(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z}{%
    \quad\FormulaRefAuto{IntegerSuccessorDef}[def]}
\end{tabproofwide}
...
\begin{tabproofwide}
  \proofstepwidestar[]{(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z}{%
    \quad\FormulaRefAuto{IntegerPredecessorDef}[def]}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{0,1\in\mathbb N}{%
    \rAI{\FormulaRefAuto{PeanoZero}[ax],\FormulaRefAuto{PeanoOneInN}[thm]}}
  \proofstepwidestar[]{\IntOne=\IntClass{1}{0}}{%
    \rChain{\FormulaRefAuto{IntegerOneDef}[def],%
      \FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{2}}}
  \proofstepwidestar[1]{b+0=b}{\FormulaRefAuto{PeanoAddRightZero}[thm]{1}}
  \proofstepwide[1]{\IntClass{a}{b}+\IntOne}{=}{\IntClass{a+1}{b+0}}{%
    \rIE{3,\FormulaRefAuto{IntegerAdditionDef}[def]{1,2}}}
  \proofstepwide[1]{}{=}{\IntClass{a+1}{b}}{\rIE{4}}
  \proofstepwidestar[1]{\IntClass{a}{b}+\IntOne=\IntClass{a+1}{b}}{\rChain{5,6}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{-\IntOne=\IntClass{0}{1}}{%
    \rIE{3,\FormulaRefAuto{IntegerNegationDef}[def]{2}}}
  ...
  \proofstepwide[1]{\IntClass{a}{b}-\IntOne}{=}{\IntClass{a}{b}+(-\IntOne)}{%
    \FormulaRefAuto{IntegerSubtractionDef}[def]{%
      \FormulaRefAuto{IntegerClassInZ}[thm]{1},\FormulaRefAuto{IntOneCarrier}[thm]}}
  \proofstepwide[1]{}{=}{\IntClass{a+0}{b+1}}{%
    \rIE{4,\FormulaRefAuto{IntegerAdditionDef}[def]{1,2}}}
  \proofstepwide[1]{}{=}{\IntClass{a}{b+1}}{\rIE{5}}
  \proofstepwidestar[1]{\IntClass{a}{b}-\IntOne=\IntClass{a}{b+1}}{\rChain{6,7,8}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Auflösen der Subtraktion]{%
    ...
    \proofstepwidestarbreakkeep[1]{(z+\IntOne)-\IntOne=(z+\IntOne)+(-\IntOne)}{%
      \FormulaRefAuto{IntegerSubtractionDef}[def]{2,\FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}}
  \closeproofpartwideindR
  \proofpartwide{Assoziativität und Inverses}
    ...
    \proofstepwide[1]{}{=}{z}{\rAEa{\FormulaRefAuto{IntegerAddZeroAxiom}[ax]{1}}}
    \proofstepwidestar[1]{(z+\IntOne)-\IntOne=z}{\rChain{5,6,7,8}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Auflösen der Subtraktion]{%
    ...
    \proofstepwidestar[1]{z-\IntOne=z+(-\IntOne)}{%
      \FormulaRefAuto{IntegerSubtractionDef}[def]{1,\FormulaRefAuto{IntegerOneCarrierAxiom}[ax]}}
    \proofstepwidestarbreakkeep[1]{(z-\IntOne)+\IntOne=(z+(-\IntOne))+\IntOne}{\rIE{2}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Injektivität]{%
    ...
    \proofstepwide[1]{x}{=}{(x+\IntOne)-\IntOne}{%
      \FormulaRefAuto{a=b\vdash b=a}{\FormulaRefAuto{IntegerPredAfterSucc}[thm]{1}}}
    \proofstepwide[1,2]{}{=}{(y+\IntOne)-\IntOne}{\rIE{5}}
    \proofstepwide[1]{}{=}{y}{\FormulaRefAuto{IntegerPredAfterSucc}[thm]{1}}
    \proofstepwidestar[1,2]{x=y}{\rChain{6,7,8}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwide[1]{}{=}{\IntEmbed(n+1)}{%
    \FormulaRefAuto{a=b\vdash b=a}{\FormulaRefAuto{NaturalIntegerEmbeddingAdditive}[thm]{1,2}}}
  \proofstepwidestar[1]{\IntEmbed(n)+\IntOne=\IntEmbed(n+1)}{\rChain{4,5}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{-\IntEmbed(n)=\IntClass{0}{n}}{%
    \rIE{4,\FormulaRefAuto{IntegerNegationDef}[def]{1,2}}}
  ...
  \proofstepwidestar[1]{-\IntEmbed(n+1)=\IntClass{0}{n+1}}{%
    \rIE{6,\FormulaRefAuto{IntegerNegationDef}[def]{2,3}}}
  \proofstepwide[1]{-\IntEmbed(n)-\IntOne}{=}{\IntClass{0}{n+1}}{%
    \rIE{5,\FormulaRefAuto{IntegerPredecessorClassValue}[thm]{2,1}}}
  \proofstepwide[1]{}{=}{-\IntEmbed(n+1)}{\FormulaRefAuto{a=b\vdash b=a}{7}}
  \proofstepwidestar[1]{-\IntEmbed(n)-\IntOne=-\IntEmbed(n+1)}{\rChain{8,9}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{\IntZero<\IntEmbed(k)}{%
    \FormulaRefAuto{IntegerStrictOrderDef}[def]{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax],13,\rAI{7,12}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,5]{(h+1)\cdot k\neq0}{%
    \FormulaRefAuto{NaturalNonzeroProductForIntegerModel}[thm]{%
      ...
      \rAEb{\rAEb{1}},%
      \FormulaRefAuto{PeanoAddOneNonzero}[thm]{\rAEa{5}},2}}
  ...
  \proofstepwidestarbreakkeep[1,5]{(a+(h+1))\cdot k
    ...
    \FormulaRefAuto{PeanoMulRightDistributive}[thm]{%
      \rAEa{1},\FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{5}},%
      \rAEb{\rAEb{1}}}}
  \proofstepwidestarbreakkeep[1,5,8]{a\cdot k+(t+1)=c\cdot k}{%
    \rIE{\rAEb{5},\rAEb{8},9}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Ordnungsteil]{%
    ...
    \proofstepwidestarbreakkeep[3]{z+\IntOne=\IntClass{a+1}{b}}{%
      \rIE{3,\FormulaRefAuto{IntegerSuccessorClassValue}[thm]{3}}}
    \proofstepwidestarbreakkeep[3]{a\leq a+1}{\FormulaRefAuto{PeanoLeqAddOne}[thm]{3}}
    \proofstepwidestarbreakkeep[3]{a+b\leq(a+1)+b}{\FormulaRefAuto{NaturalOrderTranslationForward}[thm]{3,4,6}}
    \proofstepwidestarbreakkeep[3]{\IntClass{a}{b}\leq\IntClass{a+1}{b}}{\FormulaRefAuto{IntegerOrderClassChar}[thm]{3,4,7}}
    \proofstepwidestarbreakkeep[3]{z\leq z+\IntOne}{\rIE{3,5,8}}
    \proofstepwidestarbreakkeep[1]{z\leq z+\IntOne}{\rEE{2,3,9}}
  \closeproofpartwideindR
  \proofpartwideindR[Ungleichheitsteil]{%
    ...
    \proofstepwidestarbreakkeep[4]{z+\IntOne=\IntClass{a+1}{b}}{%
      \rIE{4,\FormulaRefAuto{IntegerSuccessorClassValue}[thm]{4}}}
    \proofstepwidestarbreakkeep[2,4]{\IntClass{a}{b}=\IntClass{a+1}{b}}{\rIE{4,6,2}}
    \proofstepwidestarbreakkeep[2,4]{a+b=b+(a+1)}{\FormulaRefAuto{IntegerClassEquality}[thm]{4,5,7}}
    \proofstepwidestarbreakkeep[4]{b+(a+1)=(a+1)+b}{\FormulaRefAuto{PeanoAddCommutative}[thm]{4,5}}
    \proofstepwidestarbreakkeep[2,4]{a+b=(a+1)+b}{\rIE{8,9}}
    \proofstepwidestarbreakkeep[2,4]{a=a+1}{\FormulaRefAuto{PeanoAddRightCancellation}[thm]{4,5,10}}
    \proofstepwidestarbreakkeep[4]{a<a+1}{\FormulaRefAuto{PeanoLtAddOne}[thm]{4}}
    \proofstepwidestarbreakkeep[2,4]{\bot}{\FormulaRefAuto{PeanoStrictEqualityImpossible}[thm]{4,5,12,11}}
    \proofstepwidestarbreakkeep[1,2]{\bot}{\rEE{3,4,13}}
    \proofstepwidestarbreakkeep[1]{z\neq z+\IntOne}{\rCI{2,14}}
  \closeproofpartwideindR
  \proofpartwide{Schluss}
    \proofstepwidestarbreakkeep[1]{z\in\mathbb Z}{\rA}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{\IntEmbed(m)<\IntEmbed(m+1)}{\rIE{5,6}}
  \proofstepwidestar[8]{a=\IntEmbed(m)}{\rA}
  \proofstepwidestar[2,8]{a<\IntEmbed(m+1)}{\rIE{8,7}}
  ...
  \proofstepwidestar[2,10]{a<\IntEmbed(m+1)}{\rIE{10,24}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktion auf dem nichtnegativen Strahl]{%
    ...
    \proofstepwidestarbreakkeep[2,5]{%
      ...
      P(\IntEmbed(n)+\IntOne)}{\rRE{\rUE{2},7}}
    \proofstepwidestarbreakkeep[2,5,6]{P(\IntEmbed(n)+\IntOne)}{\rRE{8,6}}
    \proofstepwidestarbreakkeep[5]{%
      \IntEmbed(n)+\IntOne=\IntEmbed(n+1)}{%
      \FormulaRefAuto{IntegerSuccessorOnEmbedding}[thm]{5}}
    \proofstepwidestarbreakkeep[2,5,6]{P(\IntEmbed(n+1))}{\rIE{10,9}}
    \proofstepwidestarbreakkeep[2,5]{%
      P(\IntEmbed(n))\rightarrow P(\IntEmbed(n+1))}{\rRI{6,11}}
    ...
    \proofstepwidestarbreakkeep[1,2]{\forall n\in\mathbb N\,
      P(\IntEmbed(n))}{%
      \FormulaRefAuto{PeanoInductionAddOne}[thm]{4,13}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Induktion auf dem nichtpositiven Strahl]{%
    ...
    \proofstepwidestarbreakkeep[2,6,7]{P(-\IntEmbed(n)-\IntOne)}{\rRE{9,7}}
    \proofstepwidestarbreakkeep[6]{%
      -\IntEmbed(n)-\IntOne=-\IntEmbed(n+1)}{%
      \FormulaRefAuto{IntegerPredecessorOnNegativeEmbedding}[thm]{6}}
    \proofstepwidestarbreakkeep[2,6,7]{P(-\IntEmbed(n+1))}{\rIE{11,10}}
    \proofstepwidestarbreakkeep[2,6]{%
      P(-\IntEmbed(n))\rightarrow P(-\IntEmbed(n+1))}{\rRI{7,12}}
    \proofstepwidestarbreakkeep[2]{\forall n\in\mathbb N\,
      (P(-\IntEmbed(n))\rightarrow P(-\IntEmbed(n+1)))}{%
      \rUI{\rRI{6,13}}}
    \proofstepwidestarbreakkeep[1,2]{\forall n\in\mathbb N\,
      P(-\IntEmbed(n))}{%
      \FormulaRefAuto{PeanoInductionAddOne}[thm]{5,14}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestarbreakkeep[]{(x\mapsto x+\IntOne)\colon\mathbb Z\to\mathbb Z}{%
      \rAEa{\rAEb{\FormulaRefAuto{IntegerPeanoModelCarrierMaps}}}}
    \proofstepwidestarbreakkeep[]{(x\mapsto x-\IntOne)\colon\mathbb Z\to\mathbb Z}{%
      \rAEb{\rAEb{\FormulaRefAuto{IntegerPeanoModelCarrierMaps}}}}
    \proofstepwidestarbreakkeep[6]{z\in\mathbb Z}{\rA}
    \proofstepwidestarbreakkeep[6]{(z+\IntOne)-\IntOne=z}{%
