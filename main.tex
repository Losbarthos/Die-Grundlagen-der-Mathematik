...
\clearpage
\BandStartInMain{B13}
\subfile{Bd. 13 - Die ganzen Zahlen aus Äquivalenzrelationen und erweiterten Peano-Axiomen}

\clearpage
\BandStartInMain{B14}
\subfile{Bd. 14 - Axiomatischer Aufbau der endlichen Mengen}

\clearpage
\BandStartInMain{B15}
\subfile{Bd. 15 - Halbgruppen, Monoide und Halbringe}

\clearpage
\BandStartInMain{B16}
\subfile{Bd. 16 - Gruppen und Ringe}

\clearpage
\BandStartInMain{B17}
\subfile{Bd. 17 - Axiomatischer Aufbau der Halbverbände und Verbände}

\clearpage
\BandStartInMain{B18}
\subfile{Bd. 18 - Frankls Vermutung}
