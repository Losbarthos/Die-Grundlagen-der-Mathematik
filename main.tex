...
\clearpage
\BandStartInMain{B14}
\subfile{Bd. 14 - Rationale Zahlen}

\clearpage
\BandStartInMain{B15}
\subfile{Bd. 15 - Reelle Zahlen}

\clearpage
\BandStartInMain{B16}
\subfile{Bd. 16 - Endliche Mengen}

\clearpage
\BandStartInMain{B17}
\subfile{Bd. 17 - Folgen}

\clearpage
\BandStartInMain{B18}
\subfile{Bd. 18 - Halbgruppen}

\clearpage
\BandStartInMain{B19}
\subfile{Bd. 19 - Kommutative Halbgruppen}

\clearpage
\BandStartInMain{B20}
\subfile{Bd. 20 - Idempotente Halbgruppen}

\clearpage
\BandStartInMain{B21}
\subfile{Bd. 21 - Kommutative idempotente Halbgruppen}

\clearpage
\BandStartInMain{B22}
\subfile{Bd. 22 - Halbgruppen mit Nullelement}

\clearpage
\BandStartInMain{B23}
\subfile{Bd. 23 - Linkskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B24}
\subfile{Bd. 24 - Rechtskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B25}
\subfile{Bd. 25 - Kürzbare Halbgruppen}

\clearpage
\BandStartInMain{B26}
\subfile{Bd. 26 - Endliche Halbgruppen}

\clearpage
\BandStartInMain{B27}
\subfile{Bd. 27 - Monoide}

\clearpage
\BandStartInMain{B28}
\subfile{Bd. 28 - Halbringe}

\clearpage
\BandStartInMain{B29}
\subfile{Bd. 29 - Gruppen und Ringe}

\clearpage
\BandStartInMain{B30}
\subfile{Bd. 30 - Halbverbände und Verbände}

\clearpage
\BandStartInMain{B31}
\subfile{Bd. 31 - Frankls Vermutung}
