...
\clearpage
\BandStartInMain{B25}
\subfile{Bd. 25 - Rechtecksbänder}

\clearpage
\BandStartInMain{B26}
\subfile{Bd. 26 - Kommutative idempotente Halbgruppen}

\clearpage
\BandStartInMain{B27}
\subfile{Bd. 27 - Halbgruppen mit Nullelement}

\clearpage
\BandStartInMain{B28}
\subfile{Bd. 28 - Linkskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B29}
\subfile{Bd. 29 - Rechtskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B30}
\subfile{Bd. 30 - Kürzbare Halbgruppen}

\clearpage
\BandStartInMain{B31}
\subfile{Bd. 31 - Endliche Halbgruppen}

\clearpage
\BandStartInMain{B32}
\subfile{Bd. 32 - Monoide}

\clearpage
\BandStartInMain{B33}
\subfile{Bd. 33 - Halbringe}

\clearpage
\BandStartInMain{B34}
\subfile{Bd. 34 - Gruppen und Ringe}

\clearpage
\BandStartInMain{B35}
\subfile{Bd. 35 - Halbverbände und Verbände}

\clearpage
\BandStartInMain{B36}
\subfile{Bd. 36 - Frankls Vermutung}

\clearpage
\BandStartInMain{B37}
\subfile{Bd. 37 - Metrische Räume und Vollständigkeit}
