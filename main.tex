...
\input{tex/impl/csb-editions.tex}
...
\begingroup
\BandStartInMain{B00}
\subfile{Bd. 00 - Überblick über die Bände}
\clearpage
\endgroup
...
\clearpage
\BandStartInMain{B40}
\subfile{Bd. 40 - Gruppen}

\clearpage
\BandStartInMain{B41}
\subfile{Bd. 41 - Abelsche Gruppen}

\clearpage
\BandStartInMain{B42}
\subfile{Bd. 42 - Endliche Gruppen}

\clearpage
\BandStartInMain{B43}
\subfile{Bd. 43 - Ringe mit Eins}

\clearpage
\BandStartInMain{B44}
\subfile{Bd. 44 - Kommutative Ringe mit Eins}

\clearpage
\BandStartInMain{B45}
\subfile{Bd. 45 - Halbverbände und Verbände}

\clearpage
\BandStartInMain{B46}
\subfile{Bd. 46 - Frankls Vermutung}

\clearpage
\BandStartInMain{B47}
\subfile{Bd. 47 - Metrische Räume und Vollständigkeit}
\clearpage
\BandStartInMain{B48}
\subfile{Bd. 48 - Axiomatische Mengenlehre II}
