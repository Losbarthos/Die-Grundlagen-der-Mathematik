...
\clearpage
\BandStartInMain{B22}
\subfile{Bd. 22 - Endliche Wörter und Klammerungsbäume}

\clearpage
\BandStartInMain{B23}
\subfile{Bd. 23 - Halbgruppen}

\clearpage
\BandStartInMain{B24}
\subfile{Bd. 24 - Kommutative Halbgruppen}

\clearpage
\BandStartInMain{B25}
\subfile{Bd. 25 - Idempotente Halbgruppen}

\clearpage
\BandStartInMain{B26}
\subfile{Bd. 26 - Rechtecksbänder}

\clearpage
\BandStartInMain{B27}
\subfile{Bd. 27 - Kommutative idempotente Halbgruppen}

\clearpage
\BandStartInMain{B28}
\subfile{Bd. 28 - Halbgruppen mit Nullelement}

\clearpage
\BandStartInMain{B29}
\subfile{Bd. 29 - Linkskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B30}
\subfile{Bd. 30 - Rechtskürzbare Halbgruppen}

\clearpage
\BandStartInMain{B31}
\subfile{Bd. 31 - Kürzbare Halbgruppen}

\clearpage
\BandStartInMain{B32}
\subfile{Bd. 32 - Endliche Halbgruppen}

\clearpage
\BandStartInMain{B33}
\subfile{Bd. 33 - Monoide}

\clearpage
\BandStartInMain{B34}
\subfile{Bd. 34 - Halbringe}

\clearpage
\BandStartInMain{B35}
\subfile{Bd. 35 - Gruppen und Ringe}

\clearpage
\BandStartInMain{B36}
\subfile{Bd. 36 - Halbverbände und Verbände}

\clearpage
\BandStartInMain{B37}
\subfile{Bd. 37 - Frankls Vermutung}

\clearpage
\BandStartInMain{B38}
\subfile{Bd. 38 - Metrische Räume und Vollständigkeit}
