...
\ifSubfilesClassLoaded{
  \BandSetupStandalone{B29}
}{
}

\title{Bd. 29 - Gruppen und Ringe}
\author{Martin Kunze}
\date{}
\setcounter{file}{29}

\hypersetup{
  pdftitle={Bd. 29 - Gruppen und Ringe},
...
\tableofcontents
\setcounter{file}{29}
\renewcommand{\FormulaBandID}{29}

\chapter{Einleitung}

Die Bände~18--26 entwickeln Halbgruppen und ihre Spezialisierungen,
Band~27 Monoide und Band~28 Halbringe.
...
Wie in den Bänden~18--20 gehört jede Operation obligatorisch zur
...
aus Band~28 zur Verfügung. Ein Differenzenpaar \((a,b)\) soll auf die
