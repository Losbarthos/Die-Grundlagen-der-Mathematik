...
\begin{tabproof}
  ...
  \proofstep{1,2,3,4}{\bot}{\rBI{1,6}}
  \proofstep{1,2,3}{\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{\rCE{4,7}}
  \proofstep{1}{%
    B\subseteq \powerset(M)\dsep B\neq\varnothing \vdash
    \exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)
  }{\rRI{2,\rRI{3,8}}}
  \proofstep{1}{\TarskiFinite(M)}{\FormulaRefAuto{Tarski-endliche Menge}{9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{3}{\TarskiFinite(M)}{%
    \FormulaRefAuto{\neg\exists H\colon \mathbb{N}\inj M\vdash \TarskiFinite(M)}{6}}
  \proofstep{1}{\TarskiFinite(M)}{\rEE{2,3,7}}
\end{tabproof}
