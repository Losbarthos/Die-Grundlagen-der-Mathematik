...
\begin{tabproof}
  ...
  \proofstep{}{R_M \subseteq M\times \bigcup M}{%
    \FormulaRefAuto{\{\,z\in C \mid P(z)\,\}\subseteq C}{}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{(X,a)\in M\times \bigcup M \land a\in X}{%
    \FormulaRefAuto{z\in \{\,t\in C \mid P(t)\,\} \vdash z\in C \land P(z)}{1}}
  \proofstep{1}{(X,a)\in M\times \bigcup M}{\rAEa{2}}
  \proofstep{1}{a\in X}{\rAEb{2}}
  \proofstep{1}{X\in M \land a\in \bigcup M}{%
    \FormulaRefAuto{(x,y)\in A\times B \vdash x\in A \land y\in B}{3}}
  \proofstep{1}{X\in M}{\rAEa{5}}
  \proofstep{1}{a\in \bigcup M}{\rAEb{5}}
  \proofstep{1}{X\in M \land a\in \bigcup M \land a\in X}{\rAI{\rAI{6,7},4}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{a\in \bigcup M}{%
    \FormulaRefAuto{X\in M \dsep a\in X \vdash a\in \bigcup M}{1,2}}
  \proofstep{1,3}{(X,a)\in M\times \bigcup M}{%
    \FormulaRefAuto{x\in A \dsep y\in B \vdash (x,y)\in A\times B}{1,3}}
  \proofstep{1,2,4}{(X,a)\in R_M}{%
    \FormulaRefAuto{x\in A \dsep P(x) \vdash x\in \{\,t\in A \mid P(t)\,\}}{4,2}}
\end{tabproof}

% ------------------------------------------------------------
% 4) Lemma: DisjFam(M) liefert Totalität von R_M (also: TotRel)
% ------------------------------------------------------------
\FormulaThmDelta
...
\begin{tabproof}
  ...
  \proofstep{}{R_M \subseteq M\times \bigcup M}{\FormulaRefAuto{R_M \subseteq M\times \bigcup M}}
  \proofstep{3}{X\in M}{\rA}
  \proofstep{3}{X\neq\varnothing}{\FormulaRefAuto{X\in M \vdash X\neq\varnothing}{3}}
  \proofstep{3}{\exists a\,(a\in X)}{\FormulaRefAuto{X\neq\varnothing \vdash \exists a\,(a\in X)}{4}}
  \proofstep{6}{a\in X}{\rA}
  \proofstep{3,6}{(X,a)\in R_M}{\FormulaRefAuto{X\in M \dsep a\in X \vdash (X,a)\in R_M}{3,6}}
  \proofstep{3}{\exists a\in \bigcup M\,((X,a)\in R_M)}{\rEE{5,6,7}}
  \proofstep{1}{X\in M \vdash \exists a\in \bigcup M\,((X,a)\in R_M)}{\rRI{3,8}}
  \proofstep{1}{\TotRel{R_M,M,\bigcup M}}{\rAI{2,9}}
\end{tabproof}
