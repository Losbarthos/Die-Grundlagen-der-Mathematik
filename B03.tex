...
\FormulaThmDelta[Minimales Beispiel mit doppelter Vereinigung]{%
  \vdash \exists M\,\mathsf{DupUCF}(M)
}{%
  \DeltaRow{Mengen}{M\dsep M_0\dsep A\dsep a\dsep X\dsep Y}
  \DeltaRow{Teilmengenfamilien}{(M_0)_{\bar a}}
}
\begin{tabproof}
  \proofstep{}{M_0=\{\varnothing\}}{\text{Setze }M_0\coloneqq\{\varnothing\}}
  \proofstep{}{\varnothing\in M_0}{\text{Df. }M_0}
  \proofstep{}{M_0\neq\varnothing}{\text{Zeile }2}
  \proofstep{}{\Finite{M_0}}{\text{Endlichkeit der Einermenge}}

  \proofstep{5}{X\in M_0}{\rA}
  \proofstep{6}{Y\in M_0}{\rA}
  \proofstep{5}{X=\varnothing}{\text{Df. }M_0}
  \proofstep{6}{Y=\varnothing}{\text{Df. }M_0}
  \proofstep{5,6}{X\cup Y=\varnothing}{\text{Zeilen }7,8}
  \proofstep{5,6}{X\cup Y\in M_0}{\text{Df. }M_0}
  \proofstep{}{\UnionClosedFam(M_0)}{%
    \text{Vereinigungsschließung nach Zeilen }5\text{--}10}

  \proofstep{12}{A\in M_0}{\rA}
  \proofstep{12}{A=\varnothing}{\text{Df. }M_0}
  \proofstep{12}{%
    \begin{aligned}[t]
      &\forall a\in A\,\exists I_1\in (M_0)_{\bar a}\\
      &\exists I_2\in (M_0)_{\bar a}\,
        \bigl(I_1\neq I_2\\
      &\land I_1\cup A=I_2\cup A\bigr)
    \end{aligned}}{%
    \text{leer, Zeile }13}
  \proofstep{}{\mathsf{DupCov}(M_0)}{\text{Df. }\mathsf{DupCov}}

  \proofstep{}{\mathsf{DupUCF}(M_0)}{\text{Df. }\mathsf{DupUCF}\text{ aus }3,4,11,15}
  \proofstep{}{\exists M\,\mathsf{DupUCF}(M)}{\rEI{16}}
\end{tabproof}

Ausgeschrieben ist dies genau die Existenzformel
\[
  \begin{aligned}
    \exists M\Bigl(&
      M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land{}\\
