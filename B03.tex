...
% Band-3 Registry/Debug unter festem Namen schreiben
\directlua{
  thmlookup.registry_path = "_B03.registry.tsv"
  thmlookup.debug_path    = "_B03.debug.log"
}

\AtBeginDocument{%
\directlua{ thmlookup.load_registry_file("registry/_B02.registry.tsv") }%
}
