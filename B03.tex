...
\begin{tabproof}
  ...
  \proofstep{3,5}{\exists a\in S(X)\setminus X}{%
    \FormulaRefAuto{A\subset B\vdash \exists x\in B\setminus A}{6}}
  \proofstep{8}{a\in S(X)\setminus X}{\rA}
  \proofstep{2,5}{S(X)\in B}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{2,5}}
  \proofstep{1,9}{S(X)\in \powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{1,9}}
  \proofstep{10}{S(X)\subseteq M}{%
    \FormulaRefAuto{x \in \powerset(A)\eqvdash x \subseteq A}{10}}
  \proofstep{8}{a\in S(X)}{\FormulaRefAuto{x\in A\setminus B\vdash x\in A}{8}}
  \proofstep{1,2,5,8}{a\in M}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{11,12}}
  \proofstep{5,13}{(X,a)\in B\times M}{%
    \FormulaRefAuto{a\in A\dsep b\in B\vdash (a,b)\in A\times B}{5,13}}
  \proofstep{5,8,13}{(X,a)\in B\times M\land a\in S(X)\setminus X}{\rAI{14,8}}
  \proofstep{1,2,5,8}{(X,a)\in \FreshRel{S}}{%
    \rIE{\FormulaRefAuto{B\subseteq \powerset(M)\dsep S\colon B\to B \vdash \FreshRel{S}\coloneqq \{(X,a)\in B\times M\mid a\in S(X)\setminus X\}}{1,2},15}}
  \proofstep{1,2,3,5,8}{\exists a\,(X,a)\in \FreshRel{S}}{\rEI{16}}
  \proofstep{1,2,3,5}{\exists a\,(X,a)\in \FreshRel{S}}{\rEE{7,8,17}}
  \proofstep{1,2,3}{X\in B\rightarrow \exists a\,(X,a)\in \FreshRel{S}}{\rRI{5,18}}
  \proofstep{1,2,3}{\TotRel{\FreshRel{S},B,M}}{%
    \FormulaRefAuto{Totale Relation}{4,19}}
  \proofstep{1,2,3}{%
    \exists D\colon B\to M\,\forall X\in B\,\bigl((X,D(X))\in \FreshRel{S}\bigr)
  }{%
    \FormulaRefAuto{\exists F\colon A \to B\,\forall x\in A\,\bigl((x,F(x))\in R\bigr)}{20}}
  \proofstep{22}{D\colon B\to M\land \forall X\in B\,\bigl((X,D(X))\in \FreshRel{S}\bigr)}{\rA}
  \proofstep{22}{D\colon B\to M}{\rAEa{22}}
  \proofstep{22}{\forall X\in B\,\bigl((X,D(X))\in \FreshRel{S}\bigr)}{\rAEb{22}}
  \proofstep{25}{X\in B}{\rA}
  \proofstep{22,25}{(X,D(X))\in \FreshRel{S}}{\rRE{25,\rUE{24}}}
  \proofstep{1,2,22,25}{(X,D(X))\in \{(X,a)\in B\times M\mid a\in S(X)\setminus X\}}{%
    \rIE{\FormulaRefAuto{B\subseteq \powerset(M)\dsep S\colon B\to B \vdash \FreshRel{S}\coloneqq \{(X,a)\in B\times M\mid a\in S(X)\setminus X\}}{1,2},26}}
  \proofstep{1,2,22,25}{D(X)\in S(X)\setminus X}{%
    \FormulaRefAuto{x \in \{x \in A \mid P(x)\}\vdash P(x)}{27}}
  \proofstep{1,2,22}{\forall X\in B\,\bigl(D(X)\in S(X)\setminus X\bigr)}{\rUI{\rRI{25,28}}}
  \proofstep{1,2,22}{D\colon B\to M\land \forall X\in B\,\bigl(D(X)\in S(X)\setminus X\bigr)}{\rAI{23,29}}
  \proofstep{1,2,22}{\exists D\colon B\to M\,\forall X\in B\,\bigl(D(X)\in S(X)\setminus X\bigr)}{\rEI{30}}
  \proofstep{1,2,3}{\exists D\colon B\to M\,\forall X\in B\,\bigl(D(X)\in S(X)\setminus X\bigr)}{\rEE{21,22,31}}
\end{tabproof}
