...
\begin{tabproof}
  ...
  \proofcase[1.2]{x=b \vdash x\in\{c,d\}}
  \proofstep{9}{x=b}{\rA}
  ...
  \proofcase[2]{\{c,d\}\subseteq\{a,b\}}
  \proofstep{15}{x\in\{c,d\}}{\rA}
  \proofstep{15}{x=c\lor x=d}{\FormulaRefAuto{x \in \{A,B\}\;\eqvdash\;(x = A \lor x = B)}{15}}

  \proofcase[2.1]{x=c \vdash x\in\{a,b\}}
  \proofstep{17}{x=c}{\rA}
  \proofstep{1,17}{x=a}{\FormulaRefAuto{a = b,\, b = c \vdash a = c}{17,1}}
  \proofstep{1,17}{x=a\lor x=b}{\rOIa{18}}
  \proofstep{1,17}{x\in \{a,b\}}{\FormulaRefAuto{x \in \{A,B\}\;\eqvdash\;(x = A \lor x = B)}{19}}

  \proofcase[2.2]{x=d \vdash x\in\{a,b\}}
  \proofstep{21}{x=d}{\rA}
  \proofstep{2,21}{x=b}{\FormulaRefAuto{a = b,\, b = c \vdash a = c}{21,2}}
  \proofstep{2,21}{x=a\lor x=b}{\rOIb{22}}
  \proofstep{2,21}{x\in \{a,b\}}{\FormulaRefAuto{x \in \{A,B\}\;\eqvdash\;(x = A \lor x = B)}{23}}

  \proofcasesummary[2]{\{c,d\}\subseteq\{a,b\}}
  \proofstep{1,2,15}{x\in \{a,b\}}{\rOE{16,17,20,21,24}}
  \proofstep{1,2}{\{c,d\}\subseteq \{a,b\}}%
    {\FormulaRefAuto{A \subseteq B := \forall x\,(x\in A \rightarrow x\in B)}{\rUI{\rRI{15,25}}}}

  \proofcasesummary{\{a,b\}=\{c,d\}} % (optional hübsch)

  \proofstep{1,2}{\{a,b\}=\{c,d\}}%
    {\FormulaRefAuto{A \subseteq B \land B \subseteq A \eqvdash A = B}{\rAI{14,26}}}
\end{tabproof}
...
\proofstepstar{}{(a=d\land b=c)\lor (a=d\land b=d)}{}
  ...
  \proofstep{1}{d=a\lor d=b}{\FormulaRefAuto{x \in \{A,B\}\;\eqvdash\;(x = A \lor x = B)}{\rIE{1,\FormulaRefAuto{b\in\{a,b\}}}}}
  \proofstep{1}{d=c}{\FormulaRefAuto{a = c,\, b = c, d=a\lor d=b \vdash d = c}{5,6,7}}
  \proofstep{1,4}{b=d}{\FormulaRefAuto{a = b, c = b\vdash a = c}{6,8}}
  \proofstep{1,4}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIa{\rAI{5,9}}}
  \proofstep{11}{(a=c\land b=d) \lor (a=d\land b=c)}{\rA}
  \proofstep{12}{a=d\land b=d}{\rA}
  \proofstep{12}{a=d}{\rAEa{12}}
  \proofstep{12}{b=d}{\rAEb{12}}
  \proofstep{1}{c=a\lor c=b}{\FormulaRefAuto{x \in \{A,B\}\;\eqvdash\;(x = A \lor x = B)}{\rIE{1,\FormulaRefAuto{a\in\{a,b\}}}}}
  \proofstep{1,12}{c=d}{\FormulaRefAuto{a = c,\, b = c, d=a\lor d=b \vdash d = c}{13,14,15}}
  \proofstep{1,12}{b=c}{\FormulaRefAuto{a = b, c = b\vdash a = c}{14,16}}
  \proofstep{1,12}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIb{\rAI{13,17}}}
  \proofstep{1}{(a=c\land b=d)\lor (a=d\land b=c)}{\rOEn{3,4,10,11,11,12,18}}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \closeproofpart
  \proofpart{\(\dashv\)}
...
\begin{tabproofwide}
  \proofstepwide{(a,b) = (c,d)}{\leftrightarrow}{\{\{a\},\{a,b\}\}=\{\{c\},\{c,d\}\}}{\FormulaRefAuto{\forall a,b((a, b) := \{ \{ a \}, \{ a, b \}) \}}}
  \proofstepwide{}{\leftrightarrow}{\{\{a\},\{a,b\}\}=\{\{c\},\{c,d\}\}}{\FormulaRefAuto{\forall a,b((a, b) := \{ \{ a \}, \{ a, b \}) \}}}
\end{tabproofwide}
...
\subsection{Nachfolger-Graph auf einer Menge \(A\)}
...
\begin{tabproof}
  ...
  \proofstep{2,3}{ \exists y\in A\; \bigl( y = x\cup\{x\} \land (x,y)\in \mathrm{succ}_A \bigr) }%
    {\rEI{ \text{mit } y := x\cup\{x\},~ \rAI{3,\,\rUE{\FormulaRefAuto{\mathrm{succ}_A := \{\, (u,v) \in A \times A \mid v = u \cup \{u\} \,\}}{}} } }}
  \proofstep{}{\forall x\in A\,\exists y\in A\; (x,y)\in \mathrm{succ}_A}{\rUI{\UEI{2,4}}}
\end{tabproof}
...
\FormulaDefAuto[Nachfolger-Vorschrift]{\mathrm{succ}(x) := x \cup \{x\}}[Klassenvorschrift: gilt für jede Menge \(x\).]
\begin{remark}
