...
\begin{tabproof}
  ...
  \proofstep{1,2,3,4,5}{x\in H[\mathbb{N}]}{\rIE{8,9}}
  \proofstep{1,2,3,4,5}{\bot}{\rBI{10,3}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,5}{\exists n\in\mathbb{N}\,\bigl(y=H(n)\bigr)}{%
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash \exists x\in A\,y=F(x)}{%
      \FormulaRefAuto{Injektive Funktion}{1},5}}
  \proofstep{8}{n\in\mathbb{N}}{\rA}
  \proofstep{9}{y=H(n)}{\rA}
  \proofstep{6,9}{\SuccShift{H}(x)=\SuccShift{H}(H(n))}{%
    \rIE{9,6}}
  \proofstep{1,2,4,8,10}{\bot}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \dsep n\in\mathbb{N}\dsep
      \SuccShift{H}(x)=\SuccShift{H}(H(n))\vdash \bot}{1,2,4,8,10}}
  \proofstep{1,2,4,5,6}{x=y}{\rEE{7,8,9,\rCE{11}}}
\end{tabproof}
