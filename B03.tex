...
\begin{tabproof}
  ...
  \proofstep{2}{\WellOrdable(A)}{\text{Zermelo-Konstruktion aus }2}
  \proofstep{1}{\WellOrdable(A)}{\rEE{1,2,3}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{%
    \forall x\in A\,\exists! b\in B\,
    \bigl(G(b)=x\land
    \forall c\in B\,(G(c)=x\rightarrow (b,c)\in R)\bigr)%
  }{\text{\(R\)-minimale Elemente der nichtleeren Fasern}}
  \proofstep{1,2}{\exists F\colon A\to B\,G\circ F=\Id_A}{%
    \text{Funktion der eindeutigen Faserminima}}
\end{tabproof}
