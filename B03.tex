...
\begin{tabproof}
  ...
  \proofstep{5}{x\in B\land x\notin A}{\rAI{7,6}}
  \proofstep{5}{x\in B\setminus A}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash x \in A \land x \notin B}{8}}
  \proofstep{5}{\exists x\in B\setminus A}{\rEI{9}}
  \proofstep{4}{\exists x\in B\setminus A}{\rEE{4,5,10}}

  \proofstep{12}{\exists x(x\in A\land x\notin B)}{\rA}
  \proofstep{13}{x\in A\land x\notin B}{\rA}
  \proofstep{13}{x\in A}{\rAEa{13}}
  \proofstep{13}{x\notin B}{\rAEb{13}}
  \proofstep{1,13}{x\in B}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{1,14}}
  \proofstep{1,13}{\exists x\in B\setminus A}{%
    \FormulaRefAuto{P,\,\neg P \vdash Q}{16,15}}
  \proofstep{1,12}{\exists x\in B\setminus A}{\rEE{12,13,17}}

  \proofstep{1,2}{\exists x\in B\setminus A}{\rOE{3,4,11,12,18}}
\end{tabproof}
...
\proofstepstar{}{(a=d\land b=c)\lor (a=d\land b=d)}{}
  ...
  \proofstep{1,4}{b=d}{\FormulaRefAuto{a = b, c = b\vdash a = c}{6,7}}
  \proofstep{1,4}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIa{\rAI{5,8}}}
  \proofstep{10}{a=c\land b=d}{\rA}
  \proofstep{10}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIa{10}}
  \proofstep{12}{a=d\land b=c}{\rA}
  \proofstep{12}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIb{12}}
  \proofstep{14}{a=d\land b=d}{\rA}
  \proofstep{14}{a=d}{\rAEa{14}}
  \proofstep{14}{b=d}{\rAEb{14}}
  \proofstep{1,14}{c=d}{\FormulaRefAuto{\{a,b\}=\{c,d\},a=d,b=d\vdash c=d}{1,15,16}}
  \proofstep{1,14}{b=c}{\FormulaRefAuto{a = b, c = b\vdash a = c}{16,17}}
  \proofstep{1,14}{(a=c\land b=d) \lor (a=d\land b=c)}{\rOIb{\rAI{15,18}}}
  \proofstep{1}{(a=c\land b=d)\lor (a=d\land b=c)}{\FormulaRefAuto{P_1\lor P_2\lor P_3\lor P_4\dsep [P_1]\vdots R\dsep [P_2]\vdots R\dsep [P_3]\vdots R\dsep [P_4]\vdots R\vdash R}{3,4,9,10,11,12,13,14,19}}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \closeproofpart
  \proofpart{\(\dashv\)}
...
\begin{tabproofsplit}
    ...
    \proofstep{10}{\{a\}=\{c,d\}}{\rAEa{10}}
    \proofstep{10}{\{a,b\}=\{c\}}{\rAEb{10}}
...
\begin{tabproof}
  ...
  \proofstep{2}{z\in M\land z\notin M\setminus X}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash x \in A \land x \notin B}[thm]{2}}
  \proofstep{2}{z\in M}{\rAEa{3}}
  \proofstep{2}{z\notin M\setminus X}{\rAEb{3}}
  \proofstep{6}{z\notin X}{\rA}
  \proofstep{2,6}{z\in M\land z\notin X}{\rAI{4,6}}
  \proofstep{2,6}{z\in M\setminus X}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash x \in A \land x \notin B}[thm]{7}}
  \proofstep{2,6}{\bot}{\rBI{8,5}}
  \proofstep{2}{\neg(z\notin X)}{\rCI{6,9}}
  \proofstep{2}{z\in X}{\FormulaRefAuto{rDN}{10}}
  \proofstep{}{M\setminus(M\setminus X)\subseteq X}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}[def]{%
      \rUI{\rRI{2,11}}}}
  \proofstep{13}{z\in X}{\rA}
  \proofstep{1,13}{z\in M}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}[thm]{1,13}}
  \proofstep{15}{z\in M\setminus X}{\rA}
  \proofstep{15}{z\in M\land z\notin X}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash x \in A \land x \notin B}[thm]{15}}
  \proofstep{15}{z\notin X}{\rAEb{16}}
  \proofstep{13,15}{\bot}{\rBI{13,17}}
  \proofstep{13}{z\notin M\setminus X}{\rCI{15,18}}
  \proofstep{1,13}{z\in M\land z\notin M\setminus X}{\rAI{14,19}}
  \proofstep{1,13}{z\in M\setminus(M\setminus X)}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash x \in A \land x \notin B}[thm]{20}}
...
Für eine Familie \(M\) und ein Element \(a\) zerlegen die beiden folgenden
Teilmengenfamilien \(M\) danach, ob ihre Elemente \(a\) enthalten oder
vermeiden. Unter Vereinigungsschließung und \(\{a\}\in M\) wird daraus die
punktweise Adjunktion \(X\mapsto X\cup\{a\}\) als Funktion zwischen diesen
Teilmengenfamilien.
...
\section{Fränkelsche Vermutung}

Die Fränkelsche Vermutung betrifft endliche vereinigungsabgeschlossene
Mengenfamilien. In der folgenden Formulierung ist \(M\) eine Menge von Mengen.
...
Für endliche \(M\) bedeutet \(\mathsf{HalfOcc}(a,M)\), dass höchstens so
...
\FormulaDefDeltaK[Fränkelsche Eigenschaft einer Familie]{%
  \mathsf{Frankl}(M)\coloneqq \exists a\,\mathsf{HalfOcc}(a,M)
}{Fränkelsche Eigenschaft}{%
  \DeltaRow{Mengen}{M\dsep a}
  \DeltaRow{Neue Symbole}{\mathsf{Frankl}}
}

Die Fränkelsche Vermutung lautet damit:
\[
  M\neq\varnothing\dsep \Finite{M}\dsep \UnionClosedFam(M)
  \vdash \mathsf{Frankl}(M).
\]
Sie wird hier nicht als bewiesener Satz verwendet. Wir zeigen zunächst zwei
einfache Spezialfälle.

\subsection{Fall einer enthaltenen Einermenge}

\FormulaThmDelta[Fränkelsche Vermutung bei enthaltener Einermenge]{%
  \Finite{M}\dsep \UnionClosedFam(M)\dsep \{a\}\in M\vdash \mathsf{Frankl}(M)
}{%
  \DeltaRow{Mengen}{M\dsep a}
  \DeltaRow{Funktionen}{\FranklAdj{M}{a}}
}
\begin{tabproof}
  ...
  \proofstep{2,3}{\mathsf{HalfOcc}(a,M)}{%
    \FormulaRefAuto{\mathsf{HalfOcc}(a,M)\coloneqq
    a\in\bigcup M\land
    \exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{\rAI{7,5}}}
  \proofstep{2,3}{\exists a\,\mathsf{HalfOcc}(a,M)}{\rEI{8}}
  \proofstep{1,2,3}{\mathsf{Frankl}(M)}{%
    \FormulaRefAuto{\mathsf{Frankl}(M)\coloneqq \exists a\,\mathsf{HalfOcc}(a,M)}{9}}
\end{tabproof}
...
\FormulaThmDelta[Fränkelsche Vermutung bei nichtleerem Durchschnitt]{%
  \Finite{M}\dsep \UnionClosedFam(M)\dsep M\neq\varnothing\dsep
  \bigcap M\neq\varnothing\vdash \mathsf{Frankl}(M)
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep a}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproof}
  ...
  \proofstep{2}{\UnionClosedFam(M)}{\rA}
  \proofstep{3}{M\neq\varnothing}{\rA}
  \proofstep{4}{\bigcap M\neq\varnothing}{\rA}
  \proofstep{4}{\exists a\in\bigcap M}{%
    \FormulaRefAuto{B\neq\varnothing\vdash \exists x\in B}{4}}

  \proofstep{6}{a\in\bigcap M}{\rA}
  \proofstep{3,6}{a\in\bigcup M}{%
    \FormulaRefAuto{M\neq\varnothing \dsep a\in\bigcap M
    \vdash a\in\bigcup M}{3,6}}

  \proofstep{8}{X\in \FamAvoiding{M}{a}}{\rA}
  \proofstep{8}{X\in M\land a\notin X}{%
    \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{8}}
  \proofstep{8}{X\in M}{\rAEa{9}}
  \proofstep{8}{a\notin X}{\rAEb{9}}
  \proofstep{3,6,8}{a\in X}{%
    \FormulaRefAuto{M\neq\varnothing \dsep a\in\bigcap M \dsep
    X\in M \vdash a\in X}{3,6,10}}
  \proofstep{3,6,8}{\bot}{\rBI{12,11}}
  \proofstep{3,6}{X\notin \FamAvoiding{M}{a}}{\rCI{8,13}}
  \proofstep{3,6}{\forall X\,X\notin \FamAvoiding{M}{a}}{\rUI{14}}
  \proofstep{3,6}{\FamAvoiding{M}{a}=\varnothing}{%
    \FormulaRefAuto{\forall x\, x\notin A\vdash A=\varnothing}{15}}

  \proofstep{}{\varnothing\colon\varnothing\inj \FamContaining{M}{a}}{%
    \FormulaRefAuto{\varnothing\colon \varnothing\inj M}}
  \proofstep{3,6}{\varnothing\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}{16},17}}
  \proofstep{3,6}{\exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{\rEI{18}}
  \proofstep{3,6}{\mathsf{HalfOcc}(a,M)}{%
    \FormulaRefAuto{\mathsf{HalfOcc}(a,M)\coloneqq
    a\in\bigcup M\land
    \exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{\rAI{7,19}}}
  \proofstep{3,6}{\exists a\,\mathsf{HalfOcc}(a,M)}{\rEI{20}}
  \proofstep{1,2,3,6}{\mathsf{Frankl}(M)}{%
    \FormulaRefAuto{\mathsf{Frankl}(M)\coloneqq \exists a\,\mathsf{HalfOcc}(a,M)}{21}}

  \proofstep{1,2,3,4}{\mathsf{Frankl}(M)}{\rEE{5,6,22}}
\end{tabproof}

\subsection{Ein Beispiel zur fehlenden Wohldefiniertheit}

Die natürliche Vorschrift \(X\mapsto X\cup\{a\}\) scheitert auf
\(\FamAvoiding{M}{a}\) nicht an der Injektivität. Nach der Kürzung einer
frischen Adjunktion ist sie dort injektiv. Der mögliche Fehler ist vielmehr,
dass der Wert nicht wieder in der enthaltenden Teilfamilie liegt. Das zeigt
die folgende endliche vereinigungsabgeschlossene Familie.

\FormulaDefDeltaK[Fränkelsche Vierpunktfamilie]{%
  M_4\coloneqq
  \powerset(\{1,2,3,4\})\setminus
  \{\{1\},\{2\},\{3\},\{4\}\}
}{Fränkelsche Vierpunktfamilie}{%
  \DeltaRow{Mengen}{M_4}
  \DeltaRow{Neue Symbole}{M_4}
}

\FormulaThmDeltaR[Ausgesparte Einermengen auf vier Punkten]{%
  \begin{aligned}[t]
    X\in\powerset(\{1,2,3,4\})\land{}&
    X\notin\{\{1\},\{2\},\{3\},\{4\}\}\\
    \eqvdash{}&
    X\subseteq\{1,2,3,4\}\land{}\\
    &\bigl(X=\varnothing\lor
    \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
  \end{aligned}
}{%
  X\in\powerset(\{1,2,3,4\})\land
  X\notin\{\{1\},\{2\},\{3\},\{4\}\}
  \eqvdash X\subseteq\{1,2,3,4\}\land
  \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
}{%
  \DeltaRow{Mengen}{X\dsep b\dsep c}
}
\FormulaThmDeltaR[Charakterisierung der Fränkelschen Vierpunktfamilie]{%
  \begin{aligned}[t]
    X\in M_4\eqvdash{}&
    X\subseteq\{1,2,3,4\}\land{}\\
    &\bigl(X=\varnothing\lor
  ...
  X\in M_4\eqvdash X\subseteq\{1,2,3,4\}\land
  \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
}{%
  \DeltaRow{Mengen}{X\dsep b\dsep c}
}
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      ...
      &\bigl(X=\varnothing\lor
      \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    \end{aligned}}{\rChain{1,2}}
\end{tabproofwide}

\FormulaThmDelta[Die Vierpunktmenge ist endlich]{%
  \Finite{\{1,2,3,4\}}
}{%
  \DeltaRow{Mengen}{1\dsep2\dsep3\dsep4}
}
\begin{tabproof}
  \proofstep{}{\Finite{\{1,2,3,4\}}}{%
    \text{vierfache Adjunktion aus }
    \FormulaRefAuto{\Finite{\varnothing}}
    \text{ mit }
    \FormulaRefAuto{a\notin A \dsep \Finite{A} \vdash \Finite{A\cup\{a\}}}}
\end{tabproof}

\FormulaThmDelta[Fränkelsche Vierpunktfamilie ist nichtleer]{%
  M_4\neq\varnothing
}{%
  \DeltaRow{Mengen}{M_4}
}
\begin{tabproof}
  \proofstep{}{\varnothing\subseteq\{1,2,3,4\}}{%
    \FormulaRefAuto{\varnothing\subseteq A}}
  \proofstep{}{\varnothing=\varnothing\lor
    \exists b\in\varnothing\,\exists c\in\varnothing\,(b\neq c)}{\rOIa{\rII}}
  \proofstep{}{\varnothing\subseteq\{1,2,3,4\}\land
    \bigl(\varnothing=\varnothing\lor
    \exists b\in\varnothing\,\exists c\in\varnothing\,(b\neq c)\bigr)}{\rAI{1,2}}
  \proofstep{}{\varnothing\in M_4}{%
    \FormulaRefAuto{%
      X\in M_4\eqvdash X\subseteq\{1,2,3,4\}\land
      \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    }{3}}
...
\FormulaThmDelta[Fränkelsche Vierpunktfamilie ist endlich]{%
  \Finite{M_4}
}{%
  \DeltaRow{Mengen}{M_4\dsep X}
}
\begin{tabproof}
  \proofstep{}{\Finite{\{1,2,3,4\}}}{%
    \FormulaRefAuto{\Finite{\{1,2,3,4\}}}}
  \proofstep{}{\Finite{\powerset(\{1,2,3,4\})}}{%
    \FormulaRefAuto{\Finite{A}\vdash \Finite{\powerset(A)}}{1}}

  \proofstep{3}{X\in M_4}{\rA}
  \proofstep{3}{%
    \begin{aligned}[t]
      &X\subseteq\{1,2,3,4\}\land{}\\
      &\bigl(X=\varnothing\lor
  ...
  \proofstep{3}{X\subseteq\{1,2,3,4\}}{\rAEa{4}}
  \proofstep{3}{X\in\powerset(\{1,2,3,4\})}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}{5}}
  \proofstep{}{M_4\subseteq\powerset(\{1,2,3,4\})}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}{\rUI{\rRI{3,6}}}}
  \proofstep{}{\Finite{M_4}}{%
    \FormulaRefAuto{T\subseteq M\dsep \Finite{M} \vdash \Finite{T}}{7,2}}
\end{tabproof}

\FormulaThmDeltaR[Vierpunktbedingung ist vereinigungsstabil]{%
  \begin{aligned}[t]
    &X\subseteq\{1,2,3,4\}\land
    \bigl(X=\varnothing\lor
    \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)\\
    &\dsep
    Y\subseteq\{1,2,3,4\}\land
    \bigl(Y=\varnothing\lor
    \exists b\in Y\,\exists c\in Y\,(b\neq c)\bigr)\\
    &\vdash
    X\cup Y=\varnothing\lor
    \exists b\in X\cup Y\,\exists c\in X\cup Y\,(b\neq c)
  \end{aligned}
}{%
  X\subseteq\{1,2,3,4\}\land
  \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
  \dsep
  Y\subseteq\{1,2,3,4\}\land
  \bigl(Y=\varnothing\lor \exists b\in Y\,\exists c\in Y\,(b\neq c)\bigr)
  \vdash
  X\cup Y=\varnothing\lor
  \exists b\in X\cup Y\,\exists c\in X\cup Y\,(b\neq c)
}{%
  \DeltaRow{Mengen}{X\dsep Y\dsep b\dsep c}
}
\FormulaThmDelta[Fränkelsche Vierpunktfamilie ist vereinigungsabgeschlossen]{%
  \UnionClosedFam(M_4)
}{%
  \DeltaRow{Mengen}{M_4\dsep X\dsep Y\dsep b\dsep c}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{X\in M_4}{\rA}
  \proofstepwidestar[2]{Y\in M_4}{\rA}
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &X\subseteq\{1,2,3,4\}\land{}\\
      &\bigl(X=\varnothing\lor
  ...
  \proofstepwidestar[1]{X\subseteq\{1,2,3,4\}}{\rAEa{3}}
  \proofstepwidestar[2]{Y\subseteq\{1,2,3,4\}}{\rAEa{4}}
  \proofstepwidestar[1,2]{X\cup Y\subseteq\{1,2,3,4\}}{%
    \FormulaRefAuto{A \subseteq C,\, B \subseteq C \vdash A \cup B \subseteq C}{5,6}}
  \proofstepwidestar[1,2]{%
    \begin{aligned}[t]
      &X\cup Y=\varnothing\lor{}\\
      &\exists b\in X\cup Y\,\exists c\in X\cup Y\\
      &\quad(b\neq c)
    \end{aligned}}{%
    \FormulaRefAuto{%
      X\subseteq\{1,2,3,4\}\land
  ...
  \proofstepwidestar[1,2]{X\cup Y\in M_4}{%
    \FormulaRefAuto{%
      X\in M_4\eqvdash X\subseteq\{1,2,3,4\}\land
      \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    }{\rAI{7,8}}}
  \proofstepwidestar[]{\UnionClosedFam(M_4)}{%
    \FormulaRefAuto{\UnionClosedFam(M)}{\rUI{\rRI{1,\rRI{2,9}}}}}
\end{tabproofwide}

\FormulaThmDelta[Ausgesparte Einermenge der Vierpunktfamilie]{%
  \{1\}\notin M_4
}{%
  \DeltaRow{Mengen}{M_4}
}
...
\FormulaThmDelta[Adjunktion der Vierpunktfamilie verfehlt die Zielteilfamilie]{%
  \exists X\in \FamAvoiding{M_4}{1}\,
  \bigl(\tFranklAdj{M_4}{1}(X)\notin \FamContaining{M_4}{1}\bigr)
}{%
  \DeltaRow{Mengen}{M_4\dsep X}
  \DeltaRow{Funktionensymbol}{\tFranklAdj{M_4}{1}}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{M_4}{1}\dsep \FamContaining{M_4}{1}}
}
\begin{tabproof}
  \proofstep{}{\varnothing\in M_4}{%
    \FormulaRefAuto{%
      X\in M_4\eqvdash X\subseteq\{1,2,3,4\}\land
      \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    }{\rAI{\FormulaRefAuto{\varnothing\subseteq A},\rOIa{\rII}}}}
  \proofstep{}{1\notin\varnothing}{\FormulaRefAuto{x \not\in \varnothing}}
  \proofstep{}{\varnothing\in \FamAvoiding{M_4}{1}}{%
    \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{\rAI{1,2}}}
  \proofstep{}{\{1\}\notin M_4}{%
    \FormulaRefAuto{\{1\}\notin M_4}}
  \proofstep{5}{\{1\}\in \FamContaining{M_4}{1}}{\rA}
  \proofstep{5}{\{1\}\in M_4\land 1\in\{1\}}{%
    \FormulaRefAuto{\FamContaining{M}{a}\coloneqq \{X\in M\mid a\in X\}}{5}}
  \proofstep{5}{\{1\}\in M_4}{\rAEa{6}}
  \proofstep{5}{\bot}{\rBI{7,4}}
  \proofstep{}{\{1\}\notin \FamContaining{M_4}{1}}{\rCI{5,8}}
  \proofstep{}{\{1\}=\varnothing\cup\{1\}}{%
    \FormulaRefAuto{A = \varnothing \cup A}}
  \proofstep{}{\varnothing\cup\{1\}=\{1\}}{%
    \FormulaRefAuto{a=b\vdash b=a}{10}}
  \proofstep{}{\varnothing\cup\{1\}\notin \FamContaining{M_4}{1}}{\rIE{11,9}}
  \proofstep{}{\tFranklAdj{M_4}{1}(\varnothing)=\varnothing\cup\{1\}}{%
    \FormulaRefAuto{X\in \FamAvoiding{M}{a}\vdash
    \tFranklAdj{M}{a}(X)\coloneqq X\cup\{a\}}{3}}
  \proofstep{}{\tFranklAdj{M_4}{1}(\varnothing)\notin \FamContaining{M_4}{1}}{\rIE{13,12}}
  \proofstep{}{%
    \exists X\in \FamAvoiding{M_4}{1}\,
    \bigl(\tFranklAdj{M_4}{1}(X)\notin \FamContaining{M_4}{1}\bigr)}{\rEI{\rAI{3,14}}}
\end{tabproof}

\FormulaThmDelta[Endliches Vereinigungsbeispiel mit Zielverfehlung]{%
  \vdash \exists M\,\exists a\,
  \Bigl(M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land
  \exists X\in \FamAvoiding{M}{a}\,
  \bigl(\tFranklAdj{M}{a}(X)\notin \FamContaining{M}{a}\bigr)\Bigr)
}{%
  \DeltaRow{Mengen}{M\dsep M_4\dsep a\dsep X}
  \DeltaRow{Funktionensymbol}{\tFranklAdj{M}{a}}
}
\begin{tabproof}
  \proofstep{}{M_4\neq\varnothing}{%
    \FormulaRefAuto{M_4\neq\varnothing}}
  \proofstep{}{\Finite{M_4}}{%
    \FormulaRefAuto{\Finite{M_4}}}
  \proofstep{}{\UnionClosedFam(M_4)}{%
    \FormulaRefAuto{\UnionClosedFam(M_4)}}
  \proofstep{}{%
    \exists X\in \FamAvoiding{M_4}{1}\,
    \bigl(\tFranklAdj{M_4}{1}(X)\notin \FamContaining{M_4}{1}\bigr)}{%
    \FormulaRefAuto{\exists X\in \FamAvoiding{M_4}{1}\,
    \bigl(\tFranklAdj{M_4}{1}(X)\notin \FamContaining{M_4}{1}\bigr)}}
  \proofstep{}{%
    \begin{aligned}[t]
      &M_4\neq\varnothing\land \Finite{M_4}\land \UnionClosedFam(M_4)\land{}\\
      &\exists X\in \FamAvoiding{M_4}{1}\,
      \bigl(\tFranklAdj{M_4}{1}(X)\notin \FamContaining{M_4}{1}\bigr)
    \end{aligned}}{\rAI{1,\rAI{2,\rAI{3,4}}}}
  \proofstep{}{\exists a\,
    \begin{aligned}[t]
      (&M_4\neq\varnothing\land \Finite{M_4}\land \UnionClosedFam(M_4)\land{}\\
      &\exists X\in \FamAvoiding{M_4}{a}\,
      \bigl(\tFranklAdj{M_4}{a}(X)\notin \FamContaining{M_4}{a}\bigr))
    \end{aligned}}{\rEI{5}}
  \proofstep{}{\exists M\,\exists a\,
    \Bigl(M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land
    \exists X\in \FamAvoiding{M}{a}\,
    \bigl(\tFranklAdj{M}{a}(X)\notin \FamContaining{M}{a}\bigr)\Bigr)}{\rEI{6}}
\end{tabproof}

\subsection{Eine allgemeine korrigierte Adjunktion}

Die Adjunktion \(X\mapsto X\cup\{a\}\) muss nicht auf allen
\(a\)-vermeidenden Mengen einer Familie \(\mathcal I\) wieder in
\(\mathcal I\) landen. Wir trennen daher die guten Stellen der natürlichen
Adjunktion von den defekten Stellen.

\FormulaDefDeltaK[Gute Stellen der Adjunktion]{%
  \AdjGood{\mathcal I}{a}\coloneqq
  \{X\in \FamAvoiding{\mathcal I}{a}\mid X\cup\{a\}\in\mathcal I\}
}{Gute Adjunktionsstellen}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{\mathcal I}{a}}
  \DeltaRow{Neue Symbole}{\AdjGood{\mathcal I}{a}}
}

\FormulaDefDeltaK[Defekte Stellen der Adjunktion]{%
  \AdjDefect{\mathcal I}{a}\coloneqq
  \FamAvoiding{\mathcal I}{a}\setminus \AdjGood{\mathcal I}{a}
}{Defekte Adjunktionsstellen}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{\mathcal I}{a}}
  \DeltaRow{Neue Symbole}{\AdjDefect{\mathcal I}{a}}
}

\FormulaDefDeltaK[Freie Ziele nach der guten Adjunktion]{%
  \AdjFree{\mathcal I}{a}\coloneqq
  \FamContaining{\mathcal I}{a}\setminus
  \{X\cup\{a\}\mid X\in \AdjGood{\mathcal I}{a}\}
}{Freie Adjunktionsziele}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Teilmengenfamilien}{\FamContaining{\mathcal I}{a}}
  \DeltaRow{Neue Symbole}{\AdjFree{\mathcal I}{a}}
}

Ist nun eine Injektion von den defekten Stellen in die noch freien Ziele
gegeben, so ergänzt sie die natürliche Adjunktion zu einer Abbildung auf der
ganzen \(a\)-vermeidenden Teilfamilie.

\FormulaDefDeltaK[Korrigierte Adjunktionsabbildung]{%
  \FranklAdjCorr{\mathcal I}{a}{h}(X)\coloneqq
  \begin{cases}
    X\cup\{a\}, & X\in \AdjGood{\mathcal I}{a},\\
    h_a(X), & X\in \AdjDefect{\mathcal I}{a}.
  \end{cases}
}{Korrigierte Adjunktionsabbildung}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Funktionen}{h_a\dsep \FranklAdjCorr{\mathcal I}{a}{h}}
  \DeltaRow{Teilmengenfamilien}{\AdjGood{\mathcal I}{a}\dsep \AdjDefect{\mathcal I}{a}}
  \DeltaRow{Neue Symbole}{\FranklAdjCorr{\mathcal I}{a}{h}}
}

\FormulaThmDelta[Korrigierte Adjunktionsabbildung ist injektiv]{%
  h_a\colon \AdjDefect{\mathcal I}{a}\inj \AdjFree{\mathcal I}{a}
  \vdash
  \FranklAdjCorr{\mathcal I}{a}{h}\colon
  \FamAvoiding{\mathcal I}{a}\inj \FamContaining{\mathcal I}{a}
}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep Y\dsep a}
  \DeltaRow{Funktionen}{h_a\dsep \FranklAdjCorr{\mathcal I}{a}{h}}
  \DeltaRow{Teilmengenfamilien}{%
    \AdjGood{\mathcal I}{a}\dsep \AdjDefect{\mathcal I}{a}\dsep \AdjFree{\mathcal I}{a}}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{h_a\colon \AdjDefect{\mathcal I}{a}\inj \AdjFree{\mathcal I}{a}}{\rA}
  \proofstepwidestar[]{%
    \FamAvoiding{\mathcal I}{a}=
    \AdjGood{\mathcal I}{a}\cup \AdjDefect{\mathcal I}{a}}{%
    \FormulaRefAuto{\AdjDefect{\mathcal I}{a}\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus \AdjGood{\mathcal I}{a}}}
  \proofstepwidestar[]{%
    \AdjGood{\mathcal I}{a}\cap \AdjDefect{\mathcal I}{a}=\varnothing}{%
    \FormulaRefAuto{\AdjDefect{\mathcal I}{a}\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus \AdjGood{\mathcal I}{a}}}
  \proofstepwidestar[]{%
    \AdjFree{\mathcal I}{a}\cap
    \{X\cup\{a\}\mid X\in \AdjGood{\mathcal I}{a}\}=\varnothing}{%
    \FormulaRefAuto{\AdjFree{\mathcal I}{a}\coloneqq
    \FamContaining{\mathcal I}{a}\setminus
    \{X\cup\{a\}\mid X\in \AdjGood{\mathcal I}{a}\}}}
  \proofstepwidestar[]{%
    \FranklAdjCorr{\mathcal I}{a}{h}\colon
    \FamAvoiding{\mathcal I}{a}\to \FamContaining{\mathcal I}{a}}{%
    \makecell[l]{%
    \FormulaRefAuto{\FranklAdjCorr{\mathcal I}{a}{h}(X)\coloneqq
    \begin{cases}
      X\cup\{a\}, & X\in \AdjGood{\mathcal I}{a},\\
      h_a(X), & X\in \AdjDefect{\mathcal I}{a}.
    \end{cases}}\text{, }\\
    \FormulaRefAuto{\AdjGood{\mathcal I}{a}\coloneqq
    \{X\in \FamAvoiding{\mathcal I}{a}\mid X\cup\{a\}\in\mathcal I\}}
    \text{, }\\
    \FormulaRefAuto{\AdjDefect{\mathcal I}{a}\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus \AdjGood{\mathcal I}{a}}
  ...
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in \AdjGood{\mathcal I}{a}\dsep Y\in \AdjGood{\mathcal I}{a}\\
      &\dsep \FranklAdjCorr{\mathcal I}{a}{h}(X)=\FranklAdjCorr{\mathcal I}{a}{h}(Y)
      \vdash X=Y
    \end{aligned}}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep
    X\cup\{a\}=Y\cup\{a\}\vdash X=Y}}
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &X\in \AdjDefect{\mathcal I}{a}\dsep Y\in \AdjDefect{\mathcal I}{a}\\
      &\dsep \FranklAdjCorr{\mathcal I}{a}{h}(X)=\FranklAdjCorr{\mathcal I}{a}{h}(Y)
      \vdash X=Y
    \end{aligned}}{%
    \FormulaRefAuto{Injektive Funktion}{1}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in \AdjGood{\mathcal I}{a}\dsep Y\in \AdjDefect{\mathcal I}{a}\\
      &\dsep \FranklAdjCorr{\mathcal I}{a}{h}(X)=\FranklAdjCorr{\mathcal I}{a}{h}(Y)
      \vdash X=Y
    \end{aligned}}{%
    \makecell[l]{%
    ...
    \FormulaRefAuto{\AdjFree{\mathcal I}{a}\coloneqq
    \FamContaining{\mathcal I}{a}\setminus
    \{X\cup\{a\}\mid X\in \AdjGood{\mathcal I}{a}\}}\text{, }\\
    \FormulaRefAuto{Injektive Funktion}{1}}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in \AdjDefect{\mathcal I}{a}\dsep Y\in \AdjGood{\mathcal I}{a}\\
      &\dsep \FranklAdjCorr{\mathcal I}{a}{h}(X)=\FranklAdjCorr{\mathcal I}{a}{h}(Y)
      \vdash X=Y
    \end{aligned}}{%
    \makecell[l]{%
  ...
  \proofstepwidestar[1]{%
    \FranklAdjCorr{\mathcal I}{a}{h}\colon
    \FamAvoiding{\mathcal I}{a}\inj \FamContaining{\mathcal I}{a}}{%
    \FormulaRefAuto{Injektive Funktion}{5,2,3,6,7,8,9}}
\end{tabproofwide}

Im Fall einer enthaltenen Einermenge gibt es keine defekten Stellen. Damit
fällt die korrigierte Adjunktionsabbildung auf die ursprüngliche Abbildung
\(X\mapsto X\cup\{a\}\) zurück.

\FormulaThmDelta[Einermengenfall der korrigierten Adjunktion]{%
  \UnionClosedFam(\mathcal I)\dsep \{a\}\in\mathcal I
  \vdash \AdjDefect{\mathcal I}{a}=\varnothing
}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Teilmengenfamilien}{\AdjDefect{\mathcal I}{a}\dsep \AdjGood{\mathcal I}{a}}
}
\begin{tabproof}
  \proofstep{1}{\UnionClosedFam(\mathcal I)}{\rA}
  \proofstep{2}{\{a\}\in\mathcal I}{\rA}
  \proofstep{3}{X\in \AdjDefect{\mathcal I}{a}}{\rA}
  \proofstep{3}{X\in \FamAvoiding{\mathcal I}{a}\land
    X\notin \AdjGood{\mathcal I}{a}}{%
    \FormulaRefAuto{\AdjDefect{\mathcal I}{a}\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus \AdjGood{\mathcal I}{a}}{3}}
  \proofstep{3}{X\in \FamAvoiding{\mathcal I}{a}}{\rAEa{4}}
  \proofstep{3}{X\notin \AdjGood{\mathcal I}{a}}{\rAEb{4}}
  \proofstep{3}{X\in\mathcal I\land a\notin X}{%
    \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{5}}
  \proofstep{3}{X\in\mathcal I}{\rAEa{7}}
  \proofstep{1,2,3}{X\cup\{a\}\in\mathcal I}{%
    \FormulaRefAuto{X \in M \dsep Y \in M \vdash X \cup Y \in M}{8,2}}
  \proofstep{1,2,3}{X\in \AdjGood{\mathcal I}{a}}{%
    \FormulaRefAuto{\AdjGood{\mathcal I}{a}\coloneqq
    \{X\in \FamAvoiding{\mathcal I}{a}\mid X\cup\{a\}\in\mathcal I\}}{5,9}}
  \proofstep{1,2,3}{\bot}{\rBI{10,6}}
  \proofstep{1,2}{X\notin \AdjDefect{\mathcal I}{a}}{\rCI{3,11}}
  \proofstep{1,2}{\forall X\,X\notin \AdjDefect{\mathcal I}{a}}{\rUI{12}}
  \proofstep{1,2}{\AdjDefect{\mathcal I}{a}=\varnothing}{%
    \FormulaRefAuto{\forall x\, x\notin A\vdash A=\varnothing}{13}}
\end{tabproof}
