...
\Finite{M} &\Longrightarrow& D(M) & \mathrm{ZF}\\
D(M) &\Longrightarrow& S(M) & \mathrm{AC}\\
S(M) &\Longrightarrow& D(M) & \mathrm{ZF}\\
S(M) &\Longrightarrow& I(M) & \mathrm{ZF}\\
I(M) &\Longrightarrow& D(M) & \mathrm{ZF}\\
I(M) &\Longrightarrow& Q(M) & \mathrm{AC}\\
Q(M) &\Longrightarrow& I(M) & \mathrm{ZF}\\
D(M) &\Longrightarrow& T(M) & \mathrm{AC}\\
T(M) &\Longrightarrow& \Finite{M} & \mathrm{ZF}.
\end{array}
\]
