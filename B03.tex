...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,4]{G(x)\in R}{%
    \FormulaRefAuto{x\in A\vdash F(x)\in B}{2,4}}

  \proofstepwidestar[1,2,4]{G(x)\in A\times B}{%
    \FormulaRefAuto{A\subseteq B, x\in A\vdash x\in B}{1,5}}

  \proofstepwidestar[3]{\forall u\in A\,\bigl((\pi_1\restriction_R\circ G)(u)=\Id_A(u)\bigr)}{%
    \FormulaRefAuto{\forall x\in A (F(x)=G(x)) \eqvdash F=G}{3}}

  \proofstepwidestar[3,4]{(\pi_1\restriction_R\circ G)(x)=\Id_A(x)}{%
    \rRE{4,\rUE{7}}}

  \proofstepwidestar[4]{(\pi_1\restriction_R\circ G)(x)=\pi_1\restriction_R(G(x))}{%
    \FormulaRefAuto{x\in A \vdash (G\circ F)(x)=G(F(x))}{4}}

  \proofstepwidestar[4]{\Id_A(x)=x}{%
  ...
  \proofstepwidestar[1,2,4]{\pi_1\restriction_R(G(x))=\pi_1(G(x))}{%
    \FormulaRefAuto{C\subseteq A \dsep x\in C \vdash F\restriction_C(x)=F(x)}{1,5}}

  \proofstepwidestar[1,2,3,4]{\pi_1(G(x))=x}{%
    \FormulaRefAuto{a=b, b=c\vdash a=c}{11,12}}

  \proofstepwidestar[1,2,4]{G(x)=\bigl(\pi_1(G(x)),\pi_2(G(x))\bigr)}{%
    \FormulaRefAuto{z\in A\times B \vdash z = \bigl(\pi_1(z),\pi_2(z)\bigr)}{6}}

  \proofstepwidestar[1,2,3,4]{G(x)=\bigl(x,\pi_2(G(x))\bigr)}{%
    \rIE{13,14}}

  \proofstepwidestar[1,2,3,4]{\bigl(x,\pi_2(G(x))\bigr)\in R}{%
    \rIE{15,5}}

  \proofstepwidestar[1,2,3]{\forall x\in A\,\bigl(x,\pi_2(G(x))\bigr)\in R}{%
    \rUI{\rRI{4,16}}}
\end{tabproofwide}
xxx
