...
\begin{tabproof}
  ...
  \proofstep{1,5}{X\in\powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}[thm]{1,6}}
  ...
  \proofstep{1}{B^{\complement_M}\subseteq \powerset(M)}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}[def]{\rUI{\rRI{3,13}}}}
  ...
  \proofstep{16}{M\setminus X\in B^{\complement_M}}{%
    \FormulaRefAuto{TarskiKomplementdualChar}[thm]{\rEI{\rAI{16,\rII}}}}
...
\paragraph{Komplementalgebra}

Die folgenden beiden Sätze sind reine Mengensätze über das relative Komplement
in der Grundmenge \(M\).
...
\begin{tabproof}
  ...
  \proofstep{2}{M\setminus(M\setminus Y)=Y}{%
    \FormulaRefAuto{TarskiRelCompInvolutive}[thm]{2}}
  \proofstep{1}{M\setminus(M\setminus X)=X}{%
    \FormulaRefAuto{TarskiRelCompInvolutive}[thm]{1}}
  \proofstep{1,2,3}{Y=X}{\rIE{4,\rIE{3,5}}}
\end{tabproof}

\paragraph{Dualität von Maxima und Minima}

Die beiden Übersetzungssätze sind spiegelbildlich. Sie werden dennoch beide
ausgeschrieben, damit die späteren Äquivalenzbeweise nur auf benannte
Theoreme verweisen müssen.
...
\begin{tabproof}
  ...
  \proofstep{1,7}{X\in\powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}[thm]{1,8}}
  \proofstep{1,7}{X\subseteq M}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}[thm]{12}}
  \proofstep{1,10}{Y\in\powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}[thm]{1,10}}
  \proofstep{1,10}{Y\subseteq M}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}[thm]{14}}
  \proofstep{10}{M\setminus Y\in B^{\complement_M}}{%
    \FormulaRefAuto{TarskiKomplementdualChar}[thm]{10}}
  \proofstep{1,7,10,11}{M\setminus X\subseteq M\setminus Y}{%
    \FormulaRefAuto{TarskiRelCompAntitone}[thm]{15,13,11}}
  ...
  \proofstep{1,3,7,10,11}{Y=X}{%
    \FormulaRefAuto{TarskiRelCompEqualityCancel}[thm]{13,15,21}}
  \proofstep{1,3,7,10}{Y\subseteq X\rightarrow Y=X}{\rRI{11,22}}
  \proofstep{1,3,7}{%
    \begin{aligned}[t]
      &\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)
    \end{aligned}}{\rUI{\rRI{10,23}}}
  \proofstep{1,3,7}{%
    \begin{aligned}[t]
      &\exists X\in B\,\forall Y\in B\,
        \bigl(Y\subseteq X\rightarrow Y=X\bigr)
    \end{aligned}}{\rEI{\rAI{8,24}}}
  \proofstep{1,3}{%
    \begin{aligned}[t]
      &\exists X\in B\,\forall Y\in B\,
        \bigl(Y\subseteq X\rightarrow Y=X\bigr)
    \end{aligned}}{\rEE{6,7,25}}
  \proofstep{1,2}{%
    \begin{aligned}[t]
      &\exists X\in B\,\forall Y\in B\,
        \bigl(Y\subseteq X\rightarrow Y=X\bigr)
    \end{aligned}}{\rEE{2,3,26}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,7,10,11}{M\setminus Y\subseteq M\setminus X}{%
    \FormulaRefAuto{TarskiRelCompAntitone}[thm]{13,15,11}}
  \proofstep{1,7,10,11}{M\setminus Y\subseteq U}{\rIE{9,17}}
  \proofstep{3,10,11}{M\setminus Y\subseteq U\rightarrow M\setminus Y=U}{\rUE{5}}
  \proofstep{1,3,7,10,11}{M\setminus Y=U}{\rIE{18,19}}
  \proofstep{1,3,7,10,11}{M\setminus Y=M\setminus X}{\rIE{9,20}}
  \proofstep{1,3,7,10,11}{Y=X}{%
    \FormulaRefAuto{TarskiRelCompEqualityCancel}[thm]{13,15,21}}
  \proofstep{1,3,7,10}{X\subseteq Y\rightarrow Y=X}{\rRI{11,22}}
  \proofstep{1,3,7}{%
    \begin{aligned}[t]
