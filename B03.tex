...
\FormulaThmDelta[$\tSuccShift{H}$ im Bildfall]{%
...
\FormulaThmDelta[$\tSuccShift{H}$ auf Folgengliedern]{%
...
\FormulaThmDelta[$\tSuccShift{H}$ im Nicht-Bildfall]{%
...
\FormulaThmDelta[Typisierungsaxiom für $\tSuccShift{H}$]{%
...
\subsubsection{Aufwärtsrelation der Tarski-Konstruktion}

\paragraph{Relationsvorschrift}

\FormulaDefDeltaR[Relationsvorschrift der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\vdash{}\\
    &\tTarskiUpRel{B}\coloneqq
  ...
  \DeltaRow{Mengen}{M\dsep B\dsep x\dsep y}
  \DeltaRow{Funktionensymbol}{\tTarskiUpRel{B}}
}

\FormulaThmDeltaR[Typisierungsaxiom für \(\tTarskiUpRel{B}\)]{%
  B\subseteq \powerset(M)\vdash \tTarskiUpRel{B}\subseteq B\times B
}{%
  B\subseteq \powerset(M)\vdash \tTarskiUpRel{B}\subseteq B\times B
}{%
  \DeltaRow{Mengen}{M\dsep B\dsep x\dsep y}
...
\begin{tabproof}
  ...
  \proofstep{}{%
    \{(x,y)\in B\times B\mid x\subset y\}\subseteq B\times B
  }{\FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}}
  \proofstep{1}{\tTarskiUpRel{B}\subseteq B\times B}{%
    \rIE{\FormulaRefAuto{B\subseteq \powerset(M)\vdash
      \tTarskiUpRel{B}\coloneqq
      \{(x,y)\in B\times B\mid x\subset y\}}{1},2}}
\end{tabproof}

\paragraph{Existenz und Definition}

\FormulaThmDeltaR[Tarski-Aufwärtsrelation als Relation zur Vorschrift]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\vdash{}\\
    &\exists! R\,\bigl(
      R\subseteq B\times B\land R=\tTarskiUpRel{B}\bigr)
  \end{aligned}
}{%
  B\subseteq \powerset(M)\vdash
  \exists! R\,\bigl(
...
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{1}{\tTarskiUpRel{B}\subseteq B\times B}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\vdash \tTarskiUpRel{B}\subseteq B\times B}{1}}
  \proofstep{1}{%
    \exists! R\,\bigl(
      R\subseteq B\times B\land R=\tTarskiUpRel{B}\bigr)
  }{%
    \FormulaRefAuto{A\subseteq C\vdash \exists! R\,\bigl(R\subseteq C\land R=A\bigr)}{2}}
\end{tabproof}

\FormulaDefDeltaR[Definition der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\vdash{}\\
    &\TarskiUpRel{B}\coloneqq
      \iota R\,\bigl(
  ...
  \DeltaRow{Mengen}{M\dsep B}
  \DeltaRow{Relationen}{R\dsep \TarskiUpRel{B}}
  \DeltaRow{Funktionensymbol}{\tTarskiUpRel{B}}
}

\FormulaThmDeltaR[Typisierung der Tarski-Aufwärtsrelation]{%
  B\subseteq \powerset(M)\vdash \TarskiUpRel{B}\subseteq B\times B
}{%
  B\subseteq \powerset(M)\vdash \TarskiUpRel{B}\subseteq B\times B
}{%
  \DeltaRow{Mengen}{M\dsep B}
  \DeltaRow{Relationen}{\TarskiUpRel{B}}
}
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{1}{\TarskiUpRel{B}\subseteq B\times B}{%
    \rAEa{\FormulaRefAuto{B\subseteq \powerset(M)\vdash
      \TarskiUpRel{B}\coloneqq
      \iota R\,\bigl(
        R\subseteq B\times B\land R=\tTarskiUpRel{B}\bigr)}{1}}}
\end{tabproof}

\FormulaThmDeltaR[Auswertung der Tarski-Aufwärtsrelation]{%
  B\subseteq \powerset(M)\vdash \TarskiUpRel{B}=\tTarskiUpRel{B}
}{%
  B\subseteq \powerset(M)\vdash \TarskiUpRel{B}=\tTarskiUpRel{B}
}{%
  \DeltaRow{Mengen}{M\dsep B}
...
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{1}{\TarskiUpRel{B}=\tTarskiUpRel{B}}{%
    \rAEb{\FormulaRefAuto{B\subseteq \powerset(M)\vdash
      \TarskiUpRel{B}\coloneqq
      \iota R\,\bigl(
        R\subseteq B\times B\land R=\tTarskiUpRel{B}\bigr)}{1}}}
\end{tabproof}

\FormulaThmDeltaR[Entfaltung der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\vdash{}\\
    &\TarskiUpRel{B}=
      \{(x,y)\in B\times B\mid x\subset y\}
...
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{1}{\TarskiUpRel{B}=\tTarskiUpRel{B}}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\vdash \TarskiUpRel{B}=\tTarskiUpRel{B}}{1}}
  \proofstep{1}{\tTarskiUpRel{B}=\{(x,y)\in B\times B\mid x\subset y\}}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\vdash
      \tTarskiUpRel{B}\coloneqq
      \{(x,y)\in B\times B\mid x\subset y\}}{1}}
  \proofstep{1}{%
    \TarskiUpRel{B}=
    \{(x,y)\in B\times B\mid x\subset y\}
  }{\FormulaRefAuto{a=b,\, b=c\vdash a=c}{2,3}}
\end{tabproof}

\paragraph{Einführung und Elimination}

\FormulaThmDeltaR[Elimination der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep (x,y)\in \TarskiUpRel{B}\vdash{}\\
    &x\in B\land y\in B\land x\subset y
  \end{aligned}
}{%
  B\subseteq \powerset(M)\dsep (x,y)\in \TarskiUpRel{B}\vdash
  x\in B\land y\in B\land x\subset y
...
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{2}{(x,y)\in \TarskiUpRel{B}}{\rA}
  \proofstep{1,2}{(x,y)\in \{(x,y)\in B\times B\mid x\subset y\}}{%
    \rIE{\FormulaRefAuto{B\subseteq \powerset(M)\vdash
      \TarskiUpRel{B}=
      \{(x,y)\in B\times B\mid x\subset y\}}{1},2}}
  \proofstep{1,2}{(x,y)\in B\times B\land x\subset y}{%
    \FormulaRefAuto{x\in \{u\in A\mid P(u)\}\eqvdash x\in A\land P(x)}{3}}
  \proofstep{1,2}{(x,y)\in B\times B}{\rAEa{4}}
  \proofstep{1,2}{x\subset y}{\rAEb{4}}
  \proofstep{1,2}{x\in B\land y\in B}{%
    \FormulaRefAuto{(a,b)\in A\times B\eqvdash a\in A\land b\in B}{5}}
  \proofstep{1,2}{x\in B}{\rAEa{7}}
  \proofstep{1,2}{y\in B}{\rAEb{7}}
  \proofstep{1,2}{x\in B\land y\in B\land x\subset y}{%
    \FormulaRefAuto{P\dsep Q\dsep R\vdash P\land Q\land R}{8,9,6}}
\end{tabproof}

\FormulaThmDeltaR[Einführung der Tarski-Aufwärtsrelation]{%
  B\subseteq \powerset(M)\dsep x\in B\dsep y\in B\dsep x\subset y
  \vdash (x,y)\in \TarskiUpRel{B}
}{%
  B\subseteq \powerset(M)\dsep x\in B\dsep y\in B\dsep x\subset y
  \vdash (x,y)\in \TarskiUpRel{B}
}{%
...
\begin{tabproof}
  ...
  \proofstep{2,3,4}{(x,y)\in B\times B\land x\subset y}{\rAI{5,4}}
  \proofstep{2,3,4}{(x,y)\in \{(x,y)\in B\times B\mid x\subset y\}}{%
    \FormulaRefAuto{x\in \{u\in A\mid P(u)\}\eqvdash x\in A\land P(x)}{6}}
  \proofstep{1}{\{(x,y)\in B\times B\mid x\subset y\}=\TarskiUpRel{B}}{%
    \FormulaRefAuto{a=b\vdash b=a}{%
      \FormulaRefAuto{B\subseteq \powerset(M)\vdash
        \TarskiUpRel{B}=
        \{(x,y)\in B\times B\mid x\subset y\}}{1}}}
  \proofstep{1,2,3,4}{(x,y)\in \TarskiUpRel{B}}{%
    \rIE{8,7}}
\end{tabproof}

\FormulaThmDeltaR[Totalität der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash{}\\
    &\TotRel{\TarskiUpRel{B},B,B}
  \end{aligned}
}{%
  B\subseteq \powerset(M)\dsep
  \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash
...
\begin{tabproof}
  ...
  \proofstep{1}{\TarskiUpRel{B}\subseteq B\times B}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\vdash \TarskiUpRel{B}\subseteq B\times B}{1}}
  \proofstep{4}{x\in B}{\rA}
  \proofstep{2,4}{\exists y\in B\,\bigl(x\subset y\bigr)}{\rUE{2}}
  \proofstep{6}{y\in B\land x\subset y}{\rA}
  \proofstep{6}{y\in B}{\rAEa{6}}
  \proofstep{6}{x\subset y}{\rAEb{6}}
  \proofstep{1,4,6}{(x,y)\in \TarskiUpRel{B}}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep x\in B\dsep y\in B\dsep x\subset y\vdash (x,y)\in \TarskiUpRel{B}}{1,4,7,8}}
  \proofstep{1,4,6}{\exists y\,\bigl((x,y)\in \TarskiUpRel{B}\bigr)}{\rEI{9}}
  \proofstep{1,2,4}{\exists y\,\bigl((x,y)\in \TarskiUpRel{B}\bigr)}{\rEE{5,6,10}}
  \proofstep{1,2}{x\in B\vdash \exists y\,\bigl((x,y)\in \TarskiUpRel{B}\bigr)}{\rRI{4,11}}
  \proofstep{1,2}{\TotRel{\TarskiUpRel{B},B,B}}{%
    \FormulaRefAuto{Totale Relation}{3,12}}
\end{tabproof}

\FormulaThmDeltaR[Auswahlfunktion der Tarski-Aufwärtsrelation]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash{}\\
    &\exists S\colon B\to B\,
...
\begin{tabproof}
  ...
  \proofstep{2}{\forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{\rA}
  \proofstep{1,2}{\TotRel{\TarskiUpRel{B},B,B}}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash \TotRel{\TarskiUpRel{B},B,B}}{1,2}}
  \proofstep{1,2}{%
    \exists S\colon B\to B\,\forall x\in B\,\bigl((x,S(x))\in \TarskiUpRel{B}\bigr)
  }{%
    \FormulaRefAuto{\exists F\colon A \to B\,\forall x\in A\,\bigl((x,F(x))\in R\bigr)}{3}}
  \proofstep{5}{S\colon B\to B}{\rA}
  \proofstep{6}{\forall x\in B\,\bigl((x,S(x))\in \TarskiUpRel{B}\bigr)}{\rA}
  \proofstep{7}{x\in B}{\rA}
  \proofstep{6,7}{(x,S(x))\in \TarskiUpRel{B}}{\rUE{6}}
  \proofstep{1,6,7}{x\in B\land S(x)\in B\land x\subset S(x)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep (x,y)\in \TarskiUpRel{B}\vdash x\in B\land y\in B\land x\subset y}{1,8}}
  \proofstep{1,6,7}{x\subset S(x)}{\FormulaRefAuto{P\land Q\land R\vdash R}{9}}
  \proofstep{1,6}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rUI{10}}
  \proofstep{1,5,6}{\exists S\colon B\to B\,\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rEI{5,11}}
  \proofstep{1,2}{\exists S\colon B\to B\,\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rEE{4,5,6,12}}
\end{tabproof}

\subsubsection{Zuwachsrelation der Tarski-Rekursionskette}

\FormulaDefDeltaR[Definition der Zuwachsrelation der Tarski-Konstruktion]{%
  \begin{aligned}[t]
    &X\colon \mathbb{N}\to \powerset(M)\vdash{}\\
    &\TarskiDeltaRel{X}{M}\coloneqq
      \{(n,a)\in \mathbb{N}\times M
        \mid a\in X(\Succ(n))\setminus X(n)\}
  \end{aligned}
}{%
  X\colon \mathbb{N}\to \powerset(M)\vdash
  \TarskiDeltaRel{X}{M}\coloneqq
  ...
  \DeltaRow{Mengen}{M\dsep n\dsep a}
  \DeltaRow{Relationen}{\TarskiDeltaRel{X}{M}}
  \DeltaRow{Funktionen}{X}
}

\FormulaThmDeltaR[Typisierung der Zuwachsrelation der Tarski-Konstruktion]{%
  X\colon \mathbb{N}\to \powerset(M)\vdash
  \TarskiDeltaRel{X}{M}\subseteq \mathbb{N}\times M
}{%
  X\colon \mathbb{N}\to \powerset(M)\vdash
  \TarskiDeltaRel{X}{M}\subseteq \mathbb{N}\times M
}{%
...
\begin{tabproof}
  \proofstep{1}{X\colon \mathbb{N}\to \powerset(M)}{\rA}
  \proofstep{}{%
    \{(n,a)\in \mathbb{N}\times M\mid a\in X(\Succ(n))\setminus X(n)\}
    \subseteq \mathbb{N}\times M
  }{\FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}}
  \proofstep{1}{\TarskiDeltaRel{X}{M}\subseteq \mathbb{N}\times M}{%
    \rIE{\FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\vdash
      \TarskiDeltaRel{X}{M}\coloneqq
      \{(n,a)\in \mathbb{N}\times M\mid a\in X(\Succ(n))\setminus X(n)\}}{1},2}}
\end{tabproof}

\FormulaThmDeltaR[Elimination der Zuwachsrelation der Tarski-Konstruktion]{%
  \begin{aligned}[t]
    &X\colon \mathbb{N}\to \powerset(M)\dsep
      (n,a)\in \TarskiDeltaRel{X}{M}\vdash{}\\
    &n\in\mathbb{N}\land a\in M\land
      a\in X(\Succ(n))\setminus X(n)
  \end{aligned}
}{%
  X\colon \mathbb{N}\to \powerset(M)\dsep
  (n,a)\in \TarskiDeltaRel{X}{M}\vdash
...
\begin{tabproof}
  \proofstep{1}{X\colon \mathbb{N}\to \powerset(M)}{\rA}
  \proofstep{2}{(n,a)\in \TarskiDeltaRel{X}{M}}{\rA}
  \proofstep{1,2}{%
    (n,a)\in \{(n,a)\in \mathbb{N}\times M\mid
      a\in X(\Succ(n))\setminus X(n)\}
  }{%
    \rIE{\FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\vdash
      \TarskiDeltaRel{X}{M}\coloneqq
      \{(n,a)\in \mathbb{N}\times M\mid a\in X(\Succ(n))\setminus X(n)\}}{1},2}}
  \proofstep{1,2}{%
    (n,a)\in \mathbb{N}\times M\land
    a\in X(\Succ(n))\setminus X(n)
  }{\FormulaRefAuto{x\in \{u\in A\mid P(u)\}\eqvdash x\in A\land P(x)}{3}}
  \proofstep{1,2}{(n,a)\in \mathbb{N}\times M}{\rAEa{4}}
  \proofstep{1,2}{a\in X(\Succ(n))\setminus X(n)}{\rAEb{4}}
  \proofstep{1,2}{n\in\mathbb{N}\land a\in M}{%
    \FormulaRefAuto{(a,b)\in A\times B\eqvdash a\in A\land b\in B}{5}}
  \proofstep{1,2}{n\in\mathbb{N}}{\rAEa{7}}
  \proofstep{1,2}{a\in M}{\rAEb{7}}
  \proofstep{1,2}{%
    n\in\mathbb{N}\land a\in M\land
    a\in X(\Succ(n))\setminus X(n)
  }{\FormulaRefAuto{P\dsep Q\dsep R\vdash P\land Q\land R}{8,9,6}}
...
\FormulaThmDeltaR[Einführung der Zuwachsrelation der Tarski-Konstruktion]{%
  \begin{aligned}[t]
    &X\colon \mathbb{N}\to \powerset(M)\dsep
      n\in\mathbb{N}\dsep a\in M\dsep
      a\in X(\Succ(n))\setminus X(n)\vdash{}\\
    &(n,a)\in \TarskiDeltaRel{X}{M}
  \end{aligned}
}{%
  X\colon \mathbb{N}\to \powerset(M)\dsep
  n\in\mathbb{N}\dsep a\in M\dsep
...
\begin{tabproof}
  ...
  \proofstep{4}{a\in X(\Succ(n))\setminus X(n)}{\rA}
  \proofstep{2,3}{(n,a)\in \mathbb{N}\times M}{%
    \FormulaRefAuto{a\in A\dsep b\in B\vdash (a,b)\in A\times B}{2,3}}
  \proofstep{2,3,4}{%
    (n,a)\in \mathbb{N}\times M\land
    a\in X(\Succ(n))\setminus X(n)
  ...
  \proofstep{1,2,3,4}{(n,a)\in \TarskiDeltaRel{X}{M}}{%
    \rIE{\FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\vdash
      \TarskiDeltaRel{X}{M}\coloneqq
      \{(n,a)\in \mathbb{N}\times M\mid a\in X(\Succ(n))\setminus X(n)\}}{1},7}}
\end{tabproof}

\subsubsection{Rekursionskette aus einer Tarski-Aufwärtsauswahl}

\FormulaThmDeltaR[Die Tarski-Rekursionskette liegt in der Potenzmenge]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\vdash{}\\
    &\RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)
  \end{aligned}
}{%
  B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\vdash
  \RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)
}{%
  \DeltaRow{Mengen}{M\dsep B\dsep x_0}
  \DeltaRow{Funktionen}{S}
}
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{2}{x_0\in B}{\rA}
  \proofstep{3}{S\colon B\to B}{\rA}
  \proofstep{2,3}{\RecFun{x_0}{S}\colon \mathbb{N}\to B}{%
    \FormulaRefAuto{m_0\in M\dsep f\colon M\to M\vdash \RecFun{m_0}{f}\colon \mathbb{N}\to M}{2,3}}
  \proofstep{1,2,3}{\RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)}{%
    \FormulaRefAuto{F\colon A\to B\dsep B\subseteq C\vdash F\colon A\to C}{4,1}}
\end{tabproof}

\FormulaThmDeltaR[Strikte Nachfolgerstufe der Tarski-Rekursionskette]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash{}\\
    &\RecFun{x_0}{S}(n)\subset
      \RecFun{x_0}{S}(\Succ(n))
  \end{aligned}
}{%
  x_0\in B\dsep S\colon B\to B\dsep
  ...
  \DeltaRow{Mengen}{B\dsep x_0\dsep n}
  \DeltaRow{Funktionen}{S}
}
\begin{tabproof}
  \proofstep{1}{x_0\in B}{\rA}
  \proofstep{2}{S\colon B\to B}{\rA}
  \proofstep{3}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{4}{n\in\mathbb{N}}{\rA}
  \proofstep{1,2,4}{\RecFun{x_0}{S}(n)\in B}{%
    \FormulaRefAuto{m_0\in M\dsep f\colon M\to M\dsep n\in\mathbb{N}\vdash \RecFun{m_0}{f}(n)\in M}{1,2,4}}
  \proofstep{1,2,3,4}{\RecFun{x_0}{S}(n)\subset S(\RecFun{x_0}{S}(n))}{\rUE{3}}
  \proofstep{1,2,4}{%
    \RecFun{x_0}{S}(\Succ(n))=S(\RecFun{x_0}{S}(n))
  }{%
    \FormulaRefAuto{m_0\in M\dsep f\colon M\to M\dsep n\in\mathbb{N}\vdash \RecFun{m_0}{f}(\Succ(n))=f(\RecFun{m_0}{f}(n))}{1,2,4}}
  \proofstep{1,2,3,4}{%
    \RecFun{x_0}{S}(n)\subset
    \RecFun{x_0}{S}(\Succ(n))
  }{\rIE{7,6}}
...
\FormulaThmDeltaR[Abschnittsinduktion der natürlichen Zahlen]{%
  \begin{aligned}[t]
    &p\in\mathbb{N}\dsep q\in\mathbb{N}\dsep p\subseteq q\dsep
      P(p)\dsep
      [r\in\mathbb{N},P(r)]\vdots P(\Succ(r))\vdash{}\\
    &P(q)
  \end{aligned}
}{%
  p\in\mathbb{N}\dsep q\in\mathbb{N}\dsep p\subseteq q\dsep
  P(p)\dsep [r\in\mathbb{N},P(r)]\vdots P(\Succ(r))\vdash P(q)
}{%
  \DeltaRow{Mengen}{p\dsep q\dsep r}
  \DeltaRow{Prädikatensymbole}{P}
}
\begin{tabproof}
  \proofstep{1}{p\in\mathbb{N}}{\rA}
  \proofstep{2}{q\in\mathbb{N}}{\rA}
  \proofstep{3}{p\subseteq q}{\rA}
  \proofstep{4}{P(p)}{\rA}
  \proofstep{5}{[r\in\mathbb{N},P(r)]\vdots P(\Succ(r))}{\rA}
  \proofstep{1,2,3,4,5}{P(q)}{%
    \FormulaRefAuto{P(\varnothing)\dsep [x\in\mathbb{N},P(x)]\vdots P(\Succ(x))\dsep n\in\mathbb{N} \vdash P(n)}{4,5,2}}
\end{tabproof}

\FormulaThmDeltaR[Monotonie der Tarski-Rekursionskette]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
      p\in\mathbb{N}\dsep q\in\mathbb{N}\dsep p\subseteq q\vdash{}\\
    &\RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(q)
  \end{aligned}
}{%
  x_0\in B\dsep S\colon B\to B\dsep
  \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
  ...
  \DeltaRow{Mengen}{B\dsep x_0\dsep p\dsep q\dsep r}
  \DeltaRow{Funktionen}{S}
}
\begin{tabproof}
  \proofstep{1}{x_0\in B}{\rA}
  \proofstep{2}{S\colon B\to B}{\rA}
  \proofstep{3}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{4}{p\in\mathbb{N}}{\rA}
  \proofstep{5}{q\in\mathbb{N}}{\rA}
  \proofstep{6}{p\subseteq q}{\rA}
  \proofstep{1,2,3,4}{%
    \RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(p)
  }{\FormulaRefAuto{A\subseteq A}}
  \proofstep{1,2,3,4,5}{%
    r\in\mathbb{N}\dsep
    \RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(r)
    \vdash
    \RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(\Succ(r))
  }{%
    \FormulaRefAuto{A\subseteq B\dsep B\subset C\vdash A\subseteq C}{
      IV,\FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash \RecFun{x_0}{S}(n)\subset \RecFun{x_0}{S}(\Succ(n))}{1,2,3,r}}}
  \proofstep{1,2,3,4,5,6}{%
    \RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(q)
  }{%
    \FormulaRefAuto{p\in\mathbb{N}\dsep q\in\mathbb{N}\dsep p\subseteq q\dsep
    P(p)\dsep [r\in\mathbb{N},P(r)]\vdots P(\Succ(r))\vdash P(q)}{4,5,6,7,8}}
\end{tabproof}

\FormulaThmDeltaR[Echte Erweiterung hat nichtleere Differenz]{%
  A\subset B\vdash B\setminus A\neq\varnothing
}{%
  A\subset B\vdash B\setminus A\neq\varnothing
}{%
  \DeltaRow{Mengen}{A\dsep B\dsep x}
...
\begin{tabproof}
  ...
  \proofstep{4}{B\setminus A=\varnothing}{\rA}
  \proofstep{1,4}{B\subseteq A}{%
    \FormulaRefAuto{A\subseteq B\dsep B\setminus A=\varnothing\vdash B\subseteq A}{2,4}}
  \proofstep{1,4}{A=B}{\FormulaRefAuto{A\subseteq B\dsep B\subseteq A\vdash A=B}{2,5}}
  \proofstep{1,4}{\bot}{\rBI{3,6}}
  \proofstep{1}{B\setminus A\neq\varnothing}{\rCI{4,7}}
\end{tabproof}

\FormulaThmDeltaR[Zuwachsstufen der Tarski-Rekursionskette sind nichtleer]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash{}\\
    &\RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\neq\varnothing
  \end{aligned}
}{%
  x_0\in B\dsep S\colon B\to B\dsep
  \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash
...
\begin{tabproof}
  ...
  \proofstep{4}{n\in\mathbb{N}}{\rA}
  \proofstep{1,2,3,4}{%
    \RecFun{x_0}{S}(n)\subset \RecFun{x_0}{S}(\Succ(n))
  }{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash \RecFun{x_0}{S}(n)\subset \RecFun{x_0}{S}(\Succ(n))}{1,2,3,4}}
  \proofstep{1,2,3,4}{%
    \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\neq\varnothing
  }{\FormulaRefAuto{A\subset B\vdash B\setminus A\neq\varnothing}{5}}
\end{tabproof}

\FormulaThmDeltaR[Totalität der Zuwachsrelation der Tarski-Rekursionskette]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash{}\\
    &\TotRel{\TarskiDeltaRel{\RecFun{x_0}{S}}{M},\mathbb{N},M}
  \end{aligned}
}{%
  B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep
  \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash
  ...
  \DeltaRow{Mengen}{M\dsep B\dsep x_0\dsep n\dsep a}
  \DeltaRow{Relationen}{\TarskiDeltaRel{\RecFun{x_0}{S}}{M}}
  \DeltaRow{Funktionen}{S}
}
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{2}{x_0\in B}{\rA}
  \proofstep{3}{S\colon B\to B}{\rA}
  \proofstep{4}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{1,2,3}{\RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\vdash \RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)}{1,2,3}}
  \proofstep{1,2,3}{\TarskiDeltaRel{\RecFun{x_0}{S}}{M}\subseteq \mathbb{N}\times M}{%
    \FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\vdash \TarskiDeltaRel{X}{M}\subseteq \mathbb{N}\times M}{5}}
  \proofstep{7}{n\in\mathbb{N}}{\rA}
  \proofstep{2,3,4,7}{%
    \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\neq\varnothing
  }{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep n\in\mathbb{N}\vdash \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\neq\varnothing}{2,3,4,7}}
  \proofstep{5,7}{\RecFun{x_0}{S}(\Succ(n))\in \powerset(M)}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{5,\FormulaRefAuto{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}{7}}}
  \proofstep{5,7}{\RecFun{x_0}{S}(\Succ(n))\subseteq M}{%
    \FormulaRefAuto{x \in \powerset(A)\eqvdash x \subseteq A}{9}}
  \proofstep{5,7}{%
    \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)
    \subseteq \RecFun{x_0}{S}(\Succ(n))
  }{\FormulaRefAuto{A\setminus B\subseteq A}}
  \proofstep{5,7}{%
    \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\subseteq M
  }{\FormulaRefAuto{A\subseteq B\dsep B\subseteq C \vdash A\subseteq C}{11,10}}
  \proofstep{1,2,3,4,5,7}{%
    \exists a\in M\,\bigl(a\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
  }{%
    \FormulaRefAuto{A\subseteq M\dsep A\neq\varnothing\vdash \exists a\in M\,a\in A}{12,8}}
  \proofstep{14}{a\in M\land a\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)}{\rA}
  \proofstep{14}{a\in M}{\rAEa{14}}
  \proofstep{14}{a\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)}{\rAEb{14}}
  \proofstep{1,5,7,14}{(n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}}{%
    \FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\dsep n\in\mathbb{N}\dsep a\in M\dsep a\in X(\Succ(n))\setminus X(n)\vdash (n,a)\in \TarskiDeltaRel{X}{M}}{5,7,15,16}}
  \proofstep{1,5,7,14}{\exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rEI{17}}
  \proofstep{1,2,3,4,5,7}{\exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rEE{13,14,18}}
  \proofstep{1,2,3,4,5}{n\in\mathbb{N}\vdash \exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rRI{7,19}}
  \proofstep{1,2,3,4}{\TotRel{\TarskiDeltaRel{\RecFun{x_0}{S}}{M},\mathbb{N},M}}{%
    \FormulaRefAuto{Totale Relation}{6,20}}
\end{tabproof}

\FormulaThmDeltaR[Auswahl der Zuwächse der Tarski-Rekursionskette]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash{}\\
    &\exists H\colon \mathbb{N}\to M\,
      \forall n\in\mathbb{N}\,
      \bigl(H(n)\in
        \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
  \end{aligned}
}{%
  B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep
  \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash
  \exists H\colon \mathbb{N}\to M\,\forall n\in\mathbb{N}\,
  \bigl(H(n)\in
    \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
}{%
  \DeltaRow{Mengen}{M\dsep B\dsep x_0\dsep n}
  \DeltaRow{Relationen}{\TarskiDeltaRel{\RecFun{x_0}{S}}{M}}
  \DeltaRow{Funktionen}{S\dsep H}
}
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{2}{x_0\in B}{\rA}
  ...
  \proofstep{4}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{1,2,3,4}{\TotRel{\TarskiDeltaRel{\RecFun{x_0}{S}}{M},\mathbb{N},M}}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash \TotRel{\TarskiDeltaRel{\RecFun{x_0}{S}}{M},\mathbb{N},M}}{1,2,3,4}}
  \proofstep{1,2,3,4}{%
    \exists H\colon \mathbb{N}\to M\,
    \forall n\in\mathbb{N}\,\bigl((n,H(n))\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)
  }{%
    \FormulaRefAuto{\exists F\colon A \to B\,\forall x\in A\,\bigl((x,F(x))\in R\bigr)}{5}}
  \proofstep{7}{H\colon \mathbb{N}\to M}{\rA}
  \proofstep{8}{\forall n\in\mathbb{N}\,\bigl((n,H(n))\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rA}
  \proofstep{9}{n\in\mathbb{N}}{\rA}
  \proofstep{8,9}{(n,H(n))\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}}{\rUE{8}}
  \proofstep{1,2,3,8,9}{%
    n\in\mathbb{N}\land H(n)\in M\land
    H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)
  }{%
    \FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\dsep (n,a)\in \TarskiDeltaRel{X}{M}\vdash n\in\mathbb{N}\land a\in M\land a\in X(\Succ(n))\setminus X(n)}{
      \FormulaRefAuto{B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\vdash \RecFun{x_0}{S}\colon \mathbb{N}\to \powerset(M)}{1,2,3},10}}
  \proofstep{1,2,3,8,9}{%
    H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)
  }{\FormulaRefAuto{P\land Q\land R\vdash R}{11}}
  \proofstep{1,2,3,8}{%
    \forall n\in\mathbb{N}\,\bigl(
      H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
  }{\rUI{12}}
  \proofstep{1,2,3,7,8}{%
    \exists H\colon \mathbb{N}\to M\,\forall n\in\mathbb{N}\,
    \bigl(H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
  }{\rEI{7,13}}
  \proofstep{1,2,3,4}{%
    \exists H\colon \mathbb{N}\to M\,\forall n\in\mathbb{N}\,
    \bigl(H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
...
\FormulaThmDeltaR[Frühere Zuwächse liegen in späteren Stufen]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
      H\colon \mathbb{N}\to M\dsep
      \forall k\in\mathbb{N}\,
      \bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)
      \dsep m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash{}\\
    &H(m)\in \RecFun{x_0}{S}(n)
  \end{aligned}
}{%
  x_0\in B\dsep S\colon B\to B\dsep
  \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
  H\colon \mathbb{N}\to M\dsep
  \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)
  \dsep m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash
  H(m)\in \RecFun{x_0}{S}(n)
}{%
  \DeltaRow{Mengen}{M\dsep B\dsep x_0\dsep k\dsep m\dsep n}
  \DeltaRow{Funktionen}{S\dsep H}
}
\begin{tabproof}
  \proofstep{1}{x_0\in B}{\rA}
  \proofstep{2}{S\colon B\to B}{\rA}
  \proofstep{3}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{4}{H\colon \mathbb{N}\to M}{\rA}
  \proofstep{5}{\forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)}{\rA}
  \proofstep{6}{m\in\mathbb{N}}{\rA}
  \proofstep{7}{n\in\mathbb{N}}{\rA}
  \proofstep{8}{m\in n}{\rA}
  \proofstep{5,6}{H(m)\in \RecFun{x_0}{S}(\Succ(m))\setminus \RecFun{x_0}{S}(m)}{\rUE{5}}
  \proofstep{5,6}{H(m)\in \RecFun{x_0}{S}(\Succ(m))}{%
    \FormulaRefAuto{x\in A\setminus B\vdash x\in A}{9}}
  \proofstep{6,7,8}{\Succ(m)\subseteq n}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash \Succ(m)\subseteq n}{6,7,8}}
  \proofstep{1,2,3,6,7,8}{%
    \RecFun{x_0}{S}(\Succ(m))\subseteq \RecFun{x_0}{S}(n)
  }{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep p\in\mathbb{N}\dsep q\in\mathbb{N}\dsep p\subseteq q\vdash \RecFun{x_0}{S}(p)\subseteq \RecFun{x_0}{S}(q)}{
      1,2,3,\FormulaRefAuto{m\in\mathbb{N}\vdash \Succ(m)\in\mathbb{N}}{6},7,11}}
  \proofstep{1,2,3,5,6,7,8}{H(m)\in \RecFun{x_0}{S}(n)}{%
    \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}{12,10}}
\end{tabproof}

\FormulaThmDeltaR[Späterer Zuwachs liegt nicht in seiner Ausgangsstufe]{%
  \begin{aligned}[t]
    &H\colon \mathbb{N}\to M\dsep
      \forall k\in\mathbb{N}\,
      \bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)
      \dsep n\in\mathbb{N}\vdash{}\\
    &H(n)\notin \RecFun{x_0}{S}(n)
  \end{aligned}
}{%
  H\colon \mathbb{N}\to M\dsep
  ...
  \DeltaRow{Mengen}{M\dsep B\dsep x_0\dsep k\dsep n}
  \DeltaRow{Funktionen}{S\dsep H}
}
\begin{tabproof}
  \proofstep{1}{H\colon \mathbb{N}\to M}{\rA}
  \proofstep{2}{\forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)}{\rA}
  \proofstep{3}{n\in\mathbb{N}}{\rA}
  \proofstep{2,3}{H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)}{\rUE{2}}
  \proofstep{2,3}{H(n)\notin \RecFun{x_0}{S}(n)}{%
    \FormulaRefAuto{x\in A\setminus B\vdash x\notin B}{4}}
\end{tabproof}

\FormulaThmDeltaR[Ausgewählte Zuwächse verschiedener Stufen sind verschieden]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
      H\colon \mathbb{N}\to M\dsep
...
\begin{tabproof}
  ...
  \proofstep{7}{n\in\mathbb{N}}{\rA}
  \proofstep{8}{m\in n}{\rA}
  \proofstep{1,2,3,4,5,6,7,8}{H(m)\in \RecFun{x_0}{S}(n)}{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep H\colon \mathbb{N}\to M\dsep \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\dsep m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash H(m)\in \RecFun{x_0}{S}(n)}{1,2,3,4,5,6,7,8}}
  \proofstep{4,5,7}{H(n)\notin \RecFun{x_0}{S}(n)}{%
    \FormulaRefAuto{H\colon \mathbb{N}\to M\dsep \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\dsep n\in\mathbb{N}\vdash H(n)\notin \RecFun{x_0}{S}(n)}{4,5,7}}
  \proofstep{11}{H(m)=H(n)}{\rA}
  \proofstep{1,2,3,4,5,6,7,8,11}{H(n)\in \RecFun{x_0}{S}(n)}{\rIE{11,9}}
  \proofstep{1,2,3,4,5,6,7,8,11}{\bot}{\rBI{12,10}}
  \proofstep{1,2,3,4,5,6,7,8}{H(m)\neq H(n)}{\rCI{11,13}}
\end{tabproof}

\FormulaThmDeltaR[Die ausgewählten Zuwächse bilden eine Injektion]{%
  \begin{aligned}[t]
    &x_0\in B\dsep S\colon B\to B\dsep
      \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep
      H\colon \mathbb{N}\to M\dsep
      \forall k\in\mathbb{N}\,
      \bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\vdash{}\\
...
\begin{tabproof}
  ...
  \proofstep{6}{m\in\mathbb{N}}{\rA}
  \proofstep{7}{n\in\mathbb{N}}{\rA}
  \proofstep{8}{H(m)=H(n)}{\rA}
  \proofstep{6,7}{m\in n\lor n\in m\lor m=n}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m\in n\lor n\in m\lor m=n}{6,7}}
  \proofstep{10}{m\in n}{\rA}
  \proofstep{1,2,3,4,5,6,7,10}{H(m)\neq H(n)}{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep H\colon \mathbb{N}\to M\dsep \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\dsep m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash H(m)\neq H(n)}{1,2,3,4,5,6,7,10}}
  \proofstep{1,2,3,4,5,6,7,8,10}{m=n}{%
    \FormulaRefAuto{P\dsep \neg P\vdash Q}{8,11}}
  \proofstep{13}{n\in m}{\rA}
  \proofstep{1,2,3,4,5,6,7,13}{H(n)\neq H(m)}{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep H\colon \mathbb{N}\to M\dsep \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\dsep m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep m\in n\vdash H(m)\neq H(n)}{1,2,3,4,5,7,6,13}}
  \proofstep{8}{H(n)=H(m)}{\FormulaRefAuto{a=b\vdash b=a}{8}}
  \proofstep{1,2,3,4,5,6,7,8,13}{m=n}{%
    \FormulaRefAuto{P\dsep \neg P\vdash Q}{15,14}}
  \proofstep{17}{m=n}{\rA}
  \proofstep{1,2,3,4,5,6,7,8}{m=n}{%
    \FormulaRefAuto{P_1\lor P_2\lor P_3\dsep [P_1]\vdots R\dsep [P_2]\vdots R\dsep [P_3]\vdots R\vdash R}{9,10,12,13,16,17,17}}
  \proofstep{1,2,3,4,5}{%
    m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep H(m)=H(n)\vdash m=n
  }{\rRI{6,7,8,18}}
  \proofstep{1,2,3,4,5}{H\colon \mathbb{N}\inj M}{%
    \FormulaRefAuto{Injektive Funktion}{4,19}}
\end{tabproof}

\subsubsection{Scheitern der Tarski-Endlichkeit liefert eine Injektion}

\FormulaThmDeltaR[Scheitern des Maximalitätsaxioms liefert eine strikte Aufwärtsfamilie]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep
      \neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)\vdash{}\\
...
\begin{tabproof}
  ...
  \proofstep{4}{x\in B}{\rA}
  \proofstep{3,4}{\neg\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{%
    \FormulaRefAuto{\neg\exists x\in B\,P(x)\dsep x\in B\vdash \neg P(x)}{3,4}}
  \proofstep{3,4}{\exists y\in B\,\neg\bigl(x\subseteq y\rightarrow y=x\bigr)}{%
    \FormulaRefAuto{\neg\forall x\in A\,(P(x)) \eqvdash \exists x\in A\,(\neg P(x))}{5}}
  \proofstep{7}{y\in B\land \neg\bigl(x\subseteq y\rightarrow y=x\bigr)}{\rA}
  \proofstep{7}{y\in B}{\rAEa{7}}
  \proofstep{7}{\neg\bigl(x\subseteq y\rightarrow y=x\bigr)}{\rAEb{7}}
  \proofstep{7}{x\subseteq y\land y\neq x}{%
    \FormulaRefAuto{\neg(P \rightarrow Q) \eqvdash P \land \neg Q}{9}}
  \proofstep{7}{x\subseteq y}{\rAEa{10}}
  \proofstep{7}{y\neq x}{\rAEb{10}}
  \proofstep{7}{x\neq y}{\FormulaRefAuto{x\neq y\vdash y\neq x}{12}}
  \proofstep{7}{x\subset y}{%
    \FormulaRefAuto{A\subset B\coloneq A\subseteq B\land A\neq B}{\rAI{11,13}}}
  \proofstep{4,7}{\exists y\in B\,\bigl(x\subset y\bigr)}{\rEI{\rAI{8,14}}}
  \proofstep{3,4}{\exists y\in B\,\bigl(x\subset y\bigr)}{\rEE{6,7,15}}
  \proofstep{1,2,3}{\forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{\rUI{16}}
\end{tabproof}

\FormulaThmDeltaR[Scheitern des Maximalitätsaxioms liefert eine Einbettung \(\mathbb{N}\to M\)]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash{}\\
  ...
  \DeltaRow{Mengen}{M\dsep B\dsep x_0\dsep n}
  \DeltaRow{Relationen}{\TarskiUpRel{B}\dsep \TarskiDeltaRel{\RecFun{x_0}{S}}{M}}
  \DeltaRow{Funktionen}{S\dsep H}
}
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  ...
  \proofstep{2}{\exists x_0\in B}{\FormulaRefAuto{B\neq\varnothing\vdash \exists x\in B}{2}}
  \proofstep{6}{x_0\in B}{\rA}
  \proofstep{7}{S\colon B\to B}{\rA}
  \proofstep{8}{\forall x\in B\,\bigl(x\subset S(x)\bigr)}{\rA}
  \proofstep{1,6,7,8}{%
    \exists H\colon \mathbb{N}\to M\,\forall n\in\mathbb{N}\,
    \bigl(H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)
  }{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\vdash \exists H\colon \mathbb{N}\to M\,\forall n\in\mathbb{N}\,\bigl(H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)}{1,6,7,8}}
  \proofstep{10}{H\colon \mathbb{N}\to M}{\rA}
  \proofstep{11}{\forall n\in\mathbb{N}\,\bigl(H(n)\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)\bigr)}{\rA}
  \proofstep{6,7,8,10,11}{H\colon \mathbb{N}\inj M}{%
    \FormulaRefAuto{x_0\in B\dsep S\colon B\to B\dsep \forall x\in B\,\bigl(x\subset S(x)\bigr)\dsep H\colon \mathbb{N}\to M\dsep \forall k\in\mathbb{N}\,\bigl(H(k)\in \RecFun{x_0}{S}(\Succ(k))\setminus \RecFun{x_0}{S}(k)\bigr)\vdash H\colon \mathbb{N}\inj M}{6,7,8,10,11}}
  \proofstep{6,7,8,10,11}{\exists H\colon \mathbb{N}\inj M}{\rEI{12}}
  \proofstep{1,6,7,8}{\exists H\colon \mathbb{N}\inj M}{\rEE{9,10,11,13}}
  \proofstep{1,3,6}{\exists H\colon \mathbb{N}\inj M}{\rEE{4,7,8,14}}
  \proofstep{1,2,3}{\exists H\colon \mathbb{N}\inj M}{\rEE{5,6,15}}
\end{tabproof}

\FormulaThmDeltaR[Negation der Tarski-Endlichkeit liefert eine strikte Aufwärtsfamilie]{%
  \begin{aligned}[t]
    &\neg\TarskiFinite(M)\vdash{}\\
    &\exists B\,\Bigl(
      B\subseteq \powerset(M)\land B\neq\varnothing\land
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\Bigr)
  \end{aligned}
}{%
  \neg\TarskiFinite(M)\vdash
  \exists B\,\Bigl(
...
\begin{tabproof}
  \proofstep{1}{\neg\TarskiFinite(M)}{\rA}
  \proofstep{1}{%
    \exists B\,\Bigl(
      B\subseteq \powerset(M)\land B\neq\varnothing\land
      \neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)\Bigr)
  }{%
    \FormulaRefAuto{Tarski-endliche Menge}{1}}
  \proofstep{3}{%
    B\subseteq \powerset(M)\land B\neq\varnothing\land
    \neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)
  }{\rA}
  \proofstep{3}{B\subseteq \powerset(M)}{\FormulaRefAuto{P\land Q\land R\vdash P}{3}}
  \proofstep{3}{B\neq\varnothing}{\FormulaRefAuto{P\land Q\land R\vdash Q}{3}}
  \proofstep{3}{\neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{%
    \FormulaRefAuto{P\land Q\land R\vdash R}{3}}
  \proofstep{3}{\forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep \neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)\vdash \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{4,5,6}}
  \proofstep{3}{%
    B\subseteq \powerset(M)\land B\neq\varnothing\land
    \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)
  }{\FormulaRefAuto{P\dsep Q\dsep R\vdash P\land Q\land R}{4,5,7}}
  \proofstep{3}{%
    \exists B\,\Bigl(
      B\subseteq \powerset(M)\land B\neq\varnothing\land
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\Bigr)
...
\FormulaThmDeltaR[Nicht-Tarski-Endlichkeit liefert eine injektive Abbildung der natürlichen Zahlen]{%
  \neg\TarskiFinite(M)\vdash \exists H\colon \mathbb{N}\inj M
}{%
  \neg\TarskiFinite(M)\vdash \exists H\colon \mathbb{N}\inj M
}{%
  \DeltaRow{Mengen}{M\dsep B\dsep x\dsep y}
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{\neg\TarskiFinite(M)\vdash
      \exists B\,\bigl(B\subseteq \powerset(M)\land B\neq\varnothing\land
      \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\bigr)}{1}}
  \proofstep{3}{%
    B\subseteq \powerset(M)\land B\neq\varnothing\land
    \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)
  }{\rA}
  \proofstep{3}{B\subseteq \powerset(M)}{\FormulaRefAuto{P\land Q\land R\vdash P}{3}}
  \proofstep{3}{B\neq\varnothing}{\FormulaRefAuto{P\land Q\land R\vdash Q}{3}}
  \proofstep{3}{\forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{\FormulaRefAuto{P\land Q\land R\vdash R}{3}}
  \proofstep{3}{\exists H\colon \mathbb{N}\inj M}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash \exists H\colon \mathbb{N}\inj M}{4,5,6}}
  \proofstep{1}{\exists H\colon \mathbb{N}\inj M}{\rEE{2,3,7}}
\end{tabproof}

\subsubsection{Endlichkeit impliziert Tarski-Endlichkeit}

\FormulaThmDeltaR[Endliche Mengen erfüllen das Tarskische Maximalitätsaxiom]{%
  \begin{aligned}[t]
    &\Finite{M}\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing\vdash{}\\
    &\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)
  \end{aligned}
}{%
  \Finite{M}\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing\vdash
  ...
  \DeltaRow{Mengen}{M\dsep B\dsep x\dsep y\dsep n}
  \DeltaRow{Funktionen}{H}
}
\begin{tabproof}
  \proofstep{1}{\Finite{M}}{\rA}
  ...
  \proofstep{3}{B\neq\varnothing}{\rA}
  \proofstep{4}{\neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{\rA}
  \proofstep{2,3,4}{\forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep \neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)\vdash \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)}{2,3,4}}
  \proofstep{2,3,4}{\exists H\colon \mathbb{N}\inj M}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep B\neq\varnothing\dsep \forall x\in B\,\exists y\in B\,\bigl(x\subset y\bigr)\vdash \exists H\colon \mathbb{N}\inj M}{2,3,5}}
  \proofstep{1}{\exists n\in\mathbb{N}\,\bigl(n\EqCard M\bigr)}{%
    \FormulaRefAuto{\Finite{M}\coloneqq \exists n\in\mathbb{N}\,\bigl(n\EqCard M\bigr)}{1}}
  \proofstep{8}{n\in\mathbb{N}\land n\EqCard M}{\rA}
  \proofstep{8}{n\in\mathbb{N}}{\rAEa{8}}
  \proofstep{8}{n\EqCard M}{\rAEb{8}}
  \proofstep{8}{\neg\exists H\colon \mathbb{N}\inj M}{%
    \FormulaRefAuto{n\in\mathbb{N}\dsep n \EqCard M\vdash \neg\exists F\colon \mathbb{N}\inj M}{9,10}}
  \proofstep{2,3,4,8}{\bot}{\rBI{6,11}}
  \proofstep{1,2,3,4}{\bot}{\rEE{7,8,12}}
  \proofstep{1,2,3}{\neg\neg\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{\rCI{4,13}}
  \proofstep{1,2,3}{\exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{%
    \FormulaRefAuto{rDN}{14}}
\end{tabproof}

\FormulaThmDelta[Endlichkeit impliziert Tarski-Endlichkeit]{%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{\Finite{M}\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing\vdash \exists x\in B\,\forall y\in B\,\bigl(x\subseteq y\rightarrow y=x\bigr)}{1}}
  \proofstep{1}{\TarskiFinite(M)}{%
    \FormulaRefAuto{Tarski-endliche Menge}{2}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{2,3,13}{\exists x\in n\,(\iota_{m,n}\circ F)(x)=m}{%
    \FormulaRefAuto{Surjektivität}{15,3}}
