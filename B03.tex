...
\FormulaThmDeltaR[Bild-Bild-Injektivität]{%
  \begin{aligned}[t]
...
\begin{tabproof}
  ...
  \proofstep{1,2,3,4}{\Succ(n)=\Succ(k)}{%
    \FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{9,10,8}}
  \proofstep{1,2,3,4}{n=k}{%
    \FormulaRefAuto{%
      x\in\mathbb{N}\dsep y\in\mathbb{N}\dsep \Succ(x)=\Succ(y)\vdash x=y}{2,3,11}}
  \proofstep{1,2,3,4}{H(n)=H(k)}{\rIE{12,\rII}}
\end{tabproof}
