...
\text{\small Symbollegende}
\\[-.1ex]
\boxed{\FinSubsets{M}\coloneq \{F\in\powerset(M)\mid \Finite{F}\}}
\quad
...
\TarskiFinite(M)
\\[.4ex]
\FinSubsets{M}\subseteq \powerset(M),
\qquad
\FinSubsets{M}\neq\varnothing
\\[-.2ex]
\sketchref{\FinSubsets{M}\subseteq \powerset(M)}
\qquad
\sketchref{\FinSubsets{M}\neq\varnothing}
\\[.4ex]
\Downarrow
\\[-.2ex]
\exists F\in\FinSubsets{M}\,
  \forall G\in\FinSubsets{M}\,
  \bigl(F\subseteq G\rightarrow G=F\bigr)
\\[-.2ex]
\sketchref{\TarskiFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
...
F=M
\\[-.2ex]
\sketchref{F\in\FinSubsets{M}\dsep
\forall G\in\FinSubsets{M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)\vdash F=M}
\\[.4ex]
\Downarrow
\\[-.2ex]
\boxed{\Finite{M}}
\end{array}}
\\[1.1ex]
\text{\small Widerspruchsschritt}
\\[-.1ex]
\boxed{\begin{array}{@{}c@{}}
F\neq M
\quad\Longrightarrow\quad
\exists x\in M\setminus F
\\[.4ex]
x\in M\setminus F
\quad\Longrightarrow\quad
F\cup\{x\}\in\FinSubsets{M}
\ \land\
F\subset F\cup\{x\}
\\[-.2ex]
\sketchref{F\in\FinSubsets{M}\dsep x\in M\setminus F
...
\FormulaThmDelta[Endliche Teilmengen bilden eine Potenzmengenfamilie]{%
  \FinSubsets{M}\subseteq \powerset(M)
}{%
  \DeltaDecl{Mengen}{M\dsep F}%
}
...
\FormulaThmDelta[Die Familie der endlichen Teilmengen ist nichtleer]{%
  \FinSubsets{M}\neq\varnothing
}{%
  \DeltaDecl{Mengen}{M}%
}
\begin{tabproof}
  ...
  \proofstep{}{\varnothing\in\FinSubsets{M}}{%
    \FormulaRefAuto{F\in\FinSubsets{M}\eqvdash F\subseteq M\land \Finite{F}}{\rAI{1,2}}}
  \proofstep{}{\FinSubsets{M}\neq\varnothing}{%
    \FormulaRefAuto{a \in A \vdash A \neq \varnothing}{3}}
\end{tabproof}

\FormulaThmDelta[Adjunktion eines frischen Elements ist echt]{%
  a\notin A \vdash A\subset A\cup\{a\}
}{%
  \DeltaDecl{Mengen}{A\dsep a}%
}
\begin{tabproof}
  \proofstep{1}{a\notin A}{\rA}
  \proofstep{}{A\subseteq A\cup\{a\}}{\FormulaRefAuto{A\subseteq A\cup B}}
  \proofstep{}{a\in\{a\}}{\FormulaRefAuto{a\in\{a\}}}
  \proofstep{}{a\in A\cup\{a\}}{%
    \FormulaRefAuto{z \in B \vdash z \in A \cup B}{3}}
  \proofstep{1}{A\cup\{a\}\neq A}{%
    \FormulaRefAuto{x \in A,\, x \not\in B \vdash A \neq B}{4,1}}
  \proofstep{1}{A\neq A\cup\{a\}}{\FormulaRefAuto{a \neq b \vdash b \neq a}{5}}
  \proofstep{1}{A\subset A\cup\{a\}}{%
    \FormulaRefAuto{A \subset B \coloneq A \subseteq B \land A\neq B}{\rAI{2,6}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{2}{F\subset F\cup\{x\}}{%
    \FormulaRefAuto{a\notin A \vdash A\subset A\cup\{a\}}{7}}
  \proofstep{1,2}{F\cup\{x\}\in\FinSubsets{M}\land F\subset F\cup\{x\}}{\rAI{11,12}}
\end{tabproof}
...
\begin{tabproof}
  \proofstep{1}{\TarskiFinite(M)}{\rA}
  \proofstep{}{\FinSubsets{M}\subseteq \powerset(M)}{%
    \FormulaRefAuto{\FinSubsets{M}\subseteq \powerset(M)}}
  \proofstep{}{\FinSubsets{M}\neq\varnothing}{%
    \FormulaRefAuto{\FinSubsets{M}\neq\varnothing}}
  \proofstep{1}{%
    \exists F\in\FinSubsets{M}\,
    \forall G\in\FinSubsets{M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)
  }{%
    \FormulaRefAuto{\TarskiFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
    \vdash \exists F\in B\,\forall G\in B\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{1,2,3}}
  \proofstep{5}{%
    F\in\FinSubsets{M}\land
    \forall G\in\FinSubsets{M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)
  }{\rA}
  \proofstep{5}{F\in\FinSubsets{M}}{\rAEa{5}}
  \proofstep{5}{\forall G\in\FinSubsets{M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{\rAEb{5}}
  \proofstep{5}{F=M}{%
    \FormulaRefAuto{F\in\FinSubsets{M}\dsep
    \forall G\in\FinSubsets{M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)
    \vdash F=M}{6,7}}
  \proofstep{5}{F\subseteq M\land \Finite{F}}{%
    \FormulaRefAuto{F\in\FinSubsets{M}\eqvdash F\subseteq M\land \Finite{F}}{6}}
  \proofstep{5}{\Finite{F}}{\rAEb{9}}
  \proofstep{5}{\Finite{M}}{\rIE{8,10}}
  \proofstep{1}{\Finite{M}}{\rEE{4,5,11}}
\end{tabproof}

\paragraph{Bemerkung zur Auswahl}

Der vorstehende Schluss benutzt keine Auswahlannahme. Die einzige Auswahl eines
Elements erfolgt indirekt über das durch Tarski-Endlichkeit gelieferte
maximale Element der Familie \(\FinSubsets{M}\). Ein direkter Schluss von
Dedekind-Endlichkeit auf Endlichkeit ist dagegen eine eigene Aussage und darf
ohne eine entsprechende Auswahlannahme nicht mit diesem Argument identifiziert
werden.
