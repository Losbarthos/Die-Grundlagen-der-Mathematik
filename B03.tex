...
\\[.6ex]
\overset{\text{Auswahl}}{\Longrightarrow}
\\[-.2ex]
S\colon B\to B,\quad
\forall X\in B\,\bigl(X\subset S(X)\bigr)
\\[.8ex]
\overset{\text{Frischelemente}}{\Longrightarrow}
\\[-.2ex]
D\colon B\to M,\quad
...
\\[.8ex]
\overset{\text{Rekursion }F_n\coloneqq\RecFun{b_0}{S}(n)}{\Longrightarrow}
\\[-.2ex]
F_n\subseteq F_{\Succ(n)},\quad
d_n\coloneqq D(F_n)\in F_{\Succ(n)}\setminus F_n
\\[-.2ex]
...
\\[.8ex]
\overset{\text{Monotonie}}{\Longrightarrow}
\\[-.2ex]
k<n\Longrightarrow d_k\in F_n\land d_n\notin F_n
\Longrightarrow d_k\neq d_n
\\[-.2ex]
\sketchref{\GrowRec(B,b_0,S)\dsep k\in\mathbb{N}\dsep n\in\mathbb{N}\dsep k < n\vdash \RecFun{b_0}{S}(\Succ(k))\subseteq \RecFun{b_0}{S}(n)}
\quad
\sketchref{\GrowFresh(M,B,b_0,S,D)\vdash \forall k,n\in\mathbb{N}\,\bigl(k<n\rightarrow (D\circ \RecFun{b_0}{S})(k)\neq (D\circ \RecFun{b_0}{S})(n)\bigr)}
\\[.8ex]
\Downarrow
\\[-.2ex]
n\longmapsto d_n=(D\circ\RecFun{b_0}{S})(n)
\quad\Longrightarrow\quad
\exists H\colon\mathbb{N}\inj M
\\[-.2ex]
\sketchref{\GrowFresh(M,B,b_0,S,D)\vdash D\circ \RecFun{b_0}{S}\colon \mathbb{N}\inj M}
\\[.8ex]
\Downarrow\ \bot
\\[-.2ex]
