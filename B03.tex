...
\FormulaDefDeltaK[Adjunktionsabbildung zur Einermenge]{%
  J^M_a\coloneqq \{(X,X\cup\{a\})\mid X\in M_{\bar a}\}
...
\FormulaThmDelta[Adjunktionsabbildung trifft die enthaltende Teilfamilie]{%
  \UnionClosedFam(M)\dsep \{a\}\in M\dsep X\in M_{\bar a}
  \vdash X\cup\{a\}\in M_a
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep a}
}
\begin{tabproof}
  ...
  \proofstep{3}{X\in M_{\bar a}}{\rA}
  \proofstep{3}{X\in M\land a\notin X}{%
    \FormulaRefAuto{Vermeidende Teilfamilie}[def]{3}}
  ...
  \proofstep{1,2,3}{X\cup\{a\}\in M_a}{%
    \FormulaRefAuto{Enthaltende Teilfamilie}[def]{8}}
\end{tabproof}

\FormulaThmDelta[Adjunktionsabbildung ist injektiv]{%
  \UnionClosedFam(M)\dsep \{a\}\in M\vdash J^M_a\colon M_{\bar a}\inj M_a
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep Y\dsep a}
...
\begin{tabproof}
  ...
  \proofstep{3}{X\in M_{\bar a}}{\rA}
  \proofstep{1,2,3}{X\cup\{a\}\in M_a}{%
    \FormulaRefAuto{\UnionClosedFam(M)\dsep \{a\}\in M\dsep X\in M_{\bar a}\vdash X\cup\{a\}\in M_a}{1,2,3}}
  \proofstep{1,2}{J^M_a\colon M_{\bar a}\to M_a}{%
    \text{Df. }J^M_a\text{ und Zeile }4}

  \proofstep{6}{X\in M_{\bar a}}{\rA}
  \proofstep{7}{Y\in M_{\bar a}}{\rA}
  \proofstep{8}{J^M_a(X)=J^M_a(Y)}{\rA}
  \proofstep{6}{a\notin X}{\rAEb{\FormulaRefAuto{Vermeidende Teilfamilie}[def]{6}}}
  \proofstep{7}{a\notin Y}{\rAEb{\FormulaRefAuto{Vermeidende Teilfamilie}[def]{7}}}
  \proofstep{6,7,8}{X\cup\{a\}=Y\cup\{a\}}{\text{Df. }J^M_a}
  \proofstep{6,7,8}{X=Y}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep X\cup\{a\}=Y\cup\{a\}\vdash X=Y}{9,10,11}}

  \proofstep{1,2}{J^M_a\colon M_{\bar a}\inj M_a}{%
...
\begin{tabproof}
  ...
  \proofstep{2,3}{J^M_a\colon M_{\bar a}\inj M_a}{%
    \FormulaRefAuto{\UnionClosedFam(M)\dsep \{a\}\in M\vdash J^M_a\colon M_{\bar a}\inj M_a}{2,3}}
  \proofstep{2,3}{\exists F\colon M_{\bar a}\inj M_a}{\rEI{4}}
  \proofstep{}{a\in\{a\}}{\FormulaRefAuto{a\in\{a\}}}
  \proofstep{3}{a\in\bigcup M}{%
    \FormulaRefAuto{B\in A\dsep x\in B\vdash x \in \bigcup A}{3,6}}
  \proofstep{2,3}{\mathsf{HalfOcc}(a,M)}{%
    \FormulaRefAuto{Halbhäufiges Element}[def]{\rAI{7,5}}}
  \proofstep{2,3}{\exists a\,\mathsf{HalfOcc}(a,M)}{\rEI{8}}
  \proofstep{1,2,3}{\mathsf{Frankl}(M)}{%
    \FormulaRefAuto{Fränkelsche Eigenschaft}[def]{9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{11}{Y\in M_{\bar a}}{\rA}
  \proofstep{11}{Y\in M\land a\notin Y}{%
    \FormulaRefAuto{Vermeidende Teilfamilie}[def]{11}}
  \proofstep{11}{Y\in M}{\rAEa{12}}
  \proofstep{11}{a\notin Y}{\rAEb{12}}
  \proofstep{5,11}{a\in Y}{\rRE{13,\rUE{5}}}
  \proofstep{5,11}{\bot}{\rBI{15,14}}
  \proofstep{5}{Y\notin M_{\bar a}}{\rCI{11,16}}
  \proofstep{5}{\forall Y\,Y\notin M_{\bar a}}{\rUI{17}}
  \proofstep{5}{M_{\bar a}=\varnothing}{%
    \FormulaRefAuto{\forall x\, x\notin A\vdash A=\varnothing}{18}}

  \proofstep{}{\varnothing\colon\varnothing\inj M_a}{%
    \FormulaRefAuto{\varnothing\colon \varnothing\inj M}}
  \proofstep{5}{\varnothing\colon M_{\bar a}\inj M_a}{\rIE{\FormulaRefAuto{a=b\vdash b=a}{19},20}}
  \proofstep{5}{\exists F\colon M_{\bar a}\inj M_a}{\rEI{21}}
  \proofstep{3,5}{\mathsf{HalfOcc}(a,M)}{%
    \FormulaRefAuto{Halbhäufiges Element}[def]{\rAI{10,22}}}
  \proofstep{3,5}{\exists a\,\mathsf{HalfOcc}(a,M)}{\rEI{23}}
  \proofstep{1,2,3,5}{\mathsf{Frankl}(M)}{%
    \FormulaRefAuto{Fränkelsche Eigenschaft}[def]{24}}
...
\FormulaThmDeltaR[Charakterisierung der Fränkelschen Vierpunktfamilie]{%
  ...
  \DeltaRow{Mengen}{S\dsep E\dsep X\dsep b\dsep c}
}
\begin{tabproofwide}
  \proofstepwidestar[]{S=\{1,2,3,4\}}{\text{Abk.}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      E={}&\{\{1\},\{2\},\\
      &\{3\},\{4\}\}
  ...
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in M_4\eqvdash{}\\
      &X\in\powerset(S)\land X\notin E
    \end{aligned}}{%
    \FormulaRefAuto{Fränkelsche Vierpunktfamilie}[def]\text{, Zeilen }1,2}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in\powerset(S)\land X\notin E\eqvdash{}\\
      &X\subseteq S\land{}\\
      ...
      \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    \end{aligned}}{%
    \text{Potenzmenge und endliche Auswertung}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in M_4\eqvdash{}\\
      &X\subseteq\{1,2,3,4\}\land{}\\
...
\begin{tabproof}
  \proofstep{1}{X\in M_4}{\rA}
  \proofstep{2}{Y\in M_4}{\rA}
  \proofstep{1}{%
    \begin{aligned}[t]
      &X\subseteq\{1,2,3,4\}\land{}\\
      &\bigl(X=\varnothing\lor
  ...
  \proofstep{1}{X\subseteq\{1,2,3,4\}}{\rAEa{3}}
  \proofstep{2}{Y\subseteq\{1,2,3,4\}}{\rAEa{4}}
  \proofstep{1,2}{X\cup Y\subseteq\{1,2,3,4\}}{%
  ...
  \proofstep{1,2}{%
    ...
    \end{aligned}}{%
    \text{Fallunterscheidung mit Zeilen }3\text{ und }4}
  \proofstep{1,2}{X\cup Y\in M_4}{%
    \FormulaRefAuto{%
      X\in M_4\eqvdash X\subseteq\{1,2,3,4\}\land
      \bigl(X=\varnothing\lor \exists b\in X\,\exists c\in X\,(b\neq c)\bigr)
    }{\rAI{7,8}}}
  \proofstep{}{\UnionClosedFam(M_4)}{%
    \FormulaRefAuto{Vereinigungsabgeschlossene Familie}[def]{\rUI{\rRI{1,\rRI{2,9}}}}}
\end{tabproof}
...
\FormulaThmDeltaR[Zeugentabelle der Fränkelschen Vierpunktfamilie]{%
  \begin{aligned}[t]
    ...
    \exists I_1\in (M_4)_{\bar a}\,
    \exists I_2\in (M_4)_{\bar a}\\
    &\bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
  \end{aligned}
}{%
  A\in M_4\dsep a\in A\vdash
  \exists I_1\in (M_4)_{\bar a}\,\exists I_2\in (M_4)_{\bar a}\,
  \bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
}{%
  \DeltaRow{Mengen}{A\dsep a\dsep b\dsep c\dsep d\dsep I_1\dsep I_2}
  \DeltaRow{Teilmengenfamilien}{(M_4)_{\bar a}}
}
\begin{tabproof}
  ...
  \proofstep{1,2}{%
    ...
    \end{aligned}}{%
    \text{Tabelle, Zeilen }3,4\text{ und }
...
\begin{tabproof}
  ...
  \proofstep{}{\mathsf{DupCov}(M_4)}{%
    \FormulaRefAuto{Doppelte Vereinigung}[def]{\rUI{\rRI{1,\rUI{\rRI{2,3}}}}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{\mathsf{DupUCF}(M_4)}{%
    \FormulaRefAuto{Doppelt überdeckende Vereinigungsfamilie}[def]{5}}
