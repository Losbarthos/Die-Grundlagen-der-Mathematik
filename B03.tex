...
\FormulaDefDeltaK[Adjunktionsabbildung zur Einermenge]{%
  \FranklAdj{M}{a}\coloneqq \{(X,X\cup\{a\})\mid X\in \FamAvoiding{M}{a}\}
...
\FormulaThmDelta[Adjunktionsvorschrift ist auf vermeidenden Mengen injektiv]{%
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{X\cup\{a\}=Y\cup\{a\}}{%
    \FormulaRefAuto{\FranklAdj{M}{a}\coloneqq
    \{(X,X\cup\{a\})\mid X\in \FamAvoiding{M}{a}\}}{1,2,3}}
  \proofstep{1,2,3}{X=Y}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep X\cup\{a\}=Y\cup\{a\}\vdash X=Y}{4,5,6}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{8}{\FranklAdj{M}{a}(X)=\FranklAdj{M}{a}(Y)}{\rA}
  \proofstep{6}{a\notin X}{%
    \rAEb{\FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{6}}}
  \proofstep{7}{a\notin Y}{%
    \rAEb{\FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{7}}}
...
\begin{tabproof}
  ...
  \proofstep{}{%
    \exists X\in \FamAvoiding{M_4}{1}\,
    \bigl(X\cup\{1\}\notin \FamContaining{M_4}{1}\bigr)}{\rEI{\rAI{3,12}}}
\end{tabproof}
