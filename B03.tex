...
\begin{AxTable}
  \AxLine{Extensionalität}{\forall x\, (x \in A \leftrightarrow x \in B) \eqvdash A = B}
  \AxLine{Leere Menge}{\exists O\;\bigl(\forall x\,(x \not\in O)\bigr)}
  \AxLine{Aussonderung}{\exists B\,\forall x\,(x \in B \leftrightarrow x \in A \land P(x))}
  \AxLine{Paarmenge}{\exists C\;\bigl(\forall x\,(x \in C \leftrightarrow x=A \lor x=B)\bigr)}
  \AxLine{Vereinigung}{\exists C\,\forall x\,(x \in C \leftrightarrow \exists B\,(B \in A \land x \in B))}
  \AxLine{Potenzmenge}{\exists B\,\forall x\,(x \in B \leftrightarrow x \subseteq A)}
  \AxLine{Unendlichkeit}{\exists A\,(\emptyset \in A \land \forall x \in A\,(x \cup \{x\} \in A))}
  \AxLine{Regularität}{A \neq \emptyset \vdash \exists x \in A \,(x \cap A = \emptyset)}
  \AxLine{Ersetzung}{\exists C\,\forall y\,( y\in C \leftrightarrow \exists x\in A\,y=R(x))}
  \AxLine{Auswahlaxiom}{\exists B\,\forall x \in A\,\exists z\,B\cap x = \{z\}}
\end{AxTable}
\end{definition}

\section{Axiom der Extensionalität}

\FormulaAxiomDelta[Extensionalität]{\forall x\, (x \in A \leftrightarrow x \in B) \eqvdash A = B}%
{%
...
\FormulaAxiomDelta[Aussonderung]{x \in \{x \in A \mid P(x)\} \eqvdash x \in A \land P(x)}%
{%
\DeltaRow{Mengen}{A}% 
\DeltaRow{Einstellige Prädikate}{P}%
}%
...
\begin{tabproof}
    ...
    \proofstep{2}{ P(x) }{ \rA }
    \proofstep{3}{ x \in A\land P(x) }{ \rAI{1,2} }
    \proofstep{4}{ x \in \{x \in A \mid P(x)\} }{ \FormulaRefAuto{x \in \{x \in A \mid P(x)\} \eqvdash x \in A \land P(x)}{3} }
\end{tabproof}
...
\begin{definition}[Begriff der funktionalen Relation auf \(A\)]
Sei \(A\) eine Menge. Eine \textbf{funktionale Relation auf \(A\)} heißt eine Menge \(R\), die die folgenden Axiome erfüllt.

\noindent\textbf{Axiome für funktionale Relationen auf \(A\)}
\begin{AxTable}
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in R\dsep (x,z)\in R \vdash y=z}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in R}
\end{AxTable}
\end{definition}

\subsubsection{Funktionale Eindeutigkeit}
\FormulaAxiomDelta[Funktionale Eindeutigkeit]
{(x,y)\in R\dsep (x,z)\in R \vdash y=z}
{
\DeltaRow{Mengen}{x\dsep y\dsep z\dsep R}
}

\subsubsection{Totalität}
\FormulaAxiomDelta[Totalität auf \(A\)]
{x\in A \vdash \exists y\,(x,y)\in R}
{
\DeltaRow{Mengen}{x\dsep A\dsep R}
}

\subsubsection{Funktionswert}

\FormulaThmDelta[Eindeutigkeit des Funktionswertes]{x\in A\vdash \exists! y\;(x,y)\in R}{
\DeltaRow{Mengen}{x\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  \proofstep{1}{x\in A}{\rA}
  \proofstep{1}{\exists y(x,y)\in R}{\FormulaRefAuto{x\in A \vdash \exists y\,(x,y)\in R}{1}}
  \proofstep{2}{(x,y)\in R}{\rA}
  \proofstep{3}{(x,z)\in R}{\rA}
  \proofstep{2,3}{y=z}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{2,3}}
  \proofstep{1}{\exists! y(x,y)\in R}{\UEI{1,2,3,4}}
\end{tabproof}

\FormulaDefDelta[Funktionswert]{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{
\DeltaRow{Mengen}{x\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}

\FormulaThmDelta{x\in A\dsep y\in A\dsep x=y\vdash R(x)=R(y)}
{
...
\begin{tabproof}
    ...
    \proofstep{3}{x=y}{\rA}
    \proofstep{1}{(x,R(x))\in R}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{1}}
    \proofstep{2}{(y,R(y))\in R}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
    \proofstep{1,3}{(y,R(x))\in R}{\rIE{3,4}}
    \proofstep{1,2,3}{R(x)=R(y)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{6,5}}
\end{tabproof}

\FormulaThmDelta{x\in A\dsep R(x)=y\vdash (x,y)\in R}
{
\DeltaRow{Mengen}{x\dsep y\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  ...
  \proofstep{1}{(x,R(x))\in R}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{1}}
  \proofstep{1,2}{(x,y)\in R}{\rIE{2,3}}
\end{tabproof}

\FormulaThmDelta{x\in A\dsep y=R(x)\vdash (x,y)\in R}
{
\DeltaRow{Mengen}{x\dsep y\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  \proofstep{1}{x\in A}{\rA}
  \proofstep{2}{y=R(x)}{\rA}
  \proofstep{2}{R(x)=y}{\FormulaRefAuto{a=b\vdash b=a}{2}}
  \proofstep{1,2}{(x,y)\in R}{\FormulaRefAuto{x\in A\dsep R(x)=y\vdash (x,y)\in R}{1,3}}
\end{tabproof}

\FormulaThmDelta{x\in A\dsep (x,y)\in R\vdash y=R(x)}{
\DeltaRow{Mengen}{x\dsep y\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  \proofstep{1}{(x,y)\in R}{\rA}
  \proofstep{2}{x\in A}{\rA}
  \proofstep{2}{(x,R(x))\in R}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  \proofstep{1}{y=R(x)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{1,2}}
\end{tabproof}

\FormulaThmDelta{x\in A\dsep (x,y)\in R\vdash R(x)=y}{
\DeltaRow{Mengen}{x\dsep y\dsep A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  ...
  \proofstep{2}{x\in A}{\rA}
  \proofstep{2}{(x,R(x))\in R}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  \proofstep{1}{y=R(x)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{2,1}}
\end{tabproof}


\FormulaAxiomDelta[Ersetzung]{
\exists C\;\forall y\;\bigl( y\in C\;\leftrightarrow\; \exists x\in A\;y=R(x) \bigr)
}{
\DeltaRow{Mengen}{A}
\DeltaRow{Funktionale Relationen auf \(A\)}{R}
}

\FormulaDefDelta[Bildmenge unter \(R\) auf \(A\)]
{R[A] \coloneqq \iota C\Bigl(\forall y\;\bigl( y\in C \leftrightarrow \exists x\in A\,y=R(x) \bigr)\Bigr)}
{
  \DeltaRow{Mengen}{A}
  \DeltaRow{Funktionale Relationen auf \(A\)}{R}
}

\FormulaThmDelta{y\in R[A]\eqvdash \exists x\in A\,y=R(x)}
{
  \DeltaRow{Mengen}{x\dsep y\dsep A}
  \DeltaRow{Funktionale Relationen auf \(A\)}{R}
}
\begin{tabproof}
  \proofstep{}{ \forall y\;\bigl( y\in R[A] \leftrightarrow \exists x\in A\,y=R(x)\bigr) }{\FormulaRefAuto{R[A] \coloneqq \iota C\Bigl(\forall y\;\bigl( y\in C \leftrightarrow \exists x\in A\,y=R(x) \bigr)\Bigr)}}
...
\chapter{Ungleichheit von Mengen}
...
\section{Verschachtelte Paare und Tripel}
...
\chapter[Eigenschaften von Teilmengen]{Eigenschaften von Teilmengen in Bezug auf Vereinigung und Durchschnitt}
...
\chapter{Ausschluss gegenseitiger Mitgliedschaft}
...
\proofpart{\(\dashv\)}
  ...
  \proofstep{1}{(a,b)\in A\times B}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{2}}
...
\proofpart{\(\dashv\)}
  ...
  \proofstep{1}{(b,c)\in B\times C}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{3}}
...
\begin{tabproof}
  ...
  \proofstep{2,3}{(b,c)\in B\times C}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{2,3}}
...
\begin{tabproof}
  ...
  \proofstep{2}{b\in B}{\rA}
  \proofstep{3}{c\in C}{\rA}
  \proofstep{1,2}{(a,b)\in A\times B}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{1,2}}
...
\noindent\textbf{Axiome für Funktionen}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{F \subseteq A \times B}
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in R\dsep (x,z)\in R \vdash y=z}[mit \(R\coloneq F\)]
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in R}[mit \(R\coloneq F\)]
\end{AxTable}
\end{definition}

\FormulaAxiomDelta[Existenz als Menge geordneter Paare]{F \subseteq A \times B}{
\DeltaRow{Mengen}{A\dsep B}
\DeltaRow{Funktionale Relationen auf \(A\)}{F}
}
...
\begin{tabproof}
  \proofstep{1}{x\in A}{\rA}
  \proofstep{}{F\subseteq A\times B}{\FormulaRefAuto{F \subseteq A \times B}}
  \proofstep{1}{(x,F(x))\in F}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{1}}
...
\begin{tabproof}
  ...
  \proofstep{1}{(x,F(x))\in F}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  \proofstep{1}{y=F(x)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{1,3}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{x\in A}{\FormulaRefAuto{(x,y)\in F\vdash x\in A}{1}}
  \proofstep{1}{(x,F(x))\in F}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  \proofstep{1}{y=F(x)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{3,1}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{(x,y)\in G}{\FormulaRefAuto{x\in A\dsep y=R(x)\vdash (x,y)\in R}{5,4}}
\end{tabproof}
...
\proofpart{\(\dashv\)}
  ...
  \proofstep{2}{x\in A}{\rA}
  \proofstep{2}{(x,F(x))\in F}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  ...
  \proofstep{2}{(x,G(x))\in G}{\FormulaRefAuto{x\in A\vdash (R(x) \coloneqq \iota y\,\bigl((x,y)\in R\bigr)}{2}}
  \proofstep{1,2}{F(x)=G(x)}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{5,6}}
...
\begin{definition}[Begriff der injektiven Funktion]
Seien \(A,B\) Mengen, dann wird der \textbf{Begriff der injektiven Funktion} als Funktion
\[
F\colon A \to B
\]
\textbf{implizit definiert}, sofern diese die folgenden Eigenschaften hat: 

\noindent\textbf{Axiome für injektiven Funktionen}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{F \subseteq A \times B}
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in R\dsep (x,z)\in R \vdash y=z}[mit \(R\coloneq F\)]
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in R}[mit \(R\coloneq F\)]
  \AxLine{Injektivität}{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}
\end{AxTable}
\end{definition}
...
\begin{definition}[Begriff der surjektiven Funktion]
Seien \(A,B\) Mengen, dann wird der \textbf{Begriff der surjektiven Funktion} als Funktion
\[
F\colon A \to B
\]
\textbf{implizit definiert}, sofern diese die folgenden Eigenschaften hat: 

\noindent\textbf{Axiome für surjektive Funktionen}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{F \subseteq A \times B}
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in R\dsep (x,z)\in R \vdash y=z}[mit \(R\coloneq F\)]
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in R}[mit \(R\coloneq F\)]
  \AxLine{Surjektivität}{y\in B\vdash \exists x\in A\; F(x)=y}
\end{AxTable}
\end{definition}
...
\begin{theorem}
Seien \(A,B\) Mengen und \(F\colon A\to B\) eine Funktion, dann ist \(\tilde{F}\colon B\to F[B]\) eine surjektive Funktion.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Surjektivität}{y\in R[A]\eqvdash \exists x\in A\,y=R(x)}
\end{AxTable}
\end{theorem}


\begin{definition}[Begriff der bijektiven Funktion]
Seien \(A,B\) Mengen, dann wird der \textbf{Begriff der bijektiven Funktion} als Funktion
\[
F\colon A \to B
\]
\textbf{implizit definiert}, sofern diese die folgenden Eigenschaften hat: 

\noindent\textbf{Axiome für bijektiven Funktionen}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{F \subseteq A \times B}
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in R\dsep (x,z)\in R \vdash y=z}[mit \(R\coloneq F\)]
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in R}[mit \(R\coloneq F\)]
...
\begin{tabproof}
  ...
  \proofstep{3}{(x,y)\in F}{\FormulaRefAuto{x\in A\dsep R(x)=y\vdash (x,y)\in R}{4,5}}
...
\begin{theorem}[\(F^{-1}\) als Funktion]
Seien \(A,B\) Mengen und \(F\colon A\to B\) eine bijektive Funktion, dann ist \(F^{-1}\colon B\to A\) eine Funktion.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{F^{-1} \subseteq B\times A}
  \AxLine{Funktionale Eindeutigkeit}{F injektiv\dsep (y,x_1)\in F^{-1}\dsep (y,x_2)\in F^{-1} \vdash x_1 = x_2}
  \AxLine{Totalität auf \(B\)}{F surjektiv\dsep y\in B\vdash \exists x\, (y,x)\in F^{-1}}
\end{AxTable}
\end{theorem}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{(x,F^{-1}(y))\in F^{-1}}{\FormulaRefAuto{x\in A\dsep R(x)=y\vdash (x,y)\in R}{2,1}}
  \proofstep{1,3}{(y,F^{-1}(x))\in F^{-1}}{\FormulaRefAuto{x\in A\dsep y=R(x)\vdash (x,y)\in R}{3,1}}
  ...
  \proofstep{1,2,3}{x=y}{\FormulaRefAuto{(x,y)\in R\dsep (x,z)\in R \vdash y=z}{6,8}}
\end{tabproof}
...
\begin{tabproof}
  \proofstep{1}{x\in A}{\rA}
  \proofstep{1}{\exists y\,(x,y)\in F}{\FormulaRefAuto{x\in A \vdash \exists y\,(x,y)\in R}{1}}
...
\begin{theorem}[\(F^{-1}\) als bijektive Funktion]
Seien \(A,B\) Mengen und \(F\colon A\to B\) eine bijektive Funktion, dann ist \(F^{-1}\colon B\to A\) eine bijektive Funktion. Die sogenannte Umkehrfunktion von \(F\).
...
\begin{AxTable}
  ...
  \AxLine{Funktionale Eindeutigkeit}{F injektiv\dsep (y,x_1)\in F^{-1}\dsep (y,x_2)\in F^{-1} \vdash x_1 = x_2}
  \AxLine{Totalität auf \(B\)}{F surjektiv\dsep y\in B\vdash \exists x\, (y,x)\in F^{-1}}
  \AxLine{Injektivität}{x\in B\dsep y\in B\dsep F^{-1}(x)=F^{-1}(y)\vdash x=y}
  \AxLine{Surjektivität}{x\in A\vdash \exists y\in B\; F^{-1}(y)=x}
\end{AxTable}
\end{theorem}
...
\begin{tabproof}
    ...
    \proofstep{1,2}{(x,y)\in F}{\FormulaRefAuto{x\in A\dsep R(x)=y\vdash (x,y)\in R}{1,2}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{(y,x)\in F^{-1}}{\FormulaRefAuto{x\in A\dsep R(x)=y\vdash (x,y)\in R}{1,2}}
...
% — Definition —
\FormulaDefDelta[Identitätsrelation auf \(A\)]{%
...
\begin{tabproof}
    \proofstep{1}{x\in A}{\rA}
    \proofstep{1}{x=y}{\rA}
    \proofstep{1}{(x,y)\in A\times A}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{1,1}}
...
% — Identität als Funktion —
\begin{theorem}[\(\Id_A\) als Funktion]
Sei \(A\) eine Menge. Dann ist \(\Id_A\) eine Funktion \(\Id_A\colon A\to A\).

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{\Id_A \subseteq A\times A}
  \AxLine{Funktionale Eindeutigkeit}{(x,y_1)\in \Id_A \dsep (x,y_2)\in \Id_A \vdash y_1=y_2}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\, (x,y)\in \Id_A}
\end{AxTable}
\end{theorem}
...
\begin{theorem}[\(\Id_A\) als bijektive Funktion]
Sei \(A\) eine Menge. Dann ist \(\Id_A\colon A\to A\) bijektiv.
...
\begin{AxTable}
  ...
  \AxLine{Funktionale Eindeutigkeit}{(x,y_1)\in \Id_A \dsep (x,y_2)\in \Id_A \vdash y_1=y_2}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\, (x,y)\in \Id_A}
  \AxLine{Injektivität}{x\in A \dsep y\in A \dsep \Id_A(x)=\Id_A(y) \vdash x=y}
  \AxLine{Surjektivität}{x\in A \vdash \exists y\in A\; \Id_A(y)=x}
\end{AxTable}
\end{theorem}
...
\begin{tabproof}
  ...
  \proofstep{1}{(x,G(F(x)))\in A\times C}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{1,3}}
...
% — Komposition als Funktion —
\begin{theorem}[\(G\circ F\) als Funktion]
Seien \(A,B,C\) Mengen, \(F\colon A\to B\) und \(G\colon B\to C\) Funktionen. Dann ist \(G\circ F\colon A\to C\) eine Funktion.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Existenz als Menge geordneter Paare}{G\circ F \subseteq A\times C}
  \AxLine{Funktionale Eindeutigkeit}{(x,z_1)\in G\circ F \dsep (x,z_2)\in G\circ F \vdash z_1=z_2}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists z\, (x,z)\in G\circ F}
\end{AxTable}
\end{theorem}
...
\begin{theorem}[\(G\circ F\) als injektive Funktion]
Seien \(A,B,C\) Mengen, \(F\colon A\to B\) und \(G\colon B\to C\) injektive Funktionen. Dann ist \(G\circ F\colon A\to C\) eine injektive Funktion.
...
\begin{AxTable}
  ...
  \AxLine{Funktionale Eindeutigkeit}{(x,z_1)\in G\circ F \dsep (x,z_2)\in G\circ F \vdash z_1=z_2}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists z\, (x,z)\in G\circ F}
  \AxLine{Injektivität}{x\in A \dsep y\in A \dsep (G\circ F)(x)=(G\circ F)(y) \vdash x=y}
\end{AxTable}
\end{theorem}
...
\begin{theorem}[\(G\circ F\) als surjektive Funktion]
Seien \(A,B,C\) Mengen, \(F\colon A\to B\) und \(G\colon B\to C\) surjektive Funktionen. Dann ist \(G\circ F\colon A\to C\) eine surjektive Funktion.
...
\begin{AxTable}
  ...
  \AxLine{Funktionale Eindeutigkeit}{(x,z_1)\in G\circ F \dsep (x,z_2)\in G\circ F \vdash z_1=z_2}
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists z\, (x,z)\in G\circ F}
  \AxLine{Surjektivität}{z\in C \vdash \exists x\in A\, (G\circ F)(x)=z}
\end{AxTable}
\end{theorem}

\subsubsection{Erhalt der Bijektivität}

\begin{theorem}[\(G\circ F\) als bijektive Funktion]
Seien \(A,B,C\) Mengen, \(F\colon A\to B\) und \(G\colon B\to C\) bijektive Funktionen. Dann ist \(G\circ F\colon A\to C\) eine bijektive Funktion.
...
\begin{tabproof}
    ...
    \proofstep{1,2,3}{G(F(x))=G(F(y))}{\FormulaRefAuto{x\in A\dsep y\in A\dsep x=y\vdash R(x)=R(y)}{4,5,3}}
...
\begin{tabproof}
    ...
    \proofstep{3,6,9}{F(u)=F(v)}{\FormulaRefAuto{x\in A\dsep y\in A\dsep x=y\vdash R(x)=R(y)}{7,10,14}}
...
\begin{theorem}
Seien \(A,B,C\) Mengen, \(F\colon A\to B\), \(G\colon B\to C\)  Funktionen und \(G\circ F\colon A\to C\) eine bijektive Funktion. Dann ist \(F\) injektiv.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Injektivität}{G\circ F\colon A\to C bijektiv\dsep x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}
\end{AxTable}
\end{theorem}

\begin{theorem}
Seien \(A,B,C\) Mengen, \(F\colon A\to B\), \(G\colon B\to C\)  Funktionen und \(G\circ F\colon A\to C\) eine bijektive Funktion. Dann ist \(G\) surjektiv.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Surjektivität}{G\circ F\colon A\to C bijektiv\dsep y\in C\vdash \exists x\in B\; G(x)=y}
\end{AxTable}
\end{theorem}

\begin{theorem}
Seien \(A,B,C\) Mengen, \(F\colon A\to B\) eine surjektive Funktion, \(G\colon B\to C\) eine Funktionen und \(G\circ F\colon A\to C\) eine bijektive Funktion. Dann ist \(G\) bijektiv.

\noindent\textbf{Herleitung der Eigenschaften}
\begin{AxTable}
  \AxLine{Injektivität}{G\circ F\colon A\to C bijektiv\dsep F\colon A\to B surjektiv\dsep x\in B\dsep y\in B\dsep G(x)=G(y)\vdash x=y}
  \AxLine{Surjektivität}{G\circ F\colon A\to C bijektiv\dsep y\in C\vdash \exists x\in B\; G(x)=y}
\end{AxTable}
\end{theorem}
...
\FormulaRefAuto{G\circ F\colon A\to C bijektiv\dsep x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{1}




\FormulaThmDelta{%
F\circ G = \Id_A \vdash G=F^{-1}
}{
  \DeltaRow{Mengen}{A}
  \DeltaRow{Bijektive Funktionen}{G\colon A\to B \dsep F\colon B\to C}
}
