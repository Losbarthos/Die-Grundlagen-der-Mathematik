...
\begin{tabproof}
  ...
  \proofstep{1,2,3,4,7}{%
    ...
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep X\colon \mathbb{N}\to B\dsep A\neq\varnothing\vdash
    \exists a\in M\,a\in A}{1,5,8}}
  \proofstep{10}{a\in M\land a\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)}{\rA}
  \proofstep{10}{a\in M}{\rAEa{10}}
  \proofstep{10}{a\in \RecFun{x_0}{S}(\Succ(n))\setminus \RecFun{x_0}{S}(n)}{\rAEb{10}}
  \proofstep{1,5,7,10}{(n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}}{%
    \FormulaRefAuto{X\colon \mathbb{N}\to \powerset(M)\dsep n\in\mathbb{N}\dsep a\in M\dsep a\in X(\Succ(n))\setminus X(n)\vdash (n,a)\in \TarskiDeltaRel{X}{M}}{5,7,11,12}}
  \proofstep{1,5,7,10}{\exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rEI{13}}
  \proofstep{1,2,3,4,7}{\exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rEE{9,10,14}}
  \proofstep{1,2,3,4}{n\in\mathbb{N}\vdash \exists a\,\bigl((n,a)\in \TarskiDeltaRel{\RecFun{x_0}{S}}{M}\bigr)}{\rRI{7,15}}
  \proofstep{1,2,3,4}{\TotRel{\TarskiDeltaRel{\RecFun{x_0}{S}}{M},\mathbb{N},M}}{%
    \FormulaRefAuto{Totale Relation}{6,16}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{3,4}{\exists y\in B\,\neg\bigl(x\subseteq y\rightarrow y=x\bigr)}{%
    \FormulaRefAuto{\neg\forall y\in B\,P(y)\vdash \exists y\in B\,\neg P(y)}{5}}
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{\neg\TarskiFinite(M)\vdash
      ...
      \neg\exists x\in B\,\forall y\in B\,(x\subseteq y\rightarrow y=x)\bigr)}{1}}
  \proofstep{3}{%
    B\subseteq \powerset(M)\land B\neq\varnothing\land
...
\begin{tabproof}
  ...
  \proofstep{2,3,4,8}{\bot}{%
    \FormulaRefAuto{\exists H\colon \mathbb{N}\inj M\dsep \neg\exists H\colon \mathbb{N}\inj M\vdash \bot}{6,11}}
...
\begin{tabproof}
  ...
  \proofstep{1}{\TarskiFinite(M)}{%
    \FormulaRefAuto{Begriff der Tarski-Endlichkeit}{2}}
\end{tabproof}
