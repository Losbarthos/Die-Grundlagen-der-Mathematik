...
\FormulaDefDeltaK[Begriff der Menge (Zermelo-Fraenkel-Axiome)]{\in \text{(zweistelliges Prädikat)}}{Menge}{
  ...
  \DeltaRow{Aussonderung}
           ...
           [\FormulaRefAuto{x \in \{x \in A \mid P(x)\} \eqvdash x \in A \land P(x)}]
  %
  % — Paarmenge —
  \DeltaRow{Paarmenge}
  ...
  \DeltaRow{Auswahlaxiom}
           {\forall A\ \bigl(\forall x\in A\,x\neq\emptyset\bigr)\ \rightarrow\
            \exists B\,\forall x\in A\,\exists z\,\bigl(B\cap x=\{z\}\bigr)}
           [\FormulaRefAuto{\exists B\,\forall x \in A\,\exists z\,B\cap x = \{z\}}]
%
...
\begin{tabproof}
    ...
    \proofstep{1}{(x,y)\in A\times F[A]}{\FormulaRefAuto{a\in A,b\in B\vdash (a,b)\in A\times B}{2,5}}
...
\begin{AxTable}
  ...
  \AxLine{Funktionale Eindeutigkeit}{(x,y)\in F\dsep (x,z)\in F \vdash y=z}[mit \(R\coloneq F\)]
  \AxLine{Totalität auf \(A\)}{x\in A \vdash \exists y\,(x,y)\in F}[mit \(R\coloneq F\)]
...
\FormulaThmDeltaK{%
 G \textrm{ bijektiv}
}{G\circ F\colon A\to C \text{ bijektiv}\dsep F\colon A\to B \text{ surjektiv} \vdash G \text{ bijektiv}}{
  \DeltaRow{Mengen}{A\dsep B\dsep C}
  \DeltaRow{Funktionen}{G\colon B\to C}
  \DeltaRow{Surjektive Funktionen}{F\colon A\to B}
  \DeltaRow{Bijektive Funktionen}{G\circ F\colon A\to C }
...
\begin{tabproof}
  \proofaxline[aus Komposition]{Injektivität}%
    {G\circ F\colon A\to C \text{ bijektiv}\dsep F\colon A\to B \text{ surjektiv} \vdash G \text{ bijektiv}}
  \proofstep{6}{F(u)=x}{\rAEb{6}}
    \proofstep{6}{F(u)=x}{\rAEb{6}}
    \proofstep{9}{v\in A\land F(v)=y}{\rA}
...
\begin{theorem}
Seien \(A,B,C\) Mengen, \(F\colon A\to B\), \(G\colon B\to A\)  Funktionen und  \(F\circ G\colon A\to A\)\dsep \(G\circ F\colon A\to C\) bijektive Funktion. Dann ist \(G\) bijektiv.
