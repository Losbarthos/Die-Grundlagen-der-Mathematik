...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{\pi_1(x,y)=x}{%
    \FormulaRefAuto{(x,y)\in A\times B \vdash \pi_1(x,y)=x}{1}}
  \proofstepwidestar[1]{\pi_2(x,y)=y}{%
    \FormulaRefAuto{(x,y)\in A\times B \vdash \pi_2(x,y)=y}{1}}
  \proofstepwide[1]{(x,y)}{=}{(\pi_1(x,y),x)}{\rIE{2,4}}
  \proofstepwide[1]{}{=}{(\pi_1(x,y),\pi_2(x,y))}{\rIE{3,4}}
  \proofstepwide[1]{(x,y)}{=}{(\pi_1(x,y),\pi_2(x,y))}{\rChain{4,5}}
\end{tabproofwide}
...
\begin{tabproofwide}
  \proofstepwidestar[1]{z\in A\times B}{\rA}
  \proofstepwidestar[1]{\exists x\in A\,\exists y\in B\, z=(x,y)}{%
    \FormulaRefAuto{x\in A\times B\eqvdash \exists a \in A\, \exists b \in B\,x=(a,b)}{1}}
  \proofstepwidestar[3]{x\in A\land y\in B\land z=(x,y)}{\rA}
  \proofstepwidestar[3]{x\in A}{\rAEa{3}}
  \proofstepwidestar[3]{y\in B}{\FormulaRefAuto{P\land Q\land R\vdash Q}{3}}
  \proofstepwidestar[3]{z=(x,y)}{\rAEb{3}}
  \proofstepwidestar[3]{(x,y)\in A\times B}{%
    \FormulaRefAuto{(a,b)\in A\times B\eqvdash a\in A\land b\in B}{4,5}}
  \proofstepwidestar[3]{(x,y)=\bigl(\pi_1(x,y),\pi_2(x,y)\bigr)}{%
    \FormulaRefAuto{(x,y)\in A\times B \vdash (x,y)=\bigl(\pi_1(x,y),\pi_2(x,y)\bigr)}{7}}
  \proofstepwidestar[3]{\pi_1(z)=\pi_1(x,y)}{%
    \FormulaRefAuto{a=b \vdash f(a)=f(b)}{5}}
  \proofstepwidestar[3]{\pi_2(z)=\pi_2(x,y)}{%
    \FormulaRefAuto{a=b \vdash f(a)=f(b)}{5}}
  \proofstepwidestar[3]{\bigl(\pi_1(z),\pi_2(z)\bigr)=\bigl(\pi_1(x,y),\pi_2(x,y)\bigr)}{%
    \FormulaRefAuto{a=c \dsep b=d \vdash (a,b)=(c,d)}{8,9}}
  \proofstepwidestar[3]{z=\bigl(\pi_1(z),\pi_2(z)\bigr)}{%
    \FormulaRefAuto{a=b \dsep b=c \vdash a=c}{5,\rChain{7,10}}}
  \proofstepwidestar[]{z=\bigl(\pi_1(z),\pi_2(z)\bigr)}{%
    \rEE{2,3,11}}
\end{tabproofwide}
xxx
