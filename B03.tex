...
Die folgende Abbildung verschiebt die durch \(H\) eingebettete Kopie von
\(\mathbb{N}\) jeweils um einen Nachfolger weiter und lässt alle Punkte
außerhalb des Bildes \(H[\mathbb{N}]\) fest.
...
\FormulaDefDeltaR[Folgenverschiebung entlang einer Einbettung]{%
  \begin{aligned}[t]
    ...
    \iota S\Bigl(
      S\colon M\to M \land{}\\
    &\qquad\bigl(
      \forall n\in\mathbb{N}\,S(H(n))=H(\Succ(n)) \land{}\\
    &\qquad\forall x\in M\,\bigl(x\notin H[\mathbb{N}]
      \rightarrow S(x)=x\bigr)
      \bigr)
    \Bigr)
  \end{aligned}
}{%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    \begin{aligned}[t]
      &\forall n\in\mathbb{N}\,\SuccShift{H}(H(n))=H(\Succ(n)) \land{}\\
      &\forall x\in M\,\bigl(x\notin H[\mathbb{N}]
        \rightarrow \SuccShift{H}(x)=x\bigr)
    \end{aligned}
  }{%
    \rAEb{\FormulaRefAuto{%
      H\colon \mathbb{N}\inj M \vdash
  ...
  \proofstep{1}{%
    \forall n\in\mathbb{N}\,\SuccShift{H}(H(n))=H(\Succ(n))
  }{\rAEa{3}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{x\notin H[\mathbb{N}]
    \rightarrow \SuccShift{H}(x)=x}{\rRE{\rUE{5},2}}

  \proofstep{1,2,3}{\SuccShift{H}(x)=x}{\rRE{3,6}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,3,4,5}{x=y}{%
    \begin{gathered}
      ...
      \text{Bild-Bild: Injektivität von }H\text{ und }\Succ,\\
