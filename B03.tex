...
\FormulaThmDelta{F\colon A\to \powerset(A) \vdash \neg(F\colon A\sur \powerset(A))}{
\DeltaRow{Mengen}{A\dsep B\dsep F}
}
\begin{tabproofwide}
    \proofstepwidestar[1]{F\colon A\sur \powerset(A)}{\rA}
    \proofstepwidestar[1]{\forall y\in \powerset(A)\,\exists x\in A\,(F(x)=y)}{\FormulaRefAuto{y\in B\vdash \exists x\in A\; F(x)=y}{1}}
    ...
    \proofstepwide[4]{}{\leftrightarrow}{a\in A \land a\notin F(a)}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{7}}
    ...
    \proofstepwidestar[]{\neg(F\colon A\sur \powerset(A))}{\rCI{1,13}}
\end{tabproofwide}
...
\begin{tabproof}
    \proofstep{}{\pi_1\colon A\times B\to A}{\FormulaRefAuto{\Id_A\colon A\to A}}
...
\begin{tabproof}
    \proofstep{}{\pi_2\colon A\times B\to B}{\FormulaRefAuto{\Id_A\colon A\to A}}
...
\begin{tabproof}
    \proofstep{1}{A\subseteq B}{\rA}
    \proofstep{}{\iota_{A,B}\colon A\to B}{\FormulaRefAuto{\Id_A\colon A\to A}{1}}
...
z\in C \vdash \exists x\in A\, (G\circ F)(x)=z
  ...
  \DeltaRow{Surjektive Funktionen}{F\colon A\sur B \dsep G\colon B\sur C}
}
\begin{tabproof}
...
\FormulaThmDelta{%
  ...
  \DeltaRow{Mengen}{A\dsep B}
  \DeltaRow{Totale Relation}{\TotRel{R,A,B}}
  \DeltaRow{Funktion}{s\colon A\to R}
  \DeltaRow{Projektion auf erste Komponente}{\pi_1:A\times B\to A}
}
\begin{tabproofwide}
...
\FormulaThmDelta{%
  ...
  \DeltaRow{Mengen}{M \dsep X \dsep a}
  \DeltaRow{\makecell[l]{Paarweise disjunkte\\ nichtleere Familie}}{\DisjFam(M)}
  \DeltaRow{Funktionen}{F\colon M\to \bigcup M}
...
\FormulaDefDelta[Auswahlbild von F]{%
  \Ausw_F \coloneqq \{\, a \in \bigcup M \mid \exists X\in M\,(a = F(X)) \,\}
}{%
  \DeltaRow{Mengen}{M \dsep X \dsep a}
  \DeltaRow{\makecell[l]{Paarweise disjunkte\\ nichtleere Familie}}{\DisjFam(M)}
  \DeltaRow{Funktionen}{F\colon M\to \bigcup M}
...
\FormulaThmDelta[Existenz eines Auswahlelements in $X$]{%
  ...
  \vdash \exists a\in X\,a\in\Ausw_F
}{
  \DeltaRow{Mengen}{M \dsep X}
  \DeltaRow{\makecell[l]{Paarweise disjunkte\\ nichtleere Familie}}{\DisjFam(M)}
  \DeltaRow{Funktionen}{F\colon M\to \bigcup M}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{F(X)\in X}{\FormulaRefAuto{\forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M\vdash F(X)\in X}{1,2}}

  \proofstep{2}{F(X)\in \bigcup M}{%
    \FormulaRefAuto{x\in A\vdash F(x)\in B}{2}}

  \proofstep{}{F(X)=F(X)}{\rII}

  \proofstep{2}{\exists Y\in M\,(F(X)=F(Y))}{\rEI{\rAI{2,5}}}

  \proofstep{2}{F(X)\in \Ausw_F}{%
    \FormulaRefAuto{x \in A\dsep P(x)\dsep B=\{x \in A \mid P(x)\}\vdash x \in B}{4,6,\FormulaRefAuto{\Ausw_F \coloneqq \{\, a \in \bigcup M \mid \exists X\in M\,(a = F(X)) \,\}}}}

  \proofstep{1,2}{\exists a\in X\,\bigl(a\in\Ausw_F\bigr)}{\rEI{\rAI{3,7}}}
\end{tabproof}

\FormulaThmDelta[Auswahlelement in $X$ ist $F(X)$]{%
  \forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M\dsep a\in X\dsep a\in\Ausw_F
  \vdash a=F(X)
}{
  \DeltaRow{Mengen}{M \dsep X \dsep a}
  \DeltaRow{\makecell[l]{Paarweise disjunkte\\ nichtleere Familie}}{\DisjFam(M)}
...
\begin{tabproof}
  ...
  \proofstep{2}{X\in M}{\rA}
  \proofstep{3}{a\in X}{\rA}
  \proofstep{4}{a\in\Ausw_F}{\rA}

  \proofstep{4}{\exists Y\in M\,(a=F(Y))}{%
    \FormulaRefAuto{x \in A\dsep A=\{x \in B \mid P(x)\}\vdash P(x)}%
      {4,\FormulaRefAuto{\Ausw_F \coloneqq \{\, a \in \bigcup M \mid \exists X\in M\,(a = F(X)) \,\}}}}
...
\FormulaThmDelta[Eindeutige Existenz eines Auswahlelements in $X$]{%
  \forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M
  \vdash \exists! a\in X\,\bigl(a\in\Ausw_F\bigr)
}{
  \DeltaRow{Mengen}{M \dsep X}
  \DeltaRow{\makecell[l]{Paarweise disjunkte\\ nichtleere Familie}}{\DisjFam(M)}
  \DeltaRow{Funktionen}{F\colon M\to \bigcup M}
...
\begin{tabproof}
  \proofstep{1}{\forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)}{\rA}
  \proofstep{2}{X\in M}{\rA}
  \proofstep{1,2}{\exists a\in X\,a\in\Ausw_F}{%
    \FormulaRefAuto{\forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M
    \vdash \exists a\in X\,a\in\Ausw_F}{1,2}}

  \proofstep{4}{b\in X\land b\in\Ausw_F}{\rA}
  \proofstep{5}{c\in X\land c\in\Ausw_F}{\rA}

  \proofstep{4}{b\in X}{\rAEa{4}}
  \proofstep{4}{b\in\Ausw_F}{\rAEb{4}}
  \proofstep{1,2,4}{b=F(X)}{%
    \FormulaRefAuto{\forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M\dsep a\in X\dsep a\in\Ausw_F
    \vdash a=F(X)}{1,2,6,7}}

  \proofstep{5}{c\in X}{\rAEa{5}}
  \proofstep{5}{c\in\Ausw_F}{\rAEb{5}}
  ...
  \proofstep{1,2}{\exists! a\in X\,\bigl(a\in\Ausw_F\bigr)}{\UEI{3,4,5,12}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{2,4}{%
    \exists! a\in X\,\bigl(a\in\Ausw_F\bigr)
  }{%
    \FormulaRefAuto{\forall x\in M\,\bigl((x,F(x))\in \MemRel(M)\bigr)\dsep X\in M
    \vdash \exists! a\in X\,\bigl(a\in\Ausw_F\bigr)}{3,4}
  }

  \proofstep{2}{%
    \forall X\in M\,\exists! a\in X\,\bigl(a\in\Ausw_F\bigr)
  }{\rUI{\rRI{4,5}}}
...
\FormulaThmDelta
{X\in M_G \vdash \exists x\in A\,(X=\Fib_G(x))}
{
...
\begin{tabproof}
  ...
  \proofstep{1}{\exists x\in A\,(X=\Fib_G(x))}{%
...
\begin{tabproof}
  ...
  \proofstep{2}{\exists x\in A\,(X=\Fib_G(x))}{\FormulaRefAuto{X\in M_G \vdash \exists x\in A\,(X=\Fib_G(x))}{2}}
  \proofstep{4}{x\in A \land X=\Fib_G(x)}{\rA}
  \proofstep{4}{x\in A}{\rAEa{4}}
  \proofstep{4}{X=\Fib_G(x)}{\rAEb{4}}
  \proofstep{1,5}{\Fib_G(x)\neq\varnothing}{\FormulaRefAuto{G\colon B\sur A \dsep x\in A \vdash \Fib_G(x)\neq\varnothing}{1,5}}
...
\begin{tabproof}
  ...
  \proofstep{5}{b\in \Fib_G(x)\cap \Fib(G,y)}{\rA}
  \proofstep{5}{b\in \Fib_G(x) \land b\in \Fib(G,y)}{%
    \FormulaRefAuto{b\in X\cap Y \eqvdash (b\in X \land b\in Y)}{5}}
  \proofstep{5}{b\in \Fib_G(x)}{\rAEa{6}}
  ...
  \proofstep{}{b\in \Fib_G(x)\cap \Fib(G,y) \rightarrow \bot}{\rRI{5,12}}
  \proofstep{}{ \Fib_G(x)\cap \Fib(G,y)=\varnothing}{%
...
\begin{tabproof}
  ...
  \proofstep{2}{\exists x\in A\,(X=\Fib_G(x))}{\FormulaRefAuto{X\in M_G \vdash \exists x\in A\,(X=\Fib_G(x))}{2}}
  \proofstep{3}{\exists y\in A\,(Y=\Fib(G,y))}{\FormulaRefAuto{X\in M_G \vdash \exists x\in A\,(X=\Fib_G(x))}{3}}

  \proofstep{7}{x\in A \land X=\Fib_G(x)}{\rA}
  \proofstep{8}{y\in A \land Y=\Fib(G,y)}{\rA}
  \proofstep{7}{x\in A}{\rAEa{7}}
  \proofstep{7}{X=\Fib_G(x)}{\rAEb{7}}
  \proofstep{8}{y\in A}{\rAEa{8}}
  \proofstep{8}{Y=\Fib(G,y)}{\rAEb{8}}

  \proofstep{7,8}{x\neq y}{%
    \FormulaRefAuto{X=\Fib_G(x)\dsep Y=\Fib(G,y)\dsep X\neq Y \vdash x\neq y}{10,13,4}}

  \proofstep{1,9,12,14}{\Fib_G(x)\cap \Fib(G,y)=\varnothing}{%
    \FormulaRefAuto{G\colon B\to A \dsep x\in A \dsep y\in A \dsep x\neq y \vdash \Fib_G(x)\cap \Fib(G,y)=\varnothing}{1,9,12,15}}
...
{\forall X\in M_G\,\exists! a\,(a\in X \land a\in L) \dsep x\in A
 \vdash \exists! b\,\bigl(b\in \Fib_G(x)\land b\in L\bigr)}
{
...
\begin{tabproof}
  ...
  \proofstep{2}{\exists X\in M_G\,(X=\Fib_G(x))}{%
    \FormulaRefAuto{x\in A \vdash \exists X\in M_G\,(X=\Fib_G(x))}{2}}

  \proofstep{4}{X\in M_G \land X=\Fib_G(x)}{\rA}
  \proofstep{4}{X\in M_G}{\rAEa{4}}
  \proofstep{1,5}{\exists! b\,(b\in X \land b\in L)}{\rUE{1}}
  \proofstep{4}{\exists! b\,(b\in \Fib_G(x) \land b\in L)}{\rIE{7, \rIE{6,\rAEb{4}}}}
  \proofstep{1,2}{\exists! b\,(b\in \Fib_G(x) \land b\in L)}{\rEE{3,4,8}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{5}{x\in A}{\rA}
  \proofstep{4,5}{\exists! b\,(b\in \Fib_G(x)\land b\in L)}{%
    \FormulaRefAuto{\forall X\in M_G\,\exists! a\,(a\in X \land a\in L) \dsep x\in A
     \vdash \exists! b\,(b\in \Fib_G(x)\land b\in L)}{4,5}}

  \proofstep{4}{\exists F\colon A\to B\,\forall x\in A\,\bigl(F(x)\in \Fib_G(x)\land F(x)\in L\bigr)}{%
    \FormulaRefAuto{\forall x\in A\,\exists! b\,P(x,b) \vdash \exists F\colon A\to B\,\forall x\in A\,P(x,F(x))}%
      {\rUI{\rRI{5,6}}}}

  \proofstep{7}{F\colon A\to B \land \forall x\in A\,\bigl(F(x)\in \Fib_G(x)\land F(x)\in L\bigr)}{\rA}
  \proofstep{8}{x\in A}{\rA}
  \proofstep{7,8}{F(x)\in \Fib_G(x)}{\rAEa{\rUE{7}}}
...
\FormulaDefAuto[induktive Menge]{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(x \cup \{x\} \in A)}[Für eine Menge \(A\) definieren wir:]
...
\begin{tabproof}
  ...
  \proofstep{}{\exists A(\mathrm{Induktiv}(A)) }{\rIE{\FormulaRefAuto{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(x \cup \{x\} \in A)},1}}
\end{tabproof}

% Sofortige Konsequenzen aus der Definition
\FormulaThmAuto{\mathrm{Induktiv}(A)\vdash \varnothing\in A}
\begin{tabproof}
  \proofstep{1}{\mathrm{Induktiv}(A)}{\rA}
  \proofstep{1}{\varnothing \in A \land \forall x \in A\,(x \cup \{x\} \in A)}{\rIE{\FormulaRefAuto{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(x \cup \{x\} \in A)},1}}
...
\begin{tabproof}
  ...
  % Null in A∩B
  \proofstep{1}{\,\varnothing\in A}{\FormulaRefAuto{\mathrm{Induktiv}(A)\vdash \varnothing\in A}{1}}
  \proofstep{2}{\,\varnothing\in B}{\FormulaRefAuto{\mathrm{Induktiv}(A)\vdash \varnothing\in A}{2}}
  ...
  \proofstep{1,2}{\,\mathrm{Induktiv}(A\cap B)}%
    {\rIE{\FormulaRefAuto{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(x \cup \{x\} \in A)},15}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{y = x\cup\{x\}}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{\FormulaRefAuto
{\mathrm{succ}_A := \{\, (x,y) \in A \times A \mid y = x \cup \{x\} \,\}}{1}}}
  \proofstep{2}{z = x\cup\{x\}}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{\FormulaRefAuto
...
\begin{tabproof}
  ...
  \proofstep{1,2}{(x,x\cup\{x\}) \in \mathrm{succ}_A}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{4,5}}
\end{tabproof}
...
\begin{tabproof}
    ...
    \proofstep{1}{\varnothing\in N}{\FormulaRefAuto{\mathrm{Induktiv}(A)\vdash \varnothing\in A}{1}}
    \proofstep{}{\forall \mathrm{Induktiv}(N)(x\in N)}{\rUI{\rRI{1,2}}}
    \proofstep{}{\varnothing\in\mathbb{N}}{\FormulaRefAuto{x\in\mathbb{N}\eqvdash \forall \mathrm{Induktiv}(N)(x\in N)}{3}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{\,\varnothing\in\mathbb{N}\ \land\ \forall x\in\mathbb{N}\,(\mathrm{succ}(x)\in\mathbb{N})}%
    {\rAI{1,2}}
  \proofstep{}{\,\mathrm{Induktiv}(\mathbb{N})}%
    {\rIE{\FormulaRefAuto{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(\mathrm{succ}(x) \in A)},3}}
\end{tabproof}
...
\begin{tabproof}
  \proofstep{}{ x \cup \{x\}\neq\varnothing }{\FormulaRefAuto{A\cup \{a\}\neq\varnothing}}
  \proofstep{}{\mathrm{succ}(x)\neq\varnothing}{\rIE{\FormulaRefAuto{\mathrm{succ}(x) := x \cup \{x\}},2}}
\end{tabproof}
...
\FormulaThmAuto{P(\varnothing),\, \forall x\in\mathbb{N}\,(P(x) \rightarrow P(\mathrm{succ}(x))) \vdash \mathrm{Induktiv}(\{x \in \mathbb{N} \mid P(x)\})}[Für jedes einstellige Prädikat \(P\) gilt:]
\begin{notation*}
...
\begin{tabproof}
  ...
  \proofstep{1}{\varnothing\in S}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{\FormulaRefAuto{\varnothing\in\mathbb{N}},1}}
  \proofstep{4}{n\in S}{\rA}
  \proofstep{4}{n\in \mathbb{N}}{\rAEa{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{4}}}
  \proofstep{4}{P(n)}{\rAEb{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{4}}}
  ...
  \proofstep{2,4}{\mathrm{succ}(n)\in S}{\FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash x \in A \land P(x)}{7,8}}
  \proofstep{2}{\forall n\in S(\mathrm{succ}(n)\in S)}{\rUI{\rRI{4,9}}}
  \proofstep{1,2}{ \mathrm{Induktiv}(S) }{\FormulaRefAuto{\mathrm{Induktiv}(A) := \varnothing \in A \,\land\, \forall x\in A\,(\mathrm{succ}(x) \in A)}{\rAI{3,10}}}
\end{tabproof}

\FormulaThmAuto[Induktion auf \(\mathbb{N}\)]{P(\varnothing),\, \forall x\in\mathbb{N}\,(P(x) \rightarrow P(\mathrm{succ}(x))) \vdash \forall x\in\mathbb{N}\,(P(x))}[Für jedes einstellige Prädikat \(P\) gilt:]
\begin{tabproof}
  \proofstep{1}{ P(\varnothing) }{\rA}
  \proofstep{2}{ \forall x \in \mathbb{N}\,(P(x) \rightarrow P(\mathrm{succ}(x))) }{\rA}
  \proofstep{1,2}{ \mathrm{Induktiv}(\{x \in \mathbb{N} \mid P(x)\}) }{\FormulaRefAuto{P(\varnothing),\, \forall x\in\mathbb{N}\,(P(x) \rightarrow P(\mathrm{succ}(x))) \vdash \mathrm{Induktiv}(\{x \in \mathbb{N} \mid P(x)\})}{1,2}}
