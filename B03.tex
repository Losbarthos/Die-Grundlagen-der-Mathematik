...
Ist \(H\colon \mathbb{N}\inj M\), so verschiebt die folgende Vorschrift
die Punkte der eingebetteten Folge um einen Nachfolger weiter und lässt
alle Punkte außerhalb des Bildes \(H[\mathbb{N}]\) fest.
...
\FormulaDefDeltaR[Funktionsvorschrift der Folgenverschiebung]{%
  \begin{aligned}[t]
    ...
    \IfThenElse{x\in H[\mathbb{N}]}
      {H\Bigl(\Succ\bigl(\iota k\,
        (k\in\mathbb{N}\land x=H(k))\bigr)\Bigr)}
      {x}
  \end{aligned}
}{%
  H\colon \mathbb{N}\inj M\dsep x\in M \vdash
  \tSuccShift{H}(x)\coloneqq
  \IfThenElse{x\in H[\mathbb{N}]}
    {H\Bigl(\Succ\bigl(\iota k\,(k\in\mathbb{N}\land x=H(k))\bigr)\Bigr)}
    {x}
}{%
  \DeltaDecl{Mengen}{M\dsep x\dsep k}%
  \DeltaDecl{Funktionen}{H}%
...
\begin{tabproof}
  ...
  \proofstep{2}{n\in\mathbb{N}}{\rA}
  \proofstep{1}{H\colon \mathbb{N}\to M}{\FormulaRefAuto{Injektive Funktion}{1}}
  \proofstep{1,2}{H(n)\in M}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{3,2}}

  \proofstep{2}{\exists k\in\mathbb{N}\,\bigl(H(n)=H(k)\bigr)}{\rEI{\rAI{2,\rII}}}
  \proofstep{1,2}{H(n)\in H[\mathbb{N}]}{%
    \FormulaRefAuto{F\colon A\to B\dsep \exists x\in A\,y=F(x)\vdash y\in F[A]}{3,5}}

  \proofstep{1,2}{%
    \tSuccShift{H}(H(n))=
    \IfThenElse{H(n)\in H[\mathbb{N}]}
      {H\Bigl(\Succ\bigl(\iota k\,
        (k\in\mathbb{N}\land H(n)=H(k))\bigr)\Bigr)}
      {H(n)}
  }{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M \vdash
  ...
  \proofstep{1,2}{%
    \iota k\,\bigl(k\in\mathbb{N}\land H(n)=H(k)\bigr)=n
  }{%
    \begin{gathered}
      \text{Da }H\text{ injektiv ist, ist }n\text{ der eindeutige}\\
      \text{Index mit }k\in\mathbb{N}\land H(n)=H(k).
    \end{gathered}}

  \proofstep{1,2}{%
    H\Bigl(\Succ\bigl(\iota k\,
      (k\in\mathbb{N}\land H(n)=H(k))\bigr)\Bigr)=H(\Succ(n))
  }{\rIE{9,\rII}}

  \proofstep{1,2}{\tSuccShift{H}(H(n))=H(\Succ(n))}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{7,8},10}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{}{x\in H[\mathbb{N}]\lor x\notin H[\mathbb{N}]}{\FormulaRefAuto{P\lor \neg P}}

  \proofstep{4}{x\in H[\mathbb{N}]}{\rA}
  \proofstep{1,2,4}{\tSuccShift{H}(x)\in M}{%
    \begin{gathered}
      \text{Wähle den eindeutigen Index }n\in\mathbb{N}\text{ mit }x=H(n);\\
      \text{dann gilt }\tSuccShift{H}(x)=H(\Succ(n))\in M.
    \end{gathered}}

  \proofstep{6}{x\notin H[\mathbb{N}]}{\rA}
  \proofstep{1,2,6}{\tSuccShift{H}(x)=x}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \vdash \tSuccShift{H}(x)=x}{1,2,6}}
  \proofstep{1,2,6}{\tSuccShift{H}(x)\in M}{\rIE{7,2}}

  \proofstep{1,2}{\tSuccShift{H}(x)\in M}{\rOE{3,4,5,6,8}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\tSuccShift{H}(x)\in M}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\vdash
      \tSuccShift{H}(x)\in M}{1,2}}

  \proofstep{1}{\forall x\in M\,\tSuccShift{H}(x)\in M}{\rUI{\rRI{2,3}}}
\end{tabproof}
...
\FormulaDefDelta[Folgenverschiebung entlang einer Einbettung]{%
  H\colon \mathbb{N}\inj M\vdash
  \SuccShift{H}\coloneqq \iota S\Bigl(
    S\colon M\to M\land
...
\begin{tabproof}
  ...
  \proofstep{1}{\forall x\in M\,\SuccShift{H}(x)=\tSuccShift{H}(x)}{%
    \rAEb{\FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\vdash
      \SuccShift{H}\coloneqq \iota S\Bigl(
        S\colon M\to M\land
  ...
  \proofstep{1,2}{\SuccShift{H}(H(n))=\tSuccShift{H}(H(n))}{\rRE{\rUE{5},4}}
  \proofstep{1,2}{\tSuccShift{H}(H(n))=H(\Succ(n))}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\vdash
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\SuccShift{H}(x)=\tSuccShift{H}(x)}{\rRE{\rUE{4},2}}
  \proofstep{1,2,3}{\tSuccShift{H}(x)=x}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
...
\begin{tabproof}
  ...
  \proofstep{1,3,4,5}{x=y}{%
    \begin{gathered}
      \text{Fallunterscheidung nach }x\in H[\mathbb{N}]
      \text{ und }y\in H[\mathbb{N}],\\
      \text{Bild--Bild: Grundgleichung und Injektivität von }H\text{ und }\Succ,\\
      \text{gemischte Fälle: Widerspruch zur Bildzugehörigkeit,}\\
      \text{Außen--Außen: Fixpunktgleichung.}
    \end{gathered}}
  ...
  \proofstep{1,3}{%
    \forall y\in M\,\bigl(
      \SuccShift{H}(x)=\SuccShift{H}(y)\rightarrow x=y
    \bigr)
  }{\rUI{\rRI{4,7}}}

  \proofstep{1}{%
    \forall x\in M\,\forall y\in M\,\bigl(
      \SuccShift{H}(x)=\SuccShift{H}(y)\rightarrow x=y
    \bigr)
  }{\rUI{\rRI{3,8}}}
...
\begin{tabproof}
  ...
  \proofstep{1}{H(\varnothing)\in H[\mathbb{N}]}{%
    \FormulaRefAuto{F\colon A\to B\dsep \exists x\in A\,y=F(x)\vdash y\in F[A]}{2,6}}

  \proofstep{8}{\SuccShift{H}\colon M\sur M}{\rA}
  \proofstep{1,8}{\exists x\in M\,\SuccShift{H}(x)=H(\varnothing)}{%
    \FormulaRefAuto{y\in B\vdash \exists x\in A\; F(x)=y}{8,5}}

  \proofstep{10}{x\in M}{\rA}
  \proofstep{11}{\SuccShift{H}(x)=H(\varnothing)}{\rA}

  \proofstep{1,7,10,11}{\bot}{%
    \begin{gathered}
      \text{Fallunterscheidung nach }x\in H[\mathbb{N}],\\
      x=H(n)\Rightarrow H(\Succ(n))=H(\varnothing)
        \Rightarrow \Succ(n)=\varnothing,\\
      \text{im Widerspruch zu }
        n\in\mathbb{N}\vdash \Succ(n)\neq\varnothing,\\
      x\notin H[\mathbb{N}]
        \Rightarrow \SuccShift{H}(x)=x=H(\varnothing)\in H[\mathbb{N}].
    \end{gathered}}

  \proofstep{1,8}{\bot}{\rEE{9,10,11,12}}
  \proofstep{1}{\neg(\SuccShift{H}\colon M\sur M)}{\rCI{8,13}}
\end{tabproof}
