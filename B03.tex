...
Ein nichtleerer Durchschnitt der Familie wird in der folgenden Aussage durch
einen gemeinsamen Zeugen \(a\) notiert:
\[
  \exists a\,\forall X\in M\,(a\in X).
\]
Zusammen mit \(M\neq\varnothing\) liegt ein solches \(a\) auch in
\(\bigcup M\).

\FormulaThmDelta[Fränkelsche Vermutung bei nichtleerem Durchschnitt]{%
  \Finite{M}\dsep \UnionClosedFam(M)\dsep M\neq\varnothing\dsep
  \exists a\,\forall X\in M\,(a\in X)\vdash \mathsf{Frankl}(M)
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep Y\dsep a}
  \DeltaRow{Funktionen}{F}
}
\begin{tabproof}
  ...
  \proofstep{2}{\UnionClosedFam(M)}{\rA}
  \proofstep{3}{M\neq\varnothing}{\rA}
  \proofstep{4}{\exists a\,\forall X\in M\,(a\in X)}{\rA}

  \proofstep{5}{\forall X\in M\,(a\in X)}{\rA}
  \proofstep{3}{\exists X\in M}{\FormulaRefAuto{B\neq\varnothing\vdash \exists x\in B}{3}}
  \proofstep{7}{X\in M}{\rA}
  \proofstep{5,7}{a\in X}{\rRE{7,\rUE{5}}}
  \proofstep{5,7}{a\in\bigcup M}{%
    \FormulaRefAuto{B\in A\dsep x\in B\vdash x \in \bigcup A}{7,8}}
  \proofstep{3,5}{a\in\bigcup M}{\rEE{6,7,9}}

  \proofstep{11}{Y\in \FamAvoiding{M}{a}}{\rA}
  \proofstep{11}{Y\in M\land a\notin Y}{%
    \FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{11}}
  \proofstep{11}{Y\in M}{\rAEa{12}}
  \proofstep{11}{a\notin Y}{\rAEb{12}}
  \proofstep{5,11}{a\in Y}{\rRE{13,\rUE{5}}}
  \proofstep{5,11}{\bot}{\rBI{15,14}}
  \proofstep{5}{Y\notin \FamAvoiding{M}{a}}{\rCI{11,16}}
  \proofstep{5}{\forall Y\,Y\notin \FamAvoiding{M}{a}}{\rUI{17}}
  \proofstep{5}{\FamAvoiding{M}{a}=\varnothing}{%
    \FormulaRefAuto{\forall x\, x\notin A\vdash A=\varnothing}{18}}

  \proofstep{}{\varnothing\colon\varnothing\inj \FamContaining{M}{a}}{%
    \FormulaRefAuto{\varnothing\colon \varnothing\inj M}}
  \proofstep{5}{\varnothing\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}{19},20}}
  \proofstep{5}{\exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{\rEI{21}}
  \proofstep{3,5}{\mathsf{HalfOcc}(a,M)}{%
    \FormulaRefAuto{\mathsf{HalfOcc}(a,M)\coloneqq
    a\in\bigcup M\land
    \exists F\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{\rAI{10,22}}}
  \proofstep{3,5}{\exists a\,\mathsf{HalfOcc}(a,M)}{\rEI{23}}
  \proofstep{1,2,3,5}{\mathsf{Frankl}(M)}{%
    \FormulaRefAuto{\mathsf{Frankl}(M)\coloneqq \exists a\,\mathsf{HalfOcc}(a,M)}{24}}

  \proofstep{1,2,3,4}{\mathsf{Frankl}(M)}{\rEE{4,5,25}}
\end{tabproof}
