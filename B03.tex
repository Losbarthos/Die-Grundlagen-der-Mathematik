...
\quad
\sketchref{\GrowFresh(M,B,b_0,S,D)\dsep k\in\mathbb{N}\dsep n\in\mathbb{N}\dsep k < n\vdash (D\circ \RecFun{b_0}{S})(k)\neq (D\circ \RecFun{b_0}{S})(n)}
\end{array}}
\end{array}
\]
\endgroup
