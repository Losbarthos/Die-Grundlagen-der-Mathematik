...
Für ein Element \(a\) zerlegen wir \(M\) in die Teilfamilie der Mengen, die
\(a\) enthalten, und die Teilfamilie der Mengen, die \(a\) vermeiden.
...
\subsection{Vorbereitende Adjunktionsabbildung}
...
\begin{tabproof}
  ...
  \proofstep{4}{z\in X}{\rA}
  \proofstep{4}{z\in X\cup\{a\}}{\FormulaRefAuto{z \in A \vdash z \in A \cup B}{4}}
  \proofstep{3,4}{z\in Y\cup\{a\}}{\rIE{3,5}}
  \proofstep{3,4}{z\in Y\lor z=a}{%
    \FormulaRefAuto{x\in A\cup\{a\} \vdash x\in A\lor x=a}{6}}
  \proofstep{8}{z\in Y}{\rA}
  \proofstep{9}{z=a}{\rA}
  \proofstep{4,9}{a\in X}{\rIE{9,4}}
  \proofstep{1,4,9}{\bot}{\rBI{10,1}}
  \proofstep{1,4,9}{z\in Y}{\FormulaRefAuto{P\dsep \neg P \vdash Q}{10,1}}
  \proofstep{1,3,4}{z\in Y}{\rOE{7,8,8,9,12}}
  \proofstep{1,3}{X\subseteq Y}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}{\rUI{\rRI{4,13}}}}

  \proofstep{15}{z\in Y}{\rA}
  \proofstep{15}{z\in Y\cup\{a\}}{\FormulaRefAuto{z \in A \vdash z \in A \cup B}{15}}
  \proofstep{3,15}{z\in X\cup\{a\}}{\rIE{\FormulaRefAuto{a=b\vdash b=a}{3},16}}
  \proofstep{3,15}{z\in X\lor z=a}{%
    \FormulaRefAuto{x\in A\cup\{a\} \vdash x\in A\lor x=a}{17}}
  \proofstep{19}{z\in X}{\rA}
  \proofstep{20}{z=a}{\rA}
  \proofstep{15,20}{a\in Y}{\rIE{20,15}}
  \proofstep{2,15,20}{\bot}{\rBI{21,2}}
  \proofstep{2,15,20}{z\in X}{\FormulaRefAuto{P\dsep \neg P \vdash Q}{21,2}}
  \proofstep{2,3,15}{z\in X}{\rOE{18,19,19,20,23}}
  \proofstep{2,3}{Y\subseteq X}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}{\rUI{\rRI{15,24}}}}

  \proofstep{1,2,3}{X=Y}{%
    \FormulaRefAuto{A \subseteq B, B \subseteq A \vdash A = B}{14,25}}
\end{tabproof}

\FormulaDefDeltaK[Adjunktionsabbildung zur Einermenge]{%
  J^M_a\coloneqq \{(X,X\cup\{a\})\mid X\in \FamAvoiding{M}{a}\}
}{Adjunktionsabbildung der Fränkelschen Vermutung}{%
  \DeltaRow{Mengen}{M\dsep X\dsep Y\dsep a}
  \DeltaRow{Teilmengenfamilien}{\FamContaining{M}{a}\dsep \FamAvoiding{M}{a}}
  \DeltaRow{Neue Symbole}{J^M_a}
}

\FormulaThmDelta[Adjunktionsabbildung trifft die enthaltende Teilfamilie]{%
  \UnionClosedFam(M)\dsep \{a\}\in M\dsep X\in \FamAvoiding{M}{a}
  \vdash X\cup\{a\}\in \FamContaining{M}{a}
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep a}
}
\begin{tabproof}
...
\FormulaThmDelta[Adjunktionsabbildung ist injektiv]{%
  ...
  \vdash J^M_a\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}
}{%
  \DeltaRow{Mengen}{M\dsep X\dsep Y\dsep a}
  \DeltaRow{Funktionen}{J^M_a}
}
\begin{tabproof}
  \proofstep{1}{\UnionClosedFam(M)}{\rA}
  \proofstep{2}{\{a\}\in M}{\rA}
  \proofstep{3}{X\in \FamAvoiding{M}{a}}{\rA}
  \proofstep{1,2,3}{X\cup\{a\}\in \FamContaining{M}{a}}{%
    \FormulaRefAuto{\UnionClosedFam(M)\dsep \{a\}\in M\dsep X\in \FamAvoiding{M}{a}
    \vdash X\cup\{a\}\in \FamContaining{M}{a}}{1,2,3}}
  \proofstep{1,2}{J^M_a\colon \FamAvoiding{M}{a}\to \FamContaining{M}{a}}{%
    \FormulaRefAuto{J^M_a\coloneqq
    \{(X,X\cup\{a\})\mid X\in \FamAvoiding{M}{a}\}}{3,4}}

  \proofstep{6}{X\in \FamAvoiding{M}{a}}{\rA}
  \proofstep{7}{Y\in \FamAvoiding{M}{a}}{\rA}
  \proofstep{8}{J^M_a(X)=J^M_a(Y)}{\rA}
  \proofstep{6}{a\notin X}{%
    \rAEb{\FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{6}}}
  \proofstep{7}{a\notin Y}{%
    \rAEb{\FormulaRefAuto{\FamAvoiding{M}{a}\coloneqq \{X\in M\mid a\notin X\}}{7}}}
  \proofstep{6,7,8}{X\cup\{a\}=Y\cup\{a\}}{%
    \FormulaRefAuto{J^M_a\coloneqq
    \{(X,X\cup\{a\})\mid X\in \FamAvoiding{M}{a}\}}{6,7,8}}
  \proofstep{6,7,8}{X=Y}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep X\cup\{a\}=Y\cup\{a\}\vdash X=Y}{9,10,11}}

  \proofstep{1,2}{J^M_a\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{%
    \FormulaRefAuto{Injektive Funktion}{5,\rUI{\rRI{6,\rRI{7,\rRI{8,12}}}}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{2,3}{J^M_a\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{%
    \FormulaRefAuto{\UnionClosedFam(M)\dsep \{a\}\in M
    \vdash J^M_a\colon \FamAvoiding{M}{a}\inj \FamContaining{M}{a}}{2,3}}
...
\subsection{Ein Beispiel mit doppelter Vereinigung}

Die folgende Zusatzbedingung verlangt, dass jede Menge \(A\) der Familie und
jedes Element \(a\in A\) zwei verschiedene \(a\)-vermeidende Familienglieder
besitzen, die \(A\) durch Vereinigung gleich treffen.

\FormulaDefDeltaK[Doppelte Vereinigung über jedem Element]{%
  \mathsf{DupCov}(M)\coloneqq
  \forall A\in M\,\forall a\in A\,
  \exists I_1\in \FamAvoiding{M}{a}\,\exists I_2\in \FamAvoiding{M}{a}\,
  \bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
}{Doppelte Vereinigung}{%
  \DeltaRow{Mengen}{M\dsep A\dsep a\dsep I_1\dsep I_2}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{M}{a}}
  \DeltaRow{Neue Symbole}{\mathsf{DupCov}}
}

\FormulaDefDeltaK[Doppelt überdeckende endliche Vereinigungsfamilie]{%
  \mathsf{DupUCF}(M)\coloneqq
  M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land
  \mathsf{DupCov}(M)
}{Doppelt überdeckende Vereinigungsfamilie}{%
  \DeltaRow{Mengen}{M}
  \DeltaRow{Neue Symbole}{\mathsf{DupUCF}}
}
...
Für die doppelte Vereinigung verwenden wir die folgende Zeugenwahl. Sie ist
vollständig, weil jedes nichtleere Element von \(M_4\) entweder mindestens
zwei Punkte außer \(a\) enthält oder eine Zweiermenge \(\{a,b\}\) ist.
\[
  \begin{array}{c|c|c|c}
    \text{Fall} & \text{Nebenzeugen} & I_1 & I_2\\ \hline
    b,c\in A\setminus\{a\},\ b\neq c
      & b,c\in A
      & \varnothing
      & \{b,c\}\\
    A=\{a,b\},\ \{c,d\}=\{1,2,3,4\}\setminus A
      & c\neq d
      & \{c,d\}
      & \{b,c,d\}
  \end{array}
...
\FormulaThmDeltaR[Zeugenwahl aus der Vierpunktbedingung]{%
  \begin{aligned}[t]
    &A\subseteq\{1,2,3,4\}\land
    \bigl(A=\varnothing\lor
    \exists b\in A\,\exists c\in A\,(b\neq c)\bigr)\\
    &\dsep a\in A\vdash
    \exists I_1\in \FamAvoiding{M_4}{a}\,
    \exists I_2\in \FamAvoiding{M_4}{a}\\
    &\bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
  \end{aligned}
}{%
  A\subseteq\{1,2,3,4\}\land
  \bigl(A=\varnothing\lor \exists b\in A\,\exists c\in A\,(b\neq c)\bigr)
  \dsep a\in A\vdash
  \exists I_1\in \FamAvoiding{M_4}{a}\,\exists I_2\in \FamAvoiding{M_4}{a}\,
  \bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
}{%
  \DeltaRow{Mengen}{A\dsep a\dsep b\dsep c\dsep d\dsep I_1\dsep I_2}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{M_4}{a}}
}
\FormulaThmDeltaR[Zeugentabelle der Fränkelschen Vierpunktfamilie]{%
  \begin{aligned}[t]
    A\in M_4\dsep a\in A\vdash{}&
    \exists I_1\in \FamAvoiding{M_4}{a}\,
    \exists I_2\in \FamAvoiding{M_4}{a}\\
    &\bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)
  \end{aligned}
...
\FormulaThmDelta[Fränkelsche Vierpunktfamilie besitzt doppelte Vereinigung]{%
  \mathsf{DupCov}(M_4)
}{%
  \DeltaRow{Mengen}{M_4\dsep A\dsep a\dsep I_1\dsep I_2}
  \DeltaRow{Teilmengenfamilien}{\FamAvoiding{M_4}{a}}
}
\begin{tabproof}
  \proofstep{1}{A\in M_4}{\rA}
  ...
  \proofstep{}{\mathsf{DupCov}(M_4)}{%
    \FormulaRefAuto{\mathsf{DupCov}(M)\coloneqq
    \forall A\in M\,\forall a\in A\,
    \exists I_1\in \FamAvoiding{M}{a}\,\exists I_2\in \FamAvoiding{M}{a}\,
    \bigl(I_1\neq I_2\land I_1\cup A=I_2\cup A\bigr)}{\rUI{\rRI{1,\rUI{\rRI{2,3}}}}}}
\end{tabproof}

\FormulaThmDelta[Fränkelsche Vierpunktfamilie mit doppelter Vereinigung]{%
  \vdash \exists M\,\mathsf{DupUCF}(M)
}{%
  \DeltaRow{Mengen}{M\dsep M_4}
}
\begin{tabproof}
  \proofstep{}{M_4\neq\varnothing}{%
    \FormulaRefAuto{M_4\neq\varnothing}}
  ...
  \proofstep{}{\mathsf{DupCov}(M_4)}{%
    \FormulaRefAuto{\mathsf{DupCov}(M_4)}}
  \proofstep{}{%
    \begin{aligned}[t]
      &M_4\neq\varnothing\land \Finite{M_4}\land{}\\
      &\UnionClosedFam(M_4)\land \mathsf{DupCov}(M_4)
    \end{aligned}}{\rAI{1,\rAI{2,\rAI{3,4}}}}
  \proofstep{}{\mathsf{DupUCF}(M_4)}{%
    \FormulaRefAuto{\mathsf{DupUCF}(M)\coloneqq
    M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land
    \mathsf{DupCov}(M)}{5}}
  \proofstep{}{\exists M\,\mathsf{DupUCF}(M)}{\rEI{6}}
\end{tabproof}

Ausgeschrieben liefert dieses \(M_4=\powerset(\{1,2,3,4\})\setminus
\{\{1\},\{2\},\{3\},\{4\}\}\) genau die Existenzformel
\[
  \begin{aligned}
    \exists M\Bigl(&
      M\neq\varnothing\land \Finite{M}\land \UnionClosedFam(M)\land{}\\
...
\FormulaDefDeltaK[Korrigierte Adjunktionsabbildung]{%
  J^{\mathcal I,h}_a(X)\coloneqq
  \begin{cases}
    X\cup\{a\}, & X\in G^{\mathcal I}_a,\\
    h_a(X), & X\in D^{\mathcal I}_a.
  \end{cases}
}{Korrigierte Adjunktionsabbildung}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Funktionen}{h_a\dsep J^{\mathcal I,h}_a}
  \DeltaRow{Teilmengenfamilien}{G^{\mathcal I}_a\dsep D^{\mathcal I}_a}
  \DeltaRow{Neue Symbole}{J^{\mathcal I,h}_a}
}

\FormulaThmDelta[Korrigierte Adjunktionsabbildung ist injektiv]{%
  h_a\colon D^{\mathcal I}_a\inj R^{\mathcal I}_a
  \vdash
  J^{\mathcal I,h}_a\colon
  ...
  \DeltaRow{Teilmengenfamilien}{%
    G^{\mathcal I}_a\dsep D^{\mathcal I}_a\dsep R^{\mathcal I}_a}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{h_a\colon D^{\mathcal I}_a\inj R^{\mathcal I}_a}{\rA}
  \proofstepwidestar[]{%
    \FamAvoiding{\mathcal I}{a}=
    G^{\mathcal I}_a\cup D^{\mathcal I}_a}{%
    \FormulaRefAuto{D^{\mathcal I}_a\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus G^{\mathcal I}_a}}
  \proofstepwidestar[]{%
    G^{\mathcal I}_a\cap D^{\mathcal I}_a=\varnothing}{%
    \FormulaRefAuto{D^{\mathcal I}_a\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus G^{\mathcal I}_a}}
  \proofstepwidestar[]{%
    R^{\mathcal I}_a\cap
    \{X\cup\{a\}\mid X\in G^{\mathcal I}_a\}=\varnothing}{%
    \FormulaRefAuto{R^{\mathcal I}_a\coloneqq
    \FamContaining{\mathcal I}{a}\setminus
    \{X\cup\{a\}\mid X\in G^{\mathcal I}_a\}}}
  \proofstepwidestar[]{%
    J^{\mathcal I,h}_a\colon
    ...
    \makecell[l]{%
    \FormulaRefAuto{J^{\mathcal I,h}_a(X)\coloneqq
    \begin{cases}
      X\cup\{a\}, & X\in G^{\mathcal I}_a,\\
      h_a(X), & X\in D^{\mathcal I}_a.
    \end{cases}}\text{, }\\
    \FormulaRefAuto{G^{\mathcal I}_a\coloneqq
    \{X\in \FamAvoiding{\mathcal I}{a}\mid X\cup\{a\}\in\mathcal I\}}
    \text{, }\\
    \FormulaRefAuto{D^{\mathcal I}_a\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus G^{\mathcal I}_a}
  ...
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in G^{\mathcal I}_a\dsep Y\in G^{\mathcal I}_a\\
      &\dsep J^{\mathcal I,h}_a(X)=J^{\mathcal I,h}_a(Y)
      \vdash X=Y
    \end{aligned}}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep
  ...
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &X\in D^{\mathcal I}_a\dsep Y\in D^{\mathcal I}_a\\
      &\dsep J^{\mathcal I,h}_a(X)=J^{\mathcal I,h}_a(Y)
      \vdash X=Y
    \end{aligned}}{%
    \FormulaRefAuto{Injektive Funktion}{1}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in G^{\mathcal I}_a\dsep Y\in D^{\mathcal I}_a\\
      &\dsep J^{\mathcal I,h}_a(X)=J^{\mathcal I,h}_a(Y)
      \vdash X=Y
    \end{aligned}}{%
    \makecell[l]{%
    ...
    \FormulaRefAuto{R^{\mathcal I}_a\coloneqq
    \FamContaining{\mathcal I}{a}\setminus
    \{X\cup\{a\}\mid X\in G^{\mathcal I}_a\}}\text{, }\\
    \FormulaRefAuto{Injektive Funktion}{1}}}
  \proofstepwidestar[]{%
    \begin{aligned}[t]
      &X\in D^{\mathcal I}_a\dsep Y\in G^{\mathcal I}_a\\
      &\dsep J^{\mathcal I,h}_a(X)=J^{\mathcal I,h}_a(Y)
      \vdash X=Y
    \end{aligned}}{%
    \makecell[l]{%
...
\FormulaThmDelta[Einermengenfall der korrigierten Adjunktion]{%
  ...
  \vdash D^{\mathcal I}_a=\varnothing
}{%
  \DeltaRow{Mengen}{\mathcal I\dsep X\dsep a}
  \DeltaRow{Teilmengenfamilien}{D^{\mathcal I}_a\dsep G^{\mathcal I}_a}
}
\begin{tabproof}
  \proofstep{1}{\UnionClosedFam(\mathcal I)}{\rA}
  \proofstep{2}{\{a\}\in\mathcal I}{\rA}
  \proofstep{3}{X\in D^{\mathcal I}_a}{\rA}
  \proofstep{3}{X\in \FamAvoiding{\mathcal I}{a}\land
    X\notin G^{\mathcal I}_a}{%
    \FormulaRefAuto{D^{\mathcal I}_a\coloneqq
    \FamAvoiding{\mathcal I}{a}\setminus G^{\mathcal I}_a}{3}}
  \proofstep{3}{X\in \FamAvoiding{\mathcal I}{a}}{\rAEa{4}}
  \proofstep{3}{X\notin G^{\mathcal I}_a}{\rAEb{4}}
  ...
  \proofstep{1,2,3}{X\in G^{\mathcal I}_a}{%
    \FormulaRefAuto{G^{\mathcal I}_a\coloneqq
    \{X\in \FamAvoiding{\mathcal I}{a}\mid X\cup\{a\}\in\mathcal I\}}{5,9}}
  \proofstep{1,2,3}{\bot}{\rBI{10,6}}
  \proofstep{1,2}{X\notin D^{\mathcal I}_a}{\rCI{3,11}}
  \proofstep{1,2}{\forall X\,X\notin D^{\mathcal I}_a}{\rUI{12}}
  \proofstep{1,2}{D^{\mathcal I}_a=\varnothing}{%
