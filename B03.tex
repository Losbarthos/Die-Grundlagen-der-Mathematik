...
\chapter{Mengentheoretische Konstruktion der natürlichen Zahlen}
...
\section{Konstruktion der Menge \(\mathbb{N}\)}
...
\section{Eigenschaften von \(\mathbb{N}\)}

Im Folgenden werden wir einige grundlegende Eigenschaften der so konstruierten Menge \(\mathbb{N}\) beweisen.

\subsection{Induktivität von \(\mathbb{N}\)}


\FormulaThmAuto{\emptyset\in\mathbb{N}}
\begin{tabproof}
...
\FormulaThmAuto{\forall x \in \mathbb{N}\,(\mathrm{succ}(x) \in \mathbb{N})}
\begin{tabproof}
...
\subsection{Minimalität von \(\mathbb{N}\)}
...
\section{Eigenschaften zur Einführung der Peano-Axiome zur Beschreibung von \(\mathbb{N}\)}
