...
\FormulaThmDelta[Tarski-Endlichkeit liefert ein Maximum]{%
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{\TarskiFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
    \vdash \exists F\in B\,\forall G\in B\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{1,3,4}}
  \proofstep{6}{%
...
\subsubsection{Maximalitäts- und Minimalitätsform der Tarski-Endlichkeit}
...
\FormulaThmDelta[Charakterisierung der Komplementdualen]{%
...
\begin{tabproof}
  \proofstep{}{Z\in B^{\complement_M}\eqvdash
    \exists X\in B\,\bigl(Z=M\setminus X\bigr)}{%
    \text{Entfaltung von }B^{\complement_M}}
\end{tabproof}

\FormulaThmDelta[Komplementduale bleibt eine nichtleere Potenzmengenfamilie]{%
  B\subseteq \powerset(M)\dsep B\neq\varnothing
  \vdash
...
\begin{tabproof}
  ...
  \proofstep{3}{\exists X\in B\,\bigl(Z=M\setminus X\bigr)}{%
    \FormulaRefAuto{Z\in B^{\complement_M}\eqvdash \exists X\in B\,\bigl(Z=M\setminus X\bigr)}{3}}
  \proofstep{5}{X\in B\land Z=M\setminus X}{\rA}
  \proofstep{5}{X\in B}{\rAEa{5}}
  \proofstep{5}{Z=M\setminus X}{\rAEb{5}}
  \proofstep{1,5}{X\in\powerset(M)}{%
  ...
  \proofstep{1,5}{Z\subseteq M}{\rIE{7,10}}
  \proofstep{1,5}{Z\in\powerset(M)}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}{11}}
  \proofstep{1,3}{Z\in\powerset(M)}{\rEE{4,5,12}}
  \proofstep{1}{B^{\complement_M}\subseteq \powerset(M)}{%
    \FormulaRefAuto{A \subseteq B \coloneq \forall x\,(x\in A \rightarrow x\in B)}{\rUI{\rRI{3,13}}}}
  \proofstep{2}{\exists X\in B}{\FormulaRefAuto{B\neq\varnothing\vdash \exists x\in B}{2}}
  \proofstep{16}{X\in B}{\rA}
  \proofstep{16}{M\setminus X\in B^{\complement_M}}{%
    \FormulaRefAuto{Z\in B^{\complement_M}\eqvdash \exists X\in B\,\bigl(Z=M\setminus X\bigr)}{\rEI{\rAI{16,\rII}}}}
  \proofstep{16}{B^{\complement_M}\neq\varnothing}{%
    \FormulaRefAuto{a \in A \vdash A \neq \varnothing}{17}}
  \proofstep{2}{B^{\complement_M}\neq\varnothing}{\rEE{15,16,18}}
  \proofstep{1,2}{%
    B^{\complement_M}\subseteq \powerset(M)\land
    B^{\complement_M}\neq\varnothing}{\rAI{14,19}}
\end{tabproof}

\FormulaThmDeltaR[Komplement kehrt Inklusion um]{%
  \begin{aligned}[t]
...
\begin{tabproof}
  ...
  \proofstep{1,2}{X\subseteq Y\eqvdash M\setminus Y\subseteq M\setminus X}{%
    \text{elementweise aus }z\in M\setminus A\eqvdash z\in M\land z\notin A}
\end{tabproof}

\FormulaThmDelta[Relatives Komplement ist involutiv]{%
...
\FormulaThmDeltaR[Komplementduales Maximum liefert ein Minimum]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep
  ...
  B\subseteq \powerset(M)\dsep
  \exists U\in B^{\complement_M}\,\forall V\in B^{\complement_M}\,
    \bigl(U\subseteq V\rightarrow V=U\bigr)
  \vdash
  \exists X\in B\,\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)
}{%
...
\begin{tabproof}
  \proofstep{1}{B\subseteq \powerset(M)}{\rA}
  \proofstep{2}{\exists U\in B^{\complement_M}\,
      \forall V\in B^{\complement_M}\,
        \bigl(U\subseteq V\rightarrow V=U\bigr)}{\rA}
  \proofstep{3}{U\in B^{\complement_M}\land
      \forall V\in B^{\complement_M}\,
        \bigl(U\subseteq V\rightarrow V=U\bigr)}{\rA}
  \proofstep{3}{U\in B^{\complement_M}}{\rAEa{3}}
  \proofstep{3}{\forall V\in B^{\complement_M}\,
        \bigl(U\subseteq V\rightarrow V=U\bigr)}{\rAEb{3}}
  \proofstep{3}{\exists X\in B\,\bigl(U=M\setminus X\bigr)}{%
    \FormulaRefAuto{Z\in B^{\complement_M}\eqvdash \exists X\in B\,\bigl(Z=M\setminus X\bigr)}{4}}
  ...
  \proofstep{1,7}{X\in\powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{1,8}}
  \proofstep{1,7}{X\subseteq M}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}{12}}
  \proofstep{1,10}{Y\in\powerset(M)}{%
    \FormulaRefAuto{A\subseteq B,\, x\in A \vdash x\in B}{1,10}}
  ...
  \proofstep{10}{M\setminus Y\in B^{\complement_M}}{%
    \FormulaRefAuto{Z\in B^{\complement_M}\eqvdash \exists X\in B\,\bigl(Z=M\setminus X\bigr)}{\rEI{\rAI{10,\rII}}}}
  \proofstep{1,7,10,11}{M\setminus X\subseteq M\setminus Y}{%
    \FormulaRefAuto{X\subseteq M\dsep Y\subseteq M\vdash X\subseteq Y\eqvdash M\setminus Y\subseteq M\setminus X}{15,13,11}}
  \proofstep{1,7,10,11}{U\subseteq M\setminus Y}{\rIE{9,17}}
  \proofstep{3,10,11}{U\subseteq M\setminus Y\rightarrow M\setminus Y=U}{\rUE{5}}
  \proofstep{1,3,7,10,11}{M\setminus Y=U}{\rIE{18,19}}
  \proofstep{1,3,7,10,11}{M\setminus Y=M\setminus X}{\rIE{9,20}}
  \proofstep{1,3,7,10,11}{Y=X}{%
    \FormulaRefAuto{X\subseteq M\vdash M\setminus(M\setminus X)=X}{13,15,21}}
  \proofstep{1,3,7,10}{Y\subseteq X\rightarrow Y=X}{\rRI{11,22}}
  \proofstep{1,3,7}{\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)}{\rUI{\rRI{10,23}}}
  \proofstep{1,3,7}{\exists X\in B\,\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)}{\rEI{\rAI{8,24}}}
  \proofstep{1,3}{\exists X\in B\,\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)}{\rEE{6,7,25}}
  \proofstep{1,2}{\exists X\in B\,\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)}{\rEE{2,3,26}}
\end{tabproof}

\FormulaThmDeltaR[Komplementduales Minimum liefert ein Maximum]{%
  \begin{aligned}[t]
    &B\subseteq \powerset(M)\dsep
    \exists U\in B^{\complement_M}\,
      \forall V\in B^{\complement_M}\,
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\exists X\in B\,\forall Y\in B\,
      \bigl(X\subseteq Y\rightarrow Y=X\bigr)}{%
    \text{wie der vorige Dualitätssatz, mit der Inklusion umgekehrt}}
\end{tabproof}

\paragraph{Äquivalenz der Prädikate}

\FormulaThmDelta[Tarski-Minimalendlichkeit liefert ein Minimum]{%
  \TarskiMinFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
  \vdash \exists F\in B\,\forall G\in B\,\bigl(G\subseteq F\rightarrow G=F\bigr)
}{%
  \DeltaDecl{Mengen}{M\dsep B\dsep F\dsep G}%
}
\begin{tabproof}
  ...
  }{\FormulaRefAuto{minimal Tarski-endliche Menge}{1}}
  \proofstep{2,3}{B\subseteq \powerset(M)\land B\neq\varnothing}{\rAI{2,3}}
  \proofstep{1,2,3}{\exists F\in B\,\forall G\in B\,\bigl(G\subseteq F\rightarrow G=F\bigr)}{\rIE{5,4}}
\end{tabproof}

\FormulaThmDelta[Tarski-Endlichkeit impliziert minimale Tarski-Endlichkeit]{%
...
\begin{tabproof}
  ...
  \proofstep{2}{B\subseteq \powerset(M)}{\rAEa{2}}
  \proofstep{2}{B\neq\varnothing}{\rAEb{2}}
  \proofstep{2}{B^{\complement_M}\subseteq \powerset(M)\land
    B^{\complement_M}\neq\varnothing}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep B\neq\varnothing \vdash B^{\complement_M}\subseteq \powerset(M)\land B^{\complement_M}\neq\varnothing}{3,4}}
  \proofstep{2}{B^{\complement_M}\subseteq \powerset(M)}{\rAEa{5}}
  \proofstep{2}{B^{\complement_M}\neq\varnothing}{\rAEb{5}}
  \proofstep{1,2}{\exists F\in B^{\complement_M}\,
    \forall G\in B^{\complement_M}\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{%
    \FormulaRefAuto{\TarskiFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
    \vdash \exists F\in B\,\forall G\in B\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{1,6,7}}
  \proofstep{1,2}{\exists F\in B\,\forall G\in B\,\bigl(G\subseteq F\rightarrow G=F\bigr)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep \exists U\in B^{\complement_M}\,\forall V\in B^{\complement_M}\,\bigl(U\subseteq V\rightarrow V=U\bigr)\vdash \exists X\in B\,\forall Y\in B\,\bigl(Y\subseteq X\rightarrow Y=X\bigr)}{3,8}}
  \proofstep{1}{%
    \bigl(B\subseteq \powerset(M)\land B\neq\varnothing\bigr)\rightarrow
    \exists F\in B\,\forall G\in B\,\bigl(G\subseteq F\rightarrow G=F\bigr)
  }{\rRI{2,9}}
  \proofstep{1}{\TarskiMinFinite(M)}{\FormulaRefAuto{minimal Tarski-endliche Menge}{10}}
\end{tabproof}

\FormulaThmDelta[Minimale Tarski-Endlichkeit impliziert Tarski-Endlichkeit]{%
...
\begin{tabproof}
  ...
  \proofstep{2}{B^{\complement_M}\neq\varnothing}{\rAEb{5}}
  \proofstep{1,2}{\exists F\in B^{\complement_M}\,
    \forall G\in B^{\complement_M}\,\bigl(G\subseteq F\rightarrow G=F\bigr)}{%
    \FormulaRefAuto{\TarskiMinFinite(M)\dsep B\subseteq \powerset(M)\dsep B\neq\varnothing
    \vdash \exists F\in B\,\forall G\in B\,\bigl(G\subseteq F\rightarrow G=F\bigr)}{1,6,7}}
  \proofstep{1,2}{\exists F\in B\,\forall G\in B\,\bigl(F\subseteq G\rightarrow G=F\bigr)}{%
    \FormulaRefAuto{B\subseteq \powerset(M)\dsep \exists U\in B^{\complement_M}\,\forall V\in B^{\complement_M}\,\bigl(V\subseteq U\rightarrow V=U\bigr)\vdash \exists X\in B\,\forall Y\in B\,\bigl(X\subseteq Y\rightarrow Y=X\bigr)}{3,8}}
  \proofstep{1}{%
    \bigl(B\subseteq \powerset(M)\land B\neq\varnothing\bigr)\rightarrow
    \exists F\in B\,\forall G\in B\,\bigl(F\subseteq G\rightarrow G=F\bigr)
  }{\rRI{2,9}}
  \proofstep{1}{\TarskiFinite(M)}{\FormulaRefAuto{Tarski-endliche Menge}{10}}
\end{tabproof}

\FormulaThmDelta[Äquivalenz der maximalen und minimalen Tarski-Endlichkeit]{%
...
\begin{tabproofsplit}
  \proofpart{\(\vdash\)}
    ...
    \proofstep{1}{\TarskiMinFinite(M)}{%
      \FormulaRefAuto{\TarskiFinite(M)\vdash \TarskiMinFinite(M)}{1}}
  \closeproofpart

  \proofpart{\(\dashv\)}
    \proofstep{1}{\TarskiMinFinite(M)}{\rA}
    \proofstep{1}{\TarskiFinite(M)}{%
      \FormulaRefAuto{\TarskiMinFinite(M)\vdash \TarskiFinite(M)}{1}}
  \closeproofpart
\end{tabproofsplit}

\FormulaThmDelta[Tarski-Minimalendlichkeit impliziert Endlichkeit]{%
  \TarskiMinFinite(M)\vdash \Finite{M}
}{%
  \DeltaDecl{Mengen}{M}%
}
\begin{tabproof}
...
\FormulaThmDelta[Endliche Mengen sind minimal Tarski-endlich]{%
  \Finite{M}\vdash \TarskiMinFinite(M)
}{%
  \DeltaDecl{Mengen}{M}%
}
\begin{tabproof}
  ...
  \proofstep{1}{\TarskiMinFinite(M)}{%
    \FormulaRefAuto{\TarskiFinite(M)\vdash \TarskiMinFinite(M)}{2}}
\end{tabproof}
...
\begin{tabproofsplit}
  \proofpart{\(\vdash\)}
    \proofstep{1}{\Finite{M}}{\rA}
    \proofstep{1}{\TarskiMinFinite(M)}{%
      \FormulaRefAuto{\Finite{M}\vdash \TarskiMinFinite(M)}{1}}
  \closeproofpart

  \proofpart{\(\dashv\)}
    \proofstep{1}{\TarskiMinFinite(M)}{\rA}
    \proofstep{1}{\Finite{M}}{%
      \FormulaRefAuto{\TarskiMinFinite(M)\vdash \Finite{M}}{1}}
  \closeproofpart
\end{tabproofsplit}
