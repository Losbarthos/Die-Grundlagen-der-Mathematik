...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \makecell[l]{%
      ...
      \\ \quad \FormulaRefAuto{F\colon A\to B \dsep X\in\powerset(A)\vdash \tPowMap{F}(X)\coloneqq F[X]}{1},%
      \\ \quad \FormulaRefAuto{F\colon A\to B \dsep X\in\powerset(A)\vdash \tPowMap{F}(X)\in\powerset(B)}{1}%
      \\ )%
    }%
  }
\end{tabproof}
