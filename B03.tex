...
\FormulaAxiomDelta[Ersetzung (Relationenform)]{
\forall x\in A\;\exists! y\;(x,y)\in R\;\vdash \; \exists C\;\forall y\;\bigl( y\in C\;\leftrightarrow\; \exists x\in A\;(x,y)\in R \bigr)
}{
...
\;\vdash\;\exists B\,\forall x \in A\,\exists z\bigl(B\cap x = \{z\}\bigr)
}{
\DeltaRow{Mengen}{A}
}
...
\FormulaAxiomAuto[Funktionale Eindeutigkeit]{(x,y)\in F,\, (x,z)\in F \vdash y=z}[Seien \(x\in A\) und \(y,z\in B\), dann gilt:]

\FormulaAxiomAuto[Totale Definition auf der Domäne]{\exists y\;(x,y)\in F}[Sei \(x\in A\), dann gilt:]

\FormulaDefAuto[Domäne]{\mathrm{dom}(F)\coloneqq A}%
[Sei \(F\colon A\to B\) eine Funktion. Dann definieren wir die Domäne von \(F\) durch:]

\FormulaDefAuto[Kodomäne]{\mathrm{cod}(F)\coloneqq B}%
...
\FormulaThmAuto[Eindeutigkeit des Funktionswertes]{\exists! y\;(x,y)\in F}[Sei \(F\colon A\to B\) eine Funktion und \(y\in A\), dann gilt:]
\begin{tabproof}
  \prooftext{Sei \(F\colon A\to B\) eine Funktion und \(y\in A\), dann gilt:}
  \proofstep{}{\exists y(x,y)\in F}{\FormulaRefAuto{\exists y\;(x,y)\in F}}
  \proofstep{2}{(x,y)\in F}{\rA}
  \proofstep{3}{(x,z)\in F}{\rA}
  \proofstep{2,3}{y=z}{\FormulaRefAuto{(x,y)\in F,\, (x,z)\in F \vdash y=z}{2,3}}
  \proofstep{}{\exists! y\in B(x,y)\in F}{\UEI{1,2,3,4}}
\end{tabproof}

\FormulaDefAuto[Auswertung]{F(x) \coloneqq \iota y\,\bigl((x,y)\in F\bigr)}[Für \(F\colon A\to B\) und \(x\in A\) definieren wir:]

\FormulaThmAuto{F(x)\in B}[Sei \(F\colon A\to B\) eine Funktion und \(x\in A\), dann gilt:]
\begin{tabproof}
  \proofstep{}{F\subseteq A\times B}{\FormulaRefAuto{F \subseteq A \times B}}
  \proofstep{}{(x,F(x))\in F}{\FormulaRefAuto{F(x) \coloneqq \iota y\,\bigl((x,y)\in F\bigr)}}
  \proofstep{}{(x,F(x))\in A\times B}{\FormulaRefAuto{ A\subseteq B,\, x\in A \vdash x\in B }{1,2}}
  \proofstep{}{F(x)\in B}{\FormulaRefAuto{(a,b)\in A\times B\vdash b\in B}{3}}
\end{tabproof}

\FormulaThmAuto{(x,y)\in F\vdash y=F(x)}[Sei \(F\colon A\to B\) eine Funktion mit \(x\in A\) und \(y\in B\), dann gilt:]
\begin{tabproof}
  \proofstep{1}{(x,y)\in F}{\rA}
  \proofstep{1}{(x,F(x))\in F}{\FormulaRefAuto{F(x) \coloneqq \iota y\,\bigl((x,y)\in F\bigr)}}
  \proofstep{1}{y=F(x)}{\FormulaRefAuto{(x,y)\in F,\, (x,z)\in F \vdash y=z}{1,2}}
\end{tabproof}

\FormulaThmAuto{(x,y)\in F\vdash F(x)=y}[Sei \(F\colon A\to B\) eine Funktion mit \(x\in A\) und \(y\in B\), dann gilt:]
\begin{tabproof}
  \proofstep{1}{(x,y)\in F}{\rA}
  \proofstep{1}{(x,F(x))\in F}{\FormulaRefAuto{F(x) \coloneqq \iota y\,\bigl((x,y)\in F\bigr)}}
  \proofstep{1}{y=F(x)}{\FormulaRefAuto{(x,y)\in F,\, (x,z)\in F \vdash y=z}{2,1}}
\end{tabproof}
...
\FormulaAxiomAuto[Injektivität (Werteform)]%
{F(x_1)=F(x_2)\ \vdash\ x_1=x_2}%
...
\FormulaAxiomAuto[Surjektivität (Werteform)]%
{\exists x\in A\; F(x)=y}%
...
\FormulaDefAuto[Inverse Relation]{%
