...
\begin{tabproof}
  ...
  \proofstep{1,2,3,6}{x=z}{%
    \FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{2,3,6}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3,7}{a=c}{\FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{1,4,5,10}}
  \proofstep{12}{b\notin F[A]}{\rA}
...
\begin{tabproof}
    \proofstep{}{\pi_1\colon A\times B\to A}{\FormulaRefAuto{Projektion auf die erste Komponente}}
...
\begin{tabproof}
    \proofstep{}{\pi_2\colon A\times B\to B}{\FormulaRefAuto{Projektion auf die zweite Komponente}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{x\in A}{\FormulaRefAuto{A\subseteq B, x\in A\vdash x\in B}{1,2}}
  \proofstep{1,3}{y\in A}{\FormulaRefAuto{A\subseteq B, x\in A\vdash x\in B}{1,3}}
...
\subsubsection{Folgenverschiebung entlang einer Einbettung}
...
\FormulaThmDelta[Die Einbettung ist eine Bijektion auf ihr Bild]{%
  H\colon \mathbb{N}\inj M \vdash H\colon \mathbb{N}\bij H[\mathbb{N}]
}{%
  \DeltaDecl{Mengen}{M}%
  \DeltaDecl{Funktionen}{H}%
}
...
\begin{tabproof}
  ...
  \proofstep{1}{H\colon \mathbb{N}\bij H[\mathbb{N}]}{%
    \FormulaRefAuto{H\colon \mathbb{N}\inj M \vdash H\colon \mathbb{N}\bij H[\mathbb{N}]}{1}}
  \proofstep{1}{H^{-1}\colon H[\mathbb{N}]\to \mathbb{N}}{%
    \FormulaRefAuto{F\colon A\bij B\vdash F^{-1}\colon B\to A}{3}}
  \proofstep{1,2}{H^{-1}(x)\in\mathbb{N}}{%
    \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}{4,2}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\exists k\in\mathbb{N}\,\bigl(H(n)=H(k)\bigr)}{%
    \rEI{\rAI{2,\rII}}}
  \proofstep{1,2}{H(n)\in H[\mathbb{N}]}{%
    \FormulaRefAuto{F\colon A\to B\dsep \exists x\in A\,y=F(x)\vdash y\in F[A]}{3,5}}
  \proofstep{1,2}{%
    \tSuccShift{H}(H(n))=H\bigl(\Succ(H^{-1}(H(n)))\bigr)
  }{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\in H[\mathbb{N}]
      \vdash \tSuccShift{H}(x)=H\bigl(\Succ(H^{-1}(x))\bigr)}{1,4,6}}
  \proofstep{1}{H\colon \mathbb{N}\bij H[\mathbb{N}]}{%
    \FormulaRefAuto{H\colon \mathbb{N}\inj M \vdash H\colon \mathbb{N}\bij H[\mathbb{N}]}{1}}
  \proofstep{1,2}{H^{-1}(H(n))=n}{%
    \FormulaRefAuto{x\in A \vdash F^{-1}(F(x)) = x}{2}}
...
\FormulaThmDelta[Typisierungsaxiom für $\tSuccShift{H}$]{%
  ...
  \forall x\in M\,\tSuccShift{H}(x)\in M
}{%
  \DeltaDecl{Mengen}{M\dsep x}%
  \DeltaDecl{Funktionen}{H}%
  \DeltaDecl{Funktionensymbol}{\tSuccShift{H}}%
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\tSuccShift{H}(x)\in M}{%
    \FormulaRefAuto{H\colon \mathbb{N}\inj M\dsep x\in M\vdash \tSuccShift{H}(x)\in M}{1,2}}
  \proofstep{1}{\forall x\in M\,\tSuccShift{H}(x)\in M}{%
    \rUI{\rRI{2,3}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{\forall x\in M\,\tSuccShift{H}(x)\in M}{%
    \FormulaRefAuto{H\colon \mathbb{N}\inj M\vdash
      \forall x\in M\,\tSuccShift{H}(x)\in M}{1}}
  \proofstep{1}{%
    \exists! S\colon M\to M\,\forall x\in M\,S(x)=\tSuccShift{H}(x)
  }{%
    \FormulaRefAuto{%
...
\FormulaThmDelta[Folgenglieder bleiben im Bild]{%
  ...
  \DeltaDecl{Mengen}{M\dsep n\dsep k}%
  \DeltaDecl{Funktionen}{H}%
}
\begin{tabproof}
  \proofstep{1}{H\colon \mathbb{N}\inj M}{\rA}
  ...
  \proofstep{2}{\Succ(n)\in\mathbb{N}}{%
    \FormulaRefAuto{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}{2}}
  \proofstep{1,2}{\exists k\in\mathbb{N}\,\bigl(H(\Succ(n))=H(k)\bigr)}{%
    \rEI{\rAI{4,\rII}}}
...
\begin{tabproof}
  ...
  \proofstep{}{\varnothing\in\mathbb{N}}{%
    \FormulaRefAuto{\varnothing\in\mathbb{N}}}
  \proofstep{}{\exists n\in\mathbb{N}\,\bigl(H(\varnothing)=H(n)\bigr)}{%
    \rEI{\rAI{3,\rII}}}
  \proofstep{1}{H(\varnothing)\in H[\mathbb{N}]}{%
    \FormulaRefAuto{F\colon A\to B\dsep \exists x\in A\,y=F(x)\vdash y\in F[A]}{2,4}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,5}{\Succ(n)=\varnothing}{%
    \FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{4,3,5}}
  \proofstep{2}{\Succ(n)\neq\varnothing}{%
    \FormulaRefAuto{x\in \mathbb{N}\vdash \Succ(x) \neq \varnothing}{2}}
...
\FormulaThmDelta[Bild-Bild-Injektivität der Folgenverschiebung]{%
  \begin{aligned}[t]
...
\begin{tabproof}
  ...
  \proofstep{4}{\SuccShift{H}(H(n))=\SuccShift{H}(H(k))}{\rA}
  \proofstep{1,2}{\SuccShift{H}(H(n))=H(\Succ(n))}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\vdash
      \SuccShift{H}(H(n))=H(\Succ(n))}{1,2}}
  \proofstep{1,3}{\SuccShift{H}(H(k))=H(\Succ(k))}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\vdash
      \SuccShift{H}(H(n))=H(\Succ(n))}{1,3}}
  \proofstep{1,2}{H(\Succ(n))=\SuccShift{H}(H(n))}{%
    \FormulaRefAuto{a=b\vdash b=a}{5}}
  \proofstep{1,2,3,4}{H(\Succ(n))=\SuccShift{H}(H(k))}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{7,4}}
  \proofstep{1,2,3,4}{H(\Succ(n))=H(\Succ(k))}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{8,6}}
  \proofstep{2}{\Succ(n)\in\mathbb{N}}{%
    \FormulaRefAuto{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}{2}}
  \proofstep{3}{\Succ(k)\in\mathbb{N}}{%
    \FormulaRefAuto{n\in\mathbb{N}\vdash \Succ(n)\in\mathbb{N}}{3}}
  \proofstep{1,2,3,4}{\Succ(n)=\Succ(k)}{%
    \FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{10,11,9}}
  \proofstep{2,3,4}{n=k}{%
    \FormulaRefAuto{%
      x\in\mathbb{N}\dsep y\in\mathbb{N}\dsep \Succ(x)=\Succ(y)\vdash x=y}{2,3,12}}
  \proofstep{2,3,4}{H(n)=H(k)}{\rIE{13,\rII}}
\end{tabproof}

\FormulaThmDelta[Außen-Bild-Widerspruch der Folgenverschiebung]{%
  \begin{aligned}[t]
    &H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
...
\begin{tabproof}
  ...
  \proofstep{5}{\SuccShift{H}(x)=\SuccShift{H}(H(n))}{\rA}
  \proofstep{1,2,3}{\SuccShift{H}(x)=x}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \vdash \SuccShift{H}(x)=x}{1,2,3}}
  \proofstep{1,4}{\SuccShift{H}(H(n))=H(\Succ(n))}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\vdash
      \SuccShift{H}(H(n))=H(\Succ(n))}{1,4}}
  \proofstep{1,2,3}{x=\SuccShift{H}(x)}{%
    \FormulaRefAuto{a=b\vdash b=a}{6}}
  \proofstep{1,2,3,4,5}{x=\SuccShift{H}(H(n))}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{8,5}}
  \proofstep{1,2,3,4,5}{x=H(\Succ(n))}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{9,7}}
  \proofstep{1,4}{H(\Succ(n))\in H[\mathbb{N}]}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}
      \vdash H(\Succ(n))\in H[\mathbb{N}]}{1,4}}
  \proofstep{1,2,3,4,5}{x\in H[\mathbb{N}]}{\rIE{10,11}}
  \proofstep{1,2,3,4,5}{\bot}{\rBI{12,3}}
\end{tabproof}

\FormulaThmDelta[Bild-Außen-Widerspruch der Folgenverschiebung]{%
  \begin{aligned}[t]
...
\begin{tabproof}
  ...
  \proofstep{3}{x\in M}{\rA}
  \proofstep{4}{x\notin H[\mathbb{N}]}{\rA}
  \proofstep{5}{\SuccShift{H}(H(n))=\SuccShift{H}(x)}{\rA}
  \proofstep{5}{\SuccShift{H}(x)=\SuccShift{H}(H(n))}{%
    \FormulaRefAuto{a=b\vdash b=a}{5}}
...
\FormulaThmDelta[Bild-Bild-Fall der Folgenverschiebung]{%
  \begin{aligned}[t]
...
\begin{tabproof}
  ...
  \proofstep{4}{x\in H[\mathbb{N}]}{\rA}
  \proofstep{5}{y\in H[\mathbb{N}]}{\rA}
  \proofstep{6}{\SuccShift{H}(x)=\SuccShift{H}(y)}{\rA}
  \proofstep{1}{H\colon \mathbb{N}\to M}{%
    \FormulaRefAuto{Injektive Funktion}{1}}
  \proofstep{1,4}{\exists n\in\mathbb{N}\,\bigl(x=H(n)\bigr)}{%
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash \exists x\in A\,y=F(x)}{7,4}}
  \proofstep{9}{n\in\mathbb{N}}{\rA}
  \proofstep{10}{x=H(n)}{\rA}
  \proofstep{1,5}{\exists k\in\mathbb{N}\,\bigl(y=H(k)\bigr)}{%
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash \exists x\in A\,y=F(x)}{7,5}}
  \proofstep{12}{k\in\mathbb{N}}{\rA}
  \proofstep{13}{y=H(k)}{\rA}
  \proofstep{6,10,13}{%
    \begin{aligned}[t]
      \SuccShift{H}(H(n))
      &=\SuccShift{H}(H(k))
    ...
    \rIE{10,\rIE{13,6}}}
  \proofstep{1,9,12,14}{H(n)=H(k)}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\dsep k\in\mathbb{N}\dsep
      \SuccShift{H}(H(n))=\SuccShift{H}(H(k))
      \vdash H(n)=H(k)}{1,9,12,14}}
  \proofstep{10,15}{x=H(k)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{10,15}}
  \proofstep{13}{H(k)=y}{\FormulaRefAuto{a=b\vdash b=a}{13}}
  \proofstep{1,6,9,10,12,13}{x=y}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{16,17}}
  \proofstep{1,5,6,9,10}{x=y}{\rEE{11,12,13,18}}
  \proofstep{1,4,5,6}{x=y}{\rEE{8,9,10,19}}
\end{tabproof}

\FormulaThmDelta[Bild-Außen-Fall der Folgenverschiebung]{%
  \begin{aligned}[t]
    &H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
  ...
  \DeltaDecl{Mengen}{M\dsep x\dsep y\dsep n}%
  \DeltaDecl{Funktionen}{H}%
  \DeltaDecl{Funktionensymbol}{\SuccShift{H}}%
}
\begin{tabproof}
  ...
  \proofstep{9}{n\in\mathbb{N}}{\rA}
  \proofstep{10}{x=H(n)}{\rA}
  \proofstep{6,10}{\SuccShift{H}(H(n))=\SuccShift{H}(y)}{%
    \rIE{10,6}}
  \proofstep{1,3,5,9,11}{\bot}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\dsep x\in M
      \dsep x\notin H[\mathbb{N}]\dsep
      \SuccShift{H}(H(n))=\SuccShift{H}(x)\vdash \bot}{1,9,3,5,11}}
  \proofstep{1,3,5,6,9,10}{x=y}{\rCE{12}}
  \proofstep{1,3,4,5,6}{x=y}{\rEE{8,9,10,13}}
\end{tabproof}

\FormulaThmDelta[Außen-Bild-Fall der Folgenverschiebung]{%
  \begin{aligned}[t]
    &H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
...
\begin{tabproof}
  ...
  \proofstep{1}{H\colon \mathbb{N}\to M}{%
    \FormulaRefAuto{Injektive Funktion}{1}}
  \proofstep{1,5}{\exists n\in\mathbb{N}\,\bigl(y=H(n)\bigr)}{%
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash \exists x\in A\,y=F(x)}{7,5}}
  \proofstep{9}{n\in\mathbb{N}}{\rA}
  \proofstep{10}{y=H(n)}{\rA}
  \proofstep{6,10}{\SuccShift{H}(x)=\SuccShift{H}(H(n))}{%
    \rIE{10,6}}
  \proofstep{1,2,4,9,11}{\bot}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \dsep n\in\mathbb{N}\dsep
      \SuccShift{H}(x)=\SuccShift{H}(H(n))\vdash \bot}{1,2,4,9,11}}
  \proofstep{1,2,4,6,9,10}{x=y}{\rCE{12}}
  \proofstep{1,2,4,5,6}{x=y}{\rEE{8,9,10,13}}
\end{tabproof}

\FormulaThmDelta[Außen-Außen-Fall der Folgenverschiebung]{%
  \begin{aligned}[t]
    &H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
...
\begin{tabproof}
  ...
  \proofstep{5}{y\notin H[\mathbb{N}]}{\rA}
  \proofstep{6}{\SuccShift{H}(x)=\SuccShift{H}(y)}{\rA}
  \proofstep{1,2,4}{\SuccShift{H}(x)=x}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \vdash \SuccShift{H}(x)=x}{1,2,4}}
  \proofstep{1,3,5}{\SuccShift{H}(y)=y}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \vdash \SuccShift{H}(x)=x}{1,3,5}}
  \proofstep{1,2,4}{x=\SuccShift{H}(x)}{%
    \FormulaRefAuto{a=b\vdash b=a}{7}}
  \proofstep{1,2,3,4,5,6}{x=\SuccShift{H}(y)}{%
...
\begin{tabproof}
  ...
  \proofstep{2}{x\in M}{\rA}
  \proofstep{3}{y\in M}{\rA}
  \proofstep{4}{\SuccShift{H}(x)=\SuccShift{H}(y)}{\rA}
  \proofstep{}{x\in H[\mathbb{N}]\lor x\notin H[\mathbb{N}]}{%
    \FormulaRefAuto{P\lor \neg P}}

  \proofstep{6}{x\in H[\mathbb{N}]}{\rA}
  \proofstep{}{y\in H[\mathbb{N}]\lor y\notin H[\mathbb{N}]}{%
    \FormulaRefAuto{P\lor \neg P}}
  \proofstep{8}{y\in H[\mathbb{N}]}{\rA}
  \proofstep{1,2,3,4,6,8}{x=y}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
      \dsep x\in H[\mathbb{N}]\dsep y\in H[\mathbb{N}]\dsep
      \SuccShift{H}(x)=\SuccShift{H}(y)\vdash x=y}{1,2,3,6,8,4}}
  \proofstep{10}{y\notin H[\mathbb{N}]}{\rA}
  \proofstep{1,2,3,4,6,10}{x=y}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
      \dsep x\in H[\mathbb{N}]\dsep y\notin H[\mathbb{N}]\dsep
      \SuccShift{H}(x)=\SuccShift{H}(y)\vdash x=y}{1,2,3,6,10,4}}
  \proofstep{1,2,3,4,6}{x=y}{\rOE{7,8,9,10,11}}

  \proofstep{13}{x\notin H[\mathbb{N}]}{\rA}
  \proofstep{}{y\in H[\mathbb{N}]\lor y\notin H[\mathbb{N}]}{%
    \FormulaRefAuto{P\lor \neg P}}
  \proofstep{15}{y\in H[\mathbb{N}]}{\rA}
  \proofstep{1,2,3,4,13,15}{x=y}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
      \dsep x\notin H[\mathbb{N}]\dsep y\in H[\mathbb{N}]\dsep
      \SuccShift{H}(x)=\SuccShift{H}(y)\vdash x=y}{1,2,3,13,15,4}}
  \proofstep{17}{y\notin H[\mathbb{N}]}{\rA}
  \proofstep{1,2,3,4,13,17}{x=y}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep y\in M
      \dsep x\notin H[\mathbb{N}]\dsep y\notin H[\mathbb{N}]\dsep
      \SuccShift{H}(x)=\SuccShift{H}(y)\vdash x=y}{1,2,3,13,17,4}}
  \proofstep{1,2,3,4,13}{x=y}{\rOE{14,15,16,17,18}}

  \proofstep{1,2,3,4}{x=y}{\rOE{5,6,12,13,19}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,3,4}{\SuccShift{H}(x)=\SuccShift{H}(y)\rightarrow x=y}{%
    \rRI{5,6}}
  \proofstep{1,3}{%
    \forall y\in M\,\bigl(\SuccShift{H}(x)=\SuccShift{H}(y)\rightarrow x=y\bigr)
  }{\rUI{\rRI{4,7}}}
  \proofstep{1}{%
    \forall x\in M\,\forall y\in M\,
      \bigl(\SuccShift{H}(x)=\SuccShift{H}(y)\rightarrow x=y\bigr)
  }{\rUI{\rRI{3,8}}}
  \proofstep{1}{\SuccShift{H}\colon M\inj M}{%
    \FormulaRefAuto{Injektive Funktion}{2,9}}
\end{tabproof}

\FormulaThmDelta[Bildfall gegen den Anfangspunkt]{%
  H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}
...
\begin{tabproof}
  \proofstep{1}{H\colon \mathbb{N}\inj M}{\rA}
  \proofstep{2}{n\in\mathbb{N}}{\rA}
  \proofstep{3}{\SuccShift{H}(H(n))=H(\varnothing)}{\rA}
  \proofstep{1,2}{\SuccShift{H}(H(n))=H(\Succ(n))}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}\vdash
      \SuccShift{H}(H(n))=H(\Succ(n))}{1,2}}
  \proofstep{1,2}{H(\Succ(n))=\SuccShift{H}(H(n))}{%
    \FormulaRefAuto{a=b\vdash b=a}{4}}
  \proofstep{1,2,3}{H(\Succ(n))=H(\varnothing)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{5,3}}
  \proofstep{1,2}{H(\Succ(n))\neq H(\varnothing)}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}
      \vdash H(\Succ(n))\neq H(\varnothing)}{1,2}}
  \proofstep{1,2,3}{\bot}{\rBI{6,7}}
\end{tabproof}

\FormulaThmDelta[Außenfall gegen den Anfangspunkt]{%
  H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
...
\begin{tabproof}
  ...
  \proofstep{2}{x\in M}{\rA}
  \proofstep{3}{x\notin H[\mathbb{N}]}{\rA}
  \proofstep{4}{\SuccShift{H}(x)=H(\varnothing)}{\rA}
  \proofstep{1,2,3}{\SuccShift{H}(x)=x}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \vdash \SuccShift{H}(x)=x}{1,2,3}}
  \proofstep{1,2,3}{x=\SuccShift{H}(x)}{%
    \FormulaRefAuto{a=b\vdash b=a}{5}}
  \proofstep{1,2,3,4}{x=H(\varnothing)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{6,4}}
  \proofstep{1}{H(\varnothing)\in H[\mathbb{N}]}{%
    \FormulaRefAuto{H\colon \mathbb{N}\inj M \vdash H(\varnothing)\in H[\mathbb{N}]}{1}}
  \proofstep{1,2,3,4}{x\in H[\mathbb{N}]}{\rIE{7,8}}
  \proofstep{1,2,3,4}{\bot}{\rBI{9,3}}
\end{tabproof}
...
\begin{tabproof}
  \proofstep{1}{H\colon \mathbb{N}\inj M}{\rA}
  \proofstep{2}{x\in M}{\rA}
  \proofstep{3}{\SuccShift{H}(x)=H(\varnothing)}{\rA}
  \proofstep{}{x\in H[\mathbb{N}]\lor x\notin H[\mathbb{N}]}{%
    \FormulaRefAuto{P\lor \neg P}}

  \proofstep{5}{x\in H[\mathbb{N}]}{\rA}
  \proofstep{1}{H\colon \mathbb{N}\to M}{%
    \FormulaRefAuto{Injektive Funktion}{1}}
  \proofstep{1,5}{\exists n\in\mathbb{N}\,\bigl(x=H(n)\bigr)}{%
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash \exists x\in A\,y=F(x)}{6,5}}
  \proofstep{8}{n\in\mathbb{N}}{\rA}
  \proofstep{9}{x=H(n)}{\rA}
  \proofstep{3,9}{\SuccShift{H}(H(n))=H(\varnothing)}{\rIE{9,3}}
  \proofstep{1,8,10}{\bot}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep n\in\mathbb{N}
      \dsep \SuccShift{H}(H(n))=H(\varnothing)\vdash \bot}{1,8,10}}
  \proofstep{1,3,5}{\bot}{\rEE{7,8,9,11}}

  \proofstep{13}{x\notin H[\mathbb{N}]}{\rA}
  \proofstep{1,2,3,13}{\bot}{%
    \FormulaRefAuto{%
      H\colon \mathbb{N}\inj M\dsep x\in M\dsep x\notin H[\mathbb{N}]
      \dsep \SuccShift{H}(x)=H(\varnothing)\vdash \bot}{1,2,13,3}}

  \proofstep{1,2,3}{\bot}{\rOE{4,5,12,13,14}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,6}{\exists x\in M\,\SuccShift{H}(x)=H(\varnothing)}{%
    \FormulaRefAuto{F\colon A\sur B \dsep y\in B \vdash \exists x\in A\,F(x)=y}{6,5}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Fall \(M\neq\varnothing\)]{%
    ...
    \proofstepwidestar[1,5,11]{F(H(y))=y}{%
      \FormulaRefAuto{x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{9,14,11,13}}
