...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[\(\leftarrow\)]{%
    ...
    \proofstepwidestar[1]{\ReverseEdges{E}=\{(u,v)\in V\times V\mid(v,u)\in E\}}{%
      \FormulaRefAuto{DirectedReverseEdgeRelationDef}[def]{1}}
    \proofstepwidestar[1]{%
      \{(u,v)\in V\times V\mid(v,u)\in E\}=\ReverseEdges{E}}{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{%
        7}}
    \proofstepwidestar[1,2,3,4]{(x,y)\in\ReverseEdges{E}}{\rIE{8,6}}
    \proofstepwidestar[1,2,3]{%
      (y,x)\in E\rightarrow(x,y)\in\ReverseEdges{E}}{\rRI{4,9}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[\(\leftarrow\)]{%
    ...
    \proofstepwidestar[1,2]{E\cap(U\times U)=\DirectedInducedEdges{E}{U}}{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{%
        9}}
    \proofstepwidestar[1,2,3]{(x,y)\in\DirectedInducedEdges{E}{U}}{\rIE{10,8}}
    \proofstepwidestarbreak[1,2]{%
      \bigl((x,y)\in E\land x\in U\land y\in U\bigr)
      \rightarrow(x,y)\in\DirectedInducedEdges{E}{U}}{\rRI{3,11}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwide{Folgentypisierung und Startindex}
  \proofstepwidestar[1]{\GraphStruct{V,E}}{\rA}
  \proofstepwidestar[2]{\DirectedWalk{V}{E}{p}{n}}{\rA}
  \proofstepwidestar[1,2]{%
    \begin{aligned}[t]
  ...
  \proofpartwide{Endindex und Endpunkttypisierung}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{%
    \begin{aligned}[t]
      &u\in V\land v\in V\land\Bigl(u=v\lor{}\\[-2pt]
      &\exists n\in\mathbb N\,\exists p\,{}\\[-2pt]
      &\quad(\DirectedWalk{V}{E}{p}{n}\land p(0)=u\land p(n)=v)\Bigr)
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{%
    \begin{aligned}[t]
      ...
      &\exists n\in\mathbb N\,\exists p\,{}\\[-2pt]
      &\quad(\DirectedWalk{V}{E}{p}{n}\land p(0)=u\land p(n)=u)\Bigr)
    \end{aligned}}{%
