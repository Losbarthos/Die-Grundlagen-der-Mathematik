...
\title{Bd. 19 - Kommutative Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{19}

\hypersetup{
  pdftitle={Bd. 19 - Kommutative Halbgruppen},
...
Forderung, dass \(p\) nicht jedes Element teilt. Nach der in Band~18
