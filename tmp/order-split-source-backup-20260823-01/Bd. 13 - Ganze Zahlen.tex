...
\FormulaDefDeltaK[Nachfolger einer ganzen Zahl]{%
  \begin{aligned}[t]
    ...
    &\forall z\in\mathbb Z\,
      \bigl(\IntSucc(z)\coloneqq z+1_{\mathbb Z}\bigr)
  \end{aligned}%
}{IntegerSuccessorDef}{%
  \DeltaRow{Mengen}{z}%
...
\begin{tabproof}
  ...
  \proofstep{}{\forall z\in\mathbb Z\,\bigl(z+1_{\mathbb Z}\in\mathbb Z\bigr)}{%
    \rUI{\rRI{1,3}}}
\end{tabproof}
...
\FormulaDefDeltaK[Vorgänger einer ganzen Zahl]{%
  \begin{aligned}[t]
    ...
    &\forall z\in\mathbb Z\,
      \bigl(\IntPred(z)\coloneqq z+(-1_{\mathbb Z})\bigr)
  \end{aligned}%
...
\begin{tabproof}
  ...
  \proofstep{1}{z+(-1_{\mathbb Z})\in\mathbb Z}{%
    \FormulaRefAuto{IntAddClosure}[thm]{1,3}}
  \proofstep{}{%
    \forall z\in\mathbb Z\,\bigl(z+(-1_{\mathbb Z})\in\mathbb Z\bigr)}{%
    \rUI{\rRI{1,4}}}
\end{tabproof}
...
\FormulaThmDeltaK[Grundgleichung des ganzzahligen Nachfolgers]{%
  z\in\mathbb Z\vdash \IntSucc(z)=z+1_{\mathbb Z}%
...
\begin{tabproof}
  ...
  \proofstep{}{%
    \forall u\in\mathbb Z\,
      \bigl(\IntSucc(u)=u+1_{\mathbb Z}\bigr)}{%
    \FormulaRefAuto{IntegerSuccessorDef}[def]}
...
\FormulaThmDeltaK[Grundgleichung des ganzzahligen Vorgängers]{%
  z\in\mathbb Z\vdash \IntPred(z)=z+(-1_{\mathbb Z})%
...
\begin{tabproof}
  ...
  \proofstep{}{%
    \forall u\in\mathbb Z\,
      \bigl(\IntPred(u)=u+(-1_{\mathbb Z})\bigr)}{%
    \FormulaRefAuto{IntegerPredecessorDef}[def]}
...
\begin{tabproof}
  ...
  \proofstep{}{\forall z\in\mathbb Z\,\bigl(\IntSucc(z)=z+1_{\mathbb Z}\bigr)}{%
    \FormulaRefAuto{IntegerSuccessorDef}[def]}
...
\begin{tabproof}
  ...
  \proofstep{1}{\IntClass{a}{b}\in\mathbb Z}{%
    \FormulaRefAuto{IntegerClassInZ}{1}}
  \proofstep{}{%
    \forall z\in\mathbb Z\,\bigl(\IntPred(z)=z+(-1_{\mathbb Z})\bigr)}{%
    \FormulaRefAuto{IntegerPredecessorDef}[def]}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[5]{z\leq w}{\rA}
    \proofstepwidestar[6]{w\leq u}{\rA}
    \proofstepwidestar[2,3,4,5,6]{z\leq u}{%
      \FormulaRefAuto{IntegerOrderTransitive}[thm]{2,3,4,5,6}}
    \proofstepwidestar[8]{w\leq z}{\rA}
    \proofstepwidestar[2,3,5,8]{z=w}{%
      \FormulaRefAuto{IntegerOrderAntisymmetric}[thm]{2,3,5,8}}
    \proofstepwidestar[]{\PartOrd{\mathbb Z,\leq_{\mathbb Z}}}{%
      \FormulaRefAuto{Partielle Ordnung}[def]{1,7,9}}
    \proofstepwidestar[2,3]{z\leq w\lor w\leq z}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestar[10]{P(0_{\mathbb Z})}{\rA}
