...
\begin{tabproof}
  ...
  \proofstep{1}{F^{-1}(F(x))=x}{%
    \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}{%
      \FormulaRefAuto{F\colon A\bij B \vdash F\colon A\inj B},8,1,9}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1}{\forall y\in B\,\Bigl(G(y)=F^{-1}(y)\Bigr)}{\rUI{\rRI{2,7}}}
...
\begin{tabproofwide}
    ...
    \proofstepwide[1,2]{}{=}{G\circ (F\circ F^{-1})}{\rIE{\FormulaRefAuto{F\circ F^{-1} = \Id_B}{3},7}}
    ...
    \proofstepwide[1,2]{}{=}{\Id_B\circ F^{-1}}{\rIE{2,9}}
    \proofstepwide[1,2]{}{=}{F^{-1}}{\FormulaRefAuto{\Id_B\circ F = F}}
    \proofstepwide[1,2]{G}{=}{F^{-1}}{\rChain{7,11}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestarbreakkeep[1,2,3,9]{\exists H\in\CoreFamily{P}{A}\,
      \CoreTransport{P}{Q}{f}(H)=J}{%
...
\begin{tabproofwide}
  ...
  \CoreProofStepWideStarBreak[1]{%
    ...
    \FormulaRefAuto{LayerPowerMapDef}[def]{1}}
  \proofstepwidestar[4]{X\in\powerset(A\cup D)}{\rA}
  \CoreProofStepWideStarBreak[1,4]{\LayerPowerMap{A}{D}{E}{g}(X)=
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[4,7]{%
    \begin{aligned}[t]
  ...
  \proofstepwidestarbreakkeep[1,2,3,4,5,6]{%
    ...
    \end{aligned}}{\rChain{10,\rLRS{8},\rLRS{9},\rLRS{12}}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestarbreakkeep[1,2,3,9]{\exists X\in\powerset(A\cup D)\,
      \LayerPowerMap{A}{D}{E}{g}(X)=Z}{%
...
\begin{tabproofwide}
  \proofstepwidestar[1]{A\cap D=\varnothing}{\rA}
  \proofstepwidestar[2]{g\colon\powerset(D)\to\powerset(E)}{\hspace{0.8em}\rA}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Hinrichtung]{%
    ...
    \proofstepwidestar[3]{g(\varnothing)=\varnothing}{\rA}
    \proofstepwidestar[4]{L\subseteq A}{\rA}
    \proofstepwidestar[5]{X\in\powerset(A\cup D)}{\hspace{0.8em}\rA}
    \proofstepwidestar[6]{X\subseteq L}{\rA}
    \proofstepwidestarbreakkeep[1,2,3,4,5,6]{\LayerPowerMap{A}{D}{E}{g}(X)=X}{%
