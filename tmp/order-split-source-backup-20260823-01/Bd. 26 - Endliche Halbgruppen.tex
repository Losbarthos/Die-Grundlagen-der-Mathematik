...
\title{Bd. 26 - Endliche Halbgruppen}
\author{Martin Kunze}
\date{}
\setcounter{file}{26}

\hypersetup{
  pdftitle={Bd. 26 - Endliche Halbgruppen},
...
Potenzen und die Existenz von Idempotenten.  Die Idealtheorie aus Band~18
...
Band~18 zur Verfügung.  Die Endlichkeit wird nun nur noch an den Stellen
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{\Pred(r),\Pred(s)\in\mathbb N}{%
    \rAI{\FormulaRefAuto{PeanoPredNatural}[thm]{\rAEa{1}},
      \FormulaRefAuto{PeanoPredNatural}[thm]{\rAEb{1}}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{\Pred(s)\in\mathbb N}{%
    \FormulaRefAuto{PeanoPredNatural}[thm]{\rAEa{1}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[5]{\Pred(r)\in\mathbb N}{%
    \FormulaRefAuto{PeanoPredNatural}[thm]{5}}
  \proofstepwidestarbreak[6]{\Pred(s)\in\mathbb N}{%
...
Band~18 übersetzt daher die Gleichheit der Potenzfolgenwerte in
...
Band~18 verschiebt sie auf alle späteren Exponenten.  Ab dem Index läuft die
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2]{\Pred(\lambda)\in\mathbb N}{%
    \FormulaRefAuto{PeanoPredNatural}[thm]{2}}
...
Kürzbarkeit und die in Band~18 eingeführten Teilbarkeitsrelationen
...
Halbgruppe.  Diese Begriffe werden in den Bänden~27, 29 und~30 formal
...
Die in Band~18 bewiesene umgekehrte Richtung gilt sogar ohne Endlichkeit:
...
\begin{itemize}
  \item Ohne Endlichkeitsvoraussetzung ist die allgemeine Aussage falsch.
    Das in Band~18 vollständig ausgeführte Gegenbeispiel geht zurück auf
...
Unterhalbgruppe aus Band~18 gilt
\[
...
beidseitiges Inverses.  In der erst in Band~29 formal eingeführten
