...
axiomatisiert. Die spätere allgemeine Ordnungstheorie fasst die hier einzeln
...
% von \(\mathbb{N}\) enthält. Band~16 verwendet diesen Satz in der
...
späteren Band~17 als Folgen in \(M\) eingeordnet. An dieser Stelle wird nur
...
erst im späteren Band über Ordnungsrelationen vorgenommen.
...
\begin{tabproof}
  ...
  \proofstep{4}{y\in\mathbb{N}}{\rA}
  \proofstep{5}{z\in\mathbb{N}}{\rA}
  \proofstep{6}{n=\Succ(y)}{\rA}
  \proofstep{7}{n=\Succ(z)}{\rA}
  \proofstep{6,7}{\Succ(y)=\Succ(z)}{%
    \FormulaRefAuto{a=b\dsep a=c\vdash b=c}[thm]{6,7}}
  \proofstep{4,5,6,7}{y=z}{%
    \FormulaRefAuto{PeanoSuccInjective}[ax]{4,5,8}}
  \proofstep{1,2}{\exists! y\in\mathbb{N}\,\bigl(n=\Succ(y)\bigr)}{%
    \UEI{3,4,5,6,7,9}}
\end{tabproof}

Die folgende Typisierung des Fallterms erfuellt die Voraussetzung von
Theorem \FormulaRefAuto{TypedFunctionDefinitionPrinciple}[thm]. Daher wird
\(\Pred\) unmittelbar als Funktion mit ihrer Grundgleichung eingefuehrt.
...
\begin{tabproof}
  ...
  \proofstep{3}{n=0}{\rA}
  \proofstep{3}{%
    \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}=0}{%
  ...
  \proofstep{1,7}{%
    \begin{aligned}[t]
      &\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)\in\mathbb{N}\land{}\\[-2pt]
      &n=\Succ\!\left(\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)\right)
    \end{aligned}%
  }{\FormulaRefAuto{PeanoUniquePredecessor}[thm]{1,7}}
  \proofstep{1,7}{%
    \iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)\in\mathbb{N}}{%
    \rAEa{8}}
  \proofstep{7}{%
    \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}
    =\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}{%
    \FormulaRefAuto{\neg P\vdash\IfThenElse{P}{a}{b}=b}[thm]{7}}
  \proofstep{1,7}{%
    \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}
    \in\mathbb{N}}{\rIE{10,9}}

  \proofstep{1}{%
    \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}
    \in\mathbb{N}}{\rOE{2,3,6,7,11}}
  \proofstep{}{%
    \forall n\in\mathbb{N}\,\Bigl(
      \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}
      \in\mathbb{N}
...
\begin{tabproof}
  ...
  \proofstep{}{%
    \forall u\in\mathbb{N}\,\Bigl(
      \Pred(u)=
      \IfThenElse{u=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land u=\Succ(y)\bigr)}
    \Bigr)}{%
    \FormulaRefAuto{PeanoPred}[def]}
  \proofstep{1}{%
    \Pred(\Succ(n))=
    \IfThenElse{\Succ(n)=0}{0}{%
      \iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)}}{%
    \rRE{\rUE{4},2}}
  \proofstep{1}{%
    \IfThenElse{\Succ(n)=0}{0}{%
      \iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)}
  ...
  \proofstep{1}{%
    \begin{aligned}[t]
      &\iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)
        \in\mathbb{N}\land{}\\[-2pt]
      &\Succ(n)=\Succ\!\left(
        \iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)
      \right)
    \end{aligned}%
  }{\FormulaRefAuto{PeanoUniquePredecessor}[thm]{2,3}}
  \proofstep{1}{%
    \iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)
    \in\mathbb{N}}{\rAEa{8}}
  \proofstep{1}{%
    ...
    \right)}{\rAEb{8}}
  \proofstep{1}{%
    n=\iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)}{%
    \FormulaRefAuto{PeanoSuccInjective}[ax]{1,9,10}}
  \proofstep{1}{%
    \iota y\,\bigl(y\in\mathbb{N}\land \Succ(n)=\Succ(y)\bigr)=n}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{11}}
  \proofstep{1}{\Pred(\Succ(n))=n}{%
    \FormulaRefAuto{a=b\dsep b=c\vdash a=c}[thm]{7,12}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{2}{%
    \IfThenElse{n=0}{0}{\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}
    =\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}{%
    \FormulaRefAuto{\neg P\vdash\IfThenElse{P}{a}{b}=b}[thm]{2}}
  \proofstep{1,2}{%
    \Pred(n)=\iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)}{%
    \FormulaRefAuto{a=b\dsep b=c\vdash a=c}[thm]{4,5}}
  \proofstep{1,2}{%
    \iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)=\Pred(n)}{%
  ...
  \proofstep{1,2}{%
    \begin{aligned}[t]
      ...
      \right)
    \end{aligned}%
  }{\FormulaRefAuto{PeanoUniquePredecessor}[thm]{1,2}}
  \proofstep{1,2}{%
    n=\Succ\!\left(
      \iota y\,\bigl(y\in\mathbb{N}\land n=\Succ(y)\bigr)
    \right)}{\rAEb{8}}
  \proofstep{1,2}{n=\Succ(\Pred(n))}{\rIE{7,9}}
\end{tabproof}
...
Folgenterminologie erfolgen erst in Band~17.
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Bildfall]{%
    ...
    \proofstepwidestar[6]{\Pred(n)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoPredNatural}[thm]{7}}
...
abstrakte Klassifikation wird im späteren Ordnungsband nachgeholt.
...
Halbringstrukturen erfolgt in den Bänden~27 und~28.
