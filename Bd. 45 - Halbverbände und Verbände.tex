%============================================================
%  Bd. 45 - Halbverbände und Verbände
%============================================================

\documentclass[main.tex]{subfiles}

\ifSubfilesClassLoaded{
  \BandSetupStandalone{B45}
}{
}

\title{Bd. 45 - Halbverbände und Verbände}
\author{Martin Kunze}
\date{}
\setcounter{file}{45}

\hypersetup{
  pdftitle={Bd. 45 - Halbverbände und Verbände},
...
\tableofcontents
\setcounter{file}{45}
\renewcommand{\FormulaBandID}{45}
\newcommand{\ProofRefStack}[1]{%
  \ensuremath{\begin{gathered}[t]#1\end{gathered}}}

\chapter{Einleitung}

Ausgehend von den kommutativen idempotenten Halbgruppen aus Band~32 und der allgemeinen Ordnungstheorie
in den Bänden~12--15 werden Halbverbände und Verbände algebraisch aufgebaut. Ein
...
Die Bände~12 und~13 entwickeln partielle Ordnungen sowie obere und untere Schranken,
...
\begin{tabproofsplitwide}
  \proofpartwide{Funktionstypisierung der Komposition}
  \proofstepwidestar[1]{%
  ...
  \proofpartwide{Erhaltung der Halbverbandsoperation}
...
\begin{tabproofsplitwide}
  ...
  \proofstepwidestar[6]{x\InducedLeq y}{\rA}
  \proofstepwidestar[7]{y\InducedLeq z}{\rA}
  \proofstepwidestar[1,2,4,5,6,7]{x\InducedLeq z}{%
    \FormulaRefAuto{JoinOrderTransitive}[thm]{1,6,7}}
  \closeproofpartwide

  \proofpartwide{Antisymmetrie und Ordnungsstruktur}
  \setcounter{proofstepnr}{8}
  \proofstepwidestar[9]{y\InducedLeq x}{\rA}
  \proofstepwidestar[1,6,9]{x=y}{%
    \FormulaRefAuto{JoinOrderAntisymmetric}[thm]{1,6,9}}
...
Band~13 definiert das Supremum bereits für jede Teilmenge \(T\subseteq A\).
...
\begin{tabproofsplitwide}
  \proofpartwide{Eigenschaft als obere Schranke}
  \proofstepwidestar[1]{\Semi{A}}{\rA}
  \proofstepwidestar[2]{x\in A}{\rA}
  \proofstepwidestar[3]{y\in A}{\rA}
  \proofstepwidestar[1]{\PartOrd{A,\InducedLeq}}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,3,4,5]{(x\NeutralSemiOp{}y)\NeutralSemiOp{}z=\sup_{A,\leq}(\{x\NeutralSemiOp{}y,z\})}{%
      \FormulaRefAuto{PairJoinEvaluationAxiom}[ax]{2,6,5}}
  \proofstepwidestar[2,3,4,5]{%
    \begin{aligned}[t]
    ...
    \ProofRefStack{%
      \rIE{16,21}}}
  \proofstepwidestar[2,3,4,5]{x\NeutralSemiOp(y\NeutralSemiOp{}z)=\sup_{A,\leq}(\{x,y\NeutralSemiOp{}z\})}{%
      \FormulaRefAuto{PairJoinEvaluationAxiom}[ax]{2,3,7}}
  \proofstepwidestar[2,3,4,5]{%
    \begin{aligned}[t]
  ...
  \proofstepwidestar[2,3,4,5]{%
    \sup_{A,\leq}\bigl(\{x,\sup_{A,\leq}(\{y,z\})\}\bigr)
      =x\NeutralSemiOp\bigl(y\NeutralSemiOp{}z\bigr)}{%
    \FormulaRefAuto{a=b\vdash b=a}{24}}
  \proofstepwidestar[1,2,3,4,5]{%
    \bigl(x\NeutralSemiOp{}y\bigr)\NeutralSemiOp{}z
      =x\NeutralSemiOp\bigl(y\NeutralSemiOp{}z\bigr)}{%
    \rChain{22,20,25}}
...
\begin{tabproofsplitwide}
  \proofpartwide{\(\vdash\)}
    ...
    \proofstepwidestar[1,2,3,4,5]{\Semi{A,\NeutralSemiOp}}{%
      \FormulaRefAuto{PairJoinCharacterization}[thm]{1,2}}
    \proofstepwidestar[1,2,3,4,5]{x\InducedLeq y\leftrightarrow x\NeutralSemiOp{}y=y}{%
      \FormulaRefAuto{JoinOrderEvaluationAxiom}[ax]{%
          10,3,4}}
  ...
  \proofpartwide{\(\dashv\)}
    ...
    \proofstepwidestar[2,3,4,5]{x\leq y}{\rIE{7,8}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
für ihre in Band~12 definierte duale partielle Ordnung unmittelbar die
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3]{x\OmittedSemiOp{}y=y\OmittedSemiOp{}x}{%
      \FormulaRefAuto{SemilatticeCommutativityAxiom}[ax]{1,2,3}}
  \proofstepwide[1,2,3]{y\OmittedSemiOp{}x=x}{\leftrightarrow}{x\OmittedSemiOp{}y=x}{%
    \rLRS{6,5}}
\end{tabproofwide}

Band~13 definiert das Infimum bereits für jede Teilmenge \(T\subseteq A\).
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{x\InducedLeq x\OmittedSemiOp{}y}{%
    \FormulaRefAuto{JoinUpperLeft}[thm]{1,2,3}}
  \proofstep{1,2,3}{(x\OmittedSemiOp{}y)\InducedGeq x\leftrightarrow x\InducedLeq(x\OmittedSemiOp{}y)}{%
      \FormulaRefAuto{OrderDualRelation}[def]{4,2}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{y\InducedLeq x\OmittedSemiOp{}y}{%
    \FormulaRefAuto{JoinUpperRight}[thm]{1,2,3}}
  \proofstep{1,2,3}{(x\OmittedSemiOp{}y)\InducedGeq y\leftrightarrow y\InducedLeq(x\OmittedSemiOp{}y)}{%
      \FormulaRefAuto{OrderDualRelation}[def]{4,3}}
...
\begin{tabproofsplitwide}
  \proofpartwide{Obere Schranke in der supremalen Ordnung}
  \proofstepwidestar[1]{\Semi{A}}{\rA}
  \proofstepwidestar[2]{x\in A}{\rA}
  \proofstepwidestar[3]{y\in A}{\rA}
  \proofstepwidestar[1]{\PartOrd{A,\InducedLeq}}{%
  ...
  \proofpartwide{Paarinfimum in der dualen Ordnung}
...
\begin{tabproofsplitwide}
  \proofpartwide{Erhaltung des Infimums}
  \proofstepwidestar[1]{%
    \LatticeHom{f;A,\MeetOp_A,\JoinOp_A;B,\MeetOp_B,\JoinOp_B}}{\rA}
  \proofstepwidestar[2]{%
  ...
  \proofpartwide{Erhaltung des Supremums}
  ...
  \proofpartwide{Trägerabbildung und Verbandshomomorphismus}
  \setcounter{proofstepnr}{8}
  \proofstepwidestar[1]{\LatticeAlg{A,\MeetOp_A,\JoinOp_A}}{%
    \FormulaRefAuto{LatticeHomSourceAxiom}[ax]{1}}
...
\begin{tabproofsplitwide}
  \proofpartwide{Halbverbandsaxiome des Durchschnitts}
    \proofstepwidestar[1]{X\in\powerset(S)}{\rA}
    \proofstepwidestar[2]{Y\in\powerset(S)}{\rA}
    \proofstepwidestar[3]{Z\in\powerset(S)}{\rA}
    \proofstepwidestar[1,2]{X\cap Y\in\powerset(S)}{%
  ...
  \proofpartwide{Halbverbandsaxiome der Vereinigung}
  \setcounter{proofstepnr}{8}
    \proofstepwidestar[1,2]{X\cup Y\in\powerset(S)}{%
      \FormulaRefAuto{PowerSetUnionClosure}[thm]{1,2}}
    \proofstepwidestar[1,2,3]{(X\cup Y)\cup Z=X\cup(Y\cup Z)}{%
  ...
  \proofpartwide{Absorption und Verbandsstruktur}
  \setcounter{proofstepnr}{12}
    ...
    \proofstepwidestar[]{\LatticeAlg{\powerset(S),\cap,\cup}}{%
      \FormulaRefAuto{AlgebraicLattice}[def]{4,5,6,8,9,10,11,12,13,14}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{0\InducedLeq x}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{6,4}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{0\in\LB_{A,\InducedLeq}(\{x,y\})\leftrightarrow(0\in A\land 0\InducedLeq x\land 0\InducedLeq y)}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{\Semi{A,\JoinOp}}{%
    \FormulaRefAuto{ZeroJoinBaseSemilatticeAxiom}[ax]{1}}
  \proofstepwidestar[4]{d\in\LB_{A,\InducedLeq}(\{x,y\})\leftrightarrow(d\in A\land d\InducedLeq x\land d\InducedLeq y)}{%
      \FormulaRefAuto{PairLowerBoundSetCharacterization}[thm]}
  \proofstepwidestar[4]{%
    ...
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      7,4}}
  \proofstepwidestar[5]{e\in\LB_{A,\InducedLeq}(\{x,y\})\leftrightarrow(e\in A\land e\InducedLeq x\land e\InducedLeq y)}{%
      \FormulaRefAuto{PairLowerBoundSetCharacterization}[thm]}
  \proofstepwidestar[5]{%
    ...
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      9,5}}
  \proofstepwidestar[4]{d\in A}{\rAEa{\rAEa{8}}}
  \proofstepwidestar[5]{e\in A}{\rAEa{\rAEa{10}}}
  \proofstepwidestar[4]{d\InducedLeq x}{%
    \FormulaRefAuto{P\land Q\land R\vdash Q}{8}}
  \proofstepwidestar[5]{e\InducedLeq x}{%
    \FormulaRefAuto{P\land Q\land R\vdash Q}{10}}
  \proofstepwidestar[4]{d\InducedLeq y}{%
    \FormulaRefAuto{P\land Q\land R\vdash R}{8}}
  \proofstepwidestar[5]{e\InducedLeq y}{%
    \FormulaRefAuto{P\land Q\land R\vdash R}{10}}
  \proofstepwidestar[1,4,5]{d\JoinOp{}e\in A}{%
    \FormulaRefAuto{SemilatticeClosureAxiom}[ax]{6,11,12}}
  \proofstepwidestar[1,2,4,5]{%
    d\JoinOp{}e\InducedLeq x}{%
    \FormulaRefAuto{JoinLeastUpper}[thm]{6,11,12,2,13,14}}
  \proofstepwidestar[1,3,4,5]{%
    d\JoinOp{}e\InducedLeq y}{%
    \FormulaRefAuto{JoinLeastUpper}[thm]{6,11,12,3,15,16}}
  \proofstepwidestar[1,2,3,4,5]{d\JoinOp{}e\in\LB_{A,\InducedLeq}(\{x,y\})\leftrightarrow(d\JoinOp{}e\in A\land d\JoinOp{}e\InducedLeq x\land d\JoinOp{}e\InducedLeq y)}{%
      \FormulaRefAuto{PairLowerBoundSetCharacterization}[thm]}
  \proofstepwidestar[1,2,3,4,5]{%
    d\JoinOp{}e\in\LB_{A,\InducedLeq}(\{x,y\})}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{%
...
\begin{tabproofsplitwide}
  \proofpartwide{Endlichkeit und Nichtleerheit der unteren Schranken}
  \proofstepwidestar[1]{\Finite A}{\rA}
  \proofstepwidestar[2]{\ZeroJoinSemi{A,\JoinOp,0}}{\rA}
  \proofstepwidestar[3]{x\in A}{\rA}
  \proofstepwidestar[4]{y\in A}{\rA}
  ...
  \proofpartwide{Maximales und größtes unteres Element}
  ...
  \proofpartwide{Paarinfimum und Existenzschluss}
  \setcounter{proofstepnr}{19}
...
\begin{tabproof}
  ...
  \proofstep{1}{\begin{aligned}[t]&d\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (d\in A\land d\InducedLeq x\land d\not\InducedLeq y)\end{aligned}}{%
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      2,1}}
  \proofstep{1}{d\in A}{\rAEa{\rAEa{3}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3,4]{\begin{aligned}[t]&x\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (x\in A\land x\InducedLeq x\land x\not\InducedLeq y)\end{aligned}}{%
      \FormulaRefAuto{JoinSeparatorSetCharacterization}[thm]}
  \proofstepwidestar[1,2,3,4]{%
    x\in\operatorname{Sep}_{A,\JoinOp}(x,y)}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[5]{\begin{aligned}[t]&j\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (j\in A\land j\InducedLeq x\land j\not\InducedLeq y)\end{aligned}}{%
      \FormulaRefAuto{JoinSeparatorSetCharacterization}[thm]}
  \proofstepwidestar[5]{%
  ...
  \proofstepwidestar[1,5,7]{u\InducedLeq x}{%
    \FormulaRefAuto{JoinOrderTransitive}[thm]{1,7,11}}
  \proofstepwidestar[1,4,5,7,12]{%
    u\in A\land u\InducedLeq x\land u\not\InducedLeq y}{%
    \rAI{\rAI{4,13},12}}
  \proofstepwidestar[1,4,5,7,12]{\begin{aligned}[t]&u\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (u\in A\land u\InducedLeq x\land u\not\InducedLeq y)\end{aligned}}{%
      \FormulaRefAuto{JoinSeparatorSetCharacterization}[thm]}
  \proofstepwidestar[1,4,5,7,12]{%
    u\in\operatorname{Sep}_{A,\JoinOp}(x,y)}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{%
      15,14}}
  \proofstepwidestar[1,4,5,6,7,12]{u=j}{%
    \rRE{7,\rRE{16,\rUE{6}}}}
  \proofstepwidestar[1,4,5,6,7,8,12]{\bot}{\rBI{17,8}}
  \proofstepwidestar[1,2,3,4,5,6,7,8]{%
    u\InducedLeq y}{\rCI{12,18}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Ein minimaler Trenner ist nicht Null]{%
    ...
    \proofstepwidestar[4]{\begin{aligned}[t]&j\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (j\in A\land j\InducedLeq x\land j\not\InducedLeq y)\end{aligned}}{%
      \FormulaRefAuto{JoinSeparatorSetCharacterization}[thm]}
    \proofstepwidestar[4]{%
      j\in A\land j\InducedLeq x\land j\not\InducedLeq y}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
    ...
    \proofstepwidestar[1,3]{0\InducedLeq y}{%
      \FormulaRefAuto{ZeroJoinLeast}[thm]{1,3}}
    \proofstepwidestar[9]{j=0}{\rA}
    \proofstepwidestar[9]{0=j}{\FormulaRefAuto{a=b\vdash b=a}{9}}
    \proofstepwidestar[1,3,9]{j\InducedLeq y}{\rIE{10,8}}
    \proofstepwidestar[1,3,4,9]{\bot}{\rBI{7,11}}
  ...
  \proofpartwideindR[Jede Zerlegung enthält den minimalen Trenner]{%
    ...
    \proofstepwidestar[4]{j\not\InducedLeq y}{%
      \FormulaRefAuto{P\land Q\land R\vdash R}{8}}
    \proofstepwidestar[10]{u\in A}{\rA}
    \proofstepwidestar[11]{v\in A}{\rA}
    \proofstepwidestar[12]{u\JoinOp{}v=j}{\rA}
    \proofstepwidestar[6,10,11]{u\InducedLeq u\JoinOp{}v}{%
      \FormulaRefAuto{JoinUpperLeft}[thm]{6,10,11}}
    \proofstepwidestar[6,10,11,12]{u\InducedLeq j}{\rIE{12,13}}
    \proofstepwidestar[6,10,11]{v\InducedLeq u\JoinOp{}v}{%
      \FormulaRefAuto{JoinUpperRight}[thm]{6,10,11}}
    \proofstepwidestar[6,10,11,12]{v\InducedLeq j}{\rIE{12,15}}
    \proofstepwidestar[]{u=j\lor u\neq j}{\FormulaRefAuto{P\lor\neg P}}
    \proofstepwidestar[18]{u=j}{\rA}
    \proofstepwidestar[18]{u=j\lor v=j}{\rOIa{18}}
    \proofstepwidestar[20]{u\neq j}{\rA}
    \proofstepwidestar[1,2,3,4,5,10,14,20]{u\InducedLeq y}{%
      \FormulaRefAuto{StrictLowerSeparatorBelowRight}[thm]{%
        6,2,3,10,4,5,14,20}}
    \proofstepwidestar[]{v=j\lor v\neq j}{\FormulaRefAuto{P\lor\neg P}}
    \proofstepwidestar[23]{v=j}{\rA}
    \proofstepwidestar[23]{u=j\lor v=j}{\rOIb{23}}
    \proofstepwidestar[25]{v\neq j}{\rA}
    \proofstepwidestar[1,2,3,4,5,11,16,25]{v\InducedLeq y}{%
      \FormulaRefAuto{StrictLowerSeparatorBelowRight}[thm]{%
        6,2,3,11,4,5,16,25}}
    \proofstepwidestar[1,2,3,10,11,20,25]{u\JoinOp{}v\InducedLeq y}{%
      \FormulaRefAuto{JoinLeastUpper}[thm]{6,10,11,3,21,26}}
    \proofstepwidestar[1,2,3,4,10,11,12,20,25]{j\InducedLeq y}{%
      \rIE{12,27}}
    \proofstepwidestar[1,2,3,4,10,11,12,20,25]{\bot}{\rBI{9,28}}
    \proofstepwidestar[1,2,3,4,10,11,12,20,25]{u=j\lor v=j}{%
      \FormulaRefAuto{\bot\vdash P}{29}}
    \proofstepwidestar[1,2,3,4,5,10,11,12,20]{u=j\lor v=j}{%
      \rOE{22,23,24,25,30}}
    \proofstepwidestar[1,2,3,4,5,10,11,12]{u=j\lor v=j}{%
      \rOE{17,18,19,20,31}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[13]{\begin{aligned}[t]&j\in\operatorname{Sep}_{A,\JoinOp}(x,y)\\[-2pt]&\quad\leftrightarrow (j\in A\land j\InducedLeq x\land j\not\InducedLeq y)\end{aligned}}{%
      \FormulaRefAuto{JoinSeparatorSetCharacterization}[thm]}
  \proofstepwidestar[13]{%
    j\in A\land j\InducedLeq x\land j\not\InducedLeq y}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
  ...
  \proofstepwidestar[13]{j\InducedLeq x}{%
    \FormulaRefAuto{P\land Q\land R\vdash Q}{20}}
  \proofstepwidestar[13]{j\not\InducedLeq y}{%
    \FormulaRefAuto{P\land Q\land R\vdash R}{20}}
  \proofstepwidestar[2,3,4,13]{%
    \exists j\in\JoinIrrSet{A,\JoinOp,0}\,
      (j\InducedLeq x\land j\not\InducedLeq y)}{%
    \rEI{\rAI{18,\rAI{21,22}}}}
  \proofstepwidestar[1,2,3,4,5]{%
    \exists j\in\JoinIrrSet{A,\JoinOp,0}\,
      (j\InducedLeq x\land j\not\InducedLeq y)}{%
    \rEE{12,13,23}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,4]{0\in A}{%
      \FormulaRefAuto{ZeroJoinCarrierAxiom}[ax]{2}}
  ...
  \proofstepwidestar[15]{j\in\JoinIrrSet{A,\JoinOp,0}}{\rAEa{15}}
  \proofstepwidestar[15]{\exists j\,j\in\JoinIrrSet{A,\JoinOp,0}}{\rEI{16}}
  \proofstepwidestar[1,2,4]{%
    \exists j\,j\in\JoinIrrSet{A,\JoinOp,0}}{\rEE{14,15,17}}
...
\begin{tabproofsplitwide}
  \proofpartwide{Nichtleerheit der echten unteren Elemente}
  ...
  \proofpartwide{Trägereinschluss und Endlichkeit}
