...
\section{Kommutativgesetze im prädikatenlogischen Kontext}
...
\chapter{Transitivitäten im prädikatenlogischen Kontext}
...
\begin{tabproofsplit}
  \proofpart{$\vdash$}
    ...
    \proofstep{1}{\forall x(P(x)\leftrightarrow Q(x)) \leftrightarrow \neg\exists x (P(x)\land \neg Q(x))\land \neg\exists x (Q(x)\land \neg P(x))}{\FormulaRefAuto{\forall x(P(x)\leftrightarrow Q(x)) \eqvdash \neg\exists x (P(x)\land \neg Q(x))\land \neg\exists x (Q(x)\land \neg P(x))}}
    \proofstep{1}{\neg(\neg\exists x (P(x)\land \neg Q(x))\land \neg\exists x (Q(x)\land \neg P(x)))}{\FormulaRefAuto{P \leftrightarrow Q, \neg P \vdash \neg Q}{1,2}}
