...
\section{Assoziativgesetze und einfache Dreifach-Formeln}
...
\subsection{Elimination dreifacher Disjunktion}
...
\chapter{Implikation und Bikonditional (Aussagenlogik)}
...
\end{tabproof}
\begin{remark}[Äquivalenzketten]
Da \(\leftrightarrow\) reflexiv, symmetrisch und transitiv ist,
dürfen wir ab jetzt Ketten wie
\[
  P \leftrightarrow Q \leftrightarrow R \leftrightarrow S
\]
als Abkürzung verwenden: Jede solche Kette steht für eine durch
wiederholte Anwendung von \autoref{<Label Äquivtransitivität>} herleitbare
Äquivalenz zwischen dem ersten und letzten Glied.
\end{remark}
...
\section{Weitere Implikationsschemata und Fallunterscheidungen}
\begin{DeltaContext}{Im Kapitel verwendete Symbole}
  \DeltaRow{Aussagevariablen}{P \dsep Q\dsep R}
\end{DeltaContext}
