...
\title{Bd. 14 - Endliche Mengen}
\author{Martin Kunze}
\date{}
\setcounter{file}{14}

\hypersetup{
  pdftitle={Bd. 14 - Endliche Mengen},
...
ein. Er entwickelt deren Konsequenzen, verbindet sie mit den in Band~12
...
den in Band~12 entwickelten Peano-Anfangsabschnitten \(\NatSeg{n}\)
hergeleitet.
...
Ihre Zählmengen sind durchgehend die Peano-Anfangsabschnitte aus Band~12.
