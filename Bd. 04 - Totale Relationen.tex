...
\hypersetup{
  pdftitle={Bd. 04 - Totale Relationen},
...
\begin{tabproof}
  ...
  \proofstep{}{\MemRel(M)=\{(X,a)\in M\times\bigcup M\mid a\in X\}}{%
      \FormulaRefAuto{\MemRel(M) \coloneqq \{\, (X,a)\in M\times \bigcup M \mid a\in X \,\}}}
  \proofstep{}{\{\, (X,a)\in M\times \bigcup M \mid a\in X \,\}=\MemRel(M)}{\FormulaRefAuto{a=b\vdash b=a}{5}}
