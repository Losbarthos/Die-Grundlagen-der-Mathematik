%============================================================
%  Bd. 09 - Axiomatischer Aufbau der endlichen Mengen
%============================================================
...
\title{Bd. 09 - Axiomatischer Aufbau der endlichen Mengen}
\author{Martin Kunze}
\date{}
\setcounter{file}{9}
...
Dieser Band entwickelt deren Konsequenzen, verbindet sie mit den in Band~08
...
den in Band~08 entwickelten Peano-Anfangsabschnitten \(\NatSeg{n}\)
...
% Die reinen NatSeg-Grundlagen stehen nun fachlich in B08.
% Der bisherige B06-Block bleibt bis zur abschliessenden Abnahme als
...
Ihre Zählmengen sind durchgehend die Peano-Anfangsabschnitte aus Band~08.
