...
den in Band~04 entwickelten Peano-Anfangsabschnitten \(\NatSeg{n}\)
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[5]{C\subseteq A}{%
      \FormulaRefAuto{A\subseteq A\cup B\dsep A\cup B\subseteq C\vdash A\subseteq C}{%
...
% Die reinen NatSeg-Grundlagen stehen nun fachlich in B04.
...
Ihre Zählmengen sind durchgehend die Peano-Anfangsabschnitte aus Band~04.
