...
% Ergänzende Umbruchstellen für die Argumentlisten dieses Bandes.
...
Band~47 löst die Abstandsargumente von der besonderen Ordnung und Arithmetik
...
\FormulaThmDeltaKR[Eigenschaften der eingeschränkten Familie]{%
  \begin{aligned}[t]
    &a\colon I\to M\dsep J\subseteq I\vdash{}\\[-2pt]
    &\text{(i)}\quad a\restriction_J\colon J\to M,\\[-2pt]
    &\text{(ii)}\quad \forall i\in J\,\bigl((a\restriction_J)_i=a_i\bigr),\\[-2pt]
    &\text{(iii)}\quad \operatorname{Bild}(a\restriction_J)\subseteq\operatorname{Bild}(a).
  \end{aligned}%
}{%
  \begin{aligned}[t]
  &a\colon I\to M\dsep J\subseteq I\vdash
...
\proofpartwide{Koordinaten der Einschränkung}
...
\proofpartwide{Bildmenge der Einschränkung}
...
\proofstepwidestar[1,2]{%
    ...
    \proofstepwidestar[1,2]{I \subseteq I}{%
      \FormulaRefAuto{A\subseteq A}[thm]}
    \proofstepwidestar[1,2]{%
      a[J]\subseteq a[I]}{%
      \FormulaRefAuto{F\colon M\to N\dsep A\subseteq B\dsep B\subseteq M\vdash F[A]\subseteq F[B]}[thm]{1,2,9}}
    \proofstepwidestar[1,2]{%
      \operatorname{Bild}(a\restriction_J)\subseteq\operatorname{Bild}(a)}{%
      \FormulaRefAuto{IndexedFamilyImageDef}[def]{1,3},\ \rIE{8,10}}
...
\begin{tabproofsplitwide}
  \proofpartwide{Bild der Komposition}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \FormulaRefAuto{P\leftrightarrow Q, R\leftrightarrow Q\vdash P\leftrightarrow R}[thm]{5,6}}
    \proofstepwidestar[1,2]{%
      \operatorname{Bild}(a\circ\varphi)=a[\varphi[J]]}{%
      \FormulaRefAuto{\forall x\,(x\in A\leftrightarrow x\in B)\vdash A=B}[ax]{\rUI{7}}}
    \proofstepwidestar[1,2]{I \subseteq I}{%
      \FormulaRefAuto{A\subseteq A}[thm]}
    \proofstepwidestar[1,2]{%
      a[\varphi[J]]\subseteq a[I]}{%
      \FormulaRefAuto{F\colon M\to N\dsep A\subseteq B\dsep B\subseteq M\vdash F[A]\subseteq F[B]}[thm]{1,4,9}}
    \proofstepwidestar[1,2]{%
      \operatorname{Bild}(a\circ\varphi)=a[\varphi[J]]\subseteq\operatorname{Bild}(a)}{%
      8,\ \FormulaRefAuto{IndexedFamilyImageDef}[def]{1,10}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\input{tex/b21-migrated-graph-sequences}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Leerer Anfangsabschnitt]{%
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{PositiveNaturalSegmentDef}[def]{2,1}}
    \proofstepwidestar[]{%
      1\in\mathbb N}{%
    ...
    \proofstepwidestar[1]{%
      1\leq0}{%
      \FormulaRefAuto{PeanoLeqTransitive}[thm]{4,\rAEa{3},5,\rAEa{\rAEb{3}},\rAEb{\rAEb{3}}}}
    \proofstepwidestar[]{0\in\mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[]{%
      0<1}{%
      \FormulaRefAuto{PeanoLtAddOne}[thm]{7},\ \FormulaRefAuto{PeanoAddLeftZero}[thm]{4}}
    \proofstepwidestar[1]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1]{%
      \bot}{%
      \FormulaRefAuto{PeanoOrderNoCycle}[thm]{9,4,8,6}}
    \proofstepwidestar[]{%
      \forall i\,i\notin\PosNatSeg 0}{%
      \rUI{\rCI{1,10}}}
    \proofstepwidestar[]{%
      \PosNatSeg 0=\varnothing}{%
      \FormulaRefAuto{\forall x\,x\notin A\vdash A=\varnothing}[thm]{11}}
...
\FormulaDefDeltaK[Indexverschiebung zwischen den beiden Konventionen]{%
  ...
  \begin{aligned}[t]
    ...
    &\forall i\in\NatSeg{n}\,
      \bigl(\lambda_n(i)\coloneqq i+1\bigr)
  \end{aligned}%
...
\begin{tabproofsplitwide}
  \proofpartwide{Typisierung der Definitionsvorschrift}
    ...
    \proofstepwidestar[1,2]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1,2]{%
      0<i+1}{%
      \FormulaRefAuto{PeanoLeqAddOneStrict}[thm]{6,\rAEa{3},5}}
    \proofstepwidestar[]{0\in\mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    ...
    \proofstepwidestar[1,2]{%
      1\leq i+1}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{8,4,7},\ \FormulaRefAuto{PeanoAddLeftZero}[thm]{9}}
    \proofstepwidestar[1,2]{%
      i+1\leq n}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{\rAEa{3},1,\rAEb{3}}}
    \proofstepwidestar[1,2]{%
      i+1\in\PosNatSeg n}{%
      \FormulaRefAuto{PositiveNaturalSegmentDef}[def]{1,4,10,11}}
    \proofstepwidestar[1]{%
      \forall i\in\NatSeg n\,(i+1\in\PosNatSeg n)}{%
      \rUI{\rRI{2,12}}}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaThmDeltaKR[Äquivalenz der beiden endlichen Indexkonventionen]{%
  \begin{aligned}[t]
    &n\in\mathbb N\vdash{}\\[-2pt]
    &\text{(i)}\quad \lambda_n\colon\NatSeg{n}\bij\PosNatSeg{n},\\[-2pt]
    &\text{(ii)}\quad j\in\PosNatSeg{n}\vdash\lambda_n^{-1}(j)=j-1.
  \end{aligned}%
}{%
  n\in\mathbb N\vdash
  \lambda_n\colon\NatSeg{n}\bij\PosNatSeg{n}\dsep
  j\in\PosNatSeg{n}\vdash\lambda_n^{-1}(j)=j-1%
...
\proofstepwidestar[1]{%
    ...
    \proofstepwidestar[1,3]{i \in \mathbb N}{%
      \FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,\rAEa{\rAEa{3}}}}
    \proofstepwidestar[1,3]{k \in \mathbb N}{%
      \FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,\rAEb{\rAEa{3}}}}
    \proofstepwidestar[1,3]{%
      i=k}{%
      \FormulaRefAuto{PeanoAddOneInjective}[thm]{5,6,4}}
    \proofstepwidestar[1]{%
      \lambda_n\colon\NatSeg n\inj\PosNatSeg n}{%
      \FormulaRefAuto{Injektive Funktion}[def]{2,\rUI{\rUI{\rRI{3,7}}}}}
...
\proofstepwidestar[9]{%
    ...
    \proofstepwidestar[1,9]{%
      ...
      \FormulaRefAuto{PositiveNaturalSegmentDef}[def]{1,9}}
    \proofstepwidestar[]{0\in\mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1,9]{%
      j\neq0}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{11,\rAEa{10},\rAEa{\rAEb{10}}},\ \FormulaRefAuto{PeanoNoLtZero}[thm]}
    \proofstepwidestar[1,9]{%
      j-1\in\mathbb N}{%
      \FormulaRefAuto{PeanoMinusOneNatural}[thm]{\rAEa{10},12}}
    \proofstepwidestar[1,9]{%
      (j-1)+1=j}{%
      \FormulaRefAuto{PeanoMinusOneAddOne}[thm]{\rAEa{10},12}}
    \proofstepwidestar[1,9]{%
      j-1<n}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{13,1},\ \rIE{14,\rAEb{\rAEb{10}}}}
    \proofstepwidestar[1,9]{%
      j-1\in\NatSeg n}{%
      \FormulaRefAuto{PeanoNatSegMembership}[thm]{1,13,15}}
    \proofstepwidestar[1,9]{%
      \lambda_n(j-1)=j}{%
      \FormulaRefAuto{FiniteSequenceIndexShiftDef}[def]{1,16},\ \rIE{14}}
    \proofstepwidestar[1,9]{%
      \exists i\in\NatSeg n\,(\lambda_n(i)=j)}{%
      \rEI{\rAI{16,17}}}
    \proofstepwidestar[1]{%
      \lambda_n\colon\NatSeg n\sur\PosNatSeg n}{%
      \FormulaRefAuto{Surjektive Funktion}[def]{2,\rUI{\rRI{9,18}}}}
...
\proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{Bijektive Funktion}[def]{8,19}}
...
\closeproofpartwideindR
  ...
  \proofpartwide{Wert der Umkehrfunktion}
    ...
    \proofstepwidestar[1,2]{%
      \lambda_n^{-1}(j)+1=j}{%
      \FormulaRefAuto{InverseFunctionRightInverse}[thm]{3,2},\ \FormulaRefAuto{FiniteSequenceIndexShiftDef}[def]{1,4}}
    \proofstepwidestar[1,2]{{ \lambda _ n ^ { - 1 } ( j ) } \in \mathbb N}{%
      \FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,4}}
    \proofstepwidestar[1,2]{%
      (\lambda_n^{-1}(j)+1)-1=\lambda_n^{-1}(j)}{%
      \FormulaRefAuto{PeanoAddOneMinusOne}[thm]{6}}
    \proofstepwidestar[1,2]{%
      \lambda_n^{-1}(j)=j-1}{%
      \rIE{5,7},\ \FormulaRefAuto{a=b\vdash b=a}[thm]}
  \closeproofpartwide
\end{tabproofsplitwide}

\FormulaThmDeltaKR[Umrechnung endlicher Folgen]{%
  \begin{aligned}[t]
    &n\in\mathbb N\dsep a\colon\NatSeg{n}\to M\vdash{}\\[-2pt]
    &\text{(i)}\quad a\circ\lambda_n^{-1}\colon\PosNatSeg{n}\to M,\\[-2pt]
    &\text{(ii)}\quad \forall j\in\PosNatSeg{n}\,\bigl((a\circ\lambda_n^{-1})_j=a_{j-1}\bigr).
  \end{aligned}%
}{%
  \begin{aligned}[t]
  &n\in\mathbb N\dsep a\colon\NatSeg{n}\to M\vdash
  ...
  &\quad\forall j\in\PosNatSeg{n}\,
    \bigl((a\circ\lambda_n^{-1})_j=a_{j-1}\bigr)
  \end{aligned}%
...
\FormulaThmDeltaK[Rekursive Definition einer Folge durch einen Schritt]{%
  ...
  \bigl(a_0=x_0\land
    \forall n\in\mathbb N\,(a_{n+1}=F(a_n))\bigr)%
...
\begin{tabproofsplitwide}
  \proofpartwide{Rekursionssatz in Koordinatenschreibweise}
    ...
    \proofstepwidestar[2]{%
      ...
      \rA}
    \proofstepwidestar[1,2]{%
      \begin{aligned}[t]&\exists!a\colon\mathbb N\to M\,\bigl(a(0)=x_0\land{}\\[-2pt]&\qquad\forall n\in\mathbb N\,(a(n+1)=F(a(n)))\bigr)\end{aligned}}{%
      \FormulaRefAuto{DedekindRecursionTheoremAddOne}[thm]{1,2}}
    \proofstepwidestar[1,2]{%
      \begin{aligned}[t]&\exists!a\colon\mathbb N\to M\,\bigl(a_0=x_0\land{}\\[-2pt]&\qquad\forall n\in\mathbb N\,(a_{n+1}=F(a_n))\bigr)\end{aligned}}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[3]{%
      n,k\in\mathbb N}{%
      \rA}
    \proofstepwidestar[3]{D(n)\subseteq D(n+0)}{%
      \FormulaRefAuto{B21SubsetSequenceBase}[thm]{\rAEa{3}}}
    \proofstepwidestar[2,3]{\forall k\in\mathbb N\,(D(n)\subseteq D(n+k)\rightarrow D(n)\subseteq D(n+(k+1)))}{%
      \FormulaRefAuto{B21SubsetSequenceStep}[thm]{2,\rAEa{3}}}
    \proofstepwidestar[1,2,3]{%
      D(n)\subseteq D(n+k)}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{4,5,\rAEb{3}}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
\proofpartwide{Negation, Summe und Differenz}
\proofstepwidestar[1]{%
...
\proofpartwide{Skalares Vielfaches}
  \setcounter{proofstepnr}{8}% Fortlaufende Schritte dieses Beweises.
\proofstepwidestar[1,2,3]{%
      c\,a_n\in\mathbb R}{%
...
\proofpartwide{Verschiebung um einen konstanten Wert}
...
\proofpartwide{Funktionstypen der Folgen}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Widerspruch bei verschiedenen Grenzwerten}
    ...
    \proofstepwidestar[1,9,10]{a_{N+M}\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,\rAEa{11}}}
    \proofstepwidestar[1,2,9,10]{%
      |L-K|\leq|a_{N+M}-L|+|a_{N+M}-K|}{%
      \FormulaRefAuto{RealDistanceTriangle}[thm]{2,14},\ \FormulaRefAuto{RealDistanceBasicLaws}[thm]}
    \proofstepwidestar[1,2,9,10]{%
      |L-K|<2|L-K|/3}{%
      \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{15,12,13},\ \FormulaRefAuto{RealCutTotalOrder}[thm]}
    \proofstepwidestar[1,2,4,9,10]{%
      \bot}{%
      \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{5,16}}
...
\begin{tabproofsplitwide}
  \proofpartwide{Konstante Folge}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \rEI{\rAI{7,\rUI{\rRI{4,6}}}}}
    \proofstepwidestar[1]{%
      (\operatorname{const}_{\mathbb N,c})_n\to c}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{3,1,\rUI{\rRI{2,8}}}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Hinrichtung]{%
    ...
    \proofstepwidestar[1,2,3,4]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a^{\langle r\rangle}_n-L|<\varepsilon)}{%
      \rEE{5,6,11}}
    \proofstepwidestar[1,2]{a^{\langle r\rangle}\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{SequenceTailDef}[def]{1,2}}
    \proofstepwidestar[1,2,3]{%
      a^{\langle r\rangle}_n\to L}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{13,2,\rUI{\rRI{4,12}}}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Rückrichtung]{%
    ...
    \proofstepwidestar[7]{%
      ...
      \rA}
    \proofstepwidestar[2,6]{r+N\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddClosure}[thm]{2,6}}
    \proofstepwidestar[2,6,7]{%
      \exists t\in\mathbb N\,(r+N+t=n)}{%
      \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash m\leq n\leftrightarrow\exists k\in\mathbb{N}\,(m+k=n)}[thm]{8,7}}
    \proofstepwidestar[10]{%
      t\in\mathbb N\land r+N+t=n}{%
      \rA}
    \proofstepwidestar[2,6,10]{%
      N+t\in\mathbb N\land N\leq N+t}{%
      \FormulaRefAuto{B21CommonNaturalBound}[thm]{\rAEa{6},\rAEa{10}}}
    \proofstepwidestar[2,6,10]{%
      (N+t)+r=n}{%
      \FormulaRefAuto{PeanoAddAssociative}[thm]{2,6,10},\ \FormulaRefAuto{PeanoAddCommutative}[thm],\ \rAEb{10}}
    \proofstepwidestar[1,2,6,10]{%
      |a_n-L|<\varepsilon}{%
      \rRE{\rRE{\rUE{\rAEb{6}},\rAEa{11}},\rAEb{11}},\ \FormulaRefAuto{SequenceTailDef}[def],\ \rIE{12}}
    \proofstepwidestar[1,2,6,7]{%
      |a_n-L|<\varepsilon}{%
      \rEE{9,10,13}}
    \proofstepwidestar[2,6]{r+N\in\mathbb N}{%
    ...
    \proofstepwidestar[1,2,6]{%
      ...
      \rEI{\rAI{15,\rUI{\rRI{7,14}}}}}
    \proofstepwidestar[1,2,3,4]{%
      \exists M\in\mathbb N\,\forall n\in\mathbb N\,(M\leq n\rightarrow|a_n-L|<\varepsilon)}{%
      \rEE{5,6,16}}
    \proofstepwidestar[1,2,3]{%
      a_n\to L}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,2,\rUI{\rRI{4,17}}}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Zusammenfassung}
    ...
    \proofstepwidestar[2]{%
      r\in\mathbb N\land L\in\mathbb R}{%
      \rA}
    \proofstepwidestar[1,2]{(a_n\to L)\rightarrow(a^{\langle r\rangle}_n\to L)}{%
      \FormulaRefAuto{B21TailLimitForward}[thm]{1,2}}
    \proofstepwidestar[1,2]{(a^{\langle r\rangle}_n\to L)\rightarrow(a_n\to L)}{%
      \FormulaRefAuto{B21TailLimitBackward}[thm]{1,2}}
    \proofstepwidestar[1,2]{%
      a_n\to L\leftrightarrow a^{\langle r\rangle}_n\to L}{%
      \rLRI{3,4}}
  \closeproofpartwide
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Eine streng wachsende Indexfolge dominiert den Index]{%
    \varphi\colon\mathbb N\to\mathbb N\dsep\forall n\in\mathbb N\,(\varphi(n)<\varphi(n+1))\vdash\forall n\in\mathbb N\,(n\leq\varphi(n))
  }{\varphi\colon\mathbb N\to\mathbb N\dsep\forall n\in\mathbb N\,(\varphi(n)<\varphi(n+1))\vdash\forall n\in\mathbb N\,(n\leq\varphi(n))}[B21IncreasingIndexDominates]
    \proofstepwidestar[1]{%
      \varphi\colon\mathbb N\to\mathbb N}{%
      \rA}
    \proofstepwidestar[2]{%
      \forall n\in\mathbb N\,(\varphi(n)<\varphi(n+1))}{%
      \rA}
    \proofstepwidestar[1]{0 \in \mathbb N}{%
      \FormulaRefAuto{PeanoZero}[ax]}
    \proofstepwidestar[1]{\varphi ( 0 ) \in \mathbb N}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{1,3}}
    \proofstepwidestar[1]{%
      0\leq\varphi(0)}{%
    ...
    \proofstepwidestar[6]{n+1\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{6}}}
    \proofstepwidestar[1,6]{%
      \varphi(n),\varphi(n+1)\in\mathbb N}{\FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{1,\rAEa{6},7}
}
    ...
    \proofstepwidestar[1,6]{%
      n<\varphi(n)+1}{%
      \FormulaRefAuto{PeanoLeqAddOneStrict}[thm]{6,8}}
    \proofstepwidestar[1,2,6]{%
      \varphi(n)+1\leq\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{8,9}}
    \proofstepwidestar[1,2,6]{%
      n<\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtLeqTransitive}[thm]{6,8,10,11}}
    \proofstepwidestar[1,2,6]{%
      n+1\leq\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{6,8,12}}
    \proofstepwidestar[1,2]{%
      \forall n\in\mathbb N\,(n\leq\varphi(n))}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{5,\rUI{\rRI{6,13}}}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Übertragung der Epsilon-Schranke}
    ...
    \proofstepwidestar[8]{%
      n\in\mathbb N\land N\leq n}{%
      \rA}
    \proofstepwidestar[3,4]{\forall n\in\mathbb N\,(n\leq\varphi(n))}{%
      \FormulaRefAuto{B21IncreasingIndexDominates}[thm]{3,4}}
    ...
    \proofstepwidestar[3,4,7,8]{%
      N\leq\varphi(n)}{%
      \FormulaRefAuto{PeanoLeqTransitive}[thm]{7,8,11,10}}
    \proofstepwidestar[3,4,7,8]{%
      |a_{\varphi(n)}-L|<\varepsilon}{%
      \rRE{\rRE{\rUE{\rAEb{7}},11},12}}
    \proofstepwidestar[3,4,7]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_{\varphi(n)}-L|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{7},\rUI{\rRI{8,13}}}}}
    \proofstepwidestar[1,2,3,4,5]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_{\varphi(n)}-L|<\varepsilon)}{%
      \rEE{6,7,14}}
    \proofstepwidestar[1,3]{a\circ\varphi\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{CompositionDef}[def]{3,1}}
    \proofstepwidestar[1,2,3,4]{%
      a_{\varphi(n)}\to L}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{16,\rUI{\rRI{5,15}}}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Identische Epsilon-Bedingungen}
    ...
    \proofstepwidestar[1,3]{a_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,3}}
    \proofstepwidestar[1,2,3]{%
      |(a-L)_n-0|=|a_n-L|}{%
      \FormulaRefAuto{RealCutAdditiveLaws}[thm]{5,2},\ \rIE{4}}
    \proofstepwidestar[1,2]{%
      \forall n\in\mathbb N\,(|(a-L)_n-0|=|a_n-L|)}{%
      \rUI{\rRI{3,6}}}
    \proofstepwidestar[1,2]{a-L\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]{1,2}}
    \proofstepwidestar[1,2]{%
      a_n\to L\leftrightarrow(a-L)_n\to0}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,2,8,7}
}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Gemeinsamer Anfangsindex und Majorante}
    ...
    \proofstepwidestar[1,9]{b_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,9}}
    \proofstepwidestar[1,6,7,9]{%
      |a_n|\leq b_n\leq|b_n|<\varepsilon}{%
      \rUE{\rAEb{6}},\ \rUE{\rAEb{7}},\ 10,\ \FormulaRefAuto{RealAbsoluteValue}[def]{11}}
    \proofstepwidestar[1,6,7]{%
      \exists M\in\mathbb N\,\forall n\in\mathbb N\,(M\leq n\rightarrow|a_n|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{8},\rUI{\rRI{9,12}}}}}
    ...
    \proofstepwidestar[1,2,3]{%
      a_n\to0}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,\rUI{\rRI{4,15}}},\ \FormulaRefAuto{RealCutAdditiveLaws}[thm]}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Anfangsschranke: Induktionsanfang]{%
    ...
    \proofstepwidestar[2]{%
      \bot}{%
      \rBI{\rIE{\FormulaRefAuto{PeanoNatSegZero}[thm],2},\FormulaRefAuto{x\not\in\varnothing}[thm]}}
    \proofstepwidestar[1,2]{%
      |a_k|\leq0}{%
    ...
    \proofstepwidestar[1]{%
      ...
      \rUI{\rRI{2,4}}}
        \proofstepwidestar[]{\CompleteOrderedField{\mathbb R,\RealAdd,\RealMul,\RealNeg\cdot,\RealInv\cdot,\RealZero,\RealOne,\RealLe}}{\FormulaRefAuto{RealCutsCompleteOrderedField}[thm]}
    \proofstepwidestar[]{0\in\mathbb R}{\FormulaRefAuto{CompleteOrderedFieldAxioms}[def]{6}}
    \proofstepwidestar[]{0\subseteq0}{\FormulaRefAuto{A\subseteq A}[thm]}
    \proofstepwidestar[]{0\leq0}{\FormulaRefAuto{RealCutOrder}[def]{7,8}}
    \proofstepwidestar[1]{\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg0\,(|a_k|\leq C))}{\rEI{\rAI{7,\rAI{9,5}}}}
  \closeproofpartwideindR

  \proofpartwideindR[Anfangsschranke: Induktionsschritt]{%
    \begin{aligned}[t]&a\colon\mathbb N\to\mathbb R\dsep N\in\mathbb N\dsep{}\\[-2pt]&\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg N\,(|a_k|\leq C))\vdash{}\\[-2pt]&\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg{N+1}\,(|a_k|\leq C))\end{aligned}
  }{\begin{aligned}[t]&a\colon\mathbb N\to\mathbb R\dsep N\in\mathbb N\dsep{}\\[-2pt]&\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg N\,(|a_k|\leq C))\vdash{}\\[-2pt]&\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg{N+1}\,(|a_k|\leq C))\end{aligned}}[B21FinitePrefixStep]
    \proofstepwidestar[1]{%
      a\colon\mathbb N\to\mathbb R}{%
      \rA}
    \proofstepwidestar[2]{%
    ...
    \proofstepwidestar[2,7]{%
      ...
      \FormulaRefAuto{PeanoNatSegAddOneElim}[thm]{2,7}}
    \proofstepwidestar[9]{%
      k\in\NatSeg N}{%
      \rA}
    ...
    \proofstepwidestar[1,2,4,7]{%
      ...
      \rOE{8,9,10,11,12}}
    \proofstepwidestar[1,2,4]{%
      \forall k\in\NatSeg{N+1}\,(|a_k|\leq C+|a_N|)}{%
      \rUI{\rRI{7,13}}}
    \proofstepwidestar[1,2,4]{%
      \exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg{N+1}\,(|a_k|\leq C))}{%
  ...
  \proofpartwideindR[Anfangsschranke: Induktionsschluss]{%
    ...
    \proofstepwidestar[2]{%
      N\in\mathbb N}{%
      \rA}
    \proofstepwidestar[1]{\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg 0\,(|a_k|\leq C))}{%
      \FormulaRefAuto{B21FinitePrefixBase}[thm]{1}}
    \proofstepwidestar[1]{\forall N\in\mathbb N\,\bigl((\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg N\,(|a_k|\leq C)))\rightarrow(\exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg{N+1}\,(|a_k|\leq C)))\bigr)}{%
      \FormulaRefAuto{B21FinitePrefixStep}[thm]{1}}
    \proofstepwidestar[1,2]{%
      \exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg N\,(|a_k|\leq C))}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{3,4,2}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Eine Restschranke liefert eine globale Schranke]{%
    ...
    \proofstepwidestar[2,3,5]{%
      ...
      \rUI{\rRI{6,12}}}
        \proofstepwidestar[2]{C\in\mathbb R}{\rAEa{\rAEb{2}}}
    \proofstepwidestar[5]{D\in\mathbb R}{\rAEa{5}}
    \proofstepwidestar[2]{0\leq C}{\rAEb{\rAEb{2}}}
    \proofstepwidestar[5]{0\leq D}{\rAEa{\rAEb{5}}}
    \proofstepwidestar[2,5]{(C+D\in\mathbb R)\land(-C\in\mathbb R\land0\in\mathbb R)}{\FormulaRefAuto{RealCutAdditiveClosure}[thm]{\rAI{14,15}}}
    \proofstepwidestar[2,5]{C+D\in\mathbb R}{\rAEa{18}}
    \proofstepwidestar[2,5]{0\in\mathbb R}{\rAEb{\rAEb{18}}}
    \proofstepwidestar[2,5]{0+D\leq C+D}{\FormulaRefAuto{RealCutAdditionMonotone}[thm]{\rAI{20,\rAI{14,15}},16}}
    \proofstepwidestar[2,5]{0+D=D+0}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{20,15}}
    \proofstepwidestar[2,5]{D+0=D}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{15}}
    \proofstepwidestar[2,5]{D\leq C+D}{\rIE{22,23,21}}
    \proofstepwidestar[2,5]{0\subseteq D}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{20,15,17}}
    \proofstepwidestar[2,5]{D\subseteq C+D}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{15,19,24}}
    \proofstepwidestar[2,5]{0\subseteq C+D}{\FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}[thm]{25,26}}
    \proofstepwidestar[2,5]{0\leq C+D}{\FormulaRefAuto{RealCutOrder}[def]{20,19,27}}
    \proofstepwidestar[1,2,3,5]{\operatorname{Beschr}(a)}{\FormulaRefAuto{BoundedRealSequenceDef}[def]{1,\rEI{\rAI{19,\rAI{28,13}}}}}
    \proofstepwidestar[1,2,3]{\operatorname{Beschr}(a)}{\rEE{4,5,29}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Konvergenz liefert eine Restschranke}
    ...
    \proofstepwidestar[2]{%
      a_n\to L}{%
      \rA}
    \proofstepwidestar[]{\CompleteOrderedField { \mathbb R , \RealAdd , \RealMul , \RealNeg \cdot , \RealInv \cdot , \RealZero , \RealOne , \RealLe }}{%
      \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]}
    \proofstepwidestar[1,2]{%
    ...
    \proofstepwidestar[1,5,6]{%
      |a_k|\leq|a_k-L|+|L|<1+|L|}{%
      \FormulaRefAuto{RealAbsoluteValueTriangle}[thm]{1,6},\ \rRE{\rRE{\rUE{\rAEb{5}},\rAEa{6}},\rAEb{6}},\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]}
    \proofstepwidestar[1,5]{%
      \forall k\in\mathbb N\,(N\leq k\rightarrow|a_k|\leq1+|L|)}{%
      \rUI{\rRI{6,7}},\ \FormulaRefAuto{RealCutTotalOrder}[thm]}
        \proofstepwidestar[1]{L\in\mathbb R}{\rAEb{1}}
    \proofstepwidestar[1]{|L|\in\mathbb R}{\FormulaRefAuto{RealAbsoluteValue}[def]{9}, \FormulaRefAuto{RealCutAdditiveClosure}[thm]{9,9}}
    \proofstepwidestar[1]{0\leq|L|\land(|L|=0\leftrightarrow L=0)}{\FormulaRefAuto{RealAbsoluteValueNonnegativeZero}[thm]{9}}
    \proofstepwidestar[1]{0\leq|L|}{\rAEa{11}}
    \proofstepwidestar[]{1\in\mathbb R}{\FormulaRefAuto{CompleteOrderedFieldAxioms}[def]{3}}
    \proofstepwidestar[]{0\leq1}{\FormulaRefAuto{CompleteOrderedFieldAxioms}[def]{3}}
    \proofstepwidestar[1]{(1+|L|\in\mathbb R)\land(-1\in\mathbb R\land0\in\mathbb R)}{\FormulaRefAuto{RealCutAdditiveClosure}[thm]{\rAI{13,10}}}
    \proofstepwidestar[1]{1+|L|\in\mathbb R}{\rAEa{15}}
    \proofstepwidestar[1]{0\in\mathbb R}{\rAEb{\rAEb{15}}}
    \proofstepwidestar[1]{0+|L|\leq 1+|L|}{\FormulaRefAuto{RealCutAdditionMonotone}[thm]{\rAI{17,\rAI{13,10}},14}}
    \proofstepwidestar[1]{0+|L|=|L|+0}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{17,10}}
    \proofstepwidestar[1]{|L|+0=|L|}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{10}}
    \proofstepwidestar[1]{|L|\leq 1+|L|}{\rIE{19,20,18}}
    \proofstepwidestar[1]{0\subseteq |L|}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{17,10,12}}
    \proofstepwidestar[1]{|L|\subseteq 1+|L|}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{10,16,21}}
    \proofstepwidestar[1]{0\subseteq 1+|L|}{\FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}[thm]{22,23}}
    \proofstepwidestar[1]{0\leq 1+|L|}{\FormulaRefAuto{RealCutOrder}[def]{17,16,24}}
    \proofstepwidestar[1,5]{\operatorname{Beschr}(a)}{\FormulaRefAuto{B21EventuallyBoundedIsBounded}[thm]{1,\rAEa{5},16,25,8}}
    \proofstepwidestar[1,2]{\operatorname{Beschr}(a)}{\rEE{4,5,26}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\FormulaDefDeltaK[Monotone reelle Folgen]{%
  ...
  \operatorname{Mon}_{\uparrow}(a)&\coloneqq
    \forall n\in\mathbb N\,(a_n\leq a_{n+1}),\\[-2pt]
...
\FormulaThmDeltaKR[Monotone Konvergenz]{%
  \begin{aligned}[t]
    &\text{(i)}\quad
      \begin{aligned}[t]
        &a\colon\mathbb N\to\mathbb R\dsep
          \operatorname{Mon}_{\uparrow}(a)\dsep{}\\[-2pt]
        &\exists C\in\mathbb R\,\forall n\in\mathbb N\,(a_n\leq C)\\[-2pt]
        &\vdash a_n\to\sup_{\mathbb R,\RealLe}\bigl(a[\mathbb N]\bigr),
      \end{aligned}\\[-2pt]
    &\text{(ii)}\quad
      \begin{aligned}[t]
        &a\colon\mathbb N\to\mathbb R\dsep
          \operatorname{Mon}_{\downarrow}(a)\dsep{}\\[-2pt]
        &\exists C\in\mathbb R\,\forall n\in\mathbb N\,(C\leq a_n)\\[-2pt]
        &\vdash a_n\to\inf_{\mathbb R,\RealLe}\bigl(a[\mathbb N]\bigr).
      \end{aligned}
  \end{aligned}%
}{%
  \begin{aligned}[t]
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Wachsende Folgen: Vergleich beliebiger Indizes]{%
    ...
    \proofstepwidestar[1,3]{%
      a_N\leq a_{N+0}}{%
      \FormulaRefAuto{PeanoAddRightZero}[thm]{3},\ \FormulaRefAuto{RealCutTotalOrder}[thm]{4}}
    \proofstepwidestar[6]{%
      k\in\mathbb N\land a_N\leq a_{N+k}}{%
      \rA}
    \proofstepwidestar[1,2,3,6]{%
      a_{N+k}\leq a_{N+(k+1)}}{%
      \FormulaRefAuto{MonotoneRealSequenceDef}[def]{1,2},\ \FormulaRefAuto{PeanoAddClosure}[thm]{3,6},\ \FormulaRefAuto{PeanoAddAddOneRight}[thm]}
    \proofstepwidestar[1,2,3,6]{%
      a_N\leq a_{N+(k+1)}}{%
      \FormulaRefAuto{RealCutTotalOrder}[thm]{6,7}}
    \proofstepwidestar[1,2,3]{%
      \forall k\in\mathbb N\,(a_N\leq a_{N+k})}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{5,\rUI{\rRI{6,8}}}}
    \proofstepwidestar[3]{%
  ...
  \proofpartwide{Konvergenz gegen das Supremum}
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,4},\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{1},\ \FormulaRefAuto{IndexedFamilyImageSubsetCodomain}[thm]{1}}
    \proofstepwidestar[1,3]{%
      s\coloneqq\sup_{\mathbb R,\RealLe}(a[\mathbb N])\in\mathbb R}{%
      \FormulaRefAuto{RealLeastUpperBoundProperty}[thm]{5,3}}
    \proofstepwidestar[7]{%
      \varepsilon\in\mathbb R\land\varepsilon>0}{%
      \rA}
    \proofstepwidestar[1,3,7]{%
      \exists N\in\mathbb N\,(s-\varepsilon<a_N)}{%
      \FormulaRefAuto{RealLeastUpperBoundProperty}[thm]{6},\ \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{7},\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{1}}
    \proofstepwidestar[9]{%
    ...
    \proofstepwidestar[10]{%
      n\in\mathbb N\land N\leq n}{%
      \rA}
    \proofstepwidestar[1,2,3,7,9,10]{%
      s-\varepsilon<a_N\leq a_n\leq s<s+\varepsilon}{%
      \FormulaRefAuto{B21MonotoneIncreasingNesting}[thm]{1,2,9,10},\ \FormulaRefAuto{RealLeastUpperBoundProperty}[thm]{6},\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{7}}
    \proofstepwidestar[1,2,3,7,9,10]{%
      |a_n-s|<\varepsilon}{%
      \FormulaRefAuto{RealEpsilonNeighborhoodInterval}[thm]{1,6,7,11}}
    \proofstepwidestar[1,2,3,7,9]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_n-s|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{9},\rUI{\rRI{10,12}}}}}
    \proofstepwidestar[1,2,3,7]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_n-s|<\varepsilon)}{%
      \rEE{8,9,13}}
    \proofstepwidestar[1,2,3]{%
      a_n\to\sup_{\mathbb R,\RealLe}(a[\mathbb N])}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,6,\rUI{\rRI{7,14}}}}
  \closeproofpartwide
  ...
  \proofpartwide{Konvergenz gegen das Infimum}
    ...
    \proofstepwidestar[1,3]{%
      ...
      \FormulaRefAuto{RealInfimumCharacterization}[thm]{5,3}}
    \proofstepwidestar[7]{%
      \varepsilon\in\mathbb R\land\varepsilon>0}{%
      \rA}
    \proofstepwidestar[1,3,7]{%
      \exists N\in\mathbb N\,(a_N<r+\varepsilon)}{%
      \FormulaRefAuto{RealInfimumCharacterization}[thm]{6},\ \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{7},\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{1}}
    \proofstepwidestar[9]{%
    ...
    \proofstepwidestar[1,2,3,7,9,10]{%
      ...
      \FormulaRefAuto{B21MonotoneDecreasingNesting}[thm]{1,2,9,10},\ \FormulaRefAuto{RealInfimumCharacterization}[thm]{6},\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{7}}
    \proofstepwidestar[1,2,3,7,9,10]{%
      |a_n-r|<\varepsilon}{%
      \FormulaRefAuto{RealEpsilonNeighborhoodInterval}[thm]{1,6,7,11}}
    \proofstepwidestar[1,2,3,7,9]{%
...
\FormulaThmDeltaKR[Lineare Grenzwertregeln]{%
  \begin{aligned}[t]
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Summe]{%
    ...
    \proofstepwidestar[1,2,3]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(a+b)_n-(A+B)|<\varepsilon)}{%
      \rEE{5,6,10}}
    \proofstepwidestar[1]{a+b\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]{1}}
    \proofstepwidestar[1,2]{%
      (a+b)_n\to A+B}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,12,\rUI{\rRI{3,11}}}
}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Skalarmultiplikation ohne Sonderfall bei Null]{%
    ...
    \proofstepwidestar[1,2,3]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(ca)_n-cA|<\varepsilon)}{%
      \rEE{5,6,10}}
    \proofstepwidestar[1]{ca\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]{1}}
    \proofstepwidestar[1,2]{%
      (ca)_n\to cA}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,12,\rUI{\rRI{3,11}}}
}
  \closeproofpartwideindR
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Produktabschätzung}
    ...
    \proofstepwidestar[12]{%
      n\in\mathbb N\land N\leq n}{%
      \rA}
    \proofstepwidestar[1,12]{a_n,b_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,12}}
    \proofstepwidestar[1,12]{%
      a_nb_n-AB=a_n(b_n-B)+B(a_n-A)}{%
      \FormulaRefAuto{RealCutMultiplicativeLaws}[thm]{1,13},\ \FormulaRefAuto{RealCutAdditiveLaws}[thm]}
    \proofstepwidestar[1,12]{%
      |a_nb_n-AB|\leq|a_n|\,|b_n-B|+|B|\,|a_n-A|}{%
      \rIE{14},\ \FormulaRefAuto{RealAbsoluteValueTriangle}[thm],\ \FormulaRefAuto{RealAbsoluteValueNegationProduct}[thm]}
    \proofstepwidestar[1,5,11,12]{%
      |a_nb_n-AB|\leq D(|b_n-B|+|a_n-A|)}{%
      \rRE{\rUE{\rAEb{\rAEb{5}}},\rAEa{12}},\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{7,15}}
    \proofstepwidestar[1,5,8,11,12]{%
      |(a\mathbin{\cdot}b)_n-AB|<\varepsilon}{%
      \rRE{\rRE{\rUE{\rAEb{11}},\rAEa{12}},\rAEb{12}},\ \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{16,9},\ \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]}
    \proofstepwidestar[1,5,8,11]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(a\mathbin{\cdot}b)_n-AB|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{11},\rUI{\rRI{12,17}}}}}
    \proofstepwidestar[1,2,5,8]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(a\mathbin{\cdot}b)_n-AB|<\varepsilon)}{%
      \rEE{10,11,18}}
    \proofstepwidestar[1]{a\mathbin{\cdot}b\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]{1}}
    \proofstepwidestar[1,2,5]{%
      (a\mathbin{\cdot}b)_n\to AB}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,20,\rUI{\rRI{8,19}}}
}
    \proofstepwidestar[1,2]{%
...
\begin{tabproofsplitwide}
  \proofpartwide{Nennertrennung und Fehlerabschätzung}
    ...
    \proofstepwidestar[1,8]{b_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,8}}
    \proofstepwidestar[1,8]{%
      |B|\leq|B-b_n|+|b_n|}{%
      \FormulaRefAuto{RealAbsoluteValueTriangle}[thm]{1,10},\ \FormulaRefAuto{RealCutAdditiveLaws}[thm]}
    \proofstepwidestar[1,3,7,8]{%
      0<|B|/2<|b_n|}{%
      \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{5,9,11},\ \FormulaRefAuto{RealAbsoluteValueNegationProduct}[thm]}
    ...
    \proofstepwidestar[1,3,4,7,8]{%
      ...
      \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{13,12,9}}
    \proofstepwidestar[1,3,4,7]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(b^{-1})_n-1/B|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{7},\rUI{\rRI{8,14}}}},\ \FormulaRefAuto{PointwiseRealSequenceReciprocalQuotientDef}[def]}
    \proofstepwidestar[1,2,3,4]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|(b^{-1})_n-1/B|<\varepsilon)}{%
      \rEE{6,7,15}}
    \proofstepwidestar[1,2]{b^{-1}\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceReciprocalQuotientDef}[def]{1,2}}
    \proofstepwidestar[1,2,3]{%
      (b^{-1})_n\to1/B}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,17,\rUI{\rRI{4,16}}}
}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Übertragung der Konvergenz}
    ...
    \proofstepwidestar[6]{%
      n\in\mathbb N\land N\leq n}{%
      \rA}
    \proofstepwidestar[1,6]{a_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,6}}
    \proofstepwidestar[1,5,6]{%
      \bigl|(|a|)_n-|A|\bigr|\leq|a_n-A|<\varepsilon}{%
      \FormulaRefAuto{B21ReverseTriangle}[thm]{1,7},\ \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def],\ \rRE{\rRE{\rUE{\rAEb{5}},\rAEa{6}},\rAEb{6}}}
    \proofstepwidestar[1,5]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow\bigl|(|a|)_n-|A|\bigr|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{5},\rUI{\rRI{6,8}}}}}
    \proofstepwidestar[1,2,3]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow\bigl|(|a|)_n-|A|\bigr|<\varepsilon)}{%
      \rEE{4,5,9}}
    \proofstepwidestar[1]{|a|\colon\mathbb N\to\mathbb R}{%
      \FormulaRefAuto{PointwiseRealSequenceOperationsDef}[def]{1}}
    \proofstepwidestar[1,2]{%
      (|a|)_n\to|A|}{\FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,11,\rUI{\rRI{3,10}}}
}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Zwei späte Glieder}
    ...
    \proofstepwidestar[7]{%
      ...
      \rA}
    \proofstepwidestar[1,7]{a_m,a_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,7}}
    \proofstepwidestar[1,3,6,7]{%
      |a_m-a_n|\leq|a_m-L|+|a_n-L|<\varepsilon}{%
      \FormulaRefAuto{RealDistanceTriangle}[thm]{1,8},\ \FormulaRefAuto{RealDistanceBasicLaws}[thm],\ \rUE{\rAEb{6}},\ 7,\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]}
    \proofstepwidestar[1,3,6]{%
      ...
      \rEI{\rAI{\rAEa{6},\rUI{\rUI{\rRI{7,9}}}}}}
    \proofstepwidestar[1,2,3]{%
      \begin{aligned}[t]&\exists N\in\mathbb N\,\forall m,n\in\mathbb N\,\\[-2pt]&\qquad((N\leq m\land N\leq n)\rightarrow|a_m-a_n|<\varepsilon)\end{aligned}}{%
      \rEE{5,6,10}}
    \proofstepwidestar[1,2]{%
      \operatorname{Cauchy}(a)}{%
      \FormulaRefAuto{RealCauchySequenceDef}[def]{1,\rUI{\rRI{3,11}}}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Restschranke um ein festes Folgenglied}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \FormulaRefAuto{RealCauchySequenceDef}[def]{1,2,3}}
    \proofstepwidestar[5]{%
    ...
    \proofstepwidestar[5,6]{%
      |a_n-a_N|<1}{%
      \rUE{\rUE{\rAEb{5}}},\ 6,\ \FormulaRefAuto{PeanoLeqReflexive}[thm]{\rAEa{5}}}
    \proofstepwidestar[1,5]{a_N\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,5}}
    \proofstepwidestar[1,6]{a_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,6}}
    \proofstepwidestar[1,5,6]{%
      |a_n|\leq|a_n-a_N|+|a_N|<1+|a_N|}{%
      \FormulaRefAuto{RealAbsoluteValueTriangle}[thm]{8,9},\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{7}}
    \proofstepwidestar[1,5]{%
      \forall n\in\mathbb N\,(N\leq n\rightarrow|a_n|\leq1+|a_N|)}{%
      \rUI{\rRI{6,10}},\ \FormulaRefAuto{RealCutTotalOrder}[thm]}
        \proofstepwidestar[1,5]{|a_N|\in\mathbb R}{\FormulaRefAuto{RealAbsoluteValue}[def]{8}, \FormulaRefAuto{RealCutAdditiveClosure}[thm]{8,8}}
    \proofstepwidestar[1,5]{0\leq|a_N|\land(|a_N|=0\leftrightarrow a_N=0)}{\FormulaRefAuto{RealAbsoluteValueNonnegativeZero}[thm]{8}}
    \proofstepwidestar[1,5]{0\leq|a_N|}{\rAEa{13}}
    \proofstepwidestar[]{1\in\mathbb R}{\FormulaRefAuto{CompleteOrderedFieldAxioms}[def]{3}}
    \proofstepwidestar[]{0\leq1}{\FormulaRefAuto{CompleteOrderedFieldAxioms}[def]{3}}
    \proofstepwidestar[1,5]{(1+|a_N|\in\mathbb R)\land(-1\in\mathbb R\land0\in\mathbb R)}{\FormulaRefAuto{RealCutAdditiveClosure}[thm]{\rAI{15,12}}}
    \proofstepwidestar[1,5]{1+|a_N|\in\mathbb R}{\rAEa{17}}
    \proofstepwidestar[1,5]{0\in\mathbb R}{\rAEb{\rAEb{17}}}
    \proofstepwidestar[1,5]{0+|a_N|\leq 1+|a_N|}{\FormulaRefAuto{RealCutAdditionMonotone}[thm]{\rAI{19,\rAI{15,12}},16}}
    \proofstepwidestar[1,5]{0+|a_N|=|a_N|+0}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{19,12}}
    \proofstepwidestar[1,5]{|a_N|+0=|a_N|}{\FormulaRefAuto{RealCutAdditiveLaws}[thm]{12}}
    \proofstepwidestar[1,5]{|a_N|\leq 1+|a_N|}{\rIE{21,22,20}}
    \proofstepwidestar[1,5]{0\subseteq |a_N|}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{19,12,14}}
    \proofstepwidestar[1,5]{|a_N|\subseteq 1+|a_N|}{\FormulaRefAuto{RealCutOrderCharacterization}[thm]{12,18,23}}
    \proofstepwidestar[1,5]{0\subseteq 1+|a_N|}{\FormulaRefAuto{A\subseteq B\dsep B\subseteq C\vdash A\subseteq C}[thm]{24,25}}
    \proofstepwidestar[1,5]{0\leq 1+|a_N|}{\FormulaRefAuto{RealCutOrder}[def]{19,18,26}}
    \proofstepwidestar[1,5]{\operatorname{Beschr}(a)}{\FormulaRefAuto{B21EventuallyBoundedIsBounded}[thm]{1,\rAEa{5},18,27,11}}
    \proofstepwidestar[1,2]{\operatorname{Beschr}(a)}{\rEE{4,5,28}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Rückrichtung: Infima der Restwertemengen]{%
    ...
    \proofstepwidestar[1,5,9]{%
      ...
      \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{9},\ \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{9,11},\ \FormulaRefAuto{IndexedFamilyImageSubsetCodomain}[thm]{9}}
    \proofstepwidestar[1,5,9]{%
      ...
      \FormulaRefAuto{RealLeastUpperBoundProperty}[thm]{12,10},\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{9}}
    ...
    \proofstepwidestar[15]{%
      ...
      \FormulaRefAuto{RealCutsCompleteOrderedField}[thm]{15}}
    \proofstepwidestar[1,2,15]{%
      ...
      \FormulaRefAuto{RealCauchySequenceDef}[def]{1,2,16}}
    ...
    \proofstepwidestar[20]{%
      x\in T_N}{%
      \rA}
    \proofstepwidestar[1,18,20]{%
      \exists m\in\mathbb N\,(N\leq m\land x=a_m)}{%
      6,\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{1,20}}
    \proofstepwidestar[22]{%
      m\in\mathbb N\land(N\leq m\land x=a_m)}{%
      \rA}
    \proofstepwidestar[18,19,22]{%
      |a_m-a_n|<\varepsilon/2}{%
      \rUE{\rUE{\rAEb{18}}},\ 19,\ 22}
    \proofstepwidestar[1,19]{a_n\in\mathbb R}{%
      \FormulaRefAuto{IndexedFamilyCoordinateTyping}[thm]{1,19}}
    \proofstepwidestar[1,15,18,19,22]{%
      a_n-\varepsilon/2\leq x}{%
      \FormulaRefAuto{RealEpsilonNeighborhoodInterval}[thm]{24,16,23},\ \rIE{\rAEb{\rAEb{22}}},\ \FormulaRefAuto{RealCutTotalOrder}[thm]}
    \proofstepwidestar[1,15,18,19,20]{%
      a_n-\varepsilon/2\leq x}{%
      \rEE{21,22,25}}
    \proofstepwidestar[1,15,18,19]{%
      \forall x\in T_N\,(a_n-\varepsilon/2\leq x)}{%
      \rUI{\rRI{20,26}}}
    \proofstepwidestar[1,5,9,15,18,19]{%
      a_n-\varepsilon/2\leq\alpha_N}{%
      \FormulaRefAuto{RealInfimumCharacterization}[thm]{7,9,27}}
    \proofstepwidestar[1,5,9,14,15,18,19]{%
      a_n-\varepsilon/2\leq L}{%
      \rRE{\rUE{\rAEa{\rAEb{14}}},\rAEa{18}},\ \FormulaRefAuto{RealCutTotalOrder}[thm]{28}}
    \proofstepwidestar[30]{%
      k\in\mathbb N}{%
      \rA}
    \proofstepwidestar[18,30]{%
      N+k\in\mathbb N\land(N\leq N+k\land k\leq N+k)}{%
      \FormulaRefAuto{B21CommonNaturalBound}[thm]{\rAEa{18},30}}
    \proofstepwidestar[1,18,30]{%
      a_{N+k}\in T_k}{%
      6,\ \FormulaRefAuto{IndexedFamilyImageMembership}[thm]{1},\ 31}
    \proofstepwidestar[1,5,9,18,30]{%
      \alpha_k\leq a_{N+k}}{%
      \FormulaRefAuto{RealInfimumCharacterization}[thm]{7,9,32}}
    \proofstepwidestar[18,19,30]{%
      |a_{N+k}-a_n|<\varepsilon/2}{%
      \rUE{\rUE{\rAEb{18}}},\ 19,\ 31}
    \proofstepwidestar[1,5,9,15,18,19,30]{%
      \alpha_k\leq a_n+\varepsilon/2}{%
      \FormulaRefAuto{RealEpsilonNeighborhoodInterval}[thm]{1,16,34},\ \FormulaRefAuto{RealCutTotalOrder}[thm]{33}}
    \proofstepwidestar[1,5,9,15,18,19]{%
      \forall k\in\mathbb N\,(\alpha_k\leq a_n+\varepsilon/2)}{%
      \rUI{\rRI{30,35}}}
    \proofstepwidestar[1,5,9,14,15,18,19]{%
      L\leq a_n+\varepsilon/2}{%
      \rUE{\rAEb{\rAEb{14}}},\ \FormulaRefAuto{RealCutAdditiveClosure}[thm]{1,15},\ 36}
    \proofstepwidestar[1,5,9,14,15,18,19]{%
      |a_n-L|\leq\varepsilon/2<\varepsilon}{%
      \FormulaRefAuto{RealAbsoluteValue}[def],\ \FormulaRefAuto{RealCutNegationOrder}[thm],\ \FormulaRefAuto{RealCutOrderArithmeticCompatibility}[thm]{29,37,16}}
    \proofstepwidestar[1,5,9,14,15,18]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_n-L|<\varepsilon)}{%
      \rEI{\rAI{\rAEa{18},\rUI{\rRI{19,38}}}}}
    \proofstepwidestar[1,2,5,9,14,15]{%
      \exists N\in\mathbb N\,\forall n\in\mathbb N\,(N\leq n\rightarrow|a_n-L|<\varepsilon)}{%
      \rEE{17,18,39}}
    \proofstepwidestar[1,2,5,9,14]{%
      a_n\to L}{%
      \FormulaRefAuto{RealSequenceConvergenceDef}[def]{1,\rAEa{14},\rUI{\rRI{15,40}}}}
    \proofstepwidestar[1,2,5,9,14]{%
      \operatorname{Konv}(a)}{%
      \FormulaRefAuto{RealSequenceConvergentDivergentDef}[def]{1,\rEI{\rAI{\rAEa{14},41}}}}
  ...
  \proofpartwide{Äquivalenz}
    \proofstepwidestar[1]{%
      a\colon\mathbb N\to\mathbb R}{%
      \rA}
    \proofstepwidestar[1]{\operatorname{Konv}(a)\rightarrow\operatorname{Cauchy}(a)}{%
      \FormulaRefAuto{B21CauchyCriterionForward}[thm]{1}}
    \proofstepwidestar[1]{\operatorname{Cauchy}(a)\rightarrow\operatorname{Konv}(a)}{%
      \FormulaRefAuto{B21CauchyCriterionBackward}[thm]{1}}
    \proofstepwidestar[1]{%
      \operatorname{Konv}(a)\leftrightarrow\operatorname{Cauchy}(a)}{%
      \rLRI{2,3}}
  \closeproofpartwide
...
Band~47 erhebt genau diese Gesetze zu den Axiomen einer Metrik und formuliert
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Ein explizit ausgelassener Wert}
    ...
    \proofstepwidestar[]{%
      ...
      \FormulaRefAuto{A\subset B\coloneq A\subseteq B\land A\neq B}[def]{\rAI{22,\FormulaRefAuto{P\rightarrow Q,\neg Q\vdash\neg P}[thm]{\FormulaRefAuto{a=b\vdash b=a}[thm],\FormulaRefAuto{x\in A,x\not\in B\vdash A\neq B}[thm]{4,20}}}}}
  \closeproofpartwide
\end{tabproofsplitwide}
