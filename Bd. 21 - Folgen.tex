...
Band~44 löst die Abstandsargumente von der besonderen Ordnung und Arithmetik
...
\begin{tabproofsplitwide}
  \proofpartwide{Typisierung der Definitionsvorschrift}
    ...
    \proofstepwidestar[1,2]{%
      0<i+1}{%
      \FormulaRefAuto{PeanoLeqAddOneStrict}[thm]{\FormulaRefAuto{PeanoZero}[ax],\rAEa{3},5}}
    \proofstepwidestar[1,2]{%
      1\leq i+1}{%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Injektivität und Surjektivität]{%
    ...
    \proofstepwidestar[1,3]{%
      i=k}{%
      \FormulaRefAuto{PeanoAddOneInjective}[thm]{\FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,\rAEa{\rAEa{3}}},\FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,\rAEb{\rAEa{3}}},4}}
    \proofstepwidestar[1]{%
    ...
    \proofstepwidestar[1,7]{%
      j-1\in\mathbb N}{%
      \FormulaRefAuto{PeanoMinusOneNatural}[thm]{\rAEa{8},9}}
    \proofstepwidestar[1,7]{%
      (j-1)+1=j}{%
      \FormulaRefAuto{PeanoMinusOneAddOne}[thm]{\rAEa{8},9}}
    \proofstepwidestar[1,7]{%
      j-1<n}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{10,1},\ \rIE{11,\rAEb{\rAEb{8}}}}
    \proofstepwidestar[1,7]{%
      j-1\in\NatSeg n}{%
  ...
  \proofpartwide{Wert der Umkehrfunktion}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \FormulaRefAuto{PeanoAddOneMinusOne}[thm]{\FormulaRefAuto{PeanoNatSegElementNatural}[thm]{1,4}}}
    \proofstepwidestar[1,2]{%
      \lambda_n^{-1}(j)=j-1}{%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Eine streng wachsende Indexfolge dominiert den Index]{%
    ...
    \proofstepwidestar[4]{%
      ...
      \rA}
    \proofstepwidestar[1,4]{%
      \varphi(n),\varphi(n+1)\in\mathbb N}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{1,\rAEa{4},\FormulaRefAuto{PeanoAddOneClosure}[thm]}}
    \proofstepwidestar[2,4]{%
      \varphi(n)<\varphi(n+1)}{%
      \rRE{\rUE{2},\rAEa{4}}}
    \proofstepwidestar[1,4]{%
      n<\varphi(n)+1}{%
      \FormulaRefAuto{PeanoLeqAddOneStrict}[thm]{4,5}}
    \proofstepwidestar[1,2,4]{%
      \varphi(n)+1\leq\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{5,6}}
    \proofstepwidestar[1,2,4]{%
      n<\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtLeqTransitive}[thm]{4,5,7,8}}
    \proofstepwidestar[1,2,4]{%
      n+1\leq\varphi(n+1)}{%
      \FormulaRefAuto{PeanoLtAddOneLeq}[thm]{4,5,9}}
    \proofstepwidestar[1,2]{%
      \forall n\in\mathbb N\,(n\leq\varphi(n))}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{3,\rUI{\rRI{4,10}}}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Anfangsschranke: Induktionsschluss]{%
    ...
    \proofstepwidestar[1,2]{%
      \exists C\in\mathbb R\,(0\leq C\land\forall k\in\NatSeg N\,(|a_k|\leq C))}{%
      \FormulaRefAuto{PeanoInductionRuleAddOne}[thm]{\FormulaRefAuto{B21FinitePrefixBase}[thm]{1},\FormulaRefAuto{B21FinitePrefixStep}[thm]{1},2}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Wachsende Folgen: Vergleich beliebiger Indizes]{%
    ...
    \proofstepwidestar[1,2,3,5]{%
      a_{N+k}\leq a_{N+(k+1)}}{%
      \FormulaRefAuto{MonotoneRealSequenceDef}[def]{1,2},\ \FormulaRefAuto{PeanoAddClosure}[thm]{3,5},\ \FormulaRefAuto{PeanoAddAddOneRight}[thm]}
    \proofstepwidestar[1,2,3,5]{%
      a_N\leq a_{N+(k+1)}}{%
...
Band~44 erhebt genau diese Gesetze zu den Axiomen einer Metrik und formuliert
...
\begin{tabproofsplitwide}
  \proofpartwide{Die zusätzliche Trägerbedingung ist erfüllt}
    ...
    \proofstepwidestar[2]{%
      (n+1)+1\in\mathbb N}{%
      \FormulaRefAuto{PeanoAddOneClosure}[thm]{\FormulaRefAuto{PeanoAddOneClosure}[thm]{\rAEa{2}}}}
    \proofstepwidestar[2]{%
      b_{(n+1)+1,j}\in D}{%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Die ersten beiden Zeilen liegen außerhalb der Reserve]{%
    ...
    \proofstepwidestar[1,4]{%
      n+1=0}{%
      \FormulaRefAuto{PeanoAddOneInjective}[thm]{2,\FormulaRefAuto{PeanoZero}[ax],%
        \rIE{4,\FormulaRefAuto{PeanoAddLeftZero}[thm]{\FormulaRefAuto{PeanoOneInN}[thm]}}}}
    \proofstepwidestar[1,4]{%
      \bot}{%
      \rBI{\FormulaRefAuto{PeanoAddOneNonzero}[thm]{1},5}}
    \proofstepwidestar[1]{%
      (n+1)+1\neq1}{%
      \rCI{4,6}}
    \proofstepwidestar[]{%
    ...
    \proofstepwidestar[9,13]{%
      i=(n+1)+1}{%
      \rAEa{\FormulaRefAuto{MogiljanskajaBIndexUnique}[thm]{10,9,13,\FormulaRefAuto{PeanoAddOneClosure}[thm]}}}
    \proofstepwidestar[13]{%
      (n+1)+1\neq0\land(n+1)+1\neq1}{%
      \rRE{\rUE{8},\rAEa{13}}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Unverschobene Zeilen]{%
    ...
    \proofstepwidestar[2,3]{%
      n=m\land j=q}{%
      \FormulaRefAuto{MogiljanskajaBIndexUnique}[thm]{2,4,\FormulaRefAuto{PeanoAddOneClosure}[thm]}}
    \proofstepwidestar[2,3]{%
      n=m\land j=q}{%
      5}
    \proofstepwidestar[2,3]{%
  ...
  \proofpartwideindR[Verschobene Zeilen]{%
    ...
    \proofstepwidestar[2,3]{%
      ...
      \FormulaRefAuto{MogiljanskajaRowParametrizationsDef}[def]{2,3}}
    \proofstepwidestar[2,3]{%
      (n+1)+1=(m+1)+1\land j=q}{%
      \FormulaRefAuto{MogiljanskajaBIndexUnique}[thm]{2,4,\FormulaRefAuto{PeanoAddOneClosure}[thm]}}
    \proofstepwidestar[2,3]{%
      n=m\land j=q}{%
      \FormulaRefAuto{PeanoAddOneInjective}[thm]{\FormulaRefAuto{PeanoAddOneInjective}[thm]{\rAEa{5}}},\ \rAEb{5}}
    \proofstepwidestar[2,3]{%
      (n,j)=(m,q)}{%
      \FormulaRefAuto{(a,b)=(c,d)\eqvdash a=c\land b=d}[thm]{6}}
    \proofstepwidestar[]{%
...
\begin{tabproofsplitwide}
  \proofpartwide{Nullindex und Nachfolgerindex}
    ...
    \proofstepwidestar[3]{%
      b_{n+1,0}=c_2}{%
      \rIE{3},\ \FormulaRefAuto{PeanoAddLeftZero}[thm]{\FormulaRefAuto{PeanoOneInN}[thm]},\ \FormulaRefAuto{MogiljanskajaDPrimeDef}[def]}
    \proofstepwidestar[3]{%
      b_{n+1,0}\in V}{%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Injektivität der Verschiebungsfolge]{%
    ...
    \proofstepwidestar[2,3]{%
      n+1=m+1}{%
      \rAEa{\FormulaRefAuto{MogiljanskajaBIndexUnique}[thm]{2,\FormulaRefAuto{PeanoAddOneClosure}[thm],\FormulaRefAuto{PeanoZero}[ax],4}}}
    \proofstepwidestar[2,3]{%
      n=m}{%
  ...
  \proofpartwide{Anfangswert und punktierte Zielmenge}
    \proofstepwidestar[]{%
      H_0=b_{0+1,0}=c_2}{%
      \FormulaRefAuto{MogiljanskajaShiftSequenceDef}[def]{\FormulaRefAuto{PeanoZero}[ax]},\ \FormulaRefAuto{PeanoAddLeftZero}[thm]{\FormulaRefAuto{PeanoOneInN}[thm]},\ \FormulaRefAuto{MogiljanskajaDPrimeDef}[def]}
    \proofstepwidestar[]{%
      c_2\notin U}{%
      \FormulaRefAuto{MogiljanskajaReserveMarkerFacts}[thm]}
    \proofstepwidestar[]{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Ein explizit ausgelassener Wert}
    ...
    \proofstepwidestar[5]{%
      1=0}{%
      \rAEb{\FormulaRefAuto{MogiljanskajaBIndexUnique}[thm]{\FormulaRefAuto{PeanoZero}[ax],\FormulaRefAuto{PeanoOneInN}[thm],\FormulaRefAuto{PeanoAddOneClosure}[thm],5,6}}}
    \proofstepwidestar[5]{%
      \bot}{%
