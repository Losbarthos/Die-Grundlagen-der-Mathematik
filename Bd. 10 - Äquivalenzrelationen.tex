...
\hypersetup{
  pdftitle={Bd. 10 - Äquivalenzrelationen},
...
\FormulaThmDeltaK[Typisierung der Quotientenprojektionsvorschrift]{%
  \EqRel{A,\sim}\dsep x\in A\vdash
  \tQuotProj{A}{\sim}(x)\in\QuotientSet{A}{\sim}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\tQuotProj{A}{\sim}(x)\in\QuotientSet{A}{\sim}}{\rIE{3,4}}
\end{tabproof}

\FormulaThmDeltaK[Existenz der Quotientenprojektion]{%
  \EqRel{A,\sim}\vdash
  \exists! q\colon A\to\QuotientSet{A}{\sim}\,
  \forall x\in A\,q(x)=\tQuotProj{A}{\sim}(x)
}{QuotProjExists}{%
  \DeltaRow{Mengen}{A\dsep x}
  \DeltaRow{Funktionen}{q}
  \DeltaRow{Funktionensymbol}{\tQuotProj{A}{\sim}}
}
\begin{tabproof}
  \proofstep{1}{\EqRel{A,\sim}}{\rA}
  \proofstep{1}{%
...
\FormulaDefDeltaK[Quotientenprojektion]{%
  \EqRel{A,\sim}\vdash
  \QuotProj{A}{\sim}\coloneqq
  \iota q\Bigl(q\colon A\to\QuotientSet{A}{\sim}\land
  \forall x\in A\,q(x)=\tQuotProj{A}{\sim}(x)\Bigr)
}{QuotProjDef}{%
  \DeltaRow{Mengen}{A\dsep x}
  \DeltaRow{Funktionen}{q\dsep \QuotProj{A}{\sim}}
  \DeltaRow{Funktionensymbol}{\tQuotProj{A}{\sim}}
  \DeltaRow{Neue Symbole}{\QuotProj{A}{\sim}}
}
...
\begin{tabproof}
  ...
  \proofstep{1}{\forall x\in A\,
    \QuotProj{A}{\sim}(x)=\tQuotProj{A}{\sim}(x)}{%
    \rAEb{\FormulaRefAuto{QuotProjDef}{1}}}
  \proofstep{1,2}{\QuotProj{A}{\sim}(x)=\tQuotProj{A}{\sim}(x)}{%
    \rRE{2,\rUE{3}}}
  \proofstep{1,2}{\tQuotProj{A}{\sim}(x)=\EqClass{x}{\sim}{A}}{%
    \FormulaRefAuto{QuotProjRuleDef}{1,2}}
  \proofstep{1,2}{\QuotProj{A}{\sim}(x)=\EqClass{x}{\sim}{A}}{%
