...
\subsection{Die Gleichmächtigkeitsrelation auf einer Mengenfamilie}

Die Aussage \(A\EqCard B\) ist zunächst für beliebige Mengen formuliert.
Damit daraus im Sinn des hier verwendeten Relationsbegriffs eine Relation auf
einem festen Träger wird, beschränken wir sie auf eine Mengenfamilie \(M\).

\FormulaDefDeltaK[Gleichmächtigkeitsrelation auf einer Mengenfamilie]{%
  \EqCardRel{M}\coloneqq
  \{(A,B)\in M\times M\mid A\EqCard B\}
}{EqCardRelDef}{%
  \DeltaRow{Mengen}{M\dsep A\dsep B\dsep C}
  \DeltaRow{Relationen}{\EqCardRel{M}}
  \DeltaRow{Neue Symbole}{\EqCardRel{M}}
}

\FormulaThmDeltaK[Charakterisierung der Gleichmächtigkeitsrelation]{%
  (A,B)\in\EqCardRel{M}
  \eqvdash
  A\in M\land B\in M\land A\EqCard B
}{EqCardRelChar}{%
...
\begin{tabproofsplit}
  \proofpart{\(\vdash\)}
    \proofstep{1}{(A,B)\in\EqCardRel{M}}{\rA}
    \proofstep{}{%
      \EqCardRel{M}\coloneqq
      \{(A,B)\in M\times M\mid A\EqCard B\}}{%
      \FormulaRefAuto{EqCardRelDef}}
    \proofstep{1}{%
      (A,B)\in M\times M\land A\EqCard B}{%
      \FormulaRefAuto{x\in\{u\in A\mid P(u)\}
        \eqvdash x\in A\land P(x)}{2,1}}
    \proofstep{1}{(A,B)\in M\times M}{\rAEa{3}}
    \proofstep{1}{A\EqCard B}{\rAEb{3}}
    \proofstep{1}{A\in M}{%
      \FormulaRefAuto{(a,b)\in A\times B\vdash a\in A}{4}}
    \proofstep{1}{B\in M}{%
      \FormulaRefAuto{(a,b)\in A\times B\vdash b\in B}{4}}
    \proofstep{1}{A\in M\land B\in M\land A\EqCard B}{%
      \rAI{6,\rAI{7,5}}}
  \closeproofpart

  \proofpart{\(\dashv\)}
    \proofstep{1}{A\in M\land B\in M\land A\EqCard B}{\rA}
    \proofstep{}{%
      \EqCardRel{M}\coloneqq
      \{(A,B)\in M\times M\mid A\EqCard B\}}{%
      \FormulaRefAuto{EqCardRelDef}}
    \proofstep{1}{A\in M}{\rAEa{1}}
    \proofstep{1}{B\in M}{\rAEa{\rAEb{1}}}
    \proofstep{1}{A\EqCard B}{\rAEb{\rAEb{1}}}
    \proofstep{1}{(A,B)\in M\times M}{%
      \FormulaRefAuto{a\in A\dsep b\in B
        \vdash (a,b)\in A\times B}{3,4}}
    \proofstep{1}{(A,B)\in M\times M\land A\EqCard B}{%
      \rAI{6,5}}
    \proofstep{1}{(A,B)\in\EqCardRel{M}}{%
      \FormulaRefAuto{x\in\{u\in A\mid P(u)\}
        \eqvdash x\in A\land P(x)}{2,7}}
  \closeproofpart
\end{tabproofsplit}

\FormulaThmDeltaK[Trägerbedingung der Gleichmächtigkeitsrelation]{%
  \EqCardRel{M}\subseteq M\times M
}{EqCardRelCarrier}{%
  \DeltaRow{Mengen}{M\dsep A\dsep B}
  \DeltaRow{Relationen}{\EqCardRel{M}}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{(A,B)\in\EqCardRel{M}}{\rA}
  \proofstepwidestar[1]{A\in M\land B\in M\land A\EqCard B}{%
    \FormulaRefAuto{EqCardRelChar}{1}}
  \proofstepwidestar[1]{A\in M}{\rAEa{2}}
  \proofstepwidestar[1]{B\in M}{\rAEa{\rAEb{2}}}
  \proofstepwidestar[1]{(A,B)\in M\times M}{%
    \FormulaRefAuto{a\in A\dsep b\in B
      \vdash (a,b)\in A\times B}{3,4}}
  \proofstepwidestar[]{\EqCardRel{M}\subseteq M\times M}{%
    \FormulaRefAuto{A\subseteq B\coloneq
      \forall x\,(x\in A\rightarrow x\in B)}{\rUI{\rRI{1,5}}}}
\end{tabproofwide}

\FormulaThmDeltaK[Reflexivität der Gleichmächtigkeitsrelation]{%
  A\in M\vdash (A,A)\in\EqCardRel{M}
}{EqCardRelReflexivity}{%
  \DeltaRow{Mengen}{M\dsep A}
  \DeltaRow{Relationen}{\EqCardRel{M}}
}
\begin{tabproof}
  \proofstep{1}{A\in M}{\rA}
  \proofstep{}{A\EqCard A}{\FormulaRefAuto{EqCardReflexive}}
  \proofstep{1}{A\in M\land A\in M\land A\EqCard A}{%
    \rAI{1,\rAI{1,2}}}
  \proofstep{1}{(A,A)\in\EqCardRel{M}}{%
    \FormulaRefAuto{EqCardRelChar}{3}}
\end{tabproof}

\FormulaThmDeltaK[Symmetrie der Gleichmächtigkeitsrelation]{%
  (A,B)\in\EqCardRel{M}\vdash (B,A)\in\EqCardRel{M}
}{EqCardRelSymmetry}{%
  \DeltaRow{Mengen}{M\dsep A\dsep B}
  \DeltaRow{Relationen}{\EqCardRel{M}}
}
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{B\in M}{\rAEa{\rAEb{2}}}
  \proofstepwidestar[1]{A\in M}{\rAEa{2}}
  \proofstepwidestar[1]{A\EqCard B}{\rAEb{\rAEb{2}}}
  \proofstepwidestar[1]{B\EqCard A}{%
    \FormulaRefAuto{EqCardSymmetric}{5}}
  \proofstepwidestar[1]{B\in M\land A\in M\land B\EqCard A}{%
    \rAI{3,\rAI{4,6}}}
  \proofstepwidestar[1]{(B,A)\in\EqCardRel{M}}{%
    \FormulaRefAuto{EqCardRelChar}{7}}
\end{tabproofwide}

\FormulaThmDeltaK[Transitivität der Gleichmächtigkeitsrelation]{%
  (A,B)\in\EqCardRel{M}\dsep (B,C)\in\EqCardRel{M}
  \vdash (A,C)\in\EqCardRel{M}
}{EqCardRelTransitivity}{%
  \DeltaRow{Mengen}{M\dsep A\dsep B\dsep C}
  \DeltaRow{Relationen}{\EqCardRel{M}}
}
\begin{tabproofsplitwide}
  \proofpartwideindR[Gleichmächtigkeit der äußeren Mengen]{%
    (A,B)\in\EqCardRel{M}\dsep (B,C)\in\EqCardRel{M}
    \vdash A\EqCard C
  }{%
    (A,B)\in\EqCardRel{M}\dsep (B,C)\in\EqCardRel{M}
    \vdash A\EqCard C
  }[EqCardRelTransitivityOuterSets]
    \proofstepwidestar[1]{(A,B)\in\EqCardRel{M}}{\rA}
    \proofstepwidestar[2]{(B,C)\in\EqCardRel{M}}{\rA}
    \proofstepwidestar[1]{A\in M\land B\in M\land A\EqCard B}{%
      \FormulaRefAuto{EqCardRelChar}{1}}
    \proofstepwidestar[2]{B\in M\land C\in M\land B\EqCard C}{%
      \FormulaRefAuto{EqCardRelChar}{2}}
    \proofstepwidestar[1]{A\EqCard B}{\rAEb{\rAEb{3}}}
    \proofstepwidestar[2]{B\EqCard C}{\rAEb{\rAEb{4}}}
    \proofstepwidestar[1,2]{A\EqCard C}{%
      \FormulaRefAuto{EqCardTransitive}{5,6}}
  \closeproofpartwideindR

  \proofpartwide{Einsetzen in die Gleichmächtigkeitsrelation}
    \proofstepwidestar[1]{(A,B)\in\EqCardRel{M}}{\rA}
    \proofstepwidestar[2]{(B,C)\in\EqCardRel{M}}{\rA}
    \proofstepwidestar[1]{A\in M\land B\in M\land A\EqCard B}{%
      \FormulaRefAuto{EqCardRelChar}{1}}
    \proofstepwidestar[2]{B\in M\land C\in M\land B\EqCard C}{%
      \FormulaRefAuto{EqCardRelChar}{2}}
    \proofstepwidestar[1]{A\in M}{\rAEa{3}}
    \proofstepwidestar[2]{C\in M}{\rAEa{\rAEb{4}}}
    \proofstepwidestar[1,2]{A\EqCard C}{%
      \FormulaRefAuto{EqCardRelTransitivityOuterSets}{1,2}}
    \proofstepwidestar[1,2]{A\in M\land C\in M\land A\EqCard C}{%
      \rAI{5,\rAI{6,7}}}
    \proofstepwidestar[1,2]{(A,C)\in\EqCardRel{M}}{%
      \FormulaRefAuto{EqCardRelChar}{8}}
  \closeproofpartwide
...
\begin{tabproof}
  \proofstep{}{\EqCardRel{M}\subseteq M\times M}{%
    \FormulaRefAuto{EqCardRelCarrier}}
  \proofstep{}{A\in M\rightarrow(A,A)\in\EqCardRel{M}}{%
    \FormulaRefAuto{EqCardRelReflexivity}}
  \proofstep{}{(A,B)\in\EqCardRel{M}\rightarrow
    (B,A)\in\EqCardRel{M}}{%
    \FormulaRefAuto{EqCardRelSymmetry}}
  \proofstep{}{%
    \bigl((A,B)\in\EqCardRel{M}\land(B,C)\in\EqCardRel{M}\bigr)
    \rightarrow(A,C)\in\EqCardRel{M}}{%
    \FormulaRefAuto{EqCardRelTransitivity}}
  \proofstep{}{\EqRel{\EqCardRel{M},M}}{%
    \FormulaRefAuto{EqRelDef}{1,2,3,4}}
\end{tabproof}
...
\begin{tabproofsplit}
  \proofpartindR[Hinrichtung]{%
    \EqRel{R,A}\dsep x\in A\vdash
    y\in \EqClass{x}{R}{A}
    \rightarrow y\in A\land (x,y)\in R%
  }{%
    \EqRel{R,A}\dsep x\in A\vdash
    y\in \EqClass{x}{R}{A}
    \rightarrow y\in A\land (x,y)\in R%
  ...
  \proofpartindR[Rückrichtung]{%
    ...
    \proofstep{1,2}{%
      ...
      \{y\in A\mid (x,y)\in R\}}{%
      \FormulaRefAuto{EqClassDef}{1,2}}
    \proofstep{4}{y\in A\land (x,y)\in R}{\rA}
    \proofstep{1,2,4}{y\in \EqClass{x}{R}{A}}{%
      \FormulaRefAuto{x \in \{u \in A \mid P(u)\} \eqvdash
        x \in A \land P(x)}{3,4}}
    \proofstep{1,2}{%
      y\in A\land (x,y)\in R
      \rightarrow y\in \EqClass{x}{R}{A}}{\rRI{4,5}}
  \closeproofpartindR

  \proofpartindR[Zusammenführung]{%
    \EqRel{R,A}\dsep x\in A\vdash
    y\in \EqClass{x}{R}{A}
    \leftrightarrow y\in A\land (x,y)\in R%
  }{%
    \EqRel{R,A}\dsep x\in A\vdash
    y\in \EqClass{x}{R}{A}
    \leftrightarrow y\in A\land (x,y)\in R%
    ...
    \proofstep{1,2}{%
      y\in \EqClass{x}{R}{A}
      \leftrightarrow y\in A\land (x,y)\in R}{\rLRI{3,4}}
  \closeproofpartindR
\end{tabproofsplit}
...
\begin{tabproofsplit}
  \proofpartindR[Von gleichen Klassen zur Relation]{%
    \begin{aligned}[t]
      &\EqRel{R,A}\dsep x\in A\dsep y\in A\vdash{}\\
      &\EqClass{x}{R}{A}=\EqClass{y}{R}{A}
      \rightarrow (x,y)\in R
    \end{aligned}%
  }{%
  ...
  \proofpartindR[Von der Relation zu gleichen Klassen]{%
    \begin{aligned}[t]
      &\EqRel{R,A}\dsep x\in A\dsep y\in A\vdash{}\\
      &(x,y)\in R
      \rightarrow \EqClass{x}{R}{A}=\EqClass{y}{R}{A}
    \end{aligned}%
  }{%
    \EqRel{R,A}\dsep x\in A\dsep y\in A\vdash
    (x,y)\in R
    ...
    \proofstep{2}{x\in A}{\rA}
    \proofstep{3}{y\in A}{\rA}
    \proofstep{4}{(x,y)\in R}{\rA}
    \proofstep{1,2,3,4}{\EqClass{x}{R}{A}=\EqClass{y}{R}{A}}{%
      \FormulaRefAuto{EqClassEqualFromRel}{1,2,3,4}}
    \proofstep{1,2,3}{%
      (x,y)\in R
      \rightarrow \EqClass{x}{R}{A}=\EqClass{y}{R}{A}}{\rRI{4,5}}
  \closeproofpartindR
...
\begin{tabproofsplit}
  \proofpartindR[Teilmenge des Grundbereichs]{%
    \EqRel{R,A}\dsep x\in A
    \vdash \EqClass{x}{R}{A}\subseteq A%
  }{%
    \EqRel{R,A}\dsep x\in A
    \vdash \EqClass{x}{R}{A}\subseteq A%
  ...
  \proofpartindR[Zeuge der Quotientendefinition]{%
    ...
    \proofstep{1,2}{%
      \EqClass{x}{R}{A}\in\powerset(A)\land
      \exists z\in A\,
        \EqClass{x}{R}{A}=\EqClass{z}{R}{A}}{\rAI{4,6}}
  \closeproofpartindR

  \proofpartindR[Einsetzen in die Quotientenmenge]{%
    \EqRel{R,A}\dsep x\in A
    \vdash \EqClass{x}{R}{A}\in\QuotientSet{A}{R}%
  }{%
    \EqRel{R,A}\dsep x\in A
    \vdash \EqClass{x}{R}{A}\in\QuotientSet{A}{R}%
...
\begin{tabproofsplit}
  ...
  \proofpartindR[Potenzmengenabbildung als Bild]{%
    \begin{aligned}[t]
      &\EqRel{R,A}\dsep M\subseteq\powerset(A)\dsep X\in M
      \vdash{}\\
      &\PowMap{\QuotProj{A}{R}}(X)=\QuotProj{A}{R}[X]
    \end{aligned}%
  }{%
    \EqRel{R,A}\dsep M\subseteq\powerset(A)\dsep X\in M
    \vdash
...
\FormulaThmDeltaK[Gleichheit von Ununterscheidbarkeitsprojektionswerten]{%
  ...
  \leftrightarrow(a,b)\in\SameOccRel{M}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Ununterscheidbarkeit der Repräsentanten]{%
    \begin{aligned}[t]
      &C\in\OccQuotCarrier{M}\dsep D\in\OccQuotCarrier{M}\dsep{}\\[-2pt]
      &\TraceMap{\OccQuotMap{M}}(C)=
      \TraceMap{\OccQuotMap{M}}(D)\dsep{}\\[-2pt]
