...
\begin{tabproofsplitwide}
  \proofpartwideindR[\(\rightarrow\)]{%
    ...
    \proofstepwidestar[1,2,3,4]{y\in\GraphNeighbors{E}{x}\leftrightarrow(x,y)\in E}{%
      \FormulaRefAuto{UndirectedNeighborhoodMembership}[thm]{1,2,3}}
    \proofstepwidestar[1,2,3,4]{(x,y)\in E}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}[thm]{%
        5,4}}
    \proofstepwidestar[1,2,3,4]{(y,x)\in E}{%
      \FormulaRefAuto{UndirectedAdjacencySymmetric}[thm]{1,2,3,6}}
    \proofstepwidestar[1,2,3,4]{x\in\GraphNeighbors{E}{y}\leftrightarrow(y,x)\in E}{%
      \FormulaRefAuto{UndirectedNeighborhoodMembership}[thm]{1,3,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,5]{(x,y)\in\DirectedInducedEdges{E}{U}\leftrightarrow((x,y)\in E\land x\in U\land y\in U)}{%
      \FormulaRefAuto{DirectedInducedEdgeMembership}[thm]{6,2}}
  \proofstepwidestar[1,2,5]{%
    (x,y)\in E\land x\in U\land y\in U}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}[thm]{%
      9,5}}
  \proofstepwidestar[1,2,5]{(x,y)\in E}{\rAEa{10}}
  \proofstepwidestar[1,2,3,4,5]{(y,x)\in E}{%
    \FormulaRefAuto{UndirectedAdjacencySymmetric}[thm]{1,7,8,11}}
  \proofstepwidestar[1,2,3,4,5]{%
    (y,x)\in E\land y\in U\land x\in U}{%
    \FormulaRefAuto{P\dsep Q\dsep R\vdash P\land Q\land R}[thm]{12,4,3}}
  \proofstepwidestar[1,2,3,4,5]{(y,x)\in\DirectedInducedEdges{E}{U}\leftrightarrow((y,x)\in E\land y\in U\land x\in U)}{%
      \FormulaRefAuto{DirectedInducedEdgeMembership}[thm]{6,2}}
  \proofstepwidestar[1,2,3,4,5]{%
    (y,x)\in\DirectedInducedEdges{E}{U}}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}[thm]{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{x,y\in U\dsep(x,y)\in\DirectedInducedEdges{E}{U}\vdash(y,x)\in\DirectedInducedEdges{E}{U}}{%
      \FormulaRefAuto{UndirectedInducedAdjacencySymmetric}[thm]{1,2}}
