...
Jetzt wenden wir die
aus W3 abgeleitete Strukturinduktion auf das konkrete Wortmodell an
...
Wir wenden \FormulaRefAuto{WordStructureInduction}[thm] auf das Modell
...
\input{tex/b27-finite-word-induction-from-axioms}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,3,4,5]{\WordConcat u{\LetterWord a}\in C}{\rIE{8,7}}
