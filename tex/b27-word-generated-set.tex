...
Wie bei den abgeleiteten Regeln in Band~2 wird die vorausgesetzte
Teilableitung mit ihren lokalen Annahmen und ihrem Ziel angegeben.
Anschließend werden die Annahmen einzeln entlassen und die
Schrittvariablen verallgemeinert.
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[3,4,5]{P(\OccurrenceAdjunction u a)}{%
    \begin{aligned}[t]
      &[u\in\FiniteWords A,a\in A,P(u)]\\[-2pt]
      &\vdots P(\OccurrenceAdjunction u a)(3,4,5)
    \end{aligned}}
  \proofstepwidestar[3,4]{P(u)\rightarrow P(\OccurrenceAdjunction u a)}{%
    \rRI{5,6}}
  \proofstepwidestar[3]{a\in A\rightarrow
    (P(u)\rightarrow P(\OccurrenceAdjunction u a))}{\rRI{4,7}}
  \proofstepwidestar[3]{\forall a\in A\,
    (P(u)\rightarrow P(\OccurrenceAdjunction u a))}{\rUI{8}}
  \proofstepwidestar[]{u\in\FiniteWords A\rightarrow
    \forall a\in A\,(P(u)\rightarrow P(\OccurrenceAdjunction u a))}{%
    \rRI{3,9}}
  \proofstepwidestar[]{\forall u\in\FiniteWords A\,\forall a\in A\,
    (P(u)\rightarrow P(\OccurrenceAdjunction u a))}{\rUI{10}}
  \proofstepwidestar[1,2]{P(v)}{%
    \FormulaRefAuto{GeneratedWordInduction}[thm]{1,11,2}}
\end{tabproofwide}
