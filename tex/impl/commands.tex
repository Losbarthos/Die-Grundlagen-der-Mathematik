...
\usepackage{tikz}
    ...
    \newcommand{\AC}{\mathsf{AC}} % oder \mathrm{AC}, Geschmackssache
    
    % Optionale Abkürzungen für die drei Varianten
    \newcommand{\ACsur}{\AC_{\mathrm{sur}}}
    \newcommand{\ACrel}{\AC_{\mathrm{rel}}}
    \newcommand{\ACfam}{\AC_{\mathrm{fam}}}

    \newcommand{\DisjFam}{\mathsf{DisjFam}}
    \newcommand{\TotRel}[1]{\mathsf{TR}(#1)}


    \providecommand{\restriction}{\upharpoonright}


    \DeclareMathOperator{\Ausw}{Ausw}
    \DeclareMathOperator{\Fib}{Fib}
    % Faserfamilie
    \DeclareMathOperator{\FibFam}{FibFam}
    % Faserabbildung (Zuordnung y ↦ Fib_F(y))
    \newcommand{\FibMap}{\Phi}
