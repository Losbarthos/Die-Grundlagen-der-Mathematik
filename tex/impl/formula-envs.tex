...
\NewDocumentCommand{\FormulaDefAuto}{o m}{%
  ...
  \IfNoValueTF{#1}
    {%
      ...
      \label{\mxLbl}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{\mxKey}%
    }
    {%
      \begin{formulaDef}[#1]%
      \edef\mxLbl{def:auto:\theformulaDef}%
      \label{\mxLbl}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{\mxKey}{#1}%
    }%
...
\NewDocumentCommand{\FormulaAxiomAutoR}{o m m}{%
  \IfNoValueTF{#1}
    {\begin{formulaAx}\label{ax:auto:\theformulaAx}%
      \ThmLookupRegister{ax:auto:\theformulaAx}{axiom}{\theformulaAx}{#3}%
    }
    {\begin{formulaAx}[#1]\label{ax:auto:\theformulaAx}%
      \ThmLookupRegister{ax:auto:\theformulaAx}{axiom}{\theformulaAx}{#3}{#1}%
    }%
...
\NewDocumentCommand{\FormulaDefDelta}{o m +G{}}{%
  % Wrapper wie bei ThmAuto/ThmDelta: verhindert 1-Schritt-Expansion von \TotRel, \bigcup, ...
  \def\mxKey{#2}%
  \IfNoValueTF{#1}
    {%
      \begin{formulaDef}%
...
\NewDocumentCommand{\FormulaThmDelta}{o m +G{}}{%
  % Keyformel wie bei Auto: Wrapper verhindert 1-Schritt-Expansion des ersten Tokens der eigentlichen Formel
  \def\mxKey{#2}%
  \IfNoValueTF{#1}
    {%
      \begin{formulaThm}%
...
\NewDocumentCommand{\FormulaAxiomDelta}{o m +m}{%
  % Wrapper: verhindert 1-Schritt-Expansion des ersten Formeltokens
  \def\mxKey{#2}%
  \IfNoValueTF{#1}
    {%
      \begin{formulaAx}%
      \edef\mxLbl{ax:auto:\theformulaAx}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{\mxKey}%
    }
    {%
      \begin{formulaAx}[#1]%
      \edef\mxLbl{ax:auto:\theformulaAx}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{\mxKey}{#1}%
    }%
...
% Layout changes to a definition preserve its structural formula and ID.
% [Title]{Display}{Original structure}{ID}{Delta rows}
\NewDocumentCommand{\FormulaDefDeltaKR}{o m m m +m}{%
  ...
  \IfNoValueTF{#1}
    {%
      ...
      \edef\mxLbl{def:auto:\theformulaDef}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{#3}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{#4}%
    }{%
      \begin{formulaDef}[#1]%
      \edef\mxLbl{def:auto:\theformulaDef}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{#3}{#1}%
      \ThmLookupRegister{\mxLbl}{definition}{\theformulaDef}{#4}{#1}%
    }%
  \ThmLookupRegisterId{#4}{definition}{\mxLbl}%
  \MxPushFormula{definition}{\mxLbl}{#2}%
  \IfBlankTF{#5}{}{%
    \begin{DeltaContext}{ }%
      #5%
...
% Display-only changes (for example numbered conclusion lists) keep both
% the original structural lookup key and the explicit theorem ID.
% [Title]{Display}{Original structure}{ID}{Delta rows}
\NewDocumentCommand{\FormulaThmDeltaKR}{o m m m +m}{%
  \par\noindent\begin{minipage}{\linewidth}%
  \IfNoValueTF{#1}
    {%
      \begin{formulaThm}%
      \edef\mxLbl{thm:auto:\theformulaThm}%
      \ThmLookupRegister{\mxLbl}{theorem}{\theformulaThm}{#3}%
    }{%
      \begin{formulaThm}[#1]%
      \edef\mxLbl{thm:auto:\theformulaThm}%
      \ThmLookupRegister{\mxLbl}{theorem}{\theformulaThm}{#3}{#1}%
    }%
  \ThmLookupRegisterId{#4}{theorem}{\mxLbl}%
  \MxPushFormula{theorem}{\mxLbl}{#2}%
  \begin{DeltaContext}{ }%
...
\NewDocumentCommand{\FormulaAxiomDeltaK}{o m m +m}{%
  \IfNoValueTF{#1}
    {%
      ...
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{#3}%  <-- FIX
    }{%
      \begin{formulaAx}[#1]%
      \edef\mxLbl{ax:auto:\theformulaAx}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{#2}{#1}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{#3}{#1}% <-- FIX
    }%
...
% ------------------------------------------------------------
% DeltaR: Theorem  (Key #3 für Referenz, Anzeige #2)
% ------------------------------------------------------------
\NewDocumentCommand{\FormulaThmDeltaR}{o m m +m}{%
  \IfNoValueTF{#1}
    {%
      \begin{formulaThm}%
      \edef\mxLbl{thm:auto:\theformulaThm}%
  ...
  % \ThmLookupRegisterId{#3}{theorem}{\mxLbl}%  <-- diese Zeile entfernen
  \MxPushFormula{theorem}{\mxLbl}{#2}%
  \begin{DeltaContext}{ }%
    #4%
  \end{DeltaContext}%
...
% DeltaR: Definition
% ------------------------------------------------------------
\NewDocumentCommand{\FormulaDefDeltaR}{o m m +m}{%
  \IfNoValueTF{#1}
    {%
      \begin{formulaDef}%
      \edef\mxLbl{def:auto:\theformulaDef}%
...
% DeltaR: Axiom
% ------------------------------------------------------------
\NewDocumentCommand{\FormulaAxiomDeltaR}{o m m +m}{%
  \IfNoValueTF{#1}
    {%
      \begin{formulaAx}%
      \edef\mxLbl{ax:auto:\theformulaAx}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{#3}%
    }{%
      \begin{formulaAx}[#1]%
      \edef\mxLbl{ax:auto:\theformulaAx}%
      \ThmLookupRegister{\mxLbl}{axiom}{\theformulaAx}{#3}{#1}%
    }%
  \ThmLookupRegisterId{#3}{axiom}{\mxLbl}%
  \MxPushFormula{axiom}{\mxLbl}{#2}%
  \begin{DeltaContext}{ }%
...
\cs_new_protected:Npn \mx_formula_ref_suffix:n #1
  {
    \IfNoValueF{#1}
      { \tl_if_blank:nF {#1}
          { \allowbreak (\mxProofPairedDependencies{#1}) } }
  }
          ...
          \IfBooleanTF{#1}
            {
              \use:x
                {
                  \exp_not:N \ThmRefByStructure * [ \exp_not:V \l_tmpa_tl ]
                  { \exp_not:n {#3} }
                }
            }
            {
  ...
  \IfBooleanTF{#1}
    {
      \use:x
        {
          \exp_not:N \ThmRefByStructureFwd * [ \exp_not:V \l_tmpa_tl ]
          { \exp_not:n {#3} }
        }
    }
    {
