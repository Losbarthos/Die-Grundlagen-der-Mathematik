...
\makeatletter
\providecommand{\ThmLookupPrefix@theorem}{\textnormal{Th.}}
\providecommand{\ThmLookupPrefix@definition}{\textnormal{Def.}}
\providecommand{\ThmLookupPrefix@axiom}{\textnormal{Ax.}}
\providecommand{\ThmLookupPrefix@fallback}{\textnormal{Ref.}}
\makeatother
...
% Wie \ThmLookupEmitRef, aber mit Registry-Nummer als Fallback, falls das
% zugehörige .aux-Label noch fehlt oder aus einem älteren Label-Schema stammt.
...
\NewDocumentCommand{\ThmRefByStructure}{s O{} m}{%
  \begingroup
    ...
    % Inline-Verweise dürfen auch in Absatzspalten keinen Absatz erzeugen.
