...
\NewDocumentCommand{\ThmRefByStructureFwd}{s O{} m}{%
  \begingroup
    ...
    % immer in .aux schreiben; die Hilfsmakros vorher vollständig auswerten,
    % damit keine lokalen \mx...-Namen in einer halb geschriebenen .aux landen.
    \edef\mxFwdAuxLine{%
      \string\mxFwdNeed{\mxFwdQKey}{\mxOptsStr}{\mxExprStr}{\mxStarNum}%
    }%
    \protected@write\@auxout{}{\mxFwdAuxLine}%
