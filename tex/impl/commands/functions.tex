...
\DeclareRobustCommand{\AdjGoodMap}[2]{J^{#1,\mathrm{g}}_{#2}}
\DeclareRobustCommand{\tAdjGoodMap}[2]{t_{\AdjGoodMap{#1}{#2}}}
\DeclareRobustCommand{\FranklAdjCorr}[3]{J^{#1,#3}_{#2}}

% Vereinigungsabbildung fuer nichtleere Generator-Teilmengen.
\DeclareRobustCommand{\UnionEval}[1]{\Phi_{#1}}
\DeclareRobustCommand{\tUnionEval}[1]{t_{\UnionEval{#1}}}
