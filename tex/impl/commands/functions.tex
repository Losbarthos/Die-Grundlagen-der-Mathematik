...
% Relationen der Tarski-Konstruktion
\DeclareRobustCommand{\TarskiUpRel}[1]{R^{\uparrow}_{#1}}
\DeclareRobustCommand{\tTarskiUpRel}[1]{t_{\TarskiUpRel{#1}}}
\DeclareRobustCommand{\TarskiDeltaRel}[2]{R^{\Delta}_{#1,#2}}
