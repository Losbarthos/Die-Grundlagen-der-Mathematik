...
\DeclareRobustCommand{\StrictSupSel}[1]{S^{\subset}_{#1}}
\DeclareRobustCommand{\tStrictSupSel}[1]{t_{\StrictSupSel{#1}}}
\DeclareRobustCommand{\FreshRel}[1]{Q_{#1}}
\DeclareRobustCommand{\FreshSel}[1]{D_{#1}}
\DeclareRobustCommand{\tFreshSel}[1]{t_{\FreshSel{#1}}}
