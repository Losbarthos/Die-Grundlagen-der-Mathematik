...
% Place-value evaluation. The last argument is the length of the segment.
...
\DeclareRobustCommand{\BinNum}[2]{%
  \ensuremath{\BaseNum{2}{#1}{#2}}%
}
\DeclareRobustCommand{\DecNum}[2]{%
  \ensuremath{\mathord{\overline{\DigitBlockRaw{#1}{#2}}}}%
}
...
\DeclareRobustCommand{\BinDigitString}[1]{%
  \ensuremath{\BaseDigitString{2}{#1}}%
}
\DeclareRobustCommand{\DecDigitString}[1]{%
  \ensuremath{\mathord{\overline{#1}}}%
}
