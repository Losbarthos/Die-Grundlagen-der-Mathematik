...
\providecommand{\rAIStar}[1]{\RuleRefWithArg{AIStar}{\land I^{*}}{#1}}
\providecommand{\rAIRepeat}[3]{%
  \RuleRefWithArg{AIStar}{\land I^{*}}{%
    \operatorname{Wdh}_{#1}\!(#2\allowbreak\,;\,\allowbreak#3)}}
\providecommand{\rAIReuse}[2]{%
  \RuleRefWithArg{AIStar}{\land I^{*}}{%
    \operatorname{Wdh}_{#1}\!(#2)}}
...
\providecommand{\rEIStar}[1]{\RuleRefWithArg{EIStar}{\exists I^{*}}{#1}}
\providecommand{\rEEStar}[1]{\RuleRefWithArg{EEStar}{\exists E^{*}}{#1}}
