...
\DeclareRobustCommand{\FiniteSemigroupAlg}[2]{%
  \ensuremath{\mathsf{FinHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\CommutativeSemigroupAlg}[2]{%
  \ensuremath{\mathsf{KHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\IdempotentSemigroupAlg}[2]{%
  \ensuremath{\mathsf{IdemHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\RectangularBandAlg}[2]{%
  \ensuremath{\mathsf{RB}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\CommutativeIdempotentSemigroupAlg}[2]{%
  \ensuremath{\mathsf{KIHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\SemigroupWithZeroAlg}[3]{%
  \ensuremath{\mathsf{HGr}_{0}\!\left(#1,#2,#3\right)}%
}
\DeclareRobustCommand{\LeftCancellativeSemigroupAlg}[2]{%
  \ensuremath{\mathsf{LK\ddot{u}rzHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\RightCancellativeSemigroupAlg}[2]{%
  \ensuremath{\mathsf{RK\ddot{u}rzHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\CancellativeSemigroupAlg}[2]{%
  \ensuremath{\mathsf{K\ddot{u}rzHGr}\!\left(#1,#2\right)}%
}
\DeclareRobustCommand{\SemigroupLeftDivides}[3]{%
  \ensuremath{#2\mathrel{\mid^{\ell}_{#1}}#3}%
}
\DeclareRobustCommand{\SemigroupRightDivides}[3]{%
  \ensuremath{#2\mathrel{\mid^{r}_{#1}}#3}%
}
\DeclareRobustCommand{\SemigroupDivides}[3]{%
  \ensuremath{#2\mathrel{\mid_{#1}}#3}%
}
\DeclareRobustCommand{\SemigroupPrime}[2]{%
  \ensuremath{\mathsf{HGrPrim}_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\SemigroupLeftAnnihilator}[2]{%
  \ensuremath{\mathop{\mathrm{Ann}}\nolimits^{\ell}_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\SemigroupRightAnnihilator}[2]{%
  \ensuremath{\mathop{\mathrm{Ann}}\nolimits^{r}_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\SemigroupAnnihilator}[2]{%
  \ensuremath{\mathop{\mathrm{Ann}}\nolimits_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\MonoidAlg}[3]{%
  \ensuremath{\mathsf{Mon}\!\left(#1,#2,#3\right)}%
}
\DeclareRobustCommand{\FiniteMonoidAlg}[3]{%
  \ensuremath{\mathsf{FinMon}\!\left(#1,#2,#3\right)}%
}
\DeclareRobustCommand{\CommutativeMonoidAlg}[3]{%
  \ensuremath{\mathsf{KMon}\!\left(#1,#2,#3\right)}%
}
\DeclareRobustCommand{\MonoidUnit}[2]{%
  \ensuremath{\mathsf{Einh}_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\MonoidDivides}[3]{%
  \ensuremath{#2\mathrel{\mid_{#1}}#3}%
}
\DeclareRobustCommand{\MonoidIrreducible}[2]{%
  \ensuremath{\mathsf{Irr}_{#1}\!\left(#2\right)}%
}
\DeclareRobustCommand{\MonoidPrime}[2]{%
  \ensuremath{\mathsf{Prim}_{#1}\!\left(#2\right)}%
}
...
\DeclareRobustCommand{\FiniteSemiringAlg}[5]{%
  \ensuremath{\mathsf{FinHring}\!\left(#1,#2,#3,#4,#5\right)}%
}
...
% Koordinatendarstellung einer Halbgruppe bezueglich eines Basiselements.
% Die ersten beiden Argumente halten die Struktur im Quelltext explizit;
% typographisch genuegt bei festem (A,*) der Index des Basiselements.
% Kappa ist im Band Rechtecksbaender bereits fuer Kongruenzen belegt; daher
% bezeichnet chi die konkrete Koordinatenabbildung.
\DeclareRobustCommand{\SemigroupCoordinateCarrier}[3]{%
  \ensuremath{\mathcal K_{#3}}%
}
\DeclareRobustCommand{\SemigroupCoordinateProductOp}[3]{%
  \ensuremath{\mathbin{\square_{#3}}}%
}
\DeclareRobustCommand{\SemigroupCoordinateMap}[3]{%
  \ensuremath{\chi_{#3}}%
}
\DeclareRobustCommand{\SemigroupCoordinateMultiplicationMap}[3]{%
  \ensuremath{\mu_{#3}}%
}
\DeclareRobustCommand{\SemigroupCoordinateIso}[3]{%
  \ensuremath{\mathsf{HGrKoordIso}\!\left(#1,#2;#3\right)}%
}
\DeclareRobustCommand{\FiniteSemigroupHom}[3]{%
  \ensuremath{\mathsf{FinHGrHom}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\FiniteSemigroupIso}[3]{%
  \ensuremath{\mathsf{FinHGrIso}\!\left(#1;#2;#3\right)}%
}
...
\DeclareRobustCommand{\SemigroupWithZeroHom}[3]{%
  \ensuremath{\mathsf{HGr}_{0}\mathsf{Hom}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\SemigroupWithZeroIso}[3]{%
  \ensuremath{\mathsf{HGr}_{0}\mathsf{Iso}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\LeftCancellativeSemigroupHom}[3]{%
  \ensuremath{\mathsf{LK\ddot{u}rzHGrHom}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\LeftCancellativeSemigroupIso}[3]{%
  \ensuremath{\mathsf{LK\ddot{u}rzHGrIso}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\RightCancellativeSemigroupHom}[3]{%
  \ensuremath{\mathsf{RK\ddot{u}rzHGrHom}\!\left(#1;#2;#3\right)}%
}
\DeclareRobustCommand{\RightCancellativeSemigroupIso}[3]{%
  \ensuremath{\mathsf{RK\ddot{u}rzHGrIso}\!\left(#1;#2;#3\right)}%
}
...
% Formale Differenzen und Gruppenvervollstaendigung eines voll bezeichneten
% kommutativen Monoids. Das erste Argument ist jeweils die Kommaliste
% M,\star,e; dadurch bleibt die Ausgangsstruktur in allen Symbolen sichtbar.
\DeclareRobustCommand{\FormalDifferenceCarrier}[1]{%
  \ensuremath{D_{#1}}%
}
\DeclareRobustCommand{\FormalDifferenceRel}[1]{%
  \ensuremath{\mathrel{\sim_{#1}}}%
}
\DeclareRobustCommand{\FormalDifferenceClass}[3]{%
  \ensuremath{\left[#2,#3\right]_{#1}}%
}
\DeclareRobustCommand{\GroupCompletionCarrier}[1]{%
  \ensuremath{\mathcal G_{#1}}%
}
\DeclareRobustCommand{\GroupCompletionOp}[1]{%
  \ensuremath{\mathbin{\boxplus_{#1}}}%
}
\DeclareRobustCommand{\GroupCompletionZero}[1]{%
  \ensuremath{0_{#1}^{\mathcal G}}%
}
\DeclareRobustCommand{\GroupCompletionEmbed}[1]{%
  \ensuremath{\iota_{#1}^{\mathcal G}}%
}
...
% Halbverbandsform erhalten in B36 ihre vollständigen registrierten Definitionen;
