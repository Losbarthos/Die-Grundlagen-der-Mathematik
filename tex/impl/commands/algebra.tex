...
% Kompatibilitaetsnamen fuer aeltere Registereintraege. Algebraisch handelt
% es sich in beiden Orientierungen um dasselbe Halbverbandsprädikat.
...
% Von einer Halbverbandsoperation induzierte, sichtbar orientierte
% Ordnungsrelationen. Der Pfeil ist notwendig, weil dieselbe Operation beide
% zueinander dualen Relationen induziert.
\DeclareRobustCommand{\JoinOrd}[2]{%
  \ensuremath{R^{\uparrow,#1}_{#2}}%
}
\DeclareRobustCommand{\MeetOrd}[2]{%
  \ensuremath{R^{\downarrow,#1}_{#2}}%
}
\DeclareRobustCommand{\JoinLeq}[2]{%
  \ensuremath{\mathrel{\preceq^{\uparrow,#1}_{#2}}}%
}
\DeclareRobustCommand{\MeetLeq}[2]{%
  \ensuremath{\mathrel{\preceq^{\downarrow,#1}_{#2}}}%
}
...
\DeclareRobustCommand{\PairLowerSet}[5]{%
  \ensuremath{\mathsf{US}_{#1,#2}\!\left(#3,#4;#5\right)}%
}
