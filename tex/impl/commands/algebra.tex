...
\DeclareRobustCommand{\SemigroupUnit}[2]{%
  \ensuremath{\mathsf{HGrEinh}_{#1}\!\left(#2\right)}%
}
...
% Halbverbandsform erhalten in B20 ihre vollständigen registrierten Definitionen;
