\begin{tabproofwide}
  ...
  \proofstepwidestar[2,4,5]{P(u)\rightarrow P(\sigma_A(u,a))}{\rIE{\FormulaRefAuto{a=b\vdash b=a}[thm]{7},6}}
  \proofstepwidestar[2]{\forall u\in\FiniteWords A\,\forall a\in A\;(P(u)\rightarrow P(\sigma_A(u,a)))}{\rUI{\rRI{4,\rUI{\rRI{5,8}}}}}
  \proofstepwidestar[1,2]{\forall w\in\FiniteWords A\;P(w)}{\FormulaRefAuto{WordStructureInduction}[ax]{3,1,9}}
\end{tabproofwide}
