...
Die Rekursion übersetzt den schrittweisen Aufbau einer Wortstruktur in
eine andere: Das Anfangswort wird auf das dortige Anfangswort abgebildet,
und jeder Buchstabe löst dort den entsprechenden Anfügungsschritt aus.
Wir konstruieren solche Abbildungen in beiden Richtungen. Ihre
Kompositionen erhalten Anfang und Nachfolger ebenso wie die Identität.
Der bereits durch Wortinduktion bewiesene Satz
\FormulaRefAuto{WordRecursionTwoSolutionsEqual}[thm] liefert deshalb
die Identitäten als Kompositionen. Damit folgt die Bijektivität aus
Band~08. Der Aufbau mit Anfang und Nachfolgern bestimmt somit die
Wortstruktur bis auf diese eindeutige Übersetzung.
