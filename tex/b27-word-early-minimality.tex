\subsection{Induktion in Mengenform: die Minimalität des Anfügungsmodells}
...
Minimalität auch in der Sprache der Anfügungsfunktion. Sie ist die
Mengenform der Induktion: Enthält \(U\) das Anfangswort und übersteht
die Zugehörigkeit zu \(U\) jeden Anfügungsschritt, so liegen alle
Wörter in \(U\).

\noindent\begin{minipage}{\linewidth}
\FormulaThmDeltaK[W3: Induktion in Mengenform im konkreten Wortmodell]{%
  \begin{aligned}[t]
...
Die Induktion ist dabei bereits W3; ihre vertrauten Beweisformen
und die daraus folgende Rekursion werden anschließend behandelt.
