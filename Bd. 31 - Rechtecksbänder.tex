...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{\(\dashv\)}
    ...
    \proofstepwidestar[1,5]{\forall v,w\in R\,((x\star v)\star w=x\star w)}{%
      \FormulaRefAuto{\forall x \in A\,(P(x)),\, y \in A
            \vdash P(y)}[thm]{3,5}}
    \proofstepwidestar[1,5]{\forall w\in R\,((x\star y)\star w=x\star w)}{%
      \FormulaRefAuto{\forall x \in A\,(P(x)),\, y \in A
          \vdash P(y)}[thm]{%
          7,5}}
    ...
    \proofstepwidestar[1]{\RectangularBandAlg{R}{\star}}{%
      \FormulaRefAuto{RectangularBandDef}[def]{4,10}}
  \closeproofpartwide
...
\ProofWideReasonsNearFormula
\begin{tabproofsplitwide}
  \proofpartwide{Multiplikative Erkennung der Projektionen}
  \proofstepwidestar[]{%
  ...
  \proofpartwide{Klassengrößen und ihr Transport}
  ...
  \proofpartwide{Einermengenschicht und induzierter Isomorphismus}
...
\ProofWideReasonsNearFormula
\begin{tabproofsplitwide}
  \proofpartwide{Inklusion des Sandwichprodukts}
  \proofstepwidestarbreak[]{%
    \begin{aligned}[t]
  ...
  \proofpartwide{Gleichheit und Transport}
...
\begin{tabproofsplitwide}
  \proofpartwide{Leerfall und Reduktion auf nichtleere Träger}
    ...
    \proofstepwidestar[1,2]{\PowNE{A}=\varnothing}{%
      \text{\parbox[t]{\linewidth}{\raggedright Definition der nichtleeren Potenzmenge}}}
    ...
    \proofstepwidestarbreak[1,2]{%
      \exists f\,\IdempotentSemigroupIso{f}{A,\star}{B,\diamond}}{%
      \text{\parbox[t]{\linewidth}{\raggedright die leere Abbildung ist bijektiv und multiplikativ}}}
  ...
  \proofpartwide{Komponentenweise Konstruktion des Kandidaten}
    ...
    \proofstepwidestarbreak[1]{%
      ...
      \text{mit (25.34)--(25.35)}}{%
      \text{\parbox[t]{\linewidth}{\raggedright endliches Anheben (25.24)--(25.35)}}}
    \proofstepwidestar[1]{%
  ...
  \proofpartwide{Fall 2: Das Produkt liegt echt unter beiden Komponenten}
    ...
    \proofstepwidestar[1]{\alpha,\beta>\delta\dsep ab\in S_\delta}{%
      \text{\parbox[t]{\linewidth}{\raggedright Halbverbandsordnung und (25.3)}}}
    \proofstepwidestarbreak[1]{%
    ...
    \proofstepwidestarbreak[1]{%
      ...
      \text{\parbox[t]{\linewidth}{\raggedright (25.25) und Linksnullidentität}}}
    \proofstepwidestarbreak[1]{%
      S_\delta\text{ rechtsnull}
      \Longrightarrow ab=(ab)b\in U_\delta}{%
      \text{\parbox[t]{\linewidth}{\raggedright (25.25) und Rechtsnullidentität}}}
    \proofstepwidestarbreak[1]{%
      \eta(ab)\text{ ist das einzige Element von }\Psi(ab)}{%
  ...
  \proofpartwide{Fall 3a: Echte Rechtecks- oder triviale Unterkomponente}
    ...
    \proofstepwidestarbreak[1]{%
      ...
      \Psi(C)=\{\eta(b)\}}{\text{\parbox[t]{\linewidth}{\raggedright Klassenrestriktion des Transportlemmas}}}
    ...
    \proofstepwidestarbreak[1]{%
      ...
      \text{\parbox[t]{\linewidth}{\raggedright mengenweiser Transport (25.20a)}}}
    \proofstepwidestarbreak[1]{%
  ...
  \proofpartwide{Fall 3b: Linksnull-Unterkomponente}
    ...
    \proofstepwide[1]{ab}{=}{a(ab)}{%
      \text{\parbox[t]{\linewidth}{\raggedright Assoziativität und \(a^2=a\)}}}
    ...
    \proofstepwide[1]{\eta(a)x}{=}{\eta(a)}{%
      \text{\parbox[t]{\linewidth}{\raggedright Linksnullidentität im Ziel}}}
  ...
  \proofpartwide{Fall 3c: Rechtsnull-Unterkomponente}
    ...
    \proofstepwide[1]{\eta(a)\eta(b)}{=}{%
      ...
      \text{\parbox[t]{\linewidth}{\raggedright Rechtsnullidentität \(yx=x\)}}}
    \proofstepwidestarbreak[1]{%
    ...
    \proofstepwidestarbreak[1]{%
      \begin{aligned}[t]
        &\Psi\colon\mathcal P_+(S^{\mathrm{op}})
          \longrightarrow\mathcal P_+(T^{\mathrm{op}})\\[-2pt]
        &\text{ ist ein Isomorphismus}
      \end{aligned}}{%
      \text{\parbox[t]{\linewidth}{\raggedright beide Potenzhalbgruppenprodukte werden umgekehrt}}}
    \proofstepwidestarbreak[1]{%
      \begin{aligned}[t]
        &\sigma,\kappa,\rho,\tau\text{ bleiben erhalten, }\\[-2pt]
        &U_\gamma\text{ bleibt dieselbe Menge}
      \end{aligned}}{%
      \text{\parbox[t]{\linewidth}{\raggedright Definitionen (25.11)--(25.16) und (25.25)}}}
    \proofstepwidestarbreak[1]{%
      b\mathbin{\circ}a=ab\dsep
      \eta(b)\mathbin{\circ}\eta(a)=\eta(a)\eta(b)}{%
      \text{\parbox[t]{\linewidth}{\raggedright Definition der Oppositionsmultiplikation}}}
    \proofstepwidestar[1]{\eta(a)\eta(b)=\eta(ab)}{%
  ...
  \proofpartwide{Fallunterscheidung und Schluss}
    \proofstepwidestarbreak[1]{%
      \begin{aligned}[t]
        &\IdempotentSemigroupAlg{A}{\star}\dsep
         \IdempotentSemigroupAlg{B}{\diamond}\dsep{}\\[-2pt]
        &\Finite{A}\dsep\Finite{B},\\[-2pt]
        &\SemigroupIso{\Psi}
          {\PowNE{A},\star_{\mathcal P}}
          {\PowNE{B},\diamond_{\mathcal P}}
    ...
    \proofstepwidestarbreak[1,2]{%
      \eta=\displaystyle\bigcup_{\alpha\in Y}\eta_\alpha
      \colon S\bij T}{%
      \text{\parbox[t]{\linewidth}{\raggedright komponentenweise Konstruktion}}}
    \proofstepwidestar[5]{a\in S}{\rA}
    \proofstepwidestar[6]{b\in S}{\rA}
    \proofstepwidestarbreak[1,2,5,6]{%
      \exists\alpha\in Y\,\exists\beta\in Y\,
        (a\in S_\alpha\land b\in S_\beta)}{%
      \text{McLean-Zerlegung (25.2), }5,6}
    \proofstepwidestarbreak[8]{%
      \alpha\in Y\land\bigl(\beta\in Y\land
        (a\in S_\alpha\land b\in S_\beta)\bigr)}{\rA}
    \proofstepwidestarbreak[1,2,8]{%
      \alpha=\beta\ \lor\
      \alpha\beta\notin\{\alpha,\beta\}\ \lor\
      \alpha\beta=\alpha<\beta\ \lor\
      \alpha\beta=\beta<\alpha}{%
      \text{\parbox[t]{\linewidth}{\raggedright Halbverbandsordnung:
        \(\alpha\beta\leq\alpha,\beta\)}}}
    \proofstepwidestar[1,2,8]{\eta(ab)=\eta(a)\eta(b)}{%
      \text{Fälle 1, 2 und 3a--3d, }8,9}
    \proofstepwidestar[1,2,5,6]{\eta(ab)=\eta(a)\eta(b)}{\rEEStar{7,8,10}}
    \proofstepwidestarbreak[1,2,5]{%
      \forall b\in S\quad\eta(ab)=\eta(a)\eta(b)}{\rUI{\rRI{6,11}}}
    \proofstepwidestarbreak[1,2]{%
      \forall a,b\in S\quad\eta(ab)=\eta(a)\eta(b)}{\rUI{\rRI{5,12}}}
    \proofstepwidestar[1,2]{\SemigroupIso{\eta}{S}{T}}{%
      \text{\parbox[t]{\linewidth}{\raggedright Bijektivität aus Schritt 4 und Multiplikativität aus Schritt 13}}}
    \proofstepwidestarbreak[1,2]{%
      \IdempotentSemigroupIso{\eta}{A,\star}{B,\diamond}}{%
      \FormulaRefAuto{IdempotentSemigroupIsoDef}[def]{1,14}}
    \proofstepwidestarbreak[1,2]{%
      \exists f\,\IdempotentSemigroupIso{f}{A,\star}{B,\diamond}}{\rEI{15}}
    \proofstepwidestarbreak[1]{%
    ...
    \proofstepwidestar[19]{A=\varnothing}{\rA}
    \proofstepwidestarbreak[1,19]{%
      \exists f\,\IdempotentSemigroupIso{f}{A,\star}{B,\diamond}}{\rRE{17,19}}
    \proofstepwidestarbreak[1]{%
      \exists f\,\IdempotentSemigroupIso{f}{A,\star}{B,\diamond}}{\rOE{18,19,20,2,16}}
  \closeproofpartwide
\end{tabproofsplitwide}
\endgroup
