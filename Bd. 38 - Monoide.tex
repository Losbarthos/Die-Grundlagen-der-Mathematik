...
\(u=v\).  Folglich ist
\(E=\{e\}\) für ein \(e\in A\).  Für jedes \(x\in A\) liefern nun
\[
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,12]{X\in\PowNE A}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
      \FormulaRefAuto{NonemptyPowersetMonotone}[thm]{4},12}}
  ...
  \proofstepwidestarbreakkeep[1,2,3,12]{\{e\}\star_{\mathcal P}X\in(\PowNE A)^2}{%
    \FormulaRefAuto{SemigroupSquareProductMember}[thm]{11,10,9,13}}
  \proofstepwidestarbreakkeep[1,2,3,12]{X\in(\PowNE A)^2}{\rIE{14,15}}
  \proofstepwidestarbreakkeep[1,2,3]{\PowNE{A^2}\subseteq(\PowNE A)^2}{%
    \FormulaRefAuto{A\subseteq B\coloneq\forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{12,16}}}}
  \proofstepwidestarbreakkeep[1,2,3]{(\PowNE A)^2=\PowNE{A^2}}{%
    \FormulaRefAuto{A\subseteq B,\,B\subseteq A\vdash A=B}{6,17}}
  \proofstepwidestarbreakkeep[1,2,3]{\MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{\{e\}}}{\rIE{18,5}}
  \proofstepwidestarbreakkeep[1,2,3]{%
    (\PowNE A)^2=\PowNE{A^2}\ \land\
    \MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{\{e\}}}{\rAI{18,19}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3]{E\in\PowNE A}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
      \FormulaRefAuto{NonemptyPowersetMonotone}[thm]{10},8}}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4,5]{e\star t=t}{%
    \FormulaRefAuto{MonoidPowerSingletonProductValue}[thm]{1,15,16,13,4,17}}
  \proofstepwidestarbreakkeep[1,2,3,4,5]{t\star e=t}{%
    \FormulaRefAuto{MonoidPowerSingletonProductValue}[thm]{1,16,15,14,17,4}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3]{E\neq\varnothing}{%
    \rAEb{\FormulaRefAuto{NonemptyPowersetMembership}[thm]{6}}}
  \proofstepwidestarbreakkeep[1,2,3]{\exists e\,(e\in E)}{%
    \FormulaRefAuto{A\neq\varnothing\eqvdash\exists x\,(x\in A)}{7}}
  \proofstepwidestarbreakkeep[9]{e\in E}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,9]{e\in A^2}{%
    \FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{6,9}}
  \proofstepwidestarbreakkeep[11]{v\in E}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,11]{v\in A^2}{%
    \FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{6,11}}
  \proofstepwidestarbreakkeep[1,2,3,9,11]{e\star v=v}{%
    \rAEa{\rAEb{\FormulaRefAuto{PowerSemigroupSquareIdentityActions}[thm]{1,2,3,9,12}}}}
  \proofstepwidestarbreakkeep[1,2,3,9,11]{e\star v=e}{%
    \rAEb{\rAEb{\FormulaRefAuto{PowerSemigroupSquareIdentityActions}[thm]{1,2,3,11,10}}}}
  \proofstepwidestarbreakkeep[1,2,3,9,11]{v=e}{\rIE{13,14}}
  \proofstepwidestarbreakkeep[16]{v=e}{\rA}
  \proofstepwidestarbreakkeep[9,16]{v\in E}{\rIE{16,9}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\forall v\,(v\in E\leftrightarrow v=e)}{%
    \rUI{\rLRI{\rRI{11,15},\rRI{16,17}}}}
  \proofstepwidestarbreakkeep[1,2,3,9]{E=\{e\}}{%
    \FormulaRefAuto{\forall x\,(x\in A\leftrightarrow x\in B)\eqvdash A=B}{%
      18,\FormulaRefAuto{x\in\{a\}\eqvdash x=a}}}
  ...
  \proofstepwidestarbreakkeep[1,2]{\SemigroupAlg{A^2}{\star}}{%
    \FormulaRefAuto{SubsemigroupFormsSemigroup}[thm]{1,20}}
  \proofstepwidestarbreakkeep[22]{t\in A^2}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,9,22]{e\star t=t\land t\star e=t}{%
    \rAEb{\FormulaRefAuto{PowerSemigroupSquareIdentityActions}[thm]{1,2,3,9,22}}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\MonoidAlg{A^2}{\star}{e}}{%
    \FormulaRefAuto{MonoidDef}[def]{21,10,\rAEa{23},\rAEb{23}}}
  \proofstepwidestarbreakkeep[1,2,3,9]{\exists e\in A^2\,(E=\{e\}\land\MonoidAlg{A^2}{\star}{e})}{%
    \rEI{10,\rAI{19,24}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,12]{\MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{\{e\}}}{%
    \rAEb{\FormulaRefAuto{PowerSemigroupSquareMonoidForward}[thm]{1,2,12}}}
  \proofstepwidestarbreakkeep[1,2,12]{\exists E\,\MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{E}}{\rEI{13}}
  \proofstepwidestarbreakkeep[1,2,11]{\exists E\,\MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{E}}{\rEE{11,12,14}}
  \proofstepwidestarbreakkeep[1,2]{%
    \bigl(\exists E\,\MonoidAlg{(\PowNE A)^2}{\star_{\mathcal P}}{E}\bigr)
    \leftrightarrow\bigl(\exists e\,\MonoidAlg{A^2}{\star}{e}\bigr)}{%
    \rLRI{\rRI{3,10},\rRI{11,15}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4]{e\star a=a\star e}{\rChain{6,7,8}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4]{=(e\star a)\star b}{%
    \rIE{\FormulaRefAuto{MonoidRightIdentityAxiom}[ax]{3,\rAEa{\rAEb{5}}},8}}
  \proofstepwidestarbreakkeep[1,2,3,4]{=e\star(a\star b)}{%
    \FormulaRefAuto{SemigroupAssociativityAxiom}[ax]{1,\rAEa{5},4}}
  \proofstepwidestarbreakkeep[1,2,3,4]{=a\star b}{%
    \FormulaRefAuto{MonoidLeftIdentityAxiom}[ax]{3,7}}
  \proofstepwidestarbreakkeep[1,2,3,4]{(e\star a)\star(e\star b)=a\star b}{\rChain{8,9,10,11}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[4]{a\in A}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4]{e\star a\in A^2}{%
    \rAEa{\rAEb{\FormulaRefAuto{MonoidSquareIdentityProductCarrier}[thm]{1,2,3,4}}}}
  \proofstepwidestarbreakkeep[1,2,3]{\forall a\in A\,(e\star a\in A^2)}{\rUI{\rRI{4,5}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,4]{g\in A}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
      \FormulaRefAuto{SemigroupSquareSubset}[thm]{1,2},4}}
  \proofstepwidestarbreakkeep[1,2,3,4]{r_e(g)=e\star g}{%
    \FormulaRefAuto{MonoidSquareInflationDef}[def]{1,2,3,5}}
  \proofstepwidestarbreakkeep[3,4]{=g}{%
    \FormulaRefAuto{MonoidLeftIdentityAxiom}[ax]{3,4}}
  \proofstepwidestarbreakkeep[1,2,3,4]{r_e(g)=g}{\rChain{6,7}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4,6]{e\in A}{%
    \rAEa{\FormulaRefAuto{MonoidSquareIdentityProductCarrier}[thm]{1,2,3,7}}}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4,5,6]{e\star a=g}{%
    \FormulaRefAuto{MonoidPowerSingletonProductValue}[thm]{1,9,4,5,10,6}}
  \proofstepwidestarbreakkeep[1,2,3,4,6]{r_e(a)=e\star a}{%
    \FormulaRefAuto{MonoidSquareInflationDef}[def]{1,2,3,7}}
  \proofstepwidestarbreakkeep[1,2,3,4,5,6]{r_e(a)=g}{\rChain{12,11}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3]{e\in A}{%
    \FormulaRefAuto{A\subseteq B,\,x\in A\vdash x\in B}{%
      \FormulaRefAuto{SemigroupSquareSubset}[thm]{1,2},7}}
  \proofstepwidestarbreakkeep[1,2,3]{\{e\}\in\PowNE A}{%
    \FormulaRefAuto{MonoidPowerSingletonCarrier}[thm]{8}}
  \proofstepwidestarbreakkeep[1,2,3,4,6]{\exists v\in\{e\}\,\exists a\in X\,(z=v\star a)}{%
    \FormulaRefAuto{PowerSemigroupProductWitnesses}[thm]{1,9,4,6}}
  \proofstepwidestarbreakkeep[11]{v\in\{e\}\land(a\in X\land z=v\star a)}{\rA}
  \proofstepwidestarbreakkeep[11]{v=e}{\FormulaRefAuto{x\in\{a\}\eqvdash x=a}{\rAEa{11}}}
  \proofstepwidestarbreakkeep[11]{a\in X}{\rAEa{\rAEb{11}}}
  \proofstepwidestarbreakkeep[4,11]{a\in A}{\FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{4,13}}
  \proofstepwidestarbreakkeep[1,2,3,4,11]{r_e(a)=e\star a}{%
    \FormulaRefAuto{MonoidSquareInflationDef}[def]{1,2,3,14}}
  \proofstepwidestarbreakkeep[5,11]{r_e(a)=g}{\rRE{13,\rUE{5}}}
  \proofstepwidestarbreakkeep[1,2,3,4,5,11]{z=g}{%
    \rIE{12,15,16,\rAEb{\rAEb{11}}}}
  \proofstepwidestarbreakkeep[1,2,3,4,5,6]{z=g}{\rEEStar{10,11\text{--}17}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[4]{X\neq\varnothing}{%
    \rAEb{\FormulaRefAuto{NonemptyPowersetMembership}[thm]{4}}}
  \proofstepwidestarbreakkeep[4]{\exists a\,(a\in X)}{%
    \FormulaRefAuto{A\neq\varnothing\eqvdash\exists x\,(x\in A)}{6}}
  \proofstepwidestarbreakkeep[8]{a\in X}{\rA}
  \proofstepwidestarbreakkeep[4,8]{a\in A}{\FormulaRefAuto{PowerSemigroupCarrierElement}[thm]{4,8}}
  \proofstepwidestarbreakkeep[1,2,3,4,8]{e\in A}{%
    \rAEa{\FormulaRefAuto{MonoidSquareIdentityProductCarrier}[thm]{1,2,3,9}}}
  \proofstepwidestarbreakkeep[1,2,3,4,8]{\{e\}\in\PowNE A}{%
    \FormulaRefAuto{MonoidPowerSingletonCarrier}[thm]{10}}
  \proofstepwidestarbreakkeep[1,2,3,4,8]{e\star a\in\{e\}\star_{\mathcal P}X}{%
    \FormulaRefAuto{PowerSemigroupProductContains}[thm]{1,11,4,\FormulaRefAuto{a\in\{a\}},8}}
  \proofstepwidestarbreakkeep[1,2,3,4,8]{r_e(a)=e\star a}{%
    \FormulaRefAuto{MonoidSquareInflationDef}[def]{1,2,3,9}}
  \proofstepwidestarbreakkeep[5,8]{r_e(a)=g}{\rRE{8,\rUE{5}}}
  \proofstepwidestarbreakkeep[1,2,3,4,5,8]{g\in\{e\}\star_{\mathcal P}X}{\rIE{13,14,12}}
  \proofstepwidestarbreakkeep[1,2,3,4,5]{g\in\{e\}\star_{\mathcal P}X}{\rEE{7,8,15}}
  \proofstepwidestarbreakkeep[17]{z\in\{e\}\star_{\mathcal P}X}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4,5,17]{z=g}{%
    \FormulaRefAuto{MonoidSquarePowerFiberProductElement}[thm]{1,2,3,4,5,17}}
  \proofstepwidestarbreakkeep[19]{z=g}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4,5,19]{z\in\{e\}\star_{\mathcal P}X}{\rIE{19,16}}
  \proofstepwidestarbreakkeep[1,2,3,4,5]{\forall z\,(z\in\{e\}\star_{\mathcal P}X\leftrightarrow z=g)}{%
    \rUI{\rLRI{\rRI{17,18},\rRI{19,20}}}}
  \proofstepwidestarbreakkeep[1,2,3,4,5]{\{e\}\star_{\mathcal P}X=\{g\}}{%
    \FormulaRefAuto{\forall x\,(x\in A\leftrightarrow x\in B)\eqvdash A=B}{%
      21,\FormulaRefAuto{x\in\{a\}\eqvdash x=a}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,4]{a\star b,b\star a\in A}{%
    \FormulaRefAuto{SemigroupClosureAxiom}[ax]{%
      \FormulaRefAuto{MonoidBaseSemigroupAxiom}[ax]{1},4}}
  \proofstepwidestarbreakkeep[1]{e\in A}{\FormulaRefAuto{MonoidIdentityCarrierAxiom}[ax]{1}}
  \proofstepwidestarbreakkeep[12]{a\star b=e\land b\star a=e}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4,12]{F(a)\diamond F(b)=u\land F(b)\diamond F(a)=u}{%
    \rAI{\rIE{\rAEa{12},6,7},\rIE{\rAEb{12},6,8}}}
  \proofstepwidestarbreakkeep[14]{F(a)\diamond F(b)=u\land F(b)\diamond F(a)=u}{\rA}
  \proofstepwidestarbreakkeep[1,2,3,4,14]{F(a\star b)=F(e)\dsep F(b\star a)=F(e)}{%
    \rIE{6,7,8,14}}
  \proofstepwidestarbreakkeep[1,2,3,4,14]{a\star b=e}{%
    \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}[ax]{9,10,11,15}}
  \proofstepwidestarbreakkeep[1,2,3,4,14]{b\star a=e}{%
    \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep F(x)=F(y)\vdash x=y}[ax]{9,10,11,15}}
  \proofstepwidestarbreakkeep[1,2,3,4]{%
    (a\star b=e\land b\star a=e)\leftrightarrow
    (F(a)\diamond F(b)=u\land F(b)\diamond F(a)=u)}{%
    \rLRI{\rRI{12,13},\rRI{14,\rAI{16,17}}}}
\end{tabproofwide}
