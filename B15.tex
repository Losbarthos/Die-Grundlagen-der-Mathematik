...
Band~10 entwickelt. Dort stehen auch seine allgemeinen Struktursätze:
...
\(\OccClass{M}{a}\), \(\OccQuotCarrier{M}\), \(\OccQuotMap{M}\) und
\(\OccQuotFam{M}\) werden hier daher nur noch verwendet, nicht erneut
definiert.
...
benötigte Injektivität der Spurabbildung ist bereits ein Satz aus Band~10.
