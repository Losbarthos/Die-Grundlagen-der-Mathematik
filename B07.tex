...
anschließend folgen Bild-, Faser-, Einschränkungs- und Kompositionssätze.
...
Die Aussage, dass jede Funktion \(F\colon A\to B\) als Abbildung
\(F\colon A\twoheadrightarrow F[A]\) surjektiv ist, wurde bereits im
axiomatischen Teil dieses Bandes bewiesen.
