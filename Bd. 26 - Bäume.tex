...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{p(0)\in V\land p(n)\in V}{%
    \FormulaRefAuto{DirectedWalkEndpointTyping}[thm]{%
      1,\FormulaRefAuto{DirectedPathIsWalk}[thm]{1,\rAEa{3}}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{n\in\mathbb N\land
    p\colon\NatSeg{n+1}\to V\land
    \forall i\in\NatSeg n\,((p(i),p(i+1))\in E)}{%
    \FormulaRefAuto{DirectedWalkDef}[def]{1,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2,3]{%
    ...
    \FormulaRefAuto{DirectedWalkDef}[def]{1,\rAEa{5},6,16}}
  \proofstepwidestarbreak[1,2,3]{%
  ...
  \proofstepwidestarbreak[1,2,3]{%
    ...
    \FormulaRefAuto{F\colon A\inj B\dsep C\subseteq A\vdash
      ...
      \rAEn{\FormulaRefAuto{FinitePathPrefixIndexData}[thm]{%
        \rAEa{\FormulaRefAuto{DirectedWalkDef}[def]{1,4}},3}}}}
  \proofstepwidestarbreak[1,2,3]{%
    \DirectedPath{V}{E}{p\restriction_{\NatSeg{k+1}}}{k}}{%
    \FormulaRefAuto{DirectedPathDef}[def]{1,\rAEa{5},7}}
  \proofstepwidestarbreak[1,2,3]{%
    \DirectedPath{V}{E}{p\restriction_{\NatSeg{k+1}}}{k}
    \land p\restriction_{\NatSeg{k+1}}(0)=p(0)
    \land p\restriction_{\NatSeg{k+1}}(k)=p(k)}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,3]{\DirectedWalk{V}{E}{p}{n+1}}{%
    \FormulaRefAuto{DirectedPathIsWalk}[thm]{1,3}}
  \proofstepwidestarbreak[1,2,3]{p\colon\NatSeg{(n+1)+1}\inj V}{%
    \rAEb{\FormulaRefAuto{DirectedPathDef}[def]{1,3}}}
  ...
  \proofstepwidestarbreak[1,2,3,11]{\DirectedWalk{V}{E}{q}{n}}{%
    \FormulaRefAuto{DirectedWalkDef}[def]{1,2,\rAEa{11},31}}
  \proofstepwidestarbreak[1,2,3,11]{\DirectedPath{V}{E}{q}{n}}{%
    \FormulaRefAuto{DirectedPathDef}[def]{1,32,24}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2]{n\in\mathbb N}{%
    \rAEa{\FormulaRefAuto{DirectedWalkDef}[def]{1,6}}}
  \proofstepwidestarbreak[1,2]{p\colon\NatSeg{n+1}\inj V}{%
    \rAEb{\FormulaRefAuto{DirectedPathDef}[def]{1,2}}}
  ...
  \proofstepwidestarbreak[1,2,3,4,5]{%
    ...
    \FormulaRefAuto{DirectedWalkDef}[def]{1,
      \FormulaRefAuto{PeanoAddClosure}[thm]{7,
        \FormulaRefAuto{PeanoOneInN}[thm]},
  ...
  \proofstepwidestarbreak[1,2,3,4,5]{%
    \DirectedPath{V}{E}{%
      \ExtMap{\iota_{p[\NatSeg{n+1}],V}\circ p}{n+1}{y}}{n+1}}{%
    \FormulaRefAuto{DirectedPathDef}[def]{1,29,15}}
  \proofstepwidestarbreak[1,2,3,4]{%
    \ExtMap{\iota_{p[\NatSeg{n+1}],V}\circ p}{n+1}{y}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[4,8]{q\colon\NatSeg{n+1}\to V}{%
    \rAEa{\FormulaRefAuto{DirectedPathDef}[def]{4,\rAEb{8}}}}
  \proofstepwidestarbreak[4,8]{p\colon\NatSeg{(n+1)+1}\to V}{%
    \rAEa{\FormulaRefAuto{DirectedPathDef}[def]{4,6}}}
  ...
  \proofstepwidestarbreak[4,6]{p(0),p(1)\in V}{%
    \FormulaRefAuto{DirectedWalkEndpointTyping}[thm]{%
      4,\FormulaRefAuto{DirectedPathIsWalk}[thm]{4,6}}}
  ...
  \proofstepwidestarbreak[1,2,6]{(p(0),p(1))\in E}{%
    \FormulaRefAuto{DirectedWalkStepEdge}[thm]{%
      4,\FormulaRefAuto{DirectedPathIsWalk}[thm]{4,6},17}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2]{n\in\mathbb N}{%
    \rAEa{\FormulaRefAuto{DirectedWalkDef}[def]{%
      3,\FormulaRefAuto{DirectedPathIsWalk}[thm]{3,2}}}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[4,11]{%
    ...
    \FormulaRefAuto{F\colon A\to B\dsep y\in F[A]\vdash
      ...
      \FormulaRefAuto{P\land Q\land R\vdash Q}[thm]{%
        \FormulaRefAuto{DirectedWalkDef}[def]{%
          \FormulaRefAuto{UndirectedGraphAccess}[thm]{1},
          \FormulaRefAuto{DirectedPathIsWalk}[thm]{%
  ...
  \proofstepwidestarbreak[1,2,3,6,7,34,35,36,37]{(m,p)=(n,q)}{%
    \FormulaRefAuto{FinitePathSplitRigidity}[thm]{%
      ...
      \rAEa{\FormulaRefAuto{DirectedPathDef}[def]{%
        \FormulaRefAuto{UndirectedGraphAccess}[thm]{1},6}},
      \rAEa{\FormulaRefAuto{DirectedPathDef}[def]{%
...
\FormulaDefDeltaK[Wald]{%
  ...
  \DeltaRow{Neue Struktur}{\ForestStruct{V,E}}
}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{\SimpleUndirectedGraphStruct{V,E}}{%
    \FormulaRefAuto{ForestDef}[def]{1}}
  ...
  \proofstepwidestarbreak[1,3,4,5,6]{a=b}{%
    \FormulaRefAuto{ForestDef}[def]{1,3,4,5,6}}
\end{tabproofwide}

\FormulaDefDeltaK[Wegezyklus und Azyklizität]{%
  \begin{aligned}
  \PathAcyclicGraphStruct{V,E}\coloneqq{}&
  \SimpleUndirectedGraphStruct{V,E}\land{}\\[-2pt]
  ...
  \DeltaRow{Mengen}{V\dsep E\dsep u\dsep v\dsep a\dsep b}
  \DeltaRow{Neue Struktur}{\PathAcyclicGraphStruct{V,E}}
}
...
\begin{tabproofwide}
  \proofstepwidestarbreak[1]{\ForestStruct{V,E}}{\rA}
  \proofstepwidestarbreak[1]{\SimpleUndirectedGraphStruct{V,E}}{%
    \FormulaRefAuto{ForestAccess}[thm]{1}}
  \proofstepwidestarbreak[3]{%
    \exists u\in V\,\exists v\in V\,\exists a\,\exists b\,
    \bigl(a\in\GraphPathsBetween{V}{E}{u}{v}\land
          b\in\GraphPathsBetween{V}{E}{u}{v}\land a\neq b\bigr)}{\rA}
  \proofstepwidestarbreak[1,3]{a=b}{%
    \FormulaRefAuto{ForestAccess}[thm]{1,3}}
  \proofstepwidestarbreak[3]{a\neq b}{\rAEn{3}}
  \proofstepwidestarbreak[1,3]{\bot}{\rBI{4,5}}
  \proofstepwidestarbreak[1]{\PathAcyclicGraphStruct{V,E}}{%
    \FormulaRefAuto{PathAcyclicGraphDef}[def]{2,\rCI{3,6}}}
  \proofstepwidestarbreak[8]{\PathAcyclicGraphStruct{V,E}}{\rA}
  \proofstepwidestarbreak[8]{\SimpleUndirectedGraphStruct{V,E}}{%
    \FormulaRefAuto{PathAcyclicGraphDef}[def]{8}}
  \proofstepwidestarbreak[10]{u\in V}{\rA}
  \proofstepwidestarbreak[11]{v\in V}{\rA}
  \proofstepwidestarbreak[12]{a\in\GraphPathsBetween{V}{E}{u}{v}}{\rA}
  \proofstepwidestarbreak[13]{b\in\GraphPathsBetween{V}{E}{u}{v}}{\rA}
  \proofstepwidestarbreak[15]{a\neq b}{\rA}
  \proofstepwidestarbreak[8,10,11,12,13]{\neg(a\neq b)}{%
    \FormulaRefAuto{PathAcyclicGraphDef}[def]{8,10,11,12,13}}
  \proofstepwidestarbreak[8,10,11,12,13]{a=b}{%
    \FormulaRefAuto{rDN}[thm]{16}}
  \proofstepwidestarbreak[8]{\ForestStruct{V,E}}{%
    \FormulaRefAuto{ForestDef}[def]{9,10,11,12,13,17}}
  \proofstepwidestarbreak[]{\ForestStruct{V,E}\leftrightarrow
    \PathAcyclicGraphStruct{V,E}}{\rLRI{\rRI{1,7},\rRI{8,18}}}
\end{tabproofwide}
...
\FormulaDefDeltaK[Baum]{%
  ...
  \DeltaRow{Neue Struktur}{\TreeStruct{V,E}}
}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,4,5]{%
    \exists!z\,\bigl(z\in\GraphPathsBetween{V}{E}{u}{v}\bigr)}{%
    \FormulaRefAuto{TreeDef}[def]{1,4,5}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{\ForestStruct{V,E}}{%
    \FormulaRefAuto{ForestDef}[def]{2,4,5,6,7,8}}
...
\FormulaDefDeltaK[Verwurzelter Baum]{%
  \RootedTreeStruct{V,E,r}\coloneqq\TreeStruct{V,E}\land r\in V%
}{RootedTreeDef}{%
  \DeltaRow{Mengen}{V\dsep E\dsep r}
  \DeltaRow{Neue Struktur}{\RootedTreeStruct{V,E,r}}
}
...
\begin{tabproof}
  ...
  \proofstep{1}{\TreeStruct{V,E}\land r\in V}{%
    \FormulaRefAuto{RootedTreeDef}[def]{1}}
\end{tabproof}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,2,3]{\TreeStruct{V,E}}{%
    \FormulaRefAuto{TreeDef}[def]{1,16,17}}
  \proofstepwidestarbreak[1,2,3]{\RootedTreeStruct{V,E,r}}{%
    \FormulaRefAuto{RootedTreeDef}[def]{18,2}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[11]{k\in\NatSeg{k+1}}{%
    \FormulaRefAuto{P\leftrightarrow Q\dsep P\vdash Q}[thm]{%
      \FormulaRefAuto{PeanoNatSegLeqAddOneMembership}[thm]{%
        \rAEa{11},\rAEa{11}},
      \FormulaRefAuto{PeanoLeqReflexive}[thm]{\rAEa{11}}}}
  \proofstepwidestarbreak[8,11]{p\colon\NatSeg{k+1}\to V}{%
    \FormulaRefAuto{DirectedPathDef}[def]{%
      \rAEb{\FormulaRefAuto{SimpleUndirectedGraphAccess}[thm]{%
        \FormulaRefAuto{TreeAccess}[thm]{%
          \rAEa{\FormulaRefAuto{RootedTreeAccess}[thm]{1}}}}},
      \rAEn{8},\rAEb{11}}}
  \proofstepwidestarbreak[8,11]{p(k)\in V}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,7]{\DirectedWalk{V}{E}{p}{k+1}}{%
    \FormulaRefAuto{DirectedPathIsWalk}[thm]{5,\rAEa{8}}}
...
\FormulaDefDeltaK[Binärer Baum]{%
  \begin{aligned}
  \BinaryTreeStruct{V,E,r}\coloneqq{}&
  ...
  \DeltaRow{Neue Struktur}{\BinaryTreeStruct{V,E,r}}
}
...
\FormulaDefDeltaK[Voller Binärbaum]{%
  ...
  &\quad\coloneqq \BinaryTreeStruct{V,E,r}\land{}\\[-2pt]
  ...
  \DeltaRow{Mengen}{V\dsep E\dsep r\dsep x\dsep a\dsep b}
  \DeltaRow{Neue Struktur}{\FullBinaryTreeStruct{V,E,r}}
}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1,3]{%
    ...
    \exists a,b\in\TreeChildren{V}{E}{r}{x}\,
      \bigl(a\neq b\land\TreeChildren{V}{E}{r}{x}=\{a,b\}\bigr)}{%
    \FormulaRefAuto{FullBinaryTreeDef}[def]{1,3}}
...
\FormulaDefDeltaK[Geordneter voller Binärbaum]{%
  \begin{aligned}
  &\OrderedFullBinaryTreeStruct{V,E,r,\lambda,\rho}\\[-2pt]
  &\quad\coloneqq \FullBinaryTreeStruct{V,E,r}\land{}\\[-2pt]
  &\qquad\lambda,\rho\colon\TreeInnerVertices{V}{E}{r}\to V\land{}\\[-2pt]
  &\qquad\forall x\in\TreeInnerVertices{V}{E}{r}\,\Bigl(
      \lambda(x)\neq\rho(x)\land
      \TreeChildren{V}{E}{r}{x}=\{\lambda(x),\rho(x)\}\Bigr).
  \end{aligned}%
}{OrderedFullBinaryTreeDef}{%
  \DeltaRow{Mengen}{V\dsep E\dsep r\dsep x}
  \DeltaRow{Funktionen}{\lambda\dsep\rho}
  \DeltaRow{Neue Struktur}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{%
    ...
    \FormulaRefAuto{OrderedFullBinaryTreeDef}[def]{1}}
  \proofstepwidestarbreak[1,2]{\lambda(x)\neq\rho(x)\land
    \TreeChildren{V}{E}{r}{x}=\{\lambda(x),\rho(x)\}}{%
    \FormulaRefAuto{OrderedFullBinaryTreeDef}[def]{1,2}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreak[1]{\BinaryTreeStruct{V,E,r}}{%
    \FormulaRefAuto{FullBinaryTreeDef}[def]{2}}
  \proofstepwidestarbreak[1]{\RootedTreeStruct{V,E,r}}{%
    \FormulaRefAuto{BinaryTreeDef}[def]{3}}
  \proofstepwidestarbreak[1]{%
