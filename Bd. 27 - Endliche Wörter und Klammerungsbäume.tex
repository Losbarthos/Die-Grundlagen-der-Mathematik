...
\begin{tabproofsplitwide}
  \proofpartwideindR[Typisierung]{%
    ...
    \proofstepwidestar[11]{%
      ...
      \rAEb{11}}
    \proofstepwidestar[1,2,8,10,11]{%
      a=b}{%
      \FormulaRefAuto{WordConcatenationGraphFunctional}[thm]{\rAI{1,2},8,12,13,14,15}}
    \proofstepwidestar[1,2,8]{%
      \exists!a\in A\,((q,a)\in\WordConcat uv)}{%
      \UEI{9,10,11,16}}
    \proofstepwidestar[1,2]{%
    ...
    \proofstepwidestar[1,2]{%
      ...
      \FormulaRefAuto{UniqueValuedGraphFunction}[thm]{7,18}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Fall 1: Koordinate im Präfix]{%
    \begin{aligned}[t]
      ...
      &i\in\NatSeg{\WordLength w-1}\vdash{}\\[-2pt]
      &\WordConcat{
        w\restriction_{\NatSeg{\WordLength w-1}}}{
        \LetterWord{w(\WordLength w-1)}}(i)=w(i)
    \end{aligned}
  }{\begin{aligned}[t]
      &w\in\NonemptyWords{A}\dsep{}\\[-2pt]
      &i\in\NatSeg{\WordLength w-1}\vdash{}\\[-2pt]
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{NonemptyWordMembership}[thm]{1}}
    \proofstepwidestar[1]{%
      (\WordLength{w}-1)\in\mathbb N}{%
      \FormulaRefAuto{PeanoMinusOneNatural}[thm]{3,4}}
    \proofstepwidestar[1]{%
      \WordLength{w}=((\WordLength{w}-1)+1)}{%
      \FormulaRefAuto{PeanoMinusOneRecoverValue}[thm]{3,4}}
    \proofstepwidestar[1]{%
      \NatSeg{\WordLength{w}-1}
      \subseteq\NatSeg{\WordLength{w}}}{%
      \FormulaRefAuto{PeanoNatSegSubsetAddOne}[thm]{5,6}}
    \proofstepwidestar[1]{%
      (\WordLength{w}-1)\in\NatSeg{\WordLength{w}}}{%
      \FormulaRefAuto{PeanoNatSegEndpointInAddOne}[thm]{5,6}}
    \proofstepwidestar[1]{%
      w\colon\NatSeg{\WordLength{w}}\to A}{%
      \FormulaRefAuto{FiniteWordTypingAtLength}[thm]{2}}
    \proofstepwidestar[1]{%
      w\restriction_{\NatSeg{\WordLength{w}-1}}
      \colon\NatSeg{\WordLength{w}-1}\to A}{%
    ...
    \proofstepwidestar[1]{%
      w(\WordLength{w}-1)\in A}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash
        F(x)\in B}[thm]{9,8}}
    \proofstepwidestar[1]{%
      \LetterWord{w(\WordLength{w}-1)}\in\NonemptyWords{A}}{%
      \FormulaRefAuto{LetterWordNonempty}[thm]{12}}
    \proofstepwidestar[1]{%
      \LetterWord{w(\WordLength{w}-1)}\in\FiniteWords{A}}{%
      \FormulaRefAuto{NonemptyWordFinite}[thm]{13}}
    \proofstepwidestar[15]{%
      i\in\NatSeg{\WordLength w-1}}{%
      \rA}
    \proofstepwidestar[1,15]{%
      \WordConcat{
        w\restriction_{\NatSeg{\WordLength w-1}}}{
        \LetterWord{w(\WordLength w-1)}}(i)
      =w\restriction_{\NatSeg{\WordLength w-1}}(i)}{%
      \FormulaRefAuto{WordConcatenationInitialCoordinate}[thm]{11,14,15}}
    \proofstepwidestar[1,15]{%
      w\restriction_{\NatSeg{\WordLength w-1}}(i)=w(i)}{%
  ...
  \proofpartwideindR[Fall 2: Letzte Koordinate]{%
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{FiniteWordFromTyping}[thm]{5,10}}
    \proofstepwidestar[1]{%
      \WordLength{w\restriction_{\NatSeg{\WordLength{w}-1}}}
      =(\WordLength{w}-1)}{%
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash
        F(x)\in B}[thm]{9,8}}
    \proofstepwidestar[1]{%
      \WordConcat{w\restriction_{\NatSeg{\WordLength w-1}}}{\LetterWord{w(\WordLength w-1)}}(\WordLength{w\restriction_{\NatSeg{\WordLength w-1}}})=w(\WordLength w-1)}{%
      \FormulaRefAuto{WordAppendLetterLastCoordinate}[thm]{11,13}}
    \proofstepwidestar[1]{%
      \WordConcat{w\restriction_{\NatSeg{\WordLength w-1}}}{\LetterWord{w(\WordLength w-1)}}(\WordLength w-1)=w(\WordLength w-1)}{%
      \rIE{12,14}}
    \proofstepwidestar[16]{%
      i=(\WordLength w-1)}{%
      \rA}
...
\end{BandTwentySevenProofCases}
  ...
  \proofpartwideindR[Existenz]{%
    ...
    \proofstepwidestar[1]{%
      \WordLength{\LetterWord{w(\WordLength{w}-1)}}=1}{%
      \FormulaRefAuto{LetterWordLengthOne}[thm]{13}}
    \proofstepwidestar[1]{%
      \begin{aligned}[t]
      &\WordConcat{
        w\restriction_{\NatSeg{\WordLength{w}-1}}}{
        \LetterWord{w(\WordLength{w}-1)}}\\[-2pt]
      &\quad\colon\NatSeg{
        \WordLength{w\restriction_{\NatSeg{\WordLength{w}-1}}}
        +\WordLength{\LetterWord{w(\WordLength{w}-1)}}}\to A
      \end{aligned}}{%
      \FormulaRefAuto{WordConcatenationTypingPart}[thm]{11,15}}
    \proofstepwidestar[1]{%
      \WordLength{w\restriction_{\NatSeg{\WordLength{w}-1}}}
      +\WordLength{\LetterWord{w(\WordLength{w}-1)}}
      =(\WordLength{w}-1)+1}{%
      \rIE{12,16}}
    ...
    \proofstepwidestar[1]{%
      \WordLength{w\restriction_{\NatSeg{\WordLength{w}-1}}}
      +\WordLength{\LetterWord{w(\WordLength{w}-1)}}
      =\WordLength{w}}{\rChain{18,\FormulaRefAuto{PeanoMinusOneAddOne}[thm]{3,4}}}
    \proofstepwidestar[1]{%
      \WordConcat{
        w\restriction_{\NatSeg{\WordLength{w}-1}}}{
        \LetterWord{w(\WordLength{w}-1)}}
    ...
    \proofstepwidestar[1,23]{%
      i\in\NatSeg{\WordLength w-1}\lor
      i=(\WordLength w-1)}{%
      \FormulaRefAuto{PeanoNatSegAddOneElim}[thm]{5,6,23}}
    ...
    \proofstepwidestar[1,25]{%
      \WordConcat{
        w\restriction_{\NatSeg{\WordLength w-1}}}{
        \LetterWord{w(\WordLength w-1)}}(i)=w(i)}{%
      \FormulaRefAuto{NonemptyWordDecompositionPrefixCoordinate}[thm]{1,25}}
    \proofstepwidestar[27]{%
      i=(\WordLength w-1)}{%
      \rA}
    \proofstepwidestar[1,27]{%
      \WordConcat{
        w\restriction_{\NatSeg{\WordLength w-1}}}{
        \LetterWord{w(\WordLength w-1)}}(i)=w(i)}{%
      \FormulaRefAuto{NonemptyWordDecompositionLastCoordinate}[thm]{1,27}}
    \proofstepwidestar[1,23]{%
      \WordConcat{
        w\restriction_{\NatSeg{\WordLength w-1}}}{
        \LetterWord{w(\WordLength w-1)}}(i)=w(i)}{%
    ...
    \proofstepwidestar[1]{%
      \WordConcat{
        ...
        \LetterWord{w(\WordLength{w}-1)}}
      =w}{%
      \FormulaRefAuto{FunctionExtensionality}[thm]{20,9,30}}
    \proofstepwidestar[1]{%
      w=\WordConcat{
        w\restriction_{\NatSeg{\WordLength{w}-1}}}{
        \LetterWord{w(\WordLength{w}-1)}}}{%
      \FormulaRefAuto{a=b\vdash b=a}[thm]{31}}
    \proofstepwidestar[1]{%
      \exists u\in\FiniteWords{A}\,\exists a\in A\,
      w=\WordConcat{u}{\LetterWord{a}}}{%
      \rEI{\rAI{11,\rEI{\rAI{13,32}}}}}
