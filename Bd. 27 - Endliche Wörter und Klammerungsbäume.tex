...
Induktion und Rekursion werden danach aus den Strukturaxiomen
hergeleitet. Die Modellnachweise begründen deren Erfüllbarkeit;
...
\input{tex/b27-word-generated-set}

\Needspace{30\baselineskip}
\section{Der Anschluss an endliche Folgen}

\input{tex/b27-word-characterization}
...
\input{tex/b27-word-early-core}
\input{tex/b27-word-early-minimality}
\input{tex/b27-word-structure-axioms}
\input{tex/b27-word-concrete-model}
\input{tex/b27-word-structure-consequences}
\input{tex/b27-word-proof-helpers}
\input{tex/b27-word-axiomatic-recursion}
\input{tex/b27-word-canonical-isomorphism}
...
\input{tex/b27-word-concatenation-adjunction}
...
\input{tex/b27-word-concatenation-successor}
...
\input{tex/b27-associativity-from-axioms}
...
\input{tex/b27-word-decomposition-from-axioms}

\input{tex/b27-word-end-operations}

\input{tex/b27-word-finite-induction}
...
\end{minipage}\par
\input{tex/b27-nonempty-induction-proof}
...
\input{tex/b27-nonempty-recursion-from-axioms}
...
\input{tex/b27-tree-early-foundations}
\input{tex/b27-tree-early-axioms}
\input{tex/b27-tree-axiomatic-recursion}
...
\input{tex/b27-tree-decomposition-from-axioms}
...
\input{tex/b27-tree-induction-from-axioms}
...
\input{tex/b27-tree-recursion-from-axioms}

\input{tex/b27-tree-canonical-isomorphism}

\input{tex/b27-tree-recursor}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{\LetterWord{0}\in\NonemptyWords{\{0,1\}}}{%
  ...
  \proofstepwidestar[]{\LetterWord0\in\FiniteWords{\{0,1\}}}{%
    \FormulaRefAuto{NonemptyWordFinite}[thm]{%
      4}}
  \proofstepwidestar[]{\LetterWord{1}\in\NonemptyWords{\{0,1\}}}{%
      \FormulaRefAuto{LetterWordNonempty}[thm]{3}}
  \proofstepwidestar[]{\LetterWord1\in\FiniteWords{\{0,1\}}}{%
    \FormulaRefAuto{NonemptyWordFinite}[thm]{%
      6}}
  \proofstepwidestar[]{\WordLength p=\WordLength p}{\rII}
  \proofstepwidestar[9]{\WordConcat p{\LetterWord0}=\WordConcat p{\LetterWord1}}{\rA}
  \proofstepwidestar[1,9]{\LetterWord0=\LetterWord1}{%
    \FormulaRefAuto{WordConcatenationFixedCutRight}[thm]{2,2,5,7,8,9}}
  \proofstepwidestar[1,9]{0=1}{%
    \FormulaRefAuto{LetterWordInjectivity}[thm]{3,10}}
  \proofstepwidestar[]{0\neq1}{\FormulaRefAuto{PeanoZeroNeOne}[thm]}
  \proofstepwidestar[1,9]{\bot}{\rBI{12,11}}
...
\input{tex/b27-graft-proof-lemmas}
...
\input{tex/b27-position-recursor-existence}
...
\input{tex/b27-general-rooted-trees}
...
\input{tex/b27-construction-rules}
\input{tex/b27-left-bracketing}
...
\input{tex/b27-bracketing-existence}
...
\input{tex/b27-left-bracketing-evaluation}

\input{tex/b27-structural-axioms}
