...
\begin{tabproofsplitwide}
  \proofpartwideindR[Verkleben ausgewählter Faserbijektionen]{%
    \begin{aligned}[t]
      &U\colon G\to W\dsep\mathcal C(U)\vdash{}\\[-2pt]
      &\exists f\,\Bigl(f\colon S\bij T
        \land\forall x\in S\,s(f(x))=\varphi(r(x))\\[-2pt]
      &\hspace{30mm}\land\forall g\in G\,f(g)=\varphi(g)\Bigr)
    \end{aligned}%
  }{%
    U\colon G\to W\dsep\mathcal C(U)\vdash
    \exists f\,\Bigl(f\colon S\bij T
      \land\forall x\in S\,s(f(x))=\varphi(r(x))
      \land\forall g\in G\,f(g)=\varphi(g)\Bigr)
  }[RetractionFiberBijectionGluing]
    \proofstepwidestarbreakkeep[1]{U\colon G\to W}{\rA}
    \proofstepwidestarbreakkeep[2]{\mathcal C(U)}{\rA}
    \proofstepwidestarbreakkeep[3]{x\in S}{\rA}
    \proofstepwidestarinline[3]{r(x)\in G\land x\in Q_{r(x)}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{3};
      \textnormal{Faserdefinition}}
    \proofstepwidestarinline[1,2,3]{%
      U(r(x))\colon Q_{r(x)}\bij R_{\varphi(r(x))}}{%
      \textnormal{Spezialisierung von \(\mathcal C(U)\), 2,4}}
    \proofstepwidestarbreakkeep[1,2,3]{U(r(x))(x)\in R_{\varphi(r(x))}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{5,4}}
    \proofstepwidestarinline[1,2]{\forall x\in S\,U(r(x))(x)\in T}{%
      \textnormal{Faserdefinition, 6; }\rUI{\rRI{3,6}}}
    \proofstepwidestarinline[1,2]{%
      \exists f\,\bigl(f\colon S\to T\land
        \forall x\in S\,f(x)=U(r(x))(x)\bigr)}{%
      \FormulaRefAuto{TypedFunctionDefinitionPrinciple}[thm]{7}}
    \proofstepwidestarinline[9]{%
      f\colon S\to T\land\forall x\in S\,f(x)=U(r(x))(x)}{\rA}
    \proofstepwidestarforcebreakkeep[1,2,9]{%
      \forall x\in S\,s(f(x))=\varphi(r(x))}{%
      \textnormal{6,9; Faserdefinition und Gleichheitsersetzung}}
    \proofstepwidestarbreakkeep[11]{g\in G}{\rA}
    \proofstepwidestarinline[11]{g\in S\land r(g)=g}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{11};
      \textnormal{Retraktionsgleichung}}
    \proofstepwidestarforcebreakkeep[1,2,9,11]{f(g)=U(r(g))(g)=U(g)(g)=\varphi(g)}{%
      \textnormal{9,12; Spezialisierung von \(\mathcal C(U)\), 2}}
    \proofstepwidestarbreakkeep[1,2,9]{\forall g\in G\,f(g)=\varphi(g)}{%
      \rUI{\rRI{11,13}}}
    \proofstepwidestarbreakkeep[15]{x\in S\land x'\in S\land f(x)=f(x')}{\rA}
    \proofstepwidestarforcebreakkeep[1,2,9,15]{\varphi(r(x))=\varphi(r(x'))}{%
      \textnormal{Spezialisierung von 10; Gleichheitsersetzung, 15}}
    \proofstepwidestarinline[1,2,9,15]{r(x)=r(x')}{%
      \FormulaRefAuto{Bijektive Funktion}[def];
      \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep
        F(x)=F(y)\vdash x=y}[ax]{4,15,16}}
    \proofstepwidestarforcebreakkeep[1,2,9,15]{U(r(x))(x)=U(r(x))(x')}{%
      \textnormal{9,15,17; Gleichheitsersetzung}}
    \proofstepwidestarinline[1,2,9,15]{x=x'}{%
      \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep
        F(x)=F(y)\vdash x=y}[ax]{5,4,15,17,18}}
    \proofstepwidestarbreakkeep[1,2,9]{f\colon S\inj T}{%
      \FormulaRefAuto{Injektive Funktion}[def]{9,15,19}}
    \proofstepwidestarbreakkeep[21]{y\in T}{\rA}
    \proofstepwidestarinline[21]{%
      \varphi^{-1}(s(y))\in G\land
      \varphi(\varphi^{-1}(s(y)))=s(y)}{%
      \begin{tabular}[t]{@{}l@{}}
        \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{21};\\[-2pt]
        \FormulaRefAuto{y\in B\vdash F^{-1}(y)\in A}[thm];\\[-2pt]
        \FormulaRefAuto{F\colon A\bij B\dsep y\in B\vdash F(F^{-1}(y))=y}[thm]
      \end{tabular}}
    \proofstepwidestarinline[21]{g\coloneqq\varphi^{-1}(s(y))}{%
      \textnormal{Abkürzung für den Term aus 22}}
    \proofstepwidestarinline[21]{g\in G\land y\in R_{\varphi(g)}}{%
      \textnormal{22--23; Faserdefinition}}
    \proofstepwidestarbreakkeep[1,2,21]{\exists x\in Q_g\,U(g)(x)=y}{%
      \FormulaRefAuto{Surjektivität}[ax]{2,24}}
    \proofstepwidestarbreakkeep[26]{x\in Q_g\land U(g)(x)=y}{\rA}
    \proofstepwidestarbreakkeep[26]{x\in S\land r(x)=g}{\textnormal{Faserdefinition, 26}}
    \proofstepwidestarforcebreakkeep[1,2,9,26]{f(x)=U(r(x))(x)=U(g)(x)=y}{%
      \textnormal{9,26--27; Gleichheitsersetzung}}
    \proofstepwidestarbreakkeep[1,2,9,26]{\exists x\in S\,f(x)=y}{\rEI{\rAI{27,28}}}
    \proofstepwidestarbreakkeep[1,2,9,21]{\exists x\in S\,f(x)=y}{%
      \rEE{25,26,29}}
    \proofstepwidestarbreakkeep[1,2,9]{f\colon S\sur T}{%
      \FormulaRefAuto{Surjektive Funktion}[def]{9,21,30}}
    \proofstepwidestarbreakkeep[1,2,9]{f\colon S\bij T}{%
      \FormulaRefAuto{F\colon A\inj B\dsep F\colon A\sur B\vdash
        F\colon A\bij B}[thm]{20,31}}
    \proofstepwidestarforcebreakkeep[1,2,9]{%
      \begin{aligned}[t]
        &\exists f\,\Bigl(f\colon S\bij T
          \land\forall x\in S\,s(f(x))=\varphi(r(x))\\[-2pt]
        &\hspace{22mm}\land\forall g\in G\,f(g)=\varphi(g)\Bigr)
      \end{aligned}}{\rEI{\rAI{32,\rAI{10,14}}}}
    \proofstepwidestarforcebreakkeep[1,2]{%
      \begin{aligned}[t]
        &\exists f\,\Bigl(f\colon S\bij T
          \land\forall x\in S\,s(f(x))=\varphi(r(x))\\[-2pt]
        &\hspace{22mm}\land\forall g\in G\,f(g)=\varphi(g)\Bigr)
      \end{aligned}}{\rEE{8,9,33}}
  \closeproofpartwideindR
\end{tabproofsplitwide}

Für den Auswahlteil setzen wir nun
\[
  D=\bigl\{(g,u)\in G\times W\bigm|
      u\colon Q_g\bij R_{\varphi(g)}\land u(g)=\varphi(g)\bigr\}.
\]
\begin{tabproofsplitwide}
  \proofpartwide{Punktierte Fasern und Totalität der Auswahlrelation}
    \proofstepwidestarbreakkeep[1]{%
      \forall g\in G\,\exists u\,(u\colon Q_g\bij R_{\varphi(g)})}{\rA}
    \proofstepwidestarbreakkeep[2]{g\in G}{\rA}
    \proofstepwidestarforcebreakkeep[2]{g\in Q_g\land\varphi(g)\in R_{\varphi(g)}}{%
      \FormulaRefAuto{F\colon A\to B\dsep x\in A\vdash F(x)\in B}[thm]{2};
      \textnormal{Faserdefinition; Retraktionsgleichungen}}
    \proofstepwidestarbreakkeep[1,2]{\exists u\,(u\colon Q_g\bij R_{\varphi(g)})}{%
      \rRE{\rUE{1},2}}
    \proofstepwidestarinline[1,2]{%
      \exists u\,\bigl(u\colon Q_g\bij R_{\varphi(g)}
        \land u(g)=\varphi(g)\bigr)}{%
      \FormulaRefAuto{PointedBijectionExists}[thm]{4,3}}
    \proofstepwidestarinline[6]{u\colon Q_g\bij R_{\varphi(g)}\land u(g)=\varphi(g)}{\rA}
    \proofstepwidestarbreakkeep[6]{u\subseteq Q_g\times R_{\varphi(g)}}{%
      \FormulaRefAuto{FunctionGraphSubsetProduct}[thm]{6}}
    \proofstepwidestarinline[6]{u\subseteq S\times T}{%
      \begin{tabular}[t]{@{}l@{}}
        \FormulaRefAuto{CartesianProductMonotoneLeft}[thm];
          \FormulaRefAuto{CartesianProductMonotoneRight}[thm];\\[-2pt]
        \textnormal{Faserdefinition; zweimal Teilmengentransitivität, 7}
      \end{tabular}}
    \proofstepwidestarbreakkeep[6]{u\in W}{%
      \FormulaRefAuto{x\in\powerset(A)\;\eqvdash\;x\subseteq A}[thm]{8}}
    \proofstepwidestarinline[2,6]{(g,u)\in D}{%
      \FormulaRefAuto{x\in A\dsep P(x)\vdash x\in\{x\in A\mid P(x)\}}[thm]{2,6,9};
      \textnormal{Definition von \(D\)}}
    \proofstepwidestarbreakkeep[2,6]{\exists u\,((g,u)\in D)}{\rEI{10}}
    \proofstepwidestarbreakkeep[1,2]{\exists u\,((g,u)\in D)}{\rEE{5,6,11}}
    \proofstepwidestarbreakkeep[]{D\subseteq G\times W}{%
      \FormulaRefAuto{\{x\in A\mid P(x)\}\subseteq A}[thm]}
    \proofstepwidestarbreakkeep[1]{\TotRel{D,G,W}}{%
      \FormulaRefAuto{Totale Relation}[def]{13,2,12}}
  \closeproofpartwide
  ...
  \proofpartwide{Auswahl und Schluss}
    \proofstepwidestarbreakkeep[1]{%
      \forall g\in G\,\exists u\,(u\colon Q_g\bij R_{\varphi(g)})}{\rA}
    \proofstepwidestarbreakkeep[1]{\TotRel{D,G,W}}{%
      \textnormal{voriger Teil, Zeile 14}}
    \proofstepwidestarinline[1]{%
      \exists U\,\bigl(U\colon G\to W\land
        \forall g\in G\,(g,U(g))\in D\bigr)}{%
      \FormulaRefAuto{\exists F\colon A\to B\,\forall x\in A\,
        \bigl((x,F(x))\in R\bigr)}[thm]{2}}
    \proofstepwidestarbreakkeep[4]{U\colon G\to W\land
      \forall g\in G\,(g,U(g))\in D}{\rA}
    \proofstepwidestarbreakkeep[4]{U\colon G\to W}{\rAEa{4}}
    \proofstepwidestarinline[4]{\mathcal C(U)}{%
      \textnormal{Definitionen von \(D\) und \(\mathcal C\); 4}}
    \proofstepwidestarforcebreakkeep[4]{%
      \begin{aligned}[t]
        &\exists f\,\Bigl(f\colon S\bij T
          \land\forall x\in S\,s(f(x))=\varphi(r(x))\\[-2pt]
        &\hspace{22mm}\land\forall g\in G\,f(g)=\varphi(g)\Bigr)
      \end{aligned}}{%
      \FormulaRefAuto{RetractionFiberBijectionGluing}[thm]{5,6}}
    \proofstepwidestarforcebreakkeep[1]{%
      \begin{aligned}[t]
        &\exists f\,\Bigl(f\colon S\bij T
          \land\forall x\in S\,s(f(x))=\varphi(r(x))\\[-2pt]
        &\hspace{22mm}\land\forall g\in G\,f(g)=\varphi(g)\Bigr)
      \end{aligned}}{\rEE{3,4,7}}
  \closeproofpartwide
  \end{minipage}\par
\end{tabproofsplitwide}
