...
\begin{tabproof}
  ...
  \proofstep{4,6}{t(X)=U(Y)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{9,6}}
  \proofstep{4,5,6}{t(X)=t(Y)}{%
  ...
  \proofstep{1,2}{U\colon\mathcal A\inj\mathcal B}{%
    \ProofRefStack{%
      ...
      \bigl(3,\rUI{\rRI{4,\rRI{5,\rRI{6,12}}}}\bigr)}}
\end{tabproof}
...
\FormulaDefDeltaK[Kanonische Profilabbildung]{%
  ...
  \CanonicalProfileMap{A,\JoinOp,0}
    \coloneqq\Graph(\widehat c_{A,\JoinOp,0})
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &X,Y\in\mathcal L_M\vdash{}\\[-2pt]
      &\quad\PairSup{\mathcal L_M}{\subseteq}{X}{Y}{%
        X\FamilyJoinOp{M}{}Y}
    \end{aligned}}{%
