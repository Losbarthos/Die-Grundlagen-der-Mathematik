...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      &b\in\mathbb{N}\dsep
        \bigl(a\in\mathbb{N}\vdash a+b=b+a\bigr)\vdash{}\\
      &a\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(b)+a
    \end{aligned}
  }{%
    b\in\mathbb{N}\dsep
    \bigl(a\in\mathbb{N}\vdash a+b=b+a\bigr)
    \vdash
    a\in\mathbb{N}\vdash a+\Succ(b)=\Succ(b)+a%
  }[PeanoAddCommutativeStep]
    \proofstepwidestar[1]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{a\in\mathbb{N}\vdash a+b=b+a}{\rA}
    \proofstepwidestar[3]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[1,3]{a+\Succ(b)=\Succ(a+b)}{%
      \FormulaRefAuto{PeanoAddSuccRight}{3,1}}
    \proofstepwidestar[2,3]{a+b=b+a}{\rRE{2,3}}
    \proofstepwidestar[2,3]{\Succ(a+b)=\Succ(b+a)}{\rIE{5}}
    \proofstepwidestar[1,3]{\Succ(b)+a=\Succ(b+a)}{%
      \FormulaRefAuto{PeanoAddSuccLeft}{1,3}}
    \proofstepwidestar[1,3]{\Succ(b+a)=\Succ(b)+a}{%
      \FormulaRefAuto{a=b\vdash b=a}{7}}
...
\begin{proof}
  Nach der bereits bewiesenen von-Neumann-Charakterisierung ist
  \(m\leq_{\mathbb N}n\) gleichbedeutend mit \(m\subseteq n\).
  Wir zeigen durch Induktion über \(n\), dass dies genau dann gilt, wenn
  \(n\) von \(m\) aus durch Addition einer natürlichen Zahl erreicht wird.
  Für \(n=0\) erzwingt \(m\subseteq0\) die Gleichheit \(m=0\), und der
  Abstand ist \(0\); umgekehrt folgt aus \(m+k=0\), dass \(m=0\).
  Im Nachfolgerschritt zerfällt \(m\subseteq\Succ(n)\) in die Fälle
  \(m=\Succ(n)\) und \(m\subseteq n\). Im ersten Fall dient wieder \(0\)
  als Abstand. Im zweiten Fall liefert die Induktionsvoraussetzung ein
  \(k\) mit \(m+k=n\), also
  \(m+\Succ(k)=\Succ(n)\). Umgekehrt ist ein Abstand zu \(\Succ(n)\)
  entweder \(0\), oder er hat die Form \(\Succ(k)\); im zweiten Fall
  reduziert die Rekursionsgleichung der Addition die Behauptung auf die
...
\begin{proof}
  ...
  \(m<_{\mathbb N}n\) genau dann, wenn
  \(\Succ(m)\leq_{\mathbb N}n\). Nach der additiven Charakterisierung der
  nicht-strikten Ordnung ist dies äquivalent zur Existenz eines
  \(k\in\mathbb N\) mit \(\Succ(m)+k=n\). Die Rekursionsgleichungen und
  die Kommutativität der Addition liefern
  \(\Succ(m)+k=m+\Succ(k)\), also die behauptete Charakterisierung.
\end{proof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      &b\in\mathbb{N}\dsep
      \bigl(a\in\mathbb{N}\vdash\Succ(a)\cdot b=a\cdot b+b\bigr)
      \vdash{}\\
      &a\in\mathbb{N}\vdash
    ...
    \proofstepwidestar[1]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{%
      a\in\mathbb{N}\vdash\Succ(a)\cdot b=a\cdot b+b}{\rA}
    \proofstepwidestar[3]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[3]{\Succ(a)\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoSuccClosure}{3}}
    \proofstepwidestar[2,3]{\Succ(a)\cdot b=a\cdot b+b}{\rRE{2,3}}
    \proofstepwidestar[1,3]{%
      \Succ(a)\cdot\Succ(b)=\Succ(a)\cdot b+\Succ(a)}{%
      \FormulaRefAuto{PeanoMulSuccRight}{4,1}}
    \proofstepwidestar[1,2,3]{%
      \Succ(a)\cdot\Succ(b)=(a\cdot b+b)+\Succ(a)}{%
      \rIE{5,6}}
    \proofstepwidestar[3]{a+1=\Succ(a)}{%
      \FormulaRefAuto{PeanoAddOneSucc}{3}}
    \proofstepwidestar[1]{b+1=\Succ(b)}{%
      \FormulaRefAuto{PeanoAddOneSucc}{1}}
    \proofstepwidestar[]{1\in\mathbb{N}}{\FormulaRefAuto{PeanoOneInN}}
    \proofstepwidestar[1,3]{a\cdot b\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoMulClosure}{3,1}}
    \proofstepwidestar[1,3]{%
      (a\cdot b+b)+(a+1)=(a\cdot b+a)+(b+1)}{%
      \FormulaRefAuto{PeanoAddInterchange}{11,1,3,10}}
    \proofstepwidestar[1,3]{%
      (a\cdot b+b)+\Succ(a)=(a\cdot b+a)+\Succ(b)}{%
      \rIE{8,9,12}}
    \proofstepwidestar[1,3]{a\cdot\Succ(b)=a\cdot b+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{3,1}}
    \proofstepwidestar[1,3]{%
      (a\cdot b+a)+\Succ(b)=a\cdot\Succ(b)+\Succ(b)}{\rIE{14}}
    \proofstepwidestar[1,2,3]{%
      \Succ(a)\cdot\Succ(b)=a\cdot\Succ(b)+\Succ(b)}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{7,13},15}}
    \proofstepwidestar[1,2]{%
      a\in\mathbb{N}\vdash
      \Succ(a)\cdot\Succ(b)=a\cdot\Succ(b)+\Succ(b)}{\rRI{3,16}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      &b\in\mathbb{N}\dsep
      \bigl(a\in\mathbb{N}\vdash a\cdot b=b\cdot a\bigr)\vdash{}\\
      &a\in\mathbb{N}\vdash
      a\cdot\Succ(b)=\Succ(b)\cdot a
    \end{aligned}
  }{%
    b\in\mathbb{N}\dsep
    \bigl(a\in\mathbb{N}\vdash a\cdot b=b\cdot a\bigr)
    \vdash
    a\in\mathbb{N}\vdash a\cdot\Succ(b)=\Succ(b)\cdot a%
  }[PeanoMulCommutativeStep]
    \proofstepwidestar[1]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[2]{a\in\mathbb{N}\vdash a\cdot b=b\cdot a}{\rA}
    \proofstepwidestar[3]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[1,3]{a\cdot\Succ(b)=a\cdot b+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{3,1}}
    \proofstepwidestar[2,3]{a\cdot b=b\cdot a}{\rRE{2,3}}
    \proofstepwidestar[2,3]{a\cdot b+a=b\cdot a+a}{\rIE{5}}
    \proofstepwidestar[1,3]{\Succ(b)\cdot a=b\cdot a+a}{%
      \FormulaRefAuto{PeanoMulSuccLeft}{1,3}}
    \proofstepwidestar[1,3]{b\cdot a+a=\Succ(b)\cdot a}{%
      \FormulaRefAuto{a=b\vdash b=a}{7}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      &c\in\mathbb{N}\dsep
      \bigl(a,b\in\mathbb{N}\vdash
        a\cdot(b+c)=a\cdot b+a\cdot c\bigr)\vdash{}\\
    ...
    c\in\mathbb{N}\dsep
    \bigl(a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      a\cdot(b+c)=a\cdot b+a\cdot c\bigr)
    \vdash
    a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
    a\cdot(b+\Succ(c))=a\cdot b+a\cdot\Succ(c)%
    ...
    \proofstepwidestar[2]{%
      a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      a\cdot(b+c)=a\cdot b+a\cdot c}{\rA}
    \proofstepwidestar[3]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[4]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[1,4]{b+\Succ(c)=\Succ(b+c)}{%
      \FormulaRefAuto{PeanoAddSuccRight}{4,1}}
    \proofstepwidestar[1,3,4]{%
      a\cdot(b+\Succ(c))=a\cdot\Succ(b+c)}{\rIE{5}}
    \proofstepwidestar[1,3,4]{b+c\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoAddClosure}{4,1}}
    \proofstepwidestar[1,3,4]{%
      a\cdot\Succ(b+c)=a\cdot(b+c)+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{3,7}}
    \proofstepwidestar[1,2,3,4]{%
      a\cdot(b+c)=a\cdot b+a\cdot c}{\rRE{2,3,4}}
    \proofstepwidestar[1,2,3,4]{%
      a\cdot(b+c)+a=(a\cdot b+a\cdot c)+a}{\rIE{9}}
    \proofstepwidestar[1,2,3,4]{%
      (a\cdot b+a\cdot c)+a=a\cdot b+(a\cdot c+a)}{%
      \FormulaRefAuto{PeanoAddAssociative}{%
        \FormulaRefAuto{PeanoMulClosure}{3,4},
        \FormulaRefAuto{PeanoMulClosure}{3,1},3}}
    \proofstepwidestar[1,3]{a\cdot\Succ(c)=a\cdot c+a}{%
      \FormulaRefAuto{PeanoMulSuccRight}{3,1}}
    \proofstepwidestar[1,3,4]{%
      a\cdot b+(a\cdot c+a)=a\cdot b+a\cdot\Succ(c)}{\rIE{12}}
    \proofstepwidestar[1,2,3,4]{%
      a\cdot(b+\Succ(c))=a\cdot b+a\cdot\Succ(c)}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
          \FormulaRefAuto{a = b,\, b = c \vdash a = c}{6,8},10},%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{11,13}}}
    \proofstepwidestar[1,2]{%
      a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      a\cdot(b+\Succ(c))=a\cdot b+a\cdot\Succ(c)}{\rRI{3,4,14}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    \begin{aligned}[t]
      &c\in\mathbb{N}\dsep
      \bigl(a,b\in\mathbb{N}\vdash
        (a\cdot b)\cdot c=a\cdot(b\cdot c)\bigr)\vdash{}\\
      &a,b\in\mathbb{N}\vdash
    ...
    c\in\mathbb{N}\dsep
    \bigl(a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      (a\cdot b)\cdot c=a\cdot(b\cdot c)\bigr)
    \vdash
    a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
    (a\cdot b)\cdot\Succ(c)=a\cdot(b\cdot\Succ(c))%
    ...
    \proofstepwidestar[2]{%
      a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      (a\cdot b)\cdot c=a\cdot(b\cdot c)}{\rA}
    \proofstepwidestar[3]{a\in\mathbb{N}}{\rA}
    \proofstepwidestar[4]{b\in\mathbb{N}}{\rA}
    \proofstepwidestar[3,4]{a\cdot b\in\mathbb{N}}{%
      \FormulaRefAuto{PeanoMulClosure}{3,4}}
    \proofstepwidestar[1,3,4]{%
      (a\cdot b)\cdot\Succ(c)=(a\cdot b)\cdot c+a\cdot b}{%
      \FormulaRefAuto{PeanoMulSuccRight}{5,1}}
    \proofstepwidestar[1,2,3,4]{%
      (a\cdot b)\cdot c=a\cdot(b\cdot c)}{\rRE{2,3,4}}
    \proofstepwidestar[1,2,3,4]{%
      (a\cdot b)\cdot c+a\cdot b=a\cdot(b\cdot c)+a\cdot b}{\rIE{7}}
    \proofstepwidestar[1,3,4]{%
      a\cdot(b\cdot c+b)=a\cdot(b\cdot c)+a\cdot b}{%
      \FormulaRefAuto{PeanoMulLeftDistributive}{%
        3,\FormulaRefAuto{PeanoMulClosure}{4,1},4}}
    \proofstepwidestar[1,3,4]{%
      a\cdot(b\cdot c)+a\cdot b=a\cdot(b\cdot c+b)}{%
      \FormulaRefAuto{a=b\vdash b=a}{9}}
    \proofstepwidestar[1,4]{b\cdot\Succ(c)=b\cdot c+b}{%
      \FormulaRefAuto{PeanoMulSuccRight}{4,1}}
    \proofstepwidestar[1,3,4]{%
      a\cdot(b\cdot c+b)=a\cdot(b\cdot\Succ(c))}{\rIE{11}}
    \proofstepwidestar[1,2,3,4]{%
      (a\cdot b)\cdot\Succ(c)=a\cdot(b\cdot\Succ(c))}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
        \FormulaRefAuto{a = b,\, b = c \vdash a = c}{%
          \FormulaRefAuto{a = b,\, b = c \vdash a = c}{6,8},10},12}}
    \proofstepwidestar[1,2]{%
      a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
      (a\cdot b)\cdot\Succ(c)=a\cdot(b\cdot\Succ(c))}{%
      \rRI{3,4,13}}
