...
\title{Bd. 12 - Natürliche Zahlen}
\author{Martin Kunze}
\date{}
\setcounter{file}{12}

\hypersetup{
  pdftitle={Bd. 12 - Natürliche Zahlen},
...
Ordnung und Stellenwertsysteme. Die Funktionsgrundlagen aus den Bänden
B05--B08 und die allgemeine Ordnungstheorie aus Band~11 werden dabei nicht
erneut axiomatisiert.
...
\begin{tabproof}
  ...
  \proofstep{4}{n\in\mathbb{N}}{\rA}
  \proofstep{5}{k\in\mathbb{N}}{\rA}
  \proofstep{6}{m\leq n}{\rA}
  \proofstep{7}{n\leq k}{\rA}
  \proofstep{1,4,5,6,7}{m\leq k}{%
    \FormulaRefAuto{%
      m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep k\in\mathbb{N}\dsep
      m\leq n\dsep n\leq k\vdash m\leq k}{1,4,5,6,7}}

  \proofstep{9}{m\leq n}{\rA}
  \proofstep{10}{n\leq m}{\rA}
  \proofstep{1,4,9}{m\subseteq n}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
      m\leq n\leftrightarrow m\subseteq n}{1,4,9}}
  \proofstep{1,4,10}{n\subseteq m}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
      m\leq n\leftrightarrow m\subseteq n}{4,1,10}}
  \proofstep{1,4,9,10}{m=n}{%
    \FormulaRefAuto{A \subseteq B, B \subseteq A \vdash A = B}{11,12}}
  \proofstep{}{\PartOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{Partielle Ordnung}[def]{3,8,13}}

  \proofstep{15}{m\in\mathbb{N}}{\rA}
  \proofstep{16}{n\in\mathbb{N}}{\rA}
  \proofstep{15,16}{m\leq n\lor n\leq m}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\vdash
      m\leq n\lor n\leq m}{15,16}}
  \proofstep{}{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{Totale Ordnung}[def]{14,17}}
\end{tabproof}
...
\FormulaThmDelta[Wohlordnung der natürlichen Zahlen]{%
  ...
  \DeltaRow{Totale Ordnung}{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}
    [\FormulaRefAuto{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}]
  \DeltaRow{Wohlordnungsprinzip}{%
    B\subseteq\mathbb{N}\dsep B\neq\varnothing
    \vdash \exists a\in B\,\forall b\in B\,a\leq b}
    [\FormulaRefAuto{B\subseteq\mathbb{N}\dsep B\neq\varnothing \vdash \exists a\in B\,\forall b\in B\,a\leq b}]
}{}
\begin{tabproof}
  \proofstep{}{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}}
  ...
  \proofstep{2,3}{\exists a\in B\,\forall b\in B\,a\leq b}{%
    \FormulaRefAuto{B\subseteq\mathbb{N}\dsep B\neq\varnothing \vdash
      \exists a\in B\,\forall b\in B\,a\leq b}{2,3}}
  \proofstep{}{\WellOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{Wohlordnung}{1,4}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[3]{\Succ(\Succ(a)+b)=\Succ(\Succ(a+b))}{\rIE{3}}
    \proofstepwidestar[1,2,3]{\Succ(a)+\Succ(b)=\Succ(\Succ(a+b))}{%
      \FormulaRefAuto{a = b,\, b = c \vdash a = c}{5,6}}
    \proofstepwidestar[1,2]{a+\Succ(b)=\Succ(a+b)}{%
      \FormulaRefAuto{a\in\mathbb{N}\dsep b\in\mathbb{N}\vdash
        a+\Succ(b)=\Succ(a+b)}{1,2}}
    \proofstepwidestar[1,2]{\Succ(a+\Succ(b))=\Succ(\Succ(a+b))}{\rIE{8}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[4]{z\in\mathbb{N}}{\rA}
  \proofstepwidestar[5]{x\leq y}{\rA}
  \proofstepwidestar[6]{y\leq z}{\rA}
  \proofstepwidestar[1,3,4,5,6]{x\leq z}{%
    \FormulaRefAuto{k\in\mathbb{N}\dsep m\in\mathbb{N}
      \dsep n\in\mathbb{N}\dsep k\leq m\dsep m\leq n
      \vdash k\leq n}{1,3,4,5,6}}
  \proofstepwidestar[8]{x\leq y}{\rA}
  \proofstepwidestar[9]{y\leq x}{\rA}
  \proofstepwidestar[1,3,8,9]{x=y}{%
    \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}
      \dsep m\leq n\dsep n\leq m\vdash m=n}{1,3,8,9}}
  \proofstepwidestar[]{\PartOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{Partielle Ordnung}[def]{2,7,10}}
  \proofstepwidestar[12]{x\in\mathbb{N}}{\rA}
  \proofstepwidestar[13]{y\in\mathbb{N}}{\rA}
  \proofstepwidestar[12,13]{x\leq y\lor y\leq x}{%
    \FormulaRefAuto{PeanoOrderComparison}[thm]{12,13}}
  \proofstepwidestar[]{\TotOrd{\mathbb{N},\leq_{\mathbb{N}}}}{%
    \FormulaRefAuto{Totale Ordnung}[def]{11,14}}
\end{tabproofwide}
