...
\section{Existenz und Eindeutigkeit des neutralen Elements}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Ein neutraler Kandidat stimmt mit dem neutralen Element überein]{%
    \begin{aligned}[t]
    ...
    \proofstepwidestar[1,2]{e'\star e=e'}{%
      \FormulaRefAuto{MonoidRightIdentityAxiom}[ax]{1,2}}
    \proofstepwidestar[1,2,3]{e=e'}{\rIE{6,7}}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2]{%
      ...
      \eta_R(m+k)=\eta_R(m)\oplus\eta_R(k)
      \Bigr)}{%
      \FormulaRefAuto{PeanoInductionAxiom}[ax]{4,9}}
    \proofstepwidestar[1,2,3]{%
