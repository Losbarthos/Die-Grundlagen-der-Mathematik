...
\section{Beispiel: Die Potenzhalbgruppe}

Aus jeder Halbgruppe entsteht eine weitere Halbgruppe, deren Elemente die
nichtleeren Teilmengen des ursprünglichen Trägers sind. Zur Vorbereitung
halten wir zunächst fest, wie die bereits eingeführte Notation
\(\PowNE{A}=\powerset(A)\setminus\{\varnothing\}\) gelesen wird.
...
\begin{tabproofwide}
  \proofstepwide{X\in\PowNE{A}}{\leftrightarrow}{%
    X\in\powerset(A)\land X\notin\{\varnothing\}}{%
    \FormulaRefAuto{x \in A \setminus B \eqvdash
      x \in A \land x \notin B}[thm]}
  \proofstepwide{X\in\powerset(A)}{\leftrightarrow}{X\subseteq A}{%
    \FormulaRefAuto{x \in \powerset(A)\;\eqvdash\; x \subseteq A}[thm]}
  \proofstepwide{X\notin\{\varnothing\}}{\leftrightarrow}{%
    X\neq\varnothing}{%
    \FormulaRefAuto{x \notin \{a\} \eqvdash x \neq a}[thm]}
  \proofstepwide{} {\leftrightarrow}{%
    X\subseteq A\land X\notin\{\varnothing\}}{\rLRS{2}}
  \proofstepwide{} {\leftrightarrow}{%
    X\subseteq A\land X\neq\varnothing}{\rLRS{3}}
  \proofstepwide{X\in\PowNE{A}}{\leftrightarrow}{%
    X\subseteq A\land X\neq\varnothing}{\rChain{1,5}}
\end{tabproofwide}
