...
\subsection{Beispiele zu Halbgruppenhomomorphismen}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{%
    ...
    \FormulaRefAuto{SemigroupHomDef}[def]{6,7,5,20}}
\end{tabproofwide}

\subsection{Beispiele zu Halbgruppenisomorphismen}
...
\subsection{Spezialisierte Halbgruppen}
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    ...
    \FormulaRefAuto{%
      ...
      \exists! F\colon A\to B\,\forall x\in A\,F(x)=t(x)}{7,10}}
\end{tabproof}

\FormulaThmDeltaK[Rekursionsdaten des kanonischen Halbringhomomorphismus]{%
  \SemiringAlg{R}{\oplus}{\odot}{0_R}{1_R}
  \vdash
  0_R\in R\land
  \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R%
}{NaturalSemiringRecursionData}{%
...
\FormulaDefDeltaK[Kanonische Abbildung in einen Halbring]{%
  ...
  \DeltaRow{Funktionen}{\oplus\dsep\odot}
  \DeltaRow{Rekursionsdaten}{}[%
    \FormulaRefAuto{NaturalSemiringRecursionData}[thm]]
...
\begin{tabproof}
  ...
  \proofstep{1}{%
    0_R\in R\land
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{%
    \FormulaRefAuto{NaturalSemiringRecursionData}[thm]{1}}
  \proofstep{1}{0_R\in R}{\rAEa{2}}
  \proofstep{1}{%
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{\rAEb{2}}
  \proofstep{1}{%
    \RecFun{0_R}{\SemiringSuccessor{R,\oplus,\odot,0_R,1_R}}
    \colon\mathbb N\to R}{%
    \FormulaRefAuto{%
      m_0\in M\dsep f\colon M\to M \vdash
      \RecFun{m_0}{f}\colon \mathbb{N}\to M}{3,4}}
  \proofstep{1}{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}
    =
    \RecFun{0_R}{\SemiringSuccessor{R,\oplus,\odot,0_R,1_R}}}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    ...
    s_R\colon R\to R}{%
    \FormulaRefAuto{NaturalSemiringRecursionData}[thm]{1}}
  \proofstepwidestar[1]{0_R\in R}{\rAEa{3}}
  \proofstepwidestar[1]{s_R\colon R\to R}{\rAEb{3}}
  \proofstepwidestar[1,2]{%
  ...
  \proofstepwidestar[1]{\eta_R=\RecFun{0_R}{s_R}}{%
    \FormulaRefAuto{NaturalSemiringMapDef}[def]{1}}
  \proofstepwidestar[1,2]{%
    \eta_R(\Succ(n))=s_R\!\left(\eta_R(n)\right)}{\rIE{7,6}}
  ...
  \proofstepwidestar[1,2]{\eta_R(n)\in R}{%
    \FormulaRefAuto{F\colon A\to B\dsep a\in A\vdash F(a)\in B}{9,2}}
  \proofstepwidestar[1,2]{%
    s_R\!\left(\eta_R(n)\right)=\eta_R(n)\oplus1_R}{%
    \FormulaRefAuto{SemiringSuccessorDef}[def]{1,10}}
  \proofstepwidestar[1,2]{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{\MonoidAlg{R}{\oplus}{0_R}}{%
    \FormulaRefAuto{CommutativeMonoidBaseMonoidAxiom}[ax]{7}}
  \proofstepwidestar[1]{\MonoidAlg{R}{\odot}{1_R}}{%
    \FormulaRefAuto{SemiringMultiplicativeMonoidAxiom}[ax]{1}}
  \proofstepwidestar[1]{1_R\in R}{%
    \FormulaRefAuto{MonoidIdentityCarrierAxiom}[ax]{9}}
  \proofstepwide[1]{0_R\oplus1_R}{=}{1_R}{%
    \FormulaRefAuto{MonoidLeftIdentityAxiom}[ax]{8,10}}
  \proofstepwidestar[1]{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(1)=1_R}{%
    \rChain{4,5,6,11}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Additiver Monoidanteil]{%
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{NaturalSemiringMapAddition}[thm]{1}}
    \proofstepwidestar[1]{%
      \SemigroupHom{\eta_R}{\mathbb N,+}{R,\oplus}}{%
      \FormulaRefAuto{SemigroupHomDef}[def]{4,5,6,7}}
    \proofstepwidestar[1]{\eta_R(0)=0_R}{%
      \FormulaRefAuto{NaturalSemiringMapZero}[thm]{1}}
    \proofstepwidestar[1]{%
      \MonoidHom{\eta_R}{\mathbb N,+,0}{R,\oplus,0_R}}{%
      \FormulaRefAuto{MonoidHomDef}[def]{2,3,8,9}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Multiplikativer Monoidanteil]{%
    ...
    \proofstepwidestar[1]{%
      ...
      \FormulaRefAuto{NaturalSemiringMapMultiplication}[thm]{1}}
    \proofstepwidestar[1]{%
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Eindeutigkeit auf jedem natürlichen Argument]{%
    ...
    \proofstepwidestar[1,2,3]{%
      f(n)=\NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)}{%
      \FormulaRefAuto{PeanoInductionRule}[ax]{5,12,13}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Existenz und Eindeutigkeit}
    ...
    \proofstepwidestar[1,3]{%
      n\in\mathbb N\vdash
      f(n)=\NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)}{%
      \FormulaRefAuto{NaturalSemiringHomPointwiseUnique}[thm]{1,3}}
    \proofstepwidestar[1,3]{%
      f=\NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}}{%
      \FormulaRefAuto{\forall x\in A\,(F(x)=G(x)) \eqvdash F=G}[thm]{6}}
    \proofstepwidestar[1]{%
      \exists! f\,
      \SemiringHom{f}{\mathbb N,+,\cdot,0,1}
        {R,\oplus,\odot,0_R,1_R}}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    ...
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{%
    \FormulaRefAuto{NaturalSemiringRecursionData}[thm]{1}}
  \proofstepwidestar[1]{0_R\in R}{\rAEa{2}}
  \proofstepwidestar[1]{%
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{%
    \rAEb{2}}
  \proofstepwidestar[1]{%
    ...
    \FormulaRefAuto{RecFunSurjectiveIffInductionPrinciple}[thm]{3,4}}
  \proofstepwidestar[1]{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}
    =
    \RecFun{0_R}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{%
    ...
    \SemiringSuccessor{R,\oplus,\odot,0_R,1_R}\colon R\to R}{%
    \FormulaRefAuto{NaturalSemiringRecursionData}[thm]{1}}
  \proofstepwidestar[1]{0_R\in R}{\rAEa{4}}
  \proofstepwidestar[1,2,3]{%
    \RecFun{0_R}
      {\SemiringSuccessor{R,\oplus,\odot,0_R,1_R}}
      \colon\mathbb N\inj R}{%
      \FormulaRefAuto{%
        ...
        \vdash \RecFun{m_0}{f}\colon\mathbb{N}\inj M}[thm]{5,2,3}}
  \proofstepwidestar[1]{%
    \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}
    =
    \RecFun{0_R}
