...
Die umgekehrte Richtung ist unmittelbar: Ein Isomorphismus
\(f\colon A\to B\) induziert durch \(F(X)=f[X]\) einen Isomorphismus der
Potenzhalbgruppen. Die eingerahmte Richtung wird bewusst weder als Axiom noch
als Theorem registriert.
