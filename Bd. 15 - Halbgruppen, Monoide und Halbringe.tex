...
Im folgenden Beweis schreiben wir \(h:=g\circ f\).
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{h\colon A\to C}{%
  ...
  \proofstepwidestar[1,2,6,7]{%
    g(f(x\star y))=g(f(x)\diamond f(y))}{\rIE{8}}
  \proofstepwidestar[1,2,6,7]{%
    g(f(x)\diamond f(y))=g(f(x))\bullet g(f(y))}{%
    \parbox[t]{.14\textwidth}{\raggedright
      \FormulaRefAuto{SemigroupHomOperationAxiom}[ax]\\
      mit den Schritten \(2,3,6,7\)}}
  \proofstepwidestar[1,2,6,7]{%
    h(x\star y)=h(x)\bullet h(y)}{%
    \parbox[t]{.14\textwidth}{\raggedright
      \FormulaRefAuto{x\in A \vdash (G\circ F)(x)=G(F(x))}\\
      mit \FormulaRefAuto{SemigroupClosureAxiom}[ax]\\
      sowie den Schritten \(9\) und \(10\)}}
  \proofstepwidestar[1]{\SemigroupAlg{A}{\star}}{%
    \FormulaRefAuto{SemigroupHomDef}[def]{1}}
  \proofstepwidestar[2]{\SemigroupAlg{C}{\bullet}}{%
    \FormulaRefAuto{SemigroupHomDef}[def]{2}}
  \proofstepwidestar[1,2]{%
    \SemigroupHom{h}{A,\star}{C,\bullet}}{%
    \FormulaRefAuto{SemigroupHomDef}[def]{12,13,5,11}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[1,2,3]{%
      ...
      \oplus
      \NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)}{%
      \FormulaRefAuto{PeanoInductionRule}[thm]{IA,IS,3,1,2}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Eindeutigkeit auf jedem natürlichen Argument]{%
    ...
    \proofstepwidestar[1,2,3]{%
      f(n)=\NaturalSemiringMap{R,\oplus,\odot,0_R,1_R}(n)}{%
      \FormulaRefAuto{PeanoInductionRule}[thm]{5,12,13}}
  \closeproofpartwideindR
