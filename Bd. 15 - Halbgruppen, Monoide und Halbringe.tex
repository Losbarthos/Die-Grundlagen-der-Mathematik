...
Für den Induktionsschluss bezeichnet
\[
  P_+(k)\;:\!\Longleftrightarrow\;
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[2]{m\in\mathbb N}{\rA}
    \proofstepwidestar[3]{n\in\mathbb N}{\rA}
    \proofstepwidestar[1,2]{P_+(0)}{%
      \FormulaRefAuto{NaturalSemiringMapAdditionZero}[thm]{1,2}}
    \proofstepwidestar[5]{k\in\mathbb N}{\rA}
    \proofstepwidestar[6]{P_+(k)}{\rA}
    \proofstepwidestar[1,2,5,6]{P_+(\Succ(k))}{%
      \FormulaRefAuto{NaturalSemiringMapAdditionStep}[thm]{1,2,5,6}}
    \proofstepwidestar[1,2,5]{P_+(k)\rightarrow P_+(\Succ(k))}{%
      \rII{6,7}}
    \proofstepwidestar[1,2]{%
      k\in\mathbb N\rightarrow
      \bigl(P_+(k)\rightarrow P_+(\Succ(k))\bigr)}{%
      \rRI{5,8}}
    \proofstepwidestar[1,2]{%
      \forall k\in\mathbb N\,
      \bigl(P_+(k)\rightarrow P_+(\Succ(k))\bigr)}{\rUI{9}}
    \proofstepwidestar[1,2]{\forall k\in\mathbb N\,P_+(k)}{%
      \FormulaRefAuto{PeanoInductionAxiom}[ax]{4,10}}
    \proofstepwidestar[1,2,3]{%
...
Für den Induktionsschluss bezeichnet
\[
  P_{\cdot}(k)\;:\!\Longleftrightarrow\;
  \eta_R(m\cdot k)=\eta_R(m)\odot\eta_R(k).
\]
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktionsanfang]{%
    \begin{aligned}[t]
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2,3]{%
      x\odot(y\oplus1_R)=(x\odot y)\oplus(x\odot1_R)}{%
      \FormulaRefAuto{SemiringLeftDistributiveAxiom}[ax]{1,7,8,10}}
    \proofstepwidestar[1,2,3]{%
      (x\odot y)\oplus(x\odot1_R)=x\odot(y\oplus1_R)}{%
    ...
    \proofstepwide[2,3]{%
      \eta_R(m\cdot\Succ(n))}{=}{\eta_R(m\cdot n+m)}{%
    ...
    \proofstepwide[1,2,3,4]{}{=}{(x\odot y)\oplus x}{\rIE{4}}
    \proofstepwide[1,2,3,4]{}{=}{%
      (x\odot y)\oplus(x\odot1_R)}{\rIE{12}}
    \proofstepwide[1,2,3,4]{}{=}{x\odot(y\oplus1_R)}{\rIE{14}}
  ...
  \proofpartwide{Induktionsschluss}
    ...
    \proofstepwidestar[2]{m\in\mathbb N}{\rA}
    \proofstepwidestar[3]{n\in\mathbb N}{\rA}
    \proofstepwidestar[1,2]{P_{\cdot}(0)}{%
      \FormulaRefAuto{NaturalSemiringMapMultiplicationZero}[thm]{1,2}}
    \proofstepwidestar[5]{k\in\mathbb N}{\rA}
    \proofstepwidestar[6]{P_{\cdot}(k)}{\rA}
    \proofstepwidestar[1,2,5,6]{P_{\cdot}(\Succ(k))}{%
      \FormulaRefAuto{NaturalSemiringMapMultiplicationStep}[thm]{1,2,5,6}}
    \proofstepwidestar[1,2,5]{%
      P_{\cdot}(k)\rightarrow P_{\cdot}(\Succ(k))}{%
      \rII{6,7}}
    \proofstepwidestar[1,2]{%
      k\in\mathbb N\rightarrow
      \bigl(P_{\cdot}(k)\rightarrow P_{\cdot}(\Succ(k))\bigr)}{%
      \rRI{5,8}}
    \proofstepwidestar[1,2]{%
      \forall k\in\mathbb N\,
      \bigl(P_{\cdot}(k)\rightarrow P_{\cdot}(\Succ(k))\bigr)}{\rUI{9}}
    \proofstepwidestar[1,2]{\forall k\in\mathbb N\,P_{\cdot}(k)}{%
      \FormulaRefAuto{PeanoInductionAxiom}[ax]{4,10}}
    \proofstepwidestar[1,2,3]{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Widerspruch zum Nullaxiom]{%
    ...
    \proofstepwidestar[]{%
      \neg\exists n\in\mathbb{N}\,(1+n=0)}{\rCI{1,10}}
  \closeproofpartwideindR
\end{tabproofsplitwide}
