...
Die folgenden Begriffe sind rein injektiver Natur und stehen deshalb bereits
hier statt erst im Frankl-Band. Band~06 ist der frühestmögliche Ort für ihre
Formulierung, da sie den allgemeinen Funktionsbegriff aus Band~05 und den
Injektivitätsbegriff dieses Bandes voraussetzen.
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{X=Y}{%
    \FormulaRefAuto{a\notin X\dsep a\notin Y\dsep
    X\cup\{a\}=Y\cup\{a\}\vdash X=Y}{4,5,10}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{\tFranklAdj{M}{a}(X)\in
    \FamContaining{M}{a}}{\rIE{10,9}}
\end{tabproof}
...
\FormulaDefDeltaK[Adjunktionsabbildung zur Einermenge]{%
  \begin{aligned}[t]
    ...
    &\FranklAdj{M}{a}\coloneqq \iota J\Bigl(
      \begin{aligned}[t]
        &J\colon \FamAvoiding{M}{a}\to \FamContaining{M}{a}\land{}\\[-2pt]
        &\forall X\in \FamAvoiding{M}{a}\,
          J(X)=\tFranklAdj{M}{a}(X)
      \end{aligned}
    \Bigr)
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\FranklAdj{M}{a}\colon
    \FamAvoiding{M}{a}\to \FamContaining{M}{a}}{%
    \rAEa{\FormulaRefAuto{Adjunktionsabbildung einer Mengenfamilie}[def]{1,2}}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{%
    ...
    \rAEb{\FormulaRefAuto{Adjunktionsabbildung einer Mengenfamilie}[def]{1,2}}}
  \proofstep{1,2,3}{\FranklAdj{M}{a}(X)=
    \tFranklAdj{M}{a}(X)}{\rUE{4}}
\end{tabproof}
...
\begin{tabproof}
  ...
  \proofstep{1,2,4,5,6}{%
    \tFranklAdj{M}{a}(X)=\tFranklAdj{M}{a}(Y)}{%
    \FormulaRefAuto{a = b,\, b = c \vdash a = c}{10,8}}
  \proofstep{1,2,4,5,6}{X=Y}{%
    \FormulaRefAuto{X\in \FamAvoiding{M}{a}\dsep
    Y\in \FamAvoiding{M}{a}\dsep
    \tFranklAdj{M}{a}(X)=\tFranklAdj{M}{a}(Y)
    \vdash X=Y}{4,5,11}}
