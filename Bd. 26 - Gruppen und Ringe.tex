...
\title{Bd. 26 - Gruppen und Ringe}
\author{Martin Kunze}
\date{}
\setcounter{file}{26}

\hypersetup{
  pdftitle={Bd. 26 - Gruppen und Ringe},
  pdfauthor={Martin Kunze}
}

\begin{document}

\newcommand{\BandXXVIProofRefStack}[1]{%
...
Die Bände~15--23 entwickeln Halbgruppen und ihre Spezialisierungen,
Band~24 Monoide und Band~25 Halbringe.
...
der ganzen Zahlen aus Band~13 verallgemeinert: Jedes kommutative kürzbare
...
Wie in den Bänden~15--17 gehört jede Operation obligatorisch zur
...
\(\star\) kürzbar. Die Konstruktion aus Band~13 wird nun mit der
...
\FormulaDefDeltaK[Funktionsvorschrift der kanonischen Einbettung]{%
  \begin{aligned}[t]
    &\CommutativeMonoidAlg{M}{\star}{e}\dsep
      \mathsf{K\ddot{u}rz}(M,\star)\dsep a\in M\vdash{}\\[-2pt]
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{\GroupCompletionEmbed{M,\star,e}(a)
    =\FormalDifferenceClass{M,\star,e}{a}{e}}{%
    \FormulaRefAuto{GroupCompletionEmbeddingDef}[def]{1,2,3}}
  \proofstep{1,2,3}{\GroupCompletionEmbed{M,\star,e}(a)
    \in\GroupCompletionCarrier{M,\star,e}}{\rIE{7,6}}
  \proofstep{1,2}{\GroupCompletionEmbed{M,\star,e}\colon
    M\to\GroupCompletionCarrier{M,\star,e}}{%
    \FormulaRefAuto{x\in A\vdash t(x)\coloneq y\dsep
      x\in A\vdash t(x)\in B
      \exists! F\colon A\to B\,\forall x\in A\,F(x)=t(x)}{3,8}}
\end{tabproof}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3]{%
    ...
    \end{aligned}}{%
    \FormulaRefAuto{GroupCompletionEmbeddingDef}[def]{1,2,5}}
  \proofstepwidestar[1,2,3]{%
    \begin{aligned}[t]
      &\GroupCompletionEmbed{M,\star,e}(a)
        \GroupCompletionOp{M,\star,e}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{\GroupCompletionEmbed{M,\star,e}(e)
    =\FormalDifferenceClass{M,\star,e}{e}{e}}{%
    \FormulaRefAuto{GroupCompletionEmbeddingDef}[def]{1,2,4}}
  \proofstep{1,2}{\GroupCompletionZero{M,\star,e}
    =\FormalDifferenceClass{M,\star,e}{e}{e}}{%
    \FormulaRefAuto{GroupCompletionZeroDef}[def]{1,2}}
  \proofstep{1,2}{\GroupCompletionEmbed{M,\star,e}(e)
    =\GroupCompletionZero{M,\star,e}}{\rIE{5,6}}
\end{tabproof}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Gleichheitsreflexion]{%
    ...
    \proofstepwidestar[1,2,3,4]{%
      ...
      \rIE{\FormulaRefAuto{GroupCompletionEmbeddingDef}[def]{1,2,3},4}}
    \proofstepwidestar[1]{\MonoidAlg{M}{\star}{e}}{%
      \FormulaRefAuto{CommutativeMonoidBaseMonoidAxiom}[ax]{1}}
    \proofstepwidestar[1]{e\in M}{%
      \FormulaRefAuto{MonoidIdentityCarrierAxiom}[ax]{6}}
    \proofstepwidestar[1,2,3,4]{a\star e=e\star b}{%
      \FormulaRefAuto{GroupCompletionClassEquality}{1,2,3,7,5}}
    \proofstepwidestar[1,3]{a\star e=a}{%
      \FormulaRefAuto{MonoidRightIdentityAxiom}[ax]{6,3}}
    \proofstepwidestar[1,3]{e\star b=b}{%
      \FormulaRefAuto{MonoidLeftIdentityAxiom}[ax]{6,3}}
    \proofstepwidestar[1,2,3,4]{a=b}{\rIE{9,10,8}}
  \closeproofpartwideindR
...
aus Band~25 zur Verfügung. Ein Differenzenpaar \((a,b)\) soll auf die
