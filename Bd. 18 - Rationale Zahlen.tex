...
\begin{tabproofsplitwide}
  \proofpartwideindR[Positiver Normalformfall]{%
    \begin{aligned}[t]
      &b\in\PositiveIntegers\dsep n\in\mathbb N\dsep
        b=\IntEmbed(n)\vdash{}\\
      &\IntOne\leq b
    \end{aligned}
  }{%
    b\in\PositiveIntegers\dsep n\in\mathbb N\dsep
    b=\IntEmbed(n)\vdash\IntOne\leq b
  }[PositiveIntegerOneLowerBoundPositiveCase]
    \proofstepwidestarbreakkeep[1]{b\in\PositiveIntegers}{\rA}
    \proofstepwidestarbreakkeep[2]{n\in\mathbb N}{\rA}
    \proofstepwidestarbreakkeep[3]{b=\IntEmbed(n)}{\rA}
    \proofstepwidestarbreakkeep[1]{b\neq\IntZero}{%
      \FormulaRefAuto{PositiveIntegerNonzero}[thm]{1}}
    \proofstepwidestarbreakkeep[2,3,4]{n\neq0}{%
      \FormulaRefAuto{NaturalIntegerEmbeddingInjective}[thm]{%
        \FormulaRefAuto{PeanoZero}[ax],2,%
        \rRI{n=0,\rIE{3,\FormulaRefAuto{IntegerZeroDef}[def]}}}}
    \proofstepwidestarbreakkeep[2,5]{\exists k\in\mathbb N\,(n=\Succ(k))}{%
      \FormulaRefAuto{PeanoNonzeroIsSucc}[ax]{2,5}}
    \proofstepwidestarbreakkeep[7]{k\in\mathbb N\land n=\Succ(k)}{\rA}
    \proofstepwidestarbreakkeep[7]{1+k=\Succ(k)}{%
      \rIE{\FormulaRefAuto{PeanoAddCommutative}[thm]{%
          \FormulaRefAuto{PeanoOneInN}[thm],\rAEa{7}},%
        \FormulaRefAuto{PeanoAddOneSucc}[thm]{\rAEa{7}}}}
    \proofstepwidestarbreakkeep[7]{1\leq n}{%
      \FormulaRefAuto{NaturalOrderAdditiveCharacterization}[thm]{%
        \FormulaRefAuto{PeanoOneInN}[thm],\rAEb{\rAEa{7}},%
        \rEI{\rAI{\rAEa{7},\rIE{8,\rAEb{7}}}}}}
    \proofstepwidestarbreakkeep[2,7]{\IntEmbed(1)\leq\IntEmbed(n)}{%
      \FormulaRefAuto{IntegerOrderClassChar}[thm]{%
        \FormulaRefAuto{PeanoOneInN}[thm],2,9}}
    \proofstepwidestarbreakkeep[1,2,3]{\IntOne\leq b}{%
      \rEE{6,7,\rIE{10,3,\FormulaRefAuto{IntegerOneDef}[def]}}}
  \closeproofpartwideindR

  \proofpartwideindR[Negativer Normalformfall ist ausgeschlossen]{%
    \begin{aligned}[t]
      &b\in\PositiveIntegers\dsep n\in\mathbb N\dsep
        b=-\IntEmbed(n)\vdash{}\\
      &\IntOne\leq b
    ...
    b\in\PositiveIntegers\dsep n\in\mathbb N\dsep
    b=-\IntEmbed(n)\vdash\IntOne\leq b
  }[PositiveIntegerOneLowerBoundNegativeCase]
    \proofstepwidestarbreakkeep[1]{b\in\PositiveIntegers}{\rA}
    \proofstepwidestarbreakkeep[2]{n\in\mathbb N}{\rA}
    \proofstepwidestarbreakkeep[3]{b=-\IntEmbed(n)}{\rA}
    \proofstepwidestarbreakkeep[1]{\IntZero\leq b}{%
      \rAEa{\FormulaRefAuto{IntegerStrictOrderDef}[def]{%
        \rAEb{\FormulaRefAuto{PositiveIntegersDef}[def]{1}}}}}
    \proofstepwidestarbreakkeep[2]{-\IntEmbed(n)=\IntClass{0}{n}}{%
      \FormulaRefAuto{IntegerNegationDef}[def]{%
        2,\FormulaRefAuto{NaturalIntegerEmbeddingValue}[thm]{2}}}
    \proofstepwidestarbreakkeep[2,3,4]{n\leq0}{%
      \FormulaRefAuto{IntegerOrderClassChar}[thm]{%
        \FormulaRefAuto{PeanoZero}[ax],2,4,5,%
        \FormulaRefAuto{IntegerZeroClass}[thm]}}
    \proofstepwidestarbreakkeep[2]{0\leq n}{\FormulaRefAuto{PeanoZeroLeq}[thm]{2}}
    \proofstepwidestarbreakkeep[2,6,7]{n=0}{%
      \FormulaRefAuto{m\in\mathbb{N}\dsep n\in\mathbb{N}\dsep
        m\leq n\dsep n\leq m\vdash m=n}{%
        2,\FormulaRefAuto{PeanoZero}[ax],6,7}}
    \proofstepwidestarbreakkeep[2,3,5,8]{b=\IntZero}{%
      \rIE{3,5,8,\FormulaRefAuto{IntegerZeroDef}[def],%
        \FormulaRefAuto{IntegerNegativeZero}[thm]}}
    \proofstepwidestarbreakkeep[1,9]{\bot}{%
      \FormulaRefAuto{PositiveIntegerNonzero}[thm]{1,9}}
    \proofstepwidestarbreakkeep[1,2,3]{\IntOne\leq b}{%
      \FormulaRefAuto{\bot\vdash P}{10}}
  \closeproofpartwideindR

  \proofpartwide{Schluss}
    \proofstepwidestarbreakkeep[1]{b\in\PositiveIntegers}{\rA}
    \proofstepwidestarbreakkeep[1]{b\in\mathbb Z}{%
      \rAEa{\FormulaRefAuto{PositiveIntegersDef}[def]{1}}}
    \proofstepwidestarbreakkeep[1]{\exists n\in\mathbb N\,
      (b=\IntEmbed(n)\lor b=-\IntEmbed(n))}{%
      \FormulaRefAuto{IntegerSignedNormalForm}[thm]{2}}
    \proofstepwidestarbreakkeep[4]{n\in\mathbb N\land
      (b=\IntEmbed(n)\lor b=-\IntEmbed(n))}{\rA}
    \proofstepwidestarbreakkeep[1,4]{b=\IntEmbed(n)\to\IntOne\leq b}{%
      \rRI{\rAEa{\rAEb{4}},%
        \FormulaRefAuto{PositiveIntegerOneLowerBoundPositiveCase}{%
          1,\rAEa{4},\rAEa{\rAEb{4}}}}}
    \proofstepwidestarbreakkeep[1,4]{b=-\IntEmbed(n)\to\IntOne\leq b}{%
      \rRI{\rAEb{\rAEb{4}},%
        \FormulaRefAuto{PositiveIntegerOneLowerBoundNegativeCase}{%
          1,\rAEa{4},\rAEb{\rAEb{4}}}}}
    \proofstepwidestarbreakkeep[1,4]{\IntOne\leq b}{%
      \rOE{\rAEb{4},5,6}}
    \proofstepwidestarbreakkeep[1]{\IntOne\leq b}{\rEE{3,4,7}}
  \closeproofpartwide
...
\(\RatOfNat{n}\).  Dies ist eine typisierte Schreibkonvention und keine
Mengeninklusion.  Wo der umgebende Träger den Typ nicht eindeutig bestimmt,
bleiben \(\RatOfInt{z}\) beziehungsweise \(\RatOfNat{n}\) ausdrücklich
sichtbar.  Insbesondere stehen \(\RatZero,\RatOne,\RatNumeral{2},
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2]{\RatClass{a}{b},\RatClass{c}{d}\in\mathbb Q}{%
    \rAI{\FormulaRefAuto{RationalClassInQ}[thm]{1,2},%
      \FormulaRefAuto{RationalClassInQ}[thm]{1,2}}}
  ...
  \proofstepwidestarbreakkeep[4,5]{\RatClass{a d+c b}{b d}\in\mathbb Q}{%
    \FormulaRefAuto{RationalClassInQ}[thm]{%
      \FormulaRefAuto{IntAddClosure}[thm]{%
        ...
        \FormulaRefAuto{IntMulClosure}[thm]{4,5}},%
      \FormulaRefAuto{PositiveIntegerMulClosure}[thm]{4,5}}}
  \proofstepwidestarbreakkeep[4,5]{q+r\in\mathbb Q}{\rIE{6,7}}
  \proofstepwidestarbreakkeep[1]{q+r\in\mathbb Q}{\rEE{2,4,\rEE{3,5,8}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{a\cdot c,a'\cdot c'\in\mathbb Z}{%
    \rAI{\FormulaRefAuto{IntMulClosure}[thm]{1},%
      \FormulaRefAuto{IntMulClosure}[thm]{1}}}
  \proofstepwidestarbreakkeep[2]{b\cdot d,b'\cdot d'\in\PositiveIntegers}{%
    \rAI{\FormulaRefAuto{PositiveIntegerMulClosure}[thm]{2},%
      \FormulaRefAuto{PositiveIntegerMulClosure}[thm]{2}}}
  \proofstepwidestarbreakkeep[1,2,3,4]{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{z\cdot\IntZero\in\mathbb Z}{%
    \FormulaRefAuto{IntegerMulClosureAxiom}[ax]{%
      1,\FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}}
  \proofstepwidestarbreakkeep[]{\IntZero+\IntZero=\IntZero}{%
    \rAEa{\FormulaRefAuto{IntegerAddZeroAxiom}[ax]{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}}}
  \proofstepwidestarbreakkeep[1]{z\cdot\IntZero
    =z\cdot\IntZero+z\cdot\IntZero}{%
    \rIE{3,\FormulaRefAuto{IntegerMulLeftDistributiveAxiom}[ax]{%
      1,\FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}}}
  \proofstepwidestarbreakkeep[1]{-(z\cdot\IntZero)
  ...
  \proofstepwidestarbreakkeep[1]{-(z\cdot\IntZero)
    +(z\cdot\IntZero+z\cdot\IntZero)
    =z\cdot\IntZero}{%
    \FormulaRefAuto{IntegerAddAssociativeAxiom}[ax]{%
      \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{2},2},%
    \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{2},%
    \FormulaRefAuto{IntegerAddZeroAxiom}[ax]{2}}
  \proofstepwidestarbreakkeep[1]{z\cdot\IntZero=\IntZero}{%
    \rIE{4,5,6}}
  \proofstepwidestarbreakkeep[1]{\IntZero\cdot z=z\cdot\IntZero}{%
    \FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax],1}}
  \proofstepwidestarbreakkeep[1]{\IntZero\cdot z=\IntZero}{\rChain{8,7}}
  \proofstepwidestarbreakkeep[1]{z\cdot\IntZero=\IntZero\land
    \IntZero\cdot z=\IntZero}{\rAI{7,9}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[5]{%
    ...
    \FormulaRefAuto{IntMulLeftDistributive}[thm],%
    \FormulaRefAuto{IntMulRightDistributive}[thm]}
  \proofstepwidestarbreakkeep[5]{(p+q)+r=p+(q+r)}{\rIE{5,6}}
  \proofstepwidestarbreakkeep[1]{(p+q)+r=p+(q+r)}{\rEE{2,3,4,5,7}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[5]{%
    ...
    \FormulaRefAuto{IntMulAssociative}[thm],%
    \FormulaRefAuto{IntMulCommutative}[thm]}
  \proofstepwidestarbreakkeep[5]{p\cdot(q+r)=p\cdot q+p\cdot r}{\rIE{5,6}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,8]{\IntZero<-a}{%
    \FormulaRefAuto{IntegerOrderTranslationEquivalenceAxiom}[ax]{%
      1,\FormulaRefAuto{IntegerZeroCarrierAxiom}[ax],%
      \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{1},8},%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,2,3,4,5]{%
    ...
    \FormulaRefAuto{IntegerOrderTotalAxiom}[ax],%
    \FormulaRefAuto{IntegerPositiveFactorOrderAxiom}[ax]{1,2},%
    \FormulaRefAuto{IntegerPositiveFactorCancellationFromAxioms}[thm]{1,2,6}}
  \proofstepwidestarbreakkeep[8]{\IntZero<a\land\IntZero<c}{\rA}
  \proofstepwidestarbreakkeep[1,2,5,8]{\RatRecipRep{a}{b}
    =\RatRecipRep{c}{d}}{%
    \FormulaRefAuto{RationalReciprocalRepresentativeDef}[def]{1,2,8},%
    \FormulaRefAuto{RationalClassEquality}[thm]{1,2,%
      \rIE{6,\FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{1}}}}
  \proofstepwidestarbreakkeep[10]{a<\IntZero\land c<\IntZero}{\rA}
  \proofstepwidestarbreakkeep[1,2,5,10]{\RatRecipRep{a}{b}
    =\RatRecipRep{c}{d}}{%
    \FormulaRefAuto{RationalReciprocalRepresentativeDef}[def]{1,2,10},%
    \FormulaRefAuto{RationalClassEquality}[thm]{1,2,6},%
    \FormulaRefAuto{IntegerNegClosureAxiom}[ax]{1},%
    \FormulaRefAuto{IntegerMulAssociativeAxiom}[ax]{1},%
    \FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{1},%
    \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{1}}
  \proofstepwidestarbreakkeep[1,2,3,4,5]{\RatRecipRep{a}{b}
    =\RatRecipRep{c}{d}}{\rOE{7,8,9,10,11}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[4,5]{\RatClass{a}{b}\cdot\RatRecipRep{a}{b}
    =\RatOne}{%
    \FormulaRefAuto{RationalReciprocalRepresentativeDef}[def]{4,5},%
    \FormulaRefAuto{RationalMultiplicationClassValue}[thm]{4},%
    \FormulaRefAuto{RationalClassEquality}[thm]{4},%
    \FormulaRefAuto{RationalZeroOneClasses}[thm],%
    \FormulaRefAuto{IntegerMulAssociativeAxiom}[ax]{4},%
    \FormulaRefAuto{IntegerMulCommutativeAxiom}[ax]{4},%
    \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{4}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[5]{\RatClass{c}{d}\leq\RatClass{e}{f}
    ...
    \FormulaRefAuto{IntegerPositiveFactorOrderAxiom}[ax]{5},%
    \FormulaRefAuto{IntegerMulLeftDistributiveAxiom}[ax]{5},%
    \FormulaRefAuto{IntegerMulRightDistributiveAxiom}[ax]{5}}
  \proofstepwidestarbreakkeep[5]{q\leq r\leftrightarrow p+q\leq p+r}{\rIE{5,6}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[6]{a,c\in\mathbb Z\land b,d\in\PositiveIntegers
    \land q=\RatClass{a}{b}\land r=\RatClass{c}{d}}{\rA}
  \proofstepwidestarbreakkeep[2,3,6]{\IntZero\leq a
    \land\IntZero\leq c}{%
    \FormulaRefAuto{RationalOrderClassChar}[thm]{6},%
    \FormulaRefAuto{RationalZeroOneClasses}[thm],%
    \FormulaRefAuto{IntegerMulOneAxiom}[ax]{6},%
    \FormulaRefAuto{IntegerMulZeroFromAxioms}[thm]{6}}
  \proofstepwidestarbreakkeep[6,7]{\IntZero\leq a\cdot c}{%
    \FormulaRefAuto{IntegerPositiveProductAxiom}[ax]{6},%
    \FormulaRefAuto{IntegerStrictOrderDef}[def]{6},%
    \FormulaRefAuto{IntegerMulZeroFromAxioms}[thm]{6},%
    \FormulaRefAuto{IntegerOrderReflexiveAxiom}[ax]{%
      \FormulaRefAuto{IntegerZeroCarrierAxiom}[ax]}}
  \proofstepwidestarbreakkeep[6,8]{\RatZero
  ...
  \proofstepwidestarbreakkeep[2,3,6]{\RatZero\leq q\cdot r}{\rIE{9,10}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[7]{p\cdot q=\RatClass{a c}{b d}
    ...
    \rAI{\FormulaRefAuto{RationalMultiplicationClassValue}[thm]{7},%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[2,4]{\IntZero<a}{%
    \FormulaRefAuto{RationalStrictOrderClassChar}[thm]{4,2},%
    \FormulaRefAuto{RationalZeroOneClasses}[thm],%
    \FormulaRefAuto{IntegerMulOneAxiom}[ax]{4},%
    \FormulaRefAuto{IntegerMulZeroFromAxioms}[thm]{4}}
  \proofstepwidestarbreakkeep[4,5]{a\neq\IntZero}{%
    \rAEb{\FormulaRefAuto{IntegerStrictOrderDef}[def]{4,5}}}
  \proofstepwidestarbreakkeep[4,5]{q^{-1}=\RatClass{b}{a}}{%
    \rIE{\rAEb{\rAEb{4}},%
      \FormulaRefAuto{RationalReciprocalClassValue}[thm]{4,6},%
      \FormulaRefAuto{RationalReciprocalRepresentativeDef}[def]{4,5}}}
  \proofstepwidestarbreakkeep[4,5]{\RatZero<\RatClass{b}{a}}{%
    \FormulaRefAuto{RationalStrictOrderClassChar}[thm]{4,5},%
    \FormulaRefAuto{RationalZeroOneClasses}[thm],%
    \FormulaRefAuto{IntegerPositiveProductAxiom}[ax]{4,5},%
    \FormulaRefAuto{IntegerMulOneAxiom}[ax]{4},%
    \FormulaRefAuto{IntegerMulZeroFromAxioms}[thm]{4}}
  \proofstepwidestarbreakkeep[2,4]{\RatZero<q^{-1}}{\rIE{7,8}}
  \proofstepwidestarbreakkeep[1,2]{\RatZero<q^{-1}}{\rEE{3,4,9}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1]{\RatEmbed(z)=\RatClass{z}{\IntOne}
    ...
    \rAI{\FormulaRefAuto{IntegerRationalEmbedding}[def]{\rAEa{1}},%
      \FormulaRefAuto{IntegerRationalEmbedding}[def]{\rAEb{1}}}}
...
Eigenschaften von Bruchpaaren mehr vorausgesetzt.  Die folgenden beiden
...
\FormulaThmDeltaK[Ganzzahlschranke für positive Nenner im Modell]{%
  a\in\mathbb Z\dsep b\in\PositiveIntegers\vdash
...
\begin{tabproofwide}
  \proofstepwidestarbreakkeep[1]{a\in\mathbb Z}{\rA}
  \proofstepwidestarbreakkeep[2]{b\in\PositiveIntegers}{\rA}
  \proofstepwidestarbreakkeep[1]{\exists m\in\mathbb N\,
    (a=\IntEmbed(m)\lor a=-\IntEmbed(m))}{%
    \FormulaRefAuto{IntegerSignedNormalForm}[thm]{1}}
  \proofstepwidestarbreakkeep[4]{m\in\mathbb N\land
    (a=\IntEmbed(m)\lor a=-\IntEmbed(m))}{\rA}
  \proofstepwidestarbreakkeep[4]{\Succ(m)\in\mathbb N}{%
    \FormulaRefAuto{PeanoSuccClosure}[ax]{\rAEa{4}}}
  \proofstepwidestarbreakkeep[2]{\IntOne\leq b}{%
    \FormulaRefAuto{PositiveIntegerOneLowerBound}[thm]{2}}
  \proofstepwidestarbreakkeep[2,4]{a<\IntEmbed(\Succ(m))}{%
    \FormulaRefAuto{IntegerSuccessorPositiveAxiom}[ax]{\rAEa{4}},%
    \FormulaRefAuto{IntegerOrderTranslationEquivalenceAxiom}[ax],%
    \FormulaRefAuto{IntegerOrderTotalAxiom}[ax],%
    \FormulaRefAuto{IntegerAddInverseAxiom}[ax]{1}}
  \proofstepwidestarbreakkeep[2,4]{\IntEmbed(\Succ(m))
    \leq\IntEmbed(\Succ(m))\cdot b}{%
    \FormulaRefAuto{IntegerPositiveFactorOrderAxiom}[ax]{%
      \FormulaRefAuto{IntegerOnePositiveAxiom}[ax],2,6},%
    \FormulaRefAuto{IntegerMulOneAxiom}[ax]{%
      \FormulaRefAuto{NaturalIntegerEmbeddingFunction}[thm]{5}}}
  \proofstepwidestarbreakkeep[1,2,4]{a<\IntEmbed(\Succ(m))\cdot b}{%
    \FormulaRefAuto{IntegerOrderTransitiveAxiom}[ax]{1,7,8},%
    \FormulaRefAuto{IntegerStrictOrderDef}[def]{1,7}}
  \proofstepwidestarbreakkeep[1,2,4]{\exists n\in\mathbb N\,
    a<\IntEmbed(n)\cdot b}{\rEI{\rAI{5,9}}}
  \proofstepwidestarbreakkeep[1,2]{\exists n\in\mathbb N\,
    a<\IntEmbed(n)\cdot b}{\rEE{3,4,10}}
\end{tabproofwide}
...
Dichte und Archimedizität werden danach als Folgesätze bewiesen.
...
\FormulaDefDeltaK[Rationale Zahlen als erzeugter geordneter Körper]{%
  ...
  \DeltaRow{Assoziativ}{p,q,r\in\mathbb Q\vdash(p+q)+r=p+(q+r)}
  ...
  \DeltaRow{Assoziativ}{p,q,r\in\mathbb Q\vdash
  ...
  \DeltaRow{Distributiv}{p,q,r\in\mathbb Q\vdash
    p\cdot(q+r)=p\cdot q+p\cdot r}
  ...
  \DeltaRow{Translation}{p,q,r\in\mathbb Q\vdash
  ...
  \DeltaRow{\makecell[l]{Nichtnegative\\Produkte}}{\begin{aligned}[t]
    &q,r\in\mathbb Q\dsep\RatZero\leq q\dsep{}\\
  ...
  \DeltaRow{\makecell[l]{Positive\\Faktoren}}{\begin{aligned}[t]
    &p,q,r\in\mathbb Q\dsep q<r\dsep\RatZero<p\vdash{}\\
    &p\cdot q<p\cdot r
    \end{aligned}}
    [\FormulaRefAuto{RationalPositiveMulStrictOrderAxiom}[ax]]%
  \DeltaRow{\makecell[l]{Positive\\Kehrwerte}}{q\in\mathbb Q\dsep\RatZero<q
    \vdash\RatZero<q^{-1}}
    [\FormulaRefAuto{RationalPositiveReciprocalAxiom}[ax]]%
  \end{DeltaContext}
  \begin{DeltaContext}{ }%
  \DeltaRow{\makecell[l]{\textbf{Ganzzahl-}\\\textbf{einbettung}}}{}%
  ...
  \DeltaRow{Positive Nenner}{b\in\PositiveIntegers\vdash
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Hinrichtung]{%
    ...
    \proofstepwidestarbreakkeep[2,3]{q\neq\RatZero\land r\neq\RatZero}{%
      \rAI{%
        \FormulaRefAuto{a\neq b\vdash b\neq a}[thm]{%
          \FormulaRefAuto{RationalStrictOrderDef}[def]{2}},%
        \FormulaRefAuto{a\neq b\vdash b\neq a}[thm]{%
          \FormulaRefAuto{RationalStrictOrderDef}[def]{3}}}}
    ...
    \proofstepwidestarbreakkeep[1,2,3,4]{r<q}{%
      \rIE{9,%
  ...
  \proofpartwideindR[R\"uckrichtung]{%
    ...
    \proofstepwidestarbreakkeep[1,2,3]{%
      ...
      \rAI{%
        \FormulaRefAuto{RationalPositiveReciprocalAxiom}[ax]{\rAEa{1},2},%
        \FormulaRefAuto{RationalPositiveReciprocalAxiom}[ax]{\rAEb{1},3}}}
    \proofstepwidestarbreakkeep[1,2,3,4]{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[]{\RatOne+\RatOne\neq\RatZero}{%
    \FormulaRefAuto{RationalStrictOrderDef}[def]{4}}
  \proofstepwidestarbreakkeep[]{(\RatOne+\RatOne)^{-1}\in\mathbb Q}{%
    \FormulaRefAuto{RationalReciprocalClosureAxiom}[ax]{%
      \FormulaRefAuto{RationalAddClosureAxiom}[ax]{%
        \FormulaRefAuto{RationalOneCarrierAxiom}[ax]},5}}
  \proofstepwidestarbreakkeep[]{\RatZero
    <(\RatOne+\RatOne)^{-1}}{%
    \FormulaRefAuto{RationalPositiveReciprocalAxiom}[ax]{%
      \FormulaRefAuto{RationalAddClosureAxiom}[ax]{%
        \FormulaRefAuto{RationalOneCarrierAxiom}[ax]},4}}
  \proofstepwidestarbreakkeep[1]{(q+r)\cdot
    (\RatOne+\RatOne)^{-1}\in\mathbb Q}{%
    \FormulaRefAuto{RationalMulClosureAxiom}[ax]{%
      \FormulaRefAuto{RationalAddClosureAxiom}[ax]{1},6}}
  \proofstepwidestarbreakkeep[1,2]{q<(q+r)\cdot
    (\RatOne+\RatOne)^{-1}}{%
    \FormulaRefAuto{RationalOrderTranslationAxiom}[ax]{1,2},%
    \FormulaRefAuto{RationalPositiveMulStrictOrderAxiom}[ax]{1,2,7},%
    \FormulaRefAuto{RationalMulInverseAxiom}[ax]{5},%
    \FormulaRefAuto{RationalDistributiveAxiom}[ax]{1},%
    \FormulaRefAuto{RationalMulAssociativeAxiom}[ax]{1},%
    \FormulaRefAuto{RationalMulCommutativeAxiom}[ax]{1},%
    \FormulaRefAuto{RationalMulOneAxiom}[ax]{1},%
    \FormulaRefAuto{RationalAddAssociativeAxiom}[ax]{1},%
