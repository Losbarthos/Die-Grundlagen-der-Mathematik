...
\(n\neq0\), also ein Nachfolger. Die natürliche Ordnung und ihre in Band~17
...
\FormulaDefDeltaK[Ganzzahlige Einbettung]{%
  \begin{aligned}[t]
    ...
    &\forall z\in\mathbb Z\,
      \bigl(\RatEmbed(z)\coloneqq\RatClass{z}{1_{\mathbb Z}}\bigr)
  \end{aligned}%
...
\begin{tabproof}
  ...
  \proofstep{}{1_{\mathbb Z}\in\PositiveIntegers}{%
    \FormulaRefAuto{IntegerOnePositive}[thm]}
  \proofstep{1}{\RatClass{z}{1_{\mathbb Z}}\in\mathbb Q}{%
    \FormulaRefAuto{RationalClassInQ}[thm]{1,2}}
  \proofstep{}{%
    \forall z\in\mathbb Z\,
      \bigl(\RatClass{z}{1_{\mathbb Z}}\in\mathbb Q\bigr)}{%
    \rUI{\rRI{1,3}}}
\end{tabproof}
