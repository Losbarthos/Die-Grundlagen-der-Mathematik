...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Transitivität]{%
    ...
    \proofstepwidestar[2,3]{( x \geq y \leftrightarrow y \leq x )}{%
      \FormulaRefAuto{OrderDualRelation}[def]{2,3}}
    \proofstepwidestar[2,3,5]{y\leq x}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
        7,5}}
    \proofstepwidestar[3,4]{( y \geq z \leftrightarrow z \leq y )}{%
      \FormulaRefAuto{OrderDualRelation}[def]{3,4}}
    \proofstepwidestar[3,4,6]{z\leq y}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
        9,6}}
    \proofstepwidestar[1,2,3,4,5,6]{z\leq x}{%
      \FormulaRefAuto{EqRelTransitivity}[ax]{4,3,2,10,8}}
  ...
  \proofpartwideindR[Antisymmetrie]{%
    ...
    \proofstepwidestar[2,3,4]{y\leq x}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
        6,4}}
    \proofstepwidestar[2,3]{( y \geq x \leftrightarrow x \leq y )}{%
      \FormulaRefAuto{OrderDualRelation}[def]{3,2}}
    \proofstepwidestar[2,3,5]{x\leq y}{%
      \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
        8,5}}
    \proofstepwidestar[1,2,3,4,5]{x=y}{%
      \FormulaRefAuto{x\leq y \dsep y\leq x\vdash x=y}[ax]{9,7}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
\proofpartwide{Zugehörigkeit zur Teilmenge}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{( x \leq _ T y \leftrightarrow x \leq y )}{%
      \FormulaRefAuto{OrderRestrictionOperator}[def]{1,2}}
  \proofstepwidestar[1,2,4]{x\leq y}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      7,4}}
  \proofstepwidestar[2,3]{( y \leq _ T z \leftrightarrow y \leq z )}{%
      \FormulaRefAuto{OrderRestrictionOperator}[def]{2,3}}
  \proofstepwidestar[2,3,5]{y\leq z}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      9,5}}
  \proofstepwidestar[1,2,3,4,5]{x\leq z}{%
    \FormulaRefAuto{EqRelTransitivity}[ax]{6,8,10}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3]{x\leq y}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      5,3}}
  \proofstepwidestar[1,2]{( y \leq _ T x \leftrightarrow y \leq x )}{%
      \FormulaRefAuto{OrderRestrictionOperator}[def]{2,1}}
  \proofstepwidestar[1,2,4]{y\leq x}{%
    \FormulaRefAuto{P\leftrightarrow Q, P\vdash Q}{%
      7,4}}
  \proofstepwidestar[1,2,3,4]{x=y}{%
    \FormulaRefAuto{x\leq y \dsep y\leq x \vdash x=y}[ax]{6,8}}
\end{tabproofwide}
