...
\proofstep{1,2}{F\cup\{x\}\in\FinSubsets{M}\land F\subset F\cup\{x\}}{\rAI{11,16}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{\varnothing\in\powerset(A)}{%
    \FormulaRefAuto{x\in\powerset(A)\eqvdash x\subseteq A}[thm]{4}}
  \proofstepwidestar[]{\{\varnothing\}\subseteq\powerset(A)}{%
    \FormulaRefAuto{a\in B\vdash\{a\}\subseteq B}[thm]{5}}
  \proofstepwidestar[]{\powerset(A)=\{\varnothing\}\cup\PowNE{A}}{%
    \FormulaRefAuto{UnionWithRelativeRemainder}[thm]{6}}
  \proofstepwidestar[]{%
    \{\varnothing\}\cup\PowNE{A}=\PowNE{A}\cup\{\varnothing\}}{%
    \FormulaRefAuto{A\cup B=B\cup A}[thm]}
  % Die vier alten tag-Ziele im Einzelband bewahren: Auch spaetere externe
  % Satzverweise verwenden den gemeinsamen Hyperref-Ankerzaehler.
  \proofstepwidestar[]{%
    \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
    \powerset(A)=\PowNE{A}\cup\{\varnothing\}}{%
    \rChain{7,8}}
  \proofstepwidestar[]{\varnothing\notin\PowNE{A}}{%
    \FormulaRefAuto{a\notin A\setminus\{a\}}[thm]}
  \proofstepwidestar[1]{\Finite{\PowNE{A}}}{%
    \FormulaRefAuto{FiniteNonemptyPowerSet}[thm]{1}}
  \proofstepwidestar[1]{\FiniteCard(\PowNE{A})\in\mathbb N}{%
    \FormulaRefAuto{FiniteCardNatural}[thm]{11}}
  \proofstepwidestar[1]{%
    \NatSeg{\FiniteCard(\PowNE{A})}\EqCard\PowNE{A}}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{11}}
  \proofstepwidestar[1]{%
    \FiniteCard(\PowNE{A})\notin\NatSeg{\FiniteCard(\PowNE{A})}}{%
    \FormulaRefAuto{PeanoNatSegEndpointNotIn}[thm]{12}}
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &\NatSeg{\FiniteCard(\PowNE{A})}\cup\{\FiniteCard(\PowNE{A})\}\\[-2pt]
      &\qquad\EqCard\PowNE{A}\cup\{\varnothing\}
    \end{aligned}}{%
    \FormulaRefAuto{EqCardFreshAdjunction}[thm]{13,14,10}}
  \proofstepwidestar[1]{%
    \begin{aligned}[t]
      &\NatSeg{\FiniteCard(\PowNE{A})+1}={}\\[-2pt]
      &\qquad\NatSeg{\FiniteCard(\PowNE{A})}\cup\{\FiniteCard(\PowNE{A})\}
    \end{aligned}}{%
    \FormulaRefAuto{PeanoNatSegAddOne}[thm]{12}}
  \proofstepwidestar[1]{%
    \NatSeg{\FiniteCard(\PowNE{A})+1}\EqCard\PowNE{A}\cup\{\varnothing\}}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}[thm]{16},15}}
  \proofstepwidestar[1]{%
    \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
    \NatSeg{\FiniteCard(\PowNE{A})+1}\EqCard\powerset(A)}{%
    \rIE{\FormulaRefAuto{a=b\vdash b=a}[thm]{9},17}}
  \proofstepwidestar[1]{\Finite{\powerset(A)}}{%
    \FormulaRefAuto{FinitePowerSet}[thm]{1}}
  \proofstepwidestar[1,2,3]{\FiniteCard(\powerset(A))=2^n}{%
    \FormulaRefAuto{FinitePowerSetCardinality}[thm]{1,2,3}}
  \proofstepwidestar[1]{%
    \NatSeg{\FiniteCard(\powerset(A))}\EqCard\powerset(A)}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{19}}
  \proofstepwidestar[1,2,3]{%
    \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
    \NatSeg{2^n}\EqCard\powerset(A)}{%
    \rIE{20,21}}
  \proofstepwidestar[]{2\in\mathbb N}{%
    \FormulaRefAuto{PeanoTwoInN}[thm]}
  \proofstepwidestar[2]{2^n\in\mathbb N}{%
    \FormulaRefAuto{PeanoPowerClosure}[thm]{23,2}}
  \proofstepwidestar[1]{\FiniteCard(\PowNE{A})+1\in\mathbb N}{%
    \FormulaRefAuto{PeanoAddOneClosure}[thm]{12}}
  \proofstepwidestar[1,2,3]{%
    \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
    \FiniteCard(\PowNE{A})+1=2^n}{%
    \FormulaRefAuto{FiniteCardWitnessUnique}[thm]{25,24,18,22}}
  \proofstepwidestar[1]{\FiniteCard(\PowNE{A})+1\neq0}{%
    \FormulaRefAuto{PeanoAddOneNonzero}[thm]{12}}
  \proofstepwidestar[1,2,3]{2^n\neq0}{\rIE{26,27}}
  \proofstepwidestar[1,2,3]{2^n-1=\Pred(2^n)}{%
    \FormulaRefAuto{PeanoMinusOneNotation}[def]{24,28}}
  \proofstepwidestar[1]{%
    \bigl(\FiniteCard(\PowNE{A})+1\bigr)-1=\FiniteCard(\PowNE{A})}{%
    \FormulaRefAuto{PeanoAddOneMinusOne}[thm]{12}}
  \proofstepwidestar[1,2,3]{2^n-1=\FiniteCard(\PowNE{A})}{%
    \rIE{26,30}}
  \proofstepwidestar[1,2,3]{\FiniteCard(\PowNE{A})=2^n-1}{%
    \FormulaRefAuto{a=b\vdash b=a}[thm]{31}}
  \proofstepwidestar[1,2,3]{%
    \begin{aligned}[t]
      &\FiniteCard(\PowNE{A})+1=2^n\\[-2pt]
      &\qquad\land\FiniteCard(\PowNE{A})=2^n-1
    \end{aligned}}{\rAI{26,32}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwide{Kardinalzahlen der nichtleeren Potenzmengen}
    \proofstepwidestar[1]{\Finite{A}}{\rA}
    \proofstepwidestar[2]{\Finite{B}}{\rA}
    \proofstepwidestar[3]{\PowNE{A}\EqCard\PowNE{B}}{\rA}
    \proofstepwidestar[1]{\Finite{\PowNE{A}}}{%
      \FormulaRefAuto{FiniteNonemptyPowerSet}[thm]{1}}
    \proofstepwidestar[2]{\Finite{\PowNE{B}}}{%
      \FormulaRefAuto{FiniteNonemptyPowerSet}[thm]{2}}
    \proofstepwidestar[1]{\FiniteCard(\PowNE{A})\in\mathbb N}{%
      \FormulaRefAuto{FiniteCardNatural}[thm]{4}}
    \proofstepwidestar[2]{\FiniteCard(\PowNE{B})\in\mathbb N}{%
      \FormulaRefAuto{FiniteCardNatural}[thm]{5}}
    \proofstepwidestar[1]{%
      \NatSeg{\FiniteCard(\PowNE{A})}\EqCard\PowNE{A}}{%
      \FormulaRefAuto{FiniteCardCounts}[thm]{4}}
    \proofstepwidestar[2]{%
      \NatSeg{\FiniteCard(\PowNE{B})}\EqCard\PowNE{B}}{%
      \FormulaRefAuto{FiniteCardCounts}[thm]{5}}
    \proofstepwidestar[1,3]{%
      \NatSeg{\FiniteCard(\PowNE{A})}\EqCard\PowNE{B}}{%
      \FormulaRefAuto{EqCardTransitive}[thm]{8,3}}
    \proofstepwidestar[1,2,3]{%
      % Die beiden alten tag-Ziele auch in diesem Tabellenbeweis erhalten.
      \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
      \FiniteCard(\PowNE{A})=\FiniteCard(\PowNE{B})}{%
      \FormulaRefAuto{FiniteCardWitnessUnique}[thm]{6,7,10,9}}
  \closeproofpartwide

  \proofpartwide{Gleichheit der Zweierpotenzen}
    \setcounter{proofstepnr}{11}% Fortlaufende Schritte dieses Beweises.
    \proofstepwidestar[1]{\FiniteCard(A)\in\mathbb N}{%
      \FormulaRefAuto{FiniteCardNatural}[thm]{1}}
    \proofstepwidestar[2]{\FiniteCard(B)\in\mathbb N}{%
      \FormulaRefAuto{FiniteCardNatural}[thm]{2}}
    \proofstepwidestar[1]{%
      \FiniteCard(\PowNE{A})+1=2^{\FiniteCard(A)}}{%
      \rAEa{\FormulaRefAuto{FiniteNonemptyPowerSetCardinality}[thm]{%
        1,12,\rII}}}
    \proofstepwidestar[2]{%
      \ifSubfilesClassLoaded{\csname Hy@make@anchor\endcsname}{}%
      \FiniteCard(\PowNE{B})+1=2^{\FiniteCard(B)}}{%
      \rAEa{\FormulaRefAuto{FiniteNonemptyPowerSetCardinality}[thm]{%
        2,13,\rII}}}
    \proofstepwidestar[1,2,3]{%
      \FiniteCard(\PowNE{B})+1=2^{\FiniteCard(A)}}{\rIE{11,14}}
    \proofstepwidestar[1,2,3]{%
      2^{\FiniteCard(A)}=2^{\FiniteCard(B)}}{%
      \FormulaRefAuto{a=b,\,a=c\vdash b=c}[thm]{16,15}}
  \closeproofpartwide

  \Needspace{5\baselineskip}
  \proofpartwide{Injektivität der Zweierpotenzfunktion}
    \setcounter{proofstepnr}{17}% Fortlaufende Schritte dieses Beweises.
    \proofstepwidestar[]{%
      \forall n\in\mathbb N\,
      \bigl(\operatorname{pow}_2(n)=2^n\bigr)}{%
      \FormulaRefAuto{PeanoPowerTwoFunction}[def]}
    \proofstepwidestar[1]{%
      \operatorname{pow}_2(\FiniteCard(A))=2^{\FiniteCard(A)}}{%
      \rRE{\rUE{18},12}}
    \proofstepwidestar[2]{%
      \operatorname{pow}_2(\FiniteCard(B))=2^{\FiniteCard(B)}}{%
      \rRE{\rUE{18},13}}
    \proofstepwidestar[1,2,3]{%
      \operatorname{pow}_2(\FiniteCard(A))=2^{\FiniteCard(B)}}{%
      \rIE{17,19}}
    \proofstepwidestar[1,2,3]{%
      \operatorname{pow}_2(\FiniteCard(A))=
      \operatorname{pow}_2(\FiniteCard(B))}{%
      \FormulaRefAuto{a=b,\,c=b\vdash a=c}[thm]{21,20}}
    \proofstepwidestar[]{\operatorname{pow}_2\colon\mathbb N\inj\mathbb N}{%
      \FormulaRefAuto{PeanoPowerTwoStrictMonotoneInjective}[thm]\text{ (ii)}}
    \proofstepwidestar[1,2,3]{\FiniteCard(A)=\FiniteCard(B)}{%
      \FormulaRefAuto{F\colon A\inj B\dsep x\in A\dsep y\in A\dsep
        F(x)=F(y)\vdash x=y}[ax]{23,12,13,22}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
Der allgemeine Vergleich wurde in Band~11 eingeführt: \(A\CardLeq B\)
bedeutet die Existenz einer Injektion von \(A\) nach \(B\), und
\(A\CardLt B\) bedeutet zusätzlich \(\neg(A\EqCard B)\);
siehe \FormulaRefAuto{CardLeqDef}[def] und
\FormulaRefAuto{CardLtDef}[def]. Der in Band~08 bewiesene Satz von
Cantor--Schröder--Bernstein liefert die Charakterisierung
\[
  A\EqCard B\quad\Longleftrightarrow\quad
  A\CardLeq B\land B\CardLeq A
\]
aus \FormulaRefAuto{EqCardMutualCardLeqEquiv}[thm]. Diese allgemeinen
Resultate werden nun auf Endlichkeit und Unendlichkeit angewandt.
...
Der Satz von Cantor--Schröder--Bernstein verbindet den strikten
Größenvergleich mit der Überabzählbarkeit: Eine Menge, die strikt mächtiger
als \(\mathbb N\) ist, kann keine Injektion zurück nach \(\mathbb N\)
besitzen. Diesen Schluss verwenden wir später für die Potenzmenge der
natürlichen Zahlen und für die reellen Zahlen.

\Needspace{20\baselineskip}
\FormulaThmDeltaK[Strikt mächtiger als die natürlichen Zahlen ist überabzählbar]{%
  \mathbb N\CardLt A\vdash\Uncountable{A}%
}{NaturalsStrictlyLessImpliesUncountable}{%
  \DeltaRow{Mengen}{A}
}
\begin{tabproofwide}
  \proofstepwidestar[1]{\mathbb N\CardLt A}{\rA}
  \proofstepwidestar[1]{%
    \mathbb N\CardLeq A\land\neg(\mathbb N\EqCard A)}{%
    \FormulaRefAuto{CardLtDef}[def]{1}}
  \proofstepwidestar[1]{\mathbb N\CardLeq A}{\rAEa{2}}
  \proofstepwidestar[1]{\neg(\mathbb N\EqCard A)}{\rAEb{2}}
  \proofstepwidestar[5]{\AtMostCountable{A}}{\rA}
  \proofstepwidestar[5]{A\CardLeq\mathbb N}{%
    \FormulaRefAuto{AtMostCountableDef}[def]{5}}
  \proofstepwidestar[1,5]{\mathbb N\EqCard A}{%
    \FormulaRefAuto{CantorSchroederBernstein}[thm]{3,6}}
  \proofstepwidestar[1,5]{\bot}{\rBI{7,4}}
  \proofstepwidestar[1]{\neg\AtMostCountable{A}}{\rCI{5,8}}
  \proofstepwidestar[1]{\Uncountable{A}}{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{\Uncountable{\powerset(\mathbb N)}}{%
    \FormulaRefAuto{NaturalsStrictlyLessImpliesUncountable}[thm]{1}}
\end{tabproofwide}
