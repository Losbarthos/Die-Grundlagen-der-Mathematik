...
\begin{tabproof}
  ...
  \proofstep{1,6}{\Finite{A\cup\{a\}}}{%
    \FormulaRefAuto{FiniteAdjunctionAxiom}[ax]{6,1}}
...
\begin{tabproofsplitwide}
  \proofpartwideind[Induktionsanfang]{%
    ...
    \proofstepwidestar[1]{\forall F\,\bigl(F\colon \varnothing\to M \rightarrow \Finite{A\cup F[\varnothing]}\bigr)}{\rUI{4}}
      \proofstepwidestarbreak[1]{\forall F\,\bigl(F\colon \NatSeg{0}\to M \rightarrow \Finite{A\cup F[\NatSeg{0}]}\bigr)}{\rIE{\FormulaRefAuto{PeanoNatSegZero}[thm],5}}
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1,2,3]{\forall F\,\bigl(F\colon \NatSeg{\Succ(n)}\to M \rightarrow \Finite{A\cup F[\NatSeg{\Succ(n)}]}\bigr)}{\rUI{10}}
      ...
      \rIE{\FormulaRefAuto{PeanoAddOneSucc}[thm]{2},11}}
  \closeproofpartwideindR
...
\begin{tabproof}
  ...
  \proofstep{1,2,4}{\Finite{(C\cap \NatSeg{n})\cup\{n\}}}{%
    \FormulaRefAuto{FiniteAdjunctionAxiom}[ax]{11,7}}
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{\forall x\,\bigl(x\in C \rightarrow x\in\NatSeg{n+1}\bigr)}{\rUI{\rRI{4,7}}}
...
\begin{tabproof}
  ...
  \proofstep{1,2}{D(\RecFun{b_0}{S}(k))\in \RecFun{b_0}{S}(k+1)}{%
    \rAEa{\FormulaRefAuto{\GrowFresh(M,B,b_0,S,D)\dsep u\in\mathbb{N}\vdash D(\RecFun{b_0}{S}(u))\in \RecFun{b_0}{S}(u+1)\land D(\RecFun{b_0}{S}(u))\notin \RecFun{b_0}{S}(u)}{1,2}}}
  \proofstep{1,2,3,4}{%
    \RecFun{b_0}{S}(k+1)\subseteq \RecFun{b_0}{S}(n)
  }{%
...
\begin{tabproof}
  ...
  \proofstep{1,3}{D(\RecFun{b_0}{S}(n))\notin \RecFun{b_0}{S}(n)}{%
    \rAEb{\FormulaRefAuto{\GrowFresh(M,B,b_0,S,D)\dsep u\in\mathbb{N}\vdash D(\RecFun{b_0}{S}(u))\in \RecFun{b_0}{S}(u+1)\land D(\RecFun{b_0}{S}(u))\notin \RecFun{b_0}{S}(u)}{1,3}}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktionsanfang]{%
    ...
    \proofstepwidestar[]{\powerset(\NatSeg{0})=\{\varnothing\}}{%
      \rIE{1,\FormulaRefAuto{\powerset(\varnothing)=\{\varnothing\}}[thm]}}
    ...
    \proofstepwidestar[]{%
      c_0\colon\powerset(\NatSeg{0})\bij\NatSeg{2^0}}{%
      \FormulaRefAuto{Bijektive Funktion}[def]{2,5,6}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Induktionsschritt]{%
    ...
    \proofstepwidestar[1]{2^{n+1}=2^n\cdot2}{%
      \FormulaRefAuto{PeanoPowerAddOne}[thm]{%
        \FormulaRefAuto{PeanoTwoInN}[thm],1}}
    \proofstepwidestar[1,2]{%
      c_{n+1}\colon
      \powerset(\NatSeg{n+1})\bij\NatSeg{2^{n+1}}}{%
      \makecell[l]{%
        \FormulaRefAuto{BinarySubsetCode}[def],\quad
...
\FormulaThmDeltaK[Potenzmenge einer Menge mit \(n\) Elementen]{%
  ...
  \vdash \tCard\bigl(\powerset(A)\bigr)=2^n%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1]{\NatSeg{\tCard(A)}\EqCard A}{%
  ...
  \proofstepwidestar[1]{\tCard(\powerset(A))\in\mathbb{N}}{%
    \FormulaRefAuto{FiniteCardNatural}[thm]{4}}
  \proofstepwidestar[1]{%
    \NatSeg{\tCard(\powerset(A))}\EqCard\powerset(A)}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{4}}
  \proofstepwidestar[1,2,3]{\tCard(\powerset(A))=2^n}{%
...
\FormulaThmDeltaK[Kardinalität der nichtleeren Potenzmenge]{%
  \begin{aligned}[t]
    &\Finite{A}\dsep n\in\mathbb N\dsep \tCard(A)=n\vdash{}\\[-2pt]
    &\tCard\bigl(\PowNE{A}\bigr)+1=2^n
      \land
...
Setze \(p\coloneqq\tCard(\PowNE{A})\). Nach
...
\(\Finite{A}\), \(n\in\mathbb N\) und \(\tCard(A)=n\)
\[
  \tCard(\powerset(A))=2^n.
\]
...
\[
  p=(p+1)-1=2^n-1.
\]
Zusammen mit (4) und \(p=\tCard(\PowNE{A})\) sind dies die beiden
...
\[
\begin{aligned}
  a&\coloneqq\tCard(A), & b&\coloneqq\tCard(B),\\
  p&\coloneqq\tCard(\PowNE{A}), &
  q&\coloneqq\tCard(\PowNE{B}).
\end{aligned}
\]
...
\begin{tabproof}
  ...
  \proofstep{1,2,3}{\tCard(A)=\tCard(B)}{%
    \FormulaRefAuto{FiniteNonemptyPowerSetReflectsCardinality}[thm]{1,2,3}}
  \proofstep{1}{\NatSeg{\tCard(A)}\EqCard A}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{1}}
  \proofstep{1}{A\EqCard\NatSeg{\tCard(A)}}{%
    \FormulaRefAuto{EqCardSymmetric}[thm]{5}}
  \proofstep{2}{\NatSeg{\tCard(B)}\EqCard B}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{2}}
  \proofstep{1,2,3}{\NatSeg{\tCard(A)}\EqCard B}{\rIE{4,7}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[3]{\tCard(M)\leq \tCard(N)}{\rA}
  \proofstepwidestar[1]{\NatSeg{\tCard(M)}\EqCard M}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{1}}
  \proofstepwidestar[2]{\NatSeg{\tCard(N)}\EqCard N}{%
    \FormulaRefAuto{FiniteCardCounts}[thm]{2}}
  \proofstepwidestarbreak[1,2,3]{\iota_{\NatSeg{\tCard(M)},\NatSeg{\tCard(N)}}\colon
    \NatSeg{\tCard(M)}\inj \NatSeg{\tCard(N)}}{%
...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Der neue Kandidat ist maximal]{%
    ...
    \proofstepwidestar[2,3,4,10]{m,c,b\in A}{%
      \rAI{%
        \FormulaRefAuto{A\subseteq B, x\in A \vdash x\in B}{2,4},%
        \rAI{3,\FormulaRefAuto{A\subseteq B, x\in A \vdash x\in B}{2,10}}}}
    \proofstepwidestar[1,2,3,4,6,8,10]{m\preceq b}{%
      \FormulaRefAuto{EqRelTransitivity}[ax]{11,6,8}}
    \proofstepwidestar[1,2,3,4,5,6,8,10]{b=m}{%
      \rRE{\rRE{10,\rUE{5}},12}}
    \proofstepwidestar[1,2,3,4,5,6,8,10]{m=b}{%
      \FormulaRefAuto{a=b\vdash b=a}{13}}
    \proofstepwidestar[1,2,3,4,5,6,8,10]{b\preceq c}{\rIE{14,6}}
    \proofstepwidestar[1,2,3,4,5,6,8,10]{b=c}{%
      \FormulaRefAuto{OrderAntisymmetry}[ax]{1,15,8}}
    \proofstepwidestar[17]{b=c}{\rA}
    \proofstepwidestar[1,2,3,4,5,6,7,8]{b=c}{%
      \rOE{9,10,16,17,17}}
    \proofstepwidestar[1,2,3,4,5,6,7]{c\preceq b\to b=c}{\rRI{8,18}}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Induktionsanfang]{%
    ...
    \proofstepwidestar[]{%
      ...
      \forall M\,\bigl((0\EqCard M)\rightarrow\Finite{M}\bigr)}{\rIE{\FormulaRefAuto{0\coloneqq\varnothing}[def],13}}
  \closeproofpartwideindR
...
Die endliche Kardinalzahl \(\tCard(M)\) wurde nur für endliche Mengen
...
\begin{tabproof}
  ...
  \proofstep{3}{F^{-1}\colon B\bij A}{%
    \FormulaRefAuto{F\colon A\bij B\vdash F^{-1}\colon B\bij A}{3}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2,3,4,5]{\CBPart{F}{G}\subseteq X}{%
    \FormulaRefAuto{A\subseteq B \coloneq
      \forall x\,(x\in A\rightarrow x\in B)}{\rUI{\rRI{6,13}}}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Teilmengenrichtung \(\subseteq\)]{%
    ...
    \proofstepwidestar[1,2,3,14]{\exists z\in C\,y=F(z)}{%
      \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep y\in F[C]
        \vdash\exists x\in C\,y=F(x)}[thm]{%
          \FormulaRefAuto{A\subseteq B\dsep B\subseteq C
            \vdash A\subseteq C}[thm]{2,3},5,14}}
    \proofstepwidestar[16]{z\in C\land y=F(z)}{\rA}
    \proofstepwidestar[16]{z\in C}{\rAEa{16}}
    \proofstepwidestar[16]{y=F(z)}{\rAEb{16}}
    \proofstepwidestar[2,16]{z\in A}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{2,17}}
    \proofstepwidestar[3,8]{x\in M}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{3,11}}
    \proofstepwidestar[2,3,16]{z\in M}{%
      \FormulaRefAuto{A\subseteq B\dsep x\in A\vdash x\in B}[thm]{3,19}}
    \proofstepwidestar[8,16]{F(x)=F(z)}{%
      \rChain{\FormulaRefAuto{a=b\vdash b=a}[thm]{10},18}}
    \proofstepwidestar[1,2,3,8,16]{x=z}{%
      \FormulaRefAuto{Injektivität}[ax]{1,20,21,22}}
    \proofstepwidestar[1,2,3,8,16]{x\in C}{\rIE{23,17}}
    \proofstepwidestar[8]{x\notin C}{%
      \FormulaRefAuto{x\in A\setminus B\vdash x\notin B}[thm]{9}}
    \proofstepwidestar[1,2,3,8,16]{\bot}{\rBI{24,25}}
    \proofstepwidestar[1,2,3,8,14]{\bot}{\rEE{15,16,26}}
    ...
    \proofstepwidestar[1,2,3]{F[A\setminus C]\subseteq F[A]\setminus F[C]}{%
      \FormulaRefAuto{A\subseteq B\coloneq
        \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{4,30}}}}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Teilmengenrichtung \(\supseteq\)]{%
    ...
    \proofstepwidestar[1,2,3,9,12]{F(x)\in F[C]}{%
      \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep x\in C
        \vdash F(x)\in F[C]}[thm]{%
          \FormulaRefAuto{A\subseteq B\dsep B\subseteq C
            \vdash A\subseteq C}[thm]{2,3},7,12}}
    \proofstepwidestar[1,2,3,9,12]{y\in F[C]}{\rIE{11,13}}
    \proofstepwidestar[1,2,3,4,9,12]{\bot}{\rBI{14,6}}
    ...
    \proofstepwidestar[1,2,3,4,9]{y\in F[A\setminus C]}{%
      \FormulaRefAuto{C\subseteq A\dsep F\colon A\to B\dsep
        \exists x\in C\,y=F(x)\vdash y\in F[C]}[thm]{18,7,19}}
    \proofstepwidestar[1,2,3,4]{y\in F[A\setminus C]}{\rEE{8,9,20}}
    \proofstepwidestar[1,2,3]{F[A]\setminus F[C]\subseteq F[A\setminus C]}{%
      \FormulaRefAuto{A\subseteq B\coloneq
        \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{4,21}}}}
  \closeproofpartwideindR
...
\begin{tabproofsplitwide}
  ...
  \proofstepwidestar[1,2,3]{y\notin A\setminus G[B]}{%
      \rAEa{\FormulaRefAuto{OutsideUnionComponents}[thm]{7}}}
  \proofstepwidestar[1,2,3]{y\notin G[F[\CBPart{F}{G}]]}{%
      \rAEb{\FormulaRefAuto{OutsideUnionComponents}[thm]{7}}}
    \proofstepwidestar[10]{y\notin G[B]}{\rA}
    \proofstepwidestar[3,10]{y\in A\setminus G[B]}{%
      \FormulaRefAuto{x\in A\setminus B\eqvdash x\in A\land x\notin B}[thm]{%
        \rAI{4,10}}}
    \proofstepwidestar[1,2,3,10]{\bot}{\rBI{11,8}}
    \proofstepwidestar[1,2,3]{\neg(y\notin G[B])}{\rCI{10,12}}
    \proofstepwidestar[1,2,3]{y\in G[B]}{\FormulaRefAuto{rDN}[thm]{13}}
    \proofstepwidestar[1,2,3]{%
    ...
    \proofstepwidestar[1,2]{%
      A\setminus\CBPart{F}{G}
        \subseteq G[B]\setminus G[F[\CBPart{F}{G}]]}{%
      \FormulaRefAuto{A\subseteq B\coloneq
        \forall x\,(x\in A\rightarrow x\in B)}[def]{\rUI{\rRI{3,15}}}}
  \closeproofpartwideindR
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{%
    G[B\setminus F[\CBPart{F}{G}]]
      =A\setminus\CBPart{F}{G}}{\rChain{6,7}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,2]{%
    ...
    \FormulaRefAuto{F\colon A\bij B\vdash F^{-1}\colon B\bij A}[thm]{10}}
  \proofstepwidestar[]{%
  ...
  \proofstepwidestar[1,2]{%
    ...
    \FormulaRefAuto{CaseFunBijectiveDisjointTargets}[thm]{12,13,4,11}}
  \proofstepwidestar[1,2]{%
  ...
  \proofstepwidestar[1,2]{%
    \CaseFun{\CBPart{F}{G}}{A\setminus\CBPart{F}{G}}
      {F\restriction_{\CBPart{F}{G}}}
      {\bigl(G\restriction_{B\setminus F[\CBPart{F}{G}]}\bigr)^{-1}}
      \colon A\bij B}{\rIE{15,\rIE{16,14}}}
  \proofstepwidestar[1,2]{\exists H\colon A\bij B}{\rEI{17}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[3]{A\CardLeq\NatSeg n}{%
    \rAEa{\FormulaRefAuto{EqCardImpliesMutualCardLeq}[thm]{6}}}
  ...
  \proofstepwidestar[3]{%
    ...
    \FormulaRefAuto{A\subseteq B\vdash\iota_{A,B}\colon A\inj B}[thm]{8}}
  \proofstepwidestar[3]{\NatSeg n\CardLeq\mathbb N}{%
    \FormulaRefAuto{CardLeqDef}[def]{\rEI{9}}}
  \proofstepwidestar[3]{A\CardLeq\mathbb N}{%
    \FormulaRefAuto{CardLeqTransitive}[thm]{7,10}}
  \proofstepwidestar[3]{\AtMostCountable{A}}{%
    \FormulaRefAuto{AtMostCountableDef}[def]{11}}
  \proofstepwidestar[1]{\AtMostCountable{A}}{\rEE{2,3,12}}
\end{tabproofwide}
...
\begin{tabproofsplitwide}
  ...
  \proofpartwide{\(\dashv\)}
    ...
    \proofstepwidestar[4]{A\CardLeq\mathbb N}{%
      \rAEa{\FormulaRefAuto{EqCardImpliesMutualCardLeq}[thm]{5}}}
    \proofstepwidestar[4]{\AtMostCountable{A}}{%
      \FormulaRefAuto{AtMostCountableDef}[def]{6}}
    \proofstepwidestar[1]{\AtMostCountable{A}}{\rOE{1,2,3,4,7}}
  \closeproofpartwide
\end{tabproofsplitwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[2,3,4]{\{x\}=\{y\}}{%
    \rChain{\FormulaRefAuto{a=b\vdash b=a}[thm]{5},\rChain{4,6}}}
  \proofstepwidestar[]{x\in\{x\}}{%
    \FormulaRefAuto{x\in\{x\}}[thm]}
  \proofstepwidestar[2,3,4]{x\in\{y\}}{\rIE{7,8}}
  \proofstepwidestar[2,3,4]{x=y}{%
    \FormulaRefAuto{x\in\{a\}\eqvdash x=a}[thm]{9}}
  \proofstepwidestar[]{\SingletonEmbedding{A}\colon A\inj\powerset(A)}{%
    \FormulaRefAuto{Injektive Funktion}[def]{%
      1,\rUI{\rRI{2,\rRI{3,\rRI{4,10}}}}}}
\end{tabproofwide}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{%
    ...
    \FormulaRefAuto{\neg(P\leftrightarrow\neg P)}}
  \proofstepwidestar[1,2,3]{\bot}{\rBI{6,7}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[]{\mathbb N\CardLeq\mathbb R}{%
    \rAEa{\FormulaRefAuto{CardLtDef}[def]{1}}}
  \proofstepwidestar[]{\neg(\mathbb N\EqCard\mathbb R)}{%
    \rAEb{\FormulaRefAuto{CardLtDef}[def]{1}}}
  \proofstepwidestar[1]{\AtMostCountable{\mathbb R}}{\rA}
  \proofstepwidestar[1]{\mathbb R\CardLeq\mathbb N}{%
    \FormulaRefAuto{AtMostCountableDef}[def]{4}}
  \proofstepwidestar[1]{\mathbb N\EqCard\mathbb R}{%
    \FormulaRefAuto{CantorSchroederBernstein}[thm]{2,5}}
  \proofstepwidestar[1]{\bot}{\rBI{6,3}}
  \proofstepwidestar[]{\neg\AtMostCountable{\mathbb R}}{\rCI{1,7}}
