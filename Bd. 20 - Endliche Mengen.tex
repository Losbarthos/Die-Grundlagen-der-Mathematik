...
\begin{tabproofsplitwide}
  ...
  \proofpartwideindR[Der neue Kandidat ist maximal]{%
    ...
    \proofstepwidestar[1,6,8]{m\preceq b}{%
      \FormulaRefAuto{EqRelTransitivity}[ax]{1,6,8}}
    \proofstepwidestar[5,6,8,10]{b=m}{%
      \rRE{\rRE{10,\rUE{5}},11}}
    \proofstepwidestar[5,6,8,10]{m=b}{%
      \FormulaRefAuto{a=b\vdash b=a}{12}}
    \proofstepwidestar[5,6,8,10]{b\preceq c}{\rIE{13,6}}
    \proofstepwidestar[1,5,6,8,10]{b=c}{%
      \FormulaRefAuto{OrderAntisymmetry}[ax]{1,14,8}}
    \proofstepwidestar[16]{b=c}{\rA}
    \proofstepwidestar[1,5,6,7,8]{b=c}{%
      \rOE{9,10,15,16,16}}
    \proofstepwidestar[1,5,6,7]{c\preceq b\to b=c}{\rRI{8,17}}
