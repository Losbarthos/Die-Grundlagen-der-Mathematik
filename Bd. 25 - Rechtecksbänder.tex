...
\title{Bd. 25 - Rechtecksbänder}
\author{Martin Kunze}
\date{}
\setcounter{file}{25}

\hypersetup{
  pdftitle={Bd. 25 - Rechtecksbänder},
...
\begin{tabproofwide}
  ...
  \proofstepwidestarbreakkeep[1,3]{%
    \begin{aligned}[t]
      x\star x
      &=\bigl((x\star x)\star x\bigr)\star x\\[-2pt]
      &=\bigl(x\star(x\star x)\bigr)\star x\\[-2pt]
      &=x
    \end{aligned}}{%
    \text{Schritte 5--6; Gleichheitssubstitution; }%
    \FormulaRefAuto{RectangularBandIdentityAxiom}[ax]{1,3,4}}
  \proofstepwidestarbreak[1]{%
    \forall x\in R\quad x\star x=x}{%
    \text{Schritte 3--7; Allgemeinheit von }x}
  \proofstepwidestar[1]{\IdempotentSemigroupAlg{R}{\star}}{%
    \FormulaRefAuto{IdempotentSemigroupDef}[def]{2,8}}
\end{tabproofwide}
...
\FormulaThmDeltaK[Dreitermcharakterisierung der Rechtecksbänder]{%
  \begin{aligned}[t]
    &\RectangularBandAlg{R}{\star}\leftrightarrow\\[-2pt]
    &\left(
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechtecksband \(\Rightarrow\) rechte Seite]{%
    \begin{aligned}[t]
      &\RectangularBandAlg{R}{\star}\vdash{}\\[-2pt]
      &\IdempotentSemigroupAlg{R}{\star}\land
        \forall x,y,z\in R\,
    ...
    \begin{aligned}[t]
      ...
      &\IdempotentSemigroupAlg{R}{\star}\land
        \forall x,y,z\in R\,
          \bigl((x\star y)\star z=x\star z\bigr)
    \end{aligned}
  }[RectangularBandThreeTermCharacterizationForward]
    \proofstepwidestar[1]{\RectangularBandAlg{R}{\star}}{\rA}
    \proofstepwidestar[1]{\IdempotentSemigroupAlg{R}{\star}}{%
    ...
    \proofstepwidestarbreak[1]{%
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)}{%
      \FormulaRefAuto{RectangularBandThreeTermLaw}[thm]{1}}
    \proofstepwidestarbreak[1]{%
      \IdempotentSemigroupAlg{R}{\star}\land
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)}{%
  ...
  \proofpartwideindR[Rechte Seite \(\Rightarrow\) Rechtecksband]{%
    \begin{aligned}[t]
      &\IdempotentSemigroupAlg{R}{\star}\land
        \forall u,v,w\in R\,
          \bigl((u\star v)\star w=u\star w\bigr)\\[-2pt]
    ...
    \begin{aligned}[t]
      ...
      &\vdash\RectangularBandAlg{R}{\star}
    \end{aligned}
  }[RectangularBandThreeTermCharacterizationBackward]
    ...
    \proofstepwidestarbreakkeep[1,5]{%
      ...
      \text{Schritt 3 mit }u=x,\ v=y,\ w=x}
    \proofstepwide[1,5]{(x\star y)\star x}{=}{x}{%
      \rChain{7,6}}
    \proofstepwidestarbreak[1]{%
      \forall x,y\in R\quad (x\star y)\star x=x}{%
      \text{Schritte 5--8; Allgemeinheit von }x,y}
    \proofstepwidestar[1]{\RectangularBandAlg{R}{\star}}{%
      \FormulaRefAuto{RectangularBandDef}[def]{4,9}}
  \closeproofpartwideindR
  ...
  \proofpartwide{Schluss}
    ...
    \proofstepwidestarbreak[1]{%
      ...
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)}{%
      \FormulaRefAuto{RectangularBandThreeTermCharacterizationForward}[thm]{1}}
    ...
    \proofstepwidestarbreakkeep[4]{%
      \IdempotentSemigroupAlg{R}{\star}\land
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)}{\rA}
    \proofstepwidestar[4]{\RectangularBandAlg{R}{\star}}{%
      \FormulaRefAuto{RectangularBandThreeTermCharacterizationBackward}[thm]{4}}
    \proofstepwidestarbreak[]{%
      \left(
      \IdempotentSemigroupAlg{R}{\star}\land
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)
      \right)
      \rightarrow\RectangularBandAlg{R}{\star}}{%
      \rRI{4,5}}
...
\(\SemigroupCoordinateIso{R}{\star}{e}\) den in Band~22 eingeführten
...
\begin{tabproofsplitwide}
  \proofpartwideindR[Rechtecksband \(\Rightarrow\)
    ...
    \proofstepwidestarbreak[2]{%
      \forall x,y,z\in R\,
        \bigl((x\star y)\star z=x\star z\bigr)}{%
      \FormulaRefAuto{RectangularBandThreeTermLaw}[thm]{2}}
    \proofstepwidestar[6]{e\in R}{\rA}
    \proofstepwidestar[7]{x\in R}{\rA}
    \proofstepwidestar[2,7]{x\star x=x}{%
      \FormulaRefAuto{IdempotentSemigroupIdempotenceAxiom}[ax]{4,7}}
    \proofstepwidestarbreak[2]{%
      \forall x\in R\,(x\star x=x)}{%
      \text{Schritte 7--8; Allgemeinheit von }x}
    \proofstepwidestar[2,6]{%
      \SemigroupCoordinateIso{R}{\star}{e}}{%
      \FormulaRefAuto{SemigroupCoordinateIsoCriterion}[thm]{3,6,9,5}}
    \proofstepwidestar[2]{%
      \forall e\in R\,
        \SemigroupCoordinateIso{R}{\star}{e}}{%
      \text{Schritte 6--10; Allgemeinheit von }e}
  \closeproofpartwideindR
  ...
  \proofpartwideindR[Koordinatenisomorphismen \(\Rightarrow\)
    ...
    \proofstepwidestar[2,4]{%
      \SemigroupCoordinateIso{R}{\star}{e}}{%
      \text{Schritt 2; Allquantorenbeseitigung}}
