...
\proofpartwide{Mengengleichheit}
  \setcounter{proofstepnr}{25}% Fortlaufende Schritte dieses Beweises.
\proofstepwidestar[1]{%
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,7]{d\in A\land\forall t\in T\,(d\geq t)}{%
  ...
  \proofstepwidestar[1,2,7]{%
    d\geq\sup_{A,\leq}(T)\leftrightarrow
      \sup_{A,\leq}(T)\leq d}{%
    \FormulaRefAuto{OrderDualRelation}[def]{12,10}}
  \proofstepwidestar[1,2,7]{d\geq\sup_{A,\leq}(T)}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{13,9}}
  \proofstepwidestar[1,2]{%
    \forall d\in\LB_{A,\geq}(T)\,
      (d\geq\sup_{A,\leq}(T))}{\rUI{\rRI{7,14}}}
  \proofstepwidestar[1,2]{%
    \sup_{A,\leq}(T)=\inf_{A,\geq}(T)}{%
    \FormulaRefAuto{InfimumCandidateEqualsInfimum}[thm]{%
      3,1,6,15}}
...
\begin{tabproofwide}
  ...
  \proofstepwidestar[1,7]{d\in A\land\forall t\in T\,(t\geq d)}{%
      \FormulaRefAuto{UpperBoundSetElim}[thm]{1,7}}
  \proofstepwidestar[1,7]{d\in A}{%
    \rAEa{11}}
  \proofstepwidestar[1,2,7]{%
    \inf_{A,\leq}(T)\geq d\leftrightarrow
      d\leq\inf_{A,\leq}(T)}{%
    \FormulaRefAuto{OrderDualRelation}[def]{10,12}}
  \proofstepwidestar[1,2,7]{\inf_{A,\leq}(T)\geq d}{%
    \FormulaRefAuto{P\leftrightarrow Q, Q\vdash P}{13,9}}
  \proofstepwidestar[1,2]{%
    \forall d\in\UB_{A,\geq}(T)\,
      (\inf_{A,\leq}(T)\geq d)}{\rUI{\rRI{7,14}}}
  \proofstepwidestar[1,2]{%
    \inf_{A,\leq}(T)=\sup_{A,\geq}(T)}{%
    \FormulaRefAuto{SupremumCandidateEqualsSupremum}[thm]{%
      3,1,6,15}}
